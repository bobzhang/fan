...
let apply () = begin 
  ...
  with mbind
      {:extend|
        ...
        | `Ant (("mbind" |"" as n),s) ->
            mk_anti _loc ~c:"mbind" n s
        | `Quot x -> AstQuotation.expand _loc x FDyn.mbind_tag
  ...
  (* with constr *)
      {:extend|
        ...
        | `Quot x -> AstQuotation.expand _loc x FDyn.constr_tag
    ...
    {:extend|
      ...
      { "top"
       ...
       "simple"
        ...
        | `Quot x -> AstQuotation.expand _loc x FDyn.mtyp_tag
  ...
  {:extend|
    ...
    | `Quot x -> AstQuotation.expand _loc x FDyn.sigi_tag
 ...
 |};
    ...
    {:extend|
      ...
      let name_space:
       ...
       "simple"
        [ `Quot x -> AstQuotation.expand _loc x FDyn.exp_tag
  ...
  with pat
    {:extend| 
       ...
       "simple"
        ...
        | "#"; type_longident{i} -> {| # $i |}
        | `Quot x -> AstQuotation.expand _loc x FDyn.pat_tag
        | "_" -> {| _ |}
        | `LABEL i; S{p} -> {| ~ $lid:i : $p |}
  ...
  with stru
    ...
    (** ml file  entrance *)    
      ...
      { "top"
        ...
        | `Quot x -> AstQuotation.expand _loc x FDyn.stru_tag
        | exp{e} -> `StExp(_loc,e)
  ...
  with clsigi
    {:extend|
      ...
      clsigi:
      [ `Ant ((""|"csg" as n),s) -> mk_anti _loc ~c:"clsigi" n s
      | `Quot x -> AstQuotation.expand _loc x FDyn.clsigi_tag
  ...
  with clfield
    {:extend|
      ...
      clfield:
        [ `Ant ((""|"cst" as n),s) -> mk_anti _loc ~c:"clfield" n s
        | `Quot x -> AstQuotation.expand _loc x FDyn.clfield_tag
  ...
  with clexp
    {:extend|
      ...
      (* | `Quot x -> AstQuotation.expand _loc x FDyn.clexp_tag *)
  ...
  with cltyp
    {:extend|
      ...
      (* | `Quot x -> AstQuotation.expand _loc x FDyn.cltyp_tag *)
