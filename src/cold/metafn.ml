  ...
  object (self : 'this_type__002_)
    ...
    method position_flag : _ -> position_flag -> Astf.ep=
      fun _loc  ->
        ...
        | #ant as _a0 -> (self#ant _loc _a0 :>Astf.ep)
    method strings : _ -> strings -> Astf.ep=
      fun _loc  ->
        function
        | `App (_a0,_a1) ->
            `App
    ...
    method vid' : _ -> vid' -> Astf.ep=
      fun _loc  ->
        ...
        | `Uid _a0 ->
            `App (_loc, (`Vrn (_loc, "Uid")), (self#string _loc _a0))
    method dupath : _ -> dupath -> Astf.ep=
      fun _loc  ->
        function
        | `Dot (_a0,_a1) ->
            `App
        ...
        | #auident as _a0 -> (self#auident _loc _a0 :>Astf.ep)
    method dlpath : _ -> dlpath -> Astf.ep=
      fun _loc  ->
        function
        | `Dot (_a0,_a1) ->
            `App
        ...
        | #alident as _a0 -> (self#alident _loc _a0 :>Astf.ep)
    method any : _ -> any -> Astf.ep= fun _loc  `Any  -> `Vrn (_loc, "Any")
    method ctyp : _ -> ctyp -> Astf.ep=
      fun _loc  ->
        function
        | `Alias (_a0,_a1) ->
            `App
        ...
        | #ant as _a0 -> (self#ant _loc _a0 :>Astf.ep)
    method type_parameters : _ -> type_parameters -> Astf.ep=
      fun _loc  ->
        function
        | `Com (_a0,_a1) ->
            `App
        ...
        | #ant as _a0 -> (self#ant _loc _a0 :>Astf.ep)
    method row_field : _ -> row_field -> Astf.ep=
      fun _loc  ->
        function
        | #ant as _a0 -> (self#ant _loc _a0 :>Astf.ep)
        | `Bar (_a0,_a1) ->
        ...
        | `Ctyp _a0 ->
            `App (_loc, (`Vrn (_loc, "Ctyp")), (self#ctyp _loc _a0))
    method tag_names : _ -> tag_names -> Astf.ep=
      fun _loc  ->
        function
        | #ant as _a0 -> (self#ant _loc _a0 :>Astf.ep)
        | `App (_a0,_a1) ->
    ...
    method decl : _ -> decl -> Astf.ep=
      fun _loc  ->
        ...
        | #ant as _a0 -> (self#ant _loc _a0 :>Astf.ep)
    method type_constr : _ -> type_constr -> Astf.ep=
      fun _loc  ->
        function
        | `And (_a0,_a1) ->
            `App
              ...
              (_loc, (`Vrn (_loc, "Eq")),
                (`Par
                   (_loc,
                     (`Com (_loc, (self#ctyp _loc _a0), (self#ctyp _loc _a1))))))
        | #ant as _a0 -> (self#ant _loc _a0 :>Astf.ep)
    method opt_type_constr : _ -> opt_type_constr -> Astf.ep=
      fun _loc  ->
        function
        | `Some _a0 ->
            `App (_loc, (`Vrn (_loc, "Some")), (self#type_constr _loc _a0))
        | `None -> `Vrn (_loc, "None")
    method decl_param : _ -> decl_param -> Astf.ep=
      fun _loc  ->
        function
        | `Quote (_a0,_a1) ->
            `App
        ...
        | `Any -> `Vrn (_loc, "Any")
        | #ant as _a0 -> (self#ant _loc _a0 :>Astf.ep)
    method decl_params : _ -> decl_params -> Astf.ep=
      fun _loc  ->
        function
        | `Quote (_a0,_a1) ->
            `App
        ...
        | #ant as _a0 -> (self#ant _loc _a0 :>Astf.ep)
    method opt_decl_params : _ -> opt_decl_params -> Astf.ep=
      fun _loc  ->
        function
        | `Some _a0 ->
            `App (_loc, (`Vrn (_loc, "Some")), (self#decl_params _loc _a0))
        | `None -> `Vrn (_loc, "None")
    method type_info : _ -> type_info -> Astf.ep=
      fun _loc  ->
        function
        | `TyMan (_a0,_a1,_a2) ->
            `App
        ...
        | #ant as _a0 -> (self#ant _loc _a0 :>Astf.ep)
    method type_repr : _ -> type_repr -> Astf.ep=
      fun _loc  ->
        function
        | `Record _a0 ->
        ...
        | #ant as _a0 -> (self#ant _loc _a0 :>Astf.ep)
    method name_ctyp : _ -> name_ctyp -> Astf.ep=
      fun _loc  ->
        function
        | `Sem (_a0,_a1) ->
            `App
                        ...
                        (_loc, (self#alident _loc _a0),
                          (`Com
                             (_loc, (self#ctyp _loc _a1),
                               (self#flag _loc _a2))))))))
        | #ant as _a0 -> (self#ant _loc _a0 :>Astf.ep)
    method or_ctyp : _ -> or_ctyp -> Astf.ep=
      fun _loc  ->
        function
        | `Bar (_a0,_a1) ->
            `App
                ...
                (`Par
                   (_loc,
                     (`Com
                        (_loc, (self#auident _loc _a0), (self#ctyp _loc _a1))))))
        | #auident as _a0 -> (self#auident _loc _a0 :>Astf.ep)
    method of_ctyp : _ -> of_ctyp -> Astf.ep=
      fun _loc  ->
        function
        | `Of (_a0,_a1) ->
            `App
              ...
              (_loc, (`Vrn (_loc, "ModuleConstraint")),
                (`Par
                   (_loc,
                     (`Com
                        (_loc, (self#auident _loc _a0), (self#ctyp _loc _a1))))))
    method rec_pat : _ -> rec_pat -> Astf.ep=
      fun _loc  ->
        function
        | `RecBind (_a0,_a1) ->
            `App
    ...
    method rec_exp : _ -> rec_exp -> Astf.ep=
      fun _loc  ->
        function
        | `Sem (_a0,_a1) ->
            `App
                ...
                (`Par
                   (_loc,
                     (`Com
                        (_loc, (self#auident _loc _a0), (self#mtyp _loc _a1))))))
        | #ant as _a0 -> (self#ant _loc _a0 :>Astf.ep)
    method constr : _ -> constr -> Astf.ep=
      fun _loc  ->
        function
        | `TypeEq (_a0,_a1) ->
            `App
    ...
    method stru : _ -> stru -> Astf.ep=
      fun _loc  ->
        ...
        | #ant as _a0 -> (self#ant _loc _a0 :>Astf.ep)
    method cltdecl : _ -> cltdecl -> Astf.ep=
      fun _loc  ->
        function
        | `And (_a0,_a1) ->
            `App
    ...
    method cltyp : _ -> cltyp -> Astf.ep=
      fun _loc  ->
        ...
        | #ant as _a0 -> (self#ant _loc _a0 :>Astf.ep)
    method clsigi : _ -> clsigi -> Astf.ep=
      fun _loc  ->
        function
        | `Sem (_a0,_a1) ->
            `App
              ...
              (_loc, (`Vrn (_loc, "Eq")),
                (`Par
                   (_loc,
                     (`Com (_loc, (self#ctyp _loc _a0), (self#ctyp _loc _a1))))))
        | #ant as _a0 -> (self#ant _loc _a0 :>Astf.ep)
    method cldecl : _ -> cldecl -> Astf.ep=
      fun _loc  ->
        function
    ...
    method clexp : _ -> clexp -> Astf.ep=
      fun _loc  ->
        ...
        | #ant as _a0 -> (self#ant _loc _a0 :>Astf.ep)
    method clfield : _ -> clfield -> Astf.ep=
      fun _loc  ->
        function
        | `Sem (_a0,_a1) ->
            `App
    ...
    method ep : _ -> ep -> Astf.ep=
      fun _loc  ->
        ...
        | #literal as _a0 -> (self#literal _loc _a0 :>Astf.ep)
    method rec_bind : _ -> rec_bind -> Astf.ep=
      fun _loc  ->
        function
        | `RecBind (_a0,_a1) ->
            `App
