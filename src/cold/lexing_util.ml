...
let turn_on_quotation_debug = function | () -> debug := true
let turn_off_quotation_debug = function | () -> debug := false
type context = {
  mutable loc: Locf.position list;
  buffer: Buffer.t;}
let new_cxt = function | () -> { loc = []; buffer = (Buffer.create 256) }
...
let (--) = Location_util.(--)
let store =
  function | c -> (function | lexbuf -> c.buffer ++ (Lexing.lexeme lexbuf))
let with_store =
  function
  | c ->
      (function | lexbuf -> (function | f -> (store c lexbuf; f c lexbuf)))
let buff_contents =
  function
  | c ->
           ...
           (function
            | lexer ->
                (c.loc <- (Lexing.lexeme_start_p lexbuf) :: (c.loc);
                 lexer c lexbuf)))
let pop_loc = function | c -> c.loc <- List.tl c.loc
let null_loc = function | c -> c.loc = []
  ...
  | c ->
      (function
       | (lexbuf : Lexing.lexbuf) ->
           ...
           and __ocaml_lex_state1 = function | () -> 4
           and __ocaml_lex_state2 = function | () -> 3
           ...
           and __ocaml_lex_state4 = function | () -> 2
                 ...
                 (lexbuf.lex_last_pos <- lexbuf.lex_curr_pos;
                  ...
                  (match __ocaml_lex_next_char () with
                   ...
                   | _ ->
                       (lexbuf.lex_curr_pos <- lexbuf.lex_last_pos;
                        lexbuf.lex_last_action)))
           and __ocaml_lex_state7 = function | () -> 0
           and __ocaml_lex_state8 = function | () -> 1 in
             ...
             (match __ocaml_lex_result with
              ...
              | 3 ->
                  (err Unterminated_comment) @@
                    (Location_util.of_positions (List.hd c.loc)
                       lexbuf.lex_curr_p)
              | 4 -> with_store c lexbuf lex_comment
              | _ ->
                  failwith
                    ("Lexing_util" ^
                       ("." ^ ("lex_comment" ^ " lexing: empty token")))))))
let rec lex_string =
  function
  | c ->
      (function
       | (lexbuf : Lexing.lexbuf) ->
           ...
           and __ocaml_lex_state0 =
             ...
             | () ->
                 (match __ocaml_lex_next_char () with
                  ...
                  | 256 -> __ocaml_lex_state2 ()
                  | _ -> __ocaml_lex_state1 ())
           and __ocaml_lex_state1 = function | () -> 6
           and __ocaml_lex_state2 = function | () -> 5
           and __ocaml_lex_state3 =
             function
             | () ->
                 (lexbuf.lex_last_pos <- lexbuf.lex_curr_pos;
                  ...
                  (match __ocaml_lex_next_char () with
                   ...
                   | _ ->
                       (lexbuf.lex_curr_pos <- lexbuf.lex_last_pos;
                        lexbuf.lex_last_action)))
           and __ocaml_lex_state4 = function | () -> 4
           and __ocaml_lex_state5 =
             function
             | () ->
                 (lexbuf.lex_last_pos <- lexbuf.lex_curr_pos;
           ...
           and __ocaml_lex_state6 = function | () -> 0
           and __ocaml_lex_state7 = function | () -> 3
                 ...
                 (lexbuf.lex_last_pos <- lexbuf.lex_curr_pos;
                  ...
                  (match __ocaml_lex_next_char () with
                   ...
                   | _ ->
                       (lexbuf.lex_curr_pos <- lexbuf.lex_last_pos;
                        lexbuf.lex_last_action)))
           and __ocaml_lex_state10 = function | () -> 2
            ...
            (let __ocaml_lex_result = __ocaml_lex_state0 () in
             ...
             (match __ocaml_lex_result with
              ...
              | _ ->
                  failwith
                    ("Lexing_util" ^
                       ("." ^ ("lex_string" ^ " lexing: empty token")))))))
let rec lex_quotation =
  function
  | c ->
      (function
       | (lexbuf : Lexing.lexbuf) ->
           ...
           and __ocaml_lex_state0 =
             ...
             | () ->
                 (match __ocaml_lex_next_char () with
                  ...
                  | _ -> __ocaml_lex_state1 ())
           and __ocaml_lex_state1 = function | () -> 8
           ...
           and __ocaml_lex_state3 = function | () -> 6
           and __ocaml_lex_state4 = function | () -> 5
           and __ocaml_lex_state5 =
             function
             | () ->
                 (lexbuf.lex_last_pos <- lexbuf.lex_curr_pos;
                  ...
                  (match __ocaml_lex_next_char () with
                   ...
                   | _ ->
                       (lexbuf.lex_curr_pos <- lexbuf.lex_last_pos;
                        lexbuf.lex_last_action)))
           and __ocaml_lex_state6 = function | () -> 4
                 ...
                 (lexbuf.lex_last_pos <- lexbuf.lex_curr_pos;
                  ...
                  (match __ocaml_lex_next_char () with
                   ...
                   | _ ->
                       (lexbuf.lex_curr_pos <- lexbuf.lex_last_pos;
                        lexbuf.lex_last_action)))
           and __ocaml_lex_state8 = function | () -> 2
           and __ocaml_lex_state9 = function | () -> 1
                 ...
                 (lexbuf.lex_last_pos <- lexbuf.lex_curr_pos;
                  ...
                  (match __ocaml_lex_next_char () with
                   ...
                   | _ ->
                       (lexbuf.lex_curr_pos <- lexbuf.lex_last_pos;
                        lexbuf.lex_last_action)))
           and __ocaml_lex_state11 = function | () -> 0
           and __ocaml_lex_state12 =
             function
             | () ->
                 (match __ocaml_lex_next_char () with
             ...
             | () ->
                 (match __ocaml_lex_next_char () with
                  ...
                  | _ ->
                      (lexbuf.lex_curr_pos <- lexbuf.lex_last_pos;
                       lexbuf.lex_last_action))
           and __ocaml_lex_state18 = function | () -> 3
             ...
             | () ->
                 (match __ocaml_lex_next_char () with
                  ...
                  | _ ->
                      (lexbuf.lex_curr_pos <- lexbuf.lex_last_pos;
                       lexbuf.lex_last_action))
           and __ocaml_lex_state21 = function | () -> 7
            ...
            (let __ocaml_lex_result = __ocaml_lex_state0 () in
             ...
             (match __ocaml_lex_result with
              ...
              | _ ->
                  failwith
                    ("Lexing_util" ^
                       ("." ^ ("lex_quotation" ^ " lexing: empty token")))))))
let adapt_to_stream =
  function
  | token ->
      (function
           ...
           (function
            | strm ->
                ...
                (lb.lex_abs_pos <- (loc.loc_start).pos_cnum;
                 ...
                 Streamf.from (function | _ -> Some (token lb)))))
let adapt_to_string =
  function
  | token ->
      (function
       | str ->
           ...
           (lb.lex_abs_pos <- (loc.loc_start).pos_cnum;
            lb.lex_curr_p <- loc.loc_start;
            (let next = function | _ -> Some (token lb) in Streamf.from next)))
let adapt_to_buf =
  function
  | token ->
      (function | lb -> Streamf.from (function | _ -> Some (token lb)))
  ...
  | (__strm : _ Streamf.t) ->
      (match Streamf.peek __strm with
       ...
       | Some x ->
           (Streamf.junk __strm;
            (let xs = __strm in
             Streamf.icons x (Streamf.slazy (function | _ -> clean xs))))
       | _ -> Streamf.sempty)
      ...
      (match Streamf.peek __strm with
       ...
       | Some x ->
           (Streamf.junk __strm;
            (let xs = __strm in
             Streamf.icons x
               (Streamf.slazy (function | _ -> strict_clean xs))))
       | _ -> Streamf.sempty)
let debug_of_string =
  function
  | token ->
