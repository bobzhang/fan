...
class primitive =
  object
    method int =
      ...
      | _loc ->
          (function
           | (i : int) -> ((`Int (_loc, (string_of_int i)) :> Astf.ep) : ep))
    method int32 =
      function
      | _loc ->
          (function
    ...
    method char =
      ...
      | _loc ->
          (function
           | (i : char) -> ((`Chr (_loc, (Char.escaped i)) :> Astf.ep) : ep))
    method unit =
      function | _loc -> (function | (_ : unit) -> ((`Unit _loc : ep) : ep))
    method loc =
      function
      | _loc ->
          (function
    ...
    method ant =
      function | (_loc : loc) -> (function | (x : ant) -> ((x :> ep) : ep))
    method bool = function | _loc -> (function | x -> (`Bool (_loc, x) : ep))
  end
class meta =
               ...
               `App
                 (_loc, (`Vrn (_loc, "Bool")),
                   (`Par
                      (_loc,
                        (`Com
                           (_loc, (self#loc _loc _a0), (self#bool _loc _a1))))))
           | `Unit _a0 ->
               ...
               `App
                 (_loc, (`Vrn (_loc, "ClassPath")),
                   (`Par
                      (_loc,
                        (`Com
                           (_loc, (self#loc _loc _a0), (self#ident _loc _a1))))))
           | `Label (_a0,_a1,_a2) ->
               `App
                 (_loc, (`Vrn (_loc, "Label")),
                   (`Par
               ...
               `App
                 (_loc, (`Vrn (_loc, "TyObjEnd")),
                   (`Par
                      (_loc,
                        (`Com
                           (_loc, (self#loc _loc _a0), (self#flag _loc _a1))))))
           | `TyPol (_a0,_a1,_a2) ->
               `App
                 (_loc, (`Vrn (_loc, "TyPol")),
                   (`Par
               ...
               `App
                 (_loc, (`Vrn (_loc, "TyPolEnd")),
                   (`Par
                      (_loc,
                        (`Com
                           (_loc, (self#loc _loc _a0), (self#ctyp _loc _a1))))))
               ...
               `App
                 (_loc, (`Vrn (_loc, "Package")),
                   (`Par
                      (_loc,
                        (`Com
                           (_loc, (self#loc _loc _a0), (self#mtyp _loc _a1))))))
           | #ant as _a0 -> (self#ant _loc _a0 :> Astf.ep))
               ...
               `App
                 (_loc, (`Vrn (_loc, "Par")),
                   (`Par
                      (_loc,
                        (`Com
                           (_loc, (self#loc _loc _a0), (self#pat _loc _a1))))))
           | #any as _a0 -> (self#any _loc _a0 :> Astf.ep)
           | `Record (_a0,_a1) ->
               `App
                 (_loc, (`Vrn (_loc, "Record")),
    ...
    method exp : 'loc -> exp -> Astf.ep=
      ...
      | _loc ->
          (function
               ...
               `App
                 (_loc, (`Vrn (_loc, "Par")),
                   (`Par
                      (_loc,
                        (`Com
                           (_loc, (self#loc _loc _a0), (self#exp _loc _a1))))))
           | #any as _a0 -> (self#any _loc _a0 :> Astf.ep)
           | `Record (_a0,_a1) ->
               `App
                 (_loc, (`Vrn (_loc, "Record")),
               ...
               `App
                 (_loc, (`Vrn (_loc, "Fun")),
                   (`Par
                      (_loc,
                        (`Com
                           (_loc, (self#loc _loc _a0), (self#case _loc _a1))))))
           ...
           | `OvrInstEmpty _a0 ->
               `App
                 (_loc, (`Vrn (_loc, "OvrInstEmpty")), (self#loc _loc _a0))
           | `Seq (_a0,_a1) ->
               `App
                 (_loc, (`Vrn (_loc, "Seq")),
                   (`Par
               ...
               `App
                 (_loc, (`Vrn (_loc, "Package_exp")),
                   (`Par
                      (_loc,
                        (`Com
                           (_loc, (self#loc _loc _a0), (self#mexp _loc _a1)))))))
               ...
               `App
                 (_loc, (`Vrn (_loc, "Sig")),
                   (`Par
                      (_loc,
                        (`Com
                           (_loc, (self#loc _loc _a0), (self#sigi _loc _a1))))))
           | `SigEnd _a0 ->
               ...
               `App
                 (_loc, (`Vrn (_loc, "RecModule")),
                   (`Par
                      (_loc,
                        (`Com
                           (_loc, (self#loc _loc _a0), (self#mbind _loc _a1))))))
           | #ant as _a0 -> (self#ant _loc _a0 :> Astf.ep))
               ...
               `App
                 (_loc, (`Vrn (_loc, "Struct")),
                   (`Par
                      (_loc,
                        (`Com
                           (_loc, (self#loc _loc _a0), (self#stru _loc _a1))))))
           | `StructEnd _a0 ->
               ...
               `App
                 (_loc, (`Vrn (_loc, "SigInherit")),
                   (`Par
                      (_loc,
                        (`Com
                           (_loc, (self#loc _loc _a0), (self#cltyp _loc _a1))))))
