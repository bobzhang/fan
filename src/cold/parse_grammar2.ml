...
let _ =
  let d = Ns.lang in
  Ast_quotation.of_exp ~name:(d, "extend2") ~entry:extend_body ();
  Ast_quotation.of_exp ~name:(d, "unsafe_extend2") ~entry:unsafe_extend_body
    ();
  Ast_quotation.of_stru ~name:(d, "create2") ~entry:nonterminals ();
  Ast_quotation.of_stru ~name:(d, "new2") ~entry:newterminals ();
  Ast_quotation.of_exp ~name:(d, "clear2") ~entry:nonterminalsclear ()