...
let _ =
  let a: 'a Gramf.t = Gramf.mk "a"
  and n: 'n Gramf.t = Gramf.mk "n" in
  Gramf.extend_single
    ({
       entry = (a : 'a Gramf.t);
       olevel =
...
let () =
  ...
  add { domain; name = "str" } Dyn_tag.exp
    (function
     | _loc -> (function | _loc_option -> (function | s -> `Str (_loc, s))));
  add { domain; name = "str" } Dyn_tag.stru
    (function
     | _loc ->
         (function
          | _loc_option -> (function | s -> `StExp (_loc, (`Str (_loc, s))))))
