...
let _ =
  ...
  add_quotation { domains; name = "rec_exp'" } rec_exp_quot
  ...
  add_quotation { domains; name = "mbind'" } mbind_quot
    ~mexp:(Filters.me#mbind) ~mpat:(Filters.mp#mbind) ~exp_filter ~pat_filter;
  add_quotation { domains; name = "ident'" } ident_quot
    ~mexp:(Filters.me#ident) ~mpat:(Filters.mp#ident) ~exp_filter ~pat_filter;
  add_quotation { domains; name = "rec_flag'" } rec_flag_quot
  ...
  add_quotation { domains; name = "or_ctyp'" } constructor_declarations
    ...
    ~pat_filter;
  add_quotation { domains; name = "row_field'" } row_field
...
let pfilter str e =
  ...
  (`Constraint
    ...
    Astf.pat )
let _ =
  add_quotation { domains; name = "sigi-" } sigi_quot
  ...
  add_quotation { domains; name = "stru-" } stru_quot
  ...
  add_quotation { domains; name = "ctyp-" } ctyp_quot
  ...
  add_quotation { domains; name = "pat-" } pat_quot
  ...
  add_quotation { domains; name = "ep-" } exp_quot
  ...
  add_quotation { domains; name = "mtyp-" } mtyp_quot
  ...
  add_quotation { domains; name = "mexp-" } mexp_quot
  ...
  add_quotation { domains; name = "constr-" } constr_quot
    ...
    ~exp_filter:(efilter "constr") ~pat_filter:(pfilter "constr");
  add_quotation { domains; name = "bind-" } bind_quot
  ...
  add_quotation { domains; name = "rec_exp-" } rec_exp_quot
    ...
    ~exp_filter:(efilter "rec_exp") ~pat_filter:(pfilter "rec_exp");
  add_quotation { domains; name = "case-" } case_quot
...
let () = of_exp ~name:{ domains; name = "p" } ~entry:p ()
...
let () = of_stru ~name:{ domains; name = "import" } ~entry:import ()
let () =
