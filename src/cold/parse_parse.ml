...
let symbol: Gram_def.symbol Gram_def.decorate list list Gramf.t =
...
let simple: Gram_def.symbol Gram_def.decorate list list Gramf.t =
                           ...
                           Listf.concat_map
                             (fun
                                ...
                                List.map
                                  (fun
                                     (zs :
                                       Gram_def.symbol Gram_def.decorate list)
                                      ->
                                     (List.map
                                        (fun
                                           (z :
