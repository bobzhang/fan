            ...
            fn =
              (Gramf.mk_action
                 (fun (__fan_0 : Tokenf.txt)  (_loc : Locf.t)  ->
                    ...
                    ((`Int (_loc, level) : Astf.exp ) : 'a_int ) : Tokenf.txt
                                                                    ->
                                                                    Locf.t ->
                                                                    'a_int ))
          };
    ...
    ({
       ...
       productions =
         ...
         };
         {
           ...
           fn =
             (Gramf.mk_action
                (fun _  (__fan_4 : Tokenf.txt)  _  (__fan_2 : Tokenf.ant)  _ 
                   (__fan_0 : Tokenf.txt)  (_loc : Locf.t)  ->
                   let v = __fan_0.txt in
                   let x = __fan_2 in
                   let xloc = __fan_4.loc in
         ...
         [{
            ...
            fn =
              (Gramf.mk_action
                 (fun (__fan_0 : Tokenf.txt)  (_loc : Locf.t)  ->
                    let x = __fan_0.txt in
                    ((`Int (_loc, x) : Astf.exp ) : 'position ) : Tokenf.txt
                                                                    ->
                                                                    Locf.t ->
                                                                    'position ))
          };
       ...
       productions =
          ...
          };
         {
           ...
           fn =
             (Gramf.mk_action
                (fun _  (_loc : Locf.t)  ->
                   ((`Lid (_loc, "false") : Astf.exp ) : 'assoc ) : Tokenf.txt
                                                                    ->
                                                                    Locf.t ->
                                                                    'assoc ))
         };
         {
           ...
           fn =
             (Gramf.mk_action
                (fun _  (_loc : Locf.t)  ->
                   ((`Lid (_loc, "true") : Astf.exp ) : 'assoc ) : Tokenf.txt
                                                                    ->
                                                                    Locf.t ->
                                                                    'assoc ))
         };
