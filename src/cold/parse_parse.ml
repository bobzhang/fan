...
let left_rule: outer_symbol list Gramf.t = Gramf.mk_dynamic g "left_rule"
...
let symbol: Gram_def.symbol Gram_def.decorate list Gramf.t =
  Gramf.mk_dynamic g "symbol"
let rule = Gramf.mk_dynamic g "rule"
let meta_rule = Gramf.mk_dynamic g "meta_rule"
let rule_list = Gramf.mk_dynamic g "rule_list"
let psymbol: outer_symbol Gramf.t = Gramf.mk_dynamic g "psymbol"
...
let simple: Gram_def.symbol Gram_def.decorate list Gramf.t =
  Gramf.mk_dynamic g "simple"
  ...
  Gramf.extend_single (single_symbol : 'single_symbol Gramf.t )
    (None,
      ((None, None,
         ...
         ([`Keyword "Lid"],
           ("let (pattern,bounds) =\n  match (x, xloc) with\n  | (Some x,Some xloc) -> ([((xloc, x), (Some \"txt\"))], [(xloc, x)])\n  | _ -> ([], []) in\n{\n  text =\n    (`Token\n       (_loc,\n         (`Constraint\n            (_loc,\n              (`Record\n                 (_loc,\n                   (`Sem\n                      (_loc,\n                        (`RecBind\n                           (_loc, (`Lid (_loc, \"pred\")),\n                             (`Fun\n                                (_loc,\n                                  (`Bar\n                                     (_loc,\n                                       (`Case\n                                          (_loc,\n                                            (`App\n                                               (_loc, (`Vrn (_loc, v)),\n                                                 (`Any _loc))),\n                                            (`Lid (_loc, \"true\")))),\n                                       (`Case\n                                          (_loc, (`Any _loc),\n                                            (`Lid (_loc, \"false\")))))))))),\n                        (`RecBind\n                           (_loc, (`Lid (_loc, \"descr\")),\n                             (`Record\n                                (_loc,\n                                  (`Sem\n                                     (_loc,\n                                       (`RecBind\n                                          (_loc, (`Lid (_loc, \"tag\")),\n                                            (`Vrn (_loc, v)))),\n                                       (`Sem\n                                          (_loc,\n                                            (`RecBind\n                                               (_loc, (`Lid (_loc, \"word\")),\n                                                 (`Uid (_loc, \"Any\")))),\n                                            (`RecBind\n                                               (_loc,\n                                                 (`Lid (_loc, \"tag_name\")),\n                                                 (`Str (_loc, v)))))))))))))))),\n              (`Dot (_loc, (`Uid (_loc, \"Tokenf\")), (`Lid (_loc, \"pattern\"))))) : \n         FAst.exp )));\n  styp = (`Dot (_loc, (`Uid (_loc, \"Tokenf\")), (`Lid (_loc, \"txt\"))));\n  pattern;\n  bounds\n}\n",
             (Gramf.mk_action
                (fun ~__fan_0:(__fan_0 : Tokenf.txt)  (_loc : Locf.t)  ->
                   let v = __fan_0.txt in
                   let x = None in
         ...
         ([`Keyword "S"],
           ("{ text = (`Self _loc); styp = (`Self _loc); pattern = []; bounds = [] }\n",
             (Gramf.mk_action
    ...
    (None,
      ((None, None,
         [([`Nterm (Gramf.obj (symbol : 'symbol Gramf.t ))],
            ("{ psymbols = ss; outer_pattern = None }\n",
              (Gramf.mk_action
                 (fun ~__fan_0:(ss : 'symbol)  (_loc : Locf.t)  ->
                    ({ psymbols = ss; outer_pattern = None } : 'psymbol )))));
         ([`Nterm (Gramf.obj (symbol : 'symbol Gramf.t ));
          `Keyword "as";
          `Token
            ({
                       ...
                       (match prod with
                        ...
                        | x::xs ->
                            Listf.concat_map
                              (fun
                                 (y :
                                   Gram_def.osymbol Gram_def.decorate list)
                                  ->
                                 List.map
                                   (fun
                                      (z : Gram_def.symbol Gram_def.decorate)
                                       ->
                                      ({
                                         kind = (z.kind);
                                         txt =
                                      ...
                                      :: y) x.psymbols) (cross xs) : 
                       Gram_def.osymbol Gram_def.decorate list list ) in
                   ...
                   (let rec cross (prod : outer_symbol list) =
                      (match prod with
                       ...
                       | x::xs ->
                           Listf.concat_map
                             (fun
                                (y : Gram_def.osymbol Gram_def.decorate list)
                                 ->
                                List.map
                                  (fun
                                     (z : Gram_def.symbol Gram_def.decorate) 
