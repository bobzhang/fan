...
let symbol: Gram_def.symbol list Gram_def.decorate list Gramf.t =
...
let simple: Gram_def.symbol list Gram_def.decorate list Gramf.t =
  ...
  Gramf.extend_single (single_symbol : 'single_symbol Gramf.t )
    (None,
      ((None, None,
         ...
         ([`Keyword "S"],
           ("{ text = (`Self _loc); styp = (`Self _loc); bounds = [] }\n",
             (Gramf.mk_action
           ...
           ("(fun (txt : Gram_def.symbol)  ->\n   [({ kind = Gram_def.KNormal; txt = [txt] } : Gram_def.symbol list\n                                                  Gram_def.decorate )])\n  {\n    text =\n      (`Token\n         (_loc,\n           (`Constraint\n              (_loc,\n                (`Record\n                   (_loc,\n                     (`Sem\n                        (_loc,\n                          (`RecBind\n                             (_loc, (`Lid (_loc, \"pred\")),\n                               (`Fun\n                                  (_loc,\n                                    (`Bar\n                                       (_loc,\n                                         (`Case\n                                            (_loc,\n                                              (`App\n                                                 (_loc, (`Vrn (_loc, v)),\n                                                   (`Constraint\n                                                      (_loc,\n                                                        (`Record\n                                                           (_loc,\n                                                             (`Sem\n                                                                (_loc,\n                                                                  (`RecBind\n                                                                    (_loc,\n                                                                    (`Lid\n                                                                    (_loc,\n                                                                    \"txt\")),\n                                                                    (`Str\n                                                                    (_loc, x)))),\n                                                                  (`Any _loc))))),\n                                                        (`Dot\n                                                           (_loc,\n                                                             (`Uid\n                                                                (_loc,\n                                                                  \"Tokenf\")),\n                                                             (`Lid\n                                                                (_loc, \"txt\")))))))),\n                                              (`Lid (_loc, \"true\")))),\n                                         (`Case\n                                            (_loc, (`Any _loc),\n                                              (`Lid (_loc, \"false\")))))))))),\n                          (`RecBind\n                             (_loc, (`Lid (_loc, \"descr\")),\n                               (`Record\n                                  (_loc,\n                                    (`Sem\n                                       (_loc,\n                                         (`RecBind\n                                            (_loc, (`Lid (_loc, \"tag\")),\n                                              (`Vrn (_loc, v)))),\n                                         (`Sem\n                                            (_loc,\n                                              (`RecBind\n                                                 (_loc,\n                                                   (`Lid (_loc, \"word\")),\n                                                   (`App\n                                                      (_loc,\n                                                        (`Uid (_loc, \"A\")),\n                                                        (`Str (_loc, x)))))),\n                                              (`RecBind\n                                                 (_loc,\n                                                   (`Lid (_loc, \"tag_name\")),\n                                                   (`Str (_loc, v)))))))))))))))),\n                (`Dot\n                   (_loc, (`Uid (_loc, \"Tokenf\")), (`Lid (_loc, \"pattern\"))))) : \n           FAst.exp )));\n    styp = (`Dot (_loc, (`Uid (_loc, \"Tokenf\")), (`Lid (_loc, \"txt\"))));\n    bounds = []\n  }\n",
             (Gramf.mk_action
                (fun ~__fan_1:(__fan_1 : Tokenf.txt) 
                   ...
                   let x = __fan_1.txt in
                   ((fun (txt : Gram_def.symbol)  ->
                       [({ kind = Gram_def.KNormal; txt = [txt] } : Gram_def.symbol
                                                                    list
                                                                    Gram_def.decorate )])
                      {
                        text =
             ...
             (Gramf.mk_action
                (fun ~__fan_1:(s : 'single_symbol) 
                   ...
                   (let v = (_loc, (s.text)) in
                    ...
                    [{
                       kind = KNormal;
                       txt = [{ text; styp = (s.styp); bounds = (s.bounds) }]
                     }] : 'symbol )))));
         ([`Keyword "PEEK";
          `Nterm (Gramf.obj (single_symbol : 'single_symbol Gramf.t ))],
           ("let v = (_loc, (s.text)) in\nlet text = if p = \"TRY\" then `Try v else `Peek v in\n[{ kind = KNormal; txt = [{ text; styp = (s.styp); bounds = (s.bounds) }] }]\n",
