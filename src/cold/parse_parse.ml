         ...
         ({
            ...
            productions =
              ...
              };
              {
                ...
                fn =
                  (Gramf.mk_action
                     (fun (__fan_2 : Tokenf.txt)  _  (n : 'name) 
                        (_loc : Locf.t)  ->
         ...
         ({
            ...
            productions =
              ...
              };
              {
                ...
                fn =
                  (Gramf.mk_action
                     (fun (__fan_4 : Tokenf.txt)  _  (__fan_2 : Tokenf.txt) 
                        _  (xs : Tokenf.txt list)  (_loc : Locf.t)  ->
                        let lloc = __fan_2.loc in
                        let l = __fan_2.txt in
                        let xloc = __fan_4.loc in
         ...
         ({
            ...
            productions =
              ...
              };
              {
                ...
                fn =
                  (Gramf.mk_action
                     (fun _  (__fan_4 : Tokenf.txt)  _ 
                        (__fan_2 : Tokenf.ant)  _  (__fan_0 : Tokenf.txt) 
                        (_loc : Locf.t)  ->
                        let v = __fan_0.txt in
                        let x = __fan_2 in
                        let xloc = __fan_4.loc in
         ...
         ({
            ...
            productions =
              ...
              };
              {
                ...
                fn =
                  (Gramf.mk_action
                     (fun _  (s : 'single_symbol_as list)  _  _ 
                        (_loc : Locf.t)  ->
                        ([{ kind = KNone; txt = s };
                         { kind = KSome; txt = s }] : 'symbol ) : Tokenf.txt
                                                                    ->
                                                                    'single_symbol_as
                                                                    list ->
                                                                    Tokenf.txt
         ...
         ({
            ...
            productions =
              [{
                 ...
                 fn =
                   (Gramf.mk_action
                      (fun (ss : 'symbol)  (_loc : Locf.t)  ->
                         (ss : 'psymbol ) : 'symbol -> Locf.t -> 'psymbol ))
               };
              {
                symbols =
                 ...
                 fn =
                   (Gramf.mk_action
                      (fun _  (t : 't_qualid)  _  (i : 'qualid)  _ 
                         (_loc : Locf.t)  ->
                         (let old = gm () in
                          let () = module_name := t in ((Some i), old) : 
                         'extend_header ) : Tokenf.txt ->
                                              't_qualid ->
                                                Tokenf.txt ->
                                                  'qualid ->
                                                    Tokenf.txt ->
                         ...
                         (let x =
                            ...
                            | Some x ->
                                ...
                                (match Ast_quotation.resolve_name
                                 ...
                                 | None  ->
                                     Locf.failf x.loc
                                       "lang `%s' not resolved" x.txt
                                 | Some x ->
                                     (Ast_quotation.default := (Some x);
                                      `name old))
                            | None  -> `non in
         ...
         ({
            ...
            productions =
               ...
               };
              {
                ...
                fn =
                  (Gramf.mk_action
                     (fun (rules : 'rule_list)  (assoc : 'assoc) 
                        (_loc : Locf.t)  ->
                                              ...
                                              (fun
                                                 (zs :
                                                   Gram_def.osymbol list
                                                     Gram_def.decorate)
                                                  -> zs :: acc)))) : 
                            Gram_def.osymbol list Gram_def.decorate list list ) in
                          let (action :Gram_def.action)=
                            match action with | None  -> E None | Some v -> v in
         ...
         ({
            ...
            productions =
               ...
               };
              {
                ...
                fn =
                  (Gramf.mk_action
                     (fun (xs : 'left_rule)  _  (x : 'psymbol) 
                        (_loc : Locf.t)  -> (x :: xs : 'left_rule ) : 
                     'left_rule ->
                       Tokenf.txt -> 'psymbol -> Locf.t -> 'left_rule ))
              };
              {
                symbols = [];
                annot = "[]\n";
