                 ...
                 fn =
                   (Gramf.mk_action
                      (fun (pcl : 'parser_case_list)  (_loc : Locf.t)  ->
                         ...
                         (match n with
                          | Some o ->
                              Ref.protect Compile_stream.grammar_module_name
                                o (fun _  -> cparser _loc pcl)
            ...
            productions =
              [{
                 symbols =
                   ...
                   List0sep
                     ((Nterm
                         (Gramf.obj (parser_case : 'parser_case Gramf.t ))),
                       (Token
                          ({
                             descr =
                               { tag = `Key; word = (A "|"); tag_name = "Key"
            ...
            productions =
              [{
                 symbols =
                   [Nterm
                      (Gramf.obj
                         (stream_pat_comp : 'stream_pat_comp Gramf.t ))];
                 annot = "[(spc, None)]\n";
                 fn =
                   (Gramf.mk_action
                ...
                fn =
                  (Gramf.mk_action
                     (fun (sp : 'stream_pat_comp_err_list)  _ 
                        (spc : 'stream_pat_comp)  (_loc : Locf.t)  ->
                        ((spc, None) :: sp : 'stream_pat ) : 'stream_pat_comp_err_list
                                                               ->
                                                               Tokenf.txt ->
                                                                 'stream_pat_comp
                                                                   ->
              ...
              [{
                 ...
                 fn =
                   (Gramf.mk_action
                      ...
                      'exp ->
                        Tokenf.txt -> 'pat -> Locf.t -> 'stream_pat_comp ))
               };
              {
            ...
            productions =
              ...
              };
              {
                ...
                fn =
                  (Gramf.mk_action
                     (fun (sp : 'stream_pat_comp_err_list)  _ 
                        (spc : 'stream_pat_comp_err)  (_loc : Locf.t)  ->
                        (spc :: sp : 'stream_pat_comp_err_list ) : 'stream_pat_comp_err_list
                                                                    ->
                                                                    Tokenf.txt
                                                                    ->
                                                                    'stream_pat_comp_err
