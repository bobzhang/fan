     ...
     (None,
       ...
       ((Some "simple"), None,
         ...
         ([`Stoken
           ...
           ("Ast_quotation.expand x FDyn.mexp_tag\n",
             (Fgram.mk_action
                (fun (__fan_0 : [> Ftoken.t])  (_loc : FLoc.t)  ->
                   match __fan_0 with
                   | `Quot x ->
                       (Ast_quotation.expand x FDyn.mexp_tag : 'mexp )
                   | _ -> failwith "Ast_quotation.expand x FDyn.mexp_tag\n"))));
         ([`Snterm
            ...
            ("`And (_loc, b1, b2)\n",
              (Fgram.mk_action
                 (fun (b2 : 'mbind_quot)  _  (b1 : 'mbind_quot) 
                    (_loc : FLoc.t)  -> (`And (_loc, b1, b2) : 'mbind_quot )))));
         ([`Stoken
             (((function | `Ant (("mbind"|""),_) -> true | _ -> false)),
               (`App
                  ((`App ((`Vrn "Ant"), (`Bar ((`Str "mbind"), (`Str ""))))),
                    `Any)), "`Ant (\"mbind\"| \"\",_)")],
     ...
     (None,
       (None, None,
         ...
         ([`Stoken
             (((function | `Quot _ -> true | _ -> false)),
               (`App ((`Vrn "Quot"), `Any)), "`Quot _")],
           ("Ast_quotation.expand x FDyn.mbind_tag\n",
             (Fgram.mk_action
                (fun (__fan_0 : [> Ftoken.t])  (_loc : FLoc.t)  ->
                   match __fan_0 with
                   | `Quot x ->
                       (Ast_quotation.expand x FDyn.mbind_tag : 'mbind )
                   | _ -> failwith "Ast_quotation.expand x FDyn.mbind_tag\n"))));
         ([`Snterm (Fgram.obj (a_uident : 'a_uident Fgram.t ));
          `Skeyword ":";
          `Snterm (Fgram.obj (mtyp : 'mtyp Fgram.t ));
          `Skeyword "=";
           ...
           ("Ast_quotation.expand x FDyn.mbind_tag\n",
             (Fgram.mk_action
                (fun (__fan_0 : [> Ftoken.t])  (_loc : FLoc.t)  ->
                   match __fan_0 with
                   | `Quot x ->
                       (Ast_quotation.expand x FDyn.mbind_tag : 'module_rec_declaration )
                   | _ -> failwith "Ast_quotation.expand x FDyn.mbind_tag\n"))));
         ([`Snterm (Fgram.obj (a_uident : 'a_uident Fgram.t ));
          `Skeyword ":";
          `Snterm (Fgram.obj (mtyp : 'mtyp Fgram.t ))],
     ...
     (None,
       (None, None,
         [([`Snterm (Fgram.obj (constr : 'constr Fgram.t ))],
            ("x\n",
              (Fgram.mk_action
                 (fun (x : 'constr)  (_loc : FLoc.t)  -> (x : 'constr_quot )))))]));
       ...
       (None, None,
         ...
         ([`Stoken
             (((function | `Ant ((""|"constr"),_) -> true | _ -> false)),
               (`App
                  ((`App ((`Vrn "Ant"), (`Bar ((`Str ""), (`Str "constr"))))),
                    `Any)), "`Ant (\"\"| \"constr\",_)")],
         ...
         ([`Stoken
             (((function | `Quot _ -> true | _ -> false)),
               (`App ((`Vrn "Quot"), `Any)), "`Quot _")],
           ("Ast_quotation.expand x FDyn.constr_tag\n",
             (Fgram.mk_action
                (fun (__fan_0 : [> Ftoken.t])  (_loc : FLoc.t)  ->
                   match __fan_0 with
                   | `Quot x ->
                       (Ast_quotation.expand x FDyn.constr_tag : 'constr )
                   | _ -> failwith "Ast_quotation.expand x FDyn.constr_tag\n"))));
         ([`Skeyword "type";
          `Snterm
            (Fgram.obj
           ...
           ("`TypeEq (_loc, t1, t2)\n",
             (Fgram.mk_action
                (fun (t2 : 'ctyp)  _  (t1 : 'type_longident_and_parameters) 
                   _  (_loc : FLoc.t)  -> (`TypeEq (_loc, t1, t2) : 'constr )))));
         ([`Skeyword "type";
          `Snterm
            (Fgram.obj
               (type_longident_and_parameters : 'type_longident_and_parameters
          ...
          `Snterm (Fgram.obj (ctyp : 'ctyp Fgram.t ))],
           ("`TypeEqPriv (_loc, t1, t2)\n",
             (Fgram.mk_action
                (fun (t2 : 'ctyp)  _  _ 
                   (t1 : 'type_longident_and_parameters)  _  (_loc : FLoc.t) 
     ...
     (None,
       ...
       ((Some "simple"), None,
         ...
         ([`Stoken
             (((function | `Quot _ -> true | _ -> false)),
               (`App ((`Vrn "Quot"), `Any)), "`Quot _")],
           ("Ast_quotation.expand x FDyn.mtyp_tag\n",
             (Fgram.mk_action
                (fun (__fan_0 : [> Ftoken.t])  (_loc : FLoc.t)  ->
                   match __fan_0 with
                   | `Quot x ->
                       (Ast_quotation.expand x FDyn.mtyp_tag : 'mtyp )
                   | _ -> failwith "Ast_quotation.expand x FDyn.mtyp_tag\n"))));
         ([`Snterm
             (Fgram.obj
                (module_longident_with_app : 'module_longident_with_app
                                               Fgram.t ))],
     ...
     (None,
       (None, None,
         ...
         ([`Stoken
             (((function | `Quot _ -> true | _ -> false)),
               (`App ((`Vrn "Quot"), `Any)), "`Quot _")],
           ("Ast_quotation.expand x FDyn.sigi_tag\n",
             (Fgram.mk_action
                (fun (__fan_0 : [> Ftoken.t])  (_loc : FLoc.t)  ->
                   match __fan_0 with
                   | `Quot x ->
                       (Ast_quotation.expand x FDyn.sigi_tag : 'sigi )
                   | _ -> failwith "Ast_quotation.expand x FDyn.sigi_tag\n"))));
         ([`Skeyword "exception";
          `Snterm
            (Fgram.obj
         ...
         ([`Skeyword "open";
          ...
          `Snterm (Fgram.obj (module_longident : 'module_longident Fgram.t ))],
           ("`Open (_loc, (`Positive _loc), (i : vid  :>ident))\n",
             (Fgram.mk_action
                (fun (i : 'module_longident)  _  _  (_loc : FLoc.t)  ->
                   (`Open (_loc, (`Positive _loc), (i : vid  :>ident)) : 
                   'sigi )))));
         ([`Skeyword "type";
     ...
     (None,
       (None, None,
         [([`Skeyword "="; `Snterm (Fgram.obj (exp : 'exp Fgram.t ))],
            ("e\n",
              (Fgram.mk_action
                 (fun (e : 'exp)  _  (_loc : FLoc.t)  -> (e : 'cvalue_bind )))));
         ([`Skeyword ":";
          `Skeyword "type";
          `Snterm
     ...
     (None,
             ...
             ("`LetIn (_loc, r, bi, x)\n",
               (Fgram.mk_action
                  (fun (x : 'exp)  _  (bi : 'bind)  (r : 'opt_rec)  _ 
                     (_loc : FLoc.t)  -> (`LetIn (_loc, r, bi, x) : 'exp )))));
          ([`Skeyword "let";
           `Skeyword "module";
           `Snterm (Fgram.obj (a_uident : 'a_uident Fgram.t ));
            ...
            ("`LetModule (_loc, m, mb, e)\n",
              (Fgram.mk_action
                 (fun (e : 'exp)  _  (mb : 'mbind0)  (m : 'a_uident)  _  _ 
                    (_loc : FLoc.t)  -> (`LetModule (_loc, m, mb, e) : 
                    'exp )))));
          ([`Skeyword "let";
           `Skeyword "open";
           `Snterm
           ...
           ("`ObjPat (_loc, p, cst)\n",
             (Fgram.mk_action
                (fun _  (cst : 'class_structure)  _  (p : 'pat)  _  _ 
                   (_loc : FLoc.t)  -> (`ObjPat (_loc, p, cst) : 'exp )))));
         ([`Skeyword "object";
          `Skeyword "(";
          `Snterm (Fgram.obj (pat : 'pat Fgram.t ));
          `Skeyword ")";
       ...
       ((Some "simple"), None,
         [([`Stoken
              (((function | `Quot _ -> true | _ -> false)),
                (`App ((`Vrn "Quot"), `Any)), "`Quot _")],
            ("Ast_quotation.expand x FDyn.exp_tag\n",
              (Fgram.mk_action
                 (fun (__fan_0 : [> Ftoken.t])  (_loc : FLoc.t)  ->
                    match __fan_0 with
                    | `Quot x ->
                        (Ast_quotation.expand x FDyn.exp_tag : 'exp )
                    | _ -> failwith "Ast_quotation.expand x FDyn.exp_tag\n"))));
         ([`Stoken
             (((function
                | `Ant
         ...
         ([`Skeyword "{";
          ...
          `Skeyword "}"],
           ("(`RecordWith (_loc, el, (`Lid (_loc, x))) : FAst.exp )\n",
             (Fgram.mk_action
                (fun _  (el : 'label_exp_list)  _  (__fan_1 : [> Ftoken.t]) 
                   _  (_loc : FLoc.t)  ->
                   match __fan_1 with
                   | `Lid x ->
                       ((`RecordWith (_loc, el, (`Lid (_loc, x))) : FAst.exp ) : 
           ...
           ("`RecordWith (_loc, el, e)\n",
             (Fgram.mk_action
                (fun _  (el : 'label_exp_list)  _  _  (e : 'exp)  _  _ 
                   (_loc : FLoc.t)  -> (`RecordWith (_loc, el, e) : 'exp )))));
         ([`Skeyword "{<"; `Skeyword ">}"],
           ("`OvrInstEmpty _loc\n",
             (Fgram.mk_action
                (fun _  _  (_loc : FLoc.t)  -> (`OvrInstEmpty _loc : 'exp )))));
         ([`Skeyword "{<";
           ...
           ("`Coercion (_loc, e, t, t2)\n",
             (Fgram.mk_action
                (fun _  (t2 : 'ctyp)  _  (t : 'ctyp)  _  (e : 'exp)  _ 
                   (_loc : FLoc.t)  -> (`Coercion (_loc, e, t, t2) : 
                   'exp )))));
         ([`Skeyword "(";
          `Sself;
          `Skeyword ":>";
     ...
     (None,
       (None, None,
         [([`Skeyword "&"],
            ("`Lid (_loc, \"&\")\n",
              (Fgram.mk_action
                 (fun _  (_loc : FLoc.t)  -> (`Lid (_loc, "&") : 'infixop1 )))));
         ([`Skeyword "&&"],
           ("`Lid (_loc, \"&&\")\n",
             (Fgram.mk_action
                (fun _  (_loc : FLoc.t)  -> (`Lid (_loc, "&&") : 'infixop1 )))))]));
     ...
     (None,
       (None, None,
         [([`Skeyword "or"],
            ("`Lid (_loc, \"or\")\n",
              (Fgram.mk_action
                 (fun _  (_loc : FLoc.t)  -> (`Lid (_loc, "or") : 'infixop0 )))));
         ([`Skeyword "||"],
           ("`Lid (_loc, \"||\")\n",
             (Fgram.mk_action
                (fun _  (_loc : FLoc.t)  -> (`Lid (_loc, "||") : 'infixop0 )))))]));
            ...
            ("`Com (_loc, e1, e2)\n",
              (Fgram.mk_action
                 (fun (e2 : 'comma_exp)  _  (e1 : 'comma_exp) 
                    (_loc : FLoc.t)  -> (`Com (_loc, e1, e2) : 'comma_exp )))));
         ([`Snterm (Fgram.obj (exp : 'exp Fgram.t ))],
           ("e\n",
             (Fgram.mk_action
           ...
           ("`CaseWhen (_loc, p, w, e)\n",
             (Fgram.mk_action
                (fun (e : 'exp)  _  (w : 'exp)  _  (p : 'pat_as_pat_opt) 
                   (_loc : FLoc.t)  -> (`CaseWhen (_loc, p, w, e) : 'case0 )))));
         ([`Snterm (Fgram.obj (pat_as_pat_opt : 'pat_as_pat_opt Fgram.t ));
          `Skeyword "->";
          `Snterm (Fgram.obj (exp : 'exp Fgram.t ))],
           ("`Case (_loc, p, e)\n",
     ...
     (None,
       (None, None,
         ...
         ([`Snterm (Fgram.obj (pat : 'pat Fgram.t ))],
           ("p\n",
             (Fgram.mk_action
                (fun (p : 'pat)  (_loc : FLoc.t)  -> (p : 'pat_as_pat_opt )))))]));
     ...
     (None,
       ...
       ((Some "simple"), None,
         ...
         ([`Stoken
             (((function | `Quot _ -> true | _ -> false)),
               (`App ((`Vrn "Quot"), `Any)), "`Quot _")],
           ("Ast_quotation.expand x FDyn.pat_tag\n",
             (Fgram.mk_action
                (fun (__fan_0 : [> Ftoken.t])  (_loc : FLoc.t)  ->
                   match __fan_0 with
                   | `Quot x -> (Ast_quotation.expand x FDyn.pat_tag : 'pat )
                   | _ -> failwith "Ast_quotation.expand x FDyn.pat_tag\n"))));
         ([`Skeyword "_"],
           ("(`Any _loc : FAst.pat )\n",
             (Fgram.mk_action
           ...
           ("Ast_quotation.expand x FDyn.pat_tag\n",
             (Fgram.mk_action
                (fun (__fan_0 : [> Ftoken.t])  (_loc : FLoc.t)  ->
                   match __fan_0 with
                   | `Quot x ->
                       (Ast_quotation.expand x FDyn.pat_tag : 'ipat )
                   | _ -> failwith "Ast_quotation.expand x FDyn.pat_tag\n"))));
         ([`Skeyword "`"; `Snterm (Fgram.obj (luident : 'luident Fgram.t ))],
           ("(`Vrn (_loc, s) : FAst.pat )\n",
             (Fgram.mk_action
           ...
           ("`Apply (_loc, i, j)\n",
             (Fgram.mk_action
                (fun _  (j : 'ident_quot)  (i : 'ident_quot)  _ 
                   (_loc : FLoc.t)  -> (`Apply (_loc, i, j) : 'ident_quot )))))])]);
     ...
     (None,
       (None, None,
         [([`Snterm (Fgram.obj (ident : 'ident Fgram.t ))],
            ("x\n",
              (Fgram.mk_action
                 (fun (x : 'ident)  (_loc : FLoc.t)  -> (x : 'val_longident )))))]));
         ...
         ([`Skeyword "method";
          `Stoken
            (((function | `Ant ((""|"override"),_) -> true | _ -> false)),
              (`App
                 ((`App ((`Vrn "Ant"), (`Bar ((`Str ""), (`Str "override"))))),
                   `Any)), "`Ant (\"\"| \"override\",_)")],
     ...
     (None,
       (None, None,
         [([`Skeyword "private"],
            ("`Positive _loc\n",
              (Fgram.mk_action
                 (fun _  (_loc : FLoc.t)  -> (`Positive _loc : 'opt_private )))));
         ([`Stoken
     ...
     (None,
       (None, None,
         [([`Skeyword "mutable"],
            ("`Positive _loc\n",
              (Fgram.mk_action
                 (fun _  (_loc : FLoc.t)  -> (`Positive _loc : 'opt_mutable )))));
         ([`Stoken
     ...
     (None,
       (None, None,
         [([`Skeyword "virtual"],
            ("`Positive _loc\n",
              (Fgram.mk_action
                 (fun _  (_loc : FLoc.t)  -> (`Positive _loc : 'opt_virtual )))));
         ([`Stoken
     ...
     (None,
       (None, None,
         [([`Skeyword ".."],
            ("`Positive _loc\n",
              (Fgram.mk_action
                 (fun _  (_loc : FLoc.t)  -> (`Positive _loc : 'opt_dot_dot )))));
         ([`Stoken
             (((function | `Ant ("..",_) -> true | _ -> false)),
               (`App ((`App ((`Vrn "Ant"), (`Str ".."))), `Any)),
               "`Ant (\"..\",_)")],
     ...
     (None,
       [((Some "top"), None,
            ...
            ("`TypeWith (_loc, t, ns)\n",
              (Fgram.mk_action
                 (fun _  (ns : 'string_list)  _  _  (t : 'type_declaration) 
                    _  (_loc : FLoc.t)  -> (`TypeWith (_loc, t, ns) : 
                    'stru )))));
          ([`Skeyword "let";
           `Snterm (Fgram.obj (opt_rec : 'opt_rec Fgram.t ));
           `Snterm (Fgram.obj (bind : 'bind Fgram.t ));
          ...
          ([`Stoken
              (((function | `Quot _ -> true | _ -> false)),
                (`App ((`Vrn "Quot"), `Any)), "`Quot _")],
            ("Ast_quotation.expand x FDyn.stru_tag\n",
              (Fgram.mk_action
                 (fun (__fan_0 : [> Ftoken.t])  (_loc : FLoc.t)  ->
                    match __fan_0 with
                    | `Quot x ->
                        (Ast_quotation.expand x FDyn.stru_tag : 'stru )
                    | _ -> failwith "Ast_quotation.expand x FDyn.stru_tag\n"))));
          ([`Snterm (Fgram.obj (exp : 'exp Fgram.t ))],
            ("`StExp (_loc, e)\n",
              (Fgram.mk_action
                 (fun (e : 'exp)  (_loc : FLoc.t)  ->
     ...
     (None,
       (None, None,
         ...
         ([`Snterm (Fgram.obj (clsigi : 'clsigi Fgram.t ))],
           ("x\n",
             (Fgram.mk_action
                (fun (x : 'clsigi)  (_loc : FLoc.t)  -> (x : 'clsigi_quot )))))]));
     ...
     (None,
       (None, None,
         ...
         ([`Stoken
             (((function | `Quot _ -> true | _ -> false)),
               (`App ((`Vrn "Quot"), `Any)), "`Quot _")],
           ("Ast_quotation.expand x FDyn.clsigi_tag\n",
             (Fgram.mk_action
                (fun (__fan_0 : [> Ftoken.t])  (_loc : FLoc.t)  ->
                   match __fan_0 with
                   | `Quot x ->
                       (Ast_quotation.expand x FDyn.clsigi_tag : 'clsigi )
                   | _ -> failwith "Ast_quotation.expand x FDyn.clsigi_tag\n"))));
         ([`Skeyword "inherit";
     ...
     (None,
       (None, None,
         ...
         ([`Stoken
             (((function | `Quot _ -> true | _ -> false)),
               (`App ((`Vrn "Quot"), `Any)), "`Quot _")],
           ("Ast_quotation.expand x FDyn.clfield_tag\n",
             (Fgram.mk_action
                (fun (__fan_0 : [> Ftoken.t])  (_loc : FLoc.t)  ->
                   match __fan_0 with
                   | `Quot x ->
                       (Ast_quotation.expand x FDyn.clfield_tag : 'clfield )
                   | _ ->
                       failwith "Ast_quotation.expand x FDyn.clfield_tag\n"))));
         ([`Skeyword "inherit";
          `Snterm (Fgram.obj (opt_override : 'opt_override Fgram.t ));
     ...
     (None,
            ...
            ("`LetIn (_loc, rf, bi, ce)\n",
              (Fgram.mk_action
                 (fun (ce : 'clexp)  _  (bi : 'bind)  (rf : 'opt_rec)  _ 
                    (_loc : FLoc.t)  -> (`LetIn (_loc, rf, bi, ce) : 
                    'clexp )))))]);
       ((Some "apply"), (Some `NA),
       ...
       ((Some "simple"), None,
         ...
         ([`Stoken
             (((function | `Quot _ -> true | _ -> false)),
               (`App ((`Vrn "Quot"), `Any)), "`Quot _")],
           ("Ast_quotation.expand x FDyn.clexp_tag\n",
             (Fgram.mk_action
                (fun (__fan_0 : [> Ftoken.t])  (_loc : FLoc.t)  ->
                   match __fan_0 with
                   | `Quot x ->
                       (Ast_quotation.expand x FDyn.clexp_tag : 'clexp )
                   | _ -> failwith "Ast_quotation.expand x FDyn.clexp_tag\n"))));
         ([`Snterm (Fgram.obj (vid : 'vid Fgram.t ));
          `Skeyword "[";
         ...
         ([`Skeyword "("; `Sself; `Skeyword ")"],
           ("ce\n",
             (Fgram.mk_action
                (fun _  (ce : 'clexp)  _  (_loc : FLoc.t)  -> (ce : 'clexp )))))])]));
           ...
           ("`CtFun (_loc, t, ct)\n",
             (Fgram.mk_action
                (fun (ct : 'cltyp_plus)  _  _  (t : 'ctyp)  _ 
                   (_loc : FLoc.t)  -> (`CtFun (_loc, t, ct) : 'cltyp_plus )))));
        ([`Snterm (Fgram.obj (cltyp : 'cltyp Fgram.t ))],
          ("ct\n",
            (Fgram.mk_action
    ...
    (None,
      (None, None,
        ...
        ([`Stoken
            (((function | `Quot _ -> true | _ -> false)),
              (`App ((`Vrn "Quot"), `Any)), "`Quot _")],
          ("Ast_quotation.expand x FDyn.cltyp_tag\n",
            (Fgram.mk_action
               (fun (__fan_0 : [> Ftoken.t])  (_loc : FLoc.t)  ->
                  match __fan_0 with
                  | `Quot x ->
                      (Ast_quotation.expand x FDyn.cltyp_tag : 'cltyp )
                  | _ -> failwith "Ast_quotation.expand x FDyn.cltyp_tag\n"))));
        ([`Snterm (Fgram.obj (vid : 'vid Fgram.t ));
         `Skeyword "[";
         `Snterm (Fgram.obj (comma_ctyp : 'comma_ctyp Fgram.t ));
         `Skeyword "]"],
    ...
    (None,
      (None, None,
        ...
        ([`Stoken
            (((function | `Quot _ -> true | _ -> false)),
              (`App ((`Vrn "Quot"), `Any)), "`Quot _")],
          ("Ast_quotation.expand x FDyn.ctyp_tag\n",
            (Fgram.mk_action
               (fun (__fan_0 : [> Ftoken.t])  (_loc : FLoc.t)  ->
                  match __fan_0 with
                  | `Quot x ->
                      (Ast_quotation.expand x FDyn.ctyp_tag : 'unquoted_typevars )
                  | _ -> failwith "Ast_quotation.expand x FDyn.ctyp_tag\n"))));
        ([`Snterm (Fgram.obj (a_lident : 'a_lident Fgram.t ))],
          ("(i :>ctyp)\n",
            (Fgram.mk_action
               (fun (i : 'a_lident)  (_loc : FLoc.t)  ->
          ...
          ("Ast_quotation.expand x FDyn.ctyp_tag\n",
            (Fgram.mk_action
               (fun (__fan_0 : [> Ftoken.t])  (_loc : FLoc.t)  ->
                  match __fan_0 with
                  | `Quot x ->
                      (Ast_quotation.expand x FDyn.ctyp_tag : 'typevars )
                  | _ -> failwith "Ast_quotation.expand x FDyn.ctyp_tag\n"))));
        ([`Skeyword "'"; `Snterm (Fgram.obj (a_lident : 'a_lident Fgram.t ))],
          ("`Quote (_loc, (`Normal _loc), i)\n",
            (Fgram.mk_action
          ...
          ("Ast_quotation.expand x FDyn.ctyp_tag\n",
            (Fgram.mk_action
               (fun (__fan_0 : [> Ftoken.t])  (_loc : FLoc.t)  ->
                  match __fan_0 with
                  | `Quot x ->
                      (Ast_quotation.expand x FDyn.ctyp_tag : 'ctyp )
                  | _ -> failwith "Ast_quotation.expand x FDyn.ctyp_tag\n"))));
        ([`Snterm (Fgram.obj (a_uident : 'a_uident Fgram.t ));
         `Skeyword ".";
         `Sself],
          ...
          ("`PolyInfSup (_loc, rfl, ntl)\n",
            (Fgram.mk_action
               (fun _  (ntl : 'name_tags)  _  (rfl : 'row_field)  _ 
                  (_loc : FLoc.t)  -> (`PolyInfSup (_loc, rfl, ntl) : 
                  'ctyp )))));
        ([`Skeyword "#";
         `Snterm (Fgram.obj (class_longident : 'class_longident Fgram.t ))],
          ("`ClassPath (_loc, i)\n",
