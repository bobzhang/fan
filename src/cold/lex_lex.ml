...
let rec token: Lexing.lexbuf -> Tokenf.t =
  fun (lexbuf : Lexing.lexbuf)  ->
    ...
    and __ocaml_lex_state0 (lexbuf : Lexing.lexbuf) =
      ...
      | 9|12|32 -> __ocaml_lex_state13 lexbuf
      ...
      | 35|41|42|43|60|61|63|64|91|93|124 -> __ocaml_lex_state4 lexbuf
      | 39 -> __ocaml_lex_state8 lexbuf
      | 40 -> __ocaml_lex_state5 lexbuf
      | 34 -> __ocaml_lex_state7 lexbuf
      | 94 -> __ocaml_lex_state10 lexbuf
      | 10 -> __ocaml_lex_state12 lexbuf
      | 256 -> __ocaml_lex_state2 lexbuf
      | _ -> __ocaml_lex_state1 lexbuf
    and __ocaml_lex_state1 (lexbuf : Lexing.lexbuf) = 12
    and __ocaml_lex_state2 (lexbuf : Lexing.lexbuf) = 11
    and __ocaml_lex_state3 (lexbuf : Lexing.lexbuf) =
      ...
      (match __ocaml_lex_next_char lexbuf with
       | 46 -> __ocaml_lex_state32 lexbuf
       | 123 -> __ocaml_lex_state28 lexbuf
       | 64 ->
    ...
    and __ocaml_lex_state4 (lexbuf : Lexing.lexbuf) = 8
    ...
    and __ocaml_lex_state6 (lexbuf : Lexing.lexbuf) =
      ...
      (match __ocaml_lex_next_char lexbuf with
       ...
       | _ ->
           (lexbuf.Lexing.lex_curr_pos <- lexbuf.Lexing.lex_last_pos;
            lexbuf.Lexing.lex_last_action))
    and __ocaml_lex_state7 (lexbuf : Lexing.lexbuf) = 7
    and __ocaml_lex_state8 (lexbuf : Lexing.lexbuf) =
      lexbuf.Lexing.lex_last_pos <- lexbuf.Lexing.lex_curr_pos;
      lexbuf.Lexing.lex_last_action <- 12;
      (match __ocaml_lex_next_char lexbuf with
       | 10 -> __ocaml_lex_state17 lexbuf
       | 256 ->
           (lexbuf.Lexing.lex_curr_pos <- lexbuf.Lexing.lex_last_pos;
            lexbuf.Lexing.lex_last_action)
       | 13 -> __ocaml_lex_state16 lexbuf
       | 92 -> __ocaml_lex_state14 lexbuf
       | _ -> __ocaml_lex_state15 lexbuf)
    ...
    and __ocaml_lex_state11 (lexbuf : Lexing.lexbuf) =
      ...
      (match __ocaml_lex_next_char lexbuf with
       ...
       | _ ->
           (lexbuf.Lexing.lex_curr_pos <- lexbuf.Lexing.lex_last_pos;
            lexbuf.Lexing.lex_last_action))
    and __ocaml_lex_state12 (lexbuf : Lexing.lexbuf) = 1
    ...
    and __ocaml_lex_state14 (lexbuf : Lexing.lexbuf) =
      ...
      | 32|34|39|92|98|110|114|116 -> __ocaml_lex_state23 lexbuf
      | 256 ->
          (lexbuf.Lexing.lex_curr_pos <- lexbuf.Lexing.lex_last_pos;
           lexbuf.Lexing.lex_last_action)
    ...
    and __ocaml_lex_state20 (lexbuf : Lexing.lexbuf) = 6
    ...
    and __ocaml_lex_state30 (lexbuf : Lexing.lexbuf) =
      match __ocaml_lex_next_char lexbuf with
      | 123 -> __ocaml_lex_state33 lexbuf
      | 39
        |45
         |48
          |49
