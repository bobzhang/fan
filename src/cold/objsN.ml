...
let pp_print_loc: Format.formatter -> loc -> unit =
  function | fmt -> (function | _a0 -> Locf.pp_print_t fmt _a0)
...
let pp_print_literal: Format.formatter -> literal -> unit =
  ...
  | fmt ->
      (function
       | `Chr _a0 ->
           Format.fprintf fmt "@[<1>(`Chr@ %a)@]" pp_print_string _a0
       | `Int _a0 ->
           Format.fprintf fmt "@[<1>(`Int@ %a)@]" pp_print_string _a0
       | `Int32 _a0 ->
           Format.fprintf fmt "@[<1>(`Int32@ %a)@]" pp_print_string _a0
       | `Int64 _a0 ->
           Format.fprintf fmt "@[<1>(`Int64@ %a)@]" pp_print_string _a0
       | `Flo _a0 ->
           Format.fprintf fmt "@[<1>(`Flo@ %a)@]" pp_print_string _a0
       | `Nativeint _a0 ->
           Format.fprintf fmt "@[<1>(`Nativeint@ %a)@]" pp_print_string _a0
       | `Str _a0 ->
           Format.fprintf fmt "@[<1>(`Str@ %a)@]" pp_print_string _a0
       | `Bool _a0 ->
           Format.fprintf fmt "@[<1>(`Bool@ %a)@]" pp_print_bool _a0
...
let pp_print_auident: Format.formatter -> auident -> unit =
  ...
  | fmt ->
      (function
       | `Uid _a0 ->
           Format.fprintf fmt "@[<1>(`Uid@ %a)@]" pp_print_string _a0
       | #ant as _a0 -> (pp_print_ant fmt _a0 :> unit))
...
let pp_print_any: Format.formatter -> any -> unit =
  function | fmt -> (function | `Any -> Format.fprintf fmt "`Any")
      ...
      (function
       ...
       | `TyCol (_a0,_a1) ->
           Format.fprintf fmt "@[<1>(`TyCol@ %a@ %a)@]" pp_print_alident _a0
             pp_print_ctyp _a1
       | `TyColMut (_a0,_a1) ->
           Format.fprintf fmt "@[<1>(`TyColMut@ %a@ %a)@]" pp_print_alident
             _a0 pp_print_ctyp _a1
       | #ant as _a0 -> (pp_print_ant fmt _a0 :> unit))
      ...
      (function
       ...
       | `App (_a0,_a1) ->
           Format.fprintf fmt "@[<1>(`App@ %a@ %a)@]" pp_print_pat _a0
             pp_print_pat _a1
       | `Vrn _a0 ->
           Format.fprintf fmt "@[<1>(`Vrn@ %a)@]" pp_print_string _a0
       | `Com (_a0,_a1) ->
  ...
  | fmt ->
      (function
       ...
       | `Type _a0 ->
           Format.fprintf fmt "@[<1>(`Type@ %a)@]" pp_print_typedecl _a0
       | `TypeWith (_a0,_a1) ->
           Format.fprintf fmt "@[<1>(`TypeWith@ %a@ %a)@]" pp_print_typedecl
             _a0 pp_print_strings _a1
       | `Value (_a0,_a1) ->
...
class print =
  object (self : 'self_type)
    ...
    method loc : 'fmt -> loc -> unit=
      function | fmt -> (function | _a0 -> self#locf_t fmt _a0)
    ...
    method literal : 'fmt -> literal -> unit=
      ...
      | fmt ->
          (function
           | `Chr _a0 ->
               Format.fprintf fmt "@[<1>(`Chr@ %a)@]" self#string _a0
           | `Int _a0 ->
               Format.fprintf fmt "@[<1>(`Int@ %a)@]" self#string _a0
           | `Int32 _a0 ->
               Format.fprintf fmt "@[<1>(`Int32@ %a)@]" self#string _a0
           | `Int64 _a0 ->
               Format.fprintf fmt "@[<1>(`Int64@ %a)@]" self#string _a0
           | `Flo _a0 ->
               Format.fprintf fmt "@[<1>(`Flo@ %a)@]" self#string _a0
           | `Nativeint _a0 ->
               Format.fprintf fmt "@[<1>(`Nativeint@ %a)@]" self#string _a0
           | `Str _a0 ->
               Format.fprintf fmt "@[<1>(`Str@ %a)@]" self#string _a0
           | `Bool _a0 ->
               Format.fprintf fmt "@[<1>(`Bool@ %a)@]" self#bool _a0
           | `Unit -> Format.fprintf fmt "`Unit")
    ...
    method auident : 'fmt -> auident -> unit=
      ...
      | fmt ->
          (function
           | `Uid _a0 ->
               Format.fprintf fmt "@[<1>(`Uid@ %a)@]" self#string _a0
           | #ant as _a0 -> (self#ant fmt _a0 :> unit))
    ...
    method vid : 'fmt -> vid -> unit=
      ...
      | fmt ->
          (function
           | `Dot (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`Dot@ %a@ %a)@]" self#vid _a0
                 self#vid _a1
           | `Lid _a0 ->
               Format.fprintf fmt "@[<1>(`Lid@ %a)@]" self#string _a0
           | `Uid _a0 ->
          ...
          (function
           ...
           | `Label (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`Label@ %a@ %a)@]" self#alident _a0
                 self#ctyp _a1
           | `OptLabl (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`OptLabl@ %a@ %a)@]" self#alident
                 _a0 self#ctyp _a1
           | #ident' as _a0 -> (self#ident' fmt _a0 :> unit)
           | `TyObj (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`TyObj@ %a@ %a)@]" self#name_ctyp
                 _a0 self#flag _a1
           | `TyObjEnd _a0 ->
           ...
           | `Quote (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`Quote@ %a@ %a)@]"
                 self#position_flag _a0 self#alident _a1
           | `QuoteAny _a0 ->
           ...
           | `PolyInfSup (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`PolyInfSup@ %a@ %a)@]"
                 self#row_field _a0 self#tag_names _a1
           | `Package _a0 ->
    ...
    method type_parameters : 'fmt -> type_parameters -> unit=
      ...
      | fmt ->
          (function
           | `Com (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`Com@ %a@ %a)@]"
                 self#type_parameters _a0 self#type_parameters _a1
           | `Ctyp _a0 ->
               Format.fprintf fmt "@[<1>(`Ctyp@ %a)@]" self#ctyp _a0
           | #ant as _a0 -> (self#ant fmt _a0 :> unit))
    method row_field : 'fmt -> row_field -> unit=
      ...
      | fmt ->
          (function
           ...
           | `TyVrnOf (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`TyVrnOf@ %a@ %a)@]" self#astring
                 _a0 self#ctyp _a1
           | `Ctyp _a0 ->
               Format.fprintf fmt "@[<1>(`Ctyp@ %a)@]" self#ctyp _a0)
    ...
    method typedecl : 'fmt -> typedecl -> unit=
      ...
      | fmt ->
          (function
           | `TyDcl (_a0,_a1,_a2,_a3) ->
               Format.fprintf fmt "@[<1>(`TyDcl@ %a@ %a@ %a@ %a)@]"
                 self#alident _a0 self#opt_decl_params _a1 self#type_info _a2
                 self#opt_type_constr _a3
           | `TyAbstr (_a0,_a1,_a2) ->
               Format.fprintf fmt "@[<1>(`TyAbstr@ %a@ %a@ %a)@]"
                 self#alident _a0 self#opt_decl_params _a1
                 self#opt_type_constr _a2
           | `And (_a0,_a1) ->
    ...
    method type_constr : 'fmt -> type_constr -> unit=
      ...
      | fmt ->
          (function
           | `And (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`And@ %a@ %a)@]" self#type_constr
                 _a0 self#type_constr _a1
           | `Eq (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`Eq@ %a@ %a)@]" self#ctyp _a0
                 self#ctyp _a1
           | #ant as _a0 -> (self#ant fmt _a0 :> unit))
    ...
    method decl_params : 'fmt -> decl_params -> unit=
      ...
      | fmt ->
          (function
           ...
           | `Any -> Format.fprintf fmt "`Any"
           | `Com (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`Com@ %a@ %a)@]" self#decl_params
                 _a0 self#decl_params _a1
           | #ant as _a0 -> (self#ant fmt _a0 :> unit))
    ...
    method type_repr : 'fmt -> type_repr -> unit=
      ...
      | fmt ->
          (function
           ...
           | `Sum _a0 ->
               Format.fprintf fmt "@[<1>(`Sum@ %a)@]" self#or_ctyp _a0
           | #ant as _a0 -> (self#ant fmt _a0 :> unit))
          ...
          (function
           ...
           | `TyCol (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`TyCol@ %a@ %a)@]" self#alident _a0
                 self#ctyp _a1
           | `TyColMut (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`TyColMut@ %a@ %a)@]" self#alident
                 _a0 self#ctyp _a1
           | #ant as _a0 -> (self#ant fmt _a0 :> unit))
    ...
    method of_ctyp : 'fmt -> of_ctyp -> unit=
      ...
      | fmt ->
          (function
           | `Of (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`Of@ %a@ %a)@]" self#vid _a0
                 self#ctyp _a1
    ...
    method pat : 'fmt -> pat -> unit=
      ...
      | fmt ->
          (function
           | #vid as _a0 -> (self#vid fmt _a0 :> unit)
           | `App (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`App@ %a@ %a)@]" self#pat _a0
                 self#pat _a1
           | `Vrn _a0 ->
               Format.fprintf fmt "@[<1>(`Vrn@ %a)@]" self#string _a0
           | `Com (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`Com@ %a@ %a)@]" self#pat _a0
                 self#pat _a1
           | `Sem (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`Sem@ %a@ %a)@]" self#pat _a0
                 self#pat _a1
           ...
           | `ArrayEmpty -> Format.fprintf fmt "`ArrayEmpty"
           | `Array _a0 ->
               Format.fprintf fmt "@[<1>(`Array@ %a)@]" self#pat _a0
           | `LabelS _a0 ->
           ...
           | `Bar (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`Bar@ %a@ %a)@]" self#pat _a0
                 self#pat _a1
           | `PaRng (_a0,_a1) ->
           ...
           | `ClassPath _a0 ->
               Format.fprintf fmt "@[<1>(`ClassPath@ %a)@]" self#ident _a0
           | `Lazy _a0 ->
               Format.fprintf fmt "@[<1>(`Lazy@ %a)@]" self#pat _a0
           | `ModuleUnpack _a0 ->
               Format.fprintf fmt "@[<1>(`ModuleUnpack@ %a)@]" self#auident
                 _a0
           | `ModuleConstraint (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`ModuleConstraint@ %a@ %a)@]"
    ...
    method exp : 'fmt -> exp -> unit=
      ...
      | fmt ->
          (function
           | #vid as _a0 -> (self#vid fmt _a0 :> unit)
           | `App (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`App@ %a@ %a)@]" self#exp _a0
                 self#exp _a1
           | `Vrn _a0 ->
               Format.fprintf fmt "@[<1>(`Vrn@ %a)@]" self#string _a0
           | `Com (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`Com@ %a@ %a)@]" self#exp _a0
                 self#exp _a1
           | `Sem (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`Sem@ %a@ %a)@]" self#exp _a0
                 self#exp _a1
           ...
           | `ArrayEmpty -> Format.fprintf fmt "`ArrayEmpty"
           | `Array _a0 ->
               Format.fprintf fmt "@[<1>(`Array@ %a)@]" self#exp _a0
           | `Assert _a0 ->
           ...
           | `IfThenElse (_a0,_a1,_a2) ->
               Format.fprintf fmt "@[<1>(`IfThenElse@ %a@ %a@ %a)@]" 
                 self#exp _a0 self#exp _a1 self#exp _a2
           | `IfThen (_a0,_a1) ->
           ...
           | `Label (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`Label@ %a@ %a)@]" self#alident _a0
                 self#exp _a1
           | `Lazy _a0 ->
               Format.fprintf fmt "@[<1>(`Lazy@ %a)@]" self#exp _a0
           | `LetIn (_a0,_a1,_a2) ->
           ...
           | `LetModule (_a0,_a1,_a2) ->
               Format.fprintf fmt "@[<1>(`LetModule@ %a@ %a@ %a)@]"
                 self#auident _a0 self#mexp _a1 self#exp _a2
           | `Match (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`Match@ %a@ %a)@]" self#exp _a0
                 self#case _a1
           | `New _a0 ->
               Format.fprintf fmt "@[<1>(`New@ %a)@]" self#ident _a0
           | `Obj _a0 ->
               Format.fprintf fmt "@[<1>(`Obj@ %a)@]" self#clfield _a0
           | `ObjEnd -> Format.fprintf fmt "`ObjEnd"
           | `ObjPat (_a0,_a1) ->
           ...
           | `StringDot (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`StringDot@ %a@ %a)@]" self#exp _a0
                 self#exp _a1
           | `Try (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`Try@ %a@ %a)@]" self#exp _a0
                 self#case _a1
           | `Constraint (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`Constraint@ %a@ %a)@]" self#exp _a0
                 self#ctyp _a1
           | `Coercion (_a0,_a1,_a2) ->
               Format.fprintf fmt "@[<1>(`Coercion@ %a@ %a@ %a)@]" self#exp
           ...
           | `While (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`While@ %a@ %a)@]" self#exp _a0
                 self#exp _a1
           | `LetOpen (_a0,_a1,_a2) ->
               Format.fprintf fmt "@[<1>(`LetOpen@ %a@ %a@ %a)@]" self#flag
                 _a0 self#ident _a1 self#exp _a2
           | `LocalTypeFun (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`LocalTypeFun@ %a@ %a)@]"
                 self#alident _a0 self#exp _a1
           | `Package_exp _a0 ->
    ...
    method mtyp : 'fmt -> mtyp -> unit=
      ...
      | fmt ->
          (function
           ...
           | `Functor (_a0,_a1,_a2) ->
               Format.fprintf fmt "@[<1>(`Functor@ %a@ %a@ %a)@]"
                 self#auident _a0 self#mtyp _a1 self#mtyp _a2
           | `With (_a0,_a1) ->
    ...
    method sigi : 'fmt -> sigi -> unit=
      ...
      | fmt ->
          (function
           ...
           | `External (_a0,_a1,_a2) ->
               Format.fprintf fmt "@[<1>(`External@ %a@ %a@ %a)@]"
                 self#alident _a0 self#ctyp _a1 self#strings _a2
           | `Type _a0 ->
           ...
           | `Module (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`Module@ %a@ %a)@]" self#auident _a0
                 self#mtyp _a1
           | `ModuleTypeEnd _a0 ->
               Format.fprintf fmt "@[<1>(`ModuleTypeEnd@ %a)@]" self#auident
                 _a0
           | `ModuleType (_a0,_a1) ->
           ...
           | `DirectiveSimple _a0 ->
               Format.fprintf fmt "@[<1>(`DirectiveSimple@ %a)@]"
                 self#alident _a0
           | `Directive (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`Directive@ %a@ %a)@]" self#alident
                 _a0 self#exp _a1
           | `Open (_a0,_a1) ->
          ...
          (function
           ...
           | `ModuleEq (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`ModuleEq@ %a@ %a)@]" self#ident _a0
                 self#ident _a1
           | `TypeEqPriv (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`TypeEqPriv@ %a@ %a)@]" self#ctyp
                 _a0 self#ctyp _a1
           | `TypeSubst (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`TypeSubst@ %a@ %a)@]" self#ctyp _a0
                 self#ctyp _a1
           | `ModuleSubst (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`ModuleSubst@ %a@ %a)@]" self#ident
                 _a0 self#ident _a1
           | `And (_a0,_a1) ->
          ...
          (function
           ...
           | `Case (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`Case@ %a@ %a)@]" self#pat _a0
                 self#exp _a1
           | `CaseWhen (_a0,_a1,_a2) ->
               Format.fprintf fmt "@[<1>(`CaseWhen@ %a@ %a@ %a)@]" self#pat
    ...
    method mexp : 'fmt -> mexp -> unit=
      ...
      | fmt ->
          (function
           ...
           | `StructEnd -> Format.fprintf fmt "`StructEnd"
           | `Constraint (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`Constraint@ %a@ %a)@]" self#mexp
                 _a0 self#mtyp _a1
           | `PackageModule _a0 ->
      ...
      | fmt ->
          (function
           ...
           | `Exception _a0 ->
               Format.fprintf fmt "@[<1>(`Exception@ %a)@]" self#of_ctyp _a0
           | `StExp _a0 ->
               Format.fprintf fmt "@[<1>(`StExp@ %a)@]" self#exp _a0
           | `External (_a0,_a1,_a2) ->
               Format.fprintf fmt "@[<1>(`External@ %a@ %a@ %a)@]"
                 self#alident _a0 self#ctyp _a1 self#strings _a2
           | `Include _a0 ->
           ...
           | `Type _a0 ->
               Format.fprintf fmt "@[<1>(`Type@ %a)@]" self#typedecl _a0
           | `TypeWith (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`TypeWith@ %a@ %a)@]" self#typedecl
                 _a0 self#strings _a1
           | `Value (_a0,_a1) ->
    ...
    method cltdecl : 'fmt -> cltdecl -> unit=
      ...
      | fmt ->
          (function
           ...
           | `CtDecl (_a0,_a1,_a2,_a3) ->
               Format.fprintf fmt "@[<1>(`CtDecl@ %a@ %a@ %a@ %a)@]"
                 self#flag _a0 self#ident _a1 self#type_parameters _a2
                 self#cltyp _a3
           | `CtDeclS (_a0,_a1,_a2) ->
               Format.fprintf fmt "@[<1>(`CtDeclS@ %a@ %a@ %a)@]" self#flag
                 _a0 self#ident _a1 self#cltyp _a2
           | #ant as _a0 -> (self#ant fmt _a0 :> unit))
    method cltyp : 'fmt -> cltyp -> unit=
      ...
      | fmt ->
          (function
           ...
           | `Obj _a0 ->
               Format.fprintf fmt "@[<1>(`Obj@ %a)@]" self#clsigi _a0
           | `ObjEnd -> Format.fprintf fmt "`ObjEnd"
           | `And (_a0,_a1) ->
    ...
    method clsigi : 'fmt -> clsigi -> unit=
      ...
      | fmt ->
          (function
           ...
           | `CgVal (_a0,_a1,_a2,_a3) ->
               Format.fprintf fmt "@[<1>(`CgVal@ %a@ %a@ %a@ %a)@]"
                 self#alident _a0 self#flag _a1 self#flag _a2 self#ctyp _a3
           | `Method (_a0,_a1,_a2) ->
               Format.fprintf fmt "@[<1>(`Method@ %a@ %a@ %a)@]" self#alident
                 _a0 self#flag _a1 self#ctyp _a2
           | `VirMeth (_a0,_a1,_a2) ->
               Format.fprintf fmt "@[<1>(`VirMeth@ %a@ %a@ %a)@]"
                 self#alident _a0 self#flag _a1 self#ctyp _a2
           | `Eq (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`Eq@ %a@ %a)@]" self#ctyp _a0
                 self#ctyp _a1
           | #ant as _a0 -> (self#ant fmt _a0 :> unit))
          ...
          (function
           | `ClDecl (_a0,_a1,_a2,_a3) ->
               Format.fprintf fmt "@[<1>(`ClDecl@ %a@ %a@ %a@ %a)@]"
                 ...
                 self#clexp _a3
           | `ClDeclS (_a0,_a1,_a2) ->
               Format.fprintf fmt "@[<1>(`ClDeclS@ %a@ %a@ %a)@]" self#flag
                 _a0 self#ident _a1 self#clexp _a2
           | `And (_a0,_a1) ->
      ...
      | fmt ->
          (function
           ...
           | `ObjPatEnd _a0 ->
               Format.fprintf fmt "@[<1>(`ObjPatEnd@ %a)@]" self#pat _a0
           | `Constraint (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`Constraint@ %a@ %a)@]" self#clexp
                 _a0 self#cltyp _a1
           | #ant as _a0 -> (self#ant fmt _a0 :> unit))
    ...
    method ep : 'fmt -> ep -> unit=
      ...
      | fmt ->
          (function
           | #vid as _a0 -> (self#vid fmt _a0 :> unit)
           | `App (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`App@ %a@ %a)@]" self#ep _a0 
                 self#ep _a1
           | `Vrn _a0 ->
               Format.fprintf fmt "@[<1>(`Vrn@ %a)@]" self#string _a0
           | `Com (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`Com@ %a@ %a)@]" self#ep _a0 
                 self#ep _a1
           | `Sem (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`Sem@ %a@ %a)@]" self#ep _a0 
                 self#ep _a1
           ...
           | `ArrayEmpty -> Format.fprintf fmt "`ArrayEmpty"
           | `Array _a0 ->
               Format.fprintf fmt "@[<1>(`Array@ %a)@]" self#ep _a0
           | `Record _a0 ->
...
class map =
  object (self : 'self_type)
    inherit  mapbase
    method loc : loc -> loc= function | _a0 -> self#locf_t _a0
    method ant : ant -> ant=
      function
      | `Ant (_a0,_a1) ->
    ...
    method lident : lident -> lident=
      function | `Lid _a0 -> let _a0 = self#string _a0 in `Lid _a0
    ...
    method any : any -> any= function | `Any -> `Any
...
class fold =
  object (self : 'self_type)
    inherit  foldbase
    method loc : loc -> 'self_type= function | _a0 -> self#locf_t _a0
    method ant : ant -> 'self_type=
      function
      | `Ant (_a0,_a1) -> let self = self#loc _a0 in self#tokenf_ant _a1
    ...
    method lident : lident -> 'self_type=
      function | `Lid _a0 -> self#string _a0
    ...
    method dlpath : dlpath -> 'self_type=
      ...
      | #alident as _a0 -> (self#alident _a0 :> 'self_type)
    method any : any -> 'self_type= function | `Any -> self
...
let map_loc =
  ...
  | f ->
      object
        ...
        method! loc = (function | x -> f (super#loc x))
      end
let map_ant =
  function
  | f ->
      object
        inherit  map as super
        method! ant = (function | x -> f (super#ant x))
      end
let map_literal =
  function
  | f ->
      object
        inherit  map as super
        method! literal = (function | x -> f (super#literal x))
      end
let map_flag =
  function
  | f ->
      object
        inherit  map as super
        method! flag = (function | x -> f (super#flag x))
      end
let map_position_flag =
  function
  | f ->
      object
        inherit  map as super
        method! position_flag = (function | x -> f (super#position_flag x))
      end
let map_strings =
  function
  | f ->
      object
        inherit  map as super
        method! strings = (function | x -> f (super#strings x))
      end
let map_lident =
  function
  | f ->
      object
        inherit  map as super
        method! lident = (function | x -> f (super#lident x))
      end
let map_alident =
  function
  | f ->
      object
        inherit  map as super
        method! alident = (function | x -> f (super#alident x))
      end
let map_auident =
  function
  | f ->
      object
        inherit  map as super
        method! auident = (function | x -> f (super#auident x))
      end
let map_aident =
  function
  | f ->
      object
        inherit  map as super
        method! aident = (function | x -> f (super#aident x))
      end
let map_astring =
  function
  | f ->
      object
        inherit  map as super
        method! astring = (function | x -> f (super#astring x))
      end
let map_uident =
  function
  | f ->
      object
        inherit  map as super
        method! uident = (function | x -> f (super#uident x))
      end
let map_ident =
  function
  | f ->
      object
        inherit  map as super
        method! ident = (function | x -> f (super#ident x))
      end
let map_ident' =
  function
  | f ->
...
let map_vid =
  ...
  | f ->
      object
        inherit  map as super
        method! vid = (function | x -> f (super#vid x))
      end
let map_vid' =
  function
  | f ->
...
let map_dupath =
  ...
  | f ->
      object
        inherit  map as super
        method! dupath = (function | x -> f (super#dupath x))
      end
let map_dlpath =
  function
  | f ->
      object
        inherit  map as super
        method! dlpath = (function | x -> f (super#dlpath x))
      end
let map_any =
  function
  | f ->
      object
        inherit  map as super
        method! any = (function | x -> f (super#any x))
      end
let map_ctyp =
  function
  | f ->
      object
        inherit  map as super
        method! ctyp = (function | x -> f (super#ctyp x))
      end
let map_type_parameters =
  function
  | f ->
      object
        inherit  map as super
        method! type_parameters =
          (function | x -> f (super#type_parameters x))
      end
let map_row_field =
  function
  | f ->
      object
        inherit  map as super
        method! row_field = (function | x -> f (super#row_field x))
      end
let map_tag_names =
  function
  | f ->
      object
        inherit  map as super
        method! tag_names = (function | x -> f (super#tag_names x))
      end
let map_typedecl =
  function
  | f ->
      object
        inherit  map as super
        method! typedecl = (function | x -> f (super#typedecl x))
      end
let map_type_constr =
  function
  | f ->
      object
        inherit  map as super
        method! type_constr = (function | x -> f (super#type_constr x))
      end
let map_opt_type_constr =
  function
  | f ->
      object
        inherit  map as super
        method! opt_type_constr =
          (function | x -> f (super#opt_type_constr x))
      end
let map_decl_param =
  function
  | f ->
      object
        inherit  map as super
        method! decl_param = (function | x -> f (super#decl_param x))
      end
let map_decl_params =
  function
  | f ->
      object
        inherit  map as super
        method! decl_params = (function | x -> f (super#decl_params x))
      end
let map_opt_decl_params =
  function
  | f ->
      object
        inherit  map as super
        method! opt_decl_params =
          (function | x -> f (super#opt_decl_params x))
      end
let map_type_info =
  function
  | f ->
      object
        inherit  map as super
        method! type_info = (function | x -> f (super#type_info x))
      end
let map_type_repr =
  function
  | f ->
      object
        inherit  map as super
        method! type_repr = (function | x -> f (super#type_repr x))
      end
let map_name_ctyp =
  function
  | f ->
      object
        inherit  map as super
        method! name_ctyp = (function | x -> f (super#name_ctyp x))
      end
let map_or_ctyp =
  function
  | f ->
      object
        inherit  map as super
        method! or_ctyp = (function | x -> f (super#or_ctyp x))
      end
let map_of_ctyp =
  function
  | f ->
      object
        inherit  map as super
        method! of_ctyp = (function | x -> f (super#of_ctyp x))
      end
let map_pat =
  function
  | f ->
      object
        inherit  map as super
        method! pat = (function | x -> f (super#pat x))
      end
let map_rec_pat =
  function
  | f ->
      object
        inherit  map as super
        method! rec_pat = (function | x -> f (super#rec_pat x))
      end
let map_exp =
  function
  | f ->
      object
        inherit  map as super
        method! exp = (function | x -> f (super#exp x))
      end
let map_rec_exp =
  function
  | f ->
      object
        inherit  map as super
        method! rec_exp = (function | x -> f (super#rec_exp x))
      end
let map_mtyp =
  function
  | f ->
      object
        inherit  map as super
        method! mtyp = (function | x -> f (super#mtyp x))
      end
let map_sigi =
  function
  | f ->
      object
        inherit  map as super
        method! sigi = (function | x -> f (super#sigi x))
      end
let map_mbind =
  function
  | f ->
      object
        inherit  map as super
        method! mbind = (function | x -> f (super#mbind x))
      end
let map_constr =
  function
  | f ->
      object
        inherit  map as super
        method! constr = (function | x -> f (super#constr x))
      end
let map_bind =
  function
  | f ->
      object
        inherit  map as super
        method! bind = (function | x -> f (super#bind x))
      end
let map_case =
  function
  | f ->
      object
        inherit  map as super
        method! case = (function | x -> f (super#case x))
      end
let map_mexp =
  function
  | f ->
      object
        inherit  map as super
        method! mexp = (function | x -> f (super#mexp x))
      end
let map_stru =
  function
  | f ->
      object
        inherit  map as super
        method! stru = (function | x -> f (super#stru x))
      end
let map_cltdecl =
  function
  | f ->
      object
        inherit  map as super
        method! cltdecl = (function | x -> f (super#cltdecl x))
      end
let map_cltyp =
  function
  | f ->
      object
        inherit  map as super
        method! cltyp = (function | x -> f (super#cltyp x))
      end
let map_clsigi =
  function
  | f ->
      object
        inherit  map as super
        method! clsigi = (function | x -> f (super#clsigi x))
      end
let map_cldecl =
  function
  | f ->
      object
        inherit  map as super
        method! cldecl = (function | x -> f (super#cldecl x))
      end
let map_clexp =
  function
  | f ->
      object
        inherit  map as super
        method! clexp = (function | x -> f (super#clexp x))
      end
let map_clfield =
  function
  | f ->
      object
        inherit  map as super
        method! clfield = (function | x -> f (super#clfield x))
      end
let map_ep =
  function
  | f ->
      object
        inherit  map as super
        method! ep = (function | x -> f (super#ep x))
      end
let map_rec_bind =
  function
  | f ->
      object
        inherit  map as super
        method! rec_bind = (function | x -> f (super#rec_bind x))
      end
let dump = new print
