...
let dump = new print
let dump_literal = Util.to_string_of_printer dump#literal
let dump_flag = Util.to_string_of_printer dump#flag
let dump_position_flag = Util.to_string_of_printer dump#position_flag
let dump_strings = Util.to_string_of_printer dump#strings
let dump_lident = Util.to_string_of_printer dump#lident
let dump_alident = Util.to_string_of_printer dump#alident
let dump_auident = Util.to_string_of_printer dump#auident
let dump_aident = Util.to_string_of_printer dump#aident
let dump_astring = Util.to_string_of_printer dump#astring
let dump_uident = Util.to_string_of_printer dump#uident
let dump_ident = Util.to_string_of_printer dump#ident
let dump_ident' = Util.to_string_of_printer dump#ident'
let dump_vid = Util.to_string_of_printer dump#vid
let dump_vid' = Util.to_string_of_printer dump#vid'
let dump_dupath = Util.to_string_of_printer dump#dupath
let dump_dlpath = Util.to_string_of_printer dump#dlpath
let dump_any = Util.to_string_of_printer dump#any
let dump_ctyp = Util.to_string_of_printer dump#ctyp
let dump_type_parameters = Util.to_string_of_printer dump#type_parameters
let dump_row_field = Util.to_string_of_printer dump#row_field
let dump_tag_names = Util.to_string_of_printer dump#tag_names
let dump_typedecl = Util.to_string_of_printer dump#typedecl
let dump_type_constr = Util.to_string_of_printer dump#type_constr
let dump_opt_type_constr = Util.to_string_of_printer dump#opt_type_constr
let dump_decl_param = Util.to_string_of_printer dump#decl_param
let dump_decl_params = Util.to_string_of_printer dump#decl_params
let dump_opt_decl_params = Util.to_string_of_printer dump#opt_decl_params
let dump_type_info = Util.to_string_of_printer dump#type_info
let dump_type_repr = Util.to_string_of_printer dump#type_repr
let dump_name_ctyp = Util.to_string_of_printer dump#name_ctyp
let dump_or_ctyp = Util.to_string_of_printer dump#or_ctyp
let dump_of_ctyp = Util.to_string_of_printer dump#of_ctyp
let dump_pat = Util.to_string_of_printer dump#pat
let dump_rec_pat = Util.to_string_of_printer dump#rec_pat
let dump_exp = Util.to_string_of_printer dump#exp
let dump_rec_exp = Util.to_string_of_printer dump#rec_exp
let dump_mtyp = Util.to_string_of_printer dump#mtyp
let dump_sigi = Util.to_string_of_printer dump#sigi
let dump_mbind = Util.to_string_of_printer dump#mbind
let dump_constr = Util.to_string_of_printer dump#constr
let dump_bind = Util.to_string_of_printer dump#bind
let dump_case = Util.to_string_of_printer dump#case
let dump_mexp = Util.to_string_of_printer dump#mexp
let dump_stru = Util.to_string_of_printer dump#stru
let dump_cltdecl = Util.to_string_of_printer dump#cltdecl
let dump_cltyp = Util.to_string_of_printer dump#cltyp
let dump_clsigi = Util.to_string_of_printer dump#clsigi
let dump_cldecl = Util.to_string_of_printer dump#cldecl
let dump_clexp = Util.to_string_of_printer dump#clexp
let dump_clfield = Util.to_string_of_printer dump#clfield
let dump_ep = Util.to_string_of_printer dump#ep
let dump_rec_bind = Util.to_string_of_printer dump#rec_bind
let wildcarder =
  object (self)
    inherit  map as super
    method! pat =
