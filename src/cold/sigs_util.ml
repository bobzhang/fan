  ...
  fun fmt  eta__011_  ->
    (fun fmt  (_a0,_a1)  ->
       Format.fprintf fmt "@[<1>(%a,@,%a)@]" pp_print_string _a0
         pp_print_decl _a1) fmt eta__011_
and pp_print_and_types: Format.formatter -> and_types -> unit =
  fun fmt  eta__008_  -> pp_print_list pp_print_named_type fmt eta__008_
...
and pp_print_mtyps: Format.formatter -> mtyps -> unit =
  fun fmt  eta__003_  -> pp_print_list pp_print_types fmt eta__003_
