...
let rec eq_ctyp curry__101_ curry__102_ =
  ...
  | (`OptLabl (_a0,_a1,_a2),`OptLabl (_b0,_b1,_b2)) ->
      ((eq_loc _a0 _b0) && (eq_alident _a1 _b1)) && (eq_ctyp _a2 _b2)
  | ((#ident' as _a0),(#ident' as _b0)) -> (eq_ident' _a0 _b0 :>'result51)
...
and eq_pat curry__071_ curry__072_ =
  ...
  | ((#any as _a0),(#any as _b0)) -> (eq_any _a0 _b0 :>'result36)
  | (`Record (_a0,_a1),`Record (_b0,_b1)) ->
      (eq_loc _a0 _b0) && (eq_rec_pat _a1 _b1)
  | ((#literal as _a0),(#literal as _b0)) -> (eq_literal _a0 _b0 :>'result36)
  | (`Alias (_a0,_a1,_a2),`Alias (_b0,_b1,_b2)) ->
...
and eq_exp curry__067_ curry__068_ =
  ...
  | ((#any as _a0),(#any as _b0)) -> (eq_any _a0 _b0 :>'result34)
  | (`Record (_a0,_a1),`Record (_b0,_b1)) ->
      (eq_loc _a0 _b0) && (eq_rec_exp _a1 _b1)
  | ((#literal as _a0),(#literal as _b0)) -> (eq_literal _a0 _b0 :>'result34)
...
let rec eq_ep curry__105_ curry__106_ =
  ...
  | ((#any as _a0),(#any as _b0)) -> (eq_any _a0 _b0 :>'result53)
  | (`ArrayEmpty _a0,`ArrayEmpty _b0) -> eq_loc _a0 _b0
  | (`Array (_a0,_a1),`Array (_b0,_b1)) ->
...
and eq_rec_bind curry__103_ curry__104_ =
  ...
  | ((#any as _a0),(#any as _b0)) -> (eq_any _a0 _b0 :>'result52)
  | ((#ant as _a0),(#ant as _b0)) -> (eq_ant _a0 _b0 :>'result52)
  | (_,_) -> false
