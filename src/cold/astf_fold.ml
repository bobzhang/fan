...
class fold =
  object (self : 'this_type__002_)
    inherit  foldbase
    method loc : loc -> 'this_type__002_=
      fun eta__001_  -> self#locf_t eta__001_
    method ant : ant -> 'this_type__002_=
      fun (`Ant (_a0,_a1))  -> let self = self#loc _a0 in self#tokenf_ant _a1
    method literal : literal -> 'this_type__002_=
      function
    ...
    method flag : flag -> 'this_type__002_=
      function
      | `Positive _a0 -> self#loc _a0
      | `Negative _a0 -> self#loc _a0
      | #ant as _a0 -> (self#ant _a0 :>'this_type__002_)
    method position_flag : position_flag -> 'this_type__002_=
      function
      | `Positive _a0 -> self#loc _a0
      | `Negative _a0 -> self#loc _a0
      | `Normal _a0 -> self#loc _a0
      | #ant as _a0 -> (self#ant _a0 :>'this_type__002_)
    method strings : strings -> 'this_type__002_=
      function
      | `App (_a0,_a1,_a2) ->
      ...
      | `Str (_a0,_a1) -> let self = self#loc _a0 in self#string _a1
      | #ant as _a0 -> (self#ant _a0 :>'this_type__002_)
    method lident : lident -> 'this_type__002_=
      fun (`Lid (_a0,_a1))  -> let self = self#loc _a0 in self#string _a1
    method alident : alident -> 'this_type__002_=
      function
      | `Lid (_a0,_a1) -> let self = self#loc _a0 in self#string _a1
      | #ant as _a0 -> (self#ant _a0 :>'this_type__002_)
    method auident : auident -> 'this_type__002_=
      function
      | `Uid (_a0,_a1) -> let self = self#loc _a0 in self#string _a1
      | #ant as _a0 -> (self#ant _a0 :>'this_type__002_)
    method aident : aident -> 'this_type__002_=
      function
      | #alident as _a0 -> (self#alident _a0 :>'this_type__002_)
      | #auident as _a0 -> (self#auident _a0 :>'this_type__002_)
    method astring : astring -> 'this_type__002_=
      function
      | `C (_a0,_a1) -> let self = self#loc _a0 in self#string _a1
      | #ant as _a0 -> (self#ant _a0 :>'this_type__002_)
    method uident : uident -> 'this_type__002_=
      function
      | `Dot (_a0,_a1,_a2) ->
          let self = self#loc _a0 in
      ...
      | `App (_a0,_a1,_a2) ->
          ...
          let self = self#uident _a1 in self#uident _a2
      | #auident as _a0 -> (self#auident _a0 :>'this_type__002_)
    method ident : ident -> 'this_type__002_=
      function
      | `Dot (_a0,_a1,_a2) ->
          let self = self#loc _a0 in
    ...
    method ident' : ident' -> 'this_type__002_=
      ...
      | `Lid (_a0,_a1) -> let self = self#loc _a0 in self#string _a1
      | `Uid (_a0,_a1) -> let self = self#loc _a0 in self#string _a1
    method vid : vid -> 'this_type__002_=
      function
      | `Dot (_a0,_a1,_a2) ->
    ...
    method vid' : vid' -> 'this_type__002_=
      ...
      | `Lid (_a0,_a1) -> let self = self#loc _a0 in self#string _a1
      | `Uid (_a0,_a1) -> let self = self#loc _a0 in self#string _a1
    method dupath : dupath -> 'this_type__002_=
      function
      | `Dot (_a0,_a1,_a2) ->
          let self = self#loc _a0 in
          let self = self#dupath _a1 in self#dupath _a2
      | #auident as _a0 -> (self#auident _a0 :>'this_type__002_)
    method dlpath : dlpath -> 'this_type__002_=
      function
      | `Dot (_a0,_a1,_a2) ->
          let self = self#loc _a0 in
          let self = self#dupath _a1 in self#alident _a2
      | #alident as _a0 -> (self#alident _a0 :>'this_type__002_)
    method any : any -> 'this_type__002_= fun (`Any _a0)  -> self#loc _a0
    method ctyp : ctyp -> 'this_type__002_=
      function
      | `Alias (_a0,_a1,_a2) ->
          let self = self#loc _a0 in
          let self = self#ctyp _a1 in self#alident _a2
      | #any as _a0 -> (self#any _a0 :>'this_type__002_)
      | `App (_a0,_a1,_a2) ->
          let self = self#loc _a0 in
      ...
      | `OptLabl (_a0,_a1,_a2) ->
          let self = self#loc _a0 in
          let self = self#alident _a1 in self#ctyp _a2
      | #ident' as _a0 -> (self#ident' _a0 :>'this_type__002_)
      | `TyObj (_a0,_a1,_a2) ->
          let self = self#loc _a0 in
      ...
      | #ant as _a0 -> (self#ant _a0 :>'this_type__002_)
    method type_parameters : type_parameters -> 'this_type__002_=
      function
      | `Com (_a0,_a1,_a2) ->
          let self = self#loc _a0 in
      ...
      | #ant as _a0 -> (self#ant _a0 :>'this_type__002_)
    method row_field : row_field -> 'this_type__002_=
      function
      | #ant as _a0 -> (self#ant _a0 :>'this_type__002_)
      | `Bar (_a0,_a1,_a2) ->
          let self = self#loc _a0 in
      ...
      | `Ctyp (_a0,_a1) -> let self = self#loc _a0 in self#ctyp _a1
    method tag_names : tag_names -> 'this_type__002_=
      function
      | #ant as _a0 -> (self#ant _a0 :>'this_type__002_)
      | `App (_a0,_a1,_a2) ->
          let self = self#loc _a0 in
      ...
      | `TyVrn (_a0,_a1) -> let self = self#loc _a0 in self#astring _a1
    method decl : decl -> 'this_type__002_=
      function
      ...
      | #ant as _a0 -> (self#ant _a0 :>'this_type__002_)
    method type_constr : type_constr -> 'this_type__002_=
      function
      | `And (_a0,_a1,_a2) ->
          let self = self#loc _a0 in
      ...
      | `Eq (_a0,_a1,_a2) ->
          ...
          let self = self#ctyp _a1 in self#ctyp _a2
      | #ant as _a0 -> (self#ant _a0 :>'this_type__002_)
    method opt_type_constr : opt_type_constr -> 'this_type__002_=
      function
      | `Some (_a0,_a1) -> let self = self#loc _a0 in self#type_constr _a1
      | `None _a0 -> self#loc _a0
    method decl_param : decl_param -> 'this_type__002_=
      function
      | `Quote (_a0,_a1,_a2) ->
          let self = self#loc _a0 in
          let self = self#position_flag _a1 in self#alident _a2
      ...
      | #ant as _a0 -> (self#ant _a0 :>'this_type__002_)
    method decl_params : decl_params -> 'this_type__002_=
      function
      | `Quote (_a0,_a1,_a2) ->
          let self = self#loc _a0 in
          let self = self#position_flag _a1 in self#alident _a2
      ...
      | #ant as _a0 -> (self#ant _a0 :>'this_type__002_)
    method opt_decl_params : opt_decl_params -> 'this_type__002_=
      function
      | `Some (_a0,_a1) -> let self = self#loc _a0 in self#decl_params _a1
      | `None _a0 -> self#loc _a0
    method type_info : type_info -> 'this_type__002_=
      function
    ...
    method name_ctyp : name_ctyp -> 'this_type__002_=
      ...
      | #ant as _a0 -> (self#ant _a0 :>'this_type__002_)
    method or_ctyp : or_ctyp -> 'this_type__002_=
      function
      | `Bar (_a0,_a1,_a2) ->
          let self = self#loc _a0 in
      ...
      | `Of (_a0,_a1,_a2) ->
          ...
          let self = self#auident _a1 in self#ctyp _a2
      | #auident as _a0 -> (self#auident _a0 :>'this_type__002_)
    method of_ctyp : of_ctyp -> 'this_type__002_=
      function
      | `Of (_a0,_a1,_a2) ->
          let self = self#loc _a0 in let self = self#vid _a1 in self#ctyp _a2
      | #vid' as _a0 -> (self#vid' _a0 :>'this_type__002_)
      | #ant as _a0 -> (self#ant _a0 :>'this_type__002_)
    method pat : pat -> 'this_type__002_=
      function
      | #vid as _a0 -> (self#vid _a0 :>'this_type__002_)
      | `App (_a0,_a1,_a2) ->
      ...
      | #literal as _a0 -> (self#literal _a0 :>'this_type__002_)
      | `Alias (_a0,_a1,_a2) ->
          let self = self#loc _a0 in
      ...
      | `ModuleConstraint (_a0,_a1,_a2) ->
          let self = self#loc _a0 in
          let self = self#auident _a1 in self#ctyp _a2
    method rec_pat : rec_pat -> 'this_type__002_=
      function
      | `RecBind (_a0,_a1,_a2) ->
      ...
      | #any as _a0 -> (self#any _a0 :>'this_type__002_)
      | #ant as _a0 -> (self#ant _a0 :>'this_type__002_)
    method exp : exp -> 'this_type__002_=
      function
      | #vid as _a0 -> (self#vid _a0 :>'this_type__002_)
      | `App (_a0,_a1,_a2) ->
    ...
    method rec_exp : rec_exp -> 'this_type__002_=
      function
      | `Sem (_a0,_a1,_a2) ->
          let self = self#loc _a0 in
      ...
      | #any as _a0 -> (self#any _a0 :>'this_type__002_)
      | #ant as _a0 -> (self#ant _a0 :>'this_type__002_)
    method mtyp : mtyp -> 'this_type__002_=
      function
      | #ident' as _a0 -> (self#ident' _a0 :>'this_type__002_)
      ...
      | #ant as _a0 -> (self#ant _a0 :>'this_type__002_)
    method sigi : sigi -> 'this_type__002_=
      function
      | `Val (_a0,_a1,_a2) ->
          let self = self#loc _a0 in
          let self = self#alident _a1 in self#ctyp _a2
      ...
      | #ant as _a0 -> (self#ant _a0 :>'this_type__002_)
    method mbind : mbind -> 'this_type__002_=
      function
      | `And (_a0,_a1,_a2) ->
          let self = self#loc _a0 in
      ...
      | `Constraint (_a0,_a1,_a2) ->
          ...
          let self = self#auident _a1 in self#mtyp _a2
      | #ant as _a0 -> (self#ant _a0 :>'this_type__002_)
    method constr : constr -> 'this_type__002_=
      function
      | `TypeEq (_a0,_a1,_a2) ->
          let self = self#loc _a0 in
          let self = self#ctyp _a1 in self#ctyp _a2
      ...
      | #ant as _a0 -> (self#ant _a0 :>'this_type__002_)
    method bind : bind -> 'this_type__002_=
      function
      | `And (_a0,_a1,_a2) ->
          let self = self#loc _a0 in
      ...
      | #ant as _a0 -> (self#ant _a0 :>'this_type__002_)
    method case : case -> 'this_type__002_=
      function
      | `Bar (_a0,_a1,_a2) ->
          let self = self#loc _a0 in
      ...
      | #ant as _a0 -> (self#ant _a0 :>'this_type__002_)
    method mexp : mexp -> 'this_type__002_=
      function
      | #vid' as _a0 -> (self#vid' _a0 :>'this_type__002_)
      | `App (_a0,_a1,_a2) ->
          let self = self#loc _a0 in
      ...
      | #ant as _a0 -> (self#ant _a0 :>'this_type__002_)
    method stru : stru -> 'this_type__002_=
      function
      ...
      | #ant as _a0 -> (self#ant _a0 :>'this_type__002_)
    method cltdecl : cltdecl -> 'this_type__002_=
      function
      | `And (_a0,_a1,_a2) ->
          let self = self#loc _a0 in
      ...
      | #ant as _a0 -> (self#ant _a0 :>'this_type__002_)
    method cltyp : cltyp -> 'this_type__002_=
      function
      | #vid' as _a0 -> (self#vid' _a0 :>'this_type__002_)
      | `ClApply (_a0,_a1,_a2) ->
          let self = self#loc _a0 in
      ...
      | #ant as _a0 -> (self#ant _a0 :>'this_type__002_)
    method clsigi : clsigi -> 'this_type__002_=
      function
      | `Sem (_a0,_a1,_a2) ->
          let self = self#loc _a0 in
      ...
      | `Eq (_a0,_a1,_a2) ->
          ...
          let self = self#ctyp _a1 in self#ctyp _a2
      | #ant as _a0 -> (self#ant _a0 :>'this_type__002_)
    method cldecl : cldecl -> 'this_type__002_=
      function
      ...
      | #ant as _a0 -> (self#ant _a0 :>'this_type__002_)
    method clexp : clexp -> 'this_type__002_=
      function
      | `CeApp (_a0,_a1,_a2) ->
          let self = self#loc _a0 in
      ...
      | #ant as _a0 -> (self#ant _a0 :>'this_type__002_)
    method clfield : clfield -> 'this_type__002_=
      function
      | `Sem (_a0,_a1,_a2) ->
          let self = self#loc _a0 in
    ...
    method ep : ep -> 'this_type__002_=
      ...
      | #literal as _a0 -> (self#literal _a0 :>'this_type__002_)
    method rec_bind : rec_bind -> 'this_type__002_=
      function
      | `RecBind (_a0,_a1,_a2) ->
      ...
      | #any as _a0 -> (self#any _a0 :>'this_type__002_)
      | #ant as _a0 -> (self#ant _a0 :>'this_type__002_)
    method tokenf_ant : Tokenf.ant -> 'this_type__002_= self#unknown
    method locf_t : Locf.t -> 'this_type__002_= self#unknown
  end
