...
val create: (int array -> pos:int -> count:int -> int) -> lexbuf
...
val from_stream: int XStream.t -> lexbuf
...
val from_latin1_stream: char XStream.t -> lexbuf
...
val from_utf8_stream: char XStream.t -> lexbuf
...
val from_var_enc_stream: enc ref -> char XStream.t -> lexbuf
