...
module Camlp4Bin =
                                                                    ...
                                                                    (List.mem
                                                                    n (
                                                                    PreCast.loaded_modules.contents
                                                                    )) )) then
                                                                    ()
                                                                    ...
                                                                    s) ->
                                                                    (
                                                                    (PreCast.Syntax.Quotation.default
                                                                    := s)
                                                                    );
                                                                    (
                                                                    None)
                                                                    ...
                                                                    name) in
                                                                    (
                                                                    (PreCast.Syntax.current_warning
                                                                    :=
                                                                    print_warning)
                                                                    );
                                                                    let ic =
                                                                    ...
                                                                    (printf
                                                                    "%s@."
                                                                    FanConfig.camlp4_standard_library)
                                                                    );
                                                                    (exit 0)
                                                                    ...
                                                                    (
                                                                    (FanUtil.Options.print_usage_list
                                                                    ini_sl)
                                                                    );
                                                                    if 
                                                                    (ext_sl
                                                                    ...
                                                                    () ) in
                                                                    if 
                                                                    print_loaded_modules.contents then
                                                                    (
                                                                    (SSet.iter
                                                                    (
                                                                    (eprintf
