...
class ['accu] fold_free_vars (f :
                                            (string -> ('accu -> 'accu)))
                                           ?env_init:(env_init=SSet.empty)
                                           free_init =
                                           object (o)
                                            inherit Camlp4Ast.fold as super
                                            ...
                                            method add_patt =
                                             fun p ->
                                              {< env =
                                                  (fold_pattern_vars SSet.add
                                                    p env) >}
                                            method add_binding =
                                             fun bi ->
                                              {< env =
                                                  (fold_binding_vars SSet.add
                                                    bi env) >}
                                            method expr =
                                             function
                                             | ((Ast.ExId
                                            ...
                                            method str_item =
                                             ...
                                             | Ast.StVal (_, Ast.ReNil, bi) ->
                                                (((o#binding bi)#add_binding)
                                                  bi)
                                             | Ast.StVal
                                                (_, Ast.ReRecursive, bi) ->
                                                (((o#add_binding bi)#binding)
                                                  bi)
