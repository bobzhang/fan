                                                                 ...
                                                                 fun entry ->
                                                                  fun gsymbols ->
                                                                   fun action ->
                                                                    ...
                                                                    () =
                                                                    if 
                                                                    ((entry.egram).warning_verbose).contents then
                                                                    (
                                                                    (eprintf
