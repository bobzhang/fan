...
type  gram = 
  { gfilter: filter ; gkeywords:( string , int  ref ) Hashtbl.t ;
                                                                   glexer:
                                                                   ( FanLoc.t
                                                                     ->
                                                                    ( char 
...
type  token_info = 
  { prev_loc: FanLoc.t ; cur_loc: FanLoc.t ; prev_loc_only: bool } 
...
type  internal_entry = 
  { egram: gram ; ename: string ;mutable  estart:( int  ->  efun ) ;mutable 
                                                                    econtinue:
                                                                    ( int  ->
                                                                    (
                                                                    FanLoc.t 
...
and  level = 
  { assoc: assoc ; lname: string  option ; lsuffix: tree ; lprefix: tree } 
and  symbol =
  [
    `Smeta of ( string * symbol  list * Action.t )|`Snterm of  internal_entry |
    `Snterml of ( internal_entry * string )|`Slist0 of  symbol |`Slist0sep of
                                                                  ( symbol *
                                                                    symbol )|
...
let using ({gkeywords = table;gfilter = filter;_}) (kwd) =
  let r = begin try (Hashtbl.find table kwd) with
