...
class text_grammar = object (self : 'self)
                       ...
                       method symbol ppf =
                         ...
                         | `Slist0 s ->
                             fprintf ppf "LIST0 %a" (self#symbol1) s
                         | `Slist0sep (s,t) ->
                             fprintf ppf "LIST0 %a SEP %a" (self#symbol1) s
                               (self#symbol1) t
                         | `Slist1 s ->
                             fprintf ppf "LIST1 %a" (self#symbol1) s
                         | `Slist1sep (s,t) ->
                             fprintf ppf "LIST1 %a SEP %a" (self#symbol1) s
                               (self#symbol1) t
                         ...
                         | `Snterm _|`Snext|`Sself|`Stree _|`Stoken _|
                             `Skeyword _ as s -> (self#symbol1) ppf s
                       ...
                       method symbol1 ppf =
                         ...
                         | `Smeta (_,_,_)|`Snterml (_,_)|`Slist0 _|`Slist0sep
                                                                    (_,_)|
                           ...
                           | s::sl ->
                               ...
                               (fprintf ppf "%s %a" (String.sub n i (j - i))
                                ...
                                then ()
                                  ...
                                  (fprintf ppf " ";
                                   loop (min (j + 1) (String.length n)) sl)) in
                         loop 0 sl
                         ...
                         (List.fold_left
                            (fun sep ->
                               fun lev ->
                                 ...
                                 fprintf ppf "@]@;<1 2>";
                                 (self#level) ppf Format.pp_force_newline
                                   rules;
                                 (fun ppf -> fprintf ppf "@,| "))
                            (fun _ -> ()) elev ppf
                         :unit  )
