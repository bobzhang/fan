...
class text_grammar =
                            object (self : 'self)
                             method tree =
                              fun ppf ->
                               fun t ->
                                (self#level ppf Format.pp_print_space (
                                  (flatten_tree t) ))
                             method symbol =
                              fun ppf ->
                               function
                               | (`Smeta (n, sl, _)) ->
                                  (self#meta ppf n sl)
                               | (`Slist0 s) ->
                                  (fprintf ppf "LIST0 %a" ( self#symbol1
                                    ) s)
                               | (`Slist0sep (s, t)) ->
                                  (fprintf ppf "LIST0 %a SEP %a" (
                                    self#symbol1 ) s ( self#symbol1 ) t)
                               | (`Slist1 s) ->
                                  (fprintf ppf "LIST1 %a" ( self#symbol1
                                    ) s)
                               | (`Slist1sep (s, t)) ->
                                  (fprintf ppf "LIST1 %a SEP %a" (
                                    self#symbol1 ) s ( self#symbol1 ) t)
                               | (`Sopt s) ->
                                  (fprintf ppf "OPT %a" ( self#symbol1 )
                                    s)
                               | (`Stry s) ->
                                  (fprintf ppf "TRY %a" ( self#symbol1 )
                                    s)
                               | (`Snterml (e, l)) ->
                                  (fprintf ppf "%s@ Level@ %S" ( e.ename
                                    ) l)
                               | (((((((`Snterm _) | `Snext) | `Sself)
                                     | (`Stree _)) | (`Stoken _))
                                   | (`Skeyword _)) as s) ->
                                  (self#symbol1 ppf s)
                             method description =
                               ...
                               fun symbols ->
                                ...
                                (List.fold_left (
                                  fun sep ->
                                   fun symbol ->
                                    (
                                    (fprintf ppf "%t%a" sep ( self#symbol
                                      ) symbol)
                                    );
                                    fun ppf -> (fprintf ppf ";@ ") ) (
                                  fun _ -> () ) symbols ppf)
