                       ...
                       fun symb ->
                        (match symb with
                         | (((((((((((`Snterm _) | (`Snterml (_, _)))
                                    | (`Slist0 _)) | (`Slist0sep (_, _)))
                                  | (`Slist1 _)) | (`Slist1sep (_, _)))
                                | (`Sopt _)) | (`Stry _)) | (`Stoken _))
                             | (`Stree _)) | (`Skeyword _)) when
                            (symb == prev_symb) ->
                            (Some (symb))
                         | (`Slist0 symb) ->
