                ...
                (struct
                  ...
                  module Entry =
                   struct
                    ...
                    let of_parser =
                     fun name -> fun strm -> (E.of_parser gram name strm)
                  ...
                  let parse_tokens_after_filter =
                   fun entry ->
                    fun ts -> (Entry.E.parse_tokens_after_filter entry ts)
                  ...
                  let srules =
                   fun e ->
                    fun rl ->
                     (Stree
                       (List.fold_left (
                         (flip ( (uncurry ( (Insert.insert_tree e) )) )) )
                         DeadEnd  rl))
                  ...
                  (FanSig.Grammar.Static with module Loc = Lexer.Loc
                   and module Loc = Lexer.Loc and module Token = Lexer.Token))
