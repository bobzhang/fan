...
let njunk =
                 fun strm ->
                  fun n -> for _i = 1 to n do (Stream.junk strm) done
...
let recover =
                                                                    ...
                                                                    let _ =
                                                                    if 
                                                                    strict_parsing_warning.contents then
                                                                    (
                                                                    let msg =
                                                                    (Failed.tree_failed
                                                                    entry a s
