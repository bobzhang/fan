    ...
    begin
               ...
               ("Gram.mk_action\n  (fun _  (st : 'smlist_else)  _  (_loc : FLoc.t)  -> (st : 'else_macro_def ))\n",
                 (Gram.mk_action
                    (fun _  (st : 'smlist_else)  _  (_loc : FLoc.t)  ->
                       (st : 'else_macro_def )))));
            ([`Snterm (Gram.obj (endif : 'endif Gram.t ))],
              ("Gram.mk_action (fun _  (_loc : FLoc.t)  -> ([] : 'else_macro_def ))\n",
                (Gram.mk_action
        ...
        (None,
          (None, None,
            [([`Skeyword "ELSE";
              ...
              `Snterm (Gram.obj (endif : 'endif Gram.t ))],
               ("Gram.mk_action (fun _  (e : 'exp)  _  (_loc : FLoc.t)  -> (e : 'else_exp ))\n",
                 (Gram.mk_action
            ...
            [([`Slist1
                 (Gram.srules
                    ...
                    ([`Snterm (Gram.obj (stru : 'stru Gram.t ));
                     `Skeyword ";"],
                      ("Gram.mk_action (fun _  (si : 'stru)  (_loc : FLoc.t)  -> (Str si : 'e__1 ))\n",
                        (Gram.mk_action
          ...
          (None, None,
            [([`Slist1
                 (Gram.srules
                    ...
                    ([`Snterm (Gram.obj (stru : 'stru Gram.t ));
                     `Skeyword ";"],
                      ("Gram.mk_action (fun _  (si : 'stru)  (_loc : FLoc.t)  -> (Str si : 'e__2 ))\n",
                        (Gram.mk_action
                           (fun _  (si : 'stru)  (_loc : FLoc.t)  ->
                              (Str si : 'e__2 )))))])],
      ...
      Gram.extend_single (endif : 'endif Gram.t )
        (None,
          (None, None,
            [([`Skeyword "END"],
               ("Gram.mk_action (fun _  (_loc : FLoc.t)  -> (() : 'endif ))\n",
                 (Gram.mk_action (fun _  (_loc : FLoc.t)  -> (() : 'endif )))));
            ([`Skeyword "ENDIF"],
              ("Gram.mk_action (fun _  (_loc : FLoc.t)  -> (() : 'endif ))\n",
                (Gram.mk_action (fun _  (_loc : FLoc.t)  -> (() : 'endif )))))]));
      Gram.extend_single (opt_macro_value : 'opt_macro_value Gram.t )
        (None,
          (None, None,
            ...
            ([],
              ("Gram.mk_action (fun (_loc : FLoc.t)  -> (None : 'opt_macro_value ))\n",
                (Gram.mk_action
