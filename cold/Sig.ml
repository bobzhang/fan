...
module type Camlp4Syntax =
 ...
 val a_LIDENT : string Gram.t  val a_NATIVEINT : string Gram.t 
 val a_OPTLABEL : string Gram.t  val a_STRING : string Gram.t 
 val a_UIDENT : string Gram.t  val a_ident : string Gram.t 
 val amp_ctyp : Ast.ctyp Gram.t  val and_ctyp : Ast.ctyp Gram.t 
 val match_case : Ast.match_case Gram.t 
 val match_case0 : Ast.match_case Gram.t 
 val match_case_quot : Ast.match_case Gram.t 
 val binding : Ast.binding Gram.t  val binding_quot : Ast.binding Gram.t 
 ...
 val ctyp_quot : Ast.ctyp Gram.t  val cvalue_binding : Ast.expr Gram.t 
 ...
 val expr : Ast.expr Gram.t  val expr_eoi : Ast.expr Gram.t 
 val expr_quot : Ast.expr Gram.t  val field_expr : Ast.rec_binding Gram.t 
 val field_expr_list : Ast.rec_binding Gram.t 
 val fun_binding : Ast.expr Gram.t  val fun_def : Ast.expr Gram.t 
 val ident : Ast.ident Gram.t  val ident_quot : Ast.ident Gram.t 
 val ipatt : Ast.patt Gram.t  val ipatt_tcon : Ast.patt Gram.t 
 val label : string Gram.t  val label_declaration : Ast.ctyp Gram.t 
 ...
 val label_ipatt : Ast.patt Gram.t  val label_ipatt_list : Ast.patt Gram.t 
 ...
 val more_ctyp : Ast.ctyp Gram.t  val name_tags : Ast.ctyp Gram.t 
 ...
 val opt_eq_ctyp : Ast.ctyp Gram.t  val opt_expr : Ast.expr Gram.t 
 ...
 val opt_polyt : Ast.ctyp Gram.t  val opt_private : Ast.private_flag Gram.t 
 val private_flag_quot : Ast.private_flag Gram.t 
 val opt_rec : Ast.rec_flag Gram.t  val rec_flag_quot : Ast.rec_flag Gram.t 
 val opt_virtual : Ast.virtual_flag Gram.t 
 val virtual_flag_quot : Ast.virtual_flag Gram.t 
 val opt_when_expr : Ast.expr Gram.t  val patt : Ast.patt Gram.t 
 val patt_as_patt_opt : Ast.patt Gram.t  val patt_eoi : Ast.patt Gram.t 
 val patt_quot : Ast.patt Gram.t  val patt_tcon : Ast.patt Gram.t 
 val phrase : Ast.str_item Gram.t  val poly_type : Ast.ctyp Gram.t 
 val row_field : Ast.ctyp Gram.t  val sem_expr : Ast.expr Gram.t 
 val sem_expr_for_list : (Ast.expr -> Ast.expr)  Gram.t 
 val sem_patt : Ast.patt Gram.t 
 val sem_patt_for_list : (Ast.patt -> Ast.patt)  Gram.t 
 val semi : unit Gram.t  val sequence : Ast.expr Gram.t 
 val do_sequence : Ast.expr Gram.t  val sig_item : Ast.sig_item Gram.t 
 val sig_item_quot : Ast.sig_item Gram.t 
 val sig_items : Ast.sig_item Gram.t  val star_ctyp : Ast.ctyp Gram.t 
 val str_item : Ast.str_item Gram.t  val str_item_quot : Ast.str_item Gram.t 
 ...
 val typevars : Ast.ctyp Gram.t  val val_longident : Ast.ident Gram.t 
 val with_constr : Ast.with_constr Gram.t 
 val with_constr_quot : Ast.with_constr Gram.t 
 val prefixop : Ast.expr Gram.t  val infixop0 : Ast.expr Gram.t 
 val infixop1 : Ast.expr Gram.t  val infixop2 : Ast.expr Gram.t 
 val infixop3 : Ast.expr Gram.t  val infixop4 : Ast.expr Gram.t 
 val symbol : FanGrammar.symbol Gram.t  val rule : FanGrammar.rule Gram.t 
 val rule_list : FanGrammar.rule list  Gram.t 
 val psymbol : FanGrammar.symbol Gram.t  val level : FanGrammar.level Gram.t 
