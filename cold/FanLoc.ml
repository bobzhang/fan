                                                  ...
                                                  fun f ->
                                                   fun x ->
                                                    (fprintf f
                                                      ...
                                                      (
                                                      (x.loc_start).pos_fname
                                                      ) dump_pos (
                                                      x.loc_start ) (
                                                      ((
                                                        (x.loc_start).pos_cnum
                                                        ) - (
                                                        (x.loc_start).pos_bol
                                                        )) ) (
                                                      (( (x.loc_end).pos_cnum
...
let to_string =
                 fun x ->
                  ...
                  if (( (x.loc_start).pos_lnum ) <> ( (x.loc_end).pos_lnum )) then
                   (
                   (sprintf "%s (end at line %d, character %d)" res (
                     (x.loc_end).pos_lnum ) (
...
let print =
                             fun out ->
                              fun x ->
                               (pp_print_string out ( (to_string x) ))
