     ...
     (None,
       (None, None,
         ...
         ([`Snterm (Gram.obj (ipatt : 'ipatt Gram.t ))],
           ("Gram.mk_action\n  (fun (p : 'ipatt)  (_loc : FanLoc.t)  ->\n     (fun e  -> `Fun (_loc, (`Case (_loc, p, e))) : 'fun_def_patt ))\n",
             (Gram.mk_action
                (fun (p : 'ipatt)  (_loc : FanLoc.t)  ->
                   (fun e  -> `Fun (_loc, (`Case (_loc, p, e))) : 'fun_def_patt )))));
         ([`Snterm (Gram.obj (ipatt : 'ipatt Gram.t ));
          `Skeyword "when";
          `Snterm (Gram.obj (expr : 'expr Gram.t ))],
           ("Gram.mk_action\n  (fun (w : 'expr)  _  (p : 'ipatt)  (_loc : FanLoc.t)  ->\n     (fun e  -> `Fun (_loc, (`CaseWhen (_loc, p, w, e))) : 'fun_def_patt ))\n",
             (Gram.mk_action
                (fun (w : 'expr)  _  (p : 'ipatt)  (_loc : FanLoc.t)  ->
     ...
     (None,
       [((Some "top"), (Some `RA),
          ...
          ([`Skeyword "let";
           ...
           `Snterm (Gram.obj (case : 'case Gram.t ))],
            ("Gram.mk_action\n  (fun (a : 'case)  _  (x : 'expr)  _  (bi : 'binding)  (r : 'opt_rec)  _  _ \n     (_loc : FanLoc.t)  ->\n     (`App\n        (_loc,\n          (`Try\n             (_loc,\n               (`LetIn\n                  (_loc, r, bi,\n                    (`Fun\n                       (_loc,\n                         (`Case (_loc, (`Id (_loc, (`Uid (_loc, \"()\")))), x)))))),\n               (FanAst.match_pre#case a))),\n          (`Id (_loc, (`Uid (_loc, \"()\"))))) : 'expr ))\n",
              (Gram.mk_action
                 (fun (a : 'case)  _  (x : 'expr)  _  (bi : 'binding) 
          ...
          ([`Skeyword "do";
           ...
           `Skeyword "done"],
            ("Gram.mk_action\n  (fun _  (seq : 'sequence)  _  (_loc : FanLoc.t)  ->\n     (FanOps.mksequence ~loc:_loc seq : 'expr ))\n",
              (Gram.mk_action
                 (fun _  (seq : 'sequence)  _  (_loc : FanLoc.t)  ->
                    (FanOps.mksequence ~loc:_loc seq : 'expr )))));
          ([`Skeyword "with";
       ...
       ((Some "obj"), (Some `RA),
         [([`Skeyword "fun";
           ...
           `Skeyword "]"],
            ("Gram.mk_action\n  (fun _  (a : 'case0 list)  _  _  (_loc : FanLoc.t)  ->\n     (let cases = or_of_list1 a in `Fun (_loc, cases) : 'expr ))\n",
              (Gram.mk_action
                 (fun _  (a : 'case0 list)  _  _  (_loc : FanLoc.t)  ->
         ...
         ([`Skeyword "object";
          ...
          `Skeyword ")";
          `Skeyword "end"],
           ("Gram.mk_action\n  (fun _  _  (p : 'patt)  _  _  (_loc : FanLoc.t)  ->\n     (`ObjPatEnd (_loc, p) : 'expr ))\n",
             (Gram.mk_action
                (fun _  _  (p : 'patt)  _  _  (_loc : FanLoc.t)  ->
                   (`ObjPatEnd (_loc, p) : 'expr )))));
         ([`Skeyword "object";
         ...
         ([`Skeyword "object";
          ...
          `Skeyword ")";
          `Skeyword "end"],
           ("Gram.mk_action\n  (fun _  _  (t : 'ctyp)  _  (p : 'patt)  _  _  (_loc : FanLoc.t)  ->\n     (`ObjPatEnd (_loc, (`Constraint (_loc, p, t))) : 'expr ))\n",
             (Gram.mk_action
                (fun _  _  (t : 'ctyp)  _  (p : 'patt)  _  _ 
                   (_loc : FanLoc.t)  ->
                   (`ObjPatEnd (_loc, (`Constraint (_loc, p, t))) : 'expr )))));
         ([`Skeyword "object";
          `Snterm (Gram.obj (class_structure : 'class_structure Gram.t ));
         ...
         ([`Skeyword "object"; `Skeyword "end"],
           ("Gram.mk_action (fun _  _  (_loc : FanLoc.t)  -> (`ObjEnd _loc : 'expr ))\n",
             (Gram.mk_action
                (fun _  _  (_loc : FanLoc.t)  -> (`ObjEnd _loc : 'expr )))))]);
       ...
       ((Some "simple"), None,
         ...
         ([`Skeyword "(";
          ...
          `Snterm (Gram.obj (sequence : 'sequence Gram.t ));
          `Skeyword ")"],
           ("Gram.mk_action\n  (fun _  (seq : 'sequence)  _  (e : 'expr)  _  (_loc : FanLoc.t)  ->\n     (FanOps.mksequence ~loc:_loc (`Sem (_loc, e, seq)) : 'expr ))\n",
             (Gram.mk_action
                (fun _  (seq : 'sequence)  _  (e : 'expr)  _ 
                   (_loc : FanLoc.t)  ->
         ...
         ([`Skeyword "("; `Sself; `Skeyword ";"; `Skeyword ")"],
           ("Gram.mk_action\n  (fun _  _  (e : 'expr)  _  (_loc : FanLoc.t)  ->\n     (FanOps.mksequence ~loc:_loc e : 'expr ))\n",
             (Gram.mk_action
                (fun _  _  (e : 'expr)  _  (_loc : FanLoc.t)  ->
                   (FanOps.mksequence ~loc:_loc e : 'expr )))));
         ([`Skeyword "(";
       ...
       (None, None,
         [([`Slist1sep
              ((`Snterm (Gram.obj (case0 : 'case0 Gram.t ))),
                (`Skeyword "|"))],
            ("Gram.mk_action\n  (fun (x : 'case0 list)  (_loc : FanLoc.t)  -> (or_of_list1 x : 'case_quot ))\n",
              (Gram.mk_action
                 (fun (x : 'case0 list)  (_loc : FanLoc.t)  ->
                    (or_of_list1 x : 'case_quot )))))])));
     ...
     (None,
       (None, None,
         ...
         ([`Stoken
          ...
          `Snterm (Gram.obj (expr : 'expr Gram.t ));
          `Skeyword ")"],
           ("Gram.mk_action\n  (fun _  (e : 'expr)  _  (p : 'patt_tcon)  _  (__fan_0 : [> FanToken.t]) \n     (_loc : FanLoc.t)  ->\n     match __fan_0 with\n     | `OPTLABEL i -> (`OptLablExpr (_loc, (`Lid (_loc, i)), p, e) : 'ipatt )\n     | _ -> failwith \"`OptLablExpr (_loc, (`Lid (_loc, i)), p, e)\n\")\n",
             (Gram.mk_action
                (fun _  (e : 'expr)  _  (p : 'patt_tcon)  _ 
                   (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                   match __fan_0 with
         ...
         ([`Stoken
          ...
          `Snterm (Gram.obj (patt_tcon : 'patt_tcon Gram.t ));
          `Skeyword ")"],
           ("Gram.mk_action\n  (fun _  (p : 'patt_tcon)  _  (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t) \n     ->\n     match __fan_0 with\n     | `OPTLABEL i -> (`OptLabl (_loc, (`Lid (_loc, i)), p) : 'ipatt )\n     | _ -> failwith \"`OptLabl (_loc, (`Lid (_loc, i)), p)\n\")\n",
             (Gram.mk_action
                (fun _  (p : 'patt_tcon)  _  (__fan_0 : [> FanToken.t]) 
                   (_loc : FanLoc.t)  ->
                   match __fan_0 with
                   | `OPTLABEL i ->
                       (`OptLabl (_loc, (`Lid (_loc, i)), p) : 'ipatt )
                   | _ -> failwith "`OptLabl (_loc, (`Lid (_loc, i)), p)\n"))));
         ([`Skeyword "?";
          `Snterm (Gram.obj (a_lident : 'a_lident Gram.t ));
          `Skeyword ":";
          ...
          `Snterm (Gram.obj (expr : 'expr Gram.t ));
          `Skeyword ")"],
           ("Gram.mk_action\n  (fun _  (e : 'expr)  _  (p : 'patt_tcon)  _  _  (i : 'a_lident)  _ \n     (_loc : FanLoc.t)  -> (`OptLablExpr (_loc, i, p, e) : 'ipatt ))\n",
             (Gram.mk_action
                (fun _  (e : 'expr)  _  (p : 'patt_tcon)  _  _ 
                   (i : 'a_lident)  _  (_loc : FanLoc.t)  ->
                   (`OptLablExpr (_loc, i, p, e) : 'ipatt )))));
         ([`Skeyword "?";
          `Snterm (Gram.obj (a_lident : 'a_lident Gram.t ));
          `Skeyword ":";
          `Skeyword "(";
          ...
          `Stoken
            (((function | `Ant ("opt",_) -> true | _ -> false)),
              (`Normal, "`Ant (\"opt\",_)"));
          `Skeyword ")"],
           ("Gram.mk_action\n  (fun _  (__fan_6 : [> FanToken.t])  _  (p : 'patt_tcon)  _  _ \n     (i : 'a_lident)  _  (_loc : FanLoc.t)  ->\n     match __fan_6 with\n     | `Ant ((\"opt\" as n),s) ->\n         (`OptLablExpr (_loc, i, p, (`Ant (_loc, (mk_anti n s)))) : 'ipatt )\n     | _ ->\n         failwith \"`OptLablExpr (_loc, i, p, (`Ant (_loc, (mk_anti n s))))\n\")\n",
             (Gram.mk_action
                (fun _  (__fan_6 : [> FanToken.t])  _  (p : 'patt_tcon)  _  _
                    (i : 'a_lident)  _  (_loc : FanLoc.t)  ->
                   match __fan_6 with
         ...
         ([`Skeyword "?";
          ...
          `Snterm (Gram.obj (expr : 'expr Gram.t ));
          `Skeyword ")"],
           ("Gram.mk_action\n  (fun _  (e : 'expr)  _  (p : 'ipatt_tcon)  _  _  (_loc : FanLoc.t)  ->\n     (`OptLablExpr (_loc, (`Lid (_loc, \"\")), p, e) : 'ipatt ))\n",
             (Gram.mk_action
                (fun _  (e : 'expr)  _  (p : 'ipatt_tcon)  _  _ 
                   (_loc : FanLoc.t)  ->
                   (`OptLablExpr (_loc, (`Lid (_loc, "")), p, e) : 'ipatt )))))]));
       ...
       (None, None,
         ...
         ([`Slist1
             (Gram.srules
                [([`Snterm (Gram.obj (str_item : 'str_item Gram.t ));
                  `Skeyword ";;"],
                   ("Gram.mk_action (fun _  (st : 'str_item)  (_loc : FanLoc.t)  -> (st : 'e__6 ))\n",
                     (Gram.mk_action
                        (fun _  (st : 'str_item)  (_loc : FanLoc.t)  ->
                           (st : 'e__6 )))))])],
           ("Gram.mk_action\n  (fun (l : 'e__6 list)  (_loc : FanLoc.t)  -> (sem_of_list1 l : 'str_items ))\n",
             (Gram.mk_action
             ...
             (Gram.mk_action
                (fun (x : 'dot_namespace)  _  _  (_loc : FanLoc.t)  ->
                   (FanToken.paths := ((`Absolute x) ::
                      (FanToken.paths.contents));
                    None : 'top_phrase )))));
         ([`Snterm (Gram.obj (str_item : 'str_item Gram.t )); `Skeyword ";"],
         ...
         ([`Slist1
             (Gram.srules
                [([`Snterm
                  ...
                  `Skeyword ";"],
                   ("Gram.mk_action\n  (fun _  (cst : 'class_str_item)  (_loc : FanLoc.t)  -> (cst : 'e__8 ))\n",
                     (Gram.mk_action
                        (fun _  (cst : 'class_str_item)  (_loc : FanLoc.t) 
                           -> (cst : 'e__8 )))))])],
           ("Gram.mk_action\n  (fun (l : 'e__8 list)  (_loc : FanLoc.t)  ->\n     (sem_of_list1 l : 'class_structure ))\n",
             (Gram.mk_action
                (fun (l : 'e__8 list)  (_loc : FanLoc.t)  ->
                   (sem_of_list1 l : 'class_structure )))))]));
     ...
     (None,
       (None, None,
         [([`Snterm (Gram.obj (class_str_item : 'class_str_item Gram.t ));
           `Skeyword ";";
           `Sself],
            ("Gram.mk_action\n  (fun (x2 : 'class_str_item_quot)  _  (x1 : 'class_str_item) \n     (_loc : FanLoc.t)  -> (`Sem (_loc, x1, x2) : 'class_str_item_quot ))\n",
              (Gram.mk_action
                 (fun (x2 : 'class_str_item_quot)  _  (x1 : 'class_str_item) 
                    (_loc : FanLoc.t)  ->
                    (`Sem (_loc, x1, x2) : 'class_str_item_quot )))));
         ([`Snterm (Gram.obj (class_str_item : 'class_str_item Gram.t ))],
   ...
   Gram.extend_single
     ...
     (None,
       (None, None,
         ...
         ([`Snterm (Gram.obj (opt_virtual : 'opt_virtual Gram.t ));
          `Snterm (Gram.obj (a_lident : 'a_lident Gram.t ))],
           ("Gram.mk_action\n  (fun (i : 'a_lident)  (mv : 'opt_virtual)  (_loc : FanLoc.t)  ->\n     (`ClassConS (_loc, mv, (i :>ident)) : 'class_info_for_class_expr ))\n",
             (Gram.mk_action
                (fun (i : 'a_lident)  (mv : 'opt_virtual)  (_loc : FanLoc.t) 
                   ->
                   (`ClassConS (_loc, mv, (i :>ident)) : 'class_info_for_class_expr )))))]));
     ...
     (None,
       ...
       ((Some "simple"), None,
         ...
         ([`Skeyword "object";
          ...
          `Skeyword ")";
          `Skeyword "end"],
           ("Gram.mk_action\n  (fun _  _  (t : 'ctyp)  _  (p : 'patt)  _  _  (_loc : FanLoc.t)  ->\n     (`ObjPatEnd (_loc, (`Constraint (_loc, p, t))) : 'class_expr ))\n",
             (Gram.mk_action
                (fun _  _  (t : 'ctyp)  _  (p : 'patt)  _  _ 
                   (_loc : FanLoc.t)  ->
                   (`ObjPatEnd (_loc, (`Constraint (_loc, p, t))) : 'class_expr )))));
           ...
           ("Gram.mk_action\n  (fun _  (cst : 'class_structure)  _  (_loc : FanLoc.t)  ->\n     (`Obj (_loc, cst) : 'class_expr ))\n",
             (Gram.mk_action
                (fun _  (cst : 'class_structure)  _  (_loc : FanLoc.t)  ->
                   (`Obj (_loc, cst) : 'class_expr )))));
         ([`Skeyword "object"; `Skeyword "end"],
           ("Gram.mk_action\n  (fun _  _  (_loc : FanLoc.t)  -> (`ObjEnd _loc : 'class_expr ))\n",
             (Gram.mk_action
                (fun _  _  (_loc : FanLoc.t)  ->
                   (`ObjEnd _loc : 'class_expr )))));
         ([`Skeyword "(";
          `Sself;
          `Skeyword ":";
          `Snterm (Gram.obj (class_type : 'class_type Gram.t ));
                  ...
                  (let (tl,rt) = FanOps.to_generalized t in
                   `TyCol
                     (_loc, (`Id (_loc, (s :>ident))),
                       (match tl with
                        | [] -> rt
                        | _ -> `Arrow (_loc, (sta_of_list1 tl), rt))) : 
