    ...
    (let symb1 = Gram.parse_origin_tokens expr in
     let symb (__strm : _ XStream.t) =
       ...
       | Some (`ANT (("list" as n),s),_loc) ->
           (XStream.junk __strm; `ExAnt (_loc, (mk_anti ~c:"expr;" n s)))
       | _ -> symb1 __strm in
  ...
  (Gram.extend (module_expr_quot : 'module_expr_quot Gram.t )
     (None,
       [(None, None,
          ...
          ([],
            (Gram.mk_action
               (fun (_loc : FanLoc.t)  -> (`MeNil _loc : 'module_expr_quot ))))])]);
            ...
            `Sself],
             (Gram.mk_action
                (fun (mb : 'module_binding0)  _  (mt : 'module_type)  _ 
                   ...
                   (`MeFun (_loc, m, mt, mb) : 'module_binding0 ))));
          ([`Skeyword ":";
           `Snterm (Gram.obj (module_type : 'module_type Gram.t ));
           `Skeyword "=";
           `Snterm (Gram.obj (module_expr : 'module_expr Gram.t ))],
            (Gram.mk_action
               (fun (me : 'module_expr)  _  (mt : 'module_type)  _ 
                  (_loc : FanLoc.t)  ->
                  (`MeTyc (_loc, me, mt) : 'module_binding0 ))));
          ([`Skeyword "=";
           `Snterm (Gram.obj (module_expr : 'module_expr Gram.t ))],
            (Gram.mk_action
            ...
            (Gram.mk_action
               (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                  ...
                  | `ANT ((""|"mexp"|"anti"|"list" as n),s) ->
                      (`MeAnt (_loc, (mk_anti ~c:"module_expr" n s)) : 
                      'module_expr )
                  | _ -> assert false)));
         ([`Stoken
          ...
          `Skeyword ")"],
           (Gram.mk_action
              (fun _  (mt : 'module_type)  _  (me : 'module_expr)  _ 
                 (_loc : FanLoc.t)  -> (`MeTyc (_loc, me, mt) : 'module_expr ))));
          ...
          `Skeyword ")"],
           (Gram.mk_action
              (fun _  (p : 'package_type)  _  (e : 'expr)  _  _ 
                 (_loc : FanLoc.t)  ->
                 (`MePkg (_loc, (`ExTyc (_loc, e, (`TyPkg (_loc, p))))) : 
                 'module_expr ))))])]));
          ...
          [([`Sself; `Skeyword "and"; `Sself],
             (Gram.mk_action
                (fun (b2 : 'module_binding_quot)  _ 
                   ...
                   (`MbAnd (_loc, b1, b2) : 'module_binding_quot ))));
          ([`Stoken
              (((function
            ...
            (Gram.mk_action
               (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                  ...
                  | `ANT (("module_binding"|"anti"|"" as n),s) ->
                      (`MbAnt (_loc, (mk_anti ~c:"module_binding" n s)) : 
                      'module_binding_quot )
                  | _ -> assert false)));
          ([`Snterm (Gram.obj (a_UIDENT : 'a_UIDENT Gram.t ));
           `Skeyword ":";
           `Snterm (Gram.obj (module_type : 'module_type Gram.t ))],
            (Gram.mk_action
               (fun (mt : 'module_type)  _  (m : 'a_UIDENT) 
                  (_loc : FanLoc.t)  ->
                  (`MbCol (_loc, m, mt) : 'module_binding_quot ))));
          ([`Snterm (Gram.obj (a_UIDENT : 'a_UIDENT Gram.t ));
           `Skeyword ":";
           `Snterm (Gram.obj (module_type : 'module_type Gram.t ));
           `Skeyword "=";
           `Snterm (Gram.obj (module_expr : 'module_expr Gram.t ))],
            (Gram.mk_action
               (fun (me : 'module_expr)  _  (mt : 'module_type)  _ 
                  ...
                  (`MbColEq (_loc, m, mt, me) : 'module_binding_quot ))));
          ([],
            (Gram.mk_action
               (fun (_loc : FanLoc.t)  ->
                  (`MbNil _loc : 'module_binding_quot ))))])]);
          ...
          [([`Sself; `Skeyword "and"; `Sself],
             (Gram.mk_action
                (fun (b2 : 'module_binding)  _  (b1 : 'module_binding) 
                   (_loc : FanLoc.t)  ->
                   (`MbAnd (_loc, b1, b2) : 'module_binding ))));
          ([`Stoken
              (((function
          ...
          ([`Snterm (Gram.obj (a_UIDENT : 'a_UIDENT Gram.t ));
           ...
           `Snterm (Gram.obj (module_expr : 'module_expr Gram.t ))],
            (Gram.mk_action
               (fun (me : 'module_expr)  _  (mt : 'module_type)  _ 
                  (m : 'a_UIDENT)  (_loc : FanLoc.t)  ->
                  (`MbColEq (_loc, m, mt, me) : 'module_binding ))))])]);
          ...
          [([`Sself; `Skeyword "and"; `Sself],
             (Gram.mk_action
                (fun (m2 : 'module_rec_declaration)  _ 
                   ...
                   (`MbAnd (_loc, m1, m2) : 'module_rec_declaration ))));
          ([`Stoken
              (((function
                 | `ANT ((""|"module_binding"|"anti"|"list"),_) -> true
                 | _ -> false)),
          ...
          ([`Snterm (Gram.obj (a_UIDENT : 'a_UIDENT Gram.t ));
           ...
           `Snterm (Gram.obj (module_type : 'module_type Gram.t ))],
            (Gram.mk_action
               (fun (mt : 'module_type)  _  (m : 'a_UIDENT) 
                  (_loc : FanLoc.t)  ->
                  (`MbCol (_loc, m, mt) : 'module_rec_declaration ))))])]));
  (Gram.extend (with_constr_quot : 'with_constr_quot Gram.t )
     (None,
       [(None, None,
          ...
          ([],
            (Gram.mk_action
               (fun (_loc : FanLoc.t)  -> (`WcNil _loc : 'with_constr_quot ))))])]);
          ...
          [([`Sself; `Skeyword "and"; `Sself],
             (Gram.mk_action
                (fun (wc2 : 'with_constr)  _  (wc1 : 'with_constr) 
                   (_loc : FanLoc.t)  ->
                   (`WcAnd (_loc, wc1, wc2) : 'with_constr ))));
          ([`Stoken
              (((function
            ...
            (Gram.mk_action
               (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                  ...
                  | `ANT ((""|"with_constr"|"anti"|"list" as n),s) ->
                      (`WcAnt (_loc, (mk_anti ~c:"with_constr" n s)) : 
                      'with_constr )
                  | _ -> assert false)));
          ([`Stoken
              (((function | `QUOTATION _ -> true | _ -> false)),
            ...
            (Gram.mk_action
               (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                  ...
                  | `ANT ((""|"mtyp"|"anti"|"list" as n),s) ->
                      (`MtAnt (_loc, (mk_anti ~c:"module_type" n s)) : 
                      'module_type )
                  | _ -> assert false)));
         ([`Stoken
             (((function | `QUOTATION _ -> true | _ -> false)),
   ...
   Gram.extend (module_type_quot : 'module_type_quot Gram.t )
     (None,
       [(None, None,
          ...
          ([],
            (Gram.mk_action
               (fun (_loc : FanLoc.t)  -> (`MtNil _loc : 'module_type_quot ))))])]));
  (Gram.extend (sig_item_quot : 'sig_item_quot Gram.t )
     (None,
       [(None, None,
           ...
           `Sself],
            (Gram.mk_action
               (fun (sg2 : 'sig_item_quot)  _  (sg1 : 'sig_item) 
                  ...
                  (match sg2 with
                   | `SgNil _loc -> sg1
                   | _ -> `SgSem (_loc, sg1, sg2) : 'sig_item_quot ))));
          ([`Snterm (Gram.obj (sig_item : 'sig_item Gram.t ))],
            (Gram.mk_action
          ...
          ([],
            (Gram.mk_action
               (fun (_loc : FanLoc.t)  -> (`SgNil _loc : 'sig_item_quot ))))])]);
             ...
             (Gram.mk_action
                (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                   ...
                   | `ANT ((""|"sigi"|"anti"|"list" as n),s) ->
                       (`SgAnt (_loc, (mk_anti ~c:"sig_item" n s)) : 'sig_item )
                   | _ -> assert false)));
          ([`Stoken
              (((function | `QUOTATION _ -> true | _ -> false)),
                (`Normal, "`QUOTATION _"))],
           ...
           `Snterm (Gram.obj (string_list : 'string_list Gram.t ))],
            (Gram.mk_action
               (fun (sl : 'string_list)  _  (t : 'ctyp)  _  (i : 'a_LIDENT) 
                  _  (_loc : FanLoc.t)  ->
                  (`SgExt (_loc, i, t, sl) : 'sig_item ))));
          ([`Skeyword "include";
           `Snterm (Gram.obj (module_type : 'module_type Gram.t ))],
            (Gram.mk_action
               (fun (mt : 'module_type)  _  (_loc : FanLoc.t)  ->
                  (`SgInc (_loc, mt) : 'sig_item ))));
          ([`Skeyword "module";
           `Snterm (Gram.obj (a_UIDENT : 'a_UIDENT Gram.t ));
           `Snterm
            ...
            (Gram.mk_action
               (fun (mt : 'module_declaration)  (i : 'a_UIDENT)  _ 
                  (_loc : FanLoc.t)  -> (`SgMod (_loc, i, mt) : 'sig_item ))));
          ([`Skeyword "module";
           `Skeyword "rec";
           `Snterm
             (Gram.obj
            ...
            `Skeyword ";;"],
             (Gram.mk_action
                (fun _  (dp : 'opt_expr)  (n : 'a_LIDENT)  _ 
                   (_loc : FanLoc.t)  ->
                   (([`SgDir (_loc, n, dp)], (Some _loc)) : 'interf ))));
          ([`Snterm (Gram.obj (sig_item : 'sig_item Gram.t ));
           `Snterm (Gram.obj (semi : 'semi Gram.t ));
           `Sself],
            (Gram.mk_action
          ...
          [([`Stoken
             ...
             (Gram.mk_action
                (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                   match __fan_0 with
                   | `ANT ((""|"sigi"|"anti"|"list" as n),s) ->
                       (`SgAnt (_loc, (mk_anti n ~c:"sig_item" s)) : 'sig_items )
                   | _ -> assert false)));
          ([`Stoken
              (((function
                 | `ANT ((""|"sigi"|"anti"|"list"),_) -> true
           ...
           `Sself],
            (Gram.mk_action
               (fun (sg : 'sig_items)  _  (__fan_0 : [> FanToken.t]) 
                  ...
                  | `ANT ((""|"sigi"|"anti"|"list" as n),s) ->
                      (`SgSem
                         (_loc, (`SgAnt (_loc, (mk_anti n ~c:"sig_item" s))),
                           sg) : 'sig_items )
                  | _ -> assert false)));
          ([`Slist0
           ...
           `Snterm (Gram.obj (sem_expr : 'sem_expr Gram.t ))],
            (Gram.mk_action
               (fun (e2 : 'sem_expr)  _  (e1 : 'expr)  (_loc : FanLoc.t)  ->
                  (`ExSem (_loc, e1, e2) : 'expr_quot ))));
          ([`Snterm (Gram.obj (expr : 'expr Gram.t ))],
            (Gram.mk_action
               (fun (e : 'expr)  (_loc : FanLoc.t)  -> (e : 'expr_quot ))));
          ([],
            (Gram.mk_action
               (fun (_loc : FanLoc.t)  -> (`ExNil _loc : 'expr_quot ))))])]);
           ...
           `Snterm (Gram.obj (expr : 'expr Gram.t ))],
            (Gram.mk_action
               (fun (e : 'expr)  _  (t2 : 'ctyp)  _ 
                  ...
                  (let u = `TyPol (_loc, t1, t2) in `ExTyc (_loc, e, u) : 
                  'cvalue_binding ))));
          ([`Skeyword ":";
           ...
           `Snterm (Gram.obj (expr : 'expr Gram.t ))],
            (Gram.mk_action
               (fun (e : 'expr)  _  (t : 'ctyp)  _  (_loc : FanLoc.t)  ->
                  (`ExCoe (_loc, e, (`TyNil _loc), t) : 'cvalue_binding ))))])]);
            ...
            `Sself],
             (Gram.mk_action
                (fun (e : 'fun_binding)  _  (i : 'a_LIDENT)  _  _ 
                   (_loc : FanLoc.t)  -> (`ExFUN (_loc, i, e) : 'fun_binding ))));
            ...
            `Skeyword ")"],
             (Gram.mk_action
                (fun _  (i : 'a_LIDENT)  _  _  (_loc : FanLoc.t)  ->
                   (fun e  -> `ExFUN (_loc, i, e) : 'fun_def_patt ))));
          ([`Snterm (Gram.obj (ipatt : 'ipatt Gram.t ))],
            (Gram.mk_action
               (fun (p : 'ipatt)  (_loc : FanLoc.t)  ->
                  (fun e  -> `ExFun (_loc, (`McArr (_loc, p, (`ExNil _loc), e))) : 
                  'fun_def_patt ))));
          ([`Snterm (Gram.obj (ipatt : 'ipatt Gram.t ));
           `Skeyword "when";
           `Snterm (Gram.obj (expr : 'expr Gram.t ))],
            (Gram.mk_action
               (fun (w : 'expr)  _  (p : 'ipatt)  (_loc : FanLoc.t)  ->
                  (fun e  -> `ExFun (_loc, (`McArr (_loc, p, w, e))) : 
                  'fun_def_patt ))))])]);
   ...
   Gram.extend (opt_expr : 'opt_expr Gram.t )
     (None,
       [(None, None,
          ...
          ([],
            (Gram.mk_action
               (fun (_loc : FanLoc.t)  -> (`ExNil _loc : 'opt_expr ))))])]);
            ...
            `Sself],
             (Gram.mk_action
                (fun (x : 'expr)  _  (bi : 'binding)  (r : 'opt_rec)  _ 
                   (_loc : FanLoc.t)  -> (`ExLet (_loc, r, bi, x) : 'expr ))));
          ([`Skeyword "let";
           `Skeyword "module";
           `Snterm (Gram.obj (a_UIDENT : 'a_UIDENT Gram.t ));
           ...
           `Sself],
            (Gram.mk_action
               (fun (e : 'expr)  _  (i : 'module_longident)  _  _ 
                  (_loc : FanLoc.t)  -> (`ExOpI (_loc, i, e) : 'expr ))));
          ([`Skeyword "let";
           `Skeyword "try";
           `Snterm (Gram.obj (opt_rec : 'opt_rec Gram.t ));
           `Snterm (Gram.obj (binding : 'binding Gram.t ));
           ...
           `Sself],
            (Gram.mk_action
               (fun (e3 : 'expr)  _  (e2 : 'expr)  _  (e1 : 'expr)  _ 
                  (_loc : FanLoc.t)  -> (`ExIfe (_loc, e1, e2, e3) : 'expr ))));
          ([`Skeyword "if"; `Sself; `Skeyword "then"; `Sself],
            (Gram.mk_action
               (fun (e2 : 'expr)  _  (e1 : 'expr)  _  (_loc : FanLoc.t)  ->
                  (`ExIfe (_loc, e1, e2, (`ExId (_loc, (`IdUid (_loc, "()"))))) : 
                  'expr ))));
          ([`Skeyword "do";
            ...
            (Gram.mk_action
               (fun _  (seq : 'sequence)  _  (e2 : 'expr) 
                  (df : 'direction_flag)  (e1 : 'expr)  _  (i : 'a_LIDENT)  _
                   (_loc : FanLoc.t)  ->
                  (`ExFor (_loc, i, e1, e2, df, seq) : 'expr ))));
          ([`Skeyword "while";
           `Sself;
           `Skeyword "do";
           `Snterm (Gram.obj (sequence : 'sequence Gram.t ));
           `Skeyword "done"],
            (Gram.mk_action
               (fun _  (seq : 'sequence)  _  (e : 'expr)  _ 
                  (_loc : FanLoc.t)  -> (`ExWhi (_loc, e, seq) : 'expr ))))]);
       ((Some ":="), (Some `NA),
         [([`Sself; `Skeyword ":="; `Sself],
            (Gram.mk_action
               (fun (e2 : 'expr)  _  (e1 : 'expr)  (_loc : FanLoc.t)  ->
                  (`ExAss
                     (_loc,
                       (`ExAcc
                          (_loc, e1,
                            (`ExId (_loc, (`IdLid (_loc, "contents")))))), e2) : 
                  'expr ))));
         ([`Sself; `Skeyword "<-"; `Sself],
           (Gram.mk_action
              (fun (e2 : 'expr)  _  (e1 : 'expr)  (_loc : FanLoc.t)  ->
            ...
            (Gram.mk_action
               (fun (e2 : 'expr)  _  (e1 : 'expr)  (_loc : FanLoc.t)  ->
                  (`ExApp
                     (_loc,
                       (`ExApp
                          (_loc, (`ExId (_loc, (`IdLid (_loc, "land")))), e1)),
                       e2) : 'expr ))));
         ([`Sself; `Skeyword "lor"; `Sself],
           (Gram.mk_action
              (fun (e2 : 'expr)  _  (e1 : 'expr)  (_loc : FanLoc.t)  ->
                 (`ExApp
                    (_loc,
                      (`ExApp (_loc, (`ExId (_loc, (`IdLid (_loc, "lor")))), e1)),
                      e2) : 'expr ))));
           ...
           (Gram.mk_action
              (fun (e2 : 'expr)  _  (e1 : 'expr)  (_loc : FanLoc.t)  ->
                 (`ExApp
                    (_loc,
                      (`ExApp
                         (_loc, (`ExId (_loc, (`IdLid (_loc, "lxor")))), e1)),
                      e2) : 'expr ))));
         ([`Sself; `Skeyword "mod"; `Sself],
           (Gram.mk_action
              (fun (e2 : 'expr)  _  (e1 : 'expr)  (_loc : FanLoc.t)  ->
                 (`ExApp
                    (_loc,
                      (`ExApp (_loc, (`ExId (_loc, (`IdLid (_loc, "mod")))), e1)),
                      e2) : 'expr ))));
            ...
            (Gram.mk_action
               (fun (e2 : 'expr)  _  (e1 : 'expr)  (_loc : FanLoc.t)  ->
                  (`ExApp
                     (_loc,
                       (`ExApp
                          (_loc, (`ExId (_loc, (`IdLid (_loc, "asr")))), e1)),
                       e2) : 'expr ))));
         ([`Sself; `Skeyword "lsl"; `Sself],
           (Gram.mk_action
              (fun (e2 : 'expr)  _  (e1 : 'expr)  (_loc : FanLoc.t)  ->
                 (`ExApp
                    (_loc,
                      (`ExApp (_loc, (`ExId (_loc, (`IdLid (_loc, "lsl")))), e1)),
                      e2) : 'expr ))));
         ([`Sself; `Skeyword "lsr"; `Sself],
           (Gram.mk_action
              (fun (e2 : 'expr)  _  (e1 : 'expr)  (_loc : FanLoc.t)  ->
                 (`ExApp
                    (_loc,
                      (`ExApp (_loc, (`ExId (_loc, (`IdLid (_loc, "lsr")))), e1)),
                      e2) : 'expr ))));
          ...
          `Skeyword "end"],
           (Gram.mk_action
              (fun _  (cst : 'class_structure)  (csp : 'opt_class_self_patt) 
                 _  (_loc : FanLoc.t)  -> (`ExObj (_loc, csp, cst) : 'expr ))))]);
          ...
          `Sself],
           (Gram.mk_action
              (fun (e : 'expr)  (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)
                  ->
                 match __fan_0 with
                 | `OPTLABEL i -> (`ExOlb (_loc, i, e) : 'expr )
                 | _ -> assert false)));
         ([`Skeyword "?";
          `Snterm (Gram.obj (a_LIDENT : 'a_LIDENT Gram.t ));
          `Skeyword ":";
          ...
          `Snterm (Gram.obj (label : 'label Gram.t ))],
           (Gram.mk_action
              (fun (lab : 'label)  _  (e : 'expr)  (_loc : FanLoc.t)  ->
                 (`ExSnd (_loc, e, lab) : 'expr ))))]);
       ((Some "~-"), (Some `NA),
         [([`Skeyword "!"; `Sself],
            (Gram.mk_action
               (fun (e : 'expr)  _  (_loc : FanLoc.t)  ->
                  (`ExAcc (_loc, e, (`ExId (_loc, (`IdLid (_loc, "contents"))))) : 
                  'expr ))));
       ...
       ((Some "simple"), None,
              ...
              (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                 ...
                 | `ANT
                     (("exp"|""|"anti"|"`bool"|"tup"|"seq"|"int"|"`int"|"int32"|"`int32"|"int64"|"`int64"|"nativeint"|"`nativeint"|"flo"|"`flo"|"chr"|"`chr"|"str"|"`str"
                         as n),s)
                     -> (`ExAnt (_loc, (mk_anti ~c:"expr" n s)) : 'expr )
                 | _ -> assert false)));
         ([`Stoken
          ...
          `Skeyword "]"],
           (Gram.mk_action
              (fun _  (mk_list : 'sem_expr_for_list)  _  (_loc : FanLoc.t) 
                 -> (mk_list (`ExId (_loc, (`IdUid (_loc, "[]")))) : 'expr ))));
         ([`Skeyword "[|"; `Skeyword "|]"],
           (Gram.mk_action
              (fun _  _  (_loc : FanLoc.t)  ->
                 (`ExArr (_loc, (`ExNil _loc)) : 'expr ))));
         ([`Skeyword "[|";
          `Snterm (Gram.obj (sem_expr : 'sem_expr Gram.t ));
          `Skeyword "|]"],
           (Gram.mk_action
          ...
          `Skeyword "}"],
           (Gram.mk_action
              (fun _  (el : 'label_expr_list)  _  (__fan_1 : [> FanToken.t]) 
                 ...
                 match __fan_1 with
                 | `LID x ->
                     (`ExRec (_loc, el, (`ExId (_loc, (`IdLid (_loc, x))))) : 
                     'expr )
                 | _ -> assert false)));
         ([`Skeyword "{";
          `Snterm (Gram.obj (label_expr_list : 'label_expr_list Gram.t ));
          ...
          `Skeyword "}"],
           (Gram.mk_action
              (fun _  (el : 'label_expr_list)  _  _  (e : 'expr)  _  _ 
                 (_loc : FanLoc.t)  -> (`ExRec (_loc, el, e) : 'expr ))));
         ([`Skeyword "{<"; `Skeyword ">}"],
           (Gram.mk_action
              (fun _  _  (_loc : FanLoc.t)  ->
                 (`ExOvr (_loc, (`RbNil _loc)) : 'expr ))));
         ([`Skeyword "{<";
          ...
          `Skeyword ")"],
           (Gram.mk_action
              (fun _  (seq : 'sequence)  _  (e : 'expr)  _  (_loc : FanLoc.t)
                  ->
                 (Expr.mksequence ~loc:_loc (`ExSem (_loc, e, seq)) : 
                 'expr ))));
         ...
         ([`Skeyword "(";
          ...
          `Skeyword ")"],
           (Gram.mk_action
              (fun _  (t : 'ctyp)  _  (e : 'expr)  _  (_loc : FanLoc.t)  ->
                 (`ExCoe (_loc, e, (`TyNil _loc), t) : 'expr ))));
         ([`Skeyword "("; `Sself; `Skeyword ")"],
           (Gram.mk_action
          ...
          `Skeyword ")"],
           (Gram.mk_action
              (fun _  (pt : 'package_type)  _  (me : 'module_expr)  _  _ 
                 (_loc : FanLoc.t)  ->
                 (`ExPkg (_loc, (`MeTyc (_loc, me, pt))) : 'expr ))))])]);
           ...
           `Sself],
            (Gram.mk_action
               (fun (el : 'sequence)  _  (bi : 'binding)  (rf : 'opt_rec)  _ 
                  (_loc : FanLoc.t)  ->
                  (`ExLet (_loc, rf, bi, (Expr.mksequence ~loc:_loc el)) : 
                  'sequence ))));
          ([`Skeyword "let";
           `Skeyword "module";
           `Snterm (Gram.obj (a_UIDENT : 'a_UIDENT Gram.t ));
           ...
           `Sself],
            (Gram.mk_action
               (fun (el : 'sequence)  _  (mb : 'module_binding0) 
                  (m : 'a_UIDENT)  _  _  (_loc : FanLoc.t)  ->
                  (`ExLmd (_loc, m, mb, (Expr.mksequence ~loc:_loc el)) : 
                  'sequence ))));
          ([`Skeyword "let";
           `Skeyword "open";
           `Snterm (Gram.obj (module_longident : 'module_longident Gram.t ));
           ...
           `Sself],
            (Gram.mk_action
               (fun (e : 'sequence)  _  (i : 'module_longident)  _  _ 
                  (_loc : FanLoc.t)  -> (`ExOpI (_loc, i, e) : 'sequence ))));
          ([`Stoken
            ...
            (Gram.mk_action
               (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                  match __fan_0 with
                  | `ANT (("list" as n),s) ->
                      (`ExAnt (_loc, (mk_anti ~c:"expr;" n s)) : 'sequence )
                  | _ -> assert false)));
          ([`Snterm (Gram.obj (expr : 'expr Gram.t ));
           `Snterm (Gram.obj (sequence' : 'sequence' Gram.t ))],
            (Gram.mk_action
          ...
          ([`Skeyword ";"; `Snterm (Gram.obj (sequence : 'sequence Gram.t ))],
            (Gram.mk_action
               (fun (el : 'sequence)  _  (_loc : FanLoc.t)  ->
                  (fun e  -> `ExSem (_loc, e, el) : 'sequence' ))))])]);
          ...
          [([Gram.srules infixop1
             ...
             (Gram.mk_action
                (fun (x : 'e__3)  (_loc : FanLoc.t)  ->
                   (`ExId (_loc, (`IdLid (_loc, x))) : 'infixop1 ))))])]);
          ...
          [([Gram.srules infixop0
             ...
             (Gram.mk_action
                (fun (x : 'e__4)  (_loc : FanLoc.t)  ->
                   (`ExId (_loc, (`IdLid (_loc, x))) : 'infixop0 ))))])]);
          ...
          ([`Stoken
            ...
            (Gram.mk_action
               (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                  match __fan_0 with
                  | `ANT (("list" as n),s) ->
                      (`ExAnt (_loc, (mk_anti ~c:"expr," n s)) : 'comma_expr )
                  | _ -> assert false)));
  ...
  (Gram.extend (binding_quot : 'binding_quot Gram.t )
     (None,
       [(None, None,
          ...
          ([],
            (Gram.mk_action
               (fun (_loc : FanLoc.t)  -> (`BiNil _loc : 'binding_quot ))))])]);
             ...
             (Gram.mk_action
                (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                   ...
                   | `ANT (("binding"|"list" as n),s) ->
                       (`BiAnt (_loc, (mk_anti ~c:"binding" n s)) : 'binding )
                   | _ -> assert false)));
          ([`Stoken
           ...
           `Snterm (Gram.obj (expr : 'expr Gram.t ))],
            (Gram.mk_action
               (fun (e : 'expr)  _  (__fan_0 : [> FanToken.t]) 
                  ...
                  | `ANT ((""|"anti" as n),s) ->
                      (`BiEq
                         (_loc, (`PaAnt (_loc, (mk_anti ~c:"patt" n s))), e) : 
                      'binding )
                  | _ -> assert false)));
          ([`Stoken
              (((function | `ANT ((""|"anti"),_) -> true | _ -> false)),
           ...
           `Snterm (Gram.obj (expr : 'expr Gram.t ))],
            (Gram.mk_action
               (fun (e : 'expr)  _  (p : 'patt)  (_loc : FanLoc.t)  ->
                  (`McArr (_loc, p, (`ExNil _loc), e) : 'match_case ))))])]);
             ...
             (Gram.mk_action
                (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                   ...
                   | `ANT (("match_case"|"list"|"anti"|"" as n),s) ->
                       (`McAnt (_loc, (mk_anti ~c:"match_case" n s)) : 
                       'match_case0 )
                   | _ -> assert false)));
           ...
           `Snterm (Gram.obj (expr : 'expr Gram.t ))],
            (Gram.mk_action
               (fun (e : 'expr)  _  (p : 'patt_as_patt_opt) 
                  (_loc : FanLoc.t)  ->
                  (`McArr (_loc, p, (`ExNil _loc), e) : 'match_case0 ))))])]);
  ...
  (Gram.extend (rec_binding_quot : 'rec_binding_quot Gram.t )
     (None,
       [(None, None,
          ...
          ([],
            (Gram.mk_action
               (fun (_loc : FanLoc.t)  -> (`RbNil _loc : 'rec_binding_quot ))))])]);
             ...
             (Gram.mk_action
                (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                   ...
                   | `ANT (("rec_binding"|""|"anti"|"list" as n),s) ->
                       (`RbAnt (_loc, (mk_anti ~c:"rec_binding" n s)) : 
                       'label_expr )
                   | _ -> assert false)));
           ...
           `Snterm (Gram.obj (fun_binding : 'fun_binding Gram.t ))],
            (Gram.mk_action
               (fun (e : 'fun_binding)  (i : 'label_longident) 
                  (_loc : FanLoc.t)  -> (`RbEq (_loc, i, e) : 'label_expr ))));
          ([`Snterm (Gram.obj (label_longident : 'label_longident Gram.t ))],
            (Gram.mk_action
               (fun (i : 'label_longident)  (_loc : FanLoc.t)  ->
                  (`RbEq
                     (_loc, i,
                       (`ExId (_loc, (`IdLid (_loc, (Ident.to_lid i)))))) : 
                  'label_expr ))))])]);
           ...
           `Snterml ((Gram.obj (expr : 'expr Gram.t )), "top")],
            (Gram.mk_action
               (fun (e : 'expr)  _  (l : 'label)  (_loc : FanLoc.t)  ->
                  (`RbEq (_loc, (`IdLid (_loc, l)), e) : 'field_expr ))))])]);
            ...
            `Sself],
             (Gram.mk_action
                (fun (b2 : 'label_expr_list)  _  (b1 : 'label_expr) 
                   (_loc : FanLoc.t)  ->
                   (`RbSem (_loc, b1, b2) : 'label_expr_list ))));
          ([`Snterm (Gram.obj (label_expr : 'label_expr Gram.t ));
           `Skeyword ";"],
            (Gram.mk_action
            ...
            `Sself],
             (Gram.mk_action
                (fun (b2 : 'field_expr_list)  _  (b1 : 'field_expr) 
                   (_loc : FanLoc.t)  ->
                   (`RbSem (_loc, b1, b2) : 'field_expr_list ))));
          ([`Snterm (Gram.obj (field_expr : 'field_expr Gram.t ));
           `Skeyword ";"],
            (Gram.mk_action
   ...
   Gram.extend (patt_quot : 'patt_quot Gram.t )
     (None,
       [(None, None,
          ...
          ([],
            (Gram.mk_action
               (fun (_loc : FanLoc.t)  -> (`PaNil _loc : 'patt_quot ))))])]);
            ...
            `Snterm (Gram.obj (patt : 'patt Gram.t ))],
             (Gram.mk_action
                (fun (p2 : 'patt)  _  (p1 : 'patt)  (_loc : FanLoc.t)  ->
                   (`PaAli (_loc, p1, p2) : 'patt_as_patt_opt ))));
          ([`Snterm (Gram.obj (patt : 'patt Gram.t ))],
            (Gram.mk_action
     ...
     (None,
       [(None, None,
          ...
          ([],
            (Gram.mk_action
               (fun (_loc : FanLoc.t)  ->
                  (`PaNil _loc : 'opt_class_self_patt ))))])]);
          ...
          ([`Stoken
            ...
            (Gram.mk_action
               (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                  match __fan_0 with
                  | `ANT ((""|"pat"|"anti" as n),s) ->
                      (`PaAnt (_loc, (mk_anti ~c:"patt" n s)) : 'patt_constr )
                  | _ -> assert false)))])]);
   Gram.extend (patt : 'patt Gram.t )
     (None,
       ...
       ((Some "simple"), None,
               ...
               (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                  ...
                  | `ANT
                      ((""|"pat"|"anti"|"tup"|"int"|"`int"|"int32"|"`int32"|"int64"|"`int64"|"nativeint"|"`nativeint"|"flo"|"`flo"|"chr"|"`chr"|"str"|"`str"
                          as n),s)
                      -> (`PaAnt (_loc, (mk_anti ~c:"patt" n s)) : 'patt )
                  | _ -> assert false)));
         ([`Snterm (Gram.obj (ident : 'ident Gram.t ))],
           (Gram.mk_action
              (fun (i : 'ident)  (_loc : FanLoc.t)  ->
         ...
         ([`Skeyword "-";
          `Stoken
           ...
           (Gram.mk_action
              (fun (__fan_1 : [> FanToken.t])  _  (_loc : FanLoc.t)  ->
                 match __fan_1 with
                 | `FLO (_,s) -> (`PaFlo (_loc, (String.neg s)) : 'patt )
                 | _ -> assert false)));
         ([`Skeyword "["; `Skeyword "]"],
           (Gram.mk_action
              (fun _  _  (_loc : FanLoc.t)  ->
                 (`PaId (_loc, (`IdUid (_loc, "[]"))) : 'patt ))));
         ([`Skeyword "[";
          ...
          `Skeyword "]"],
           (Gram.mk_action
              (fun _  (mk_list : 'sem_patt_for_list)  _  (_loc : FanLoc.t) 
                 -> (mk_list (`PaId (_loc, (`IdUid (_loc, "[]")))) : 'patt ))));
         ([`Skeyword "[|"; `Skeyword "|]"],
           (Gram.mk_action
              (fun _  _  (_loc : FanLoc.t)  ->
                 (`PaArr (_loc, (`PaNil _loc)) : 'patt ))));
         ([`Skeyword "[|";
          `Snterm (Gram.obj (sem_patt : 'sem_patt Gram.t ));
          `Skeyword "|]"],
           (Gram.mk_action
          ...
          `Skeyword ")"],
           (Gram.mk_action
              (fun _  (pt : 'package_type)  _  (m : 'a_UIDENT)  _  _ 
                 (_loc : FanLoc.t)  ->
                 (`PaTyc (_loc, (`PaMod (_loc, m)), (`TyPkg (_loc, pt))) : 
                 'patt ))));
         ([`Skeyword "("; `Sself; `Skeyword ")"],
           (Gram.mk_action
         ...
         ([`Skeyword "_"],
           (Gram.mk_action
              (fun _  (_loc : FanLoc.t)  -> (`PaAny _loc : 'patt ))));
         ([`Stoken
             (((function | `LABEL _ -> true | _ -> false)),
               (`Normal, "`LABEL _"));
          `Sself],
          ...
          `Stoken
           ...
           (Gram.mk_action
              (fun (__fan_1 : [> FanToken.t])  _  (_loc : FanLoc.t)  ->
                 match __fan_1 with
                 | `ANT ((""|"lid" as n),i) ->
                     (`PaLab (_loc, (mk_anti n i), (`PaNil _loc)) : 'patt )
                 | _ -> assert false)));
         ([`Skeyword "~";
          `Stoken
            (((function | `LID _ -> true | _ -> false)), (`Normal, "`LID _"))],
           (Gram.mk_action
              (fun (__fan_1 : [> FanToken.t])  _  (_loc : FanLoc.t)  ->
                 match __fan_1 with
                 | `LID i -> (`PaLab (_loc, i, (`PaNil _loc)) : 'patt )
                 | _ -> assert false)));
         ([`Stoken
             (((function | `OPTLABEL _ -> true | _ -> false)),
               (`Normal, "`OPTLABEL _"));
         ...
         ([`Skeyword "?";
          `Stoken
           ...
           (Gram.mk_action
              (fun (__fan_1 : [> FanToken.t])  _  (_loc : FanLoc.t)  ->
                 match __fan_1 with
                 | `LID i -> (`PaOlb (_loc, i, (`PaNil _loc)) : 'patt )
                 | _ -> assert false)));
         ([`Skeyword "?";
          `Stoken
            (((function | `ANT ((""|"lid"),_) -> true | _ -> false)),
           ...
           (Gram.mk_action
              (fun (__fan_1 : [> FanToken.t])  _  (_loc : FanLoc.t)  ->
                 match __fan_1 with
                 | `ANT ((""|"lid" as n),i) ->
                     (`PaOlb (_loc, (mk_anti n i), (`PaNil _loc)) : 'patt )
                 | _ -> assert false)));
         ([`Skeyword "?";
          `Skeyword "(";
          ...
          `Skeyword ")"],
           (Gram.mk_action
              (fun _  (e : 'expr)  _  (p : 'ipatt_tcon)  _  _ 
                 (_loc : FanLoc.t)  -> (`PaOlbi (_loc, "", p, e) : 'patt ))))])]);
   Gram.extend (ipatt : 'ipatt Gram.t )
     (None,
       [(None, None,
            ...
            (Gram.mk_action
               (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                  ...
                  | `ANT ((""|"pat"|"anti"|"tup" as n),s) ->
                      (`PaAnt (_loc, (mk_anti ~c:"patt" n s)) : 'ipatt )
                  | _ -> assert false)));
          ([`Skeyword "("; `Skeyword ")"],
            (Gram.mk_action
               (fun _  _  (_loc : FanLoc.t)  ->
                  (`PaId (_loc, (`IdUid (_loc, "()"))) : 'ipatt ))));
          ([`Skeyword "(";
           `Skeyword "module";
           `Snterm (Gram.obj (a_UIDENT : 'a_UIDENT Gram.t ));
           `Skeyword ")"],
          ...
          ([`Skeyword "_"],
            (Gram.mk_action
               (fun _  (_loc : FanLoc.t)  -> (`PaAny _loc : 'ipatt ))));
          ([`Stoken
              (((function | `LABEL _ -> true | _ -> false)),
                (`Normal, "`LABEL _"));
           `Sself],
           ...
           `Stoken
            ...
            (Gram.mk_action
               (fun (__fan_1 : [> FanToken.t])  _  (_loc : FanLoc.t)  ->
                  match __fan_1 with
                  | `ANT ((""|"lid" as n),i) ->
                      (`PaLab (_loc, (mk_anti n i), (`PaNil _loc)) : 'ipatt )
                  | _ -> assert false)));
          ([`Skeyword "~";
           `Stoken
            ...
            (Gram.mk_action
               (fun (__fan_1 : [> FanToken.t])  _  (_loc : FanLoc.t)  ->
                  match __fan_1 with
                  | `LID i -> (`PaLab (_loc, i, (`PaNil _loc)) : 'ipatt )
                  | _ -> assert false)));
          ([`Stoken
              (((function | `OPTLABEL _ -> true | _ -> false)),
                (`Normal, "`OPTLABEL _"));
          ...
          ([`Skeyword "?";
           `Stoken
            ...
            (Gram.mk_action
               (fun (__fan_1 : [> FanToken.t])  _  (_loc : FanLoc.t)  ->
                  match __fan_1 with
                  | `LID i -> (`PaOlb (_loc, i, (`PaNil _loc)) : 'ipatt )
                  | _ -> assert false)));
          ([`Skeyword "?";
           `Stoken
             (((function | `ANT ((""|"lid"),_) -> true | _ -> false)),
            ...
            (Gram.mk_action
               (fun (__fan_1 : [> FanToken.t])  _  (_loc : FanLoc.t)  ->
                  match __fan_1 with
                  | `ANT ((""|"lid" as n),i) ->
                      (`PaOlb (_loc, (mk_anti n i), (`PaNil _loc)) : 'ipatt )
                  | _ -> assert false)));
          ([`Skeyword "?";
           `Skeyword "(";
           `Snterm (Gram.obj (ipatt_tcon : 'ipatt_tcon Gram.t ));
          ...
          ([`Skeyword "?";
           ...
           `Skeyword ")"],
            (Gram.mk_action
               (fun _  (e : 'expr)  _  (p : 'ipatt_tcon)  _  _ 
                  (_loc : FanLoc.t)  -> (`PaOlbi (_loc, "", p, e) : 'ipatt ))))])]);
          ...
          [([`Stoken
             ...
             (Gram.mk_action
                (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                   match __fan_0 with
                   | `ANT ((""|"anti" as n),s) ->
                       (`PaAnt (_loc, (mk_anti ~c:"patt" n s)) : 'ipatt_tcon )
                   | _ -> assert false)));
          ([`Snterm (Gram.obj (a_LIDENT : 'a_LIDENT Gram.t ))],
            (Gram.mk_action
               (fun (i : 'a_LIDENT)  (_loc : FanLoc.t)  ->
                  (`PaId (_loc, (`IdLid (_loc, i))) : 'ipatt_tcon ))));
          ([`Snterm (Gram.obj (a_LIDENT : 'a_LIDENT Gram.t ));
           `Skeyword ":";
           `Snterm (Gram.obj (ctyp : 'ctyp Gram.t ))],
            (Gram.mk_action
               (fun (t : 'ctyp)  _  (i : 'a_LIDENT)  (_loc : FanLoc.t)  ->
                  (`PaTyc (_loc, (`PaId (_loc, (`IdLid (_loc, i)))), t) : 
                  'ipatt_tcon ))))])]);
     ...
     (None,
       [(None, None,
          [([`Skeyword "="; `Snterm (Gram.obj (expr : 'expr Gram.t ))],
             (Gram.mk_action
                (fun (e : 'expr)  _  (_loc : FanLoc.t)  ->
                   (fun i  p  -> `PaOlbi (_loc, i, p, e) : 'eq_expr ))));
          ([],
            (Gram.mk_action
               (fun (_loc : FanLoc.t)  ->
                  (fun i  p  -> `PaOlb (_loc, i, p) : 'eq_expr ))))])]);
          ...
          ([`Stoken
            ...
            (Gram.mk_action
               (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                  match __fan_0 with
                  | `ANT (("list" as n),s) ->
                      (`PaAnt (_loc, (mk_anti ~c:"patt," n s)) : 'comma_ipatt )
                  | _ -> assert false)));
          ([`Snterm (Gram.obj (ipatt : 'ipatt Gram.t ))],
            (Gram.mk_action
          ...
          ([`Stoken
            ...
            (Gram.mk_action
               (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                  match __fan_0 with
                  | `ANT (("list" as n),s) ->
                      (`PaAnt (_loc, (mk_anti ~c:"patt," n s)) : 'comma_patt )
                  | _ -> assert false)));
          ([`Snterm (Gram.obj (patt : 'patt Gram.t ))],
            (Gram.mk_action
            ...
            `Sself],
             (Gram.mk_action
                (fun (p2 : 'label_patt_list)  _  (p1 : 'label_patt) 
                   (_loc : FanLoc.t)  ->
                   (`PaSem (_loc, p1, p2) : 'label_patt_list ))));
          ([`Snterm (Gram.obj (label_patt : 'label_patt Gram.t ));
           `Skeyword ";";
           `Skeyword "_"],
            (Gram.mk_action
               (fun _  _  (p1 : 'label_patt)  (_loc : FanLoc.t)  ->
                  (`PaSem (_loc, p1, (`PaAny _loc)) : 'label_patt_list ))));
          ([`Snterm (Gram.obj (label_patt : 'label_patt Gram.t ));
           `Skeyword ";";
           `Skeyword "_";
           `Skeyword ";"],
          ...
          [([`Stoken
             ...
             (Gram.mk_action
                (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                   match __fan_0 with
                   | `ANT ((""|"pat"|"anti" as n),s) ->
                       (`PaAnt (_loc, (mk_anti ~c:"patt" n s)) : 'label_patt )
                   | _ -> assert false)));
          ([`Stoken
              (((function | `QUOTATION _ -> true | _ -> false)),
                (`Normal, "`QUOTATION _"))],
          ...
          ([`Snterm (Gram.obj (label_longident : 'label_longident Gram.t ))],
            (Gram.mk_action
               (fun (i : 'label_longident)  (_loc : FanLoc.t)  ->
                  (`PaEq
                     (_loc, i,
                       (`PaId (_loc, (`IdLid (_loc, (Ident.to_lid i)))))) : 
                  'label_patt ))))])]));
       ...
       [(None, None,
            ...
            `Snterm (Gram.obj (comma_ctyp : 'comma_ctyp Gram.t ))],
             (Gram.mk_action
                (fun (y : 'comma_ctyp)  _  (x : 'more_ctyp) 
                   (_loc : FanLoc.t)  -> (`TyCom (_loc, x, y) : 'ctyp_quot ))));
          ([`Snterm (Gram.obj (more_ctyp : 'more_ctyp Gram.t ));
           `Skeyword ";";
           `Snterm
             (Gram.obj
           ...
           `Snterm
            ...
            (Gram.mk_action
               (fun (y : 'constructor_declarations)  _  (x : 'more_ctyp) 
                  (_loc : FanLoc.t)  -> (`TyOr (_loc, x, y) : 'ctyp_quot ))));
          ([`Snterm (Gram.obj (more_ctyp : 'more_ctyp Gram.t ));
           `Skeyword "of";
           `Snterm
            ...
            (Gram.mk_action
               (fun (y : 'constructor_arg_list)  _  (x : 'more_ctyp) 
                  (_loc : FanLoc.t)  -> (`TyOf (_loc, x, y) : 'ctyp_quot ))));
          ([`Snterm (Gram.obj (more_ctyp : 'more_ctyp Gram.t ));
           `Skeyword "of";
           `Snterm
             (Gram.obj (constructor_arg_list : 'constructor_arg_list Gram.t ));
           ...
           `Snterm
            ...
            (Gram.mk_action
               (fun (z : 'constructor_declarations)  _ 
                  ...
                  (_loc : FanLoc.t)  ->
                  (`TyOr (_loc, (`TyOf (_loc, x, y)), z) : 'ctyp_quot ))));
          ([`Snterm (Gram.obj (more_ctyp : 'more_ctyp Gram.t ));
           `Skeyword "of";
           `Skeyword "&";
           ...
           `Snterm (Gram.obj (row_field : 'row_field Gram.t ))],
            (Gram.mk_action
               (fun (z : 'row_field)  _  (y : 'amp_ctyp)  _  _ 
                  ...
                  (`TyOr (_loc, (`TyOfAmp (_loc, x, y)), z) : 'ctyp_quot ))));
          ([`Snterm (Gram.obj (more_ctyp : 'more_ctyp Gram.t ));
           `Skeyword ":";
           `Snterm (Gram.obj (more_ctyp : 'more_ctyp Gram.t ))],
            (Gram.mk_action
          ...
          ([`Snterm (Gram.obj (more_ctyp : 'more_ctyp Gram.t ));
           ...
           `Snterm
            ...
            (Gram.mk_action
               (fun (y : 'constructor_arg_list)  _  (x : 'more_ctyp) 
                  (_loc : FanLoc.t)  -> (`TyAnd (_loc, x, y) : 'ctyp_quot ))));
          ([`Snterm (Gram.obj (more_ctyp : 'more_ctyp Gram.t ))],
            (Gram.mk_action
               (fun (x : 'more_ctyp)  (_loc : FanLoc.t)  -> (x : 'ctyp_quot ))));
          ([],
            (Gram.mk_action
               (fun (_loc : FanLoc.t)  -> (`TyNil _loc : 'ctyp_quot ))))])]);
     ...
     (None,
       [(None, None,
          [([`Stoken
             ...
             (Gram.mk_action
                (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                   match __fan_0 with
                   | `ANT ((""|"typ"|"anti" as n),s) ->
                       (`TyAnt (_loc, (mk_anti n s)) : 'type_parameter )
                   | _ -> assert false)));
          ([`Stoken
              (((function | `QUOTATION _ -> true | _ -> false)),
                (`Normal, "`QUOTATION _"))],
          ...
          ([`Skeyword "'"; `Snterm (Gram.obj (a_ident : 'a_ident Gram.t ))],
            (Gram.mk_action
               (fun (i : 'a_ident)  _  (_loc : FanLoc.t)  ->
                  (`TyQuo (_loc, i) : 'type_parameter ))));
          ([`Skeyword "+";
           `Skeyword "'";
           `Snterm (Gram.obj (a_ident : 'a_ident Gram.t ))],
            (Gram.mk_action
               (fun (i : 'a_ident)  _  _  (_loc : FanLoc.t)  ->
                  (`TyQuP (_loc, i) : 'type_parameter ))));
          ([`Skeyword "-";
           `Skeyword "'";
           `Snterm (Gram.obj (a_ident : 'a_ident Gram.t ))],
            (Gram.mk_action
               (fun (i : 'a_ident)  _  _  (_loc : FanLoc.t)  ->
                  (`TyQuM (_loc, i) : 'type_parameter ))))])]);
   Gram.extend
     ...
     (None,
       [(None, None,
          [([`Stoken
             ...
             (Gram.mk_action
                (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                   match __fan_0 with
                   | `ANT ((""|"typ"|"anti" as n),s) ->
                       (`TyAnt (_loc, (mk_anti n s)) : 'optional_type_parameter )
                   | _ -> assert false)));
          ([`Stoken
              (((function | `QUOTATION _ -> true | _ -> false)),
                (`Normal, "`QUOTATION _"))],
          ...
          ([`Skeyword "'"; `Snterm (Gram.obj (a_ident : 'a_ident Gram.t ))],
            (Gram.mk_action
               (fun (i : 'a_ident)  _  (_loc : FanLoc.t)  ->
                  (`TyQuo (_loc, i) : 'optional_type_parameter ))));
          ([`Skeyword "+";
           `Skeyword "'";
           `Snterm (Gram.obj (a_ident : 'a_ident Gram.t ))],
            (Gram.mk_action
               (fun (i : 'a_ident)  _  _  (_loc : FanLoc.t)  ->
                  (`TyQuP (_loc, i) : 'optional_type_parameter ))));
          ([`Skeyword "-";
           `Skeyword "'";
           `Snterm (Gram.obj (a_ident : 'a_ident Gram.t ))],
            (Gram.mk_action
               (fun (i : 'a_ident)  _  _  (_loc : FanLoc.t)  ->
                  (`TyQuM (_loc, i) : 'optional_type_parameter ))));
          ([`Skeyword "+"; `Skeyword "_"],
            (Gram.mk_action
               (fun _  _  (_loc : FanLoc.t)  ->
                  (`TyAnP _loc : 'optional_type_parameter ))));
          ([`Skeyword "-"; `Skeyword "_"],
            (Gram.mk_action
               (fun _  _  (_loc : FanLoc.t)  ->
                  (`TyAnM _loc : 'optional_type_parameter ))));
          ([`Skeyword "_"],
            (Gram.mk_action
               (fun _  (_loc : FanLoc.t)  ->
                  (`TyAny _loc : 'optional_type_parameter ))))])]);
   Gram.extend
            ...
            `Snterm (Gram.obj (type_parameters : 'type_parameters Gram.t ))],
             (Gram.mk_action
                (fun (tpl : 'type_parameters)  (i : 'type_longident) 
                   (_loc : FanLoc.t)  ->
                   (tpl (`TyId (_loc, i)) : 'type_longident_and_parameters ))));
          ([`Stoken
              (((function | `ANT ((""|"anti"),_) -> true | _ -> false)),
                (`Normal, "`ANT ((\"\"|\"anti\"),_)"))],
            (Gram.mk_action
               (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                  match __fan_0 with
                  | `ANT ((""|"anti" as n),s) ->
                      (`TyAnt (_loc, (mk_anti n s ~c:"ctyp")) : 'type_longident_and_parameters )
                  | _ -> assert false)))])]);
     ...
     (None,
       [(None, None,
          ...
          ([],
            (Gram.mk_action
               (fun (_loc : FanLoc.t)  ->
                  (`TyNil _loc : 'opt_class_self_type ))))])]);
          ...
          [([`Stoken
             ...
             (Gram.mk_action
                (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                   match __fan_0 with
                   | `ANT ((""|"typ" as n),s) ->
                       (`TyAnt (_loc, (mk_anti ~c:"ctyp" n s)) : 'meth_decl )
                   | _ -> assert false)));
          ([`Stoken
              (((function | `ANT ("list",_) -> true | _ -> false)),
                (`Normal, "`ANT (\"list\",_)"))],
           ...
           `Snterm (Gram.obj (poly_type : 'poly_type Gram.t ))],
            (Gram.mk_action
               (fun (t : 'poly_type)  _  (lab : 'a_LIDENT)  (_loc : FanLoc.t)
                   ->
                  (`TyCol (_loc, (`TyId (_loc, (`IdLid (_loc, lab)))), t) : 
                  'meth_decl ))))])]);
          ...
          ([`Snterm (Gram.obj (opt_dot_dot : 'opt_dot_dot Gram.t ))],
            (Gram.mk_action
               (fun (v : 'opt_dot_dot)  (_loc : FanLoc.t)  ->
                  (`TyObj (_loc, (`TyNil _loc), v) : 'opt_meth_list ))))])]);
          ...
          ([`Stoken
            ...
            (Gram.mk_action
               (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                  match __fan_0 with
                  | `ANT ((""|"typ" as n),s) ->
                      (`TyAnt (_loc, (mk_anti ~c:"ctyp" n s)) : 'unquoted_typevars )
                  | _ -> assert false)));
          ([`Stoken
              (((function | `QUOTATION _ -> true | _ -> false)),
                (`Normal, "`QUOTATION _"))],
          ...
          ([`Snterm (Gram.obj (a_ident : 'a_ident Gram.t ))],
            (Gram.mk_action
               (fun (i : 'a_ident)  (_loc : FanLoc.t)  ->
                  (`TyId (_loc, (`IdLid (_loc, i))) : 'unquoted_typevars ))))])]);
          ...
          [([`Stoken
             ...
             (Gram.mk_action
                (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                   match __fan_0 with
                   | `ANT ((""|"typ" as n),s) ->
                       (`TyAnt (_loc, (mk_anti ~c:"ctyp" n s)) : 'row_field )
                   | _ -> assert false)));
          ([`Stoken
              (((function | `ANT ("list",_) -> true | _ -> false)),
                (`Normal, "`ANT (\"list\",_)"))],
          ...
          ([`Sself; `Skeyword "|"; `Sself],
            (Gram.mk_action
               (fun (t2 : 'row_field)  _  (t1 : 'row_field) 
                  (_loc : FanLoc.t)  -> (`TyOr (_loc, t1, t2) : 'row_field ))));
          ([`Skeyword "`"; `Snterm (Gram.obj (a_ident : 'a_ident Gram.t ))],
            (Gram.mk_action
               (fun (i : 'a_ident)  _  (_loc : FanLoc.t)  ->
           ...
           `Snterm (Gram.obj (amp_ctyp : 'amp_ctyp Gram.t ))],
            (Gram.mk_action
               (fun (t : 'amp_ctyp)  _  (i : 'a_ident)  _  (_loc : FanLoc.t) 
                  -> (`TyOf (_loc, (`TyVrn (_loc, i)), t) : 'row_field ))));
          ([`Snterm (Gram.obj (ctyp : 'ctyp Gram.t ))],
            (Gram.mk_action
          ...
          ([`Stoken
            ...
            (Gram.mk_action
               (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                  match __fan_0 with
                  | `ANT (("list" as n),s) ->
                      (`TyAnt (_loc, (mk_anti ~c:"ctyp&" n s)) : 'amp_ctyp )
                  | _ -> assert false)));
          ([`Snterm (Gram.obj (ctyp : 'ctyp Gram.t ))],
            (Gram.mk_action
          ...
          [([`Stoken
             ...
             (Gram.mk_action
                (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                   match __fan_0 with
                   | `ANT ((""|"typ" as n),s) ->
                       (`TyAnt (_loc, (mk_anti ~c:"ctyp" n s)) : 'name_tags )
                   | _ -> assert false)));
          ([`Sself; `Sself],
            (Gram.mk_action
   ...
   Gram.extend (opt_polyt : 'opt_polyt Gram.t )
     (None,
       [(None, None,
          ...
          ([],
            (Gram.mk_action
               (fun (_loc : FanLoc.t)  -> (`TyNil _loc : 'opt_polyt ))))])]);
          ...
          [([`Stoken
             ...
             (Gram.mk_action
                (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                   match __fan_0 with
                   | `ANT ((""|"typ"|"anti" as n),s) ->
                       (`TyAnt (_loc, (mk_anti ~c:"ctyp" n s)) : 'type_declaration )
                   | _ -> assert false)));
          ([`Stoken
              (((function | `ANT ("list",_) -> true | _ -> false)),
                (`Normal, "`ANT (\"list\",_)"))],
            (Gram.mk_action
               (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                  match __fan_0 with
                  | `ANT (("list" as n),s) ->
                      (`TyAnt (_loc, (mk_anti ~c:"ctypand" n s)) : 'type_declaration )
                  | _ -> assert false)));
          ([`Stoken
              (((function | `QUOTATION _ -> true | _ -> false)),
                (`Normal, "`QUOTATION _"))],
          ...
          ([`Sself; `Skeyword "and"; `Sself],
            (Gram.mk_action
               (fun (t2 : 'type_declaration)  _  (t1 : 'type_declaration) 
                  (_loc : FanLoc.t)  ->
                  (`TyAnd (_loc, t1, t2) : 'type_declaration ))));
          ([`Snterm
              (Gram.obj
   ...
   Gram.extend (opt_eq_ctyp : 'opt_eq_ctyp Gram.t )
     (None,
       [(None, None,
          ...
          ([],
            (Gram.mk_action
               (fun (_loc : FanLoc.t)  -> (`TyNil _loc : 'opt_eq_ctyp ))))])]);
          ...
          ([`Stoken
            ...
            (Gram.mk_action
               (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                  match __fan_0 with
                  | `ANT ((""|"typ" as n),s) ->
                      (`TyAnt (_loc, (mk_anti ~c:"ctyp" n s)) : 'typevars )
                  | _ -> assert false)));
          ([`Stoken
              (((function | `ANT ("list",_) -> true | _ -> false)),
                (`Normal, "`ANT (\"list\",_)"))],
            (Gram.mk_action
               (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                  match __fan_0 with
                  | `ANT (("list" as n),s) ->
                      (`TyAnt (_loc, (mk_anti ~c:"forall" n s)) : 'typevars )
                  | _ -> assert false)));
          ([`Stoken
              (((function | `QUOTATION _ -> true | _ -> false)),
                (`Normal, "`QUOTATION _"))],
   ...
   Gram.extend (ctyp : 'ctyp Gram.t )
     (None,
       ...
       ((Some "simple"), None,
         ...
         ([`Skeyword "_"],
           (Gram.mk_action
              (fun _  (_loc : FanLoc.t)  -> (`TyAny _loc : 'ctyp ))));
         ([`Stoken
             (((function | `ANT ((""|"typ"|"anti"),_) -> true | _ -> false)),
               (`Normal, "`ANT ((\"\"|\"typ\"|\"anti\"),_)"))],
           (Gram.mk_action
              (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                 match __fan_0 with
                 | `ANT ((""|"typ"|"anti" as n),s) ->
                     (`TyAnt (_loc, (mk_anti ~c:"ctyp" n s)) : 'ctyp )
                 | _ -> assert false)));
         ([`Stoken
           ...
           (Gram.mk_action
              (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                 match __fan_0 with
                 | `ANT (("tup" as n),s) ->
                     (`TyTup (_loc, (`TyAnt (_loc, (mk_anti ~c:"ctyp" n s)))) : 
                     'ctyp )
                 | _ -> assert false)));
         ([`Stoken
           ...
           (Gram.mk_action
              (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                 match __fan_0 with
                 | `ANT (("id" as n),s) ->
                     (`TyId (_loc, (`IdAnt (_loc, (mk_anti ~c:"ident" n s)))) : 
                     'ctyp )
                 | _ -> assert false)));
         ([`Stoken
             (((function | `QUOTATION _ -> true | _ -> false)),
         ...
         ([`Snterm (Gram.obj (a_LIDENT : 'a_LIDENT Gram.t ))],
           (Gram.mk_action
              (fun (i : 'a_LIDENT)  (_loc : FanLoc.t)  ->
                 (`TyId (_loc, (`IdLid (_loc, i))) : 'ctyp ))));
         ([`Snterm (Gram.obj (a_UIDENT : 'a_UIDENT Gram.t ))],
           (Gram.mk_action
              (fun (i : 'a_UIDENT)  (_loc : FanLoc.t)  ->
                 (`TyId (_loc, (`IdUid (_loc, i))) : 'ctyp ))));
         ([`Skeyword "(";
          `Sself;
          `Skeyword "*";
          `Snterm (Gram.obj (star_ctyp : 'star_ctyp Gram.t ));
          `Skeyword ")"],
           (Gram.mk_action
              (fun _  (tl : 'star_ctyp)  _  (t : 'ctyp)  _  (_loc : FanLoc.t)
                  -> (`TyTup (_loc, (`TySta (_loc, t, tl))) : 'ctyp ))));
         ([`Skeyword "("; `Sself; `Skeyword ")"],
           (Gram.mk_action
          ...
          [([`Stoken
             ...
             (Gram.mk_action
                (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                   match __fan_0 with
                   | `ANT ((""|"typ" as n),s) ->
                       (`TyAnt (_loc, (mk_anti ~c:"ctyp" n s)) : 'star_ctyp )
                   | _ -> assert false)));
          ([`Stoken
              (((function | `ANT ("list",_) -> true | _ -> false)),
                (`Normal, "`ANT (\"list\",_)"))],
          ...
          ([`Sself; `Skeyword "*"; `Sself],
            (Gram.mk_action
               (fun (t2 : 'star_ctyp)  _  (t1 : 'star_ctyp) 
                  (_loc : FanLoc.t)  -> (`TySta (_loc, t1, t2) : 'star_ctyp ))));
          ([`Snterm (Gram.obj (ctyp : 'ctyp Gram.t ))],
            (Gram.mk_action
          ...
          [([`Stoken
             ...
             (Gram.mk_action
                (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                   match __fan_0 with
                   | `ANT ((""|"typ" as n),s) ->
                       (`TyAnt (_loc, (mk_anti ~c:"ctyp" n s)) : 'constructor_declarations )
                   | _ -> assert false)));
          ([`Stoken
              (((function | `ANT ("list",_) -> true | _ -> false)),
                (`Normal, "`ANT (\"list\",_)"))],
          ...
          ([`Sself; `Skeyword "|"; `Sself],
            (Gram.mk_action
               (fun (t2 : 'constructor_declarations)  _ 
                  ...
                  (`TyOr (_loc, t1, t2) : 'constructor_declarations ))));
          ([`Snterm (Gram.obj (a_UIDENT : 'a_UIDENT Gram.t ));
           `Skeyword "of";
           `Snterm
             (Gram.obj (constructor_arg_list : 'constructor_arg_list Gram.t ))],
            (Gram.mk_action
               (fun (t : 'constructor_arg_list)  _  (s : 'a_UIDENT) 
                  (_loc : FanLoc.t)  ->
                  (`TyOf (_loc, (`TyId (_loc, (`IdUid (_loc, s)))), t) : 
          ...
          ([`Snterm (Gram.obj (a_UIDENT : 'a_UIDENT Gram.t ))],
            (Gram.mk_action
               (fun (s : 'a_UIDENT)  (_loc : FanLoc.t)  ->
                  (`TyId (_loc, (`IdUid (_loc, s))) : 'constructor_declarations ))))])]);
     ...
     (None,
       [(None, None,
          [([`Stoken
             ...
             (Gram.mk_action
                (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                   match __fan_0 with
                   | `ANT ((""|"typ" as n),s) ->
                       (`TyAnt (_loc, (mk_anti ~c:"ctyp" n s)) : 'constructor_declaration )
                   | _ -> assert false)));
          ([`Stoken
              (((function | `QUOTATION _ -> true | _ -> false)),
                (`Normal, "`QUOTATION _"))],
          ...
          ([`Snterm (Gram.obj (a_UIDENT : 'a_UIDENT Gram.t ))],
            (Gram.mk_action
               (fun (s : 'a_UIDENT)  (_loc : FanLoc.t)  ->
                  (`TyId (_loc, (`IdUid (_loc, s))) : 'constructor_declaration ))))])]);
          ...
          [([`Stoken
             ...
             (Gram.mk_action
                (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                   match __fan_0 with
                   | `ANT (("list" as n),s) ->
                       (`TyAnt (_loc, (mk_anti ~c:"ctypand" n s)) : 'constructor_arg_list )
                   | _ -> assert false)));
          ([`Sself; `Skeyword "and"; `Sself],
            (Gram.mk_action
               (fun (t2 : 'constructor_arg_list)  _ 
                  (t1 : 'constructor_arg_list)  (_loc : FanLoc.t)  ->
                  (`TyAnd (_loc, t1, t2) : 'constructor_arg_list ))));
          ([`Snterm (Gram.obj (ctyp : 'ctyp Gram.t ))],
            (Gram.mk_action
          ...
          [([`Stoken
             ...
             (Gram.mk_action
                (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                   match __fan_0 with
                   | `ANT ((""|"typ" as n),s) ->
                       (`TyAnt (_loc, (mk_anti ~c:"ctyp" n s)) : 'label_declaration )
                   | _ -> assert false)));
          ([`Stoken
              (((function | `ANT ("list",_) -> true | _ -> false)),
                (`Normal, "`ANT (\"list\",_)"))],
           ...
           `Snterm (Gram.obj (poly_type : 'poly_type Gram.t ))],
            (Gram.mk_action
               (fun (t : 'poly_type)  _  (s : 'a_LIDENT)  (_loc : FanLoc.t) 
                  ->
                  (`TyCol (_loc, (`TyId (_loc, (`IdLid (_loc, s)))), t) : 
                  'label_declaration ))));
          ([`Snterm (Gram.obj (a_LIDENT : 'a_LIDENT Gram.t ));
           `Skeyword ":";
           `Skeyword "mutable";
           `Snterm (Gram.obj (poly_type : 'poly_type Gram.t ))],
            (Gram.mk_action
               (fun (t : 'poly_type)  _  _  (s : 'a_LIDENT) 
                  (_loc : FanLoc.t)  ->
                  (`TyCol
                     (_loc, (`TyId (_loc, (`IdLid (_loc, s)))),
                       (`TyMut (_loc, t))) : 'label_declaration ))))])]);
     ...
     (None,
       [(None, None,
          ...
          ([`Snterm (Gram.obj (a_LIDENT : 'a_LIDENT Gram.t ))],
            (Gram.mk_action
               (fun (i : 'a_LIDENT)  (_loc : FanLoc.t)  ->
                  ((i, (`TyNil _loc)) : 'class_name_and_param ))))])]);
          ...
          [([`Sself; `Skeyword ","; `Sself],
             (Gram.mk_action
                (fun (t2 : 'comma_type_parameter)  _ 
                   ...
                   (`TyCom (_loc, t1, t2) : 'comma_type_parameter ))));
          ([`Stoken
              (((function | `ANT ("list",_) -> true | _ -> false)),
                (`Normal, "`ANT (\"list\",_)"))],
            (Gram.mk_action
               (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                  match __fan_0 with
                  | `ANT (("list" as n),s) ->
                      (`TyAnt (_loc, (mk_anti ~c:"ctyp," n s)) : 'comma_type_parameter )
                  | _ -> assert false)));
          ([`Snterm (Gram.obj (type_parameter : 'type_parameter Gram.t ))],
            (Gram.mk_action
               (fun (t : 'type_parameter)  (_loc : FanLoc.t)  ->
   ...
   Gram.extend (opt_comma_ctyp : 'opt_comma_ctyp Gram.t )
     (None,
       [(None, None,
          ...
          ([],
            (Gram.mk_action
               (fun (_loc : FanLoc.t)  -> (`TyNil _loc : 'opt_comma_ctyp ))))])]);
          ...
          ([`Stoken
            ...
            (Gram.mk_action
               (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                  match __fan_0 with
                  | `ANT (("list" as n),s) ->
                      (`TyAnt (_loc, (mk_anti ~c:"ctyp," n s)) : 'comma_ctyp )
                  | _ -> assert false)));
          ([`Snterm (Gram.obj (ctyp : 'ctyp Gram.t ))],
            (Gram.mk_action
            ...
            (Gram.mk_action
               (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                  ...
                  | `ANT ((""|"id"|"anti"|"list"|"uid" as n),s) ->
                      (`IdAnt (_loc, (mk_anti ~c:"ident" n s)) : 'ident_quot )
                  | _ -> assert false)));
         ([`Stoken
             (((function | `ANT ("lid",_) -> true | _ -> false)),
               (`Normal, "`ANT (\"lid\",_)"))],
          ...
          `Sself],
           (Gram.mk_action
              (fun (i : 'ident_quot)  _  (__fan_0 : [> FanToken.t]) 
                 ...
                 | `ANT ((""|"id"|"anti"|"list"|"uid" as n),s) ->
                     (`IdAcc
                        (_loc, (`IdAnt (_loc, (mk_anti ~c:"ident" n s))), i) : 
                     'ident_quot )
                 | _ -> assert false)));
         ([`Stoken
             (((function | `LID _ -> true | _ -> false)),
          ...
          [([`Stoken
             ...
             (Gram.mk_action
                (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                   match __fan_0 with
                   | `ANT ((""|"id"|"anti"|"list"|"uid" as n),s) ->
                       (`IdAnt (_loc, (mk_anti ~c:"ident" n s)) : 'ident )
                   | _ -> assert false)));
          ([`Stoken
              (((function | `ANT ("lid",_) -> true | _ -> false)),
                (`Normal, "`ANT (\"lid\",_)"))],
           ...
           `Sself],
            (Gram.mk_action
               (fun (j : 'ident)  _  (__fan_0 : [> FanToken.t]) 
                  (_loc : FanLoc.t)  ->
                  match __fan_0 with
                  | `UID s -> (`IdAcc (_loc, (`IdUid (_loc, s)), j) : 'ident )
                  | _ -> assert false)))])]);
   Gram.extend
            ...
            `Skeyword "("],
             (Gram.mk_action
                (fun _  _  (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                   match __fan_0 with
                   | `ANT ((""|"id"|"anti"|"list"|"uid" as n),s) ->
                       (`IdAnt (_loc, (mk_anti ~c:"ident" n s)) : 'module_longident_dot_lparen )
                   | _ -> assert false)));
          ([`Stoken
              (((function | `UID _ -> true | _ -> false)),
                (`Normal, "`UID _"));
           ...
           `Sself],
            (Gram.mk_action
               (fun (l : 'module_longident_dot_lparen)  _ 
                  ...
                  match __fan_0 with
                  | `UID i ->
                      (`IdAcc (_loc, (`IdUid (_loc, i)), l) : 'module_longident_dot_lparen )
                  | _ -> assert false)));
          ([`Stoken
              (((function | `UID _ -> true | _ -> false)),
                (`Normal, "`UID _"));
           ...
           `Skeyword "("],
            (Gram.mk_action
               (fun _  _  (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                  match __fan_0 with
                  | `UID i ->
                      (`IdUid (_loc, i) : 'module_longident_dot_lparen )
                  | _ -> assert false)));
          ([`Stoken
           ...
           `Sself],
            (Gram.mk_action
               (fun (l : 'module_longident_dot_lparen)  _ 
                  ...
                  | `ANT (("uid"|"" as n),s) ->
                      (`IdAcc
                         (_loc, (`IdAnt (_loc, (mk_anti ~c:"ident" n s))), l) : 
             ...
             (Gram.mk_action
                (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                   ...
                   | `ANT ((""|"id"|"anti"|"list" as n),s) ->
                       (`IdAnt (_loc, (mk_anti ~c:"ident" n s)) : 'module_longident )
                   | _ -> assert false)));
          ([`Stoken
              (((function | `UID _ -> true | _ -> false)),
                (`Normal, "`UID _"));
           ...
           `Sself],
            (Gram.mk_action
               (fun (l : 'module_longident)  _  (__fan_0 : [> FanToken.t]) 
                  ...
                  match __fan_0 with
                  | `UID i ->
                      (`IdAcc (_loc, (`IdUid (_loc, i)), l) : 'module_longident )
                  | _ -> assert false)));
          ([`Stoken
              (((function | `UID _ -> true | _ -> false)),
                (`Normal, "`UID _"))],
            (Gram.mk_action
               (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                  match __fan_0 with
                  | `UID i -> (`IdUid (_loc, i) : 'module_longident )
                  | _ -> assert false)));
          ([`Stoken
              (((function | `ANT ((""|"uid"),_) -> true | _ -> false)),
                (`Normal, "`ANT ((\"\"|\"uid\"),_)"))],
         ...
         [([`Stoken
            ...
            (Gram.mk_action
               (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                  match __fan_0 with
                  | `ANT ((""|"id"|"anti"|"list"|"uid" as n),s) ->
                      (`IdAnt (_loc, (mk_anti ~c:"ident" n s)) : 'module_longident_with_app )
                  | _ -> assert false)));
         ([`Stoken
             (((function | `UID _ -> true | _ -> false)),
               (`Normal, "`UID _"))],
           (Gram.mk_action
              (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                 match __fan_0 with
                 | `UID i -> (`IdUid (_loc, i) : 'module_longident_with_app )
                 | _ -> assert false)));
         ([`Skeyword "("; `Sself; `Skeyword ")"],
           (Gram.mk_action
            ...
            (Gram.mk_action
               (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                  ...
                  | `ANT ((""|"id"|"anti"|"list"|"uid"|"lid" as n),s) ->
                      (`IdAnt (_loc, (mk_anti ~c:"ident" n s)) : 'type_longident )
                  | _ -> assert false)));
         ([`Stoken
             (((function | `LID _ -> true | _ -> false)),
               (`Normal, "`LID _"))],
           (Gram.mk_action
              (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                 match __fan_0 with
                 | `LID i -> (`IdLid (_loc, i) : 'type_longident )
                 | _ -> assert false)));
         ([`Stoken
             (((function | `UID _ -> true | _ -> false)),
               (`Normal, "`UID _"))],
           (Gram.mk_action
              (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                 match __fan_0 with
                 | `UID i -> (`IdUid (_loc, i) : 'type_longident )
                 | _ -> assert false)));
         ([`Skeyword "("; `Sself; `Skeyword ")"],
           (Gram.mk_action
             ...
             (Gram.mk_action
                (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                   ...
                   | `ANT ((""|"id"|"anti"|"list"|"lid" as n),s) ->
                       (`IdAnt (_loc, (mk_anti ~c:"ident" n s)) : 'label_longident )
                   | _ -> assert false)));
          ([`Stoken
              (((function | `LID _ -> true | _ -> false)),
                (`Normal, "`LID _"))],
            (Gram.mk_action
               (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                  match __fan_0 with
                  | `LID i -> (`IdLid (_loc, i) : 'label_longident )
                  | _ -> assert false)));
          ([`Stoken
              (((function | `UID _ -> true | _ -> false)),
                (`Normal, "`UID _"));
           ...
           `Sself],
            (Gram.mk_action
               (fun (l : 'label_longident)  _  (__fan_0 : [> FanToken.t]) 
                  ...
                  match __fan_0 with
                  | `UID i ->
                      (`IdAcc (_loc, (`IdUid (_loc, i)), l) : 'label_longident )
                  | _ -> assert false)));
          ([`Stoken
              (((function | `ANT ((""|"uid"),_) -> true | _ -> false)),
                (`Normal, "`ANT ((\"\"|\"uid\"),_)"));
     ...
     (None,
       [(None, None,
          [([`Skeyword "method"; `Skeyword "!"],
             (Gram.mk_action
                (fun _  _  (_loc : FanLoc.t)  ->
                   (`OvOverride : 'method_opt_override ))));
          ([`Skeyword "method";
           `Stoken
             (((function
            ...
            (Gram.mk_action
               (fun (__fan_1 : [> FanToken.t])  _  (_loc : FanLoc.t)  ->
                  ...
                  | `ANT ((""|"override"|"anti" as n),s) ->
                      (`OvAnt (mk_anti ~c:"override_flag" n s) : 'method_opt_override )
                  | _ -> assert false)));
          ([`Skeyword "method"],
            (Gram.mk_action
               (fun _  (_loc : FanLoc.t)  -> (`OvNil : 'method_opt_override ))))])]);
   Gram.extend (opt_override : 'opt_override Gram.t )
     (None,
       [(None, None,
          [([`Skeyword "!"],
             (Gram.mk_action
                (fun _  (_loc : FanLoc.t)  -> (`OvOverride : 'opt_override ))));
          ([`Stoken
              (((function
                 | `ANT (("!"|"override"|"anti"),_) -> true
                 | _ -> false)),
            ...
            (Gram.mk_action
               (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                  match __fan_0 with
                  | `ANT (("!"|"override"|"anti" as n),s) ->
                      (`OvAnt (mk_anti ~c:"override_flag" n s) : 'opt_override )
                  | _ -> assert false)));
          ([],
            (Gram.mk_action
               (fun (_loc : FanLoc.t)  -> (`OvNil : 'opt_override ))))])]);
     ...
     (None,
       [(None, None,
          [([`Skeyword "val"; `Skeyword "!"],
             (Gram.mk_action
                (fun _  _  (_loc : FanLoc.t)  ->
                   (`OvOverride : 'value_val_opt_override ))));
          ([`Skeyword "val";
           `Stoken
             (((function
                | `ANT ((""|"override"|"anti"),_) -> true
            ...
            (Gram.mk_action
               (fun (__fan_1 : [> FanToken.t])  _  (_loc : FanLoc.t)  ->
                  match __fan_1 with
                  | `ANT ((""|"override"|"anti" as n),s) ->
                      (`OvAnt (mk_anti ~c:"override_flag" n s) : 'value_val_opt_override )
                  | _ -> assert false)));
          ([`Skeyword "val"],
            (Gram.mk_action
               (fun _  (_loc : FanLoc.t)  ->
                  (`OvNil : 'value_val_opt_override ))))])]);
          ...
          ([`Stoken
            ...
            (Gram.mk_action
               (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                  match __fan_0 with
                  | `ANT (("to"|"anti"|"" as n),s) ->
                      (`DiAnt (mk_anti ~c:"direction_flag" n s) : 'direction_flag )
                  | _ -> assert false)))])]);
            ...
            (Gram.mk_action
               (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                  ...
                  | `ANT (("private"|"anti" as n),s) ->
                      (`PrAnt (mk_anti ~c:"private_flag" n s) : 'opt_private )
                  | _ -> assert false)));
          ([],
            (Gram.mk_action
            ...
            (Gram.mk_action
               (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                  ...
                  | `ANT (("mutable"|"anti" as n),s) ->
                      (`MuAnt (mk_anti ~c:"mutable_flag" n s) : 'opt_mutable )
                  | _ -> assert false)));
          ([],
            (Gram.mk_action
            ...
            (Gram.mk_action
               (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                  ...
                  | `ANT (("virtual"|"anti" as n),s) ->
                      (`ViAnt (mk_anti ~c:"virtual_flag" n s) : 'opt_virtual )
                  | _ -> assert false)));
          ([],
            (Gram.mk_action
          ...
          ([`Stoken
            ...
            (Gram.mk_action
               (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                  match __fan_0 with
                  | `ANT ((".."|"anti" as n),s) ->
                      (`RvAnt (mk_anti ~c:"row_var_flag" n s) : 'opt_dot_dot )
                  | _ -> assert false)));
          ([],
            (Gram.mk_action
          ...
          ([`Stoken
            ...
            (Gram.mk_action
               (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                  match __fan_0 with
                  | `ANT (("rec"|"anti" as n),s) ->
                      (`ReAnt (mk_anti ~c:"rec_flag" n s) : 'opt_rec )
                  | _ -> assert false)));
          ([],
          ...
          [([`Stoken
             ...
             (Gram.mk_action
                (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                   match __fan_0 with
                   | `ANT ((""|"str_list"),s) ->
                       (`LAnt (mk_anti "str_list" s) : 'string_list )
                   | _ -> assert false)));
          ([`Stoken
              (((function | `STR (_,_) -> true | _ -> false)),
                (`Normal, "`STR (_,_)"));
          ...
          [([`Skeyword "#";
            ...
            `Skeyword ";;"],
             (Gram.mk_action
                (fun _  (dp : 'opt_expr)  (n : 'a_LIDENT)  _ 
                   (_loc : FanLoc.t)  ->
                   (([`StDir (_loc, n, dp)], (Some _loc)) : 'implem ))));
             ...
             (Gram.mk_action
                (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                   ...
                   | `ANT ((""|"stri"|"anti"|"list" as n),s) ->
                       (`StAnt (_loc, (mk_anti n ~c:"str_item" s)) : 'str_items )
                   | _ -> assert false)));
          ([`Stoken
              (((function
                 | `ANT ((""|"stri"|"anti"|"list"),_) -> true
           ...
           `Sself],
            (Gram.mk_action
               (fun (st : 'str_items)  _  (__fan_0 : [> FanToken.t]) 
                  ...
                  | `ANT ((""|"stri"|"anti"|"list" as n),s) ->
                      (`StSem
                         (_loc, (`StAnt (_loc, (mk_anti n ~c:"str_item" s))),
                           st) : 'str_items )
                  | _ -> assert false)));
          ([`Slist0
          ...
          [([`Skeyword "#";
            ...
            `Skeyword ";;"],
             (Gram.mk_action
                (fun _  (dp : 'opt_expr)  (n : 'a_LIDENT)  _ 
                   (_loc : FanLoc.t)  ->
                   (Some (`StDir (_loc, n, dp)) : 'top_phrase ))));
          ([`Snterm (Gram.obj (str_item : 'str_item Gram.t ));
           `Snterm (Gram.obj (semi : 'semi Gram.t ))],
            (Gram.mk_action
               (fun _  (st : 'str_item)  (_loc : FanLoc.t)  ->
   ...
   Gram.extend (str_item_quot : 'str_item_quot Gram.t )
     (None,
       [(None, None,
           ...
           `Sself],
            (Gram.mk_action
               (fun (st2 : 'str_item_quot)  _  (st1 : 'str_item) 
                  ...
                  (match st2 with
                   | `StNil _loc -> st1
                   | _ -> `StSem (_loc, st1, st2) : 'str_item_quot ))));
          ([`Snterm (Gram.obj (str_item : 'str_item Gram.t ))],
            (Gram.mk_action
          ...
          ([],
            (Gram.mk_action
               (fun (_loc : FanLoc.t)  -> (`StNil _loc : 'str_item_quot ))))])]);
       ...
       [((Some "top"), None,
          ...
          ([`Skeyword "module";
           ...
           `Snterm (Gram.obj (module_type : 'module_type Gram.t ))],
            (Gram.mk_action
               (fun (mt : 'module_type)  _  (i : 'a_ident)  _  _ 
                  (_loc : FanLoc.t)  -> (`StMty (_loc, i, mt) : 'str_item ))));
          ([`Skeyword "open";
           `Stoken
           ...
           `Stoken
            ...
            (Gram.mk_action
               (fun (__fan_2 : [> FanToken.t])  (__fan_1 : [> FanToken.t])  _
                  ...
                  | (`STR (_,s),`LID "lang") ->
                      ((AstQuotation.default := s; `StNil _loc) : 'str_item )
                  | _ -> assert false)));
          ([`Skeyword "open";
           `Snterm (Gram.obj (module_longident : 'module_longident Gram.t ))],
            (Gram.mk_action
               (fun (i : 'module_longident)  _  (_loc : FanLoc.t)  ->
                  (`StOpn (_loc, i) : 'str_item ))));
          ([`Skeyword "type";
           `Snterm (Gram.obj (type_declaration : 'type_declaration Gram.t ))],
            (Gram.mk_action
               (fun (td : 'type_declaration)  _  (_loc : FanLoc.t)  ->
                  (`StTyp (_loc, td) : 'str_item ))));
          ([`Skeyword "let";
           `Snterm (Gram.obj (opt_rec : 'opt_rec Gram.t ));
           `Snterm (Gram.obj (binding : 'binding Gram.t ));
           `Skeyword "in";
           `Snterm (Gram.obj (expr : 'expr Gram.t ))],
            (Gram.mk_action
               (fun (x : 'expr)  _  (bi : 'binding)  (r : 'opt_rec)  _ 
                  (_loc : FanLoc.t)  ->
                  (`StExp (_loc, (`ExLet (_loc, r, bi, x))) : 'str_item ))));
          ([`Skeyword "let";
           `Snterm (Gram.obj (opt_rec : 'opt_rec Gram.t ));
           `Snterm (Gram.obj (binding : 'binding Gram.t ))],
            (Gram.mk_action
               (fun (bi : 'binding)  (r : 'opt_rec)  _  (_loc : FanLoc.t)  ->
                  (match bi with
                   | `BiEq (_loc,`PaAny _,e) -> `StExp (_loc, e)
                   | _ -> `StVal (_loc, r, bi) : 'str_item ))));
          ([`Skeyword "let";
           `Skeyword "module";
           `Snterm (Gram.obj (a_UIDENT : 'a_UIDENT Gram.t ));
           `Snterm (Gram.obj (module_binding0 : 'module_binding0 Gram.t ));
           ...
           `Snterm (Gram.obj (expr : 'expr Gram.t ))],
            (Gram.mk_action
               (fun (e : 'expr)  _  (mb : 'module_binding0)  (m : 'a_UIDENT) 
                  _  _  (_loc : FanLoc.t)  ->
                  (`StExp (_loc, (`ExLmd (_loc, m, mb, e))) : 'str_item ))));
          ([`Skeyword "let";
           `Skeyword "open";
           `Snterm (Gram.obj (module_longident : 'module_longident Gram.t ));
           `Skeyword "in";
           `Snterm (Gram.obj (expr : 'expr Gram.t ))],
            (Gram.mk_action
               (fun (e : 'expr)  _  (i : 'module_longident)  _  _ 
                  (_loc : FanLoc.t)  ->
                  (`StExp (_loc, (`ExOpI (_loc, i, e))) : 'str_item ))));
          ([`Skeyword "let";
           `Skeyword "try";
           `Snterm (Gram.obj (opt_rec : 'opt_rec Gram.t ));
           `Snterm (Gram.obj (binding : 'binding Gram.t ));
          ...
          ([`Stoken
            ...
            (Gram.mk_action
               (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                  match __fan_0 with
                  | `ANT ((""|"stri"|"anti"|"list" as n),s) ->
                      (`StAnt (_loc, (mk_anti ~c:"str_item" n s)) : 'str_item )
                  | _ -> assert false)));
          ([`Stoken
              (((function | `QUOTATION _ -> true | _ -> false)),
                (`Normal, "`QUOTATION _"))],
     ...
     (None,
       [(None, None,
            ...
            `Sself],
             (Gram.mk_action
                (fun (x2 : 'class_sig_item_quot)  _  (x1 : 'class_sig_item) 
                   ...
                   (match x2 with
                    | `CgNil _loc -> x1
                    | _ -> `CgSem (_loc, x1, x2) : 'class_sig_item_quot ))));
          ([`Snterm (Gram.obj (class_sig_item : 'class_sig_item Gram.t ))],
            (Gram.mk_action
          ...
          ([],
            (Gram.mk_action
               (fun (_loc : FanLoc.t)  ->
                  (`CgNil _loc : 'class_sig_item_quot ))))])]);
             ...
             (Gram.mk_action
                (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                   ...
                   | `ANT ((""|"csg"|"anti"|"list" as n),s) ->
                       (`CgAnt (_loc, (mk_anti ~c:"class_sig_item" n s)) : 
                       'class_signature )
                   | _ -> assert false)));
          ([`Stoken
              (((function
       ...
       [(None, None,
          ...
          ([`Skeyword "method";
           ...
           `Snterm (Gram.obj (poly_type : 'poly_type Gram.t ))],
            (Gram.mk_action
               (fun (t : 'poly_type)  _  (l : 'label)  (pf : 'opt_private)  _
                   (_loc : FanLoc.t)  ->
                  (`CgMth (_loc, l, pf, t) : 'class_sig_item ))));
          ([`Skeyword "method";
           `Snterm (Gram.obj (opt_private : 'opt_private Gram.t ));
           `Skeyword "virtual";
           `Snterm (Gram.obj (label : 'label Gram.t ));
          ...
          ([`Snterm (Gram.obj (type_constraint : 'type_constraint Gram.t ));
           ...
           `Snterm (Gram.obj (ctyp : 'ctyp Gram.t ))],
            (Gram.mk_action
               (fun (t2 : 'ctyp)  _  (t1 : 'ctyp)  _  (_loc : FanLoc.t)  ->
                  (`CgCtr (_loc, t1, t2) : 'class_sig_item ))))])]));
             ...
             (Gram.mk_action
                (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                   ...
                   | `ANT ((""|"cst"|"anti"|"list" as n),s) ->
                       (`CrAnt (_loc, (mk_anti ~c:"class_str_item" n s)) : 
                       'class_structure )
                   | _ -> assert false)));
          ([`Stoken
              (((function
       ...
       [(None, None,
           ...
           `Snterm (Gram.obj (opt_as_lident : 'opt_as_lident Gram.t ))],
            (Gram.mk_action
               (fun (pb : 'opt_as_lident)  (ce : 'class_expr) 
                  ...
                  (`CrInh (_loc, o, ce, pb) : 'class_str_item ))));
          ([`Snterm
              (Gram.obj
            ...
            (Gram.mk_action
               (fun (t : 'poly_type)  _  (l : 'label)  _  (mf : 'opt_mutable)
                  ...
                  (if o <> `OvNil
                   ...
                   else `CrVvr (_loc, l, mf, t) : 'class_str_item ))));
          ([`Snterm
              (Gram.obj
                 (value_val_opt_override : 'value_val_opt_override Gram.t ));
           `Skeyword "virtual";
                  ...
                  (if o <> `OvNil
                   then
                     raise
                       (XStream.Error
                          "override (!) is incompatible with virtual")
                   else `CrVir (_loc, l, pf, t) : 'class_str_item ))));
          ([`Snterm
              (Gram.obj (method_opt_override : 'method_opt_override Gram.t ));
           `Snterm (Gram.obj (opt_private : 'opt_private Gram.t ));
           `Snterm (Gram.obj (label : 'label Gram.t ));
          ...
          ([`Snterm (Gram.obj (type_constraint : 'type_constraint Gram.t ));
           ...
           `Snterm (Gram.obj (ctyp : 'ctyp Gram.t ))],
            (Gram.mk_action
               (fun (t2 : 'ctyp)  _  (t1 : 'ctyp)  _  (_loc : FanLoc.t)  ->
                  (`CrCtr (_loc, t1, t2) : 'class_str_item ))));
          ([`Skeyword "initializer";
           `Snterm (Gram.obj (expr : 'expr Gram.t ))],
            (Gram.mk_action
               (fun (se : 'expr)  _  (_loc : FanLoc.t)  ->
                  (`CrIni (_loc, se) : 'class_str_item ))))])]);
     ...
     (None,
       [(None, None,
          ...
          ([],
            (Gram.mk_action
               (fun (_loc : FanLoc.t)  ->
                  (`CrNil _loc : 'class_str_item_quot ))))])]));
  (Gram.extend (class_expr_quot : 'class_expr_quot Gram.t )
     (None,
       [(None, None,
          [([`Sself; `Skeyword "and"; `Sself],
             (Gram.mk_action
                (fun (ce2 : 'class_expr_quot)  _  (ce1 : 'class_expr_quot) 
                   (_loc : FanLoc.t)  ->
                   (`CeAnd (_loc, ce1, ce2) : 'class_expr_quot ))));
          ([`Sself; `Skeyword "="; `Sself],
            (Gram.mk_action
               (fun (ce2 : 'class_expr_quot)  _  (ce1 : 'class_expr_quot) 
                  (_loc : FanLoc.t)  ->
                  (`CeEq (_loc, ce1, ce2) : 'class_expr_quot ))));
          ([`Skeyword "virtual";
           `Snterm
            ...
            (Gram.mk_action
               (fun ((i,ot) : 'class_name_and_param)  _  (_loc : FanLoc.t) 
                  ->
                  (`CeCon (_loc, `ViVirtual, (`IdLid (_loc, i)), ot) : 'class_expr_quot ))));
          ([`Stoken
           ...
           `Snterm (Gram.obj (opt_comma_ctyp : 'opt_comma_ctyp Gram.t ))],
            (Gram.mk_action
               (fun (ot : 'opt_comma_ctyp)  (i : 'ident) 
                  ...
                  match __fan_0 with
                  | `ANT (("virtual" as n),s) ->
                      (let anti = `ViAnt (mk_anti ~c:"class_expr" n s) in
          ...
          ([],
            (Gram.mk_action
               (fun (_loc : FanLoc.t)  -> (`CeNil _loc : 'class_expr_quot ))))])]);
          ...
          [([`Sself; `Skeyword "and"; `Sself],
             (Gram.mk_action
                (fun (c2 : 'class_declaration)  _  (c1 : 'class_declaration) 
                   (_loc : FanLoc.t)  ->
                   (`CeAnd (_loc, c1, c2) : 'class_declaration ))));
          ([`Stoken
              (((function
            ...
            (Gram.mk_action
               (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                  ...
                  | `ANT ((""|"cdcl"|"anti"|"list" as n),s) ->
                      (`CeAnt (_loc, (mk_anti ~c:"class_expr" n s)) : 
                      'class_declaration )
                  | _ -> assert false)));
          ([`Stoken
              (((function | `QUOTATION _ -> true | _ -> false)),
           ...
           `Snterm
            ...
            (Gram.mk_action
               (fun (ce : 'class_fun_binding) 
                  ...
                  (`CeEq (_loc, ci, ce) : 'class_declaration ))))])]);
            ...
            `Snterm
             ...
             (Gram.mk_action
                (fun ((i,ot) : 'class_name_and_param)  (mv : 'opt_virtual) 
                   (_loc : FanLoc.t)  ->
                   (`CeCon (_loc, mv, (`IdLid (_loc, i)), ot) : 'class_info_for_class_expr ))))])]);
            ...
            `Snterm (Gram.obj (class_fun_def : 'class_fun_def Gram.t ))],
             (Gram.mk_action
                (fun (ce : 'class_fun_def)  (p : 'ipatt)  _ 
                   (_loc : FanLoc.t)  -> (`CeFun (_loc, p, ce) : 'class_expr ))));
          ([`Skeyword "function";
           `Snterm (Gram.obj (ipatt : 'ipatt Gram.t ));
           `Snterm (Gram.obj (class_fun_def : 'class_fun_def Gram.t ))],
            (Gram.mk_action
           ...
           (Gram.mk_action
              (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                 ...
                 | `ANT ((""|"typ"|"anti"|"list" as n),s) ->
                     (`CtAnt (_loc, (mk_anti ~c:"class_type" n s)) : 'class_description )
                 | _ -> assert false)));
         ([`Stoken
             (((function | `QUOTATION _ -> true | _ -> false)),
               (`Normal, "`QUOTATION _"))],
         ...
         ([`Stoken
           ...
           (Gram.mk_action
              (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                 match __fan_0 with
                 | `ANT ((""|"typ"|"anti"|"list" as n),s) ->
                     (`CtAnt (_loc, (mk_anti ~c:"class_type" n s)) : 'class_type_declaration )
                 | _ -> assert false)));
         ([`Stoken
             (((function | `QUOTATION _ -> true | _ -> false)),
               (`Normal, "`QUOTATION _"))],
         ...
         [([`Snterm (Gram.obj (opt_virtual : 'opt_virtual Gram.t ));
           `Snterm
            ...
            (Gram.mk_action
               (fun ((i,ot) : 'class_name_and_param)  (mv : 'opt_virtual) 
                  (_loc : FanLoc.t)  ->
                  (`CtCon (_loc, mv, (`IdLid (_loc, i)), ot) : 'class_info_for_class_type ))))])]);
      ...
      [(None, None,
         ...
         ([`Skeyword "virtual";
          `Snterm
           ...
           (Gram.mk_action
              (fun ((i,ot) : 'class_name_and_param)  _  (_loc : FanLoc.t)  ->
                 (`CtCon (_loc, `ViVirtual, (`IdLid (_loc, i)), ot) : 'class_type_quot ))));
         ([`Stoken
             (((function | `ANT ("virtual",_) -> true | _ -> false)),
               (`Normal, "`ANT (\"virtual\",_)"));
          `Snterm (Gram.obj (ident : 'ident Gram.t ));
          `Snterm (Gram.obj (opt_comma_ctyp : 'opt_comma_ctyp Gram.t ))],
           (Gram.mk_action
              (fun (ot : 'opt_comma_ctyp)  (i : 'ident) 
                 ...
                 match __fan_0 with
                 | `ANT (("virtual" as n),s) ->
                     (let anti = `ViAnt (mk_anti ~c:"class_type" n s) in
         ...
         ([],
           (Gram.mk_action
              (fun (_loc : FanLoc.t)  -> (`CtNil _loc : 'class_type_quot ))))])]);
            ...
            (Gram.mk_action
               (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                  ...
                  | `ANT ((""|"ctyp"|"anti" as n),s) ->
                      (`CtAnt (_loc, (mk_anti ~c:"class_type" n s)) : 
                      'class_type )
                  | _ -> assert false)));
         ([`Stoken
             (((function | `QUOTATION _ -> true | _ -> false)),
