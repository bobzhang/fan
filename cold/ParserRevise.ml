             ...
             (Gram.mk_action
                (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                   ...
                   | `ANT ((""|"sigi"|"anti"|"list" as n),s) ->
                       (`SgAnt (_loc, (mk_anti ~c:"sig_item" n s)) : 
                       'sig_item )
                   | _ -> assert false)));
          ([`Stoken
              (((function | `QUOTATION _ -> true | _ -> false)),
          ...
          [([`Stoken
             ...
             (Gram.mk_action
                (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                   match __fan_0 with
                   | `ANT ((""|"sigi"|"anti"|"list" as n),s) ->
                       (`SgAnt (_loc, (mk_anti n ~c:"sig_item" s)) : 
                       'sig_items )
                   | _ -> assert false)));
          ([`Stoken
              (((function
           ...
           (Gram.mk_action
              (fun (e2 : 'expr)  _  (e1 : 'expr)  (_loc : FanLoc.t)  ->
                 (`ExApp
                    (_loc,
                      (`ExApp
                         (_loc, (`ExId (_loc, (`IdLid (_loc, "lor")))), e1)),
                      e2) : 'expr ))));
           ...
           (Gram.mk_action
              (fun (e2 : 'expr)  _  (e1 : 'expr)  (_loc : FanLoc.t)  ->
                 (`ExApp
                    (_loc,
                      (`ExApp
                         (_loc, (`ExId (_loc, (`IdLid (_loc, "mod")))), e1)),
                      e2) : 'expr ))));
           ...
           (Gram.mk_action
              (fun (e2 : 'expr)  _  (e1 : 'expr)  (_loc : FanLoc.t)  ->
                 (`ExApp
                    (_loc,
                      (`ExApp
                         (_loc, (`ExId (_loc, (`IdLid (_loc, "lsl")))), e1)),
                      e2) : 'expr ))));
           ...
           (Gram.mk_action
              (fun (e2 : 'expr)  _  (e1 : 'expr)  (_loc : FanLoc.t)  ->
                 (`ExApp
                    (_loc,
                      (`ExApp
                         (_loc, (`ExId (_loc, (`IdLid (_loc, "lsr")))), e1)),
                      e2) : 'expr ))));
          ...
          `Skeyword "end"],
           (Gram.mk_action
              (fun _  (cst : 'class_structure)  (csp : 'opt_class_self_patt) 
                 _  (_loc : FanLoc.t)  -> (`ExObj (_loc, csp, cst) : 
                 'expr ))))]);
       ...
       ((Some "~-"), (Some `NA),
         [([`Skeyword "!"; `Sself],
            (Gram.mk_action
               (fun (e : 'expr)  _  (_loc : FanLoc.t)  ->
                  (`ExAcc
                     (_loc, e, (`ExId (_loc, (`IdLid (_loc, "contents"))))) : 
                  'expr ))));
           ...
           `Stoken
            ...
            (Gram.mk_action
               (fun (__fan_1 : [> FanToken.t])  _  (_loc : FanLoc.t)  ->
                  match __fan_1 with
                  | `ANT ((""|"lid" as n),i) ->
                      (`PaLab (_loc, (mk_anti n i), (`PaNil _loc)) : 
                      'ipatt )
                  | _ -> assert false)));
          ([`Skeyword "~";
           `Stoken
           ...
           `Stoken
            ...
            (Gram.mk_action
               (fun (__fan_1 : [> FanToken.t])  _  (_loc : FanLoc.t)  ->
                  match __fan_1 with
                  | `ANT ((""|"lid" as n),i) ->
                      (`PaOlb (_loc, (mk_anti n i), (`PaNil _loc)) : 
                      'ipatt )
                  | _ -> assert false)));
          ([`Skeyword "?";
           `Skeyword "(";
           ...
           `Sself],
            (Gram.mk_action
               (fun (j : 'ident)  _  (__fan_0 : [> FanToken.t]) 
                  ...
                  match __fan_0 with
                  | `UID s ->
                      (`IdAcc (_loc, (`IdUid (_loc, s)), j) : 'ident )
                  | _ -> assert false)))])]);
   Gram.extend
            ...
            (Gram.mk_action
               (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                  ...
                  | `ANT (("virtual"|"anti" as n),s) ->
                      (`ViAnt (_loc, (mk_anti ~c:"virtual_flag" n s)) : 
                      'opt_virtual )
                  | _ -> assert false)));
          ([],
            (Gram.mk_action
          ...
          ([`Stoken
            ...
            (Gram.mk_action
               (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                  match __fan_0 with
                  | `ANT ((".."|"anti" as n),s) ->
                      (`RvAnt (_loc, (mk_anti ~c:"row_var_flag" n s)) : 
                      'opt_dot_dot )
                  | _ -> assert false)));
          ([],
            (Gram.mk_action
          ...
          ([`Stoken
            ...
            (Gram.mk_action
               (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                  match __fan_0 with
                  | `ANT (("rec"|"anti" as n),s) ->
                      (`ReAnt (_loc, (mk_anti ~c:"rec_flag" n s)) : 'opt_rec )
                  | _ -> assert false)));
          ([],
          ...
          [([`Stoken
             ...
             (Gram.mk_action
                (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                   match __fan_0 with
                   | `ANT ((""|"str_list"),s) ->
                       (`LAnt (_loc, (mk_anti "str_list" s)) : 'string_list )
                   | _ -> assert false)));
          ([`Stoken
              (((function | `STR (_,_) -> true | _ -> false)),
                (`Normal, "`STR (_,_)"));
             ...
             (Gram.mk_action
                (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                   ...
                   | `ANT ((""|"stri"|"anti"|"list" as n),s) ->
                       (`StAnt (_loc, (mk_anti n ~c:"str_item" s)) : 
                       'str_items )
                   | _ -> assert false)));
          ([`Stoken
              (((function
           ...
           `Snterm
            ...
            (Gram.mk_action
               (fun ((i,ot) : 'class_name_and_param)  _  (_loc : FanLoc.t) 
                  ->
                  (`CeCon (_loc, `ViVirtual, (`IdLid (_loc, i)), ot) : 
                  'class_expr_quot ))));
          ([`Stoken
           ...
           `Snterm (Gram.obj (opt_comma_ctyp : 'opt_comma_ctyp Gram.t ))],
            (Gram.mk_action
               (fun (ot : 'opt_comma_ctyp)  (i : 'ident) 
                  ...
                  | `ANT (("virtual" as n),s) ->
                      (let anti =
                         `ViAnt (_loc, (mk_anti ~c:"class_expr" n s)) in
      ...
      [(None, None,
         ...
         ([`Skeyword "virtual";
          `Snterm
           ...
           (Gram.mk_action
              (fun ((i,ot) : 'class_name_and_param)  _  (_loc : FanLoc.t)  ->
                 (`CtCon (_loc, `ViVirtual, (`IdLid (_loc, i)), ot) : 
                 'class_type_quot ))));
         ([`Stoken
             (((function | `ANT ("virtual",_) -> true | _ -> false)),
               (`Normal, "`ANT (\"virtual\",_)"));
