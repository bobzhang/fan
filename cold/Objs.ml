...
let rec pp_print_ctyp fmt =
  ...
  | `OptLabl (_a0,_a1,_a2) ->
      Format.fprintf fmt "@[<1>(`OptLabl@ %a@ %a@ %a)@]" pp_print_loc _a0
        pp_print_alident _a1 pp_print_ctyp _a2
  | #ident' as _a0 -> (pp_print_ident' fmt _a0 :>'result56)
  | `TyObj (_a0,_a1,_a2) ->
...
and pp_print_sigi fmt =
  ...
  | `ModuleApp (_a0,_a1,_a2,_a3) ->
      Format.fprintf fmt "@[<1>(`ModuleApp@ %a@ %a@ %a@ %a)@]" pp_print_loc
        _a0 pp_print_auident _a1 pp_print_mtbind _a2 pp_print_mtyp _a3
...
and pp_print_mtbind fmt =
  function
  | `App (_a0,_a1,_a2) ->
      Format.fprintf fmt "@[<1>(`App@ %a@ %a@ %a)@]" pp_print_loc _a0
        pp_print_mtbind _a1 pp_print_mtbind _a2
  | `Col (_a0,_a1) ->
      Format.fprintf fmt "@[<1>(`Col@ %a@ %a)@]" pp_print_auident _a0
        pp_print_mtyp _a1
  ...
  object (self : 'self_type)
    ...
    method sigi : 'fmt -> sigi -> unit=
      fun fmt  ->
        ...
        | `ModuleApp (_a0,_a1,_a2,_a3) ->
            Format.fprintf fmt "@[<1>(`ModuleApp@ %a@ %a@ %a@ %a)@]" 
              self#loc _a0 self#auident _a1 self#mtbind _a2 self#mtyp _a3
        | `ModuleTypeEnd (_a0,_a1) ->
    ...
    method mtbind : 'fmt -> mtbind -> unit=
      fun fmt  ->
        ...
        | `App (_a0,_a1,_a2) ->
            Format.fprintf fmt "@[<1>(`App@ %a@ %a@ %a)@]" self#loc _a0
              self#mtbind _a1 self#mtbind _a2
        | `Col (_a0,_a1) ->
  ...
  object (self : 'self_type)
    ...
    method sigi : sigi -> sigi=
      ...
      | `ModuleApp (_a0,_a1,_a2,_a3) ->
          let _a0 = self#loc _a0 in
          let _a1 = self#auident _a1 in
          let _a2 = self#mtbind _a2 in
          let _a3 = self#mtyp _a3 in `ModuleApp (_a0, _a1, _a2, _a3)
      | `ModuleTypeEnd (_a0,_a1) ->
          let _a0 = self#loc _a0 in
    ...
    method mtbind : mtbind -> mtbind=
      function
      | `App (_a0,_a1,_a2) ->
          let _a0 = self#loc _a0 in
          let _a1 = self#mtbind _a1 in
          let _a2 = self#mtbind _a2 in `App (_a0, _a1, _a2)
      | `Col (_a0,_a1) ->
          let _a0 = self#auident _a0 in
          let _a1 = self#mtyp _a1 in `Col (_a0, _a1)
      | #ant as _a0 -> (self#ant _a0 : ant  :>mtbind)
  ...
  object (self : 'self_type)
    ...
    method sigi : sigi -> 'self_type=
      ...
      | `ModuleApp (_a0,_a1,_a2,_a3) ->
          let self = self#loc _a0 in
          let self = self#auident _a1 in
          let self = self#mtbind _a2 in self#mtyp _a3
      | `ModuleTypeEnd (_a0,_a1) ->
          let self = self#loc _a0 in self#auident _a1
      | `ModuleType (_a0,_a1,_a2) ->
          let self = self#loc _a0 in
      ...
      | #ant as _a0 -> (self#ant _a0 :>'self_type)
    method mtbind : mtbind -> 'self_type=
      function
      | `App (_a0,_a1,_a2) ->
          let self = self#loc _a0 in
          let self = self#mtbind _a1 in self#mtbind _a2
      | `Col (_a0,_a1) -> let self = self#auident _a0 in self#mtyp _a1
      | #ant as _a0 -> (self#ant _a0 :>'self_type)
...
let rec strip_loc_ctyp =
  ...
  | #ident' as _a0 -> (strip_loc_ident' _a0 :>'result296)
  | `TyObj (_a0,_a1,_a2) ->
...
and strip_loc_sigi =
  ...
  | `ModuleApp (_a0,_a1,_a2,_a3) ->
      let _a1 = strip_loc_auident _a1 in
      let _a2 = strip_loc_mtbind _a2 in
      let _a3 = strip_loc_mtyp _a3 in `ModuleApp (_a1, _a2, _a3)
  | `ModuleTypeEnd (_a0,_a1) ->
...
and strip_loc_mtbind =
  function
  | `App (_a0,_a1,_a2) ->
      let _a1 = strip_loc_mtbind _a1 in
      let _a2 = strip_loc_mtbind _a2 in `App (_a1, _a2)
  | `Col (_a0,_a1) ->
      let _a0 = strip_loc_auident _a0 in
      let _a1 = strip_loc_mtyp _a1 in `Col (_a0, _a1)
...
let map_mtbind f =
  object  inherit  map as super method! mtbind x = f (super#mtbind x) end
...
let dump_mtbind = LibUtil.to_string_of_printer dump#mtbind
