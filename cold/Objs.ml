  ...
  object (self : 'self_type)
    ...
    method nil : nil -> nil -> nil=
      fun _a0  _b0  ->
        ...
        | ((#ant as _a0),(#ant as _b0)) -> (self#ant _a0 _b0 : ant  :>nil)
    ...
    method aident : aident -> aident -> aident=
      fun _a0  _b0  ->
        ...
        | ((#ant as _a0),(#ant as _b0)) -> (self#ant _a0 _b0 : ant  :>aident)
        | (_,_) -> invalid_arg "map2 failure"
    ...
    method uident : uident -> uident -> uident=
      fun _a0  _b0  ->
        ...
        | ((#ant as _a0),(#ant as _b0)) -> (self#ant _a0 _b0 : ant  :>uident)
        | (_,_) -> invalid_arg "map2 failure"
    method ident : ident -> ident -> ident=
      fun _a0  _b0  ->
        ...
        | ((#ant as _a0),(#ant as _b0)) -> (self#ant _a0 _b0 : ant  :>ident)
        | (_,_) -> invalid_arg "map2 failure"
    method dupath : dupath -> dupath -> dupath=
      fun _a0  _b0  ->
        ...
        | ((#ant as _a0),(#ant as _b0)) -> (self#ant _a0 _b0 : ant  :>dupath)
        | (_,_) -> invalid_arg "map2 failure"
    method dlpath : dlpath -> dlpath -> dlpath=
      fun _a0  _b0  ->
        ...
        | ((#ant as _a0),(#ant as _b0)) -> (self#ant _a0 _b0 : ant  :>dlpath)
        | (_,_) -> invalid_arg "map2 failure"
    method sid : sid -> sid -> sid=
      fun _a0  _b0  ->
        ...
        | ((#ant as _a0),(#ant as _b0)) -> (self#ant _a0 _b0 : ant  :>sid)
        | (_,_) -> invalid_arg "map2 failure"
    method any : any -> any -> any=
      fun _a0  _b0  ->
        match (_a0, _b0) with
        | (`Any _a0,`Any _b0) -> let _a0 = self#loc _a0 _b0 in `Any _a0
        | ((#ant as _a0),(#ant as _b0)) -> (self#ant _a0 _b0 : ant  :>any)
        | (_,_) -> invalid_arg "map2 failure"
    ...
    method row_field : row_field -> row_field -> row_field=
      fun _a0  _b0  ->
        match (_a0, _b0) with
        | ((#nil as _a0),(#nil as _b0)) ->
            (self#nil _a0 _b0 : nil  :>row_field)
    ...
    method tag_names : tag_names -> tag_names -> tag_names=
      fun _a0  _b0  ->
        match (_a0, _b0) with
        | ((#nil as _a0),(#nil as _b0)) ->
            (self#nil _a0 _b0 : nil  :>tag_names)
        | (`App (_a0,_a1,_a2),`App (_b0,_b1,_b2)) ->
            let _a0 = self#loc _a0 _b0 in
...
class map =
  object (self : 'self_type)
    ...
    method nil : nil -> nil=
      ...
      | #ant as _a0 -> (self#ant _a0 : ant  :>nil)
    method literal : literal -> literal=
      ...
      | #ant as _a0 -> (self#ant _a0 : ant  :>literal)
    ...
    method aident : aident -> aident=
      ...
      | #ant as _a0 -> (self#ant _a0 : ant  :>aident)
    ...
    method uident : uident -> uident=
      ...
      | #ant as _a0 -> (self#ant _a0 : ant  :>uident)
    method ident : ident -> ident=
      ...
      | #ant as _a0 -> (self#ant _a0 : ant  :>ident)
    method dupath : dupath -> dupath=
      ...
      | #ant as _a0 -> (self#ant _a0 : ant  :>dupath)
    method dlpath : dlpath -> dlpath=
      ...
      | #ant as _a0 -> (self#ant _a0 : ant  :>dlpath)
    method sid : sid -> sid=
      function
      | `Id (_a0,_a1) ->
          let _a0 = self#loc _a0 in
          let _a1 = self#ident _a1 in `Id (_a0, _a1)
      | #ant as _a0 -> (self#ant _a0 : ant  :>sid)
    method any : any -> any=
      function
      | `Any _a0 -> let _a0 = self#loc _a0 in `Any _a0
      | #ant as _a0 -> (self#ant _a0 : ant  :>any)
    ...
    method row_field : row_field -> row_field=
      function
      | #nil as _a0 -> (self#nil _a0 : nil  :>row_field)
      | `Or (_a0,_a1,_a2) ->
          let _a0 = self#loc _a0 in
          let _a1 = self#row_field _a1 in
    ...
    method tag_names : tag_names -> tag_names=
      function
      | #nil as _a0 -> (self#nil _a0 : nil  :>tag_names)
      | `App (_a0,_a1,_a2) ->
          let _a0 = self#loc _a0 in
    ...
    method typedecl : typedecl -> typedecl=
      ...
      | #nil as _a0 -> (self#nil _a0 : nil  :>typedecl)
    ...
    method or_ctyp : or_ctyp -> or_ctyp=
      ...
      | #nil as _a0 -> (self#nil _a0 : nil  :>or_ctyp)
  ...
  object (self : 'self_type)
    ...
    method typedecl : 'fmt -> typedecl -> 'result298=
      fun fmt  ->
        ...
        | #nil as _a0 -> (self#nil fmt _a0 :>'result298)
    ...
    method type_info : 'fmt -> type_info -> 'result299=
      fun fmt  ->
        ...
        | #nil as _a0 -> (self#nil fmt _a0 :>'result299)
    ...
    method of_ctyp : 'fmt -> of_ctyp -> 'result303=
      fun fmt  ->
        ...
        | #nil as _a0 -> (self#nil fmt _a0 :>'result303)
...
class eq =
  object (self : 'self_type)
    ...
    method row_field : row_field -> row_field -> 'result350=
      fun _a0  _b0  ->
        match (_a0, _b0) with
        | ((#nil as _a0),(#nil as _b0)) -> (self#nil _a0 _b0 :>'result350)
        | (`Or (_a0,_a1,_a2),`Or (_b0,_b1,_b2)) ->
            ((self#loc _a0 _b0) && (self#row_field _a1 _b1)) &&
    ...
    method tag_names : tag_names -> tag_names -> 'result351=
      fun _a0  _b0  ->
        match (_a0, _b0) with
        | ((#nil as _a0),(#nil as _b0)) -> (self#nil _a0 _b0 :>'result351)
        | (`App (_a0,_a1,_a2),`App (_b0,_b1,_b2)) ->
    ...
    method typedecl : typedecl -> typedecl -> 'result352=
      fun _a0  _b0  ->
        ...
        | ((#nil as _a0),(#nil as _b0)) -> (self#nil _a0 _b0 :>'result352)
    ...
    method of_ctyp : of_ctyp -> of_ctyp -> 'result357=
      fun _a0  _b0  ->
        ...
        | ((#nil as _a0),(#nil as _b0)) -> (self#nil _a0 _b0 :>'result357)
...
and pp_print_class_str_item fmt =
  function
  | #nil as _a0 -> (pp_print_nil fmt _a0 :>'result452)
  | `Sem (_a0,_a1,_a2) ->
      Format.fprintf fmt "@[<1>(`Sem@ %a@ %a@ %a)@]" pp_print_loc _a0
