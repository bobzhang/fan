...
let rec pp_print_ctyp fmt =
  ...
  | `OptLabl (_a0,_a1,_a2) ->
      Format.fprintf fmt "@[<1>(`OptLabl@ %a@ %a@ %a)@]" pp_print_loc _a0
        pp_print_alident _a1 pp_print_ctyp _a2
  | #sid as _a0 -> (pp_print_sid fmt _a0 :>'result53)
  | `TyObj (_a0,_a1,_a2) ->
...
and pp_print_of_ctyp fmt =
  ...
  | `Of (_a0,_a1,_a2) ->
      Format.fprintf fmt "@[<1>(`Of@ %a@ %a@ %a)@]" pp_print_loc _a0
        pp_print_sid _a1 pp_print_ctyp _a2
  | #sid as _a0 -> (pp_print_sid fmt _a0 :>'result39)
  | #ant as _a0 -> (pp_print_ant fmt _a0 :>'result39)
and pp_print_pat fmt =
  function
  | #sid as _a0 -> (pp_print_sid fmt _a0 :>'result38)
  | `App (_a0,_a1,_a2) ->
      Format.fprintf fmt "@[<1>(`App@ %a@ %a@ %a)@]" pp_print_loc _a0
...
and pp_print_exp fmt =
  function
  | #sid as _a0 -> (pp_print_sid fmt _a0 :>'result36)
  | `App (_a0,_a1,_a2) ->
      Format.fprintf fmt "@[<1>(`App@ %a@ %a@ %a)@]" pp_print_loc _a0
  ...
  | #literal as _a0 -> (pp_print_literal fmt _a0 :>'result36)
...
and pp_print_module_type fmt =
  function
  | #sid as _a0 -> (pp_print_sid fmt _a0 :>'result34)
...
and pp_print_module_exp fmt =
  function
  | #sid as _a0 -> (pp_print_sid fmt _a0 :>'result28)
  | `App (_a0,_a1,_a2) ->
      Format.fprintf fmt "@[<1>(`App@ %a@ %a@ %a)@]" pp_print_loc _a0
...
let rec pp_print_ep fmt =
  ...
  | #literal as _a0 -> (pp_print_literal fmt _a0 :>'result55)
...
class print =
  object (self : 'self_type)
    ...
    method strings : 'fmt -> strings -> 'result68=
      fun fmt  ->
        function
        | `App (_a0,_a1,_a2) ->
    ...
    method alident : 'fmt -> alident -> 'result69=
      fun fmt  ->
        function
        | `Lid (_a0,_a1) ->
    ...
    method auident : 'fmt -> auident -> 'result70=
      fun fmt  ->
        function
        | `Uid (_a0,_a1) ->
    ...
    method aident : 'fmt -> aident -> 'result71=
      fun fmt  ->
        function
        | #alident as _a0 -> (self#alident fmt _a0 :>'result71)
        | #auident as _a0 -> (self#auident fmt _a0 :>'result71)
    method astring : 'fmt -> astring -> 'result72=
      fun fmt  ->
        function
        | `C (_a0,_a1) ->
    ...
    method uident : 'fmt -> uident -> 'result73=
      fun fmt  ->
        function
        | `Dot (_a0,_a1,_a2) ->
    ...
    method type_parameters : 'fmt -> type_parameters -> 'result80=
      fun fmt  ->
        function
        | `Com (_a0,_a1,_a2) ->
            Format.fprintf fmt "@[<1>(`Com@ %a@ %a@ %a)@]" self#loc _a0
    ...
    method row_field : 'fmt -> row_field -> 'result81=
      fun fmt  ->
        function
        ...
        | `Ctyp (_a0,_a1) ->
            Format.fprintf fmt "@[<1>(`Ctyp@ %a@ %a)@]" self#loc _a0
              self#ctyp _a1
    method tag_names : 'fmt -> tag_names -> 'result82=
      fun fmt  ->
        function
        ...
        | `TyVrn (_a0,_a1) ->
            Format.fprintf fmt "@[<1>(`TyVrn@ %a@ %a)@]" self#loc _a0
              self#astring _a1
    method typedecl : 'fmt -> typedecl -> 'result83=
      fun fmt  ->
        function
        | `TyDcl (_a0,_a1,_a2,_a3,_a4) ->
    ...
    method type_constr : 'fmt -> type_constr -> 'result84=
      fun fmt  ->
        function
        | `And (_a0,_a1,_a2) ->
            Format.fprintf fmt "@[<1>(`And@ %a@ %a@ %a)@]" self#loc _a0
    ...
    method opt_type_constr : 'fmt -> opt_type_constr -> 'result85=
      fun fmt  ->
        function
        | `Some (_a0,_a1) ->
    ...
    method decl_param : 'fmt -> decl_param -> 'result86=
      fun fmt  ->
        function
        | `Quote (_a0,_a1,_a2) ->
            Format.fprintf fmt "@[<1>(`Quote@ %a@ %a@ %a)@]" self#loc _a0
    ...
    method decl_params : 'fmt -> decl_params -> 'result87=
      fun fmt  ->
        function
        | `Quote (_a0,_a1,_a2) ->
            Format.fprintf fmt "@[<1>(`Quote@ %a@ %a@ %a)@]" self#loc _a0
    ...
    method opt_decl_params : 'fmt -> opt_decl_params -> 'result88=
      fun fmt  ->
        function
        | `Some (_a0,_a1) ->
            Format.fprintf fmt "@[<1>(`Some@ %a@ %a)@]" self#loc _a0
        ...
        | `None _a0 -> Format.fprintf fmt "@[<1>(`None@ %a)@]" self#loc _a0
    method type_info : 'fmt -> type_info -> 'result89=
      fun fmt  ->
        function
        | `TyMan (_a0,_a1,_a2,_a3) ->
    ...
    method type_repr : 'fmt -> type_repr -> 'result90=
      fun fmt  ->
        function
        | `Record (_a0,_a1) ->
    ...
    method name_ctyp : 'fmt -> name_ctyp -> 'result91=
      fun fmt  ->
        function
        | `Sem (_a0,_a1,_a2) ->
    ...
    method or_ctyp : 'fmt -> or_ctyp -> 'result92=
      fun fmt  ->
        function
        | `Or (_a0,_a1,_a2) ->
            Format.fprintf fmt "@[<1>(`Or@ %a@ %a@ %a)@]" self#loc _a0
    ...
    method of_ctyp : 'fmt -> of_ctyp -> 'result93=
      fun fmt  ->
        function
        | `Of (_a0,_a1,_a2) ->
            Format.fprintf fmt "@[<1>(`Of@ %a@ %a@ %a)@]" self#loc _a0
              self#sid _a1 self#ctyp _a2
        | #sid as _a0 -> (self#sid fmt _a0 :>'result93)
        | #ant as _a0 -> (self#ant fmt _a0 :>'result93)
    method pat : 'fmt -> pat -> 'result94=
      fun fmt  ->
        function
    ...
    method rec_pat : 'fmt -> rec_pat -> 'result95=
      fun fmt  ->
        function
        | `RecBind (_a0,_a1,_a2) ->
      ...
      fun fmt  ->
        ...
        | `Package_exp (_a0,_a1) ->
            Format.fprintf fmt "@[<1>(`Package_exp@ %a@ %a)@]" self#loc _a0
              self#module_exp _a1
    method rec_exp : 'fmt -> rec_exp -> 'result97=
      fun fmt  ->
        function
        | `Sem (_a0,_a1,_a2) ->
            Format.fprintf fmt "@[<1>(`Sem@ %a@ %a@ %a)@]" self#loc _a0
    ...
    method module_type : 'fmt -> module_type -> 'result98=
      fun fmt  ->
        function
    ...
    method sig_item : 'fmt -> sig_item -> 'result99=
      fun fmt  ->
        function
        | `Class (_a0,_a1) ->
    ...
    method with_constr : 'fmt -> with_constr -> 'result100=
      fun fmt  ->
        function
        | `TypeEq (_a0,_a1,_a2) ->
    ...
    method binding : 'fmt -> binding -> 'result101=
      fun fmt  ->
        function
        | `And (_a0,_a1,_a2) ->
            Format.fprintf fmt "@[<1>(`And@ %a@ %a@ %a)@]" self#loc _a0
    ...
    method module_binding : 'fmt -> module_binding -> 'result102=
      fun fmt  ->
        function
        | `And (_a0,_a1,_a2) ->
            Format.fprintf fmt "@[<1>(`And@ %a@ %a@ %a)@]" self#loc _a0
    ...
    method case : 'fmt -> case -> 'result103=
      fun fmt  ->
        function
        | `Or (_a0,_a1,_a2) ->
            Format.fprintf fmt "@[<1>(`Or@ %a@ %a@ %a)@]" self#loc _a0
    ...
    method module_exp : 'fmt -> module_exp -> 'result104=
      fun fmt  ->
        function
    ...
    method stru : 'fmt -> stru -> 'result105=
      fun fmt  ->
        function
        | `Class (_a0,_a1) ->
            Format.fprintf fmt "@[<1>(`Class@ %a@ %a)@]" self#loc _a0
    ...
    method class_type : 'fmt -> class_type -> 'result106=
      fun fmt  ->
        function
        | `ClassCon (_a0,_a1,_a2,_a3) ->
    ...
    method class_sig_item : 'fmt -> class_sig_item -> 'result107=
      fun fmt  ->
        function
        | `Eq (_a0,_a1,_a2) ->
            Format.fprintf fmt "@[<1>(`Eq@ %a@ %a@ %a)@]" self#loc _a0
    ...
    method class_exp : 'fmt -> class_exp -> 'result108=
      fun fmt  ->
        function
        | `CeApp (_a0,_a1,_a2) ->
    ...
    method cstru : 'fmt -> cstru -> 'result109=
      fun fmt  ->
        function
        | `Sem (_a0,_a1,_a2) ->
            Format.fprintf fmt "@[<1>(`Sem@ %a@ %a@ %a)@]" self#loc _a0
    ...
    method ep : 'fmt -> ep -> 'result110=
      fun fmt  ->
        function
        | #sid as _a0 -> (self#sid fmt _a0 :>'result110)
        | `App (_a0,_a1,_a2) ->
            Format.fprintf fmt "@[<1>(`App@ %a@ %a@ %a)@]" self#loc _a0
        ...
        | `Tup (_a0,_a1) ->
            Format.fprintf fmt "@[<1>(`Tup@ %a@ %a)@]" self#loc _a0 self#ep
              _a1
        | #any as _a0 -> (self#any fmt _a0 :>'result110)
        | `ArrayEmpty _a0 ->
            Format.fprintf fmt "@[<1>(`ArrayEmpty@ %a)@]" self#loc _a0
        | `Array (_a0,_a1) ->
            Format.fprintf fmt "@[<1>(`Array@ %a@ %a)@]" self#loc _a0 
        ...
        | `Record (_a0,_a1) ->
            Format.fprintf fmt "@[<1>(`Record@ %a@ %a)@]" self#loc _a0
              self#rec_bind _a1
        | #literal as _a0 -> (self#literal fmt _a0 :>'result110)
        | #ant as _a0 -> (self#ant fmt _a0 :>'result110)
    method rec_bind : 'fmt -> rec_bind -> 'result111=
      fun fmt  ->
        function
        | `RecBind (_a0,_a1,_a2) ->
            Format.fprintf fmt "@[<1>(`RecBind@ %a@ %a@ %a)@]" self#loc _a0
        ...
        | #any as _a0 -> (self#any fmt _a0 :>'result111)
        | #ant as _a0 -> (self#ant fmt _a0 :>'result111)
    method fanloc_t : 'fmt -> FanLoc.t -> 'result112= self#unknown
    method fanutil_anti_cxt : 'fmt -> FanUtil.anti_cxt -> 'result113=
      self#unknown
  end
class map =
  object (self : 'self_type)
...
let rec strip_loc_ctyp =
  ...
  | #sid as _a0 -> (strip_loc_sid _a0 :>'result281)
  | `TyObj (_a0,_a1,_a2) ->
...
and strip_loc_or_ctyp =
  ...
  | #sid as _a0 -> (strip_loc_sid _a0 :>'result268)
...
and strip_loc_pat =
  ...
  | #literal as _a0 -> (strip_loc_literal _a0 :>'result266)
  | `Alias (_a0,_a1,_a2) ->
      let _a1 = strip_loc_pat _a1 in
      let _a2 = strip_loc_alident _a2 in `Alias (_a1, _a2)
...
and strip_loc_rec_pat =
  ...
  | #any as _a0 -> (strip_loc_any _a0 :>'result265)
  | #ant as _a0 -> (strip_loc_ant _a0 :>'result265)
and strip_loc_exp =
  function
  | #sid as _a0 -> (strip_loc_sid _a0 :>'result264)
  | `App (_a0,_a1,_a2) ->
  ...
  | #literal as _a0 -> (strip_loc_literal _a0 :>'result264)
  | `RecordWith (_a0,_a1,_a2) ->
...
and strip_loc_rec_exp =
  ...
  | #any as _a0 -> (strip_loc_any _a0 :>'result263)
  | #ant as _a0 -> (strip_loc_ant _a0 :>'result263)
and strip_loc_module_type =
  function
  | #sid as _a0 -> (strip_loc_sid _a0 :>'result262)
  | `Functor (_a0,_a1,_a2,_a3) ->
      let _a1 = strip_loc_auident _a1 in
...
and strip_loc_module_exp =
  function
  | #sid as _a0 -> (strip_loc_sid _a0 :>'result256)
  | `App (_a0,_a1,_a2) ->
...
let rec strip_loc_ep =
  ...
  | #literal as _a0 -> (strip_loc_literal _a0 :>'result283)
