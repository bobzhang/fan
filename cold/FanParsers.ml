 ...
 functor (Syntax : Sig.Camlp4Syntax) ->
  struct
   ...
   let _ = let _ = (expr : 'expr Gram.t) in
           ...
           let end_or_in =
            ((grammar_entry_create "end_or_in") : 'end_or_in Gram.t)
           and start_debug =
...
module IdGrammarParser =
 struct let name = "Camlp4GrammarParser" let version = Sys.ocaml_version end
 ...
 functor (Syntax : Sig.Camlp4Syntax) ->
  struct
   ...
   let _ = let _ = (expr : 'expr Gram.t)
           and _ = (level_list : 'level_list Gram.t)
           and _ = (level : 'level Gram.t)
           and _ = (psymbol : 'psymbol Gram.t)
           and _ = (rule_list : 'rule_list Gram.t)
           and _ = (rule : 'rule Gram.t)
           ...
           and pattern = ((grammar_entry_create "pattern") : 'pattern Gram.t)
           ...
           and qualuid = ((grammar_entry_create "qualuid") : 'qualuid Gram.t)
 ...
 functor (Syntax : Sig.Camlp4Syntax) ->
  struct
   ...
   type 'a item_or_def =
    ...
    | SdLazy of 'a Lazy.t
   let defined = (ref [] )
   let is_defined = fun i -> (List.mem_assoc i ( defined.contents ))
   ...
   let parse_include_file =
    fun rule ->
     let dir_ok = fun file -> fun dir -> (Sys.file_exists ( (dir ^ file) )) in
     fun file ->
      let file =
       (try
         ((
   ...
   let make_SdITE_result =
    fun st1 ->
     fun st2 -> let test = (Stack.pop stack) in (SdITE (test, st1, st2))
   ...
   let _ = let _ = (expr : 'expr Gram.t)
           ...
           let grammar_entry_create = Gram.mk in
           let macro_def =
            ((grammar_entry_create "macro_def") : 'macro_def Gram.t)
           and uident =
            ((grammar_entry_create "uident") : 'uident Gram.t)
           and opt_macro_value =
           ...
           and else_expr =
            ((grammar_entry_create "else_expr") : 'else_expr Gram.t)
...
module MakeRevisedParser =
 functor (Syntax : Sig.Camlp4Syntax) ->
  struct
   ...
   let _ = let _ = (a_CHAR : 'a_CHAR Gram.t)
           and _ = (override_flag_quot : 'override_flag_quot Gram.t)
           and _ = (row_var_flag_quot : 'row_var_flag_quot Gram.t)
           and _ = (virtual_flag_quot : 'virtual_flag_quot Gram.t)
           and _ = (private_flag_quot : 'private_flag_quot Gram.t)
           and _ = (mutable_flag_quot : 'mutable_flag_quot Gram.t)
           and _ = (direction_flag_quot : 'direction_flag_quot Gram.t)
           and _ = (rec_flag_quot : 'rec_flag_quot Gram.t)
           and _ = (package_type : 'package_type Gram.t)
           and _ = (do_sequence : 'do_sequence Gram.t)
           and _ = (infixop4 : 'infixop4 Gram.t)
           and _ = (infixop3 : 'infixop3 Gram.t)
           and _ = (infixop2 : 'infixop2 Gram.t)
           and _ = (infixop1 : 'infixop1 Gram.t)
           and _ = (infixop0 : 'infixop0 Gram.t)
           and _ = (with_constr_quot : 'with_constr_quot Gram.t)
           and _ = (with_constr : 'with_constr Gram.t)
           and _ = (val_longident : 'val_longident Gram.t)
           and _ = (use_file : 'use_file Gram.t)
           and _ = (typevars : 'typevars Gram.t)
           and _ = (type_parameters : 'type_parameters Gram.t)
           and _ = (type_parameter : 'type_parameter Gram.t)
           and _ =
            (type_longident_and_parameters :
              'type_longident_and_parameters Gram.t)
           and _ = (type_longident : 'type_longident Gram.t)
           and _ = (type_kind : 'type_kind Gram.t)
           and _ =
            (type_ident_and_parameters : 'type_ident_and_parameters Gram.t)
           and _ = (type_declaration : 'type_declaration Gram.t)
           and _ = (type_constraint : 'type_constraint Gram.t)
           and _ = (top_phrase : 'top_phrase Gram.t)
           and _ = (str_items : 'str_items Gram.t)
           and _ = (str_item_quot : 'str_item_quot Gram.t)
           and _ = (str_item : 'str_item Gram.t)
           and _ = (star_ctyp : 'star_ctyp Gram.t)
           and _ = (sig_items : 'sig_items Gram.t)
           and _ = (sig_item_quot : 'sig_item_quot Gram.t)
           and _ = (sig_item : 'sig_item Gram.t)
           and _ = (sequence : 'sequence Gram.t)
           and _ = (semi : 'semi Gram.t)
           and _ = (sem_patt_for_list : 'sem_patt_for_list Gram.t)
           and _ = (sem_patt : 'sem_patt Gram.t)
           and _ = (sem_expr_for_list : 'sem_expr_for_list Gram.t)
           and _ = (sem_expr : 'sem_expr Gram.t)
           and _ = (row_field : 'row_field Gram.t)
           and _ = (poly_type : 'poly_type Gram.t)
           and _ = (phrase : 'phrase Gram.t)
           and _ = (patt_tcon : 'patt_tcon Gram.t)
           and _ = (patt_quot : 'patt_quot Gram.t)
           and _ = (patt_eoi : 'patt_eoi Gram.t)
           and _ = (patt_as_patt_opt : 'patt_as_patt_opt Gram.t)
           and _ = (patt : 'patt Gram.t)
           and _ = (opt_when_expr : 'opt_when_expr Gram.t)
           and _ = (opt_virtual : 'opt_virtual Gram.t)
           and _ = (opt_rec : 'opt_rec Gram.t)
           and _ = (opt_private : 'opt_private Gram.t)
           and _ = (opt_polyt : 'opt_polyt Gram.t)
           and _ = (opt_mutable : 'opt_mutable Gram.t)
           and _ = (opt_meth_list : 'opt_meth_list Gram.t)
           and _ = (opt_expr : 'opt_expr Gram.t)
           and _ = (opt_eq_ctyp : 'opt_eq_ctyp Gram.t)
           and _ = (opt_dot_dot : 'opt_dot_dot Gram.t)
           and _ = (opt_comma_ctyp : 'opt_comma_ctyp Gram.t)
           and _ = (opt_class_self_type : 'opt_class_self_type Gram.t)
           and _ = (opt_class_self_patt : 'opt_class_self_patt Gram.t)
           and _ = (opt_as_lident : 'opt_as_lident Gram.t)
           and _ = (name_tags : 'name_tags Gram.t)
           and _ = (more_ctyp : 'more_ctyp Gram.t)
           and _ = (module_type_quot : 'module_type_quot Gram.t)
           and _ = (module_type : 'module_type Gram.t)
           and _ = (module_rec_declaration : 'module_rec_declaration Gram.t)
           and _ =
            (module_longident_with_app : 'module_longident_with_app Gram.t)
           and _ = (module_longident : 'module_longident Gram.t)
           and _ = (module_expr_quot : 'module_expr_quot Gram.t)
           and _ = (module_expr : 'module_expr Gram.t)
           and _ = (module_declaration : 'module_declaration Gram.t)
           and _ = (module_binding_quot : 'module_binding_quot Gram.t)
           and _ = (module_binding0 : 'module_binding0 Gram.t)
           and _ = (module_binding : 'module_binding Gram.t)
           and _ = (meth_decl : 'meth_decl Gram.t)
           and _ = (meth_list : 'meth_list Gram.t)
           and _ = (let_binding : 'let_binding Gram.t)
           and _ = (labeled_ipatt : 'labeled_ipatt Gram.t)
           and _ = (label_patt_list : 'label_patt_list Gram.t)
           and _ = (label_patt : 'label_patt Gram.t)
           and _ = (label_longident : 'label_longident Gram.t)
           and _ = (label_ipatt_list : 'label_ipatt_list Gram.t)
           and _ = (label_ipatt : 'label_ipatt Gram.t)
           and _ = (label_expr_list : 'label_expr_list Gram.t)
           and _ = (label_expr : 'label_expr Gram.t)
           and _ = (label_declaration_list : 'label_declaration_list Gram.t)
           and _ = (label_declaration : 'label_declaration Gram.t)
           and _ = (label : 'label Gram.t)
           and _ = (ipatt_tcon : 'ipatt_tcon Gram.t)
           and _ = (ipatt : 'ipatt Gram.t)
           and _ = (interf : 'interf Gram.t)
           and _ = (implem : 'implem Gram.t)
           and _ = (ident_quot : 'ident_quot Gram.t)
           and _ = (ident : 'ident Gram.t)
           and _ = (fun_def : 'fun_def Gram.t)
           and _ = (fun_binding : 'fun_binding Gram.t)
           and _ = (field_expr_list : 'field_expr_list Gram.t)
           and _ = (field_expr : 'field_expr Gram.t)
           and _ = (expr_quot : 'expr_quot Gram.t)
           and _ = (expr_eoi : 'expr_eoi Gram.t)
           and _ = (expr : 'expr Gram.t)
           and _ = (eq_expr : 'eq_expr Gram.t)
           and _ = (dummy : 'dummy Gram.t)
           and _ = (direction_flag : 'direction_flag Gram.t)
           and _ = (cvalue_binding : 'cvalue_binding Gram.t)
           and _ = (ctyp_quot : 'ctyp_quot Gram.t)
           ...
           and _ = (constructor_arg_list : 'constructor_arg_list Gram.t)
           and _ = (constrain : 'constrain Gram.t)
           and _ = (comma_type_parameter : 'comma_type_parameter Gram.t)
           and _ = (comma_patt : 'comma_patt Gram.t)
           and _ = (comma_ipatt : 'comma_ipatt Gram.t)
           and _ = (comma_expr : 'comma_expr Gram.t)
           and _ = (comma_ctyp : 'comma_ctyp Gram.t)
           and _ = (class_type_quot : 'class_type_quot Gram.t)
           and _ = (class_type_plus : 'class_type_plus Gram.t)
           and _ =
            (class_type_longident_and_param :
              'class_type_longident_and_param Gram.t)
           and _ = (class_type_longident : 'class_type_longident Gram.t)
           and _ = (class_type_declaration : 'class_type_declaration Gram.t)
           and _ = (class_type : 'class_type Gram.t)
           and _ = (class_structure : 'class_structure Gram.t)
           and _ = (class_str_item_quot : 'class_str_item_quot Gram.t)
           and _ = (class_str_item : 'class_str_item Gram.t)
           and _ = (class_signature : 'class_signature Gram.t)
           and _ = (class_sig_item_quot : 'class_sig_item_quot Gram.t)
           and _ = (class_sig_item : 'class_sig_item Gram.t)
           and _ = (class_name_and_param : 'class_name_and_param Gram.t)
           and _ =
            (class_longident_and_param : 'class_longident_and_param Gram.t)
           and _ = (class_longident : 'class_longident Gram.t)
           and _ =
            (class_info_for_class_type : 'class_info_for_class_type Gram.t)
           and _ =
            (class_info_for_class_expr : 'class_info_for_class_expr Gram.t)
           and _ = (class_fun_def : 'class_fun_def Gram.t)
           and _ = (class_fun_binding : 'class_fun_binding Gram.t)
           and _ = (class_expr_quot : 'class_expr_quot Gram.t)
           and _ = (class_expr : 'class_expr Gram.t)
           and _ = (class_description : 'class_description Gram.t)
           and _ = (class_declaration : 'class_declaration Gram.t)
           and _ = (binding_quot : 'binding_quot Gram.t)
           and _ = (binding : 'binding Gram.t)
           and _ = (match_case_quot : 'match_case_quot Gram.t)
           and _ = (match_case0 : 'match_case0 Gram.t)
           and _ = (match_case : 'match_case Gram.t)
           and _ = (and_ctyp : 'and_ctyp Gram.t)
           and _ = (amp_ctyp : 'amp_ctyp Gram.t)
           and _ = (a_ident : 'a_ident Gram.t)
           and _ = (a_UIDENT : 'a_UIDENT Gram.t)
           and _ = (a_STRING : 'a_STRING Gram.t)
           and _ = (a_OPTLABEL : 'a_OPTLABEL Gram.t)
           and _ = (a_NATIVEINT : 'a_NATIVEINT Gram.t)
           and _ = (rec_binding_quot : 'rec_binding_quot Gram.t)
           and _ = (a_LIDENT : 'a_LIDENT Gram.t)
           and _ = (a_LABEL : 'a_LABEL Gram.t)
           and _ = (a_INT64 : 'a_INT64 Gram.t)
           and _ = (a_INT32 : 'a_INT32 Gram.t)
           and _ = (a_INT : 'a_INT Gram.t)
           and _ = (a_FLOAT : 'a_FLOAT Gram.t) in
           let grammar_entry_create = Gram.mk in
           let infixop5 =
            ((grammar_entry_create "infixop5") : 'infixop5 Gram.t)
           and string_list =
            ((grammar_entry_create "string_list") : 'string_list Gram.t)
           and opt_override =
           ...
           and sequence' =
            ((grammar_entry_create "sequence'") : 'sequence' Gram.t)
           and infixop6 =
                       ...
                       fun __camlp4_0 ->
                        fun (_loc :
                         ...
                         (match __camlp4_0 with
                          | (`QUOTATION x) ->
                             ((Quotation.expand _loc x
                                DynAst.module_binding_tag) : 'module_binding)
                          | _ -> assert false) )) ));
                    ((
                     [`Stoken
                       (((
                       ...
                       fun __camlp4_0 ->
                        fun (_loc :
                         ...
                         (match __camlp4_0 with
                          | (`QUOTATION x) ->
                             ((Quotation.expand _loc x
                                DynAst.class_str_item_tag) : 'class_str_item)
                          | _ -> assert false) )) ));
                    ((
                     [`Stoken
                       (((
                       ...
                       fun __camlp4_0 ->
                        fun (_loc :
                         ...
                         (match __camlp4_0 with
                          | (`QUOTATION x) ->
                             ((Quotation.expand _loc x
                                DynAst.class_sig_item_tag) : 'class_sig_item)
                          | _ -> assert false) )) ));
                    ((
                     [`Stoken
                       (((
...
module MakeRevisedParserParser =
 functor (Syntax : Sig.Camlp4Syntax) ->
  struct
     ...
     (match e with
      | Ast.ExApp
         (_, Ast.ExId (_, Ast.IdLid (_, "raise")),
          Ast.ExId
           (_,
            Ast.IdAcc (_, Ast.IdUid (_, "Stream"), Ast.IdUid (_, "Failure")))) ->
         (true)
      | _ -> (false))
   ...
   let _ = let _ = (expr : 'expr Gram.t)
           and _ = (parser_case_list : 'parser_case_list Gram.t)
           and _ = (parser_case : 'parser_case Gram.t)
           and _ = (stream_quot : 'stream_quot Gram.t)
           and _ = (stream_end : 'stream_end Gram.t)
           and _ = (stream_begin : 'stream_begin Gram.t)
