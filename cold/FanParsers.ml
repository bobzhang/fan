 ...
 functor (Syntax : Sig.Camlp4Syntax) ->
  struct
   ...
   let _ = let _ = (a_CHAR : 'a_CHAR Gram.t)
                ...
                (None , (
                 [(( (Some ("top")) ), ( (Some (`RA)) ), (
                   [((
                    ...
                    ((
                     [`Skeyword ("if"); `Sself; `Skeyword ("then");
                    ...
                    ((
                     [`Skeyword ("fun"); `Skeyword ("[");
                      `Slist0sep
                       ((`Snterm
                          ((Gram.obj (
                             (match_case0 : 'match_case0 Gram.t) ))),
                         `Skeyword ("|"))); `Skeyword ("]")] ), (
                     (Gram.mk_action (
                       fun _ ->
                        fun (a :
                 ...
                 [(None , None , (
                   [((
                     [`Snterm
                      ...
                      `Snterm
                       ((Gram.obj (
                          (opt_when_expr : 'opt_when_expr Gram.t) )));
                      `Skeyword ("->");
                      `Snterm ((Gram.obj ( (expr : 'expr Gram.t) )))] ),
                     (
                     (Gram.mk_action (
                   ...
                   [((
                    ...
                    ((
                     [`Skeyword ("<");
                      `Snterm
                       ((Gram.obj (
                          (opt_meth_list : 'opt_meth_list Gram.t) )));
                      `Skeyword (">")] ), (
                     (Gram.mk_action (
                       fun _ ->
                        fun (t :
                   ...
                   [((
                    ...
                    ((
                     [`Skeyword ("fun");
                      ...
                      `Snterm
                       ((Gram.obj (
                          (class_fun_def : 'class_fun_def Gram.t) )))] ),
                     (
                     (Gram.mk_action (
                       fun (ce :
                         'class_fun_def) ->
                   ...
                   [((
                    ...
                    ((
                     [`Skeyword ("inherit");
                      ...
                      `Snterm
                       ((Gram.obj (
                          (opt_as_lident : 'opt_as_lident Gram.t) )))] ),
                     (
                     (Gram.mk_action (
                       fun (pb :
                         'opt_as_lident) ->
           ...
           (
           (Gram.extend (
             (override_flag_quot : 'override_flag_quot Gram.t) ) (
             ((fun ()
                 ->
                (None , (
                 [(None , None , (
                  ...
                  (_, Ast.PaId (_, Ast.IdLid (_, v)),
                   Ast.TyApp
                    (_,
                     ...
                     Ast.TyAny (_))), Ast.ExNil (_), e)) when
              (v = strm_n) ->
              e
           | _ ->
              (Ast.ExApp
                   ...
                   [((
                     [`Skeyword ("match");
                      ...
                      `Sopt
                       (`Snterm
                         ((Gram.obj (
                            (parser_ipatt : 'parser_ipatt Gram.t) ))));
                      `Snterm
                       ((Gram.obj (
                    ...
                    ((
                     [`Skeyword ("[");
                      `Slist0sep
                       ((`Snterm
                          ((Gram.obj (
                             (parser_case : 'parser_case Gram.t) ))),
                         `Skeyword ("|"))); `Skeyword ("]")] ), (
                     (Gram.mk_action (
                       fun _ ->
                        fun (pcl :
...
module MakeQuotationExpander =
 functor (Syntax : Sig.Camlp4Syntax) ->
  struct module M = (MakeQuotationCommon)(Syntax)
   include M
   end
