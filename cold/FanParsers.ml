          ...
          Gram.mk_action (
            fun __camlp4_0 ->
              fun (_loc : FanLoc.t ) ->
                ...
                | _ -> assert false ) ));
          ([`Stoken (( ( function | `UIDENT _ -> true | _ -> false ) ),
              (`Normal, "`UIDENT _")); `Skeyword "."; `Sself], (
          Gram.mk_action (
            fun (xs : 'qualuid) ->
              fun _ ->
                fun __camlp4_0 ->
    ...
    Gram.extend (psymbol :'psymbol Gram.t  ) (
      (
        fun () -> (None, [(None, None,
          ...
          `Skeyword "{"; `Snterm ( Gram.obj (pattern :'pattern Gram.t  ) );
          `Skeyword "}"], (
          Gram.mk_action (
            fun _ ->
              fun (p : 'pattern) ->
    ...
    Gram.extend (symbol :'symbol Gram.t  ) (
      (
        fun () -> (None, [(( Some "top" ), ( Some `NA ),
          ...
          `Sopt (
            Gram.srules symbol
              [([`Stoken (( ( function | `UIDENT "Level" -> true | _ -> false
                   ) ), (`Normal, "`UIDENT \"Level\""));
              `Stoken (( ( function | `STRING (_,_) -> true | _ -> false ) ),
                (`Normal, "`STRING (_,_)"))], (
              Gram.mk_action (
          ...
          Gram.mk_action (
            fun __camlp4_0 ->
              fun (_loc : FanLoc.t ) ->
                match __camlp4_0 with
                | `STRING (_,s) ->
                    (mk_symbol ~used:[] ~text:( TXkwd (_loc, s) ) ~styp:(
                       STtok _loc ) ~pattern:None
                    :'symbol )
                ...
                fun _ ->
                  fun (_loc : FanLoc.t ) ->
                    (let rl = retype_rule_list_without_patterns _loc rl in
                     ...
                     mk_symbol ~used ~text:(
                       TXrules (_loc, ( srules _loc t rl "" )) ) ~styp:(
                       STquo (_loc, t) ) ~pattern:None :'symbol ) ) ));
    ...
    Gram.extend (comma_patt :'comma_patt Gram.t  ) (
      (
        fun () -> (None, [(None, None,
          ...
          Gram.mk_action (
            fun (p : 'pattern) -> fun (_loc : FanLoc.t ) -> (p :'comma_patt )
        ...
        fun () -> (None, [(None, None,
          ...
          ([`Stry (
              Gram.srules item
                ...
                Gram.mk_action (
                  fun _ ->
                    fun (p : 'patt) -> fun (_loc : FanLoc.t ) -> (p :'e__5 )
                  ) ))]
              ); `Snterml (( Gram.obj (expr :'expr Gram.t  ) ), "top")], (
          Gram.mk_action (
            fun (e : 'expr) ->
...
module MakeMacroParser(Syntax:Sig.Camlp4Syntax) = struct
  ...
  let parse_include_file rule =
    ...
    fun file ->
      let file =
        try
          ( List.find ( dir_ok file ) ( include_dirs.contents @ ["./"] ) ) ^
            file
  ...
  let execute_macro_if_active_branch _loc nil cons branch macro_def =
    ...
    let item =
      if
        ( test && ( branch = Then ) ) || ( ( not test ) && ( branch = Else )
          )
  ...
  let _ =
      ...
      (
        fun () -> (None, [(None, None,
          ...
          Gram.mk_action (
            fun _ ->
              fun (st : 'sglist_else) ->
                fun _ -> fun (_loc : FanLoc.t ) -> (st :'else_macro_def_sig )
            ) ))])]) ) () );
                     ...
                     fun (d : 'macro_def) ->
                       fun (_loc : FanLoc.t ) ->
                         (execute_macro_if_active_branch _loc (
                            Ast.StNil _loc ) (
                            fun a -> fun b -> Ast.StSem (_loc, a, b) ) Then d
                         :'e__6 ) ) ))]
               )], (
          Gram.mk_action (
            fun (sml : 'e__6 list ) ->
                   ...
                   fun _ ->
                     fun (d : 'macro_def) ->
                       fun (_loc : FanLoc.t ) ->
                         (execute_macro_if_active_branch _loc (
                            Ast.StNil _loc ) (
                            fun a -> fun b -> Ast.StSem (_loc, a, b) ) Else d
                         :'e__7 ) ) ))]
               )], (
          Gram.mk_action (
            fun (sml : 'e__7 list ) ->
                   ...
                   fun _ ->
                     fun (d : 'macro_def_sig) ->
                       fun (_loc : FanLoc.t ) ->
                         (execute_macro_if_active_branch _loc (
                            Ast.SgNil _loc ) (
                            fun a -> fun b -> Ast.SgSem (_loc, a, b) ) Then d
                         :'e__8 ) ) ))]
               )], (
          Gram.mk_action (
            fun (sgl : 'e__8 list ) ->
                   ...
                   fun _ ->
                     fun (d : 'macro_def_sig) ->
                       fun (_loc : FanLoc.t ) ->
                         (execute_macro_if_active_branch _loc (
                            Ast.SgNil _loc ) (
                            fun a -> fun b -> Ast.SgSem (_loc, a, b) ) Else d
                         :'e__9 ) ) ))]
               )], (
          Gram.mk_action (
            fun (sgl : 'e__9 list ) ->
    ...
    Gram.extend (expr :'expr Gram.t  ) (
      (
        fun () -> (( Some ( `Level "top" ) ), [(None, None,
          [([`Skeyword "DEFINE";
          `Stoken (( ( function | `LIDENT _ -> true | _ -> false ) ),
            (`Normal, "`LIDENT _")); `Skeyword "="; `Sself; `Skeyword "IN";
          `Sself], (
          Gram.mk_action (
            fun (body : 'expr) ->
              fun _ ->
    ...
    Gram.extend (expr :'expr Gram.t  ) (
      (
        fun () -> (( Some ( `Before "simple" ) ), [(None, None,
          [([`Skeyword "`";
          `Snterm ( Gram.obj (a_ident :'a_ident Gram.t  ) )], (
          Gram.mk_action (
            fun (s : 'a_ident) ->
        ...
        fun () -> (None, [(( Some "top" ), None,
          ...
          Gram.mk_action (
            fun (ctd : 'class_type_declaration) ->
              fun _ ->
                fun _ ->
                  fun (_loc : FanLoc.t ) -> (Ast.StClt (_loc, ctd) :'str_item
                    ) ) )); ([`Skeyword "class";
              ...
              fun _ ->
                fun (t : 'ctyp) ->
                  fun _ ->
                    fun (i : 'a_LIDENT) ->
                      fun _ ->
                        fun (_loc : FanLoc.t ) -> (Ast.StExt (_loc, i, t, sl)
                          :'str_item ) ) )); ([`Skeyword "exception";
          `Snterm (
      ...
      (
        fun () -> (None, [(( Some "top" ), None, [([`Skeyword "functor";
          ...
          Gram.mk_action (
            fun (i : 'a_ident) ->
              fun _ ->
                fun (_loc : FanLoc.t ) -> (Ast.MtQuo (_loc, i) :'module_type
                  ) ) ));
          ([`Snterm (
        ...
        fun () -> (None, [(( Some "top" ), None, [([`Skeyword "class";
          ...
          Gram.mk_action (
            fun (ctd : 'class_type_declaration) ->
              fun _ ->
                fun _ ->
                  fun (_loc : FanLoc.t ) -> (Ast.SgClt (_loc, ctd) :'sig_item
                    ) ) )); ([`Skeyword "class";
              ...
              fun _ ->
                fun (t : 'ctyp) ->
                  fun _ ->
                    fun (i : 'a_LIDENT) ->
                      fun _ ->
                        fun (_loc : FanLoc.t ) -> (Ast.SgExt (_loc, i, t, sl)
                          :'sig_item ) ) )); ([`Skeyword "exception";
          `Snterm (
            Gram.obj (constructor_declaration
              :'constructor_declaration Gram.t  )
            )], (
              ...
              fun _ ->
                fun (t : 'module_type) ->
                  fun _ ->
                    fun (i : 'a_UIDENT) ->
                      fun _ ->
                        fun (_loc : FanLoc.t ) -> (Ast.MtFun (_loc, i, t, mt)
                ...
                fun (t1 : 'type_longident_and_parameters) ->
                  fun _ ->
                    fun (_loc : FanLoc.t ) -> (Ast.WcTyS (_loc, t1, t2)
                      :'with_constr ) ) )); ([`Skeyword "type";
          `Stoken (( (
            function | `ANTIQUOT (( ""|"typ"|"anti" ),_) -> true | _ -> false
      ...
      (
        fun () -> (None, [(( Some "top" ), ( Some `RA ),
          ...
          Gram.mk_action (
            fun (seq : 'do_sequence) ->
              fun _ ->
                fun (_loc : FanLoc.t ) -> (Expr.mksequence _loc seq :'expr )
              ...
              fun _ ->
                fun (mb : 'module_binding0) ->
                  fun (m : 'a_UIDENT) ->
                    fun _ ->
                      fun _ ->
                        fun (_loc : FanLoc.t ) -> (Ast.ExLmd (_loc, m, mb, e)
                          :'expr ) ) )); ([`Skeyword "let";
          `Snterm ( Gram.obj (opt_rec :'opt_rec Gram.t  ) );
          `Snterm ( Gram.obj (binding :'binding Gram.t  ) ); `Skeyword "in";
          `Sself], (
          ...
          Gram.mk_action (
            fun (e : 'expr) ->
              fun _ ->
                fun (_loc : FanLoc.t ) -> (Expr.mkumin _loc "-" e :'expr ) )
          ))]); (( Some "apply" ), ( Some `LA ), [([`Skeyword "lazy";
          `Sself], (
          Gram.mk_action (
            fun (e : 'expr) ->
              fun _ ->
            ...
            fun (e : 'expr) ->
              fun __camlp4_0 ->
                fun (_loc : FanLoc.t ) ->
                  ...
                  | _ -> assert false ) ));
          ([`Stoken (( ( function | `LABEL _ -> true | _ -> false ) ),
            ...
            fun _ ->
              fun (e2 : 'comma_expr) ->
                fun _ ->
                  fun _ ->
                    fun (e1 : 'expr) ->
                      fun (_loc : FanLoc.t ) -> (Expr.bigarray_get _loc e1 e2
                        :'expr ) ) )); ([`Sself; `Skeyword ".";
          `Skeyword "["; `Sself; `Skeyword "]"], (
          Gram.mk_action (
            fun _ ->
          ...
          Gram.mk_action (
            fun _ ->
              fun (me : 'module_expr) ->
                fun _ ->
                  fun _ ->
                    fun (_loc : FanLoc.t ) -> (Ast.ExPkg (_loc, me) :'expr )
                ...
                fun _ ->
                  fun _ ->
                    fun (e : 'expr) ->
                      fun _ ->
                        fun _ ->
                          fun (_loc : FanLoc.t ) -> (Ast.ExRec (_loc, el, e)
                            :'expr ) ) )); ([`Skeyword "{";
          `Snterm ( Gram.obj (label_expr_list :'label_expr_list Gram.t  ) );
          `Skeyword "}"], (
          Gram.mk_action (
          ...
          Gram.mk_action (
            fun _ ->
              fun (last : 'expr) ->
                fun _ ->
                  fun (mk_list : 'sem_expr_for_list) ->
                    fun _ -> fun (_loc : FanLoc.t ) -> (mk_list last :'expr )
            ) )); ([`Skeyword "["; `Skeyword "]"], (
          Gram.mk_action (
            fun _ ->
              fun _ ->
            ...
            fun _ ->
              fun (e : 'sequence) ->
                fun (i : 'module_longident_dot_lparen) ->
                  fun (_loc : FanLoc.t ) -> (Ast.ExOpI (_loc, i, e) :'expr )
        ...
        fun () -> (None, [(None, None, [([`Skeyword "done"], (
          ...
          ([`Stry (
              Gram.srules do_sequence [([`Skeyword "{"; `Skeyword "}"], (
                Gram.mk_action (
                  fun _ -> fun _ -> fun (_loc : FanLoc.t ) -> (() :'e__14 ) )
                ))]
              )], (
          Gram.mk_action (
            fun _ ->
    ...
    Gram.extend (comma_expr :'comma_expr Gram.t  ) (
      (
        fun () -> (None, [(None, None,
          ...
          ([`Stoken (( ( function | `ANTIQUOT ("list",_) -> true | _ -> false
    ...
    Gram.extend (sequence :'sequence Gram.t  ) (
      (
        fun () -> (None, [(None, None,
          ...
          Gram.mk_action (
            fun (k : 'sequence') ->
              fun (e : 'expr) -> fun (_loc : FanLoc.t ) -> (k e :'sequence )
            ) ));
          ([`Stoken (( ( function | `ANTIQUOT ("list",_) -> true | _ -> false
              ) ), (`Normal, "`ANTIQUOT (\"list\",_)"))], (
          Gram.mk_action (
        ...
        fun () -> (None, [(None, ( Some `RA ),
          ...
          ([`Stry (
              Gram.srules fun_binding [([`Skeyword "("; `Skeyword "type"], (
                Gram.mk_action (
                  fun _ -> fun _ -> fun (_loc : FanLoc.t ) -> (() :'e__18 ) )
                ))]
              ); `Snterm ( Gram.obj (a_LIDENT :'a_LIDENT Gram.t  ) );
          `Skeyword ")"; `Sself], (
          Gram.mk_action (
          ...
          Gram.mk_action (
            fun _ ->
              fun (l : 'match_case0 list ) ->
                fun _ ->
                  fun (_loc : FanLoc.t ) -> (Ast.mcOr_of_list l :'match_case
                    ) ) ))])]) ) () );
      ...
      (
        fun () -> (None, [(None, None,
          ...
          Gram.mk_action (
            fun (e : 'fun_binding) ->
              fun (i : 'label_longident) ->
                fun (_loc : FanLoc.t ) -> (Ast.RbEq (_loc, i, e) :'label_expr
                  ) ) ));
          ([`Stoken (( ( function | `ANTIQUOT ("list",_) -> true | _ -> false
              ) ), (`Normal, "`ANTIQUOT (\"list\",_)"))], (
          Gram.mk_action (
        ...
        fun () -> (None, [(None, None,
          ...
          ([`Stry (
              Gram.srules fun_def [([`Skeyword "("; `Skeyword "type"], (
                Gram.mk_action (
                  fun _ -> fun _ -> fun (_loc : FanLoc.t ) -> (() :'e__19 ) )
                ))]
              ); `Snterm ( Gram.obj (a_LIDENT :'a_LIDENT Gram.t  ) );
          `Skeyword ")";
          `Snterm (
        ...
        fun () -> (None, [(None, ( Some `RA ), [([`Skeyword "->";
          ...
          Gram.mk_action (
            fun (e : 'expr) ->
              fun _ ->
                fun (w : 'expr) ->
                  fun _ -> fun (_loc : FanLoc.t ) -> ((w, e) :'fun_def_cont )
            ) ));
          ([`Stry (
              `Snterm ( Gram.obj (labeled_ipatt :'labeled_ipatt Gram.t  ) ) );
          `Sself], (
          ...
          ([`Stry (
              Gram.srules fun_def_cont [([`Skeyword "("; `Skeyword "type"], (
                Gram.mk_action (
                  fun _ -> fun _ -> fun (_loc : FanLoc.t ) -> (() :'e__20 ) )
                ))]
              ); `Snterm ( Gram.obj (a_LIDENT :'a_LIDENT Gram.t  ) );
          `Skeyword ")";
          `Snterm (
    ...
    Gram.extend (fun_def_cont_no_when :'fun_def_cont_no_when Gram.t  ) (
      (
        fun () -> (None, [(None, ( Some `RA ), [([`Skeyword "->";
          ...
          Gram.mk_action (
            fun (e : 'expr) ->
              fun _ -> fun (_loc : FanLoc.t ) -> (e :'fun_def_cont_no_when )
            ) ));
          ([`Stry (
              `Snterm ( Gram.obj (labeled_ipatt :'labeled_ipatt Gram.t  ) ) );
          `Snterm ( Gram.obj (fun_def_cont :'fun_def_cont Gram.t  ) )], (
          ...
          ([`Stry (
              Gram.srules fun_def_cont_no_when [([`Skeyword "(";
                `Skeyword "type"], (
                Gram.mk_action (
                  fun _ -> fun _ -> fun (_loc : FanLoc.t ) -> (() :'e__21 ) )
                ))]
              ); `Snterm ( Gram.obj (a_LIDENT :'a_LIDENT Gram.t  ) );
          `Skeyword ")"; `Sself], (
          Gram.mk_action (
          ...
          Gram.mk_action (
            fun _ ->
              fun (last : 'patt) ->
                fun _ ->
                  fun (mk_list : 'sem_patt_for_list) ->
                    fun _ -> fun (_loc : FanLoc.t ) -> (mk_list last :'patt )
            ) )); ([`Skeyword "["; `Skeyword "]"], (
          Gram.mk_action (
            fun _ ->
              fun _ ->
          ...
          Gram.mk_action (
            fun _ ->
              fun (m : 'a_UIDENT) ->
                fun _ ->
                  fun _ ->
                    fun (_loc : FanLoc.t ) -> (Ast.PaMod (_loc, m) :'ipatt )
            ) )); ([`Skeyword "("; `Skeyword ")"], (
          Gram.mk_action (
            fun _ ->
              fun _ ->
    ...
    Gram.extend (comma_ipatt :'comma_ipatt Gram.t  ) (
      (
        fun () -> (None, [(None, ( Some `LA ),
          [([`Snterm ( Gram.obj (ipatt :'ipatt Gram.t  ) )], (
          Gram.mk_action (
            fun (p : 'ipatt) -> fun (_loc : FanLoc.t ) -> (p :'comma_ipatt )
            ) ));
          ([`Stoken (( ( function | `ANTIQUOT ("list",_) -> true | _ -> false
              ) ), (`Normal, "`ANTIQUOT (\"list\",_)"))], (
          Gram.mk_action (
            ...
            fun (cl : 'constrain list ) ->
              fun (tk : 'opt_eq_ctyp) ->
                fun ((n,tpl) : 'type_ident_and_parameters) ->
                  fun (_loc : FanLoc.t ) -> (Ast.TyDcl (_loc, n, tpl, tk, cl)
                    :'type_declaration ) ) )); ([`Sself; `Skeyword "and";
          `Sself], (
          Gram.mk_action (
        ...
        fun () -> (None, [(None, None, [([`Skeyword "constraint";
          ...
          Gram.mk_action (
            fun (t2 : 'ctyp) ->
              fun _ ->
                fun (t1 : 'ctyp) ->
                  fun _ -> fun (_loc : FanLoc.t ) -> ((t1, t2) :'constrain )
            ) ))])]) ) () );
        ...
        fun () -> (None, [(None, None, [([], (
          ...
          Gram.mk_action (
            fun (t : 'type_parameter) ->
              fun (_loc : FanLoc.t ) -> (fun acc -> Ast.TyApp (_loc, acc, t)
                :'type_parameters ) ) ));
          ([`Snterm ( Gram.obj (type_parameter :'type_parameter Gram.t  ) );
          `Sself], (
          Gram.mk_action (
    ...
    Gram.extend (ctyp :'ctyp Gram.t  ) (
      (
        fun () -> (None, [(( Some "==" ), ( Some `LA ), [([`Sself;
          ...
          ))]); (( Some "alias" ), ( Some `LA ), [([`Sself; `Skeyword "as";
          `Sself], (
          Gram.mk_action (
            fun (t2 : 'ctyp) ->
              fun _ ->
    ...
    Gram.extend (type_longident :'type_longident Gram.t  ) (
      (
        fun () -> (None, [(( Some "apply" ), None, [([`Sself; `Sself], (
          ...
          Gram.mk_action (
            fun (i : 'a_UIDENT) ->
              fun (_loc : FanLoc.t ) -> (Ast.IdUid (_loc, i) :'type_longident
                ) ) ));
          ([`Snterm ( Gram.obj (a_LIDENT :'a_LIDENT Gram.t  ) )], (
          Gram.mk_action (
            fun (i : 'a_LIDENT) ->
              fun (_loc : FanLoc.t ) -> (Ast.IdLid (_loc, i) :'type_longident
                ) ) ));
          ([`Stoken (( (
              function
              | `ANTIQUOT (( ""|"id"|"anti"|"list" ),_) -> true
          ...
          Gram.mk_action (
            fun _ ->
              fun (x : 'comma_type_parameter) ->
                fun _ ->
                  fun (i : 'a_LIDENT) ->
                    fun (_loc : FanLoc.t ) -> ((i, x) :'class_name_and_param
                      ) ) ))])]) ) () );
            ...
            fun (ce : 'class_expr) ->
              fun _ ->
                fun (bi : 'binding) ->
                  fun (rf : 'opt_rec) ->
                    fun _ ->
                      fun (_loc : FanLoc.t ) -> (Ast.CeLet (_loc, rf, bi, ce)
                        :'class_expr ) ) )); ([`Skeyword "fun";
          `Snterm ( Gram.obj (labeled_ipatt :'labeled_ipatt Gram.t  ) );
      ...
      (
        fun () -> (None, [(None, None, [([], (
          ...
          Gram.mk_action (
            fun _ ->
              fun (p : 'patt) ->
                fun _ -> fun (_loc : FanLoc.t ) -> (p :'opt_class_self_patt )
            ) ))])]) ) () );
      ...
      (
        fun () -> (None, [(None, None, [([], (
          ...
          Gram.mk_action (
            fun _ ->
              fun (t : 'ctyp) ->
                fun _ -> fun (_loc : FanLoc.t ) -> (t :'opt_class_self_type )
            ) ))])]) ) () );
              ...
              fun _ ->
                fun (l : 'label) ->
                  fun _ ->
                    fun (pf : 'opt_private) ->
                      fun _ ->
                        fun (_loc : FanLoc.t ) -> (Ast.CgVir (_loc, l, pf, t)
                          :'class_sig_item ) ) )); ([`Skeyword "method";
          `Snterm ( Gram.obj (opt_private :'opt_private Gram.t  ) );
          `Snterm ( Gram.obj (label :'label Gram.t  ) ); `Skeyword ":";
          `Snterm ( Gram.obj (poly_type :'poly_type Gram.t  ) )], (
    ...
    Gram.extend (opt_private :'opt_private Gram.t  ) (
      (
        fun () -> (None, [(None, None, [([], (
          ...
          Gram.mk_action (
            fun _ -> fun (_loc : FanLoc.t ) -> (Ast.PrPrivate :'opt_private )
            ) ))])]) ) () );
    Gram.extend (opt_mutable :'opt_mutable Gram.t  ) (
      (
        fun () -> (None, [(None, None, [([], (
          ...
          Gram.mk_action (
            fun _ -> fun (_loc : FanLoc.t ) -> (Ast.MuMutable :'opt_mutable )
            ) ))])]) ) () );
    Gram.extend (opt_virtual :'opt_virtual Gram.t  ) (
      (
        fun () -> (None, [(None, None, [([], (
          ...
          Gram.mk_action (
            fun _ -> fun (_loc : FanLoc.t ) -> (Ast.ViVirtual :'opt_virtual )
            ) ))])]) ) () );
          ...
          Gram.mk_action (
            fun __camlp4_0 ->
              fun (_loc : FanLoc.t ) ->
                ...
                | _ -> assert false ) )); ([`Skeyword ".."], (
          Gram.mk_action (
            fun _ -> fun (_loc : FanLoc.t ) -> (Ast.RvRowVar :'opt_dot_dot )
            ) ))])]) ) () );
            ...
            fun (xs : 'string_list) ->
              fun __camlp4_0 ->
                fun (_loc : FanLoc.t ) ->
                  ...
                  | _ -> assert false ) ));
          ([`Stoken (( (
              function | `ANTIQUOT (( ""|"str_list" ),_) -> true | _ -> false
        ...
        fun () -> (None, [(None, None, [([], (
          ...
          Gram.mk_action (
            fun (x : 'match_case0 list ) ->
              fun (_loc : FanLoc.t ) -> (Ast.mcOr_of_list x :'match_case_quot
                ) ) ))])]) ) () );
          ...
          Gram.mk_action (
            fun _ ->
              fun (pcl : 'parser_case list ) ->
                fun _ -> fun (_loc : FanLoc.t ) -> (pcl :'parser_case_list )
            ) ))])]) ) () );
              ...
              fun _ ->
                fun (po : 'parser_ipatt option ) ->
                  fun _ ->
                    fun (sp : 'stream_patt) ->
                      fun _ ->
                        fun (_loc : FanLoc.t ) -> ((sp, po, e) :'parser_case
                          ) ) ))])]) ) () );
            ...
            fun (sp : 'stream_patt_comp_err_list) ->
              fun _ ->
                fun (spc : 'stream_patt_comp) ->
                  fun (_loc : FanLoc.t ) -> ((spc, None) :: sp :'stream_patt
                    ) ) ));
          ([`Snterm ( Gram.obj (stream_patt_comp :'stream_patt_comp Gram.t  )
              )], (
          Gram.mk_action (
      ...
      (
        fun () -> (None, [(None, None,
          ...
          Gram.mk_action (
            fun (p : 'patt) ->
              fun _ ->
                fun (_loc : FanLoc.t ) -> (SpStr (_loc, p) :'stream_patt_comp
                  ) ) )); ([`Snterm ( Gram.obj (patt :'patt Gram.t  ) );
          `Skeyword "=";
      ...
      (
        fun () -> (None, [(None, None,
          ...
          Gram.mk_action (
            fun (e : 'stream_expr) ->
              fun _ ->
                fun (_loc : FanLoc.t ) -> (SeNtr (_loc, e) :'stream_expr_comp
                  ) ) ));
          ([`Snterm ( Gram.obj (stream_expr :'stream_expr Gram.t  ) )], (
          Gram.mk_action (
            fun (e : 'stream_expr) ->
