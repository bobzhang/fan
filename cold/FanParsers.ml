                ...
                [(None  , None  , (
                  [((
                    [`Snterm ((Gram.obj ( (name : 'name Gram.t) )));
                     `Skeyword (":");
                     `Sopt
                      (`Snterm ((Gram.obj ( (position : 'position Gram.t) ))));
                     `Snterm
...
module MakeMacroParser =
 functor (Syntax : Sig.Camlp4Syntax) ->
  ...
  let _ = let _ = (expr : 'expr Gram.t)
          ...
          and uident = ((grammar_entry_create "uident") : 'uident Gram.t)
          and opt_macro_value =
...
module MakeRevisedParser =
 functor (Syntax : Sig.Camlp4Syntax) ->
  ...
  let _ = let _ = (a_CHAR : 'a_CHAR Gram.t)
          ...
          and _ = (constructor_declaration : 'constructor_declaration Gram.t)
