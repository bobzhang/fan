    ...
    Gram.extend (macro_def_sig :'macro_def_sig Gram.t  )
      (((fun () -> (None, [(None, None, [([`Skeyword "INCLUDE";
           ...
           (Gram.mk_action
              ((fun (i : 'uident) ->
                  fun _ ->
                    fun (_loc : FanLoc.t ) -> (SdDef (i, None)
                      :'macro_def_sig )))))])]))) ());
      ...
      (((fun () -> ((Some (`Before "simple")), [(None, None,
           ...
           Gram.srules expr [([`Skeyword "IN"],
             (Gram.mk_action
                ((fun x ->
                    fun (_loc : FanLoc.t ) -> (Gram.string_of_token x :
                      'e__11 ))))); ([`Skeyword "DEFINE"],
             (Gram.mk_action
                ((fun x ->
                    fun (_loc : FanLoc.t ) -> (Gram.string_of_token x :
                      'e__11 ))))); ([`Skeyword "ENDIF"],
             (Gram.mk_action
                ((fun x ->
                    fun (_loc : FanLoc.t ) -> (Gram.string_of_token x :
                      'e__11 ))))); ([`Skeyword "END"],
             ...
             (Gram.mk_action
                ((fun x ->
                    fun (_loc : FanLoc.t ) -> (Gram.string_of_token x :
                      'e__11 ))))); ([`Skeyword "IFNDEF"],
             (Gram.mk_action
                ((fun x ->
                    fun (_loc : FanLoc.t ) -> (Gram.string_of_token x :
                      'e__11 ))))); ([`Skeyword "IFDEF"],
             (Gram.mk_action
                ((fun x ->
                    fun (_loc : FanLoc.t ) -> (Gram.string_of_token x :
                      'e__11 )))))]],
      ...
      (((fun () -> ((Some (`Before "simple")), [(None, None,
           ...
           Gram.srules patt [([`Skeyword "ENDIF"],
             ...
             (Gram.mk_action
                ((fun x ->
                    fun (_loc : FanLoc.t ) -> (Gram.string_of_token x :
                      'e__12 ))))); ([`Skeyword "IFNDEF"],
             (Gram.mk_action
                ((fun x ->
                    fun (_loc : FanLoc.t ) -> (Gram.string_of_token x :
                      'e__12 ))))); ([`Skeyword "IFDEF"],
             (Gram.mk_action
                ((fun x ->
                    fun (_loc : FanLoc.t ) -> (Gram.string_of_token x :
                      'e__12 )))))]],
  ...
  let _=
              ...
              ((fun (cd : 'class_declaration) ->
                  fun _ ->
                    fun (_loc : FanLoc.t ) -> (Ast.StCls (_loc, cd)
                      :'str_item ))))); ([`Skeyword "let"; `Skeyword "open";
              ...
              ((fun __camlp4_0 ->
                  fun (_loc : FanLoc.t ) ->
                    ...
                    | `ANTIQUOT (("module_binding"|"anti"|"list" as n),s) ->
                        (Ast.MbAnt (_loc, (mk_anti ~c:"module_binding" n s))
                        :'module_binding )
                    | _ -> assert false)))); ([`Sself; `Skeyword "and";
           `Sself],
           (Gram.mk_action
    ...
    Gram.extend (expr :'expr Gram.t  )
      (((fun () -> (None, [((Some "top"), (Some `RA), [([`Skeyword "object";
           ...
           ((Some "where"), None, [([`Sself; `Skeyword "where";
           `Snterm (Gram.obj (opt_rec :'opt_rec Gram.t  ));
           ...
           ((Some ":="), (Some `NA), [([`Sself; `Skeyword "<-"; `Sself;
           ...
           (Gram.mk_action
              ((fun _ ->
                  fun (_loc : FanLoc.t ) -> (Ast.OvNil
                    :'value_val_opt_override ))))); ([`Skeyword "val";
           `Stoken
             (((function
                | `ANTIQUOT (("!"|"override"|"anti"),_) -> true
                | _ -> false)),
                        ...
                        fun (mf : 'opt_mutable) ->
                          fun _ ->
                            fun (_loc : FanLoc.t ) ->
                              ...
                              :'class_sig_item ))))); ([`Skeyword "inherit";
           `Snterm (Gram.obj (class_type :'class_type Gram.t  ))],
           (Gram.mk_action
              ((fun (cs : 'class_type) ->
                  fun _ ->
      ...
      (((fun () -> (None, [(None, None,
           ...
           (Gram.mk_action
              ((fun ((ml,v) : 'meth_list) ->
                  fun _ ->
                    fun (m : 'meth_decl) ->
                      fun (_loc : FanLoc.t ) -> (((Ast.TySem (_loc, m, ml)),
                        v) :'meth_list )))))])]))) ());
              ...
              ((fun (i : 'a_ident) ->
                  fun _ ->
                    fun (_loc : FanLoc.t ) -> (Ast.TyVrn (_loc, i)
                      :'row_field ))))); ([`Sself; `Skeyword "|"; `Sself],
           (Gram.mk_action
              ((fun (t2 : 'row_field) ->
                  fun _ ->
                    fun (t1 : 'row_field) ->
              ...
              ((fun (x : 'a_ident) ->
                  fun _ ->
                    fun (_loc : FanLoc.t ) -> (Ast.TyVrn (_loc, x)
                      :'more_ctyp ))))); ([`Skeyword "mutable"; `Sself],
           (Gram.mk_action
              ((fun (x : 'more_ctyp) ->
                  fun _ ->
    ...
    Gram.extend (stream_patt_comp_err :'stream_patt_comp_err Gram.t  )
      (((fun () -> (None, [(None, None,
           ...
           (Gram.mk_action
              ((fun (eo : 'e__27 option ) ->
                  fun (spc : 'stream_patt_comp) ->
                    fun (_loc : FanLoc.t ) -> ((spc, eo)
                      :'stream_patt_comp_err )))))])]))) ());
    Gram.extend (stream_patt_comp_err_list
      :'stream_patt_comp_err_list Gram.t  )
      (((fun () -> (None, [(None, None,
           [([`Snterm
                (Gram.obj (stream_patt_comp_err
                   :'stream_patt_comp_err Gram.t  )); `Skeyword ";"; `Sself],
           (Gram.mk_action
              ((fun (sp : 'stream_patt_comp_err_list) ->
                  fun _ ->
