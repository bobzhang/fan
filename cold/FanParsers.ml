...
module MakeDebugParser (Syntax:Sig.Camlp4Syntax) =
  struct include Syntax module Ast  = Camlp4Ast
    ...
    let _=
      ...
      start_debug =
      ((grammar_entry_create "start_debug" ): 'start_debug  Gram.t )  in
      begin
      (
...
module MakeGrammarParser (Syntax:Sig.Camlp4Syntax) =
  struct include Syntax module Ast  = Camlp4Ast open FanGrammar
    ...
    let _=
      ...
      (level_list: 'level_list  Gram.t ) and _ = (level: 'level  Gram.t ) and
      _ = (psymbol: 'psymbol  Gram.t ) and _ =
      (rule_list: 'rule_list  Gram.t ) and _ = (rule: 'rule  Gram.t ) and _ =
      (symbol: 'symbol  Gram.t )  in
      ...
      ((grammar_entry_create "comma_patt" ): 'comma_patt  Gram.t ) and
      pattern = ((grammar_entry_create "pattern" ): 'pattern  Gram.t ) and
      assoc = ((grammar_entry_create "assoc" ): 'assoc  Gram.t ) and position
                  ...
                  fun ((t : 'qualuid )) ->
                    fun ((_loc : FanLoc.t)) ->
                      (
                        ...
                        (None  , old ): 'extend_header ) ) ) ) ) ;
               (( [`Skeyword ("(") ; `Snterm
                ((Gram.obj ( (qualid: 'qualid  Gram.t ) ) )) ; `Skeyword
                (":") ; `Snterm
                ((Gram.obj ( (t_qualid: 't_qualid  Gram.t ) ) )) ; `Skeyword
                (")")]  ) , (
                (Gram.mk_action (
                  fun (_) ->
                    fun ((t : 't_qualid )) ->
                       ...
                       fun ((n : 'name )) ->
                         fun ((old : 'delete_rule_header )) ->
                           fun ((_loc : FanLoc.t)) ->
                             (
                               let  (e , b ) =
                               (expr_of_delete_rule _loc n sl ) in
                      ...
                      (Gram.mk_action (
                        fun (__camlp4_0) ->
                          fun ((_loc : FanLoc.t)) ->
                            ...
                            | (`STRING (_ , x )) -> (x: 'e__2 )
                            | _ -> assert false) ) ) ) )]  ) )) ; `Sopt
                 (`Snterm ((Gram.obj ( (assoc: 'assoc  Gram.t ) ) ))) ;
      ...
      (Gram.extend ( (rule_list: 'rule_list  Gram.t ) ) (
        ((fun (() ) ->
            (None  , (
             [(None  , None  , (
               [(( [`Skeyword ("[") ; `Slist1sep
                 ((`Snterm ((Gram.obj ( (rule: 'rule  Gram.t ) ) )) ,
                   `Skeyword ("|") )) ; `Skeyword ("]")]  ) , (
                 (Gram.mk_action (
                   fun (_) ->
                     fun ((rules : 'rule  list )) ->
               ...
               (Gram.mk_action (
                 fun (__camlp4_0) ->
                   fun ((_loc : FanLoc.t)) ->
                     ...
                     | _ -> assert false) ) ) ) ) ;
              (( [`Skeyword ("`") ; `Snterm
               ((Gram.obj ( (a_ident: 'a_ident  Gram.t ) ) )) ; `Sopt
                            ...
                            fun (__camlp4_0) ->
                              fun ((_loc : FanLoc.t)) ->
                                ...
                                | ((`UIDENT "SEP") , (`UIDENT "FOLD0") ) ->
                                  ((sfoldsep _loc "FOLD0 SEP" "sfold0sep" f e
                                     s sep ): 'symbol )
                                | _ -> assert false) ) ) ) ) ;
               (( [`Stoken
                ((( 
            ...
            (None  , (
             [(None  , None  , (
               ...
               (( [`Snterml
                ((( (Gram.obj ( (expr: 'expr  Gram.t ) ) ) ) , "top" )) ;
                `Skeyword ("|") ; `Slist1sep
                ((`Snterm ((Gram.obj ( (item: 'item  Gram.t ) ) )) ,
                  `Skeyword (";") ))]  ) , (
                (Gram.mk_action (
                  fun ((l : 'item  list )) ->
                    fun (_) ->
...
module MakeMacroParser (Syntax:Sig.Camlp4Syntax) =
  struct include Syntax module Ast  = Camlp4Ast
    ...
    let _=
      ...
      let  _ = (expr: 'expr  Gram.t ) and _ =
      (sig_item: 'sig_item  Gram.t ) and _ =
      (str_item: 'str_item  Gram.t ) and _ = (patt: 'patt  Gram.t )  in
      
      let  grammar_entry_create = Gram.mk in
      
      let  macro_def =
      ((grammar_entry_create "macro_def" ): 'macro_def  Gram.t ) and
      uident = ((grammar_entry_create "uident" ): 'uident  Gram.t ) and
      opt_macro_value =
      ((grammar_entry_create "opt_macro_value" ): 'opt_macro_value 
        Gram.t ) and endif =
      ((grammar_entry_create "endif" ): 'endif  Gram.t ) and sglist_else
      = ((grammar_entry_create "sglist_else" ): 'sglist_else  Gram.t )
      and sglist_then =
        ...
        ((fun (() ) ->
            (None  , (
             [(None  , None  , (
               [(( [`Skeyword ("IFNDEF") ; `Snterm
                 ((Gram.obj ( (uident: 'uident  Gram.t ) ) )) ; `Skeyword
                 ("THEN") ; `Sself ; `Skeyword ("ELSE") ; `Sself ;
                 `Snterm ((Gram.obj ( (endif: 'endif  Gram.t ) ) ))]  ) ,
                 (
                 (Gram.mk_action (
                   fun (_) ->
...
module MakeRevisedParser (Syntax:Sig.Camlp4Syntax) =
  struct include Syntax module Ast  = Camlp4Ast
    ...
    let _= (Gram.clear class_signature ) let _= (Gram.clear class_str_item )
    ...
    let _=
      (Gram.setup_parser sem_expr (
        ...
        | Some((`KEYWORD ";") , _ ) ->
          ...
          let  _loc =
          (FanLoc.merge ( (Ast.loc_of_expr al ) ) ( (Ast.loc_of_expr a ) ) )
    ...
    let _=
      ...
      (infixop4: 'infixop4  Gram.t ) and _ = (infixop3: 'infixop3  Gram.t )
      and _ = (infixop2: 'infixop2  Gram.t ) and _ =
      (infixop1: 'infixop1  Gram.t ) and _ = (infixop0: 'infixop0  Gram.t )
      and _ = (with_constr_quot: 'with_constr_quot  Gram.t ) and _ =
      (with_constr: 'with_constr  Gram.t ) and _ =
      (val_longident: 'val_longident  Gram.t ) and _ =
      (use_file: 'use_file  Gram.t ) and _ = (typevars: 'typevars  Gram.t )
      and _ = (type_parameters: 'type_parameters  Gram.t ) and _ =
      ...
      (sig_item: 'sig_item  Gram.t ) and _ = (sequence: 'sequence  Gram.t )
      and _ = (semi: 'semi  Gram.t ) and _ =
      ...
      (phrase: 'phrase  Gram.t ) and _ = (patt_tcon: 'patt_tcon  Gram.t ) and
      _ = (patt_quot: 'patt_quot  Gram.t ) and _ =
      (patt_eoi: 'patt_eoi  Gram.t ) and _ =
      (patt_as_patt_opt: 'patt_as_patt_opt  Gram.t ) and _ =
      (patt: 'patt  Gram.t ) and _ = (opt_when_expr: 'opt_when_expr  Gram.t )
      and _ = (opt_virtual: 'opt_virtual  Gram.t ) and _ =
      (opt_rec: 'opt_rec  Gram.t ) and _ =
      (opt_private: 'opt_private  Gram.t ) and _ =
      (opt_polyt: 'opt_polyt  Gram.t ) and _ =
      ...
      (name_tags: 'name_tags  Gram.t ) and _ =
      (more_ctyp: 'more_ctyp  Gram.t ) and _ =
      (module_type_quot: 'module_type_quot  Gram.t ) and _ =
      ...
      (meth_decl: 'meth_decl  Gram.t ) and _ =
      (meth_list: 'meth_list  Gram.t ) and _ =
      (let_binding: 'let_binding  Gram.t ) and _ =
      ...
      (label: 'label  Gram.t ) and _ = (ipatt_tcon: 'ipatt_tcon  Gram.t ) and
      _ = (ipatt: 'ipatt  Gram.t ) and _ = (interf: 'interf  Gram.t ) and _ =
      (implem: 'implem  Gram.t ) and _ = (ident_quot: 'ident_quot  Gram.t )
      and _ = (ident: 'ident  Gram.t ) and _ = (fun_def: 'fun_def  Gram.t )
      and _ = (fun_binding: 'fun_binding  Gram.t ) and _ =
      ...
      and _ = (expr: 'expr  Gram.t ) and _ = (eq_expr: 'eq_expr  Gram.t ) and
      _ = (dummy: 'dummy  Gram.t ) and _ =
      ...
      = (class_info_for_class_expr: 'class_info_for_class_expr  Gram.t ) and
      _ = (class_fun_def: 'class_fun_def  Gram.t ) and _ =
      ...
      (match_case: 'match_case  Gram.t ) and _ =
      (and_ctyp: 'and_ctyp  Gram.t ) and _ = (amp_ctyp: 'amp_ctyp  Gram.t )
      and _ = (a_ident: 'a_ident  Gram.t ) and _ =
      (a_UIDENT: 'a_UIDENT  Gram.t ) and _ = (a_STRING: 'a_STRING  Gram.t )
      and _ = (a_OPTLABEL: 'a_OPTLABEL  Gram.t ) and _ =
      (a_NATIVEINT: 'a_NATIVEINT  Gram.t ) and _ =
      (rec_binding_quot: 'rec_binding_quot  Gram.t ) and _ =
      (a_LIDENT: 'a_LIDENT  Gram.t ) and _ = (a_LABEL: 'a_LABEL  Gram.t ) and
      _ = (a_INT64: 'a_INT64  Gram.t ) and _ = (a_INT32: 'a_INT32  Gram.t )
      and _ = (a_INT: 'a_INT  Gram.t ) and _ = (a_FLOAT: 'a_FLOAT  Gram.t ) 
      in
      
      let  grammar_entry_create = Gram.mk in
      
      let  infixop5 =
      ((grammar_entry_create "infixop5" ): 'infixop5  Gram.t ) and
      string_list =
      ((grammar_entry_create "string_list" ): 'string_list  Gram.t ) and
      opt_override =
      ((grammar_entry_create "opt_override" ): 'opt_override  Gram.t ) and
      unquoted_typevars =
      ((grammar_entry_create "unquoted_typevars" ): 'unquoted_typevars 
        Gram.t ) and value_val_opt_override =
            ...
            (None  , (
             [(( Some ("top") ) , None  , (
               [(( [`Skeyword ("struct") ; `Snterm
                 ((Gram.obj ( (str_items: 'str_items  Gram.t ) ) )) ;
                 `Skeyword ("end")]  ) , (
                 (Gram.mk_action (
                   fun (_) ->
                     fun ((st : 'str_items )) ->
              ...
              (( [`Skeyword ("(") ; `Sself ; `Skeyword (")")]  ) , (
               (Gram.mk_action (
                 fun (_) ->
                   fun ((me : 'module_expr )) ->
                     fun (_) ->
                       fun ((_loc : FanLoc.t)) -> (me: 'module_expr ) ) ) ) )
              ;
              (( [`Skeyword ("(") ; `Sself ; `Skeyword (":") ; `Snterm
               ((Gram.obj ( (module_type: 'module_type  Gram.t ) ) )) ;
               `Skeyword (")")]  ) , (
      ...
      (Gram.extend ( (module_type: 'module_type  Gram.t ) ) (
        ((fun (() ) ->
            (None  , (
             ...
             (( Some ("sig") ) , None  , (
              [(( [`Skeyword ("sig") ; `Snterm
                ((Gram.obj ( (sig_items: 'sig_items  Gram.t ) ) )) ;
                `Skeyword ("end")]  ) , (
                (Gram.mk_action (
                  fun (_) ->
                    fun ((sg : 'sig_items )) ->
             ...
             (( Some ("simple") ) , None  , (
              [(( [`Skeyword ("module") ; `Skeyword ("type") ; `Skeyword
                ("of") ; `Snterm
                ((Gram.obj ( (module_expr: 'module_expr  Gram.t ) ) ))]  ) ,
                (
                (Gram.mk_action (
              ...
              (( [`Skeyword ("(") ; `Sself ; `Skeyword (")")]  ) , (
               (Gram.mk_action (
                 fun (_) ->
                   fun ((mt : 'module_type )) ->
                     fun (_) ->
                       fun ((_loc : FanLoc.t)) -> (mt: 'module_type ) ) ) ) )
              ;
              (( [`Skeyword ("'") ; `Snterm
               ((Gram.obj ( (a_ident: 'a_ident  Gram.t ) ) ))]  ) , (
               (Gram.mk_action (
            ...
            (None  , (
             [(( Some ("top") ) , None  , (
               ...
               (( [`Skeyword ("module") ; `Snterm
                ((Gram.obj ( (a_UIDENT: 'a_UIDENT  Gram.t ) ) )) ; `Snterm
                ((Gram.obj (
                   (module_declaration: 'module_declaration  Gram.t ) ) ))] 
                ) , (
                (Gram.mk_action (
             ...
             [(None  , None  , (
               ...
               (( [`Skeyword ("when") ; `Snterm
                ...
                (Gram.mk_action (
                  fun ((w : 'expr )) ->
                    fun (_) ->
                      fun ((_loc : FanLoc.t)) -> (w: 'opt_when_expr ) ) ) ) )]
                ) )]  ) )) ()  ) ) ) ); (
            ...
            (None  , (
             ...
             (( Some ("simple") ) , None  , (
              [(( [`Skeyword ("?") ; `Skeyword ("(") ; `Snterm
                ((Gram.obj ( (patt_tcon: 'patt_tcon  Gram.t ) ) )) ;
                `Skeyword ("=") ; `Snterm
                ((Gram.obj ( (expr: 'expr  Gram.t ) ) )) ; `Skeyword (")")] 
                ) , (
                (Gram.mk_action (
      ...
      (Gram.extend ( (ctyp: 'ctyp  Gram.t ) ) (
        ((fun (() ) ->
            (None  , (
             ...
             (( Some ("label") ) , ( Some (`NA) ) , (
              [(( [`Snterm
                ((Gram.obj ( (a_OPTLABEL: 'a_OPTLABEL  Gram.t ) ) )) ;
                `Sself]  ) , (
                (Gram.mk_action (
                  fun ((t : 'ctyp )) ->
                    fun ((i : 'a_OPTLABEL )) ->
        ...
        ((fun (() ) ->
            (None  , (
             [(None  , None  , (
               [(( [`Snterm
                 ((Gram.obj (
                    (label_declaration: 'label_declaration  Gram.t ) ) ))]  )
                 , (
                 (Gram.mk_action (
               ...
               [(( [`Snterm
                 ((Gram.obj (
                    (class_info_for_class_expr: 'class_info_for_class_expr 
                      Gram.t ) ) )) ; `Snterm
                 ((Gram.obj (
                    (class_fun_binding: 'class_fun_binding  Gram.t ) ) ))]  )
                 , (
                 (Gram.mk_action (
             ...
             [(None  , None  , (
               ...
               (( [`Skeyword ("as") ; `Snterm
                ...
                (Gram.mk_action (
                  fun ((i : 'a_LIDENT )) ->
                    fun (_) ->
                      fun ((_loc : FanLoc.t)) -> (i: 'opt_as_lident ) ) ) ) )]
                ) )]  ) )) ()  ) ) ) ); (
             ...
             [(None  , None  , (
               ...
               (( [`Skeyword ("=") ; `Snterm
                ...
                (Gram.mk_action (
                  fun ((e : 'expr )) ->
                    fun (_) ->
                      fun ((_loc : FanLoc.t)) -> (e: 'cvalue_binding ) ) ) )
                )]  ) )]  ) )) ()  ) ) ) ); (
                   ...
                   fun ((v : 'opt_dot_dot )) ->
                     fun ((_loc : FanLoc.t)) ->
                       (Ast.TyObj ((_loc , ( Ast.TyNil (_loc) ) , v )):
                         'opt_meth_list ) ) ) ) ) ;
               (( [`Snterm
                ((Gram.obj ( (meth_list: 'meth_list  Gram.t ) ) ))]  ) , (
                (Gram.mk_action (
                  fun (((ml , v ) : 'meth_list )) ->
                    fun ((_loc : FanLoc.t)) ->
...
module MakeRevisedParserParser (Syntax:Sig.Camlp4Syntax) =
  struct include Syntax module Ast  = Camlp4Ast
    ...
    let _=
      ...
      ((grammar_entry_create "stream_patt" ): 'stream_patt  Gram.t )  in
      begin
      (
      (Gram.extend ( (expr: 'expr  Gram.t ) ) (
        ((fun (() ) ->
            ...
            (None  , (
             [(None  , None  , (
               [(( [`Snterm
                 ...
                 `Snterm
                 ((Gram.obj ( (stream_patt: 'stream_patt  Gram.t ) ) )) ;
...
module MakeQuotationCommon (Syntax:Sig.Camlp4Syntax) =
  struct include Syntax open Quotation open Meta
    let _=
      (add_quotation "sig_item" sig_item_quot ME.meta_sig_item
        MP.meta_sig_item )
    let _=
      (add_quotation "str_item" str_item_quot ME.meta_str_item
        MP.meta_str_item )
    ...
    let _=
      (add_quotation "rec_flag" rec_flag_quot ME.meta_rec_flag
        MP.meta_rec_flag )
    let _=
