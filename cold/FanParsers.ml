    ...
    Gram.extend (global : 'global Gram.t )
      ((fun ()  ->
          (None,
            [(None, None,
               [([`Stoken
                    (((function | `UIDENT "LOCAL" -> true | _ -> false)),
                      (`Normal, "`UIDENT \"LOCAL\""));
                 `Skeyword ":";
                 `Slist1 (`Snterm (Gram.obj (name : 'name Gram.t )));
                 `Snterm (Gram.obj (semi_sep : 'semi_sep Gram.t ))],
                  (Gram.mk_action
                     (fun _  (sl : 'name list)  _  __camlp4_0 
                        (_loc : FanLoc.t)  ->
                        match __camlp4_0 with
          ...
          (None,
                    ...
                    (fun (s : 'symbol)  __camlp4_0  (_loc : FanLoc.t)  ->
                       ...
                       | `UIDENT "OPT" ->
                           (let () = check_not_tok s in
                            let styp =
                              STapp
                                (_loc, (STlid (_loc, "option")), (s.styp)) in
                            let text = TXopt (_loc, (s.text)) in
                            mk_symbol ~used:(s.used) ~text ~styp
                              ~pattern:None : 'symbol )
                       | _ -> assert false)));
               ([`Stoken
                   (((function
            ...
            (None, None,
              [([`Skeyword "("; `Sself; `Skeyword ")"],
                 (Gram.mk_action
                    (fun _  (s_t : 'symbol)  _  (_loc : FanLoc.t)  ->
                       (s_t : 'symbol ))));
              ([`Snterm (Gram.obj (name : 'name Gram.t ));
               `Sopt
                 (Gram.srules symbol
            ...
            [(None, None,
               ...
               ([`Skeyword "IFNDEF";
                ...
                `Snterm
                 ...
                 (Gram.mk_action
                    (fun (sg2 : 'else_macro_def_sig)  (sg1 : 'sglist_then)  _
                        _  _  (_loc : FanLoc.t)  ->
                         ...
                         (Gram.mk_action
                            (fun _  (d : 'macro_def)  (_loc : FanLoc.t)  ->
                               (execute_macro_if_active_branch _loc
                                  (Ast.StNil _loc)
                                  (fun a  b  -> Ast.StSem (_loc, a, b)) Then
                                  d : 'e__6 ))))])],
                  (Gram.mk_action
                        ...
                        `Snterm (Gram.obj (semi : 'semi Gram.t ))],
                         (Gram.mk_action
                            (fun _  (d : 'macro_def)  (_loc : FanLoc.t)  ->
                               (execute_macro_if_active_branch _loc
                                  (Ast.StNil _loc)
                                  (fun a  b  -> Ast.StSem (_loc, a, b)) Else
                                  d : 'e__7 ))))])],
                  (Gram.mk_action
                        ...
                        `Snterm (Gram.obj (semi : 'semi Gram.t ))],
                         (Gram.mk_action
                            (fun _  (d : 'macro_def_sig)  (_loc : FanLoc.t) 
                               ...
                               (execute_macro_if_active_branch _loc
                                  (Ast.SgNil _loc)
                                  (fun a  b  -> Ast.SgSem (_loc, a, b)) Then
                                  d : 'e__8 ))))])],
                  (Gram.mk_action
                        ...
                        `Snterm (Gram.obj (semi : 'semi Gram.t ))],
                         (Gram.mk_action
                            (fun _  (d : 'macro_def_sig)  (_loc : FanLoc.t) 
                               ...
                               (execute_macro_if_active_branch _loc
                                  (Ast.SgNil _loc)
                                  (fun a  b  -> Ast.SgSem (_loc, a, b)) Else
                                  d : 'e__9 ))))])],
                  (Gram.mk_action
          ...
          (None,
            [(None, None,
               ...
               ([`Skeyword "(";
                ...
                `Snterm (Gram.obj (expr : 'expr Gram.t ))],
                 (Gram.mk_action
                    (fun (e : 'expr)  _  _  (pl : 'e__10 list)  _ 
                       (_loc : FanLoc.t)  ->
          ...
          (None,
            [(None, None,
               [([`Skeyword "IFNDEF";
                 ...
                 `Snterm (Gram.obj (endif : 'endif Gram.t ))],
                  (Gram.mk_action
                     (fun _  (p2 : 'patt)  _  (p1 : 'patt)  _  (i : 'uident) 
                        _  (_loc : FanLoc.t)  ->
                ...
                `Snterm (Gram.obj (type_longident : 'type_longident Gram.t ))],
                 (Gram.mk_action
                    (fun (i : 'type_longident)  _ 
                       (t : 'constructor_declaration)  _  (_loc : FanLoc.t) 
          ...
          (None,
            [(None, (Some `RA),
               [([`Skeyword "(";
                 ...
                 `Sself],
                  (Gram.mk_action
                     (fun (mt : 'module_declaration)  _  (t : 'module_type) 
                        _  (i : 'a_UIDENT)  _  (_loc : FanLoc.t)  ->
          ...
          (None,
            ...
            ((Some "simple"), None,
              [([`Skeyword "(";
                ...
                `Skeyword ")"],
                 (Gram.mk_action
                    (fun _  (pt : 'package_type)  _  (me : 'module_expr)  _ 
                       _  (_loc : FanLoc.t)  ->
              ...
              ([`Skeyword "[";
               ...
               `Skeyword "]"],
                (Gram.mk_action
                   (fun _  (last : 'expr)  _  (mk_list : 'sem_expr_for_list) 
                      _  (_loc : FanLoc.t)  -> (mk_list last : 'expr ))));
              ([`Skeyword "["; `Skeyword "]"],
                (Gram.mk_action
                   (fun _  _  (_loc : FanLoc.t)  ->
                      (Ast.ExId (_loc, (Ast.IdUid (_loc, "[]"))) : 'expr ))));
              ...
              ([`Stry
               ...
               `Skeyword ")"],
                (Gram.mk_action
                   (fun _  (e : 'sequence) 
                      (i : 'module_longident_dot_lparen)  (_loc : FanLoc.t) 
                      -> (Ast.ExOpI (_loc, i, e) : 'expr ))));
          ...
          (None,
            ...
            ((Some "simple"), None,
              ...
              ([`Skeyword "?";
               ...
               `Skeyword ")"],
                (Gram.mk_action
                   (fun _  (f : 'eq_expr)  (p : 'patt_tcon)  _  _  __camlp4_0
                       _  (_loc : FanLoc.t)  ->
                      match __camlp4_0 with
                      | `ANTIQUOT ((""|"lid" as n),i) ->
              ...
              ([`Skeyword "[";
               ...
               `Skeyword "]"],
                (Gram.mk_action
                   (fun _  (last : 'patt)  _  (mk_list : 'sem_patt_for_list) 
                      _  (_loc : FanLoc.t)  -> (mk_list last : 'patt ))));
              ([`Skeyword "["; `Skeyword "]"],
                (Gram.mk_action
                   (fun _  _  (_loc : FanLoc.t)  ->
                      (Ast.PaId (_loc, (Ast.IdUid (_loc, "[]"))) : 'patt ))));
               ...
               ([`Sself; `Skeyword "and"; `Sself],
                 (Gram.mk_action
                    (fun (t2 : 'type_declaration)  _ 
                       (t1 : 'type_declaration)  (_loc : FanLoc.t)  ->
               ...
               `Skeyword "}"],
                (Gram.mk_action
                   (fun _  (t : 'label_declaration_list)  _ 
                      (_loc : FanLoc.t)  -> (Ast.TyRec (_loc, t) : 'ctyp ))));
              ([`Skeyword "[<";
               ...
               `Skeyword "]"],
                (Gram.mk_action
                   (fun _  (t : 'constructor_declarations)  _ 
                      (_loc : FanLoc.t)  -> (Ast.TySum (_loc, t) : 'ctyp ))));
              ([`Skeyword "["; `Skeyword "]"],
                (Gram.mk_action
                   (fun _  _  (_loc : FanLoc.t)  ->
    ...
    Gram.extend (class_expr : 'class_expr Gram.t )
      ((fun ()  ->
          (None,
            ...
            ((Some "apply"), (Some `NA),
              [([`Sself;
                `Snterml ((Gram.obj (expr : 'expr Gram.t )), "label")],
                 (Gram.mk_action
            ...
            [(None, (Some `LA),
                ...
                `Snterm (Gram.obj (poly_type : 'poly_type Gram.t ))],
                 (Gram.mk_action
                    (fun (t : 'poly_type)  _  (l : 'label) 
                       (pf : 'opt_private)  _  (o : 'method_opt_override) 
                       (_loc : FanLoc.t)  ->
                       (if o <> Ast.OvNil
                        then
                          raise
               ...
               ([`Snterm
                ...
                `Snterm (Gram.obj (poly_type : 'poly_type Gram.t ))],
                 (Gram.mk_action
                    (fun (t : 'poly_type)  _  (l : 'label) 
                       (mf : 'opt_mutable)  _  (o : 'value_val_opt_override) 
                       (_loc : FanLoc.t)  ->
                       (if o <> Ast.OvNil
                        then
                          raise
            ...
            [(None, None,
               ...
               ([`Skeyword "method";
                ...
                `Snterm (Gram.obj (poly_type : 'poly_type Gram.t ))],
                 (Gram.mk_action
                    (fun (t : 'poly_type)  _  (l : 'label) 
                       (pf : 'opt_private)  _  _  (_loc : FanLoc.t)  ->
                       (Ast.CgVir (_loc, l, pf, t) : 'class_sig_item ))));
               ([`Skeyword "val";
                `Snterm (Gram.obj (opt_mutable : 'opt_mutable Gram.t ));
                `Snterm (Gram.obj (opt_virtual : 'opt_virtual Gram.t ));
                    ...
                    (fun (sg : 'sig_items)  _  __camlp4_0  (_loc : FanLoc.t) 
                       ...
                       | `ANTIQUOT ((""|"sigi"|"anti"|"list" as n),s) ->
                           (Ast.SgSem
                              (_loc,
                                (Ast.SgAnt
                                   (_loc, (mk_anti n ~c:"sig_item" s))), sg) : 
                           'sig_items )
                       | _ -> assert false)));
               ([`Stoken
                   (((function
                    ...
                    (fun (st : 'str_items)  _  __camlp4_0  (_loc : FanLoc.t) 
                       ...
                       | `ANTIQUOT ((""|"stri"|"anti"|"list" as n),s) ->
                           (Ast.StSem
                              (_loc,
                                (Ast.StAnt
                                   (_loc, (mk_anti n ~c:"str_item" s))), st) : 
                           'str_items )
                       | _ -> assert false)));
               ([`Stoken
                   (((function
               ...
               ([`Snterm (Gram.obj (more_ctyp : 'more_ctyp Gram.t ));
                ...
                `Snterm
                  (Gram.obj
                     (label_declaration_list : 'label_declaration_list Gram.t ))],
                 (Gram.mk_action
                    (fun (z : 'label_declaration_list)  _  (y : 'more_ctyp) 
                       _  (x : 'more_ctyp)  (_loc : FanLoc.t)  ->
          ...
          (None,
            [(None, None,
               ...
               ([`Stoken
                ...
                `Snterm (Gram.obj (module_type : 'module_type Gram.t ))],
                 (Gram.mk_action
                    (fun (mt : 'module_type)  _  __camlp4_0 
                       (_loc : FanLoc.t)  ->
                       match __camlp4_0 with
                       | `ANTIQUOT (("" as n),m) ->
               ...
               ([`Sself; `Skeyword "="; `Sself],
                 (Gram.mk_action
                    (fun (ce2 : 'class_expr_quot)  _ 
                       (ce1 : 'class_expr_quot)  (_loc : FanLoc.t)  ->
               ...
               ([`Sself; `Skeyword ":"; `Sself],
                 (Gram.mk_action
                    (fun (ct2 : 'class_type_quot)  _ 
                       (ct1 : 'class_type_quot)  (_loc : FanLoc.t)  ->
                ...
                `Sself],
                 (Gram.mk_action
                    (fun (x2 : 'class_str_item_quot)  _ 
                       (x1 : 'class_str_item)  (_loc : FanLoc.t)  ->
                       (match x2 with
                        | Ast.CrNil _ -> x1
                ...
                `Sself],
                 (Gram.mk_action
                    (fun (x2 : 'class_sig_item_quot)  _ 
                       (x1 : 'class_sig_item)  (_loc : FanLoc.t)  ->
                       (match x2 with
                        | Ast.CgNil _ -> x1
            ...
            [(None, None,
                 ...
                 `Snterm
                  ...
                  (Gram.mk_action
                     (fun (pcl : 'parser_case_list) 
                        (po : 'parser_ipatt option)  (name : 'e__27 option) 
                        _  _  (e : 'sequence)  _  (_loc : FanLoc.t)  ->
                        (match name with
                         | Some o ->
               ...
               ([`Skeyword "parser";
                ...
                `Snterm
                 ...
                 (Gram.mk_action
                    (fun (pcl : 'parser_case_list) 
                       (po : 'parser_ipatt option)  (name : 'e__26 option)  _
                        (_loc : FanLoc.t)  ->
                       (match name with
                        | Some o ->
                            Ref.protect FanStreamTools.grammar_module_name o
            ...
            [(None, None,
               [([`Snterm
                 ...
                 `Sself],
                  (Gram.mk_action
                     (fun (sp : 'stream_patt_comp_err_list)  _ 
                        (spc : 'stream_patt_comp_err)  (_loc : FanLoc.t)  ->
