...
module IdDebugParser =
 struct let  name = "Camlp4DebugParser" let  version = Sys.ocaml_version  end
module MakeDebugParser =
 functor (Syntax : Sig.Camlp4Syntax) ->
  ...
  let  end_or_in =
  ((grammar_entry_create "end_or_in" ) : 'end_or_in  Gram.t ) and start_debug
                 ...
                 fun ((global_list : 'global  option )) ->
                   fun (((gram , old ) : 'extend_header )) ->
                     fun ((_loc : FanLoc.t)) ->
                       (
                         let  res =
                         (text_of_functorial_extend _loc gram global_list el
                           ) in
                  ...
                  (Gram.mk_action (
                    fun (__camlp4_0) ->
                      fun ((_loc : FanLoc.t)) ->
                        ...
                        with
                        | (`STRING (_ , x )) -> (x : 'e__2 )
                        | _ -> assert false) ) ) ) )]  ) )) ; `Sopt (`Snterm
             ((Gram.obj ( (assoc : 'assoc  Gram.t ) ) ))) ; `Snterm
         ...
         [(( Some ("top") ) , ( Some (`NA) ) , (
           [(( [`Stoken
             ((( 
               function
               | (`UIDENT "TRY") -> true
               | _ -> false ) , (`Normal , "(`UIDENT \"TRY\")" ) )) ; `Sself]
              ) , (
             (Gram.mk_action (
               fun ((s : 'symbol )) ->
                 fun (__camlp4_0) ->
           ...
           (( [`Stoken
            ((( 
              function
              | (`UIDENT "OPT") -> true
              | _ -> false ) , (`Normal , "(`UIDENT \"OPT\")" ) )) ; `Sself] 
            ) , (
            (Gram.mk_action (
              fun ((s : 'symbol )) ->
                fun (__camlp4_0) ->
             ...
             fun (_) ->
               fun ((rl : 'rule  list )) ->
                 fun (_) ->
                   fun ((_loc : FanLoc.t)) ->
                     (
                       let  rl = (retype_rule_list_without_patterns _loc rl )
                       in
         ...
         [(None  , None  , (
           [(( [`Stoken
             ...
             ((( 
               function
               | (`UIDENT "SEP") -> true
               | _ -> false ) , (`Normal , "(`UIDENT \"SEP\")" ) )) ; `Sself]
              ) , (
             (Gram.mk_action (
               fun ((sep : 'symbol )) ->
                 fun (__camlp4_1) ->
...
module MakeMacroParser =
 functor (Syntax : Sig.Camlp4Syntax) ->
  ...
  and endif = ((grammar_entry_create "endif" ) : 'endif  Gram.t ) and
  sglist_else =
  ...
  else_expr = ((grammar_entry_create "else_expr" ) : 'else_expr  Gram.t )
  ...
  ((grammar_entry_create "macro_def_sig" ) : 'macro_def_sig  Gram.t )  in
  begin
   (
...
module MakeRevisedParser =
 functor (Syntax : Sig.Camlp4Syntax) ->
  ...
  let _ = (Gram.clear class_description )
  ...
  let _ = (Gram.clear constructor_declarations )
  ...
  let _ = (Gram.clear sem_expr_for_list )
  let _ = (Gram.clear sem_patt )
  let _ = (Gram.clear sem_patt_for_list )
  ...
  (setup_op_parser prefixop (
    fun (x) ->
      (( (not ( (List.mem x excl ) ) ) ) && (
        (( (( (String.length x ) ) >= 2) ) && (
          (( (List.mem ( (String.get x 0 ) ) list ) ) && ( (symbolchar x 1 )
            )) )) )) ) )
  let _ = 
  let  list_ok = ["<" ; ">" ; "<=" ; ">=" ; "=" ; "<>" ; "==" ; "!=" ; "$"] 
  in
  ...
  (setup_op_parser infixop0 (
    fun (x) ->
      (( (List.mem x list_ok ) ) || (
        (( (not ( (List.mem x excl ) ) ) ) && (
          (( (( (String.length x ) ) >= 2) ) && (
            (( (List.mem ( (String.get x 0 ) ) list_first_char_ok ) ) && (
              (symbolchar x 1 ) )) )) )) )) ) )
  let _ = 
  let  list = ['@' ; '^']  in
      ...
      (( (( (String.length x ) ) >= 1) ) && (
        (( (List.mem ( (String.get x 0 ) ) list ) ) && (
          ((
            (( (( (String.get x 0 ) ) <> '*') ) || (
              (( (( (String.length x ) ) < 2) ) || (
                (( (String.get x 1 ) ) <> '*') )) )) ) && ( (symbolchar x 1 )
            )) )) )) ) )
  let _ = (setup_op_parser infixop4 (
            fun (x) ->
              (( (( (String.length x ) ) >= 2) ) && (
                (( (( (String.get x 0 ) ) == '*') ) && (
                  (( (( (String.get x 1 ) ) == '*') ) && ( (symbolchar x 2 )
                    )) )) )) ) )
  ...
  ((grammar_entry_create "value_val_opt_override" ) : 'value_val_opt_override
     Gram.t ) and method_opt_override =
                        ...
                        fun (_) ->
                          fun ((i : 'a_LIDENT )) ->
                            fun (_) ->
                              fun ((_loc : FanLoc.t)) ->
                                (Ast.ExFor
                                   ((_loc , i , ( (Expr.mksequence' _loc e1 )
                    ...
                    fun ((m : 'a_UIDENT )) ->
                      fun (_) ->
                        fun (_) ->
                          fun ((_loc : FanLoc.t)) ->
                            (Ast.ExLmd
                               ((_loc , m , mb , ( (Expr.mksequence _loc el )
                                 ) )) : 'sequence ) ) ) ) ) ;
           (( [`Skeyword ("let") ; `Skeyword ("module") ; `Snterm
            ((Gram.obj ( (a_UIDENT : 'a_UIDENT  Gram.t ) ) )) ; `Snterm
            ((Gram.obj ( (module_binding0 : 'module_binding0  Gram.t ) ) )) ;
                  ...
                  fun ((bi : 'binding )) ->
                    fun ((rf : 'opt_rec )) ->
                      fun (_) ->
                        fun ((_loc : FanLoc.t)) ->
                          (Ast.ExLet
                             ((_loc , rf , bi , ( (Expr.mksequence _loc el )
                               ) )) : 'sequence ) ) ) ) ) ;
           (( [`Skeyword ("let") ; `Snterm
            ((Gram.obj ( (opt_rec : 'opt_rec  Gram.t ) ) )) ; `Snterm
            ((Gram.obj ( (binding : 'binding  Gram.t ) ) )) ; `Skeyword
  ...
  (Gram.extend ( (let_binding : 'let_binding  Gram.t ) ) (
    ((fun (() ) ->
        (None  , (
         [(None  , None  , (
           [(( [`Snterm ((Gram.obj ( (ipatt : 'ipatt  Gram.t ) ) )) ; `Snterm
         ...
         [(None  , None  , (
           ...
           (( [`Stoken
            ((( 
              function
              | (`STRING (_ , _ )) -> true
              | _ -> false ) , (`Normal , "(`STRING (_ , _ ))" ) )) ; `Sself]
             ) , (
            (Gram.mk_action (
              fun ((xs : 'string_list )) ->
                fun (__camlp4_0) ->
         ...
         [(None  , None  , (
           ...
           (( [`Stoken
            ((( 
              ...
              | _ -> false ) , (`Normal , "(`ANTIQUOT (\"virtual\" , _ ))" )
              )) ; `Snterm ((Gram.obj ( (ident : 'ident  Gram.t ) ) )) ;
            `Snterm
