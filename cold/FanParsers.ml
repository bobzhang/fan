...
module MakeDebugParser =
 functor (Syntax : Sig.Camlp4Syntax) ->
  ...
  let _ = let  _ = (expr : 'expr  Gram.t ) in
...
module MakeGrammarParser =
 functor (Syntax : Sig.Camlp4Syntax) ->
  ...
  let _ = let  _ = (expr : 'expr  Gram.t ) and _ =
          (level_list : 'level_list  Gram.t ) and _ =
          (level : 'level  Gram.t ) and _ = (psymbol : 'psymbol  Gram.t ) and
          _ = (rule_list : 'rule_list  Gram.t ) and _ =
          (rule : 'rule  Gram.t ) and _ = (symbol : 'symbol  Gram.t )  in
          let  grammar_entry_create = Gram.mk in
          let  extend_header =
          ((grammar_entry_create "extend_header" ) : 'extend_header  Gram.t )
          and semi_sep =
          ((grammar_entry_create "semi_sep" ) : 'semi_sep  Gram.t ) and
          string = ((grammar_entry_create "string" ) : 'string  Gram.t ) and
          name = ((grammar_entry_create "name" ) : 'name  Gram.t ) and
          comma_patt =
          ((grammar_entry_create "comma_patt" ) : 'comma_patt  Gram.t ) and
          pattern = ((grammar_entry_create "pattern" ) : 'pattern  Gram.t )
          and assoc = ((grammar_entry_create "assoc" ) : 'assoc  Gram.t ) and
          position =
          ...
          = ((grammar_entry_create "t_qualid" ) : 't_qualid  Gram.t ) and
          qualid = ((grammar_entry_create "qualid" ) : 'qualid  Gram.t ) and
          qualuid = ((grammar_entry_create "qualuid" ) : 'qualuid  Gram.t )
          and delete_rule_header =
          ((grammar_entry_create "delete_rule_header" ) : 'delete_rule_header
             Gram.t ) and delete_rule_body =
          ((grammar_entry_create "delete_rule_body" ) : 'delete_rule_body 
            Gram.t ) and extend_body =
                       ...
                       fun ((el : 'e__1  list )) ->
                         fun ((global_list : 'global  option )) ->
                           fun (((gram , old ) : 'extend_header )) ->
                             fun ((_loc : FanLoc.t)) ->
                               (let  res =
                                (text_of_functorial_extend _loc gram
                                  global_list el ) in
                 ...
                 [(None  , None  , (
                   [((
                     [`Snterm
                      ...
                      ((Gram.obj ( (name : 'name  Gram.t ) ) )); `Skeyword
                      (":"); `Slist0sep
                       ...
                       fun ((ll : 'level_list )) ->
                         fun ((pos : 'position  option )) ->
                           fun (_) ->
                             fun ((n : 'name )) ->
                               fun ((_loc : FanLoc.t)) ->
                                 ((mk_entry ~name:n ~pos:pos ~levels:ll ) :
                                   'entry ) ) ) ) )] ) )] ) )) ()  ) ) )
          );
           (
                       ...
                       fun ((n : 'string )) ->
                         fun (__camlp4_0) ->
                           fun ((_loc : FanLoc.t)) ->
                             (match __camlp4_0 with
                              | (`UIDENT
                                 ((("Before" | "After") | "Level") as x)) ->
                                 ((Ast.ExApp(_loc , ( (Ast.ExVrn(_loc , x ))
                                             ) , n )) : 'position )
                              | _ -> assert false) ) ) ) );
                    ((
                     [`Stoken
                             ...
                             (match __camlp4_0 with
                              | (`UIDENT "TRY") ->
                                 (let  text = (TXtry(_loc , ( s.text ) )) in
                                  (mk_symbol ~used:( s.used ) ~text:text
                  ...
                  (None  , None  , (
                   [(( [`Skeyword ("("); `Sself; `Skeyword (")")] ) , (
                           ...
                           fun (_) ->
                             fun ((_loc : FanLoc.t)) ->
                               (let  p =
                                ...
                                in
                                let  (p , ls ) =
                                (Expr.filter_patt_with_captured_variables p )
                                in
                                (match ls with
                                    ...
                                    (List.fold_left (
                                      ...
                                      (Ast.ExApp(_loc , (
                                                 (Ast.ExApp(_loc , (
                                                            ...
                                                            x )) ) , y )) )
                                      ys ) in
                                    (mk_tok _loc ~restrict:restrict p (
                                      (STtok(_loc)) ) )) : 'symbol ) ) ) ) );
                    ((
                     [`Skeyword ("["); `Slist0sep
                      ((`Snterm ((Gram.obj ( (rule : 'rule  Gram.t ) ) )) ,
                       ...
                       fun (_) ->
                         fun ((rl : 'rule  list )) ->
                           fun (_) ->
                             fun ((_loc : FanLoc.t)) ->
                               (let  rl =
                                (retype_rule_list_without_patterns _loc rl )
                                in
                    ...
                    ((
                     [`Stoken
                      (((
                        function | (`UIDENT "SELF") -> (true) | _ -> (false)
                        ) , (`Normal , "(`UIDENT \"SELF\")" ) ))] ) , (
                     (Gram.mk_action (
                       fun (__camlp4_0) ->
                         fun ((_loc : FanLoc.t)) ->
                                   ...
                                   fun ((_loc : FanLoc.t)) ->
                                     (match (__camlp4_1 , __camlp4_0 ) with
                                      | ((`UIDENT "SEP") , (`UIDENT "FOLD1") ) ->
                                         ((sfoldsep _loc "FOLD1 SEP"
                                            "sfold1sep" f e s sep ) : 'symbol
                                           )
                                      | _ -> assert false) ) ) ) );
                    ((
                     [`Stoken
                                   ...
                                   fun ((_loc : FanLoc.t)) ->
                                     (match (__camlp4_1 , __camlp4_0 ) with
                                      | ((`UIDENT "SEP") , (`UIDENT "FOLD0") ) ->
                                         ((sfoldsep _loc "FOLD0 SEP"
                                            "sfold0sep" f e s sep ) : 'symbol
                                           )
                                      | _ -> assert false) ) ) ) );
                    ((
                     [`Stoken
...
module MakeMacroParser =
 functor (Syntax : Sig.Camlp4Syntax) ->
  ...
  (FanLoc.raise loc (
    (Failure(Printf.sprintf "expected %d parameters; found %d" (
  ...
  let _ = let  _ = (expr : 'expr  Gram.t ) and _ =
          ...
          (str_item : 'str_item  Gram.t ) and _ = (patt : 'patt  Gram.t ) 
          in
          let  grammar_entry_create = Gram.mk in
          let  macro_def =
          ((grammar_entry_create "macro_def" ) : 'macro_def  Gram.t ) and
          uident = ((grammar_entry_create "uident" ) : 'uident  Gram.t )
          and opt_macro_value =
          ((grammar_entry_create "opt_macro_value" ) : 'opt_macro_value 
            Gram.t ) and endif =
          ((grammar_entry_create "endif" ) : 'endif  Gram.t ) and
          sglist_else =
          ((grammar_entry_create "sglist_else" ) : 'sglist_else  Gram.t )
          and sglist_then =
          ((grammar_entry_create "sglist_then" ) : 'sglist_then  Gram.t )
          and smlist_else =
          ((grammar_entry_create "smlist_else" ) : 'smlist_else  Gram.t )
          and smlist_then =
          ((grammar_entry_create "smlist_then" ) : 'smlist_then  Gram.t )
          and else_expr =
          ...
          ((grammar_entry_create "else_macro_def" ) : 'else_macro_def 
            Gram.t ) and uident_eval_ifndef =
          ...
          ((grammar_entry_create "uident_eval_ifdef" ) :
            'uident_eval_ifdef  Gram.t ) and macro_def_sig =
          ((grammar_entry_create "macro_def_sig" ) : 'macro_def_sig 
            Gram.t )  in
          begin
           (
                   ...
                   [((
                    ...
                    ((
                     [`Skeyword ("IFNDEF"); `Snterm
                      ((Gram.obj (
                         (uident_eval_ifndef : 'uident_eval_ifndef 
                           Gram.t ) ) )); `Skeyword ("THEN"); `Snterm
                   ...
                   [((
                    ...
                    ((
                     [`Skeyword ("IFNDEF"); `Snterm
                      ...
                      ((Gram.obj (
                         (else_macro_def_sig : 'else_macro_def_sig 
                           Gram.t ) ) ))] ) , (
                     (Gram.mk_action (
                ...
                (None  , (
                 [(None  , None  , (
                   [((
                     [`Skeyword ("IFNDEF"); `Snterm
                      ((Gram.obj ( (uident : 'uident  Gram.t ) ) ));
                      `Skeyword ("THEN"); `Sself; `Skeyword ("ELSE");
                      `Sself; `Snterm
                      ((Gram.obj ( (endif : 'endif  Gram.t ) ) ))] ) , (
                     (Gram.mk_action (
                       fun (_) ->
...
module MakeRevisedParser =
 functor (Syntax : Sig.Camlp4Syntax) ->
  ...
  let _ = let  _ = (a_CHAR : 'a_CHAR  Gram.t ) and _ =
          ...
          (infixop4 : 'infixop4  Gram.t ) and _ =
          (infixop3 : 'infixop3  Gram.t ) and _ =
          (infixop2 : 'infixop2  Gram.t ) and _ =
          (infixop1 : 'infixop1  Gram.t ) and _ =
          ...
          (use_file : 'use_file  Gram.t ) and _ =
          (typevars : 'typevars  Gram.t ) and _ =
          ...
          (type_longident_and_parameters : 'type_longident_and_parameters 
            Gram.t ) and _ = (type_longident : 'type_longident  Gram.t ) and
          _ = (type_kind : 'type_kind  Gram.t ) and _ =
          ...
          (str_item : 'str_item  Gram.t ) and _ =
          (star_ctyp : 'star_ctyp  Gram.t ) and _ =
          (sig_items : 'sig_items  Gram.t ) and _ =
          (sig_item_quot : 'sig_item_quot  Gram.t ) and _ =
          (sig_item : 'sig_item  Gram.t ) and _ =
          (sequence : 'sequence  Gram.t ) and _ = (semi : 'semi  Gram.t ) and
          _ = (sem_patt_for_list : 'sem_patt_for_list  Gram.t ) and _ =
          (sem_patt : 'sem_patt  Gram.t ) and _ =
          (sem_expr_for_list : 'sem_expr_for_list  Gram.t ) and _ =
          (sem_expr : 'sem_expr  Gram.t ) and _ =
          (row_field : 'row_field  Gram.t ) and _ =
          (poly_type : 'poly_type  Gram.t ) and _ =
          (phrase : 'phrase  Gram.t ) and _ =
          (patt_tcon : 'patt_tcon  Gram.t ) and _ =
          (patt_quot : 'patt_quot  Gram.t ) and _ =
          (patt_eoi : 'patt_eoi  Gram.t ) and _ =
          (patt_as_patt_opt : 'patt_as_patt_opt  Gram.t ) and _ =
          (patt : 'patt  Gram.t ) and _ =
          (opt_when_expr : 'opt_when_expr  Gram.t ) and _ =
          (opt_virtual : 'opt_virtual  Gram.t ) and _ =
          ...
          (label : 'label  Gram.t ) and _ =
          (ipatt_tcon : 'ipatt_tcon  Gram.t ) and _ =
          (ipatt : 'ipatt  Gram.t ) and _ = (interf : 'interf  Gram.t ) and _
          = (implem : 'implem  Gram.t ) and _ =
          (ident_quot : 'ident_quot  Gram.t ) and _ =
          (ident : 'ident  Gram.t ) and _ = (fun_def : 'fun_def  Gram.t ) and
          _ = (fun_binding : 'fun_binding  Gram.t ) and _ =
          (field_expr_list : 'field_expr_list  Gram.t ) and _ =
          (field_expr : 'field_expr  Gram.t ) and _ =
          (expr_quot : 'expr_quot  Gram.t ) and _ =
          (expr_eoi : 'expr_eoi  Gram.t ) and _ = (expr : 'expr  Gram.t ) and
          _ = (eq_expr : 'eq_expr  Gram.t ) and _ = (dummy : 'dummy  Gram.t )
          and _ = (direction_flag : 'direction_flag  Gram.t ) and _ =
          (cvalue_binding : 'cvalue_binding  Gram.t ) and _ =
          (ctyp_quot : 'ctyp_quot  Gram.t ) and _ = (ctyp : 'ctyp  Gram.t )
          and _ =
          (constructor_declarations : 'constructor_declarations  Gram.t ) and
          _ = (constructor_declaration : 'constructor_declaration  Gram.t )
          and _ = (constructor_arg_list : 'constructor_arg_list  Gram.t ) and
          _ = (constrain : 'constrain  Gram.t ) and _ =
          ...
          (and_ctyp : 'and_ctyp  Gram.t ) and _ =
          (amp_ctyp : 'amp_ctyp  Gram.t ) and _ =
          (a_ident : 'a_ident  Gram.t ) and _ =
          (a_UIDENT : 'a_UIDENT  Gram.t ) and _ =
          ...
          (a_LIDENT : 'a_LIDENT  Gram.t ) and _ =
          (a_LABEL : 'a_LABEL  Gram.t ) and _ = (a_INT64 : 'a_INT64  Gram.t )
          and _ = (a_INT32 : 'a_INT32  Gram.t ) and _ =
          ...
          opt_override =
          ((grammar_entry_create "opt_override" ) : 'opt_override  Gram.t )
          ...
          ((grammar_entry_create "module_longident_dot_lparen" ) :
            'module_longident_dot_lparen  Gram.t ) and
          ...
          ((grammar_entry_create "fun_def_cont" ) : 'fun_def_cont  Gram.t )
          and sequence' =
          ((grammar_entry_create "sequence'" ) : 'sequence'  Gram.t ) and
          infixop6 =
          ((grammar_entry_create "infixop6" ) : 'infixop6  Gram.t )  in
          begin
           (
                   ...
                   [((
                    ...
                    ((
                     [`Skeyword ("functor"); `Skeyword ("("); `Snterm
                      ((Gram.obj ( (a_UIDENT : 'a_UIDENT  Gram.t ) ) ));
                      `Skeyword (":"); `Snterm
                  ...
                  (( (Some("simple")) ) , None  , (
                   [((
                    ...
                    ((
                     [`Snterm
                      ((Gram.obj (
                         (module_longident : 'module_longident  Gram.t ) ) ))]
                     ) , (
                     (Gram.mk_action (
                           ...
                           (match __camlp4_0 with
                            | (`QUOTATION x) ->
                               ((Quotation.expand _loc x
                                  DynAst.module_expr_tag ) : 'module_expr )
                            | _ -> assert false) ) ) ) );
                    ((
                     [`Stoken
                      (((
                   ...
                   [(( [`Snterm ((Gram.obj ( (expr : 'expr  Gram.t ) ) ))] )
                    ...
                    ((
                     [`Skeyword ("class"); `Snterm
                      ((Gram.obj (
                         (class_declaration : 'class_declaration  Gram.t ) )
                         ))] ) , (
                     (Gram.mk_action (
                    ...
                    ((
                     [`Skeyword ("let"); `Skeyword ("module"); `Snterm
                      ...
                      `Snterm
                      ((Gram.obj (
                         (module_binding0 : 'module_binding0  Gram.t ) ) ));
                      `Skeyword ("in"); `Snterm
                      ((Gram.obj ( (expr : 'expr  Gram.t ) ) ))] ) , (
                     (Gram.mk_action (
                       fun ((e : 'expr )) ->
                    ...
                    ((
                     [`Skeyword ("let"); `Snterm
                      ((Gram.obj ( (opt_rec : 'opt_rec  Gram.t ) ) ));
                      `Snterm
                    ...
                    ((
                     [`Skeyword ("type"); `Snterm
                      ((Gram.obj (
                         (type_declaration : 'type_declaration  Gram.t ) ) ))]
                     ) , (
                     (Gram.mk_action (
                    ...
                    ((
                     [`Skeyword ("module"); `Skeyword ("rec"); `Snterm
                      ((Gram.obj (
                         (module_binding : 'module_binding  Gram.t ) ) ))] )
                     , (
                     (Gram.mk_action (
                    ...
                    ((
                     [`Skeyword ("exception"); `Snterm
                      ...
                      ((Gram.obj (
                         (type_longident : 'type_longident  Gram.t ) ) ))] )
                     , (
                     (Gram.mk_action (
                       ...
                       fun (__camlp4_0) ->
                         fun ((_loc : FanLoc.t)) ->
                           (match __camlp4_0 with
                            | (`QUOTATION x) ->
                               ((Quotation.expand _loc x
                                  DynAst.module_type_tag ) : 'module_type )
                            | _ -> assert false) ) ) ) );
                    ((
                     [`Stoken
                      (((
                 ...
                 [(( (Some("top")) ) , None  , (
                   [((
                    ...
                    ((
                     [`Skeyword ("class"); `Snterm
                      ((Gram.obj (
                         (class_description : 'class_description  Gram.t ) )
                         ))] ) , (
                     (Gram.mk_action (
                       ...
                       fun (__camlp4_0) ->
                         fun ((_loc : FanLoc.t)) ->
                           (match __camlp4_0 with
                            | (`QUOTATION x) ->
                               ((Quotation.expand _loc x
                                  DynAst.with_constr_tag ) : 'with_constr )
                            | _ -> assert false) ) ) ) );
                    ((
                     [`Stoken
                      (((
                 ...
                 [(( (Some("top")) ) , ( (Some(`RA)) ) , (
                   [((
                     [`Skeyword ("object"); `Snterm
                      ...
                      ((Gram.obj (
                         (class_structure : 'class_structure  Gram.t ) ) ));
                      `Skeyword ("end")] ) , (
                     (Gram.mk_action (
                       fun (_) ->
                    ...
                    ((
                     [`Skeyword ("for"); `Snterm
                      ...
                      `Snterm
                      ((Gram.obj (
                         (direction_flag : 'direction_flag  Gram.t ) ) ));
                      `Snterm
                      ((Gram.obj ( (sequence : 'sequence  Gram.t ) ) ));
                      `Skeyword ("do"); `Snterm
                      ((Gram.obj ( (do_sequence : 'do_sequence  Gram.t ) ) ))]
                  ...
                  (( (Some("||")) ) , ( (Some(`RA)) ) , (
                   [((
                     [`Sself; `Snterm
                      ((Gram.obj ( (infixop6 : 'infixop6  Gram.t ) ) ));
                      `Sself] ) , (
                     (Gram.mk_action (
                       fun ((e2 : 'expr )) ->
                         fun ((op : 'infixop6 )) ->
                  ...
                  (( (Some("&&")) ) , ( (Some(`RA)) ) , (
                   [((
                     [`Sself; `Snterm
                      ((Gram.obj ( (infixop5 : 'infixop5  Gram.t ) ) ));
                      `Sself] ) , (
                     (Gram.mk_action (
                       fun ((e2 : 'expr )) ->
                         fun ((op : 'infixop5 )) ->
                  ...
                  (( (Some("<")) ) , ( (Some(`LA)) ) , (
                   [((
                     [`Sself; `Snterm
                      ((Gram.obj ( (infixop0 : 'infixop0  Gram.t ) ) ));
                      `Sself] ) , (
                     (Gram.mk_action (
                       fun ((e2 : 'expr )) ->
                         fun ((op : 'infixop0 )) ->
                  ...
                  (( (Some("^")) ) , ( (Some(`RA)) ) , (
                   [((
                     [`Sself; `Snterm
                      ((Gram.obj ( (infixop1 : 'infixop1  Gram.t ) ) ));
                      `Sself] ) , (
                     (Gram.mk_action (
                       fun ((e2 : 'expr )) ->
                         fun ((op : 'infixop1 )) ->
                  ...
                  (( (Some("+")) ) , ( (Some(`LA)) ) , (
                   [((
                     [`Sself; `Snterm
                      ((Gram.obj ( (infixop2 : 'infixop2  Gram.t ) ) ));
                      `Sself] ) , (
                     (Gram.mk_action (
                       fun ((e2 : 'expr )) ->
                         fun ((op : 'infixop2 )) ->
                  ...
                  (( (Some("*")) ) , ( (Some(`LA)) ) , (
                   [((
                     [`Sself; `Snterm
                      ((Gram.obj ( (infixop3 : 'infixop3  Gram.t ) ) ));
                      `Sself] ) , (
                     (Gram.mk_action (
                       fun ((e2 : 'expr )) ->
                         fun ((op : 'infixop3 )) ->
                  ...
                  (( (Some("**")) ) , ( (Some(`RA)) ) , (
                   [((
                     [`Sself; `Snterm
                      ((Gram.obj ( (infixop4 : 'infixop4  Gram.t ) ) ));
                      `Sself] ) , (
                     (Gram.mk_action (
                       fun ((e2 : 'expr )) ->
                         fun ((op : 'infixop4 )) ->
                  ...
                  (( (Some("apply")) ) , ( (Some(`LA)) ) , (
                   [(( [`Skeyword ("lazy"); `Sself] ) , (
                    ...
                    ((
                     [`Skeyword ("new"); `Snterm
                      ((Gram.obj (
                         (class_longident : 'class_longident  Gram.t ) ) ))]
                     ) , (
                     (Gram.mk_action (
                  ...
                  (( (Some("~-")) ) , ( (Some(`NA)) ) , (
                   [((
                     [`Snterm
                      ((Gram.obj ( (prefixop : 'prefixop  Gram.t ) ) ));
                      `Sself] ) , (
                     (Gram.mk_action (
                       fun ((e : 'expr )) ->
                         fun ((f : 'prefixop )) ->
                  ...
                  (( (Some("simple")) ) , None  , (
                   [((
                         ...
                         fun ((t : 'ctyp )) ->
                           fun (_) ->
                             fun ((e : 'expr )) ->
                               fun (_) ->
                                 fun ((_loc : FanLoc.t)) ->
                                   ((Ast.ExCoe(_loc , e , ( (Ast.TyNil(_loc))
                                               ) , t )) : 'expr ) ) ) ) );
                    ((
                     [`Skeyword ("("); `Sself; `Skeyword (":"); `Snterm
                      ((Gram.obj ( (ctyp : 'ctyp  Gram.t ) ) )); `Skeyword
                    ...
                    ((
                     [`Skeyword ("{<"); `Snterm
                      ((Gram.obj (
                         (field_expr_list : 'field_expr_list  Gram.t ) ) ));
                      `Skeyword (">}")] ) , (
                     (Gram.mk_action (
                       fun (_) ->
                    ...
                    ((
                     [`Skeyword ("{"); `Skeyword ("("); `Sself; `Skeyword
                      (")"); `Skeyword ("with"); `Snterm
                      ((Gram.obj (
                         (label_expr_list : 'label_expr_list  Gram.t ) ) ));
                      `Skeyword ("}")] ) , (
                     (Gram.mk_action (
                       fun (_) ->
                    ...
                    ((
                     [`Snterm
                      ((Gram.obj ( (a_STRING : 'a_STRING  Gram.t ) ) ))] ) ,
                     (
                     (Gram.mk_action (
                       fun ((s : 'a_STRING )) ->
                         fun ((_loc : FanLoc.t)) ->
                     ...
                     (Gram.mk_action (
                       fun (__camlp4_0) ->
                         fun ((_loc : FanLoc.t)) ->
                           (match __camlp4_0 with
                            | (`QUOTATION x) ->
                               ((Quotation.expand _loc x DynAst.expr_tag ) :
                                 'expr )
                            | _ -> assert false) ) ) ) )] ) )] ) )) ()  ) ) )
          );
           (
                ...
                (None  , (
                 [(None  , ( (Some(`RA)) ) , (
                   [((
                     [`Snterm
                      ((Gram.obj (
                         (cvalue_binding : 'cvalue_binding  Gram.t ) ) ))] )
                     , (
                     (Gram.mk_action (
                ...
                (None  , (
                 [(None  , None  , (
                   [((
                     [`Snterm
                      ((Gram.obj (
                         (patt_as_patt_opt : 'patt_as_patt_opt  Gram.t ) ) ));
                      `Snterm
                ...
                (None  , (
                 [(None  , None  , (
                   [((
                     [`Snterm
                      ((Gram.obj (
                         (label_longident : 'label_longident  Gram.t ) ) ))]
                     ) , (
                     (Gram.mk_action (
                      ...
                      ((Gram.srules fun_def (
                         [(( [`Skeyword ("("); `Skeyword ("type")] ) , (
                           (Gram.mk_action (
                             fun (_) ->
                               fun (_) ->
                                 fun ((_loc : FanLoc.t)) -> (() : 'e__19 ) )
                             ) ) )] ) )); `Snterm
                      ((Gram.obj ( (a_LIDENT : 'a_LIDENT  Gram.t ) ) ));
                      `Skeyword (")"); `Snterm
                      ((Gram.obj (
                         (fun_def_cont_no_when : 'fun_def_cont_no_when 
                           Gram.t ) ) ))] ) , (
                     (Gram.mk_action (
                   ...
                   [((
                    ...
                    ((
                     [`Skeyword ("?"); `Stoken
                      ...
                      ((Gram.obj ( (patt_tcon : 'patt_tcon  Gram.t ) ) ));
                      `Snterm
                      ((Gram.obj ( (eq_expr : 'eq_expr  Gram.t ) ) ));
                      `Skeyword (")")] ) , (
                     (Gram.mk_action (
                       fun (_) ->
                         fun ((f : 'eq_expr )) ->
                    ...
                    ((
                     [`Skeyword ("{"); `Snterm
                      ((Gram.obj (
                         (label_patt_list : 'label_patt_list  Gram.t ) ) ));
                      `Skeyword ("}")] ) , (
                     (Gram.mk_action (
                       fun (_) ->
                    ...
                    ((
                     [`Skeyword ("["); `Snterm
                      ((Gram.obj (
                         (sem_patt_for_list : 'sem_patt_for_list  Gram.t ) )
                         )); `Skeyword ("]")] ) , (
                     (Gram.mk_action (
                       fun (_) ->
                 ...
                 [(None  , None  , (
                   [(( [`Skeyword ("_")] ) , (
                    ...
                    ((
                     [`Skeyword ("{"); `Snterm
                      ((Gram.obj (
                         (label_ipatt_list : 'label_ipatt_list  Gram.t ) ) ));
                      `Skeyword ("}")] ) , (
                     (Gram.mk_action (
                       fun (_) ->
                   ...
                   [([]  , (
                    ...
                    ((
                     ...
                     (Gram.mk_action (
                       fun ((tk : 'type_kind )) ->
                         fun (_) ->
                           fun ((_loc : FanLoc.t)) -> (tk : 'opt_eq_ctyp ) )
                       ) ) )] ) )] ) )) ()  ) ) )
          );
           (
                 ...
                 [(None  , None  , (
                   [((
                     [`Snterm
                      ...
                      `Snterm
                      ((Gram.obj (
                         (type_parameters : 'type_parameters  Gram.t ) ) ))]
                     ) , (
                     (Gram.mk_action (
                 ...
                 [(None  , None  , (
                   [([]  , (
                    ...
                    ((
                     [`Snterm
                      ((Gram.obj (
                         (type_parameter : 'type_parameter  Gram.t ) ) ))] )
                     , (
                     (Gram.mk_action (
                ...
                (None  , (
                 [(( (Some("==")) ) , ( (Some(`LA)) ) , (
                  ...
                  (( (Some("forall")) ) , ( (Some(`LA)) ) , (
                   [((
                     [`Skeyword ("!"); `Snterm
                      ((Gram.obj ( (typevars : 'typevars  Gram.t ) ) ));
                      `Skeyword ("."); `Sself] ) , (
                     (Gram.mk_action (
                       fun ((t2 : 'ctyp )) ->
                         fun (_) ->
                  ...
                  (( (Some("label")) ) , ( (Some(`NA)) ) , (
                   [((
                    ...
                    ((
                     [`Snterm
                      ((Gram.obj ( (a_LABEL : 'a_LABEL  Gram.t ) ) ));
                      `Sself] ) , (
                     (Gram.mk_action (
                       fun ((t : 'ctyp )) ->
                         fun ((i : 'a_LABEL )) ->
                   ...
                   [((
                    ...
                    ((
                     [`Skeyword ("[<"); `Snterm
                      ...
                      `Skeyword (">"); `Snterm
                      ((Gram.obj ( (name_tags : 'name_tags  Gram.t ) ) ));
                      `Skeyword ("]")] ) , (
                     (Gram.mk_action (
                       fun (_) ->
                         fun ((ntl : 'name_tags )) ->
                 ...
                 [(None  , None  , (
                   [((
                    ...
                    ((
                     [`Skeyword (":"); `Snterm
                      ((Gram.obj (
                         (class_type_plus : 'class_type_plus  Gram.t ) ) ));
                      `Skeyword ("="); `Snterm
                 ...
                 [(None  , None  , (
                   [((
                     [`Snterm
                      ...
                      `Snterm
                      ((Gram.obj (
                         (class_name_and_param : 'class_name_and_param 
                           Gram.t ) ) ))] ) , (
                     (Gram.mk_action (
                   ...
                   [((
                    ...
                    ((
                     [`Snterm
                      ...
                      `Skeyword ("["); `Snterm
                      ((Gram.obj (
                         (comma_type_parameter : 'comma_type_parameter 
                           Gram.t ) ) )); `Skeyword ("]")] ) , (
                     (Gram.mk_action (
                       fun (_) ->
                       ...
                       fun (__camlp4_0) ->
                         fun ((_loc : FanLoc.t)) ->
                           (match __camlp4_0 with
                            | (`QUOTATION x) ->
                               ((Quotation.expand _loc x
                                  DynAst.class_expr_tag ) : 'class_expr )
                            | _ -> assert false) ) ) ) );
                    ((
                     [`Stoken
                      (((
                   ...
                   [((
                     [`Slist0
                      ((Gram.srules class_structure (
                         [((
                           [`Snterm
                            ((Gram.obj (
                               (class_str_item : 'class_str_item  Gram.t ) )
                               )); `Snterm
                            ((Gram.obj ( (semi : 'semi  Gram.t ) ) ))] ) , (
                           (Gram.mk_action (
                             fun (_) ->
                    ...
                    ((
                     [`Stoken
                      ...
                      ((Gram.obj ( (semi : 'semi  Gram.t ) ) )); `Sself] ) ,
                     (
                     (Gram.mk_action (
                       fun ((cst : 'class_structure )) ->
                         fun (_) ->
                 ...
                 [(None  , ( (Some(`LA)) ) , (
                   [((
                    ...
                    ((
                     [`Snterm
                      ((Gram.obj (
                         (type_constraint : 'type_constraint  Gram.t ) ) ));
                      `Snterm ((Gram.obj ( (ctyp : 'ctyp  Gram.t ) ) ));
                      `Skeyword ("="); `Snterm
                      ((Gram.obj ( (ctyp : 'ctyp  Gram.t ) ) ))] ) , (
                     (Gram.mk_action (
                                 ...
                                 fun ((o : 'method_opt_override )) ->
                                   fun ((_loc : FanLoc.t)) ->
                                     (if (o <> Ast.OvNil ) then
                                       (
                                       (raise (
                                         (Stream.Error("override (!) is incompatible with virtual"))
                                         ) )
                                       )
                     ...
                     [`Snterm
                      ((Gram.obj (
                         (value_val_opt_override : 'value_val_opt_override 
                           Gram.t ) ) )); `Skeyword ("virtual"); `Snterm
                   ...
                   [((
                    ...
                    ((
                     [`Skeyword (":"); `Skeyword ("type"); `Snterm
                      ((Gram.obj (
                         (unquoted_typevars : 'unquoted_typevars  Gram.t ) )
                         )); `Skeyword ("."); `Snterm
                      ((Gram.obj ( (ctyp : 'ctyp  Gram.t ) ) )); `Skeyword
                      ("="); `Snterm
                      ((Gram.obj ( (expr : 'expr  Gram.t ) ) ))] ) , (
                 ...
                 [(None  , None  , (
                   [((
                     [`Skeyword ("object"); `Snterm
                      ...
                      ((Gram.obj (
                         (class_signature : 'class_signature  Gram.t ) ) ));
                      `Skeyword ("end")] ) , (
                     (Gram.mk_action (
                       fun (_) ->
                       ...
                       fun (__camlp4_0) ->
                         fun ((_loc : FanLoc.t)) ->
                           (match __camlp4_0 with
                            | (`QUOTATION x) ->
                               ((Quotation.expand _loc x
                                  DynAst.class_type_tag ) : 'class_type )
                            | _ -> assert false) ) ) ) );
                    ((
                     [`Stoken
                      (((
                ...
                (None  , (
                 [(None  , None  , (
                   [((
                     [`Snterm
                      ((Gram.obj (
                         (class_type_longident : 'class_type_longident 
                           Gram.t ) ) ))] ) , (
                     (Gram.mk_action (
                     ...
                     [`Slist0
                      ((Gram.srules class_signature (
                         [((
                           [`Snterm
                            ((Gram.obj (
                               (class_sig_item : 'class_sig_item  Gram.t ) )
                               )); `Snterm
                            ((Gram.obj ( (semi : 'semi  Gram.t ) ) ))] ) , (
                           (Gram.mk_action (
                             fun (_) ->
                     ...
                     (Gram.mk_action (
                       fun ((e : 'expr )) ->
                         fun (_) ->
                           fun ((l : 'label )) ->
                             fun ((_loc : FanLoc.t)) ->
                               ((Ast.RbEq(_loc , ( (Ast.IdLid(_loc , l )) ) ,
                                          e )) : 'field_expr ) ) ) ) );
                    ((
                     [`Stoken
                      (((
            ...
            ((fun (()) ->
                (None  , (
                 [(None  , None  , (
                   [((
                     [`Snterm
                      ((Gram.obj ( (meth_decl : 'meth_decl  Gram.t ) ) ));
                      `Snterm
                       ...
                       fun ((t : 'amp_ctyp )) ->
                         fun (_) ->
                           fun ((i : 'a_ident )) ->
                             fun (_) ->
                               fun ((_loc : FanLoc.t)) ->
                                 ((Ast.TyOf(_loc , ( (Ast.TyVrn(_loc , i )) )
                                            , t )) : 'row_field ) ) ) ) );
                    ((
                     [`Skeyword ("`"); `Snterm
                      ((Gram.obj ( (a_ident : 'a_ident  Gram.t ) ) ));
          ...
          (Gram.extend ( (rec_binding_quot : 'rec_binding_quot  Gram.t ) ) (
           ...
           (
          (Gram.extend (
            (module_binding_quot : 'module_binding_quot  Gram.t ) ) (
            ((fun (()) ->
                (None  , (
                 [(None  , None  , (
                   [([]  , (
                   ...
                   [(( [`Skeyword ("("); `Sself; `Skeyword (")")] ) , (
                     (Gram.mk_action (
                       fun (_) ->
                         fun ((i : 'ident_quot )) ->
                           fun (_) ->
                             fun ((_loc : FanLoc.t)) -> (i : 'ident_quot ) )
                       ) ) );
                    ((
                     [`Stoken
                      (((
                   ...
                   [([]  , (
                    ...
                    ((
                     [`Stoken
                      ...
                      `Snterm
                      ((Gram.obj (
                         (opt_comma_ctyp : 'opt_comma_ctyp  Gram.t ) ) ))] )
                     , (
                     (Gram.mk_action (
                             ...
                             fun ((_loc : FanLoc.t)) ->
                               (match __camlp4_0 with
                                | (`ANTIQUOT (("virtual" as n) , s )) ->
                                   (let  anti =
                                    (Ast.ViAnt(mk_anti ~c:"class_expr" n s ))
          ...
          (Gram.extend ( (class_type_quot : 'class_type_quot  Gram.t ) ) (
                           ...
                           fun (__camlp4_0) ->
                             fun ((_loc : FanLoc.t)) ->
                               (match __camlp4_0 with
                                | (`ANTIQUOT (("virtual" as n) , s )) ->
                                   (let  anti =
                                    (Ast.ViAnt(mk_anti ~c:"class_type" n s ))
           ...
           (
          (Gram.extend (
            (class_str_item_quot : 'class_str_item_quot  Gram.t ) ) (
            ((fun (()) ->
                (None  , (
                 [(None  , None  , (
                   [([]  , (
           ...
           (
          (Gram.extend (
            (class_sig_item_quot : 'class_sig_item_quot  Gram.t ) ) (
            ((fun (()) ->
                (None  , (
                 [(None  , None  , (
                   [([]  , (
          ...
          (Gram.extend ( (rec_flag_quot : 'rec_flag_quot  Gram.t ) ) (
           ...
           (
          (Gram.extend (
            (direction_flag_quot : 'direction_flag_quot  Gram.t ) ) (
            ((fun (()) ->
                (None  , (
                 [(None  , None  , (
                   [((
...
module MakeRevisedParserParser =
 functor (Syntax : Sig.Camlp4Syntax) ->
     ...
     if (pattern_eq_expression p skont ) then
      ...
      if (is_raise_failure ckont ) then e
       ...
       (Ast.ExTry(_loc , e , (
           ...
           (Ast.ExLet(_loc , Ast.ReNil  , ( (Ast.BiEq(_loc , p , tst )) ) ,
                      skont ))
           )
     else
      (Ast.ExMat(_loc , (
  ...
  (List.fold_right (
    fun ((p , w , _loc , spcl , epo , e )) ->
      fun (acc) ->
        ...
        let  ekont (err) =
        let  str =
        (match err with | Some(estr) -> estr | _ -> (Ast.ExStr(_loc , "" )))
        in
        (Ast.ExApp(_loc , (
  ...
  function
  | (((((Ast.ExId(_ , Ast.IdLid(_ , _ ) ) | Ast.ExId(_ , Ast.IdUid(_ , _ ) ))
        | Ast.ExInt(_ , _ )) | Ast.ExFlo(_ , _ )) | Ast.ExChr(_ , _ ))
     | Ast.ExStr(_ , _ )) ->
     (true)
  | Ast.ExApp(_ , x , y ) ->
  ...
  let _ = let  _ = (expr : 'expr  Gram.t ) and _ =
          ...
          let  grammar_entry_create = Gram.mk in
          let  parser_ipatt =
          ((grammar_entry_create "parser_ipatt" ) : 'parser_ipatt  Gram.t )
          and stream_expr_comp =
          ((grammar_entry_create "stream_expr_comp" ) : 'stream_expr_comp 
            Gram.t ) and stream_expr_comp_list =
          ...
          ((grammar_entry_create "stream_patt_comp" ) : 'stream_patt_comp 
            Gram.t ) and stream_patt =
                ...
                (( (Some(`Level ("top"))) ) , (
                 [(None  , None  , (
                   [((
                     [`Skeyword ("match"); `Snterm
                      ((Gram.obj ( (sequence : 'sequence  Gram.t ) ) ));
                      `Skeyword ("with"); `Skeyword ("parser"); `Sopt
                      (`Snterm
                      ((Gram.obj ( (parser_ipatt : 'parser_ipatt  Gram.t ) )
                         ))); `Snterm
                      ((Gram.obj (
                         (parser_case_list : 'parser_case_list  Gram.t ) ) ))]
                     ) , (
                     (Gram.mk_action (
                 ...
                 [(None  , None  , (
                   [([]  , (
                    ...
                    ((
                     [`Snterm
                      ((Gram.obj (
                         (stream_patt_comp : 'stream_patt_comp  Gram.t ) ) ));
                      `Skeyword (";"); `Snterm
                      ((Gram.obj (
                     ...
                     [`Snterm ((Gram.obj ( (patt : 'patt  Gram.t ) ) ));
                      ...
                      ((Gram.srules stream_patt_comp (
                         [((
                           [`Skeyword ("when"); `Snterm
                            ((Gram.obj (
                               (stream_expr : 'stream_expr  Gram.t ) ) ))] )
                           , (
                           (Gram.mk_action (
                             fun ((e : 'stream_expr )) ->
                               fun (_) ->
                                 fun ((_loc : FanLoc.t)) -> (e : 'e__26 ) ) )
                           ) )] ) ))] ) , (
                     (Gram.mk_action (
                       fun ((eo : 'e__26  option )) ->
                         fun ((p : 'patt )) ->
                ...
                (None  , (
                 [(None  , None  , (
                   [((
                     [`Snterm
                      ((Gram.obj (
                         (stream_patt_comp_err : 'stream_patt_comp_err 
                           Gram.t ) ) )); `Skeyword (";"); `Sself] ) , (
                     (Gram.mk_action (
                       fun ((sp : 'stream_patt_comp_err_list )) ->
                         fun (_) ->
                 ...
                 [(None  , None  , (
                   [((
                     [`Snterm
                      ...
                      ((Gram.obj (
                         (stream_expr_comp_list : 'stream_expr_comp_list 
                           Gram.t ) ) )); `Snterm
                      ((Gram.obj ( (stream_end : 'stream_end  Gram.t ) ) ))]
                     ) , (
                     (Gram.mk_action (
                ...
                (None  , (
                 [(None  , None  , (
                   [((
                     [`Snterm
                      ((Gram.obj (
                         (stream_expr_comp : 'stream_expr_comp  Gram.t ) ) ))]
                     ) , (
                     (Gram.mk_action (
