...
module MakeDebugParser(Syntax:Sig.Camlp4Syntax) = struct
  ...
  let mk_debug_mode _loc =
    ...
    | Some m ->
        Ast.ExId
          (_loc,(Ast.IdAcc
                   (_loc,(Ast.IdUid (_loc,m)),(Ast.IdAcc
                                                 (_loc,(Ast.IdUid
                                                          (_loc,"Debug")),(
                                                 Ast.IdLid (_loc,"mode")))))))
  let mk_debug _loc m fmt section args =
    ...
    Ast.ExIfe
      (_loc,(Ast.ExApp
               (_loc,(mk_debug_mode _loc m),(Ast.ExStr (_loc,section)))),call,(
  ...
  let _=
    ...
    Gram.extend (expr :'expr Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Snterm
           (Gram.obj (start_debug :'start_debug Gram.t  ));`Stoken
           (((function
              | `LIDENT _ -> true
              | _ -> false)),(`Normal,"`LIDENT _"));`Stoken
           (((function
              | `STRING (_,_) -> true
              | _ -> false)),(`Normal,"`STRING (_,_)"));`Slist0 (`Snterml
           ((Gram.obj (expr :'expr Gram.t  )),"."));`Snterm
           (Gram.obj (end_or_in :'end_or_in Gram.t  ))]),(Gram.mk_action
                                                            ((fun
                                                                (x :
                                                                  'end_or_in)
                                                                ->
    ...
    Gram.extend (end_or_in :'end_or_in Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Skeyword "in";`Snterm
           (Gram.obj (expr :'expr Gram.t  ))]),(Gram.mk_action
                                                  ((fun (e : 'expr) ->
                                                      fun _ ->
                                                        fun
                                                          (_loc : FanLoc.t )
           ...
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun (_loc : FanLoc.t ) ->
                   ...
                   | _ -> assert false))));(([`Stoken
           (((function
              | `LIDENT "debug" -> true
              | _ -> false)),(`Normal,"`LIDENT \"debug\""))]),(Gram.mk_action
                                                                 ((fun
                                                                    __camlp4_0
                                                                    ->
                                                                    fun
...
module MakeGrammarParser(Syntax:Sig.Camlp4Syntax) = struct
  ...
  let _=
    ...
    Gram.extend (expr :'expr Gram.t  )
      (((fun () -> ((Some (`After "top")),([(None,None,([(([`Skeyword
           "DELETE_RULE";`Snterm
           (Gram.obj (delete_rule_body :'delete_rule_body Gram.t  ));`Skeyword
           "END"]),(Gram.mk_action
                      ((fun _ ->
                          fun (e : 'delete_rule_body) ->
                            fun _ -> fun (_loc : FanLoc.t ) -> (e :'expr )))));(([`Skeyword
           "EXTEND";`Snterm
           (Gram.obj (extend_body :'extend_body Gram.t  ));`Skeyword
           "END"]),(Gram.mk_action
                      ((fun _ ->
                          fun (e : 'extend_body) ->
    ...
    Gram.extend (extend_header :'extend_header Gram.t  )
      (((fun () ->
           (None,([(None,None,([([],(Gram.mk_action
                                       ((fun (_loc : FanLoc.t ) ->
                                           ((None,(gm ())) :'extend_header )))));(([`Snterm
           (Gram.obj (qualuid :'qualuid Gram.t  ))]),(Gram.mk_action
                                                        ((fun (t : 'qualuid)
                                                            ->
                                                            fun
                                                              (_loc :
    ...
    Gram.extend (extend_body :'extend_body Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Snterm
           (Gram.obj (extend_header :'extend_header Gram.t  ));`Sopt (`Snterm
           (Gram.obj (global :'global Gram.t  )));`Slist1
           (Gram.srules extend_body ([(([`Snterm
              (Gram.obj (entry :'entry Gram.t  ))]),(Gram.mk_action
                                                       ((fun (e : 'entry) ->
                                                           fun
                                                             (_loc :
                                                               FanLoc.t ) ->
    ...
    Gram.extend (delete_rule_body :'delete_rule_body Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Snterm
           (Gram.obj (delete_rule_header :'delete_rule_header Gram.t  ));`Snterm
           (Gram.obj (name :'name Gram.t  ));`Skeyword ":";`Slist0sep
           ((`Snterm (Gram.obj (symbol :'symbol Gram.t  ))),(`Snterm
           (Gram.obj (semi_sep :'semi_sep Gram.t  ))))]),(Gram.mk_action
                                                            ((fun
                                                                (sl :
                                                                  'symbol
                                                                    list ) ->
    ...
    Gram.extend (qualuid :'qualuid Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Stoken
           (((function
              | `UIDENT _ -> true
              | _ -> false)),(`Normal,"`UIDENT _"))]),(Gram.mk_action
                                                         ((fun __camlp4_0 ->
                                                             fun
                                                               (_loc :
                                                                 FanLoc.t )
           ...
           (((function
              | `UIDENT _ -> true
              | _ -> false)),(`Normal,"`UIDENT _"));`Skeyword
           ".";`Sself]),(Gram.mk_action
                           ((fun (xs : 'qualuid) ->
                               fun _ ->
                                 fun __camlp4_0 ->
                                   fun (_loc : FanLoc.t ) ->
    ...
    Gram.extend (qualid :'qualid Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Stoken
           (((function
              | `LIDENT _ -> true
              | _ -> false)),(`Normal,"`LIDENT _"))]),(Gram.mk_action
                                                         ((fun __camlp4_0 ->
                                                             fun
                                                               (_loc :
                                                                 FanLoc.t )
    ...
    Gram.extend (t_qualid :'t_qualid Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Stoken
           (((function
              | `UIDENT _ -> true
              | _ -> false)),(`Normal,"`UIDENT _"));`Skeyword ".";`Stoken
           (((function
              | `LIDENT "t" -> true
              | _ -> false)),(`Normal,"`LIDENT \"t\""))]),(Gram.mk_action
                                                             ((fun __camlp4_1
                                                                 ->
                                                                 fun _ ->
                                                                   fun
    ...
    Gram.extend (global :'global Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Stoken
           (((function
              | `UIDENT "GLOBAL" -> true
              | _ -> false)),(`Normal,"`UIDENT \"GLOBAL\""));`Skeyword
           ":";`Slist1 (`Snterm (Gram.obj (name :'name Gram.t  )));`Snterm
           (Gram.obj (semi_sep :'semi_sep Gram.t  ))]),(Gram.mk_action
                                                          ((fun _ ->
                                                              fun
                                                                (sl :
    ...
    Gram.extend (entry :'entry Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Snterm
           (Gram.obj (name :'name Gram.t  ));`Skeyword ":";`Sopt (`Snterm
           (Gram.obj (position :'position Gram.t  )));`Snterm
           (Gram.obj (level_list :'level_list Gram.t  ))]),(Gram.mk_action
                                                              ((fun
                                                                  (ll :
                                                                    'level_list)
                                                                  ->
    ...
    Gram.extend (position :'position Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Stoken
           (((function
              ...
              | _ -> false)),(`Normal,"`UIDENT (\"Before\"|\"After\"|\"Level\")"));`Snterm
           (Gram.obj (string :'string Gram.t  ))]),(Gram.mk_action
                                                      ((fun (n : 'string) ->
                                                          fun __camlp4_0 ->
                                                            fun
                                                              (_loc :
           ...
           (((function
              ...
              | _ -> false)),(`Normal,"`UIDENT (\"First\"|\"Last\")"))]),(
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun (_loc : FanLoc.t ) ->
                   match __camlp4_0 with
    ...
    Gram.extend (level_list :'level_list Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Skeyword "[";`Slist0sep ((`Snterm
           (Gram.obj (level :'level Gram.t  ))),(`Skeyword "|"));`Skeyword
           "]"]),(Gram.mk_action
                    ((fun _ ->
                        fun (ll : 'level list ) ->
                          fun _ ->
    ...
    Gram.extend (level :'level Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Sopt
           (Gram.srules level ([(([`Stoken
              (((function
                 | `STRING (_,_) -> true
                 | _ -> false)),(`Normal,"`STRING (_,_)"))]),(Gram.mk_action
                                                                ((fun
                                                                    __camlp4_0
                                                                    ->
                                                                    fun
                                                                    ...
                                                                    assert
                                                                    false))))]));`Sopt
           (`Snterm (Gram.obj (assoc :'assoc Gram.t  )));`Snterm
           (Gram.obj (rule_list :'rule_list Gram.t  ))]),(Gram.mk_action
                                                            ((fun
                                                                (rules :
                                                                  'rule_list)
                                                                ->
    ...
    Gram.extend (assoc :'assoc Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Stoken
           ...
           (((function
              ...
              | _ -> false)),(`Normal,"`UIDENT (\"LA\"|\"RA\"|\"NA\")"))]),(
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun (_loc : FanLoc.t ) ->
                   match __camlp4_0 with
    ...
    Gram.extend (rule_list :'rule_list Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Skeyword "[";`Slist1sep ((`Snterm
           (Gram.obj (rule :'rule Gram.t  ))),(`Skeyword "|"));`Skeyword
           "]"]),(Gram.mk_action
                    ((fun _ ->
                        fun (rules : 'rule list ) ->
                          fun _ ->
           ...
           "]"]),(Gram.mk_action
                    ((fun _ ->
                        fun _ -> fun (_loc : FanLoc.t ) -> ([] :'rule_list )))))]))]))))
         ());
    Gram.extend (rule :'rule Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Slist0sep ((`Snterm
           (Gram.obj (psymbol :'psymbol Gram.t  ))),(`Snterm
           (Gram.obj (semi_sep :'semi_sep Gram.t  ))))]),(Gram.mk_action
                                                            ((fun
                                                                (psl :
                                                                  'psymbol
                                                                ...
                                                                fun
                                                                  ...
                                                                  (mk_rule
                                                                    ...
                                                                    ~action:None
                                                                  :'rule )))));(([`Slist0sep
           ((`Snterm (Gram.obj (psymbol :'psymbol Gram.t  ))),(`Snterm
           (Gram.obj (semi_sep :'semi_sep Gram.t  ))));`Skeyword "->";`Snterm
           (Gram.obj (expr :'expr Gram.t  ))]),(Gram.mk_action
                                                  ((fun (act : 'expr) ->
                                                      fun _ ->
                                                        fun
    ...
    Gram.extend (psymbol :'psymbol Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Snterm
           (Gram.obj (symbol :'symbol Gram.t  ))]),(Gram.mk_action
                                                      ((fun (s : 'symbol) ->
                                                          fun
                                                            (_loc :
                                                              FanLoc.t ) ->
                                                            (s :'psymbol )))));(([`Snterm
           (Gram.obj (symbol :'symbol Gram.t  ));`Skeyword "{";`Snterm
           (Gram.obj (pattern :'pattern Gram.t  ));`Skeyword
           "}"]),(Gram.mk_action
                    ((fun _ ->
                        fun (p : 'pattern) ->
                          fun _ ->
    ...
    Gram.extend (symbol :'symbol Gram.t  )
      (((fun () -> (None,([((Some "top"),(Some `NA),([(([`Stoken
           (((function
              | `UIDENT "TRY" -> true
              | _ -> false)),(`Normal,"`UIDENT \"TRY\""));`Sself]),(Gram.mk_action
                                                                    ((fun
                                                                    (s :
                                                                    'symbol)
                                                                    ->
           ...
           (((function
              | `UIDENT "OPT" -> true
              | _ -> false)),(`Normal,"`UIDENT \"OPT\""));`Sself]),(Gram.mk_action
                                                                    ((fun
                                                                    (s :
                                                                    'symbol)
                                                                    ->
                                                                    ...
                                                                    false))));(([`Stoken
           (((function
              | `UIDENT ("LIST0"|"LIST1") -> true
              | _ -> false)),(`Normal,"`UIDENT (\"LIST0\"|\"LIST1\")"));`Sself;`Sopt
           (Gram.srules symbol ([(([`Stoken
              (((function
                 | `UIDENT "SEP" -> true
                 | _ -> false)),(`Normal,"`UIDENT \"SEP\""));`Snterm
              (Gram.obj (symbol :'symbol Gram.t  ))]),(Gram.mk_action
                                                         ((fun (t : 'symbol)
                                                             ->
                                                             fun __camlp4_0
           ...
           ")"]),(Gram.mk_action
                    ((fun _ ->
                        fun (s_t : 'symbol) ->
                          fun _ -> fun (_loc : FanLoc.t ) -> (s_t :'symbol )))));(([`Snterm
           (Gram.obj (name :'name Gram.t  ));`Sopt
           (Gram.srules symbol ([(([`Stoken
              (((function
                 | `UIDENT "Level" -> true
                 | _ -> false)),(`Normal,"`UIDENT \"Level\""));`Stoken
              (((function
                 | `STRING (_,_) -> true
                 | _ -> false)),(`Normal,"`STRING (_,_)"))]),(Gram.mk_action
                                                                ((fun
                                                             ...
                                                             ((fun __camlp4_0
                                                                 ...
                                                                 fun
                                                                   ...
                                                                   _ ->
                                                                    assert
                                                                    false))));(([`Skeyword
           "`";`Snterm (Gram.obj (a_ident :'a_ident Gram.t  ));`Sopt (`Snterm
           (Gram.obj (patt :'patt Gram.t  )))]),(Gram.mk_action
                                                   ((fun (p : 'patt option )
                                                       ->
                                                       fun (i : 'a_ident) ->
                                                         fun _ ->
           ...
           (((function
              | `UIDENT "NEXT" -> true
              | _ -> false)),(`Normal,"`UIDENT \"NEXT\""))]),(Gram.mk_action
                                                                ((fun
                                                                    __camlp4_0
                                                                    ->
                                                                    fun
           ...
           (((function
              | `UIDENT "SELF" -> true
              | _ -> false)),(`Normal,"`UIDENT \"SELF\""))]),(Gram.mk_action
                                                                ((fun
                                                                    __camlp4_0
                                                                    ->
                                                                    fun
    ...
    Gram.extend (pattern :'pattern Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Skeyword "(";`Sself;`Skeyword
           ",";`Snterm
           (Gram.obj (comma_patt :'comma_patt Gram.t  ));`Skeyword
           ")"]),(Gram.mk_action
                    ((fun _ ->
                        fun (p2 : 'comma_patt) ->
                          fun _ ->
           ...
           ")"]),(Gram.mk_action
                    ((fun _ ->
                        fun (p : 'pattern) ->
                          fun _ -> fun (_loc : FanLoc.t ) -> (p :'pattern )))));(([`Skeyword
           "_"]),(Gram.mk_action
                    ((fun _ ->
                        fun (_loc : FanLoc.t ) -> (Ast.PaAny _loc :'pattern )))));(([`Stoken
           (((function
              | `LIDENT _ -> true
              | _ -> false)),(`Normal,"`LIDENT _"))]),(Gram.mk_action
                                                         ((fun __camlp4_0 ->
    ...
    Gram.extend (comma_patt :'comma_patt Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Snterm
           (Gram.obj (pattern :'pattern Gram.t  ))]),(Gram.mk_action
                                                        ((fun (p : 'pattern)
                                                            ->
                                                            fun
                                                              (_loc :
    ...
    Gram.extend (name :'name Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Snterm
           (Gram.obj (qualid :'qualid Gram.t  ))]),(Gram.mk_action
                                                      ((fun (il : 'qualid) ->
                                                          fun
                                                            (_loc :
                                                              FanLoc.t ) ->
    ...
    Gram.extend (string :'string Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Stoken
           (((function
              | `ANTIQUOT ("",_) -> true
              | _ -> false)),(`Normal,"`ANTIQUOT (\"\",_)"))]),(Gram.mk_action
                                                                  ((fun
                                                                    __camlp4_0
                                                                    ->
                                                                    fun
  ...
  let _=
    ...
    Gram.extend (symbol :'symbol Gram.t  )
      (((fun () -> ((Some (`Level "top")),([(None,None,([(([`Stoken
           (((function
              | `UIDENT "FOLD1" -> true
              | _ -> false)),(`Normal,"`UIDENT \"FOLD1\""));`Snterm
           (Gram.obj (simple_expr :'simple_expr Gram.t  ));`Snterm
           (Gram.obj (simple_expr :'simple_expr Gram.t  ));`Sself;`Stoken
           (((function
              | `UIDENT "SEP" -> true
              | _ -> false)),(`Normal,"`UIDENT \"SEP\""));`Sself]),(Gram.mk_action
                                                                    ((fun
                                                                    (sep :
                                                                    'symbol)
                                                                    ->
           ...
           (((function
              | `UIDENT "FOLD0" -> true
              | _ -> false)),(`Normal,"`UIDENT \"FOLD0\""));`Snterm
           (Gram.obj (simple_expr :'simple_expr Gram.t  ));`Snterm
           (Gram.obj (simple_expr :'simple_expr Gram.t  ));`Sself;`Stoken
           (((function
              | `UIDENT "SEP" -> true
           ...
           (((function
              ...
              | _ -> false)),(`Normal,"`UIDENT \"FOLD1\""));`Snterm
           (Gram.obj (simple_expr :'simple_expr Gram.t  ));`Snterm
           (Gram.obj (simple_expr :'simple_expr Gram.t  ));`Sself]),(
           Gram.mk_action
             ((fun (s : 'symbol) ->
                 fun (e : 'simple_expr) ->
                   fun (f : 'simple_expr) ->
    ...
    Gram.extend (simple_expr :'simple_expr Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Skeyword "(";`Snterm
           (Gram.obj (expr :'expr Gram.t  ));`Skeyword
           ")"]),(Gram.mk_action
                    ((fun _ ->
                        fun (e : 'expr) ->
                          fun _ ->
                            fun (_loc : FanLoc.t ) -> (e :'simple_expr )))));(([`Snterm
           (Gram.obj (a_LIDENT :'a_LIDENT Gram.t  ))]),(Gram.mk_action
                                                          ((fun
                                                              (i : 'a_LIDENT)
                                                              ->
                                                              fun
...
module MakeListComprehension(Syntax:Sig.Camlp4Syntax) = struct
  ...
  let _=
    ...
    Gram.extend (expr :'expr Gram.t  )
      (((fun () -> ((Some (`Level "simple")),([(None,None,([(([`Skeyword
           ...
           (Gram.obj (comprehension_or_sem_expr_for_list
              :'comprehension_or_sem_expr_for_list Gram.t  ));`Skeyword
           "]"]),(Gram.mk_action
                    ((fun _ ->
    ...
    Gram.extend (comprehension_or_sem_expr_for_list
      ...
      (((fun () -> (None,([(None,None,([(([`Snterml
           ((Gram.obj (expr :'expr Gram.t  )),"top")]),(Gram.mk_action
                                                          ((fun (e : 'expr)
                                                              ->
                                                              fun
                                                                (_loc :
           ...
           ((Gram.obj (expr :'expr Gram.t  )),"top");`Skeyword "|";`Slist1sep
                          ...
                          fun _ ->
                            fun (e : 'expr) ->
                              fun (_loc : FanLoc.t ) -> (Expr.compr _loc e l
                                :'comprehension_or_sem_expr_for_list )))));(([`Snterml
                        ...
                        fun (e : 'expr) ->
                          fun (_loc : FanLoc.t ) ->
                            (Ast.ExApp
                               ...
                               Ast.ExId (_loc,(Ast.IdUid (_loc,"[]")))))
                            :'comprehension_or_sem_expr_for_list )))));(([`Snterml
           ((Gram.obj (expr :'expr Gram.t  )),"top");`Skeyword ";";`Snterm
           ...
           ((Gram.obj (expr :'expr Gram.t  )),"top")]),(Gram.mk_action
                                                          ((fun (e : 'expr)
                                                              ...
                                                              fun
                                                                ...
                                                                -> (`cond e
                                                                :'item )))));(([`Stry
           (Gram.srules item ([(([`Snterm
              (Gram.obj (patt :'patt Gram.t  ));`Skeyword
              "<-"]),(Gram.mk_action
                        ((fun _ ->
                            fun (p : 'patt) ->
                              fun (_loc : FanLoc.t ) -> (p :'e__5 )))))]));`Snterml
           ((Gram.obj (expr :'expr Gram.t  )),"top")]),(Gram.mk_action
                                                          ((fun (e : 'expr)
                                                              ->
                                                              fun (p : 'e__5)
...
module MakeMacroParser(Syntax:Sig.Camlp4Syntax) = struct
  ...
  let define eo x =
    (match eo with
     | Some ([],e) ->
         (Gram.extend (expr :'expr Gram.t  )
            (((fun () -> ((Some (`Level "simple")),([(None,None,([(([`Stoken
                 (((function
                    | `UIDENT __x when x = __x -> true
                    | _ -> false)),(`Antiquot,"`UIDENT __x"))]),(Gram.mk_action
                                                                   ((
                                                                   fun
                                                                    __camlp4_0
                                                                    ->
     ...
     | Some (sl,e) ->
         (Gram.extend (expr :'expr Gram.t  )
            (((fun () -> ((Some (`Level "apply")),([(None,None,([(([`Stoken
                 (((function
                    | `UIDENT __x when x = __x -> true
                    | _ -> false)),(`Antiquot,"`UIDENT __x"));`Sself]),(
                 Gram.mk_action
                   ((fun (param : 'expr) ->
                       fun __camlp4_0 ->
                         fun (_loc : FanLoc.t ) ->
  ...
  let undef x =
    try
      ...
      (match eo with
       | Some ([],_) ->
           (Gram.delete_rule expr ([`Stoken
              (((function
                 | `UIDENT __x when x = __x -> true
                 | _ -> false)),(`Antiquot,"`UIDENT __x"))]);
            Gram.delete_rule patt ([`Stoken
              (((function
                 | `UIDENT __x when x = __x -> true
                 | _ -> false)),(`Antiquot,"`UIDENT __x"))]))
       | Some (_,_) ->
  ...
  let parse_include_file rule =
    ...
    fun file ->
      let file =
        try
          (List.find (dir_ok file) (include_dirs.contents @ (["./"]))) ^ file
  ...
  let _=
    ...
    Gram.extend (str_item :'str_item Gram.t  )
      (((fun () -> ((Some `First),([(None,None,([(([`Snterm
           (Gram.obj (macro_def :'macro_def Gram.t  ))]),(Gram.mk_action
                                                            ((fun
                                                                (x :
                                                                  'macro_def)
                                                                ->
    ...
    Gram.extend (sig_item :'sig_item Gram.t  )
      (((fun () -> ((Some `First),([(None,None,([(([`Snterm
           (Gram.obj (macro_def_sig :'macro_def_sig Gram.t  ))]),(Gram.mk_action
                                                                    ((
                                                                    fun
                                                                    (x :
                                                                    'macro_def_sig)
    ...
    Gram.extend (macro_def :'macro_def Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Skeyword "INCLUDE";`Stoken
           (((function
              | `STRING (_,_) -> true
              | _ -> false)),(`Normal,"`STRING (_,_)"))]),(Gram.mk_action
                                                             ((fun __camlp4_0
                                                                 ...
                                                                 fun _ ->
                                                                   fun
                                                                    ...
                                                                    false))));(([`Skeyword
           "IFNDEF";`Snterm
           (Gram.obj (uident_eval_ifndef :'uident_eval_ifndef Gram.t  ));`Skeyword
           "THEN";`Snterm
           (Gram.obj (smlist_then :'smlist_then Gram.t  ));`Snterm
           (Gram.obj (else_macro_def :'else_macro_def Gram.t  ))]),(Gram.mk_action
                                                                    ((fun
                                                                    (st2 :
                                                                    'else_macro_def)
                                                                    ->
           ...
           "IFDEF";`Snterm
           (Gram.obj (uident_eval_ifdef :'uident_eval_ifdef Gram.t  ));`Skeyword
           "THEN";`Snterm
           (Gram.obj (smlist_then :'smlist_then Gram.t  ));`Snterm
           (Gram.obj (else_macro_def :'else_macro_def Gram.t  ))]),(Gram.mk_action
                                                                    ((fun
           ...
           "UNDEF";`Snterm
           (Gram.obj (uident :'uident Gram.t  ))]),(Gram.mk_action
                                                      ((fun (i : 'uident) ->
                                                          fun _ ->
                                                            fun
                                                              (_loc :
                                                              ...
                                                              (SdUnd i
                                                              :'macro_def )))));(([`Skeyword
           "DEFINE";`Snterm (Gram.obj (uident :'uident Gram.t  ));`Snterm
           (Gram.obj (opt_macro_value :'opt_macro_value Gram.t  ))]),(
           Gram.mk_action
    ...
    Gram.extend (macro_def_sig :'macro_def_sig Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Skeyword "INCLUDE";`Stoken
           ...
           (Gram.obj (uident_eval_ifndef :'uident_eval_ifndef Gram.t  ));`Skeyword
           "THEN";`Snterm
           (Gram.obj (sglist_then :'sglist_then Gram.t  ));`Snterm
                     ...
                     fun _ ->
                       fun _ ->
                         fun (_loc : FanLoc.t ) -> (make_SdITE_result sg1 sg2
                           :'macro_def_sig )))));(([`Skeyword "IFDEF";`Snterm
           (Gram.obj (uident_eval_ifdef :'uident_eval_ifdef Gram.t  ));`Skeyword
           "THEN";`Snterm
           (Gram.obj (sglist_then :'sglist_then Gram.t  ));`Snterm
           (Gram.obj (else_macro_def_sig :'else_macro_def_sig Gram.t  ))]),(
                 ...
                 fun (sg1 : 'sglist_then) ->
                   fun _ ->
                     fun _ ->
                       fun _ ->
                         fun (_loc : FanLoc.t ) -> (make_SdITE_result sg1 sg2
                           :'macro_def_sig )))));(([`Skeyword "UNDEF";`Snterm
           (Gram.obj (uident :'uident Gram.t  ))]),(Gram.mk_action
                                                      ((fun (i : 'uident) ->
                                                          fun _ ->
                                                            fun
    ...
    Gram.extend (else_macro_def :'else_macro_def Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Snterm
           (Gram.obj (endif :'endif Gram.t  ))]),(Gram.mk_action
                                                    ((fun _ ->
                                                        fun
                                                          (_loc : FanLoc.t )
                                                          -> ([]
                                                          :'else_macro_def )))));(([`Skeyword
           "ELSE";`Snterm
           (Gram.obj (smlist_else :'smlist_else Gram.t  ));`Snterm
           (Gram.obj (endif :'endif Gram.t  ))]),(Gram.mk_action
                                                    ((fun _ ->
                                                        fun
                                                          (st : 'smlist_else)
    ...
    Gram.extend (else_macro_def_sig :'else_macro_def_sig Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Snterm
           ...
           "ELSE";`Snterm
           (Gram.obj (sglist_else :'sglist_else Gram.t  ));`Snterm
           (Gram.obj (endif :'endif Gram.t  ))]),(Gram.mk_action
                                                    ((fun _ ->
                                                        fun
                                                          (st : 'sglist_else)
                                                        ...
                                                        fun
                                                          ...
                                                          (Ast.ExId
                                                             (_loc,(Ast.IdUid
                                                                    (_loc,"()")))
                                                          :'else_expr )))));(([`Skeyword
           "ELSE";`Snterm (Gram.obj (expr :'expr Gram.t  ));`Snterm
           (Gram.obj (endif :'endif Gram.t  ))]),(Gram.mk_action
                                                    ((fun _ ->
                                                        fun (e : 'expr) ->
                                                          fun _ ->
    ...
    Gram.extend (smlist_then :'smlist_then Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Slist1
           (Gram.srules smlist_then ([(([`Snterm
              (Gram.obj (str_item :'str_item Gram.t  ));`Snterm
              (Gram.obj (semi :'semi Gram.t  ))]),(Gram.mk_action
                                                     ((fun _ ->
                                                         fun (si : 'str_item)
                                                           ->
                                                           fun
                                                             ...
                                                             (SdStr si :
                                                             'e__6 )))));(([`Snterm
              (Gram.obj (macro_def :'macro_def Gram.t  ));`Snterm
              (Gram.obj (semi :'semi Gram.t  ))]),(Gram.mk_action
                                                     ((fun _ ->
                                                         fun (d : 'macro_def)
                                                           ->
    ...
    Gram.extend (smlist_else :'smlist_else Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Slist1
           (Gram.srules smlist_else ([(([`Snterm
              (Gram.obj (str_item :'str_item Gram.t  ));`Snterm
              (Gram.obj (semi :'semi Gram.t  ))]),(Gram.mk_action
                                                     ((fun _ ->
                                                         fun (si : 'str_item)
    ...
    Gram.extend (sglist_then :'sglist_then Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Slist1
           (Gram.srules sglist_then ([(([`Snterm
              (Gram.obj (sig_item :'sig_item Gram.t  ));`Snterm
              (Gram.obj (semi :'semi Gram.t  ))]),(Gram.mk_action
                                                     ((fun _ ->
                                                         fun (si : 'sig_item)
                                                           ->
                                                           fun
                                                             ...
                                                             (SdStr si :
                                                             'e__8 )))));(([`Snterm
              (Gram.obj (macro_def_sig :'macro_def_sig Gram.t  ));`Snterm
              (Gram.obj (semi :'semi Gram.t  ))]),(Gram.mk_action
                                                     ((fun _ ->
                                                         fun
                                                           (d :
    ...
    Gram.extend (sglist_else :'sglist_else Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Slist1
           (Gram.srules sglist_else ([(([`Snterm
              (Gram.obj (sig_item :'sig_item Gram.t  ));`Snterm
              (Gram.obj (semi :'semi Gram.t  ))]),(Gram.mk_action
                                                     ((fun _ ->
                                                         fun (si : 'sig_item)
    ...
    Gram.extend (endif :'endif Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Skeyword
           "ENDIF"]),(Gram.mk_action
                        ((fun _ -> fun (_loc : FanLoc.t ) -> (() :'endif )))));(([`Skeyword
           "END"]),(Gram.mk_action
                      ((fun _ -> fun (_loc : FanLoc.t ) -> (() :'endif )))))]))]))))
         ());
    Gram.extend (opt_macro_value :'opt_macro_value Gram.t  )
      (((fun () ->
           (None,([(None,None,([([],(Gram.mk_action
                                       ((fun (_loc : FanLoc.t ) -> (None
                                           :'opt_macro_value )))));(([`Skeyword
           "=";`Snterm
           (Gram.obj (expr :'expr Gram.t  ))]),(Gram.mk_action
                                                  ((fun (e : 'expr) ->
                                                      fun _ ->
                                                        fun
                                                          ...
                                                          :'opt_macro_value )))));(([`Skeyword
           "(";`Slist1sep
           ((Gram.srules opt_macro_value ([(([`Stoken
               (((function
                  | `LIDENT _ -> true
                  | _ -> false)),(`Normal,"`LIDENT _"))]),(Gram.mk_action
                                                             ((fun __camlp4_0
         ...
         ());
    Gram.extend (expr :'expr Gram.t  )
      (((fun () -> ((Some (`Level "top")),([(None,None,([(([`Skeyword
           "DEFINE";`Stoken
           (((function
              | `LIDENT _ -> true
              | _ -> false)),(`Normal,"`LIDENT _"));`Skeyword
           "=";`Sself;`Skeyword
           "IN";`Sself]),(Gram.mk_action
                            ((fun (body : 'expr) ->
                                fun _ ->
                                  fun (def : 'expr) ->
                                    fun _ ->
           ...
           "THEN";`Sself;`Snterm
           (Gram.obj (else_expr :'else_expr Gram.t  ))]),(Gram.mk_action
                                                            ((fun
                                                                (e2 :
                                                                  'else_expr)
                                                                ->
                                                                fun
                                                                  ...
                                                                  fun _ ->
                                                                    ...
                                                                    :'expr )))));(([`Skeyword
           "IFDEF";`Snterm (Gram.obj (uident :'uident Gram.t  ));`Skeyword
           "THEN";`Sself;`Snterm
           (Gram.obj (else_expr :'else_expr Gram.t  ))]),(Gram.mk_action
                                                            ((fun
                                                                (e2 :
         ...
         ());
    Gram.extend (patt :'patt Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Skeyword "IFNDEF";`Snterm
           (Gram.obj (uident :'uident Gram.t  ));`Skeyword
           "THEN";`Sself;`Skeyword "ELSE";`Sself;`Snterm
           (Gram.obj (endif :'endif Gram.t  ))]),(Gram.mk_action
                                                    ((fun _ ->
                                                        fun (p2 : 'patt) ->
                                                          fun _ ->
    ...
    Gram.extend (expr :'expr Gram.t  )
      (((fun () -> ((Some (`Before "simple")),([(None,None,([(([`Skeyword
           "`";`Snterm
           (Gram.obj (a_ident :'a_ident Gram.t  ))]),(Gram.mk_action
                                                        ((fun (s : 'a_ident)
                                                            ->
                                                            fun _ ->
                                                              fun
                                                                ...
                                                                (Ast.ExVrn
                                                                   (_loc,s)
                                                                :'expr )))));(([`Skeyword
           "`";Gram.srules expr ([(([`Skeyword
                 "IN"]),(Gram.mk_action
                           ((fun x ->
                               fun (_loc : FanLoc.t ) ->
                                 (Gram.string_of_token x :'e__11 )))));(([`Skeyword
                 "DEFINE"]),(Gram.mk_action
                               ((fun x ->
                                   fun (_loc : FanLoc.t ) ->
                                     (Gram.string_of_token x :'e__11 )))));(([`Skeyword
                 "ENDIF"]),(Gram.mk_action
                 ...
                 "THEN"]),(Gram.mk_action
                             ((fun x ->
                                 fun (_loc : FanLoc.t ) ->
                                   (Gram.string_of_token x :'e__11 )))));(([`Skeyword
                 "IFNDEF"]),(Gram.mk_action
                               ((fun x ->
                                   fun (_loc : FanLoc.t ) ->
                                     (Gram.string_of_token x :'e__11 )))));(([`Skeyword
                 "IFDEF"]),(Gram.mk_action
                              ((fun x ->
                                  fun (_loc : FanLoc.t ) ->
                                    (Gram.string_of_token x :'e__11 )))))])]),(
           Gram.mk_action
             ((fun (kwd : 'e__11) ->
                 fun _ ->
                                                            ...
                                                            fun _ ->
                                                              fun
                                                                ...
                                                                (Ast.PaVrn
                                                                   (_loc,s)
                                                                :'patt )))));(([`Skeyword
           "`";Gram.srules patt ([(([`Skeyword
                 "ENDIF"]),(Gram.mk_action
                              ((fun x ->
                                  fun (_loc : FanLoc.t ) ->
                                    (Gram.string_of_token x :'e__12 )))));(([`Skeyword
                 "END"]),(Gram.mk_action
                            ((fun x ->
                                fun (_loc : FanLoc.t ) ->
                                  (Gram.string_of_token x :'e__12 )))));(([`Skeyword
...
module MakeRevisedParser(Syntax:Sig.Camlp4Syntax) = struct
  ...
  let _=
    ...
    Gram.extend (module_expr :'module_expr Gram.t  )
      (((fun () -> (None,([((Some "top"),None,([(([`Skeyword "struct";`Snterm
           (Gram.obj (str_items :'str_items Gram.t  ));`Skeyword
           "end"]),(Gram.mk_action
                      ((fun _ ->
                          fun (st : 'str_items) ->
                            fun _ ->
           ...
           "functor";`Skeyword "(";`Snterm
           (Gram.obj (a_UIDENT :'a_UIDENT Gram.t  ));`Skeyword ":";`Snterm
           (Gram.obj (module_type :'module_type Gram.t  ));`Skeyword
           ")";`Skeyword
           "->";`Sself]),(Gram.mk_action
                            ((fun (me : 'module_expr) ->
                                fun _ ->
                                      ...
                                      fun _ ->
                                        fun (i : 'a_UIDENT) ->
                                          fun _ ->
                                            fun _ ->
                                              fun (_loc : FanLoc.t ) ->
                                                (Ast.MeFun (_loc,i,t,me)
                                                :'module_expr )))))]));((
           Some "apply"),None,([(([`Sself;`Sself]),(Gram.mk_action
                                                      ((fun
                                                          (me2 :
                                                            'module_expr) ->
                                                          fun
                                                            ...
                                                            fun
                                                              ...
                                                              (Ast.MeApp
                                                                 (_loc,me1,me2)
                                                              :'module_expr )))))]));((
           Some "simple"),None,([(([`Skeyword "(";`Skeyword "val";`Snterm
           (Gram.obj (expr :'expr Gram.t  ));`Skeyword ":";`Snterm
           (Gram.obj (package_type :'package_type Gram.t  ));`Skeyword
           ")"]),(Gram.mk_action
                    ((fun _ ->
                        fun (p : 'package_type) ->
                          fun _ ->
           ...
           ")"]),(Gram.mk_action
                    ((fun _ ->
                        fun (me : 'module_expr) ->
                          fun _ ->
                            fun (_loc : FanLoc.t ) -> (me :'module_expr )))));(([`Skeyword
           "(";`Sself;`Skeyword ":";`Snterm
           (Gram.obj (module_type :'module_type Gram.t  ));`Skeyword
           ")"]),(Gram.mk_action
                    ((fun _ ->
                        fun (mt : 'module_type) ->
                          fun _ ->
                            fun (me : 'module_expr) ->
                              fun _ ->
                                fun (_loc : FanLoc.t ) ->
                                  (Ast.MeTyc (_loc,me,mt) :'module_expr )))));(([`Snterm
           (Gram.obj (module_longident :'module_longident Gram.t  ))]),(
           Gram.mk_action
             ((fun (i : 'module_longident) ->
                 fun (_loc : FanLoc.t ) -> (Ast.MeId (_loc,i) :'module_expr )))));(([`Stoken
           (((function
              | `QUOTATION _ -> true
              | _ -> false)),(`Normal,"`QUOTATION _"))]),(Gram.mk_action
                                                            ((fun __camlp4_0
                                                                ->
                                                                fun
                                                                  (_loc :
           ...
           (((function
              ...
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"\"|\"mexp\"|\"anti\"|\"list\"),_)"))]),(
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun (_loc : FanLoc.t ) ->
                   match __camlp4_0 with
    ...
    Gram.extend (str_item :'str_item Gram.t  )
      (((fun () -> (None,([((Some "top"),None,([(([`Snterm
           ...
           (((function
              ...
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"\"|\"stri\"|\"anti\"|\"list\"),_)"))]),(
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun (_loc : FanLoc.t ) ->
                   match __camlp4_0 with
                   | `ANTIQUOT ((""|"stri"|"anti"|"list" as n),s) ->
                       ...
                       :'str_item )
                   | _ -> assert false))));(([`Skeyword "class";`Skeyword
           "type";`Snterm
           (Gram.obj (class_type_declaration :'class_type_declaration Gram.t 
              ))]),(Gram.mk_action
                      ((fun (ctd : 'class_type_declaration) ->
                          fun _ ->
                            fun _ ->
                              fun (_loc : FanLoc.t ) -> (Ast.StClt (_loc,ctd)
                                :'str_item )))));(([`Skeyword "class";`Snterm
           (Gram.obj (class_declaration :'class_declaration Gram.t  ))]),(
           Gram.mk_action
             ((fun (cd : 'class_declaration) ->
                 fun _ ->
                   fun (_loc : FanLoc.t ) -> (Ast.StCls (_loc,cd) :'str_item
                     )))));(([`Skeyword "let";`Skeyword "open";`Snterm
           (Gram.obj (module_longident :'module_longident Gram.t  ));`Skeyword
           "in";`Snterm
           (Gram.obj (expr :'expr Gram.t  ))]),(Gram.mk_action
                                                  ((fun (e : 'expr) ->
                                                      fun _ ->
                                                              ...
                                                              fun
                                                                ...
                                                                (Ast.StExp
                                                                   ...
                                                                   Ast.ExOpI
                                                                    (_loc,i,e)))
                                                                :'str_item )))));(([`Skeyword
           "let";`Skeyword "module";`Snterm
           (Gram.obj (a_UIDENT :'a_UIDENT Gram.t  ));`Snterm
           (Gram.obj (module_binding0 :'module_binding0 Gram.t  ));`Skeyword
           "in";`Snterm
           (Gram.obj (expr :'expr Gram.t  ))]),(Gram.mk_action
                                                  ((fun (e : 'expr) ->
                                                      fun _ ->
           ...
           "let";`Snterm (Gram.obj (opt_rec :'opt_rec Gram.t  ));`Snterm
           (Gram.obj (binding :'binding Gram.t  ))]),(Gram.mk_action
                                                        ((fun (bi : 'binding)
                                                            ->
                                                            fun
                                                              (r : 'opt_rec)
           ...
           "let";`Snterm (Gram.obj (opt_rec :'opt_rec Gram.t  ));`Snterm
           (Gram.obj (binding :'binding Gram.t  ));`Skeyword "in";`Snterm
           (Gram.obj (expr :'expr Gram.t  ))]),(Gram.mk_action
                                                  ((fun (x : 'expr) ->
                                                      fun _ ->
                                                        fun (bi : 'binding)
             ...
             ((fun (td : 'type_declaration) ->
                 fun _ ->
                   fun (_loc : FanLoc.t ) -> (Ast.StTyp (_loc,td) :'str_item
                     )))));(([`Skeyword "open";`Snterm
           (Gram.obj (module_longident :'module_longident Gram.t  ))]),(
           Gram.mk_action
             ((fun (i : 'module_longident) ->
                 fun _ ->
                   fun (_loc : FanLoc.t ) -> (Ast.StOpn (_loc,i) :'str_item )))));(([`Skeyword
           "module";`Skeyword "type";`Snterm
           (Gram.obj (a_ident :'a_ident Gram.t  ));`Skeyword "=";`Snterm
           (Gram.obj (module_type :'module_type Gram.t  ))]),(Gram.mk_action
                                                                ((fun
                                                                    (mt :
                                                                    'module_type)
                                                                    ->
           ...
           "module";`Skeyword "rec";`Snterm
           (Gram.obj (module_binding :'module_binding Gram.t  ))]),(Gram.mk_action
                                                                    ((fun
                                                                    (mb :
                                                                    'module_binding)
                                                                    ->
           ...
           "module";`Snterm (Gram.obj (a_UIDENT :'a_UIDENT Gram.t  ));`Snterm
           (Gram.obj (module_binding0 :'module_binding0 Gram.t  ))]),(
           Gram.mk_action
             ((fun (mb : 'module_binding0) ->
                 fun (i : 'a_UIDENT) ->
                   fun _ ->
                     fun (_loc : FanLoc.t ) -> (Ast.StMod (_loc,i,mb)
                       :'str_item )))));(([`Skeyword "include";`Snterm
           (Gram.obj (module_expr :'module_expr Gram.t  ))]),(Gram.mk_action
                                                                ((fun
                                                                    (me :
                                                                    'module_expr)
                                                                    ->
           ...
           "external";`Snterm
           (Gram.obj (a_LIDENT :'a_LIDENT Gram.t  ));`Skeyword ":";`Snterm
           (Gram.obj (ctyp :'ctyp Gram.t  ));`Skeyword "=";`Snterm
           (Gram.obj (string_list :'string_list Gram.t  ))]),(Gram.mk_action
                                                                ((fun
                                                                    (sl :
                                                                    'string_list)
                                                                    ->
           ...
           (Gram.obj (constructor_declaration
              :'constructor_declaration Gram.t  ));`Skeyword "=";`Snterm
           (Gram.obj (type_longident :'type_longident Gram.t  ))]),(Gram.mk_action
                                                                    ((fun
                                                                    (i :
                                                                    'type_longident)
                                                                    ->
           ...
           "exception";`Snterm
           (Gram.obj (constructor_declaration
              :'constructor_declaration Gram.t  ))]),(Gram.mk_action
                                                        ((fun
                                                            (t :
                                                              'constructor_declaration)
                                                            ->
    ...
    Gram.extend (module_binding0 :'module_binding0 Gram.t  )
      (((fun () -> (None,([(None,(Some `RA),([(([`Skeyword "=";`Snterm
           (Gram.obj (module_expr :'module_expr Gram.t  ))]),(Gram.mk_action
                                                                ((fun
                                                                    (me :
                                                                    'module_expr)
    ...
    Gram.extend (module_binding :'module_binding Gram.t  )
      (((fun () -> (None,([(None,(Some `LA),([(([`Snterm
           ...
           (((function
              | `ANTIQUOT ("",_) -> true
              | _ -> false)),(`Normal,"`ANTIQUOT (\"\",_)"));`Skeyword
           ":";`Snterm
           (Gram.obj (module_type :'module_type Gram.t  ));`Skeyword
           "=";`Snterm
           (Gram.obj (module_expr :'module_expr Gram.t  ))]),(Gram.mk_action
           ...
           (((function
              ...
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"module_binding\"|\"anti\"|\"list\"),_)"))]),(
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun (_loc : FanLoc.t ) ->
                   match __camlp4_0 with
                   | `ANTIQUOT (("module_binding"|"anti"|"list" as n),s) ->
                       ...
                       :'module_binding )
                   | _ -> assert false))));(([`Sself;`Skeyword
           "and";`Sself]),(Gram.mk_action
    ...
    Gram.extend (module_type :'module_type Gram.t  )
      (((fun () -> (None,([((Some "top"),None,([(([`Skeyword
           "functor";`Skeyword "(";`Snterm
           (Gram.obj (a_UIDENT :'a_UIDENT Gram.t  ));`Skeyword
           ":";`Sself;`Skeyword ")";`Skeyword
           "->";`Sself]),(Gram.mk_action
                            ((fun (mt : 'module_type) ->
                                fun _ ->
                                  fun _ ->
                                          ...
                                          fun _ ->
                                            fun _ ->
                                              fun (_loc : FanLoc.t ) ->
                                                ...
                                                :'module_type )))))]));((
           Some "with"),None,([(([`Sself;`Skeyword "with";`Snterm
           (Gram.obj (with_constr :'with_constr Gram.t  ))]),(Gram.mk_action
                                                                ((fun
                                                                    (wc :
                                                                    'with_constr)
                                                                    ->
           ...
           Some "apply"),None,([(([`Sself;`Sself;`Snterm
           (Gram.obj (dummy :'dummy Gram.t  ))]),(Gram.mk_action
                                                    ((fun _ ->
                                                        fun
                                                          (mt2 :
                                                            'module_type) ->
           ...
           Some "sig"),None,([(([`Skeyword "sig";`Snterm
           (Gram.obj (sig_items :'sig_items Gram.t  ));`Skeyword
           "end"]),(Gram.mk_action
                      ((fun _ ->
                          fun (sg : 'sig_items) ->
                            fun _ ->
                              fun (_loc : FanLoc.t ) -> (Ast.MtSig (_loc,sg)
                                :'module_type )))))]));((Some "simple"),None,([(([`Skeyword
           "module";`Skeyword "type";`Skeyword "of";`Snterm
           (Gram.obj (module_expr :'module_expr Gram.t  ))]),(Gram.mk_action
                                                                ((fun
                                                                    (me :
                                                                    'module_expr)
           ...
           ")"]),(Gram.mk_action
                    ((fun _ ->
                        fun (mt : 'module_type) ->
                          fun _ ->
                            fun (_loc : FanLoc.t ) -> (mt :'module_type )))));(([`Skeyword
           "'";`Snterm
           (Gram.obj (a_ident :'a_ident Gram.t  ))]),(Gram.mk_action
                                                        ((fun (i : 'a_ident)
                                                            ->
           ...
           (Gram.obj (module_longident_with_app
              :'module_longident_with_app Gram.t  ))]),(Gram.mk_action
                                                          ((fun
                                                              (i :
           ...
           (((function
              ...
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"\"|\"mtyp\"|\"anti\"|\"list\"),_)"))]),(
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun (_loc : FanLoc.t ) ->
                   match __camlp4_0 with
    ...
    Gram.extend (sig_item :'sig_item Gram.t  )
      (((fun () -> (None,([((Some "top"),None,([(([`Skeyword
                          ...
                          fun _ ->
                            fun _ ->
                              fun (_loc : FanLoc.t ) -> (Ast.SgClt (_loc,ctd)
                                :'sig_item )))));(([`Skeyword "class";`Snterm
           ...
           (Gram.obj (a_LIDENT :'a_LIDENT Gram.t  ));`Skeyword ":";`Snterm
           (Gram.obj (ctyp :'ctyp Gram.t  ))]),(Gram.mk_action
                                                  ((fun (t : 'ctyp) ->
                                                      fun _ ->
                                                        fun (i : 'a_LIDENT)
                                                          ->
           ...
           Gram.mk_action
             ((fun (t : 'type_declaration) ->
                 fun _ ->
                   fun (_loc : FanLoc.t ) -> (Ast.SgTyp (_loc,t) :'sig_item )))));(([`Skeyword
           "open";`Snterm
           (Gram.obj (module_longident :'module_longident Gram.t  ))]),(
           Gram.mk_action
             ((fun (i : 'module_longident) ->
                 fun _ ->
                   fun (_loc : FanLoc.t ) -> (Ast.SgOpn (_loc,i) :'sig_item )))));(([`Skeyword
           "module";`Skeyword "type";`Snterm
           (Gram.obj (a_ident :'a_ident Gram.t  ))]),(Gram.mk_action
                                                        ((fun (i : 'a_ident)
                                                            ->
           ...
           "module";`Skeyword "rec";`Snterm
           (Gram.obj (module_rec_declaration :'module_rec_declaration Gram.t 
              ))]),(Gram.mk_action
                      ((fun (mb : 'module_rec_declaration) ->
                          fun _ ->
                            fun _ ->
                              fun (_loc : FanLoc.t ) ->
                                (Ast.SgRecMod (_loc,mb) :'sig_item )))));(([`Skeyword
           "module";`Snterm (Gram.obj (a_UIDENT :'a_UIDENT Gram.t  ));`Snterm
                 ...
                 fun (i : 'a_UIDENT) ->
                   fun _ ->
                     fun (_loc : FanLoc.t ) -> (Ast.SgMod (_loc,i,mt)
                       :'sig_item )))));(([`Skeyword "include";`Snterm
           (Gram.obj (module_type :'module_type Gram.t  ))]),(Gram.mk_action
                                                                ((fun
                                                                    (mt :
                                                                    'module_type)
           ...
           (((function
              ...
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"\"|\"sigi\"|\"anti\"|\"list\"),_)"))]),(
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun (_loc : FanLoc.t ) ->
                   match __camlp4_0 with
    ...
    Gram.extend (with_constr :'with_constr Gram.t  )
      (((fun () -> (None,([(None,(Some `LA),([(([`Skeyword "module";`Snterm
           (Gram.obj (module_longident :'module_longident Gram.t  ));`Skeyword
           ":=";`Snterm
           (Gram.obj (module_longident_with_app
              :'module_longident_with_app Gram.t  ))]),(Gram.mk_action
                                                        ...
                                                        fun
                                                          ...
                                                          fun _ ->
                                                            fun
                                                              ...
                                                              (Ast.WcTyS
                                                                 (_loc,t1,t2)
                                                              :'with_constr )))));(([`Skeyword
           "type";`Stoken
           (((function
              | `ANTIQUOT ((""|"typ"|"anti"),_) -> true
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"\"|\"typ\"|\"anti\"),_)"));`Skeyword
           ":=";`Snterm
           (Gram.obj (ctyp :'ctyp Gram.t  ))]),(Gram.mk_action
                                                  ((fun (t : 'ctyp) ->
                                                      fun _ ->
           ...
           (((function
              ...
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"\"|\"with_constr\"|\"anti\"|\"list\"),_)"))]),(
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun (_loc : FanLoc.t ) ->
                   match __camlp4_0 with
                                 ...
                                 fun _ ->
                                   fun (wc1 : 'with_constr) ->
                                     fun (_loc : FanLoc.t ) ->
                                       ...
                                       :'with_constr )))))]))])))) ());
    Gram.extend (expr :'expr Gram.t  )
      (((fun () -> (None,([((Some "top"),(Some `RA),([(([`Skeyword
           "object";`Snterm
           (Gram.obj (opt_class_self_patt :'opt_class_self_patt Gram.t  ));`Snterm
           (Gram.obj (class_structure :'class_structure Gram.t  ));`Skeyword
           "end"]),(Gram.mk_action
                      ((fun _ ->
                          fun (cst : 'class_structure) ->
                            fun (csp : 'opt_class_self_patt) ->
                              fun _ ->
                                fun (_loc : FanLoc.t ) ->
                                  (Ast.ExObj (_loc,csp,cst) :'expr )))));(([`Skeyword
           "while";`Snterm
           (Gram.obj (sequence :'sequence Gram.t  ));`Skeyword "do";`Snterm
           (Gram.obj (do_sequence :'do_sequence Gram.t  ))]),(Gram.mk_action
                                                                ((fun
                                                                    (seq :
                                                                    'do_sequence)
                                                                    ->
                                                                    ...
                                                                    _loc e),seq)
                                                                    :'expr )))));(([`Skeyword
           "for";`Snterm (Gram.obj (a_LIDENT :'a_LIDENT Gram.t  ));`Skeyword
           "=";`Snterm (Gram.obj (sequence :'sequence Gram.t  ));`Snterm
           (Gram.obj (direction_flag :'direction_flag Gram.t  ));`Snterm
           (Gram.obj (sequence :'sequence Gram.t  ));`Skeyword "do";`Snterm
           (Gram.obj (do_sequence :'do_sequence Gram.t  ))]),(Gram.mk_action
                                                                ((fun
                                                                    (seq :
           ...
           (Gram.obj (do_sequence :'do_sequence Gram.t  ))]),(Gram.mk_action
                                                                ((fun
                                                                    ...
                                                                    _loc seq
                                                                    :'expr )))));(([`Skeyword
           "if";`Sself;`Skeyword "then";`Sself;`Skeyword
           "else";`Sself]),(Gram.mk_action
                              ((fun (e3 : 'expr) ->
                                  fun _ ->
                                    fun (e2 : 'expr) ->
                                      fun _ ->
                                        fun (e1 : 'expr) ->
                                          fun _ ->
                                            fun (_loc : FanLoc.t ) ->
                                              ...
                                              :'expr )))));(([`Skeyword
           "try";`Snterm (Gram.obj (sequence :'sequence Gram.t  ));`Skeyword
           "with";`Snterm
           (Gram.obj (match_case :'match_case Gram.t  ))]),(Gram.mk_action
                                                              ((fun
                                                                  (a :
                                                                    'match_case)
                                                                  ->
                                                                  fun _ ->
                                                                    ...
                                                                    :'expr )))));(([`Skeyword
           "match";`Snterm
           (Gram.obj (sequence :'sequence Gram.t  ));`Skeyword "with";`Snterm
           (Gram.obj (match_case :'match_case Gram.t  ))]),(Gram.mk_action
                                                              ((fun
                                                                  (a :
                                                                    'match_case)
                                                                  ...
                                                                  fun _ ->
                                                                    ...
                                                                    :'expr )))));(([`Skeyword
           "fun";`Snterm
           (Gram.obj (fun_def :'fun_def Gram.t  ))]),(Gram.mk_action
                                                        ((fun (e : 'fun_def)
                                                            ->
                                                            fun _ ->
                                                              fun
                                                                ...
                                                                -> (e :
                                                                'expr )))));(([`Skeyword
           "fun";`Skeyword "[";`Slist0sep ((`Snterm
           (Gram.obj (match_case0 :'match_case0 Gram.t  ))),(`Skeyword
           "|"));`Skeyword
           "]"]),(Gram.mk_action
                    ((fun _ ->
                                ...
                                fun _ ->
                                  fun (i : 'module_longident) ->
                                    fun _ ->
                                      fun _ ->
                                        fun (_loc : FanLoc.t ) ->
                                          (Ast.ExOpI (_loc,i,e) :'expr )))));(([`Skeyword
           "let";`Skeyword "module";`Snterm
           (Gram.obj (a_UIDENT :'a_UIDENT Gram.t  ));`Snterm
           (Gram.obj (module_binding0 :'module_binding0 Gram.t  ));`Skeyword
           "in";`Sself]),(Gram.mk_action
                                      ...
                                      fun _ ->
                                        fun _ ->
                                          fun (_loc : FanLoc.t ) ->
                                            ...
                                            'expr )))));(([`Skeyword
           "let";`Snterm (Gram.obj (opt_rec :'opt_rec Gram.t  ));`Snterm
           (Gram.obj (binding :'binding Gram.t  ));`Skeyword
           "in";`Sself]),(Gram.mk_action
                            ((fun (x : 'expr) ->
                                fun _ ->
                                  fun (bi : 'binding) ->
           ...
           Some "where"),None,([(([`Sself;`Skeyword "where";`Snterm
           (Gram.obj (opt_rec :'opt_rec Gram.t  ));`Snterm
           (Gram.obj (let_binding :'let_binding Gram.t  ))]),(Gram.mk_action
                                                                ((fun
                                                                    (lb :
                                                                    'let_binding)
                                                                    ->
                                                                    ...
                                                                    (_loc,rf,lb,e)
                                                                    :'expr )))))]));((
           Some ":="),(Some `NA),([(([`Sself;`Skeyword "<-";`Sself;`Snterm
           (Gram.obj (dummy :'dummy Gram.t  ))]),(Gram.mk_action
                                                    ((fun _ ->
                                                        fun (e2 : 'expr) ->
                                                          fun _ ->
                                                              ...
                                                              fun
                                                                ...
                                                                (Ast.ExAss
                                                                   ...
                                                                   Ast.ExAcc
                                                                    ...
                                                                    (_loc,"contents")))))),e2)
                                                                :'expr )))))]));((
           Some "||"),(Some `RA),([(([`Sself;`Snterm
           (Gram.obj (infixop6 :'infixop6 Gram.t  ));`Sself]),(Gram.mk_action
                                                                 ((fun
                                                                    (e2 :
                                                                    'expr) ->
                                                                    fun
                                                                    ...
                                                                    :'expr )))))]));((
           Some "&&"),(Some `RA),([(([`Sself;`Snterm
           (Gram.obj (infixop5 :'infixop5 Gram.t  ));`Sself]),(Gram.mk_action
                                                                 ((fun
                                                                    (e2 :
                                                                    'expr) ->
                                                                    fun
                                                                    ...
                                                                    (_loc,op,e1)),e2)
                                                                    :'expr )))))]));((
           Some "<"),(Some `LA),([(([`Sself;`Snterm
           (Gram.obj (infixop0 :'infixop0 Gram.t  ));`Sself]),(Gram.mk_action
                                                                 ((fun
                                                                    (e2 :
                                                                    'expr) ->
                                                                    fun
                                                                    ...
                                                                    :'expr )))))]));((
           Some "^"),(Some `RA),([(([`Sself;`Snterm
           (Gram.obj (infixop1 :'infixop1 Gram.t  ));`Sself]),(Gram.mk_action
                                                                 ((fun
                                                                    (e2 :
                                                                    'expr) ->
                                                                    fun
                                                                    ...
                                                                    :'expr )))))]));((
           Some "+"),(Some `LA),([(([`Sself;`Snterm
           (Gram.obj (infixop2 :'infixop2 Gram.t  ));`Sself]),(Gram.mk_action
                                                                 ((fun
                                                                    (e2 :
                                                                    'expr) ->
                                                                    fun
                                                                    ...
                                                                    :'expr )))))]));((
           Some "*"),(Some `LA),([(([`Sself;`Snterm
           (Gram.obj (infixop3 :'infixop3 Gram.t  ));`Sself]),(Gram.mk_action
                                                                 ((fun
                                                                    (e2 :
                                                                    'expr) ->
                                                                    fun
                                           ...
                                           (_loc,(Ast.ExApp
                                                    (_loc,(Ast.ExId
                                                             (_loc,(Ast.IdLid
                                                                    (_loc,"land")))),e1)),e2)
                                        :'expr )))))]));((Some "**"),(
           Some `RA),([(([`Sself;`Snterm
           (Gram.obj (infixop4 :'infixop4 Gram.t  ));`Sself]),(Gram.mk_action
                                                                 ((fun
                                                                    (e2 :
                                                                    'expr) ->
                                                                    fun
                                       ...
                                       (Ast.ExApp
                                          (_loc,(Ast.ExApp
                                                   (_loc,(Ast.ExId
                                                            (_loc,(Ast.IdLid
                                                                    (_loc,"asr")))),e1)),e2)
                                       :'expr )))))]));((Some "unary minus"),(
           Some `NA),([(([`Skeyword
           "-.";`Sself]),(Gram.mk_action
                            ((fun (e : 'expr) ->
                                fun _ ->
                                  fun (_loc : FanLoc.t ) ->
                                    (Expr.mkumin _loc "-." e :'expr )))));(([`Skeyword
           "-";`Sself]),(Gram.mk_action
                           ((fun (e : 'expr) ->
                               fun _ ->
                                 fun (_loc : FanLoc.t ) ->
                                   (Expr.mkumin _loc "-" e :'expr )))))]));((
           Some "apply"),(Some `LA),([(([`Skeyword
           "lazy";`Sself]),(Gram.mk_action
                              ((fun (e : 'expr) ->
                                  fun _ ->
                                    fun (_loc : FanLoc.t ) ->
                                      (Ast.ExLaz (_loc,e) :'expr )))));(([`Skeyword
           "new";`Snterm
           (Gram.obj (class_longident :'class_longident Gram.t  ))]),(
           Gram.mk_action
             ((fun (i : 'class_longident) ->
                 fun _ ->
                   fun (_loc : FanLoc.t ) -> (Ast.ExNew (_loc,i) :'expr )))));(([`Skeyword
           "assert";`Sself]),(Gram.mk_action
                                ((fun (e : 'expr) ->
                                    fun _ ->
                                      fun (_loc : FanLoc.t ) ->
                                        (Expr.mkassert _loc e :'expr )))));(([`Sself;`Sself]),(
           Gram.mk_action
             ((fun (e2 : 'expr) ->
                 fun (e1 : 'expr) ->
                   fun (_loc : FanLoc.t ) -> (Ast.ExApp (_loc,e1,e2) :'expr )))))]));((
           Some "label"),(Some `NA),([(([`Skeyword "?";`Snterm
           (Gram.obj (a_LIDENT :'a_LIDENT Gram.t  ))]),(Gram.mk_action
                                                          ((fun
                                                              (i : 'a_LIDENT)
                                                              ->
                           ...
                           ((fun (e : 'expr) ->
                               fun _ ->
                                 fun (i : 'a_LIDENT) ->
                                   fun _ ->
                                     fun (_loc : FanLoc.t ) ->
                                       (Ast.ExOlb (_loc,i,e) :'expr )))));(([`Stoken
           (((function
              | `OPTLABEL _ -> true
              | _ -> false)),(`Normal,"`OPTLABEL _"));`Sself]),(Gram.mk_action
                                                                  ((fun
                                                                    (e :
                                                                    'expr) ->
                                                                    fun
           ...
           (((function
              | `LABEL _ -> true
              | _ -> false)),(`Normal,"`LABEL _"));`Sself]),(Gram.mk_action
                                                               ((fun
                                                                   (e :
                                                                    'expr) ->
                                                                   fun
           ...
           Some "."),(Some `LA),([(([`Sself;`Skeyword "#";`Snterm
           (Gram.obj (label :'label Gram.t  ))]),(Gram.mk_action
                                                    ((fun (lab : 'label) ->
                                                        fun _ ->
                                                          fun (e : 'expr) ->
                                                            fun
           ...
           ".";`Sself]),(Gram.mk_action
                           ((fun (e2 : 'expr) ->
                               fun _ ->
                                 fun (e1 : 'expr) ->
                                   fun (_loc : FanLoc.t ) ->
                                     (Ast.ExAcc (_loc,e1,e2) :'expr )))));(([`Sself;`Skeyword
           ".";`Skeyword "{";`Snterm
           (Gram.obj (comma_expr :'comma_expr Gram.t  ));`Skeyword
           "}"]),(Gram.mk_action
                    ((fun _ ->
                        fun (e2 : 'comma_expr) ->
                          fun _ ->
                            fun _ ->
                              fun (e1 : 'expr) ->
                                fun (_loc : FanLoc.t ) ->
                                  (Expr.bigarray_get _loc e1 e2 :'expr )))));(([`Sself;`Skeyword
                        ...
                        fun (e2 : 'expr) ->
                          fun _ ->
                            fun _ ->
                              fun (e1 : 'expr) ->
                                fun (_loc : FanLoc.t ) ->
                                  (Ast.ExSte (_loc,e1,e2) :'expr )))));(([`Sself;`Skeyword
           ".";`Skeyword "(";`Sself;`Skeyword
           ")"]),(Gram.mk_action
                    ((fun _ ->
                        fun (e2 : 'expr) ->
           ...
           Some "~-"),(Some `NA),([(([`Snterm
           (Gram.obj (prefixop :'prefixop Gram.t  ));`Sself]),(Gram.mk_action
                                                                 ((fun
                                                                    (e :
                                                                    'expr) ->
                                                                    fun
           ...
           "(";`Skeyword "module";`Snterm
           (Gram.obj (module_expr :'module_expr Gram.t  ));`Skeyword
           ":";`Snterm
           (Gram.obj (package_type :'package_type Gram.t  ));`Skeyword
           ")"]),(Gram.mk_action
                    ((fun _ ->
                          ...
                          fun _ ->
                            fun _ ->
                              fun (_loc : FanLoc.t ) -> (Ast.ExPkg (_loc,me)
                                :'expr )))));(([`Skeyword "begin";`Skeyword
           "end"]),(Gram.mk_action
                      ((fun _ ->
                          fun _ ->
                            fun (_loc : FanLoc.t ) ->
                              (Ast.ExId (_loc,(Ast.IdUid (_loc,"()"))) :
                              'expr )))));(([`Skeyword "begin";`Snterm
           (Gram.obj (sequence :'sequence Gram.t  ));`Skeyword
           "end"]),(Gram.mk_action
                      ((fun _ ->
                          fun (seq : 'sequence) ->
                            fun _ ->
                              fun (_loc : FanLoc.t ) ->
                                (Expr.mksequence _loc seq :'expr )))));(([`Skeyword
           "(";`Sself;`Skeyword
           ")"]),(Gram.mk_action
                    ((fun _ ->
                        fun (e : 'expr) ->
                          fun _ -> fun (_loc : FanLoc.t ) -> (e :'expr )))));(([`Skeyword
           "(";`Sself;`Skeyword ":>";`Snterm
           (Gram.obj (ctyp :'ctyp Gram.t  ));`Skeyword
           ")"]),(Gram.mk_action
                    ((fun _ ->
                        fun (t : 'ctyp) ->
                          fun _ ->
                            ...
                            fun (t : 'ctyp) ->
                              fun _ ->
                                fun (e : 'expr) ->
                                  fun _ ->
                                    fun (_loc : FanLoc.t ) ->
                                      (Ast.ExCoe (_loc,e,t,t2) :'expr )))));(([`Skeyword
           "(";`Sself;`Skeyword ";";`Skeyword
           ")"]),(Gram.mk_action
                    ((fun _ ->
                        fun _ ->
                          fun (e : 'expr) ->
                            fun _ ->
                              fun (_loc : FanLoc.t ) ->
                                (Expr.mksequence _loc e :'expr )))));(([`Skeyword
           "(";`Sself;`Skeyword ";";`Snterm
           (Gram.obj (sequence :'sequence Gram.t  ));`Skeyword
           ")"]),(Gram.mk_action
                    ((fun _ ->
                        fun (seq : 'sequence) ->
                          fun _ ->
                            fun (e : 'expr) ->
                              fun _ ->
                                fun (_loc : FanLoc.t ) ->
                                  (Expr.mksequence _loc
                                     (Ast.ExSem (_loc,e,seq)) :'expr )))));(([`Skeyword
           "(";`Sself;`Skeyword ",";`Snterm
           (Gram.obj (comma_expr :'comma_expr Gram.t  ));`Skeyword
           ")"]),(Gram.mk_action
                    ((fun _ ->
                        ...
                        fun (t : 'ctyp) ->
                          fun _ ->
                            fun (e : 'expr) ->
                              fun _ ->
                                fun (_loc : FanLoc.t ) ->
                                  (Ast.ExTyc (_loc,e,t) :'expr )))));(([`Skeyword
           "(";`Skeyword
           ")"]),(Gram.mk_action
                    ((fun _ ->
                        fun _ ->
                          fun (_loc : FanLoc.t ) ->
                            (Ast.ExId (_loc,(Ast.IdUid (_loc,"()"))) :
                            'expr )))));(([`Skeyword "{<";`Snterm
           (Gram.obj (field_expr_list :'field_expr_list Gram.t  ));`Skeyword
           ">}"]),(Gram.mk_action
                     ((fun _ ->
                         fun (fel : 'field_expr_list) ->
                           fun _ ->
                             fun (_loc : FanLoc.t ) -> (Ast.ExOvr (_loc,fel)
                               :'expr )))));(([`Skeyword "{<";`Skeyword
           ">}"]),(Gram.mk_action
                     ((fun _ ->
                         fun _ ->
                           fun (_loc : FanLoc.t ) ->
                             (Ast.ExOvr (_loc,(Ast.RbNil _loc)) :'expr )))));(([`Skeyword
           "{";`Skeyword "(";`Sself;`Skeyword ")";`Skeyword "with";`Snterm
           (Gram.obj (label_expr_list :'label_expr_list Gram.t  ));`Skeyword
           "}"]),(Gram.mk_action
                    ((fun _ ->
                            ...
                            fun _ ->
                              fun (e : 'expr) ->
                                fun _ ->
                                  fun _ ->
                                    fun (_loc : FanLoc.t ) ->
                                      (Ast.ExRec (_loc,el,e) :'expr )))));(([`Skeyword
           "{";`Snterm
           (Gram.obj (label_expr_list :'label_expr_list Gram.t  ));`Skeyword
           "}"]),(Gram.mk_action
                    ((fun _ ->
                        fun (el : 'label_expr_list) ->
                          fun _ ->
                            fun (_loc : FanLoc.t ) ->
                              ...
                              'expr )))));(([`Skeyword "[|";`Snterm
           (Gram.obj (sem_expr :'sem_expr Gram.t  ));`Skeyword
           "|]"]),(Gram.mk_action
                     ((fun _ ->
                         fun (el : 'sem_expr) ->
                           fun _ ->
                             fun (_loc : FanLoc.t ) -> (Ast.ExArr (_loc,el)
                               :'expr )))));(([`Skeyword "[|";`Skeyword
           "|]"]),(Gram.mk_action
                     ((fun _ ->
                         fun _ ->
                           fun (_loc : FanLoc.t ) ->
                             (Ast.ExArr (_loc,(Ast.ExNil _loc)) :'expr )))));(([`Skeyword
           "[";`Snterm
           (Gram.obj (sem_expr_for_list :'sem_expr_for_list Gram.t  ));`Skeyword
           "]"]),(Gram.mk_action
                    ((fun _ ->
                    ...
                    ((fun _ ->
                        fun (last : 'expr) ->
                          fun _ ->
                            fun (mk_list : 'sem_expr_for_list) ->
                              fun _ ->
                                fun (_loc : FanLoc.t ) -> (mk_list last
                                  :'expr )))));(([`Skeyword "[";`Skeyword
           "]"]),(Gram.mk_action
                    ((fun _ ->
                        fun _ ->
                                                        ...
                                                        ((fun (s : 'a_ident)
                                                            ...
                                                            fun _ ->
                                                              fun
                                                                ...
                                                                :'expr )))));(([`Stry
           (`Snterm
           (Gram.obj (val_longident :'val_longident Gram.t  )))]),(Gram.mk_action
                                                                    ((
                                                                    fun
                                                                    (i :
                                                                    'val_longident)
           ...
           (Gram.obj (module_longident_dot_lparen
              :'module_longident_dot_lparen Gram.t  )));`Snterm
           (Gram.obj (sequence :'sequence Gram.t  ));`Skeyword
           ")"]),(Gram.mk_action
                    ((fun _ ->
                        fun (e : 'sequence) ->
                          fun (i : 'module_longident_dot_lparen) ->
                            fun (_loc : FanLoc.t ) -> (Ast.ExOpI (_loc,i,e)
                              :'expr )))));(([`Snterm
           (Gram.obj (a_CHAR :'a_CHAR Gram.t  ))]),(Gram.mk_action
                                                      ((fun (s : 'a_CHAR) ->
                                                          fun
                                                            (_loc :
                                                              FanLoc.t ) ->
                                                            (Ast.ExChr
                                                               (_loc,s)
                                                            :'expr )))));(([`Snterm
           (Gram.obj (a_STRING :'a_STRING Gram.t  ))]),(Gram.mk_action
                                                          ((fun
                                                              (s : 'a_STRING)
                                                              ->
                                                              fun
                                                                ...
                                                                (Ast.ExStr
                                                                   (_loc,s)
                                                                :'expr )))));(([`Snterm
           (Gram.obj (a_FLOAT :'a_FLOAT Gram.t  ))]),(Gram.mk_action
                                                        ((fun (s : 'a_FLOAT)
                                                            ->
                                                            fun
                                                              (_loc :
                                                              ...
                                                              (Ast.ExFlo
                                                                 (_loc,s)
                                                              :'expr )))));(([`Snterm
           (Gram.obj (a_NATIVEINT :'a_NATIVEINT Gram.t  ))]),(Gram.mk_action
                                                                ((fun
                                                                    (s :
                                                                    'a_NATIVEINT)
                                                                    ->
                                                                    ...
                                                                    (_loc,s)
                                                                    :'expr )))));(([`Snterm
           (Gram.obj (a_INT64 :'a_INT64 Gram.t  ))]),(Gram.mk_action
                                                        ((fun (s : 'a_INT64)
                                                            ->
                                                            fun
                                                              (_loc :
                                                              ...
                                                              (Ast.ExInt64
                                                                 (_loc,s)
                                                              :'expr )))));(([`Snterm
           (Gram.obj (a_INT32 :'a_INT32 Gram.t  ))]),(Gram.mk_action
                                                        ((fun (s : 'a_INT32)
                                                            ->
                                                            fun
                                                              (_loc :
                                                              ...
                                                              (Ast.ExInt32
                                                                 (_loc,s)
                                                              :'expr )))));(([`Snterm
           (Gram.obj (a_INT :'a_INT Gram.t  ))]),(Gram.mk_action
                                                    ((fun (s : 'a_INT) ->
                                                        fun
                                                          (_loc : FanLoc.t )
                                                          ->
           ...
           (((function
              | `ANTIQUOT ("seq",_) -> true
              | _ -> false)),(`Normal,"`ANTIQUOT (\"seq\",_)"))]),(Gram.mk_action
                                                                    ((
                                                                    fun
                                                                    __camlp4_0
                                                                    ->
           ...
           (((function
              | `ANTIQUOT ("tup",_) -> true
              | _ -> false)),(`Normal,"`ANTIQUOT (\"tup\",_)"))]),(Gram.mk_action
                                                                    ((
                                                                    fun
                                                                    __camlp4_0
                                                                    ->
           ...
           (((function
              ...
              | _ -> false)),(`Normal,"`ANTIQUOT (\"`bool\",_)"))]),(
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun (_loc : FanLoc.t ) ->
                   match __camlp4_0 with
           ...
           (((function
              ...
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"exp\"|\"\"|\"anti\"),_)"))]),(
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun (_loc : FanLoc.t ) ->
                   match __camlp4_0 with
    ...
    Gram.extend (do_sequence :'do_sequence Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Skeyword
           "done"]),(Gram.mk_action
                       ((fun _ ->
                           fun (_loc : FanLoc.t ) ->
                             (Ast.ExId (_loc,(Ast.IdUid (_loc,"()")))
                             :'do_sequence )))));(([`Stry
           (Gram.srules do_sequence ([(([`Snterm
              (Gram.obj (sequence :'sequence Gram.t  ));`Skeyword
              "done"]),(Gram.mk_action
                          ((fun _ ->
                              fun (seq : 'sequence) ->
           ...
           Gram.mk_action
             ((fun (seq : 'e__15) ->
                 fun (_loc : FanLoc.t ) -> (seq :'do_sequence )))));(([`Stry
           ...
           Gram.mk_action
             ((fun _ ->
                 fun (_loc : FanLoc.t ) ->
                   (Ast.ExId (_loc,(Ast.IdUid (_loc,"()"))) :'do_sequence )))));(([`Stry
           (Gram.srules do_sequence ([(([`Skeyword "{";`Snterm
              (Gram.obj (sequence :'sequence Gram.t  ));`Skeyword
              "}"]),(Gram.mk_action
                       ((fun _ ->
                           fun (seq : 'sequence) ->
                             fun _ ->
                               fun (_loc : FanLoc.t ) -> (seq :'e__13 )))))]))]),(
           Gram.mk_action
             ((fun (seq : 'e__13) ->
    ...
    Gram.extend (infixop5 :'infixop5 Gram.t  )
      (((fun () ->
           (None,([(None,None,([(([Gram.srules infixop5 ([(([`Skeyword
                                     "&&"]),(Gram.mk_action
                                               ((fun x ->
                                                   fun (_loc : FanLoc.t ) ->
    ...
    Gram.extend (infixop6 :'infixop6 Gram.t  )
      (((fun () ->
           (None,([(None,None,([(([Gram.srules infixop6 ([(([`Skeyword
                                     "||"]),(Gram.mk_action
                                               ((fun x ->
                                                   fun (_loc : FanLoc.t ) ->
                                                     (Gram.string_of_token x
    ...
    Gram.extend (comma_expr :'comma_expr Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Snterml
           ...
           (((function
              ...
              | _ -> false)),(`Normal,"`ANTIQUOT (\"list\",_)"))]),(Gram.mk_action
                                                                    ((fun
                                                                    __camlp4_0
                                                                    ->
                                                                    fun
    ...
    Gram.extend (sequence' :'sequence' Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Skeyword ";";`Snterm
           (Gram.obj (sequence :'sequence Gram.t  ))]),(Gram.mk_action
                                                          ((fun
                                                              (el :
                                                                'sequence) ->
                                                              fun _ ->
                                ...
                                fun _ ->
                                  fun (i : 'module_longident) ->
                                    fun _ ->
                                      fun _ ->
                                        fun (_loc : FanLoc.t ) ->
                                          (Ast.ExOpI (_loc,i,e) :'sequence )))));(([`Skeyword
           "let";`Skeyword "module";`Snterm
           (Gram.obj (a_UIDENT :'a_UIDENT Gram.t  ));`Snterm
           (Gram.obj (module_binding0 :'module_binding0 Gram.t  ));`Skeyword
           ";";`Sself]),(Gram.mk_action
                                   ...
                                   fun (m : 'a_UIDENT) ->
                                     fun _ ->
                                       fun _ ->
                                         fun (_loc : FanLoc.t ) ->
                                           (Ast.ExLmd
                                              (_loc,m,mb,(Expr.mksequence
                                                            _loc el))
                                           :'sequence )))));(([`Skeyword
           "let";`Skeyword "module";`Snterm
           (Gram.obj (a_UIDENT :'a_UIDENT Gram.t  ));`Snterm
           (Gram.obj (module_binding0 :'module_binding0 Gram.t  ));`Skeyword
           "in";`Snterm (Gram.obj (expr :'expr Gram.t  ));`Snterm
           (Gram.obj (sequence' :'sequence' Gram.t  ))]),(Gram.mk_action
                                                            ((fun
                                                                (k :
                                                                  'sequence')
                                 ...
                                 fun (bi : 'binding) ->
                                   fun (rf : 'opt_rec) ->
                                     fun _ ->
                                       fun (_loc : FanLoc.t ) ->
                                         (Ast.ExLet
                                            (_loc,rf,bi,(Expr.mksequence _loc
                                                           el)) :'sequence )))));(([`Skeyword
           "let";`Snterm (Gram.obj (opt_rec :'opt_rec Gram.t  ));`Snterm
           (Gram.obj (binding :'binding Gram.t  ));`Skeyword "in";`Snterm
           (Gram.obj (expr :'expr Gram.t  ));`Snterm
           (Gram.obj (sequence' :'sequence' Gram.t  ))]),(Gram.mk_action
    ...
    Gram.extend (binding :'binding Gram.t  )
      (((fun () -> (None,([(None,(Some `LA),([(([`Snterm
           ...
           "and";`Sself]),(Gram.mk_action
                             ((fun (b2 : 'binding) ->
                                 fun _ ->
                                   fun (b1 : 'binding) ->
                                     fun (_loc : FanLoc.t ) ->
                                       (Ast.BiAnd (_loc,b1,b2) :'binding )))));(([`Stoken
           (((function
              | `ANTIQUOT ((""|"anti"),_) -> true
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"\"|\"anti\"),_)"))]),(
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun (_loc : FanLoc.t ) ->
                   match __camlp4_0 with
           ...
           (((function
              | `ANTIQUOT ((""|"anti"),_) -> true
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"\"|\"anti\"),_)"));`Skeyword
           "=";`Snterm
           (Gram.obj (expr :'expr Gram.t  ))]),(Gram.mk_action
                                                  ((fun (e : 'expr) ->
                                                      fun _ ->
           ...
           (((function
              ...
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"binding\"|\"list\"),_)"))]),(
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun (_loc : FanLoc.t ) ->
                   match __camlp4_0 with
    ...
    Gram.extend (let_binding :'let_binding Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Snterm
           (Gram.obj (ipatt :'ipatt Gram.t  ));`Snterm
           (Gram.obj (fun_binding :'fun_binding Gram.t  ))]),(Gram.mk_action
                                                                ((fun
                                                                    (e :
                                                                    'fun_binding)
                                                                    ->
    ...
    Gram.extend (fun_binding :'fun_binding Gram.t  )
      (((fun () -> (None,([(None,(Some `RA),([(([`Snterm
           (Gram.obj (cvalue_binding :'cvalue_binding Gram.t  ))]),(Gram.mk_action
                                                                    ((fun
                                                                    (bi :
                                                                    'cvalue_binding)
                                                                    ->
           ...
           (`Snterm
           (Gram.obj (labeled_ipatt :'labeled_ipatt Gram.t  )));`Sself]),(
           Gram.mk_action
             ((fun (e : 'fun_binding) ->
                 fun (p : 'labeled_ipatt) ->
                   fun (_loc : FanLoc.t ) ->
                     ...
                     :'fun_binding )))));(([`Stry
           (Gram.srules fun_binding ([(([`Skeyword "(";`Skeyword
              "type"]),(Gram.mk_action
                          ((fun _ ->
                              fun _ ->
                                fun (_loc : FanLoc.t ) -> (() :'e__18 )))))]));`Snterm
           (Gram.obj (a_LIDENT :'a_LIDENT Gram.t  ));`Skeyword
           ")";`Sself]),(Gram.mk_action
                           ((fun (e : 'fun_binding) ->
                               fun _ ->
                                 fun (i : 'a_LIDENT) ->
    ...
    Gram.extend (match_case :'match_case Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Snterm
           (Gram.obj (ipatt :'ipatt Gram.t  ));`Skeyword "->";`Snterm
           (Gram.obj (expr :'expr Gram.t  ))]),(Gram.mk_action
                                                  ((fun (e : 'expr) ->
                                                      fun _ ->
                                                        fun (p : 'ipatt) ->
    ...
    Gram.extend (match_case0 :'match_case0 Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Snterm
           (Gram.obj (patt_as_patt_opt :'patt_as_patt_opt Gram.t  ));`Snterm
           (Gram.obj (opt_when_expr :'opt_when_expr Gram.t  ));`Skeyword
           "->";`Snterm
           (Gram.obj (expr :'expr Gram.t  ))]),(Gram.mk_action
                                                  ((fun (e : 'expr) ->
                                                      fun _ ->
           ...
           (((function
              | `ANTIQUOT ((""|"anti"),_) -> true
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"\"|\"anti\"),_)"));`Skeyword
           "when";`Snterm (Gram.obj (expr :'expr Gram.t  ));`Skeyword
           "->";`Snterm
           (Gram.obj (expr :'expr Gram.t  ))]),(Gram.mk_action
                                                  ((fun (e : 'expr) ->
                                                      fun _ ->
           ...
           (((function
              ...
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"match_case\"|\"list\"),_)"))]),(
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun (_loc : FanLoc.t ) ->
                   match __camlp4_0 with
    ...
    Gram.extend (opt_when_expr :'opt_when_expr Gram.t  )
      (((fun () ->
           (None,([(None,None,([([],(Gram.mk_action
                                       ((fun (_loc : FanLoc.t ) ->
                                           (Ast.ExNil _loc :'opt_when_expr )))));(([`Skeyword
           "when";`Snterm
           (Gram.obj (expr :'expr Gram.t  ))]),(Gram.mk_action
                                                  ((fun (w : 'expr) ->
                                                      fun _ ->
      ...
      (((fun () -> (None,([(None,None,([(([`Snterm
           (Gram.obj (patt :'patt Gram.t  ))]),(Gram.mk_action
                                                  ((fun (p : 'patt) ->
                                                      fun (_loc : FanLoc.t )
                                                        -> (p
                                                        :'patt_as_patt_opt )))));(([`Snterm
           (Gram.obj (patt :'patt Gram.t  ));`Skeyword "as";`Snterm
           (Gram.obj (patt :'patt Gram.t  ))]),(Gram.mk_action
                                                  ((fun (p2 : 'patt) ->
                                                      fun _ ->
                                                        fun (p1 : 'patt) ->
    ...
    Gram.extend (label_expr_list :'label_expr_list Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Snterm
           (Gram.obj (label_expr :'label_expr Gram.t  ))]),(Gram.mk_action
                                                              ((fun
                                                                  (b1 :
                                                                    'label_expr)
                                                                  ->
           ...
           (Gram.obj (label_expr :'label_expr Gram.t  ));`Skeyword
           ";"]),(Gram.mk_action
                    ((fun _ ->
                        fun (b1 : 'label_expr) ->
                          fun (_loc : FanLoc.t ) -> (b1 :'label_expr_list )))));(([`Snterm
           (Gram.obj (label_expr :'label_expr Gram.t  ));`Skeyword
           ";";`Sself]),(Gram.mk_action
    ...
    Gram.extend (label_expr :'label_expr Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Snterm
           ...
           Gram.mk_action
             ((fun (i : 'label_longident) ->
                 fun (_loc : FanLoc.t ) ->
                   ...
                   :'label_expr )))));(([`Snterm
           (Gram.obj (label_longident :'label_longident Gram.t  ));`Snterm
           (Gram.obj (fun_binding :'fun_binding Gram.t  ))]),(Gram.mk_action
                                                                ((fun
                                                                    (e :
                                                                    'fun_binding)
           ...
           (((function
              ...
              | _ -> false)),(`Normal,"`ANTIQUOT (\"rec_binding\",_)"))]),(
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun (_loc : FanLoc.t ) ->
                   match __camlp4_0 with
    ...
    Gram.extend (fun_def :'fun_def Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Stry (`Snterm
           (Gram.obj (labeled_ipatt :'labeled_ipatt Gram.t  )));`Snterm
           (Gram.obj (fun_def_cont :'fun_def_cont Gram.t  ))]),(Gram.mk_action
                                                                  ((fun
                                                                    ((w,e) :
                                                                    'fun_def_cont)
                                                                    ->
           ...
           (Gram.srules fun_def ([(([`Skeyword "(";`Skeyword
              "type"]),(Gram.mk_action
                          ((fun _ ->
                              fun _ ->
                                fun (_loc : FanLoc.t ) -> (() :'e__19 )))))]));`Snterm
           (Gram.obj (a_LIDENT :'a_LIDENT Gram.t  ));`Skeyword ")";`Snterm
      ...
      (((fun () -> (None,([(None,(Some `RA),([(([`Skeyword "->";`Snterm
           ...
           Gram.mk_action
             ((fun ((w,e) : 'fun_def_cont) ->
                 fun (p : 'labeled_ipatt) ->
                   fun (_loc : FanLoc.t ) ->
                     (((Ast.ExNil _loc),(Ast.ExFun
                                           (_loc,(Ast.McArr (_loc,p,w,e)))))
                     :'fun_def_cont )))));(([`Stry
           (Gram.srules fun_def_cont ([(([`Skeyword "(";`Skeyword
              "type"]),(Gram.mk_action
                          ((fun _ ->
                              fun _ ->
                                fun (_loc : FanLoc.t ) -> (() :'e__20 )))))]));`Snterm
           (Gram.obj (a_LIDENT :'a_LIDENT Gram.t  ));`Skeyword ")";`Snterm
           (Gram.obj (fun_def_cont_no_when :'fun_def_cont_no_when Gram.t  ))]),(
           Gram.mk_action
             ((fun (e : 'fun_def_cont_no_when) ->
    ...
    Gram.extend (fun_def_cont_no_when :'fun_def_cont_no_when Gram.t  )
      (((fun () -> (None,([(None,(Some `RA),([(([`Skeyword "->";`Snterm
           ...
           (Gram.srules fun_def_cont_no_when ([(([`Skeyword "(";`Skeyword
              "type"]),(Gram.mk_action
                          ((fun _ ->
                              fun _ ->
                                fun (_loc : FanLoc.t ) -> (() :'e__21 )))))]));`Snterm
           (Gram.obj (a_LIDENT :'a_LIDENT Gram.t  ));`Skeyword
           ")";`Sself]),(Gram.mk_action
                           ((fun (e : 'fun_def_cont_no_when) ->
                               fun _ ->
      ...
      (((fun () -> (None,([((Some "|"),(Some `LA),([(([`Sself;`Skeyword
           ...
           "lazy";`Sself]),(Gram.mk_action
                              ((fun (p : 'patt) ->
                                  fun _ ->
                                    fun (_loc : FanLoc.t ) ->
                                      (Ast.PaLaz (_loc,p) :'patt )))));(([`Sself;`Sself]),(
           Gram.mk_action
             ((fun (p2 : 'patt) ->
                 fun (p1 : 'patt) ->
                   fun (_loc : FanLoc.t ) -> (Ast.PaApp (_loc,p1,p2) :'patt )))))]));((
           Some "simple"),None,([(([`Skeyword "?";`Skeyword "(";`Snterm
           (Gram.obj (patt_tcon :'patt_tcon Gram.t  ));`Skeyword "=";`Snterm
           (Gram.obj (expr :'expr Gram.t  ));`Skeyword
           ")"]),(Gram.mk_action
                    ((fun _ ->
                        fun (e : 'expr) ->
                          fun _ ->
                            fun (p : 'patt_tcon) ->
                              fun _ ->
                                fun _ ->
                                  fun (_loc : FanLoc.t ) ->
                                    (Ast.PaOlbi (_loc,"",p,e) :'patt )))));(([`Skeyword
           "?";`Skeyword "(";`Snterm
           (Gram.obj (patt_tcon :'patt_tcon Gram.t  ));`Skeyword
           ")"]),(Gram.mk_action
                    ((fun _ ->
                        fun (p : 'patt_tcon) ->
                          fun _ ->
                            fun _ ->
                              fun (_loc : FanLoc.t ) ->
                                (Ast.PaOlb (_loc,"",p) :'patt )))));(([`Skeyword
           "?";`Stoken
           (((function
              | `ANTIQUOT ((""|"lid"),_) -> true
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"\"|\"lid\"),_)"))]),(
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun _ ->
                   fun (_loc : FanLoc.t ) ->
                     ...
                     | `ANTIQUOT ((""|"lid" as n),i) ->
                         ...
                         :'patt )
                     | _ -> assert false))));(([`Skeyword "?";`Stoken
           (((function
              | `LIDENT _ -> true
              | _ -> false)),(`Normal,"`LIDENT _"))]),(Gram.mk_action
                                                         ((fun __camlp4_0 ->
           ...
           (((function
              | `ANTIQUOT ((""|"lid"),_) -> true
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"\"|\"lid\"),_)"));`Skeyword
           ":";`Skeyword "(";`Snterm
           (Gram.obj (patt_tcon :'patt_tcon Gram.t  ));`Snterm
           (Gram.obj (eq_expr :'eq_expr Gram.t  ));`Skeyword
           ")"]),(Gram.mk_action
                    ((fun _ ->
                        fun (f : 'eq_expr) ->
                          fun (p : 'patt_tcon) ->
           ...
           (((function
              | `OPTLABEL _ -> true
              | _ -> false)),(`Normal,"`OPTLABEL _"));`Skeyword "(";`Snterm
           (Gram.obj (patt_tcon :'patt_tcon Gram.t  ));`Snterm
           (Gram.obj (eq_expr :'eq_expr Gram.t  ));`Skeyword
           ")"]),(Gram.mk_action
                    ((fun _ ->
           ...
           "_"]),(Gram.mk_action
                    ((fun _ ->
                        fun (_loc : FanLoc.t ) -> (Ast.PaAny _loc :'patt )))));(([`Skeyword
           "(";`Sself;`Skeyword ",";`Snterm
           (Gram.obj (comma_patt :'comma_patt Gram.t  ));`Skeyword
           ")"]),(Gram.mk_action
                    ((fun _ ->
                            ...
                            fun (p : 'patt) ->
                              fun _ ->
                                fun (_loc : FanLoc.t ) ->
                                  ...
                                  :'patt )))));(([`Skeyword
           "(";`Sself;`Skeyword "as";`Sself;`Skeyword
           ")"]),(Gram.mk_action
                    ((fun _ ->
                        fun (p2 : 'patt) ->
                          fun _ ->
                            fun (p : 'patt) ->
                              fun _ ->
                                fun (_loc : FanLoc.t ) ->
                                  (Ast.PaAli (_loc,p,p2) :'patt )))));(([`Skeyword
           "(";`Sself;`Skeyword ":";`Snterm
           (Gram.obj (ctyp :'ctyp Gram.t  ));`Skeyword
           ")"]),(Gram.mk_action
                    ((fun _ ->
                        fun (t : 'ctyp) ->
                          fun _ ->
                            fun (p : 'patt) ->
                              fun _ ->
                                fun (_loc : FanLoc.t ) ->
                                  (Ast.PaTyc (_loc,p,t) :'patt )))));(([`Skeyword
           "(";`Sself;`Skeyword
           ")"]),(Gram.mk_action
                    ((fun _ ->
                        fun (p : 'patt) ->
                          fun _ -> fun (_loc : FanLoc.t ) -> (p :'patt )))));(([`Skeyword
           "(";`Skeyword "module";`Snterm
           (Gram.obj (a_UIDENT :'a_UIDENT Gram.t  ));`Skeyword ":";`Snterm
           (Gram.obj (package_type :'package_type Gram.t  ));`Skeyword
           ")"]),(Gram.mk_action
                            ...
                            fun (m : 'a_UIDENT) ->
                              fun _ ->
                                fun _ ->
                                  fun (_loc : FanLoc.t ) ->
                                    (Ast.PaTyc
                                       (_loc,(Ast.PaMod (_loc,m)),(Ast.TyPkg
                                                                    (_loc,pt)))
                                    :'patt )))));(([`Skeyword "(";`Skeyword
           "module";`Snterm
           (Gram.obj (a_UIDENT :'a_UIDENT Gram.t  ));`Skeyword
           ")"]),(Gram.mk_action
                    ((fun _ ->
                    ...
                    ((fun _ ->
                        fun _ ->
                          fun (_loc : FanLoc.t ) ->
                            ...
                            'patt )))));(([`Skeyword "{";`Snterm
           (Gram.obj (label_patt_list :'label_patt_list Gram.t  ));`Skeyword
           "}"]),(Gram.mk_action
                    ((fun _ ->
                        fun (pl : 'label_patt_list) ->
                          fun _ ->
                            fun (_loc : FanLoc.t ) -> (Ast.PaRec (_loc,pl)
                              :'patt )))));(([`Skeyword "[|";`Snterm
           (Gram.obj (sem_patt :'sem_patt Gram.t  ));`Skeyword
           "|]"]),(Gram.mk_action
                     ((fun _ ->
                         fun (pl : 'sem_patt) ->
                           fun _ ->
                             fun (_loc : FanLoc.t ) -> (Ast.PaArr (_loc,pl)
                               :'patt )))));(([`Skeyword "[|";`Skeyword
           "|]"]),(Gram.mk_action
                     ((fun _ ->
                         fun _ ->
                           fun (_loc : FanLoc.t ) ->
                             (Ast.PaArr (_loc,(Ast.PaNil _loc)) :'patt )))));(([`Skeyword
           "[";`Snterm
           (Gram.obj (sem_patt_for_list :'sem_patt_for_list Gram.t  ));`Skeyword
           "]"]),(Gram.mk_action
                    ((fun _ ->
           ...
           (Gram.obj (a_INT :'a_INT Gram.t  ))]),(Gram.mk_action
                                                    ((fun (s : 'a_INT) ->
                                                        fun
                                                          ...
                                                          (Ast.PaInt (_loc,s)
                                                          :'patt )))));(([`Snterm
           (Gram.obj (ident :'ident Gram.t  ))]),(Gram.mk_action
                                                    ((fun (i : 'ident) ->
                                                        fun
                                                          (_loc : FanLoc.t )
                                                          ->
           ...
           (((function
              ...
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"\"|\"pat\"|\"anti\"),_)"))]),(
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun (_loc : FanLoc.t ) ->
                   match __camlp4_0 with
    ...
    Gram.extend (sem_patt :'sem_patt Gram.t  )
      (((fun () -> (None,([(None,(Some `LA),([(([`Snterm
           ...
           ";"]),(Gram.mk_action
                    ((fun _ ->
                        fun (p : 'patt) ->
                          fun (_loc : FanLoc.t ) -> (p :'sem_patt )))));(([`Stoken
           (((function
              | `ANTIQUOT ("list",_) -> true
              | _ -> false)),(`Normal,"`ANTIQUOT (\"list\",_)"))]),(Gram.mk_action
                                                                    ((fun
    ...
    Gram.extend (label_patt_list :'label_patt_list Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Snterm
           (Gram.obj (label_patt :'label_patt Gram.t  ))]),(Gram.mk_action
                                                              ((fun
                                                                  (p1 :
                                                                    'label_patt)
                                                                  ->
           ...
           (Gram.obj (label_patt :'label_patt Gram.t  ));`Skeyword
           ";"]),(Gram.mk_action
                    ((fun _ ->
                        fun (p1 : 'label_patt) ->
                          fun (_loc : FanLoc.t ) -> (p1 :'label_patt_list )))));(([`Snterm
           (Gram.obj (label_patt :'label_patt Gram.t  ));`Skeyword
           ";";`Skeyword "_";`Skeyword
           ";"]),(Gram.mk_action
                    ((fun _ ->
                 ...
                 fun (_loc : FanLoc.t ) ->
                   (Ast.PaEq
                      (_loc,i,(Ast.PaId
                                 (_loc,(Ast.IdLid (_loc,(Ident.to_lid i))))))
                   :'label_patt )))));(([`Snterm
           (Gram.obj (label_longident :'label_longident Gram.t  ));`Skeyword
           "=";`Snterm
           (Gram.obj (patt :'patt Gram.t  ))]),(Gram.mk_action
                                                  ((fun (p : 'patt) ->
                                                      fun _ ->
    ...
    Gram.extend (ipatt :'ipatt Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Skeyword
           "_"]),(Gram.mk_action
                    ((fun _ ->
                        fun (_loc : FanLoc.t ) -> (Ast.PaAny _loc :'ipatt )))));(([`Snterm
           (Gram.obj (a_LIDENT :'a_LIDENT Gram.t  ))]),(Gram.mk_action
                                                          ((fun
                                                              (s : 'a_LIDENT)
                                                              ->
                                                              fun
                                                                ...
                                                                :'ipatt )))));(([`Skeyword
           "(";`Sself;`Skeyword ",";`Snterm
           (Gram.obj (comma_ipatt :'comma_ipatt Gram.t  ));`Skeyword
           ")"]),(Gram.mk_action
                    ((fun _ ->
                        fun (pl : 'comma_ipatt) ->
                          fun _ ->
                        ...
                        fun (p2 : 'ipatt) ->
                          fun _ ->
                            fun (p : 'ipatt) ->
                              fun _ ->
                                fun (_loc : FanLoc.t ) ->
                                  (Ast.PaAli (_loc,p,p2) :'ipatt )))));(([`Skeyword
           "(";`Sself;`Skeyword ":";`Snterm
           (Gram.obj (ctyp :'ctyp Gram.t  ));`Skeyword
           ")"]),(Gram.mk_action
                    ((fun _ ->
                        fun (t : 'ctyp) ->
                          fun _ ->
                            fun (p : 'ipatt) ->
                              fun _ ->
                                fun (_loc : FanLoc.t ) ->
                                  (Ast.PaTyc (_loc,p,t) :'ipatt )))));(([`Skeyword
           "(";`Sself;`Skeyword
           ")"]),(Gram.mk_action
                    ((fun _ ->
                        fun (p : 'ipatt) ->
                          fun _ -> fun (_loc : FanLoc.t ) -> (p :'ipatt )))));(([`Skeyword
           "(";`Skeyword "module";`Snterm
           (Gram.obj (a_UIDENT :'a_UIDENT Gram.t  ));`Skeyword ":";`Snterm
           (Gram.obj (package_type :'package_type Gram.t  ));`Skeyword
           ")"]),(Gram.mk_action
           ...
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun (_loc : FanLoc.t ) ->
                   ...
                   | _ -> assert false))));(([`Skeyword "{";`Snterm
           (Gram.obj (label_ipatt_list :'label_ipatt_list Gram.t  ));`Skeyword
           "}"]),(Gram.mk_action
                    ((fun _ ->
    ...
    Gram.extend (labeled_ipatt :'labeled_ipatt Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Snterm
           (Gram.obj (ipatt :'ipatt Gram.t  ))]),(Gram.mk_action
                                                    ((fun (p : 'ipatt) ->
                                                        fun
                                                          (_loc : FanLoc.t )
                                                          -> (p
    ...
    Gram.extend (label_ipatt_list :'label_ipatt_list Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Snterm
           (Gram.obj (label_ipatt :'label_ipatt Gram.t  ))]),(Gram.mk_action
                                                                ((fun
                                                                    (p1 :
                                                                    'label_ipatt)
                                                                    ->
           ...
           (Gram.obj (label_ipatt :'label_ipatt Gram.t  ));`Skeyword
           ";"]),(Gram.mk_action
                    ((fun _ ->
                        fun (p1 : 'label_ipatt) ->
                          fun (_loc : FanLoc.t ) -> (p1 :'label_ipatt_list )))));(([`Snterm
           (Gram.obj (label_ipatt :'label_ipatt Gram.t  ));`Skeyword
           ";";`Skeyword "_";`Skeyword
           ";"]),(Gram.mk_action
                    ((fun _ ->
    ...
    Gram.extend (type_declaration :'type_declaration Gram.t  )
      (((fun () -> (None,([(None,(Some `LA),([(([`Snterm
           (Gram.obj (type_ident_and_parameters
              :'type_ident_and_parameters Gram.t  ));`Snterm
           (Gram.obj (opt_eq_ctyp :'opt_eq_ctyp Gram.t  ));`Slist0 (`Snterm
           (Gram.obj (constrain :'constrain Gram.t  )))]),(Gram.mk_action
                                                             ((fun
                                                                 (cl :
                                                                   'constrain
                                                                    list ) ->
           ...
           (((function
              | `ANTIQUOT ((""|"typ"|"anti"),_) -> true
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"\"|\"typ\"|\"anti\"),_)"))]),(
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun (_loc : FanLoc.t ) ->
                   match __camlp4_0 with
    ...
    Gram.extend (constrain :'constrain Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Skeyword "constraint";`Snterm
           (Gram.obj (ctyp :'ctyp Gram.t  ));`Skeyword "=";`Snterm
           (Gram.obj (ctyp :'ctyp Gram.t  ))]),(Gram.mk_action
                                                  ((fun (t2 : 'ctyp) ->
                                                      fun _ ->
    ...
    Gram.extend (opt_eq_ctyp :'opt_eq_ctyp Gram.t  )
      (((fun () ->
           (None,([(None,None,([([],(Gram.mk_action
                                       ((fun (_loc : FanLoc.t ) ->
                                           (Ast.TyNil _loc :'opt_eq_ctyp )))));(([`Skeyword
           "=";`Snterm
           (Gram.obj (type_kind :'type_kind Gram.t  ))]),(Gram.mk_action
                                                            ((fun
                                                                (tk :
                                                                  'type_kind)
                                                                ->
    ...
    Gram.extend (type_ident_and_parameters
      ...
      (((fun () -> (None,([(None,None,([(([`Snterm
           (Gram.obj (a_LIDENT :'a_LIDENT Gram.t  ));`Slist0 (`Snterm
           (Gram.obj (optional_type_parameter
              :'optional_type_parameter Gram.t  )))]),(Gram.mk_action
                                                         ((fun
                                                             (tpl :
    ...
    Gram.extend (type_longident_and_parameters
      ...
      (((fun () -> (None,([(None,None,([(([`Snterm
           (Gram.obj (type_longident :'type_longident Gram.t  ));`Snterm
           (Gram.obj (type_parameters :'type_parameters Gram.t  ))]),(
           Gram.mk_action
    ...
    Gram.extend (type_parameters :'type_parameters Gram.t  )
      (((fun () ->
           (None,([(None,None,([([],(Gram.mk_action
                                       ((fun (_loc : FanLoc.t ) ->
                                           (fun t -> t :'type_parameters )))));(([`Snterm
           (Gram.obj (type_parameter :'type_parameter Gram.t  ))]),(Gram.mk_action
                                                                    ((fun
                                                                    (t :
                                                                    'type_parameter)
                                                                    ->
           ...
           (Gram.obj (type_parameter :'type_parameter Gram.t  ));`Sself]),(
           Gram.mk_action
    ...
    Gram.extend (ctyp :'ctyp Gram.t  )
      (((fun () -> (None,([((Some "=="),(Some `LA),([(([`Sself;`Skeyword
           ...
           Some "private"),(Some `NA),([(([`Skeyword "private";`Snterml
           ((Gram.obj (ctyp :'ctyp Gram.t  )),"alias")]),(Gram.mk_action
                                                            ((fun (t : 'ctyp)
                                                                ->
                                                                fun _ ->
                                                                  fun
                                                                    ...
                                                                    :
                                                                    'ctyp )))))]));((
           Some "alias"),(Some `LA),([(([`Sself;`Skeyword
           "as";`Sself]),(Gram.mk_action
                            ((fun (t2 : 'ctyp) ->
                                fun _ ->
                                  fun (t1 : 'ctyp) ->
                                    fun (_loc : FanLoc.t ) ->
                                      (Ast.TyAli (_loc,t1,t2) :'ctyp )))))]));((
           Some "forall"),(Some `LA),([(([`Skeyword "!";`Snterm
           (Gram.obj (typevars :'typevars Gram.t  ));`Skeyword
           ".";`Sself]),(Gram.mk_action
                           ((fun (t2 : 'ctyp) ->
                               fun _ ->
                                 fun (t1 : 'typevars) ->
           ...
           Some "arrow"),(Some `RA),([(([`Sself;`Skeyword
           "->";`Sself]),(Gram.mk_action
                            ((fun (t2 : 'ctyp) ->
                                fun _ ->
                                  fun (t1 : 'ctyp) ->
           ...
           Some "label"),(Some `NA),([(([`Snterm
           (Gram.obj (a_OPTLABEL :'a_OPTLABEL Gram.t  ));`Sself]),(Gram.mk_action
                                                                    ((
                                                                    fun
                                                                    (t :
                                                                    'ctyp) ->
                           ...
                           ((fun (t : 'ctyp) ->
                               fun _ ->
                                 fun (i : 'a_LIDENT) ->
                                   fun _ ->
                                     fun (_loc : FanLoc.t ) ->
                                       (Ast.TyOlb (_loc,i,t) :'ctyp )))));(([`Snterm
           (Gram.obj (a_LABEL :'a_LABEL Gram.t  ));`Sself]),(Gram.mk_action
                                                               ((fun
                                                                   (t :
                                                                    'ctyp) ->
                                                                   fun
           ...
           Some "apply"),(Some `LA),([(([`Sself;`Sself]),(Gram.mk_action
                                                            ((fun
                                                                (t2 : 'ctyp)
                                                                ->
                                                                fun
                                 ...
                                 fun (t1 : 'ctyp) ->
                                   fun (_loc : FanLoc.t ) ->
                                     (try
                                        Ast.TyId
                                          (_loc,(Ast.IdAcc
                                                   (_loc,(Ast.ident_of_ctyp
                                                            t1),(Ast.ident_of_ctyp
                                                                   t2))))
                                      with
                                      | Invalid_argument s ->
                                          raise (Stream.Error s) :'ctyp )))))]));((
           Some "simple"),None,([(([`Skeyword "(";`Skeyword "module";`Snterm
           (Gram.obj (package_type :'package_type Gram.t  ));`Skeyword
           ")"]),(Gram.mk_action
                    ((fun _ ->
                        fun (p : 'package_type) ->
                          fun _ ->
                            fun _ ->
                              fun (_loc : FanLoc.t ) -> (Ast.TyPkg (_loc,p)
                                :'ctyp )))));(([`Skeyword "<";`Snterm
           (Gram.obj (opt_meth_list :'opt_meth_list Gram.t  ));`Skeyword
           ">"]),(Gram.mk_action
                    ((fun _ ->
                        fun (t : 'opt_meth_list) ->
                          fun _ -> fun (_loc : FanLoc.t ) -> (t :'ctyp )))));(([`Skeyword
           "#";`Snterm
           (Gram.obj (class_longident :'class_longident Gram.t  ))]),(
           Gram.mk_action
             ((fun (i : 'class_longident) ->
                 fun _ ->
                   fun (_loc : FanLoc.t ) -> (Ast.TyCls (_loc,i) :'ctyp )))));(([`Skeyword
           "{";`Snterm
           (Gram.obj (label_declaration_list :'label_declaration_list Gram.t 
              ));`Skeyword
           "}"]),(Gram.mk_action
                    ((fun _ ->
                        fun (t : 'label_declaration_list) ->
                          fun _ ->
                            fun (_loc : FanLoc.t ) -> (Ast.TyRec (_loc,t)
                              :'ctyp )))));(([`Skeyword "[<";`Snterm
           (Gram.obj (row_field :'row_field Gram.t  ));`Skeyword ">";`Snterm
           (Gram.obj (name_tags :'name_tags Gram.t  ));`Skeyword
           "]"]),(Gram.mk_action
                    ((fun _ ->
                        fun (ntl : 'name_tags) ->
                          fun _ ->
                            fun (rfl : 'row_field) ->
                              fun _ ->
                                fun (_loc : FanLoc.t ) ->
                                  (Ast.TyVrnInfSup (_loc,rfl,ntl) :'ctyp )))));(([`Skeyword
           ...
           "]"]),(Gram.mk_action
                    ((fun _ ->
                        fun (rfl : 'row_field) ->
                          fun _ ->
                            fun (_loc : FanLoc.t ) ->
                              (Ast.TyVrnInf (_loc,rfl) :'ctyp )))));(([`Skeyword
           "[";`Skeyword "<";`Snterm
           (Gram.obj (row_field :'row_field Gram.t  ));`Skeyword ">";`Snterm
           (Gram.obj (name_tags :'name_tags Gram.t  ));`Skeyword
           "]"]),(Gram.mk_action
                          ...
                          fun _ ->
                            fun _ ->
                              fun (_loc : FanLoc.t ) ->
                                (Ast.TyVrnInf (_loc,rfl) :'ctyp )))));(([`Skeyword
           "[";`Skeyword ">";`Snterm
           (Gram.obj (row_field :'row_field Gram.t  ));`Skeyword
           "]"]),(Gram.mk_action
                    ((fun _ ->
                        fun (rfl : 'row_field) ->
                          fun _ ->
                            fun _ ->
                              fun (_loc : FanLoc.t ) ->
                                (Ast.TyVrnSup (_loc,rfl) :'ctyp )))));(([`Skeyword
           "[";`Skeyword ">";`Skeyword
           "]"]),(Gram.mk_action
                    ((fun _ ->
                        fun _ ->
                    ...
                    ((fun _ ->
                        fun (rfl : 'row_field) ->
                          fun _ ->
                            fun _ ->
                              fun (_loc : FanLoc.t ) ->
                                (Ast.TyVrnEq (_loc,rfl) :'ctyp )))));(([`Skeyword
           "[";`Snterm
           ...
           "]"]),(Gram.mk_action
                    ((fun _ ->
                        fun (t : 'constructor_declarations) ->
                          fun _ ->
                            fun (_loc : FanLoc.t ) -> (Ast.TySum (_loc,t)
                              :'ctyp )))));(([`Skeyword "[";`Skeyword
           "]"]),(Gram.mk_action
                    ((fun _ ->
                        fun _ ->
                          fun (_loc : FanLoc.t ) ->
                            (Ast.TySum (_loc,(Ast.TyNil _loc)) :'ctyp )))));(([`Skeyword
           "(";`Sself;`Skeyword
           ")"]),(Gram.mk_action
                    ((fun _ ->
                        fun (t : 'ctyp) ->
                          fun _ -> fun (_loc : FanLoc.t ) -> (t :'ctyp )))));(([`Skeyword
           "(";`Sself;`Skeyword "*";`Snterm
           (Gram.obj (star_ctyp :'star_ctyp Gram.t  ));`Skeyword
           ")"]),(Gram.mk_action
                    ((fun _ ->
                        fun (tl : 'star_ctyp) ->
                          fun _ ->
                            fun (t : 'ctyp) ->
                              fun _ ->
                                fun (_loc : FanLoc.t ) ->
                                  ...
                                  :'ctyp )))));(([`Snterm
           (Gram.obj (a_UIDENT :'a_UIDENT Gram.t  ))]),(Gram.mk_action
                                                          ((fun
                                                              (i : 'a_UIDENT)
                                                              ->
                                                              fun
           ...
           (((function
              | `ANTIQUOT ("id",_) -> true
              | _ -> false)),(`Normal,"`ANTIQUOT (\"id\",_)"))]),(Gram.mk_action
                                                                    ((
                                                                    fun
                                                                    __camlp4_0
                                                                    ->
           ...
           "_"]),(Gram.mk_action
                    ((fun _ ->
                        fun (_loc : FanLoc.t ) -> (Ast.TyAny _loc :'ctyp )))));(([`Skeyword
           "'";`Snterm
           (Gram.obj (a_ident :'a_ident Gram.t  ))]),(Gram.mk_action
                                                        ((fun (i : 'a_ident)
                                                            ->
    ...
    Gram.extend (star_ctyp :'star_ctyp Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Snterm
           (Gram.obj (ctyp :'ctyp Gram.t  ))]),(Gram.mk_action
                                                  ((fun (t : 'ctyp) ->
                                                      fun (_loc : FanLoc.t )
                                                        -> (t :'star_ctyp )))));(([`Sself;`Skeyword
           "*";`Sself]),(Gram.mk_action
                           ((fun (t2 : 'star_ctyp) ->
                               fun _ ->
                                 fun (t1 : 'star_ctyp) ->
                                   fun (_loc : FanLoc.t ) ->
                                     (Ast.TySta (_loc,t1,t2) :'star_ctyp )))));(([`Stoken
           (((function
              | `ANTIQUOT ("list",_) -> true
              | _ -> false)),(`Normal,"`ANTIQUOT (\"list\",_)"))]),(Gram.mk_action
                                                                    ((fun
    ...
    Gram.extend (constructor_declarations :'constructor_declarations Gram.t 
      ...
      (((fun () -> (None,([(None,None,([(([`Snterm
           ...
           (Gram.obj (a_UIDENT :'a_UIDENT Gram.t  ));`Skeyword "of";`Snterm
                 ...
                 fun _ ->
                   fun (s : 'a_UIDENT) ->
                     fun (_loc : FanLoc.t ) ->
                       ...
                       :'constructor_declarations )))));(([`Sself;`Skeyword
           "|";`Sself]),(Gram.mk_action
                           ((fun (t2 : 'constructor_declarations) ->
                               fun _ ->
                                 fun (t1 : 'constructor_declarations) ->
                                   fun (_loc : FanLoc.t ) ->
                                     (Ast.TyOr (_loc,t1,t2)
                                     :'constructor_declarations )))));(([`Stoken
           (((function
              | `QUOTATION _ -> true
              | _ -> false)),(`Normal,"`QUOTATION _"))]),(Gram.mk_action
                                                            ((fun __camlp4_0
                 ...
                 fun _ ->
                   fun (s : 'a_UIDENT) ->
                     fun (_loc : FanLoc.t ) ->
                       (Ast.TyOf
                          (_loc,(Ast.TyId (_loc,(Ast.IdUid (_loc,s)))),t)
                       :'constructor_declaration )))));(([`Stoken
           (((function
              | `QUOTATION _ -> true
              | _ -> false)),(`Normal,"`QUOTATION _"))]),(Gram.mk_action
                                                            ((fun __camlp4_0
      ...
      (((fun () -> (None,([(None,None,([(([`Snterm
           ...
           Gram.mk_action
             ((fun (t1 : 'label_declaration) ->
                 fun (_loc : FanLoc.t ) -> (t1 :'label_declaration_list )))));(([`Snterm
           (Gram.obj (label_declaration :'label_declaration Gram.t  ));`Skeyword
           ";"]),(Gram.mk_action
                    ((fun _ ->
                        fun (t1 : 'label_declaration) ->
                          fun (_loc : FanLoc.t ) -> (t1
                            :'label_declaration_list )))));(([`Snterm
           (Gram.obj (label_declaration :'label_declaration Gram.t  ));`Skeyword
           ";";`Sself]),(Gram.mk_action
    ...
    Gram.extend (label_declaration :'label_declaration Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Snterm
           (Gram.obj (a_LIDENT :'a_LIDENT Gram.t  ));`Skeyword ":";`Skeyword
           "mutable";`Snterm
           (Gram.obj (poly_type :'poly_type Gram.t  ))]),(Gram.mk_action
                                                            ((fun
                                                                (t :
                                                                  'poly_type)
                                                                ->
    ...
    Gram.extend (ident :'ident Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Snterm
           ...
           (((function
              ...
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"\"|\"id\"|\"anti\"|\"list\"),_)"));`Skeyword
           ".";`Sself]),(Gram.mk_action
                           ((fun (i : 'ident) ->
                               fun _ ->
                                 fun __camlp4_0 ->
           ...
           (((function
              | `ANTIQUOT ((""|"id"|"anti"|"list"),_) -> true
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"\"|\"id\"|\"anti\"|\"list\"),_)"))]),(
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun (_loc : FanLoc.t ) ->
                   match __camlp4_0 with
    ...
    Gram.extend (module_longident_with_app
      ...
      (((fun () ->
           (None,([((Some "apply"),None,([(([`Sself;`Sself]),(Gram.mk_action
                                                                ((fun
                                                                    (j :
                                                                    'module_longident_with_app)
                                                                    ->
                               ...
                               fun _ ->
                                 fun (i : 'module_longident_with_app) ->
                                   fun (_loc : FanLoc.t ) ->
                                     (Ast.IdAcc (_loc,i,j)
                                     :'module_longident_with_app )))))]));((
           Some "simple"),None,([(([`Skeyword "(";`Sself;`Skeyword
           ")"]),(Gram.mk_action
                    ((fun _ ->
                        fun (i : 'module_longident_with_app) ->
                          fun _ ->
                            fun (_loc : FanLoc.t ) -> (i
                              :'module_longident_with_app )))));(([`Snterm
           (Gram.obj (a_UIDENT :'a_UIDENT Gram.t  ))]),(Gram.mk_action
                                                          ((fun
                                                              (i : 'a_UIDENT)
                                                              ->
    ...
    Gram.extend (module_longident_dot_lparen
      ...
      (((fun () -> (None,([(None,None,([(([`Snterm
           (Gram.obj (a_UIDENT :'a_UIDENT Gram.t  ));`Skeyword ".";`Skeyword
           "("]),(Gram.mk_action
                    ((fun _ ->
                        fun _ ->
                          fun (i : 'a_UIDENT) ->
                            fun (_loc : FanLoc.t ) -> (Ast.IdUid (_loc,i)
                              :'module_longident_dot_lparen )))));(([`Snterm
           (Gram.obj (a_UIDENT :'a_UIDENT Gram.t  ));`Skeyword
           ".";`Sself]),(Gram.mk_action
                           ((fun (l : 'module_longident_dot_lparen) ->
                               fun _ ->
                                 fun (m : 'a_UIDENT) ->
                                   fun (_loc : FanLoc.t ) ->
                                     (Ast.IdAcc (_loc,(Ast.IdUid (_loc,m)),l)
                                     :'module_longident_dot_lparen )))));(([`Stoken
           (((function
              | `ANTIQUOT ((""|"id"|"anti"|"list"),_) -> true
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"\"|\"id\"|\"anti\"|\"list\"),_)"));`Skeyword
           ".";`Skeyword
      ...
      (((fun () ->
           ...
           ")"]),(Gram.mk_action
                    ((fun _ ->
                        fun (i : 'type_longident) ->
                          fun _ ->
                            fun (_loc : FanLoc.t ) -> (i :'type_longident )))));(([`Snterm
           (Gram.obj (a_UIDENT :'a_UIDENT Gram.t  ))]),(Gram.mk_action
                                                          ((fun
                                                              (i : 'a_UIDENT)
                                                              ->
    ...
    Gram.extend (class_declaration :'class_declaration Gram.t  )
      (((fun () -> (None,([(None,(Some `LA),([(([`Snterm
           (Gram.obj (class_info_for_class_expr
              :'class_info_for_class_expr Gram.t  ));`Snterm
           ...
           (((function
              ...
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"\"|\"cdcl\"|\"anti\"|\"list\"),_)"))]),(
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun (_loc : FanLoc.t ) ->
                   match __camlp4_0 with
             ...
             ((fun (cfb : 'class_fun_binding) ->
                 fun (p : 'labeled_ipatt) ->
                   fun (_loc : FanLoc.t ) -> (Ast.CeFun (_loc,p,cfb)
                     :'class_fun_binding )))));(([`Skeyword ":";`Snterm
           (Gram.obj (class_type_plus :'class_type_plus Gram.t  ));`Skeyword
           "=";`Snterm
           (Gram.obj (class_expr :'class_expr Gram.t  ))]),(Gram.mk_action
                                                              ((fun
                                                                  (ce :
                                                                    'class_expr)
                                                                  ->
    ...
    Gram.extend (class_info_for_class_type
      ...
      (((fun () -> (None,([(None,None,([(([`Snterm
           (Gram.obj (opt_virtual :'opt_virtual Gram.t  ));`Snterm
    ...
    Gram.extend (class_name_and_param :'class_name_and_param Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Snterm
           ...
           (Gram.obj (a_LIDENT :'a_LIDENT Gram.t  ));`Skeyword "[";`Snterm
           (Gram.obj (comma_type_parameter :'comma_type_parameter Gram.t  ));`Skeyword
           "]"]),(Gram.mk_action
                    ((fun _ ->
    ...
    Gram.extend (opt_comma_ctyp :'opt_comma_ctyp Gram.t  )
      (((fun () ->
           (None,([(None,None,([([],(Gram.mk_action
                                       ((fun (_loc : FanLoc.t ) ->
                                           (Ast.TyNil _loc :'opt_comma_ctyp )))));(([`Skeyword
           "[";`Snterm
           (Gram.obj (comma_ctyp :'comma_ctyp Gram.t  ));`Skeyword
           "]"]),(Gram.mk_action
                    ((fun _ ->
                        fun (x : 'comma_ctyp) ->
                          fun _ ->
                            fun (_loc : FanLoc.t ) -> (x :'opt_comma_ctyp )))))]))]))))
         ());
    ...
    Gram.extend (class_expr :'class_expr Gram.t  )
      (((fun () -> (None,([((Some "top"),None,([(([`Skeyword "let";`Snterm
           (Gram.obj (opt_rec :'opt_rec Gram.t  ));`Snterm
           (Gram.obj (binding :'binding Gram.t  ));`Skeyword
           "in";`Sself]),(Gram.mk_action
                            ((fun (ce : 'class_expr) ->
           ...
           "fun";`Snterm
           (Gram.obj (labeled_ipatt :'labeled_ipatt Gram.t  ));`Snterm
           (Gram.obj (class_fun_def :'class_fun_def Gram.t  ))]),(Gram.mk_action
                                                                    ((
                                                                    fun
                                                                    (ce :
                                                                    'class_fun_def)
           ...
           Some "apply"),(Some `NA),([(([`Sself;`Snterml
           ((Gram.obj (expr :'expr Gram.t  )),"label")]),(Gram.mk_action
                                                            ((fun (e : 'expr)
                                                                ->
                                                                fun
                                                                  (ce :
           ...
           ")"]),(Gram.mk_action
                    ((fun _ ->
                        fun (ce : 'class_expr) ->
                          fun _ ->
                            fun (_loc : FanLoc.t ) -> (ce :'class_expr )))));(([`Skeyword
           "(";`Sself;`Skeyword ":";`Snterm
           (Gram.obj (class_type :'class_type Gram.t  ));`Skeyword
           ")"]),(Gram.mk_action
                    ((fun _ ->
                        fun (ct : 'class_type) ->
                          fun _ ->
                            fun (ce : 'class_expr) ->
                              fun _ ->
                                fun (_loc : FanLoc.t ) ->
                                  (Ast.CeTyc (_loc,ce,ct) :'class_expr )))));(([`Skeyword
           "object";`Snterm
           (Gram.obj (opt_class_self_patt :'opt_class_self_patt Gram.t  ));`Snterm
           (Gram.obj (class_structure :'class_structure Gram.t  ));`Skeyword
           "end"]),(Gram.mk_action
                      ((fun _ ->
                          fun (cst : 'class_structure) ->
                            fun (csp : 'opt_class_self_patt) ->
                              fun _ ->
                                fun (_loc : FanLoc.t ) ->
                                  (Ast.CeStr (_loc,csp,cst) :'class_expr )))));(([`Snterm
           (Gram.obj (class_longident_and_param
              :'class_longident_and_param Gram.t  ))]),(Gram.mk_action
                                                          ((fun
                                                              (ce :
           ...
           (((function
              ...
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"\"|\"cexp\"|\"anti\"),_)"))]),(
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun (_loc : FanLoc.t ) ->
                   match __camlp4_0 with
           ...
           Gram.mk_action
             ((fun (ci : 'class_longident) ->
                 fun (_loc : FanLoc.t ) ->
                   ...
                   :'class_longident_and_param )))));(([`Snterm
           (Gram.obj (class_longident :'class_longident Gram.t  ));`Skeyword
           "[";`Snterm
           (Gram.obj (comma_ctyp :'comma_ctyp Gram.t  ));`Skeyword
           "]"]),(Gram.mk_action
                    ((fun _ ->
    ...
    Gram.extend (class_structure :'class_structure Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Slist0
           (Gram.srules class_structure ([(([`Snterm
              (Gram.obj (class_str_item :'class_str_item Gram.t  ));`Snterm
              (Gram.obj (semi :'semi Gram.t  ))]),(Gram.mk_action
                                                     ((fun _ ->
                                                         fun
                                                           (cst :
           ...
           Gram.mk_action
             ((fun (l : 'e__22 list ) ->
                 fun (_loc : FanLoc.t ) -> (Ast.crSem_of_list l
                   :'class_structure )))));(([`Stoken
           (((function
              | `ANTIQUOT ((""|"cst"|"anti"|"list"),_) -> true
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"\"|\"cst\"|\"anti\"|\"list\"),_)"));`Snterm
           (Gram.obj (semi :'semi Gram.t  ));`Sself]),(Gram.mk_action
                                                         ((fun
                                                             (cst :
                                                               'class_structure)
                                                             ->
           ...
           (((function
              | `ANTIQUOT ((""|"cst"|"anti"|"list"),_) -> true
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"\"|\"cst\"|\"anti\"|\"list\"),_)"))]),(
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun (_loc : FanLoc.t ) ->
                   match __camlp4_0 with
    ...
    Gram.extend (class_str_item :'class_str_item Gram.t  )
      (((fun () -> (None,([(None,(Some `LA),([(([`Skeyword
           ...
           (Gram.obj (type_constraint :'type_constraint Gram.t  ));`Snterm
           (Gram.obj (ctyp :'ctyp Gram.t  ));`Skeyword "=";`Snterm
           (Gram.obj (ctyp :'ctyp Gram.t  ))]),(Gram.mk_action
                                                  ((fun (t2 : 'ctyp) ->
                                                      fun _ ->
           ...
           (Gram.obj (method_opt_override :'method_opt_override Gram.t  ));`Snterm
           (Gram.obj (opt_private :'opt_private Gram.t  ));`Skeyword
           "virtual";`Snterm (Gram.obj (label :'label Gram.t  ));`Skeyword
           ":";`Snterm
           (Gram.obj (poly_type :'poly_type Gram.t  ))]),(Gram.mk_action
                                                            ((fun
                                                                (t :
           ...
           (Gram.obj (method_opt_override :'method_opt_override Gram.t  ));`Skeyword
           "virtual";`Snterm
           (Gram.obj (opt_private :'opt_private Gram.t  ));`Snterm
           (Gram.obj (label :'label Gram.t  ));`Skeyword ":";`Snterm
           (Gram.obj (poly_type :'poly_type Gram.t  ))]),(Gram.mk_action
                                                            ((fun
                                                                (t :
                                                                  'poly_type)
           ...
           (Gram.obj (value_val_opt_override :'value_val_opt_override Gram.t 
              ));`Skeyword "virtual";`Snterm
           (Gram.obj (opt_mutable :'opt_mutable Gram.t  ));`Snterm
           (Gram.obj (label :'label Gram.t  ));`Skeyword ":";`Snterm
           (Gram.obj (poly_type :'poly_type Gram.t  ))]),(Gram.mk_action
                                                            ((fun
                                                                (t :
           ...
           "inherit";`Snterm
           (Gram.obj (opt_override :'opt_override Gram.t  ));`Snterm
           (Gram.obj (class_expr :'class_expr Gram.t  ));`Snterm
           (Gram.obj (opt_as_lident :'opt_as_lident Gram.t  ))]),(Gram.mk_action
                                                                    ((
                                                                    fun
                                                                    (pb :
                                                                    'opt_as_lident)
    ...
    Gram.extend (method_opt_override :'method_opt_override Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Skeyword
           "method"]),(Gram.mk_action
                         ((fun _ ->
                             fun (_loc : FanLoc.t ) -> (Ast.OvNil
                               :'method_opt_override )))));(([`Skeyword
           "method";`Stoken
           (((function
              | `ANTIQUOT (("!"|"override"|"anti"),_) -> true
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"!\"|\"override\"|\"anti\"),_)"))]),(
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun _ ->
                   fun (_loc : FanLoc.t ) ->
                     ...
                     | _ -> assert false))));(([`Skeyword "method";`Skeyword
           "!"]),(Gram.mk_action
                    ((fun _ ->
                        fun _ ->
    ...
    Gram.extend (value_val_opt_override :'value_val_opt_override Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Skeyword
           "val"]),(Gram.mk_action
                      ((fun _ ->
                          fun (_loc : FanLoc.t ) -> (Ast.OvNil
                            :'value_val_opt_override )))));(([`Skeyword
           "val";`Stoken
           (((function
              | `ANTIQUOT (("!"|"override"|"anti"),_) -> true
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"!\"|\"override\"|\"anti\"),_)"))]),(
             ...
             ((fun __camlp4_0 ->
                 fun _ ->
                   fun (_loc : FanLoc.t ) ->
                     ...
                     | _ -> assert false))));(([`Skeyword "val";`Skeyword
           "!"]),(Gram.mk_action
                    ((fun _ ->
                        fun _ ->
                          fun (_loc : FanLoc.t ) -> (Ast.OvOverride
    ...
    Gram.extend (opt_polyt :'opt_polyt Gram.t  )
      (((fun () ->
           (None,([(None,None,([([],(Gram.mk_action
                                       ((fun (_loc : FanLoc.t ) ->
                                           (Ast.TyNil _loc :'opt_polyt )))));(([`Skeyword
           ":";`Snterm
           (Gram.obj (poly_type :'poly_type Gram.t  ))]),(Gram.mk_action
                                                            ((fun
                                                                (t :
    ...
    Gram.extend (cvalue_binding :'cvalue_binding Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Skeyword ":>";`Snterm
           ...
           ":";`Skeyword "type";`Snterm
           (Gram.obj (unquoted_typevars :'unquoted_typevars Gram.t  ));`Skeyword
           ".";`Snterm (Gram.obj (ctyp :'ctyp Gram.t  ));`Skeyword
           "=";`Snterm
           (Gram.obj (expr :'expr Gram.t  ))]),(Gram.mk_action
                                                  ((fun (e : 'expr) ->
    ...
    Gram.extend (class_type :'class_type Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Skeyword "object";`Snterm
           (Gram.obj (opt_class_self_type :'opt_class_self_type Gram.t  ));`Snterm
           (Gram.obj (class_signature :'class_signature Gram.t  ));`Skeyword
           "end"]),(Gram.mk_action
                      ((fun _ ->
                          fun (csg : 'class_signature) ->
                            fun (cst : 'opt_class_self_type) ->
                              fun _ ->
                                fun (_loc : FanLoc.t ) ->
                                  (Ast.CtSig (_loc,cst,csg) :'class_type )))));(([`Snterm
           (Gram.obj (class_type_longident_and_param
              :'class_type_longident_and_param Gram.t  ))]),(Gram.mk_action
                                                               ((fun
                                                                   (ct :
           ...
           (((function
              ...
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"\"|\"ctyp\"|\"anti\"),_)"))]),(
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun (_loc : FanLoc.t ) ->
                   match __camlp4_0 with
           ...
           Gram.mk_action
             ((fun (i : 'class_type_longident) ->
                 fun (_loc : FanLoc.t ) ->
                   ...
                   :'class_type_longident_and_param )))));(([`Snterm
           (Gram.obj (class_type_longident :'class_type_longident Gram.t  ));`Skeyword
           "[";`Snterm
           (Gram.obj (comma_ctyp :'comma_ctyp Gram.t  ));`Skeyword
           "]"]),(Gram.mk_action
                    ((fun _ ->
    ...
    Gram.extend (class_type_plus :'class_type_plus Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Snterm
           (Gram.obj (class_type :'class_type Gram.t  ))]),(Gram.mk_action
                                                              ((fun
                                                                  (ct :
                                                                    'class_type)
                                                                  ->
    ...
    Gram.extend (class_signature :'class_signature Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Slist0
           (Gram.srules class_signature ([(([`Snterm
              (Gram.obj (class_sig_item :'class_sig_item Gram.t  ));`Snterm
              (Gram.obj (semi :'semi Gram.t  ))]),(Gram.mk_action
                                                     ((fun _ ->
                                                         fun
                                                           (csg :
           ...
           Gram.mk_action
             ((fun (l : 'e__23 list ) ->
                 fun (_loc : FanLoc.t ) -> (Ast.cgSem_of_list l
                   :'class_signature )))));(([`Stoken
           (((function
              | `ANTIQUOT ((""|"csg"|"anti"|"list"),_) -> true
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"\"|\"csg\"|\"anti\"|\"list\"),_)"));`Snterm
           (Gram.obj (semi :'semi Gram.t  ));`Sself]),(Gram.mk_action
                                                         ((fun
                                                             (csg :
                                                               'class_signature)
           ...
           (((function
              | `ANTIQUOT ((""|"csg"|"anti"|"list"),_) -> true
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"\"|\"csg\"|\"anti\"|\"list\"),_)"))]),(
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun (_loc : FanLoc.t ) ->
                   match __camlp4_0 with
    ...
    Gram.extend (class_sig_item :'class_sig_item Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Snterm
           ...
           "method";`Skeyword "virtual";`Snterm
           (Gram.obj (opt_private :'opt_private Gram.t  ));`Snterm
           (Gram.obj (label :'label Gram.t  ));`Skeyword ":";`Snterm
           (Gram.obj (poly_type :'poly_type Gram.t  ))]),(Gram.mk_action
                                                            ((fun
    ...
    Gram.extend (type_constraint :'type_constraint Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Skeyword
           "constraint"]),(Gram.mk_action
                             ((fun _ ->
                                 fun (_loc : FanLoc.t ) -> (()
                                   :'type_constraint )))));(([`Skeyword
           "type"]),(Gram.mk_action
                       ((fun _ ->
                           fun (_loc : FanLoc.t ) -> (() :'type_constraint )))))]))]))))
         ());
    Gram.extend (class_description :'class_description Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Snterm
           (Gram.obj (class_info_for_class_type
              :'class_info_for_class_type Gram.t  ));`Skeyword ":";`Snterm
           (Gram.obj (class_type_plus :'class_type_plus Gram.t  ))]),(
           Gram.mk_action
             ((fun (ct : 'class_type_plus) ->
                 fun _ ->
                   fun (ci : 'class_info_for_class_type) ->
                     fun (_loc : FanLoc.t ) -> (Ast.CtCol (_loc,ci,ct)
                       :'class_description )))));(([`Stoken
           (((function
              | `QUOTATION _ -> true
              | _ -> false)),(`Normal,"`QUOTATION _"))]),(Gram.mk_action
                                                            ((fun __camlp4_0
           ...
           (((function
              ...
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"\"|\"typ\"|\"anti\"|\"list\"),_)"))]),(
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun (_loc : FanLoc.t ) ->
                   match __camlp4_0 with
    ...
    Gram.extend (field_expr_list :'field_expr_list Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Snterm
           (Gram.obj (field_expr :'field_expr Gram.t  ))]),(Gram.mk_action
                                                              ((fun
                                                                  (b1 :
                                                                    'field_expr)
                                                                  ->
           ...
           (Gram.obj (field_expr :'field_expr Gram.t  ));`Skeyword
           ";"]),(Gram.mk_action
                    ((fun _ ->
                        fun (b1 : 'field_expr) ->
                          fun (_loc : FanLoc.t ) -> (b1 :'field_expr_list )))));(([`Snterm
           (Gram.obj (field_expr :'field_expr Gram.t  ));`Skeyword
           ";";`Sself]),(Gram.mk_action
    ...
    Gram.extend (field_expr :'field_expr Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Snterm
           (Gram.obj (label :'label Gram.t  ));`Skeyword "=";`Snterml
           ((Gram.obj (expr :'expr Gram.t  )),"top")]),(Gram.mk_action
                                                          ((fun (e : 'expr)
                                                              ->
                                                              fun _ ->
           ...
           (((function
              ...
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"\"|\"bi\"|\"anti\"),_)"))]),(
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun (_loc : FanLoc.t ) ->
                   match __camlp4_0 with
    ...
    Gram.extend (meth_list :'meth_list Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Snterm
           (Gram.obj (meth_decl :'meth_decl Gram.t  ));`Snterm
           (Gram.obj (opt_dot_dot :'opt_dot_dot Gram.t  ))]),(Gram.mk_action
                                                                ((fun
                                                                    (v :
                                                                    'opt_dot_dot)
                                                                    ->
           ...
           (Gram.obj (meth_decl :'meth_decl Gram.t  ));`Skeyword ";";`Snterm
           (Gram.obj (opt_dot_dot :'opt_dot_dot Gram.t  ))]),(Gram.mk_action
                                                                ((fun
                                                                    (v :
                                                                    'opt_dot_dot)
           ...
           (Gram.obj (meth_decl :'meth_decl Gram.t  ));`Skeyword
           ";";`Sself]),(Gram.mk_action
                           ((fun ((ml,v) : 'meth_list) ->
                               fun _ ->
                                 fun (m : 'meth_decl) ->
    ...
    Gram.extend (opt_meth_list :'opt_meth_list Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Snterm
           ...
           (Gram.obj (meth_list :'meth_list Gram.t  ))]),(Gram.mk_action
                                                            ((fun
                                                                ((ml,v) :
                                                                  'meth_list)
                                                                ->
    ...
    Gram.extend (typevars :'typevars Gram.t  )
      (((fun () -> (None,([(None,(Some `LA),([(([`Skeyword "'";`Snterm
           (Gram.obj (a_ident :'a_ident Gram.t  ))]),(Gram.mk_action
                                                        ((fun (i : 'a_ident)
                                                            ->
                                                            fun _ ->
           ...
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun (_loc : FanLoc.t ) ->
                   ...
                   | _ -> assert false))));(([`Sself;`Sself]),(Gram.mk_action
                                                                 ((fun
                                                                    (t2 :
                                                                    'typevars)
                                                                    ->
    ...
    Gram.extend (row_field :'row_field Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Snterm
           (Gram.obj (ctyp :'ctyp Gram.t  ))]),(Gram.mk_action
                                                  ((fun (t : 'ctyp) ->
                                                      fun (_loc : FanLoc.t )
                                                        -> (t :'row_field )))));(([`Skeyword
           "`";`Snterm (Gram.obj (a_ident :'a_ident Gram.t  ));`Skeyword
           "of";`Snterm
           (Gram.obj (amp_ctyp :'amp_ctyp Gram.t  ))]),(Gram.mk_action
                                                          ((fun
                                                              (t : 'amp_ctyp)
                                                              ->
                                                              fun _ ->
                                                        ...
                                                        ((fun (i : 'a_ident)
                                                            ...
                                                            fun _ ->
                                                              fun
                                                                ...
                                                                (Ast.TyVrn
                                                                   (_loc,i)
                                                                :'row_field )))));(([`Sself;`Skeyword
           "|";`Sself]),(Gram.mk_action
                           ((fun (t2 : 'row_field) ->
                               fun _ ->
                                 fun (t1 : 'row_field) ->
                                   fun (_loc : FanLoc.t ) ->
                                     (Ast.TyOr (_loc,t1,t2) :'row_field )))));(([`Stoken
           (((function
              | `ANTIQUOT ("list",_) -> true
              | _ -> false)),(`Normal,"`ANTIQUOT (\"list\",_)"))]),(Gram.mk_action
                                                                    ((fun
      ...
      (((fun () -> (None,([(None,None,([(([`Snterm
           (Gram.obj (patt :'patt Gram.t  ))]),(Gram.mk_action
                                                  ((fun (p : 'patt) ->
                                                      fun (_loc : FanLoc.t )
                                                        -> (p :'patt_tcon )))));(([`Snterm
           (Gram.obj (patt :'patt Gram.t  ));`Skeyword ":";`Snterm
           (Gram.obj (ctyp :'ctyp Gram.t  ))]),(Gram.mk_action
                                                  ((fun (t : 'ctyp) ->
                                                      fun _ ->
                                                        fun (p : 'patt) ->
    ...
    Gram.extend (ipatt :'ipatt Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Skeyword "?";`Skeyword
           "(";`Snterm
           (Gram.obj (ipatt_tcon :'ipatt_tcon Gram.t  ));`Skeyword
                          ...
                          fun _ ->
                            fun (p : 'ipatt_tcon) ->
                              fun _ ->
                                fun _ ->
                                  fun (_loc : FanLoc.t ) ->
                                    (Ast.PaOlbi (_loc,"",p,e) :'ipatt )))));(([`Skeyword
           "?";`Skeyword "(";`Snterm
           (Gram.obj (ipatt_tcon :'ipatt_tcon Gram.t  ));`Skeyword
           ")"]),(Gram.mk_action
                    ((fun _ ->
                        fun (p : 'ipatt_tcon) ->
                          fun _ ->
                            fun _ ->
                              fun (_loc : FanLoc.t ) ->
                                (Ast.PaOlb (_loc,"",p) :'ipatt )))));(([`Skeyword
           "?";`Stoken
           (((function
              | `ANTIQUOT ((""|"lid"),_) -> true
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"\"|\"lid\"),_)"))]),(
           ...
           (((function
              ...
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"\"|\"lid\"),_)"));`Skeyword
           ":";`Skeyword "(";`Snterm
           (Gram.obj (ipatt_tcon :'ipatt_tcon Gram.t  ));`Snterm
           (Gram.obj (eq_expr :'eq_expr Gram.t  ));`Skeyword
           ")"]),(Gram.mk_action
                    ((fun _ ->
                        fun (f : 'eq_expr) ->
    ...
    Gram.extend (direction_flag :'direction_flag Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Stoken
           (((function
              ...
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"to\"|\"anti\"),_)"))]),(
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun (_loc : FanLoc.t ) ->
                   match __camlp4_0 with
                   ...
                   | _ -> assert false))));(([`Skeyword
           "downto"]),(Gram.mk_action
                         ((fun _ ->
                             fun (_loc : FanLoc.t ) -> (Ast.DiDownto
                               :'direction_flag )))));(([`Skeyword
           "to"]),(Gram.mk_action
                     ((fun _ ->
                         fun (_loc : FanLoc.t ) -> (Ast.DiTo :'direction_flag
                           )))))]))])))) ());
    Gram.extend (opt_private :'opt_private Gram.t  )
      (((fun () ->
           (None,([(None,None,([([],(Gram.mk_action
                                       ((fun (_loc : FanLoc.t ) -> (Ast.PrNil
                                           :'opt_private )))));(([`Stoken
           (((function
              | `ANTIQUOT (("private"|"anti"),_) -> true
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"private\"|\"anti\"),_)"))]),(
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun (_loc : FanLoc.t ) ->
                   match __camlp4_0 with
                   ...
                   | _ -> assert false))));(([`Skeyword
           "private"]),(Gram.mk_action
                          ((fun _ ->
                              fun (_loc : FanLoc.t ) -> (Ast.PrPrivate
                                :'opt_private )))))]))])))) ());
    Gram.extend (opt_mutable :'opt_mutable Gram.t  )
      (((fun () ->
           (None,([(None,None,([([],(Gram.mk_action
                                       ((fun (_loc : FanLoc.t ) -> (Ast.MuNil
                                           :'opt_mutable )))));(([`Stoken
           (((function
              | `ANTIQUOT (("mutable"|"anti"),_) -> true
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"mutable\"|\"anti\"),_)"))]),(
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun (_loc : FanLoc.t ) ->
                   match __camlp4_0 with
                   ...
                   | _ -> assert false))));(([`Skeyword
           "mutable"]),(Gram.mk_action
                          ((fun _ ->
                              fun (_loc : FanLoc.t ) -> (Ast.MuMutable
                                :'opt_mutable )))))]))])))) ());
    Gram.extend (opt_virtual :'opt_virtual Gram.t  )
      (((fun () ->
           (None,([(None,None,([([],(Gram.mk_action
                                       ((fun (_loc : FanLoc.t ) -> (Ast.ViNil
                                           :'opt_virtual )))));(([`Stoken
           (((function
              | `ANTIQUOT (("virtual"|"anti"),_) -> true
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"virtual\"|\"anti\"),_)"))]),(
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun (_loc : FanLoc.t ) ->
                   match __camlp4_0 with
                   ...
                   | _ -> assert false))));(([`Skeyword
           "virtual"]),(Gram.mk_action
                          ((fun _ ->
                              fun (_loc : FanLoc.t ) -> (Ast.ViVirtual
                                :'opt_virtual )))))]))])))) ());
    Gram.extend (opt_dot_dot :'opt_dot_dot Gram.t  )
      (((fun () ->
           (None,([(None,None,([([],(Gram.mk_action
                                       ((fun (_loc : FanLoc.t ) -> (Ast.RvNil
                                           :'opt_dot_dot )))));(([`Stoken
           (((function
              | `ANTIQUOT ((".."|"anti"),_) -> true
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"..\"|\"anti\"),_)"))]),(
           ...
           ".."]),(Gram.mk_action
                     ((fun _ ->
                         fun (_loc : FanLoc.t ) -> (Ast.RvRowVar
                           :'opt_dot_dot )))))]))])))) ());
    Gram.extend (opt_rec :'opt_rec Gram.t  )
      (((fun () ->
           (None,([(None,None,([([],(Gram.mk_action
                                       ((fun (_loc : FanLoc.t ) -> (Ast.ReNil
                                           :'opt_rec )))));(([`Stoken
           (((function
              | `ANTIQUOT (("rec"|"anti"),_) -> true
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"rec\"|\"anti\"),_)"))]),(
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun (_loc : FanLoc.t ) ->
                   match __camlp4_0 with
           ...
           "rec"]),(Gram.mk_action
                      ((fun _ ->
                          fun (_loc : FanLoc.t ) -> (Ast.ReRecursive
                            :'opt_rec )))))]))])))) ());
    ...
    Gram.extend (opt_expr :'opt_expr Gram.t  )
      (((fun () ->
           (None,([(None,None,([([],(Gram.mk_action
                                       ((fun (_loc : FanLoc.t ) ->
                                           (Ast.ExNil _loc :'opt_expr )))));(([`Snterm
           (Gram.obj (expr :'expr Gram.t  ))]),(Gram.mk_action
                                                  ((fun (e : 'expr) ->
                                                      fun (_loc : FanLoc.t )
                                                        -> (e :'opt_expr )))))]))]))))
    ...
    Gram.extend (interf :'interf Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Stoken
           (((function
              | `EOI -> true
              | _ -> false)),(`Normal,"`EOI"))]),(Gram.mk_action
                                                    ((fun __camlp4_0 ->
                                                        fun
                                                          (_loc : FanLoc.t )
                                                          ->
                                                             ...
                                                             fun _ ->
                                                               fun
                                                                 ...
                                                                 fun
                                                                   ...
                                                                   (((si::sil),stopped)
                                                                   :'interf )))));(([`Skeyword
           "#";`Snterm (Gram.obj (a_LIDENT :'a_LIDENT Gram.t  ));`Snterm
           (Gram.obj (opt_expr :'opt_expr Gram.t  ));`Snterm
           (Gram.obj (semi :'semi Gram.t  ))]),(Gram.mk_action
                                                  ((fun _ ->
                                                      fun (dp : 'opt_expr) ->
                                                        fun (n : 'a_LIDENT)
    ...
    Gram.extend (sig_items :'sig_items Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Slist0
           ...
           Gram.mk_action
             ((fun (l : 'e__24 list ) ->
                 fun (_loc : FanLoc.t ) -> (Ast.sgSem_of_list l :'sig_items )))));(([`Stoken
           (((function
              | `ANTIQUOT ((""|"sigi"|"anti"|"list"),_) -> true
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"\"|\"sigi\"|\"anti\"|\"list\"),_)"));`Snterm
           (Gram.obj (semi :'semi Gram.t  ));`Sself]),(Gram.mk_action
                                                         ((fun
                                                             (sg :
                                                               'sig_items) ->
    ...
    Gram.extend (str_items :'str_items Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Slist0
           ...
           Gram.mk_action
             ((fun (l : 'e__25 list ) ->
                 fun (_loc : FanLoc.t ) -> (Ast.stSem_of_list l :'str_items )))));(([`Stoken
           (((function
              | `ANTIQUOT ((""|"stri"|"anti"|"list"),_) -> true
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"\"|\"stri\"|\"anti\"|\"list\"),_)"));`Snterm
           (Gram.obj (semi :'semi Gram.t  ));`Sself]),(Gram.mk_action
                                                         ((fun
                                                             (st :
                                                               'str_items) ->
                                                    ...
                                                    ((fun __camlp4_0 ->
                                                        fun
                                                          ...
                                                          | `EOI -> (
                                                              ...
                                                              :'top_phrase )
                                                          | _ -> assert false))));(([`Snterm
           (Gram.obj (phrase :'phrase Gram.t  ))]),(Gram.mk_action
                                                      ((fun (ph : 'phrase) ->
                                                          fun
                                                            (_loc :
                                                              FanLoc.t ) ->
                                                  ...
                                                  ((fun _ ->
                                                      fun (st : 'str_item) ->
                                                        fun
                                                          ...
                                                          -> (st :'phrase )))));(([`Skeyword
           "#";`Snterm (Gram.obj (a_LIDENT :'a_LIDENT Gram.t  ));`Snterm
           (Gram.obj (opt_expr :'opt_expr Gram.t  ));`Skeyword
           ";;"]),(Gram.mk_action
                     ((fun _ ->
                         fun (dp : 'opt_expr) ->
                           fun (n : 'a_LIDENT) ->
    ...
    Gram.extend (a_INT :'a_INT Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Stoken
           (((function
              | `INT (_,_) -> true
              | _ -> false)),(`Normal,"`INT (_,_)"))]),(Gram.mk_action
                                                          ((fun __camlp4_0 ->
                                                              fun
                                                                (_loc :
                                                                  FanLoc.t )
           ...
           (((function
              ...
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"\"|\"int\"|\"`int\"),_)"))]),(
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun (_loc : FanLoc.t ) ->
                   match __camlp4_0 with
    ...
    Gram.extend (a_INT32 :'a_INT32 Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Stoken
           (((function
              | `INT32 (_,_) -> true
              | _ -> false)),(`Normal,"`INT32 (_,_)"))]),(Gram.mk_action
                                                            ((fun __camlp4_0
                                                                ->
                                                                fun
                                                                  (_loc :
           ...
           (((function
              ...
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"\"|\"int32\"|\"`int32\"),_)"))]),(
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun (_loc : FanLoc.t ) ->
                   match __camlp4_0 with
    ...
    Gram.extend (a_INT64 :'a_INT64 Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Stoken
           (((function
              | `INT64 (_,_) -> true
              | _ -> false)),(`Normal,"`INT64 (_,_)"))]),(Gram.mk_action
                                                            ((fun __camlp4_0
                                                                ->
                                                                fun
                                                                  (_loc :
           ...
           (((function
              ...
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"\"|\"int64\"|\"`int64\"),_)"))]),(
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun (_loc : FanLoc.t ) ->
                   match __camlp4_0 with
    ...
    Gram.extend (a_NATIVEINT :'a_NATIVEINT Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Stoken
           (((function
              | `NATIVEINT (_,_) -> true
              | _ -> false)),(`Normal,"`NATIVEINT (_,_)"))]),(Gram.mk_action
                                                                ((fun
                                                                    __camlp4_0
                                                                    ->
                                                                    fun
           ...
           (((function
              ...
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"\"|\"nativeint\"|\"`nativeint\"),_)"))]),(
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun (_loc : FanLoc.t ) ->
                   match __camlp4_0 with
    ...
    Gram.extend (a_FLOAT :'a_FLOAT Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Stoken
           (((function
              | `FLOAT (_,_) -> true
              | _ -> false)),(`Normal,"`FLOAT (_,_)"))]),(Gram.mk_action
                                                            ((fun __camlp4_0
                                                                ->
                                                                fun
                                                                  (_loc :
           ...
           (((function
              ...
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"\"|\"flo\"|\"`flo\"),_)"))]),(
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun (_loc : FanLoc.t ) ->
                   match __camlp4_0 with
    ...
    Gram.extend (a_CHAR :'a_CHAR Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Stoken
           (((function
              | `CHAR (_,_) -> true
              | _ -> false)),(`Normal,"`CHAR (_,_)"))]),(Gram.mk_action
                                                           ((fun __camlp4_0
                                                               ->
                                                               fun
                                                                 (_loc :
           ...
           (((function
              ...
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"\"|\"chr\"|\"`chr\"),_)"))]),(
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun (_loc : FanLoc.t ) ->
                   match __camlp4_0 with
    ...
    Gram.extend (a_LABEL :'a_LABEL Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Stoken
           (((function
              | `LABEL _ -> true
              | _ -> false)),(`Normal,"`LABEL _"))]),(Gram.mk_action
                                                        ((fun __camlp4_0 ->
                                                            fun
                                                              (_loc :
                                                                FanLoc.t ) ->
    ...
    Gram.extend (a_OPTLABEL :'a_OPTLABEL Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Stoken
           (((function
              | `OPTLABEL _ -> true
              | _ -> false)),(`Normal,"`OPTLABEL _"))]),(Gram.mk_action
                                                           ((fun __camlp4_0
                                                               ->
                                                               fun
                                                                 (_loc :
    ...
    Gram.extend (a_STRING :'a_STRING Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Stoken
           ...
           (((function
              ...
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"\"|\"str\"|\"`str\"),_)"))]),(
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun (_loc : FanLoc.t ) ->
                   match __camlp4_0 with
    ...
    Gram.extend (string_list :'string_list Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Stoken
           ...
           (((function
              | `STRING (_,_) -> true
              | _ -> false)),(`Normal,"`STRING (_,_)"));`Sself]),(Gram.mk_action
                                                                    ((
                                                                    fun
                                                                    (xs :
                                                                    'string_list)
           ...
           (((function
              ...
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"\"|\"str_list\"),_)"))]),(
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun (_loc : FanLoc.t ) ->
                   match __camlp4_0 with
    ...
    Gram.extend (expr_quot :'expr_quot Gram.t  )
      (((fun () ->
           (None,([(None,None,([([],(Gram.mk_action
                                       ((fun (_loc : FanLoc.t ) ->
                                           (Ast.ExNil _loc :'expr_quot )))));(([`Snterm
           (Gram.obj (expr :'expr Gram.t  ))]),(Gram.mk_action
                                                  ((fun (e : 'expr) ->
                                                      fun (_loc : FanLoc.t )
                                                        -> (e :'expr_quot )))));(([`Snterm
           (Gram.obj (expr :'expr Gram.t  ));`Skeyword ";";`Snterm
           (Gram.obj (sem_expr :'sem_expr Gram.t  ))]),(Gram.mk_action
                                                          ((fun
                                                              (e2 :
                                                                'sem_expr) ->
                                                              fun _ ->
           ...
           (Gram.obj (expr :'expr Gram.t  ));`Skeyword ",";`Snterm
           (Gram.obj (comma_expr :'comma_expr Gram.t  ))]),(Gram.mk_action
                                                              ((fun
                                                                  (e2 :
                                                                    'comma_expr)
                                                                  ->
    ...
    Gram.extend (patt_quot :'patt_quot Gram.t  )
      (((fun () ->
           (None,([(None,None,([([],(Gram.mk_action
                                       ((fun (_loc : FanLoc.t ) ->
                                           (Ast.PaNil _loc :'patt_quot )))));(([`Snterm
           (Gram.obj (patt :'patt Gram.t  ))]),(Gram.mk_action
                                                  ((fun (x : 'patt) ->
                                                      fun (_loc : FanLoc.t )
                                                        -> (x :'patt_quot )))));(([`Snterm
                                                      ...
                                                      fun _ ->
                                                        fun (x : 'patt) ->
                                                          fun
                                                            ...
                                                            :'patt_quot )))));(([`Snterm
           (Gram.obj (patt :'patt Gram.t  ));`Skeyword ";";`Snterm
           (Gram.obj (sem_patt :'sem_patt Gram.t  ))]),(Gram.mk_action
                                                          ((fun
                                                              (y : 'sem_patt)
                                                              ->
                                                              fun _ ->
           ...
           (Gram.obj (patt :'patt Gram.t  ));`Skeyword ",";`Snterm
           (Gram.obj (comma_patt :'comma_patt Gram.t  ))]),(Gram.mk_action
                                                              ((fun
                                                                  (y :
                                                                    'comma_patt)
                                                                  ->
    ...
    Gram.extend (ctyp_quot :'ctyp_quot Gram.t  )
      (((fun () ->
           (None,([(None,None,([([],(Gram.mk_action
                                       ((fun (_loc : FanLoc.t ) ->
                                           (Ast.TyNil _loc :'ctyp_quot )))));(([`Snterm
           (Gram.obj (more_ctyp :'more_ctyp Gram.t  ))]),(Gram.mk_action
                                                            ((fun
                                                                (x :
                                                                  'more_ctyp)
                                                                ->
           ...
           (Gram.obj (more_ctyp :'more_ctyp Gram.t  ));`Skeyword
           "and";`Snterm
           (Gram.obj (constructor_arg_list :'constructor_arg_list Gram.t  ))]),(
           Gram.mk_action
                 ...
                 fun _ ->
                   fun (x : 'more_ctyp) ->
                     fun (_loc : FanLoc.t ) -> (Ast.TyAnd (_loc,x,y)
                       :'ctyp_quot )))));(([`Snterm
           (Gram.obj (more_ctyp :'more_ctyp Gram.t  ));`Skeyword "&";`Snterm
           (Gram.obj (amp_ctyp :'amp_ctyp Gram.t  ))]),(Gram.mk_action
                                                          ((fun
                                                              (y : 'amp_ctyp)
                                                              ->
           ...
           (Gram.obj (more_ctyp :'more_ctyp Gram.t  ));`Skeyword "*";`Snterm
           (Gram.obj (star_ctyp :'star_ctyp Gram.t  ))]),(Gram.mk_action
                                                            ((fun
                                                                (y :
                                                                  'star_ctyp)
                                                                ->
           ...
           (Gram.obj (more_ctyp :'more_ctyp Gram.t  ));`Skeyword
           "of";`Skeyword "&";`Snterm
           (Gram.obj (amp_ctyp :'amp_ctyp Gram.t  ));`Skeyword "|";`Snterm
           (Gram.obj (row_field :'row_field Gram.t  ))]),(Gram.mk_action
                                                            ((fun
                                                                (z :
                                                                  'row_field)
                                                                ->
           ...
           (Gram.obj (more_ctyp :'more_ctyp Gram.t  ));`Skeyword "of";`Snterm
           (Gram.obj (constructor_arg_list :'constructor_arg_list Gram.t  ));`Skeyword
           "|";`Snterm
           (Gram.obj (constructor_declarations
              :'constructor_declarations Gram.t  ))]),(Gram.mk_action
                                                         ((fun
                                                             (z :
                                                               'constructor_declarations)
                                                             ->
                          ...
                          fun _ ->
                            fun (x : 'more_ctyp) ->
                              fun (_loc : FanLoc.t ) -> (Ast.TySem (_loc,x,y)
                                :'ctyp_quot )))));(([`Snterm
           (Gram.obj (more_ctyp :'more_ctyp Gram.t  ));`Skeyword ",";`Snterm
           (Gram.obj (comma_ctyp :'comma_ctyp Gram.t  ))]),(Gram.mk_action
                                                              ((fun
                                                                  (y :
                                                                    'comma_ctyp)
                                                                  ->
    ...
    Gram.extend (str_item_quot :'str_item_quot Gram.t  )
      (((fun () ->
           (None,([(None,None,([([],(Gram.mk_action
                                       ((fun (_loc : FanLoc.t ) ->
                                           (Ast.StNil _loc :'str_item_quot )))));(([`Snterm
           (Gram.obj (str_item :'str_item Gram.t  ))]),(Gram.mk_action
                                                          ((fun
                                                              (st :
                                                                'str_item) ->
                                                              fun
           ...
           "#";`Snterm (Gram.obj (a_LIDENT :'a_LIDENT Gram.t  ));`Snterm
           (Gram.obj (opt_expr :'opt_expr Gram.t  ))]),(Gram.mk_action
                                                          ((fun
                                                              (dp :
                                                                'opt_expr) ->
                                                              fun
    ...
    Gram.extend (sig_item_quot :'sig_item_quot Gram.t  )
      (((fun () ->
           (None,([(None,None,([([],(Gram.mk_action
                                       ((fun (_loc : FanLoc.t ) ->
                                           (Ast.SgNil _loc :'sig_item_quot )))));(([`Snterm
           (Gram.obj (sig_item :'sig_item Gram.t  ))]),(Gram.mk_action
                                                          ((fun
                                                              (sg :
                                                                'sig_item) ->
                                                              fun
    ...
    Gram.extend (binding_quot :'binding_quot Gram.t  )
      (((fun () ->
           (None,([(None,None,([([],(Gram.mk_action
                                       ((fun (_loc : FanLoc.t ) ->
                                           (Ast.BiNil _loc :'binding_quot )))));(([`Snterm
           (Gram.obj (binding :'binding Gram.t  ))]),(Gram.mk_action
                                                        ((fun (x : 'binding)
                                                            ->
                                                            fun
    ...
    Gram.extend (rec_binding_quot :'rec_binding_quot Gram.t  )
      (((fun () ->
           ...
           (Gram.obj (label_expr_list :'label_expr_list Gram.t  ))]),(
           Gram.mk_action
    ...
    Gram.extend (module_binding_quot :'module_binding_quot Gram.t  )
      (((fun () ->
           ...
           (((function
              ...
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"module_binding\"|\"anti\"),_)"))]),(
           Gram.mk_action
             ((fun __camlp4_0 ->
                 fun (_loc : FanLoc.t ) ->
                   match __camlp4_0 with
      ...
      (((fun () ->
           ...
           ")"]),(Gram.mk_action
                    ((fun _ ->
                        fun (i : 'ident_quot) ->
                          fun _ ->
                            fun (_loc : FanLoc.t ) -> (i :'ident_quot )))));(([`Stoken
           (((function
              | `ANTIQUOT ((""|"id"|"anti"|"list"),_) -> true
              | _ -> false)),(`Normal,"`ANTIQUOT ((\"\"|\"id\"|\"anti\"|\"list\"),_)"));`Skeyword
           ".";`Sself]),(Gram.mk_action
    ...
    Gram.extend (class_expr_quot :'class_expr_quot Gram.t  )
      (((fun () ->
           ...
           (((function
              ...
              | _ -> false)),(`Normal,"`ANTIQUOT (\"virtual\",_)"));`Snterm
           (Gram.obj (ident :'ident Gram.t  ));`Snterm
           (Gram.obj (opt_comma_ctyp :'opt_comma_ctyp Gram.t  ))]),(Gram.mk_action
                                                                    ((fun
                                                                    (ot :
                                                                    'opt_comma_ctyp)
                                                                    ->
             ...
             ((fun ((i,ot) : 'class_name_and_param) ->
                 fun _ ->
                   fun (_loc : FanLoc.t ) ->
                     ...
                     :'class_expr_quot )))));(([`Sself;`Skeyword
           "=";`Sself]),(Gram.mk_action
      ...
      (((fun () ->
           ...
           Gram.mk_action
             ((fun (x : 'class_type_plus) ->
                 fun (_loc : FanLoc.t ) -> (x :'class_type_quot )))));(([`Stoken
           (((function
              | `ANTIQUOT ("virtual",_) -> true
              | _ -> false)),(`Normal,"`ANTIQUOT (\"virtual\",_)"));`Snterm
           (Gram.obj (ident :'ident Gram.t  ));`Snterm
    ...
    Gram.extend (class_str_item_quot :'class_str_item_quot Gram.t  )
      (((fun () ->
           (None,([(None,None,([([],(Gram.mk_action
                                       ((fun (_loc : FanLoc.t ) ->
                                           (Ast.CrNil _loc
                                           :'class_str_item_quot )))));(([`Snterm
           (Gram.obj (class_str_item :'class_str_item Gram.t  ))]),(Gram.mk_action
                                                                    ((fun
                                                                    (x :
                                                                    'class_str_item)
                                                                    ->
    ...
    Gram.extend (class_sig_item_quot :'class_sig_item_quot Gram.t  )
      (((fun () ->
           (None,([(None,None,([([],(Gram.mk_action
                                       ((fun (_loc : FanLoc.t ) ->
                                           (Ast.CgNil _loc
                                           :'class_sig_item_quot )))));(([`Snterm
           (Gram.obj (class_sig_item :'class_sig_item Gram.t  ))]),(Gram.mk_action
                                                                    ((fun
                                                                    (x :
                                                                    'class_sig_item)
                                                                    ->
    ...
    Gram.extend (rec_flag_quot :'rec_flag_quot Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Snterm
           (Gram.obj (opt_rec :'opt_rec Gram.t  ))]),(Gram.mk_action
                                                        ((fun (x : 'opt_rec)
                                                            ->
                                                            fun
                                                              (_loc :
    ...
    Gram.extend (direction_flag_quot :'direction_flag_quot Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Snterm
           (Gram.obj (direction_flag :'direction_flag Gram.t  ))]),(Gram.mk_action
                                                                    ((fun
                                                                    (x :
                                                                    'direction_flag)
                                                                    ->
    ...
    Gram.extend (mutable_flag_quot :'mutable_flag_quot Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Snterm
           (Gram.obj (opt_mutable :'opt_mutable Gram.t  ))]),(Gram.mk_action
                                                                ((fun
                                                                    (x :
                                                                    'opt_mutable)
                                                                    ->
    ...
    Gram.extend (private_flag_quot :'private_flag_quot Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Snterm
           (Gram.obj (opt_private :'opt_private Gram.t  ))]),(Gram.mk_action
                                                                ((fun
                                                                    (x :
                                                                    'opt_private)
                                                                    ->
    ...
    Gram.extend (virtual_flag_quot :'virtual_flag_quot Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Snterm
           (Gram.obj (opt_virtual :'opt_virtual Gram.t  ))]),(Gram.mk_action
                                                                ((fun
                                                                    (x :
                                                                    'opt_virtual)
                                                                    ->
    ...
    Gram.extend (override_flag_quot :'override_flag_quot Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Snterm
           (Gram.obj (opt_override :'opt_override Gram.t  ))]),(Gram.mk_action
                                                                  ((fun
                                                                    (x :
                                                                    'opt_override)
                                                                    ->
    ...
    Gram.extend (patt_eoi :'patt_eoi Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Snterm
           (Gram.obj (patt :'patt Gram.t  ));`Stoken
           (((function
              | `EOI -> true
              | _ -> false)),(`Normal,"`EOI"))]),(Gram.mk_action
                                                    ((fun __camlp4_0 ->
    ...
    Gram.extend (expr_eoi :'expr_eoi Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Snterm
           (Gram.obj (expr :'expr Gram.t  ));`Stoken
           (((function
              | `EOI -> true
              | _ -> false)),(`Normal,"`EOI"))]),(Gram.mk_action
                                                    ((fun __camlp4_0 ->
...
module MakeRevisedParserParser(Syntax:Sig.Camlp4Syntax) =
  ...
  let peek_fun _loc =
    Ast.ExId
      (_loc,(Ast.IdAcc
               (_loc,(Ast.IdUid (_loc,"Stream")),(Ast.IdLid (_loc,"peek")))))
  let junk_fun _loc =
    Ast.ExId
      (_loc,(Ast.IdAcc
               (_loc,(Ast.IdUid (_loc,"Stream")),(Ast.IdLid (_loc,"junk")))))
  ...
  let rec subst v e =
    ...
    | Ast.BiEq (_loc,Ast.PaId (_,Ast.IdLid (_,v')),e) ->
        Ast.BiEq
          (_loc,(Ast.PaId (_loc,(Ast.IdLid (_loc,v')))),(if v = v'
                                                         then e
                                                         else subst v e))
    | _ -> raise Not_found
        ...
        Ast.ExMat
          ...
          Ast.McOr
            (_loc,(Ast.McArr
                     (_loc,(Ast.PaApp
                              (_loc,(Ast.PaId
                                       (_loc,(Ast.IdUid (_loc,"Some")))),p)),w,(
                     Ast.ExSeq
                       (_loc,(Ast.ExSem
                                (_loc,(Ast.ExApp
                                         (_loc,(junk_fun _loc),(Ast.ExId
                                                                  (_loc,(
                                                                  Ast.IdLid
                                                                    (_loc,strm_n)))))),skont)))))),(
            Ast.McArr (_loc,(Ast.PaAny _loc),(Ast.ExNil _loc),ckont)))))
        ...
        let e =
          (match e with
           | Ast.ExFun
               ...
               when v = strm_n -> e
           | _ ->
               Ast.ExApp (_loc,e,(Ast.ExId (_loc,(Ast.IdLid (_loc,strm_n)))))) in
                  ...
                  Ast.McOr
                    (_loc,(Ast.McArr
                             (_loc,(Ast.PaApp
                                      (_loc,(Ast.PaId
                                               (_loc,(Ast.IdUid (_loc,"Some")))),p)),(
                             Ast.ExNil _loc),skont)),(Ast.McArr
                                                        (_loc,(Ast.PaAny _loc),(
                                                        Ast.ExNil _loc),ckont)))))
    | SpStr (_loc,p) ->
        (try
         ...
         | Not_found  ->
             Ast.ExLet
               (_loc,Ast.ReNil,(Ast.BiEq
                                  (_loc,p,(Ast.ExId
                                             (_loc,(Ast.IdLid (_loc,strm_n)))))),skont))
    ...
    | (spc,err)::spcl ->
        let skont =
          let ekont err =
            ...
            Ast.ExApp
              (_loc,(Ast.ExId (_loc,(Ast.IdLid (_loc,"raise")))),(Ast.ExApp
                                                                    (_loc,(
                                                                    Ast.ExId
                                                                    (_loc,(
                                                                    Ast.IdAcc
  ...
  let stream_patterns_term _loc ekont tspel =
    ...
    Ast.ExMat
      ...
      Ast.McOr
        (_loc,pel,(Ast.McArr
                     (_loc,(Ast.PaAny _loc),(Ast.ExNil _loc),(ekont ()))))))
  let rec group_terms =
    function
  ...
  let rec parser_cases _loc =
    ...
    | [] ->
        Ast.ExApp
          (_loc,(Ast.ExId (_loc,(Ast.IdLid (_loc,"raise")))),(Ast.ExId
                                                                (_loc,(
                                                                Ast.IdAcc
                                                                  (_loc,(
                                                                  Ast.IdUid
    ...
    | spel ->
        (match group_terms spel with
         | ([],(spcl,epo,e)::spel) ->
             stream_pattern _loc epo e ((fun _ -> parser_cases _loc spel))
               spcl
         | (tspel,spel) ->
                                           ...
                                           (_loc,(Ast.ExId
                                                    (_loc,(Ast.IdAcc
                                                             ...
                                                             Ast.IdLid
                                                               (_loc,"count")))))),(
                                           Ast.ExId
                                             (_loc,(Ast.IdLid (_loc,strm_n)))))))),e)
      | None  -> e in
    let p =
      Ast.PaTyc
        (_loc,(Ast.PaId (_loc,(Ast.IdLid (_loc,strm_n)))),(Ast.TyApp
                                                             (_loc,(Ast.TyId
                                                                    (_loc,(
                                                                    Ast.IdAcc
                                                                    (_loc,(
  ...
  let rec cstream gloc =
    ...
    | [] ->
        ...
        Ast.ExId
          (_loc,(Ast.IdAcc
                   (_loc,(Ast.IdUid (_loc,"Stream")),(Ast.IdLid
                                                        (_loc,"sempty")))))
    | SeTrm (_loc,e)::[] ->
        if not_computing e
        then
  ...
  let _=
    ...
    Gram.extend (expr :'expr Gram.t  )
      (((fun () -> ((Some (`Level "top")),([(None,None,([(([`Skeyword
           "match";`Snterm
           (Gram.obj (sequence :'sequence Gram.t  ));`Skeyword
           "with";`Skeyword "parser";`Sopt (`Snterm
           (Gram.obj (parser_ipatt :'parser_ipatt Gram.t  )));`Snterm
                   ...
                   fun _ ->
                     fun _ ->
                       fun (e : 'sequence) ->
                         fun _ ->
                           fun (_loc : FanLoc.t ) ->
                             (cparser_match _loc e po pcl :'expr )))));(([`Skeyword
           "parser";`Sopt (`Snterm
           (Gram.obj (parser_ipatt :'parser_ipatt Gram.t  )));`Snterm
           (Gram.obj (parser_case_list :'parser_case_list Gram.t  ))]),(
           Gram.mk_action
    ...
    Gram.extend (parser_ipatt :'parser_ipatt Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Skeyword
           "_"]),(Gram.mk_action
                    ((fun _ ->
                        fun (_loc : FanLoc.t ) -> (Ast.PaAny _loc
                          :'parser_ipatt )))));(([`Snterm
           (Gram.obj (a_LIDENT :'a_LIDENT Gram.t  ))]),(Gram.mk_action
                                                          ((fun
                                                              (i : 'a_LIDENT)
    ...
    Gram.extend (parser_case_list :'parser_case_list Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Snterm
           (Gram.obj (parser_case :'parser_case Gram.t  ))]),(Gram.mk_action
                                                                ((fun
                                                                    (pc :
                                                                    'parser_case)
                                                                    ->
           ...
           "[";`Slist0sep ((`Snterm
           (Gram.obj (parser_case :'parser_case Gram.t  ))),(`Skeyword
           "|"));`Skeyword
           "]"]),(Gram.mk_action
                    ((fun _ ->
    ...
    Gram.extend (parser_case :'parser_case Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Snterm
           (Gram.obj (stream_begin :'stream_begin Gram.t  ));`Snterm
           (Gram.obj (stream_patt :'stream_patt Gram.t  ));`Snterm
           (Gram.obj (stream_end :'stream_end Gram.t  ));`Sopt (`Snterm
           (Gram.obj (parser_ipatt :'parser_ipatt Gram.t  )));`Skeyword
           "->";`Snterm
           (Gram.obj (expr :'expr Gram.t  ))]),(Gram.mk_action
                                                  ((fun (e : 'expr) ->
                                                      fun _ ->
    ...
    Gram.extend (stream_patt :'stream_patt Gram.t  )
      (((fun () ->
           (None,([(None,None,([([],(Gram.mk_action
                                       ((fun (_loc : FanLoc.t ) -> ([]
                                           :'stream_patt )))));(([`Snterm
           (Gram.obj (stream_patt_comp :'stream_patt_comp Gram.t  ));`Skeyword
           ";";`Snterm
           (Gram.obj (stream_patt_comp_err_list
              :'stream_patt_comp_err_list Gram.t  ))]),(Gram.mk_action
                                                          ((fun
                                                              (sp :
    ...
    Gram.extend (stream_patt_comp :'stream_patt_comp Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Snterm
           (Gram.obj (stream_quot :'stream_quot Gram.t  ));`Snterm
           (Gram.obj (patt :'patt Gram.t  ))]),(Gram.mk_action
                                                  ((fun (p : 'patt) ->
                                                      fun _ ->
                                                        fun
           ...
           (Gram.obj (patt :'patt Gram.t  ));`Skeyword "=";`Snterm
           (Gram.obj (stream_expr :'stream_expr Gram.t  ))]),(Gram.mk_action
                                                                ((fun
                                                                    (e :
                                                                    'stream_expr)
                                                                    ->
           ...
           (Gram.obj (patt :'patt Gram.t  ));`Sopt
           (Gram.srules stream_patt_comp ([(([`Skeyword "when";`Snterm
              (Gram.obj (stream_expr :'stream_expr Gram.t  ))]),(Gram.mk_action
                                                                   ((
                                                                   fun
                                                                    (e :
    ...
    Gram.extend (stream_patt_comp_err :'stream_patt_comp_err Gram.t  )
      (((fun () -> (None,([(None,None,([(([`Snterm
           (Gram.obj (stream_patt_comp :'stream_patt_comp Gram.t  ));`Sopt
           (Gram.srules stream_patt_comp_err ([(([`Skeyword "??";`Snterm
              (Gram.obj (stream_expr :'stream_expr Gram.t  ))]),(Gram.mk_action
                                                                   ((
                                                                   fun
                                                                    (e :
    ...
    Gram.extend (stream_patt_comp_err_list
      ...
      (((fun () -> (None,([(None,None,([(([`Snterm
           (Gram.obj (stream_patt_comp_err :'stream_patt_comp_err Gram.t  ));`Skeyword
           ";";`Sself]),(Gram.mk_action
                           ((fun (sp : 'stream_patt_comp_err_list) ->
                               fun _ ->
                                 fun (spc : 'stream_patt_comp_err) ->
                                   fun (_loc : FanLoc.t ) -> (spc::sp
                                     :'stream_patt_comp_err_list )))));(([`Snterm
           (Gram.obj (stream_patt_comp_err :'stream_patt_comp_err Gram.t  ));`Skeyword
           ";"]),(Gram.mk_action
                    ((fun _ ->
                        fun (spc : 'stream_patt_comp_err) ->
    ...
    Gram.extend (expr :'expr Gram.t  )
      (((fun () -> ((Some (`Level "simple")),([(None,None,([(([`Snterm
           (Gram.obj (stream_begin :'stream_begin Gram.t  ));`Snterm
           (Gram.obj (stream_expr_comp_list :'stream_expr_comp_list Gram.t  ));`Snterm
           (Gram.obj (stream_end :'stream_end Gram.t  ))]),(Gram.mk_action
                                                              ((fun _ ->
                                                                  fun
                                                                    (sel :
      ...
      (((fun () -> (None,([(None,None,([(([`Snterm
           ...
           Gram.mk_action
             ((fun (se : 'stream_expr_comp) ->
                 fun (_loc : FanLoc.t ) -> ([se] :'stream_expr_comp_list )))));(([`Snterm
           (Gram.obj (stream_expr_comp :'stream_expr_comp Gram.t  ));`Skeyword
           ";"]),(Gram.mk_action
                    ((fun _ ->
                        fun (se : 'stream_expr_comp) ->
                          fun (_loc : FanLoc.t ) -> ([se]
                            :'stream_expr_comp_list )))));(([`Snterm
           (Gram.obj (stream_expr_comp :'stream_expr_comp Gram.t  ));`Skeyword
           ";";`Sself]),(Gram.mk_action
