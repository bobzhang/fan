                 ...
                 [(None  , None  , (
                   [((
                     [`Snterm
                      ...
                      `Sopt
                       (`Snterm ((Gram.obj ( (global : 'global  Gram.t ) ) )));
                      `Slist1
                         ...
                         fun ((_loc : FanLoc.t)) ->
                           (match __camlp4_0 with
                            | (`STRING (_ , s )) ->
                               ((mk_symbol ~used:[]  ~text:(
                                  (TXkwd (_loc , s )) ) ~styp:(
                                  (STtok (_loc)) ) ~pattern:None  ) : 'symbol
                                 )
                            | _ -> assert false) ) ) ) );
                    ((
                     [`Skeyword ("`");
                   ...
                   [((
                    ...
                    ((
                     [`Stry
                       (`Snterm
                         ((Gram.obj (
                            (val_longident : 'val_longident  Gram.t ) ) )))]
                     ) , (
                     (Gram.mk_action (
                       fun ((i : 'val_longident )) ->
                         fun ((_loc : FanLoc.t)) ->
                   ...
                   [((
                    ...
                    ((
                     [`Stry
                       (`Snterm
                         ((Gram.obj (
                            (labeled_ipatt : 'labeled_ipatt  Gram.t ) ) )));
                      `Sself] ) , (
                     (Gram.mk_action (
                       fun ((e : 'fun_binding )) ->
                         fun ((p : 'labeled_ipatt )) ->
                               ...
                               fun (_) ->
                                 fun ((_loc : FanLoc.t)) ->
                                   ((Ast.CgMth (_loc , l , pf , t )) :
                                     'class_sig_item ) ) ) ) );
                    ((
                     [`Skeyword ("method"); `Skeyword ("virtual");
                      `Snterm
                       ((Gram.obj ( (opt_private : 'opt_private  Gram.t ) ) ));
                      `Snterm ((Gram.obj ( (label : 'label  Gram.t ) ) ));
                      `Skeyword (":");
              ...
              Ast.TyApp
               (_ ,
                Ast.TyId
                 (_ ,
                  Ast.IdAcc
                   (_ , Ast.IdUid (_ , "Stream" ) , Ast.IdLid (_ , "t" ) ) )
                , Ast.TyAny (_) ) ) , Ast.ExNil (_) , e ) ) when (v = strm_n) ->
         e
      | _ ->
         (Ast.ExApp
           (_loc , e , (
       ...
       (_loc , (
        (Ast.TyId
          (_loc , (
           (Ast.IdAcc
             (_loc , ( (Ast.IdUid (_loc , "Stream" )) ) , (
              (Ast.IdLid (_loc , "t" )) ) )) ) )) ) , ( (Ast.TyAny (_loc)) )
        )) ) )) in
  (Ast.ExFun
    (_loc , ( (Ast.McArr (_loc , p , ( (Ast.ExNil (_loc)) ) , e )) ) ))
