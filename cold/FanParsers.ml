...
module MakeGrammarParser(Syntax:Sig.Camlp4Syntax) = struct
  ...
  let _ =
    ...
    let delete_rule_body:'delete_rule_body Gram.t 
      ...
      =grammar_entry_create "extend_body" and
      extend_header:'extend_header Gram.t 
      =grammar_entry_create "extend_header" and
                  ...
                  fun _ ->
                    fun (_loc : FanLoc.t ) ->
                      (let p =
                         ...
                         | Some p ->
                             Ast.PaApp (( _loc ), (Ast.PaVrn (( _loc ), i)),
                               p) in
                       let (p,ls) =
...
module MakeMacroParser(Syntax:Sig.Camlp4Syntax) = struct
  ...
  let _ =
    ...
    let macro_def:'macro_def Gram.t  =grammar_entry_create "macro_def" and
      ...
      =grammar_entry_create "sglist_else" and
      sglist_then:'sglist_then Gram.t  =grammar_entry_create "sglist_then"
      and smlist_else:'smlist_else Gram.t 
      =grammar_entry_create "smlist_else" and
      ...
      =grammar_entry_create "else_macro_def_sig" and
      else_macro_def:'else_macro_def Gram.t 
      =grammar_entry_create "else_macro_def" and
      uident_eval_ifndef:'uident_eval_ifndef Gram.t 
      =grammar_entry_create "uident_eval_ifndef" and
      uident_eval_ifdef:'uident_eval_ifdef Gram.t 
      =grammar_entry_create "uident_eval_ifdef" and
             ...
             (fun (x : 'macro_def) ->
                fun (_loc : FanLoc.t ) ->
                  (execute_macro (Ast.StNil ( _loc ))
                     (fun a -> fun b -> Ast.StSem (( _loc ), a, b)) x
                  :'str_item ))))])])) ());
             ...
             (fun (x : 'macro_def_sig) ->
                fun (_loc : FanLoc.t ) ->
                  (execute_macro (Ast.SgNil ( _loc ))
                     (fun a -> fun b -> Ast.SgSem (( _loc ), a, b)) x
                  :'sig_item ))))])])) ());
                      ...
                      fun __camlp4_0 ->
                        fun _ ->
                          fun (_loc : FanLoc.t ) ->
                            match ( __camlp4_0 ) with
                            | `LIDENT i ->
                                (((new Expr.subst) ( _loc ) [(i, def)])#expr
                                   body
                                :'expr )
                            | _ -> assert false)));
          ([`Skeyword "IFNDEF";
    ...
    Gram.extend (expr :'expr Gram.t  )
      ((fun () -> ((Some (`Before "simple")),
          ...
          (Gram.mk_action
             (fun (kwd : 'e__11) ->
                fun _ ->
                  fun (_loc : FanLoc.t ) -> (Ast.ExVrn (( _loc ), kwd) :
                    'expr ))))])])) ());
    Gram.extend (patt :'patt Gram.t  )
      ((fun () -> ((Some (`Before "simple")),
          [(None,
          ...
          (Gram.mk_action
             (fun (kwd : 'e__12) ->
                fun _ ->
                  fun (_loc : FanLoc.t ) -> (Ast.PaVrn (( _loc ), kwd) :
                    'patt ))))])])) ())
  let _ =
...
module MakeRevisedParser(Syntax:Sig.Camlp4Syntax) = struct
  ...
  let _ =
    ...
    let string_list:'string_list Gram.t  =grammar_entry_create "string_list"
      ...
      =grammar_entry_create "unquoted_typevars" and
      value_val_opt_override:'value_val_opt_override Gram.t 
      =grammar_entry_create "value_val_opt_override" and
      method_opt_override:'method_opt_override Gram.t 
      =grammar_entry_create "method_opt_override" and
      ...
      =grammar_entry_create "fun_def_cont_no_when" and
      fun_def_cont:'fun_def_cont Gram.t  =grammar_entry_create "fun_def_cont"
      and fun_def:'fun_def Gram.t  =grammar_entry_create "fun_def" and
      sequence':'sequence' Gram.t  =grammar_entry_create "sequence'" and
      module_longident_dot_lparen:'module_longident_dot_lparen Gram.t 
      =grammar_entry_create "module_longident_dot_lparen" and
      infixop6:'infixop6 Gram.t  =grammar_entry_create "infixop6" and
      infixop5:'infixop5 Gram.t  =grammar_entry_create "infixop5" in
      ...
      ((fun () -> (None,
          ...
          (Gram.mk_action
             (fun (i : 'module_longident) ->
                fun (_loc : FanLoc.t ) -> (Ast.MeId (( _loc ), i)
                  :'module_expr ))));
      ...
      ((fun () -> (None,
          ...
          (Gram.mk_action
             (fun (cd : 'class_declaration) ->
                fun _ ->
                  fun (_loc : FanLoc.t ) -> (Ast.StCls (( _loc ), cd)
                    :'str_item ))));
          ([`Skeyword "let";
           `Skeyword "open";
           `Snterm (Gram.obj (module_longident :'module_longident Gram.t  ));
                    ...
                    fun (m : 'a_UIDENT) ->
                      fun _ ->
                        fun _ ->
                          fun (_loc : FanLoc.t ) ->
                            (Ast.StExp (( _loc ),
                               (Ast.ExLmd (( _loc ), m, mb, e))) :'str_item ))));
          ([`Skeyword "let";
          ...
          (Gram.mk_action
             (fun (i : 'module_longident) ->
                fun _ ->
                  fun (_loc : FanLoc.t ) -> (Ast.StOpn (( _loc ), i)
                    :'str_item ))));
          ([`Skeyword "module";
           `Skeyword "type";
           `Snterm (Gram.obj (a_ident :'a_ident Gram.t  ));
          ...
          (Gram.mk_action
             (fun (me : 'module_expr) ->
                fun _ ->
                  fun (_loc : FanLoc.t ) -> (Ast.StInc (( _loc ), me)
                    :'str_item ))));
          ([`Skeyword "external";
           `Snterm (Gram.obj (a_LIDENT :'a_LIDENT Gram.t  ));
           `Skeyword ":";
      ...
      ((fun () -> (None,
          ...
          (Gram.mk_action
             (fun (i : 'module_longident_with_app) ->
                fun (_loc : FanLoc.t ) -> (Ast.MtId (( _loc ), i)
                  :'module_type ))));
          ([`Stoken (((function | `QUOTATION _ -> true | _ -> false)),
              (`Normal, "`QUOTATION _"))],
          (Gram.mk_action
      ...
      ((fun () -> (None,
          ...
          (Gram.mk_action
             (fun (cd : 'class_description) ->
                fun _ ->
                  fun (_loc : FanLoc.t ) -> (Ast.SgCls (( _loc ), cd)
                    :'sig_item ))));
          ([`Skeyword "val";
           `Snterm (Gram.obj (a_LIDENT :'a_LIDENT Gram.t  ));
           `Skeyword ":";
          ...
          (Gram.mk_action
             (fun (t : 'type_declaration) ->
                fun _ ->
                  fun (_loc : FanLoc.t ) -> (Ast.SgTyp (( _loc ), t)
                    :'sig_item ))));
          ([`Skeyword "open";
           `Snterm (Gram.obj (module_longident :'module_longident Gram.t  ))],
          (Gram.mk_action
             (fun (i : 'module_longident) ->
                fun _ ->
                  fun (_loc : FanLoc.t ) -> (Ast.SgOpn (( _loc ), i)
                    :'sig_item ))));
          ([`Skeyword "module";
           `Skeyword "type";
           `Snterm (Gram.obj (a_ident :'a_ident Gram.t  ))],
          ...
          (Gram.mk_action
             (fun (mt : 'module_type) ->
                fun _ ->
                  fun (_loc : FanLoc.t ) -> (Ast.SgInc (( _loc ), mt)
                    :'sig_item ))));
          ([`Skeyword "external";
           `Snterm (Gram.obj (a_LIDENT :'a_LIDENT Gram.t  ));
           `Skeyword ":";
          ...
          (Gram.mk_action
             (fun (t : 'constructor_declaration) ->
                fun _ ->
                  fun (_loc : FanLoc.t ) -> (Ast.SgExc (( _loc ), t)
                    :'sig_item ))));
          ([`Stoken (((function | `QUOTATION _ -> true | _ -> false)),
              (`Normal, "`QUOTATION _"))],
          (Gram.mk_action
    ...
    Gram.extend (expr :'expr Gram.t  )
      ((fun () -> (None,
             ...
             (fun (seq : 'do_sequence) ->
                fun _ ->
                  fun (e : 'sequence) ->
                    fun _ ->
                      fun (_loc : FanLoc.t ) ->
                        (Ast.ExWhi (( _loc ), (Expr.mksequence' ( _loc ) e),
                           seq) :'expr ))));
          ([`Skeyword "for";
           `Snterm (Gram.obj (a_LIDENT :'a_LIDENT Gram.t  ));
           `Skeyword "=";
             ...
             (fun (a : 'match_case) ->
                fun _ ->
                  fun (e : 'sequence) ->
                    fun _ ->
                      fun (_loc : FanLoc.t ) ->
                        (Ast.ExTry (( _loc ), (Expr.mksequence' ( _loc ) e),
                           a) :'expr ))));
          ([`Skeyword "match";
           `Snterm (Gram.obj (sequence :'sequence Gram.t  ));
           `Skeyword "with";
             ...
             (fun (a : 'match_case) ->
                fun _ ->
                  fun (e : 'sequence) ->
                    fun _ ->
                      fun (_loc : FanLoc.t ) ->
                        (Ast.ExMat (( _loc ), (Expr.mksequence' ( _loc ) e),
                           a) :'expr ))));
          ...
          (Gram.mk_action
             (fun (e : 'expr) ->
                fun _ ->
                  fun (_loc : FanLoc.t ) -> (Expr.mkumin ( _loc ) "-." e
                    :'expr ))));
          ([`Skeyword "-"; `Sself],
          (Gram.mk_action
             (fun (e : 'expr) ->
          ...
          (Gram.mk_action
             (fun (e : 'expr) ->
                fun _ ->
                  fun (_loc : FanLoc.t ) -> (Expr.mkassert ( _loc ) e :
                    'expr ))));
          ([`Sself; `Sself],
          (Gram.mk_action
             (fun (e2 : 'expr) ->
          ...
          (Gram.mk_action
             (fun (e : 'expr) ->
                fun (f : 'prefixop) ->
                  fun (_loc : FanLoc.t ) -> (Ast.ExApp (( _loc ), f, e)
                    :'expr ))));
          ([`Skeyword "!"; `Sself],
          (Gram.mk_action
             (fun (e : 'expr) ->
          ...
          (Gram.mk_action
             (fun (s : 'a_NATIVEINT) ->
                fun (_loc : FanLoc.t ) -> (Ast.ExNativeInt (( _loc ), s)
                  :'expr ))));
    ...
    Gram.extend (patt :'patt Gram.t  )
      ((fun () -> (None,
          ...
          (Gram.mk_action
             (fun (s : 'a_NATIVEINT) ->
                fun (_loc : FanLoc.t ) -> (Ast.PaNativeInt (( _loc ), s)
                  :'patt ))));
          ([`Snterm (Gram.obj (a_INT64 :'a_INT64 Gram.t  ))],
          (Gram.mk_action
             (fun (s : 'a_INT64) ->
    ...
    Gram.extend (row_field :'row_field Gram.t  )
      ((fun () -> (None,
          ...
          (Gram.mk_action
             (fun (i : 'a_ident) ->
                fun _ ->
                  fun (_loc : FanLoc.t ) -> (Ast.TyVrn (( _loc ), i)
                    :'row_field ))));
          ([`Sself; `Skeyword "|"; `Sself],
          (Gram.mk_action
             (fun (t2 : 'row_field) ->
                    ...
                    fun _ ->
                      fun _ ->
                        fun (x : 'more_ctyp) ->
                          fun (_loc : FanLoc.t ) ->
                            (Ast.TyOr (( _loc ),
                               (Ast.TyOfAmp (( _loc ), x, y)), z) :'ctyp_quot
                            ))));
          ([`Snterm (Gram.obj (more_ctyp :'more_ctyp Gram.t  ));
           `Skeyword "of";
           `Skeyword "&";
    ...
    Gram.extend (more_ctyp :'more_ctyp Gram.t  )
      ((fun () -> (None,
          ...
          (Gram.mk_action
             (fun (x : 'a_ident) ->
                fun _ ->
                  fun (_loc : FanLoc.t ) -> (Ast.TyVrn (( _loc ), x)
                    :'more_ctyp ))));
          ([`Skeyword "mutable"; `Sself],
          (Gram.mk_action
             (fun (x : 'more_ctyp) ->
                fun _ ->
                  fun (_loc : FanLoc.t ) -> (Ast.TyMut (( _loc ), x)
                    :'more_ctyp ))))])])) ());
    ...
    Gram.extend (module_type_quot :'module_type_quot Gram.t  )
      ((fun () -> (None,
          ...
          [([],
          (Gram.mk_action
             (fun (_loc : FanLoc.t ) -> (Ast.MtNil ( _loc )
                :'module_type_quot ))));
          ([`Snterm (Gram.obj (module_type :'module_type Gram.t  ))],
          (Gram.mk_action
             (fun (x : 'module_type) ->
    ...
    Gram.extend (module_expr_quot :'module_expr_quot Gram.t  )
      ((fun () -> (None,
          ...
          [([],
          (Gram.mk_action
             (fun (_loc : FanLoc.t ) -> (Ast.MeNil ( _loc )
                :'module_expr_quot ))));
          ([`Snterm (Gram.obj (module_expr :'module_expr Gram.t  ))],
          (Gram.mk_action
             (fun (x : 'module_expr) ->
    ...
    Gram.extend (rec_binding_quot :'rec_binding_quot Gram.t  )
      ((fun () -> (None,
          ...
          [([],
          (Gram.mk_action
             (fun (_loc : FanLoc.t ) -> (Ast.RbNil ( _loc )
                :'rec_binding_quot ))));
          ([`Snterm (Gram.obj (label_expr_list :'label_expr_list Gram.t  ))],
          (Gram.mk_action
                ...
                fun _ ->
                  fun (_loc : FanLoc.t ) ->
                    (Ast.CeCon (( _loc ), Ast.ViVirtual,
                       (Ast.IdLid (( _loc ), i)), ot) :'class_expr_quot ))));
          ([`Sself; `Skeyword "="; `Sself],
          (Gram.mk_action
                ...
                fun _ ->
                  fun (_loc : FanLoc.t ) ->
                    (Ast.CtCon (( _loc ), Ast.ViVirtual,
                       (Ast.IdLid (( _loc ), i)), ot) :'class_type_quot ))));
          ([`Sself; `Skeyword ":"; `Sself],
          (Gram.mk_action
    ...
    Gram.extend (with_constr_quot :'with_constr_quot Gram.t  )
      ((fun () -> (None,
          ...
          [([],
          (Gram.mk_action
             (fun (_loc : FanLoc.t ) -> (Ast.WcNil ( _loc )
                :'with_constr_quot ))));
          ([`Snterm (Gram.obj (with_constr :'with_constr Gram.t  ))],
          (Gram.mk_action
             (fun (x : 'with_constr) ->
...
module MakeRevisedParserParser(Syntax:Sig.Camlp4Syntax) =
  ...
  let _ =
    ...
    let parser_ipatt:'parser_ipatt Gram.t 
      =grammar_entry_create "parser_ipatt" and
      stream_quot:'stream_quot Gram.t  =grammar_entry_create "stream_quot"
      and stream_expr:'stream_expr Gram.t 
      =grammar_entry_create "stream_expr" and
      parser_case_list:'parser_case_list Gram.t 
      =grammar_entry_create "parser_case_list" and
      parser_case:'parser_case Gram.t  =grammar_entry_create "parser_case"
      and stream_patt:'stream_patt Gram.t 
      =grammar_entry_create "stream_patt" and stream_end:'stream_end Gram.t 
      =grammar_entry_create "stream_end" and
      stream_begin:'stream_begin Gram.t  =grammar_entry_create "stream_begin"
      ...
      =grammar_entry_create "stream_patt_comp_err" and
      stream_patt_comp:'stream_patt_comp Gram.t 
      =grammar_entry_create "stream_patt_comp" and
      stream_expr_comp_list:'stream_expr_comp_list Gram.t 
      =grammar_entry_create "stream_expr_comp_list" and
    ...
    Gram.extend (stream_expr_comp :'stream_expr_comp Gram.t  )
      ((fun () -> (None,
          ...
          (Gram.mk_action
             (fun (e : 'stream_expr) ->
                fun (_loc : FanLoc.t ) -> (SeTrm (( _loc ), e)
                  :'stream_expr_comp ))))])])) ())
  end
