...
| (((((((((((((TyOfAmp (_ , _ , _ ) | TyAmp (_ , _ , _ ))
              | TySta (_ , _ , _ )) | TyCom (_ , _ , _ )) | TyVrn (_ , _ ))
           | TyQuM (_ , _ )) | TyQuP (_ , _ )) | TyDcl (_ , _ , _ , _ , _ ))
...
function
| Ast.TyCol
   (loc , Ast.TyId (_ , Ast.IdLid (sloc , s ) ) , Ast.TyMut (_ , t ) ) ->
...
| Ast.TyCol
   (loc , Ast.TyId (_ , Ast.IdUid (sloc , s ) ) , Ast.TyArr (_ , t , u ) ) ->
   (( (with_loc ( (conv_con s ) ) sloc ) ) , (
...
| ((((PaEq (_ , _ , _ ) | PaSem (_ , _ , _ )) | PaCom (_ , _ , _ ))
    | PaNil (_)) as p) ->
