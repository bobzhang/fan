    ...
    external loc_of_expr :
      ...
      external loc_of_module_type :
        ...
        external loc_of_module_expr :
          ...
          external loc_of_sig_item :
            (sig_item -> FanLoc.t)  = "%field0"
            external loc_of_str_item :
              (str_item -> FanLoc.t)  = "%field0"
              external loc_of_class_type :
                (class_type -> FanLoc.t)  = "%field0"
                external loc_of_class_sig_item :
                  (class_sig_item -> FanLoc.t)  = "%field0"
                  external loc_of_class_expr :
                    (class_expr -> FanLoc.t)  = "%field0"
                    external loc_of_class_str_item :
                      (class_str_item -> FanLoc.t)  = "%field0"
                      external loc_of_with_constr :
                        (with_constr -> FanLoc.t)  = "%field0"
                        external loc_of_binding :
                          (binding -> FanLoc.t)  = "%field0"
                          external loc_of_rec_binding :
                            (rec_binding -> FanLoc.t)  = "%field0"
                            external loc_of_module_binding :
                              (module_binding -> FanLoc.t)  = "%field0"
                              external loc_of_match_case :
                                (match_case -> FanLoc.t)  = "%field0"
                                external loc_of_ident :
                                  (ident -> FanLoc.t)  = "%field0"
                                  let  ghost = FanLoc.ghost
                                  let rec  is_module_longident =
                                    
                                    function
                                    | Ast.IdAcc(_,_,i) ->
                                      (is_module_longident i)
                                    | Ast.IdApp(_,i1,i2) ->
                                      (( (is_module_longident i1) ) && (
                                        (is_module_longident i2) ))
                                    | Ast.IdUid(_,_) -> true
                                    | _ -> false
                                  let  ident_of_expr =
                                    ...
                                    | Ast.ExId(_,Ast.IdLid(_,_)) ->
                                      (error () )
                                    | Ast.ExId(_,i) ->
                                      if (is_module_longident i) then i
                                      else (error () )
                                    | _ -> (error () ) in
                                  ...
                                  let  ident_of_ctyp =
                                    ...
                                    | Ast.TyApp(_loc,t1,t2) ->
                                      Ast.IdApp
                                        ((_loc,( (self t1) ),( (self t2) )))
                                    | Ast.TyId(_,Ast.IdLid(_,_)) ->
                                      (error () )
                                    | Ast.TyId(_,i) ->
                                      if (is_module_longident i) then i
                                      else (error () )
                                  ...
                                  let rec  is_irrefut_patt =
                                    ...
                                    |
                                      (((((((((((Ast.PaVrn(_,_)
                                              ...
                                              |Ast.PaInt64(_,_))
                                             |Ast.PaInt32(_,_))
                                            |Ast.PaInt(_,_)) |Ast.PaChr
                                           (_,_)) |Ast.PaTyp(_,_))
                                         |Ast.PaArr(_,_)) |Ast.PaAnt(_,_)) ->
                                      false
                                  ...
                                  let rec  is_expr_constructor =
                                    ...
                                    | Ast.ExAcc(_,e1,e2) ->
                                      (( (is_expr_constructor e1) ) && (
                                        (is_expr_constructor e2) ))
                                    | Ast.ExVrn(_,_) -> true
                                    | _ -> false
                                  ...
                                  let  bi_of_pe ((p,e)) =
                                    ...
                                    let  _loc = (loc_of_patt p) in
                                    Ast.BiEq ((_loc,p,e))
                                  let  sum_type_of_list (l) =
                                    (tyOr_of_list ( (List.map ty_of_stl l) ))
                                  let  record_type_of_list (l) =
                                    (tySem_of_list ( (List.map ty_of_sbt l)
                                      ))
                                  let  binding_of_pel (l) =
                                    (biAnd_of_list ( (List.map bi_of_pe l) ))
                                  ...
                                  let rec  list_of_rec_binding (x) (acc) =
                                    ...
                                    with
                                    | Ast.RbSem(_,b1,b2) ->
                                      (list_of_rec_binding b1 (
                                        (list_of_rec_binding b2 acc) ))
                                    | t -> t::acc)
                                  let rec  list_of_with_constr (x) (acc) =
                                    ...
                                    with
                                    | Ast.WcAnd(_,w1,w2) ->
                                      (list_of_with_constr w1 (
                                        (list_of_with_constr w2 acc) ))
                                    | t -> t::acc)
                                  ...
                                  let rec  list_of_class_sig_item (x) (acc) =
                                    ...
                                    | Ast.CgNil(_) -> acc
                                    | Ast.CgSem(_,x,y) ->
                                      (list_of_class_sig_item x (
                                        (list_of_class_sig_item y acc) ))
                                    | x -> x::acc)
                                  let rec  list_of_class_str_item (x) (acc) =
                                    ...
                                    | Ast.CrNil(_) -> acc
                                    | Ast.CrSem(_,x,y) ->
                                      (list_of_class_str_item x (
                                        (list_of_class_str_item y acc) ))
                                    | x -> x::acc)
                                  let rec  list_of_class_type (x) (acc) =
                                    ...
                                    with
                                    | Ast.CtAnd(_,x,y) ->
                                      (list_of_class_type x (
                                        (list_of_class_type y acc) ))
                                    | x -> x::acc)
                                  let rec  list_of_class_expr (x) (acc) =
                                    ...
                                    with
                                    | Ast.CeAnd(_,x,y) ->
                                      (list_of_class_expr x (
                                        (list_of_class_expr y acc) ))
                                    | x -> x::acc)
                                  let rec  list_of_module_expr (x) (acc) =
                                    ...
                                    with
                                    | Ast.MeApp(_,x,y) ->
                                      (list_of_module_expr x (
                                        (list_of_module_expr y acc) ))
                                    | x -> x::acc)
                                  let rec  list_of_match_case (x) (acc) =
                                    ...
                                    | Ast.McNil(_) -> acc
                                    | Ast.McOr(_,x,y) ->
                                      (list_of_match_case x (
                                        (list_of_match_case y acc) ))
                                    | x -> x::acc)
                                  ...
                                  let rec  list_of_module_binding (x) (acc) =
                                    ...
                                    with
                                    | Ast.MbAnd(_,x,y) ->
                                      (list_of_module_binding x (
                                        (list_of_module_binding y acc) ))
                                    | x -> x::acc)
                                  module type META_LOC =
                                    sig 
                                     val meta_loc_patt :
                                       (FanLoc.t -> (FanLoc.t -> Ast.patt) ) 
                                    val meta_loc_expr :
                                      (FanLoc.t -> (FanLoc.t -> Ast.expr) ) 
                                    end
                                  module Meta  =
                                    struct
                                          ...
                                          module Expr  =
                                            struct 
                                               let  meta_string (_loc) (s) =
                                                 Ast.ExStr
                                                   ((_loc,(
                                                     (safe_string_escaped s)
                                                     )))
                                              let  meta_int (_loc) (s) =
                                                Ast.ExInt ((_loc,s))
                                              let  meta_float (_loc) (s) =
                                                Ast.ExFlo ((_loc,s))
                                              let  meta_char (_loc) (s) =
                                                Ast.ExChr
                                                  ((_loc,( (String.escaped s)
                                                    )))
                                              let  meta_bool (_loc) =
                                  ...
                                  class map =
                                    ...
                                    method   list :
                                      ...
                                      fun (_f_a) ->
                                        ...
                                        | _x::_x_i1 ->
                                          ...
                                          let  _x_i1 = (o#list _f_a _x_i1) in
                                          _x::_x_i1
                                    method   with_constr :
                                    ...
                                    method   str_item :
                                      ...
                                      | StExc(_x,_x_i1,_x_i2) ->
                                        ...
                                        let  _x_i2 =
                                        (o#meta_option ( fun (o) -> o#ident )
                                          _x_i2) in StExc ((_x,_x_i1,_x_i2))
                                      | StExp(_x,_x_i1) ->
                                    ...
                                    method   expr : (expr -> expr)  =
                                      ...
                                      |
                                        ...
                                        let  _x_i4 = (o#direction_flag _x_i4)
                                        in
                                        
                                        let  _x_i5 = (o#expr _x_i5) in
                                        ExFor
                                          ((_x,_x_i1,_x_i2,_x_i3,_x_i4,_x_i5))
                                      | ExFun(_x,_x_i1) ->
                                    ...
                                    method   class_type :
                                      ...
                                      | CtCon(_x,_x_i1,_x_i2,_x_i3) ->
                                        ...
                                        let  _x_i1 = (o#virtual_flag _x_i1)
                                        in
                                    ...
                                    method   class_str_item :
                                      ...
                                      | CrSem(_x,_x_i1,_x_i2) ->
                                        ...
                                        let  _x_i1 = (o#class_str_item _x_i1)
                                        in
                                      ...
                                      | CrInh(_x,_x_i1,_x_i2,_x_i3) ->
                                        ...
                                        let  _x_i1 = (o#override_flag _x_i1)
                                        in
                                      ...
                                      |
                                        ...
                                        let  _x_i2 = (o#override_flag _x_i2)
                                        in
                                        
                                        let  _x_i3 = (o#private_flag _x_i3)
                                        in
                                      ...
                                      | CrVal(_x,_x_i1,_x_i2,_x_i3,_x_i4) ->
                                        ...
                                        let  _x_i3 = (o#mutable_flag _x_i3)
                                        in
                                      ...
                                      | CrVir(_x,_x_i1,_x_i2,_x_i3) ->
                                        ...
                                        let  _x_i2 = (o#private_flag _x_i2)
                                        in
                                      ...
                                      | CrVvr(_x,_x_i1,_x_i2,_x_i3) ->
                                        ...
                                        let  _x_i2 = (o#mutable_flag _x_i2)
                                        in
                                    ...
                                    method   class_sig_item :
                                      ...
                                      | CgSem(_x,_x_i1,_x_i2) ->
                                        ...
                                        let  _x_i1 = (o#class_sig_item _x_i1)
                                        in
                                      ...
                                      | CgVal(_x,_x_i1,_x_i2,_x_i3,_x_i4) ->
                                        ...
                                        let  _x_i3 = (o#virtual_flag _x_i3)
                                        in
                                  ...
                                  class fold =
                                    ...
                                    method   module_binding :
                                      ...
                                      | MbAnd(_x,_x_i1,_x_i2) ->
                                        ...
                                        let  o = (o#module_binding _x_i2) in
                                        o
                                      | MbColEq(_x,_x_i1,_x_i2,_x_i3) ->
                                    ...
                                    method   expr : (expr -> 'self_type )  =
                                      ...
                                      | ExObj(_x,_x_i1,_x_i2) ->
                                        ...
                                        let  o = (o#class_str_item _x_i2) in
                                        o
                                      | ExOlb(_x,_x_i1,_x_i2) ->
                                    ...
                                    method   class_type :
                                      ...
                                      | CtSig(_x,_x_i1,_x_i2) ->
                                        ...
                                        let  o = (o#class_sig_item _x_i2) in
                                        o
                                      | CtAnd(_x,_x_i1,_x_i2) ->
                                  ...
                                  let  map_expr (f) =
                                    ...
                                    method !  expr =
                                      fun (x) -> (f ( (super#expr x) ))
                                    end
                                  let  map_patt (f) =
                                    object
                                     inherit  map as super
                                    method !  patt =
                                      fun (x) -> (f ( (super#patt x) ))
                                    end
                                  let  map_ctyp (f) =
                                    object
                                     inherit  map as super
                                    method !  ctyp =
                                      fun (x) -> (f ( (super#ctyp x) ))
                                    end
                                  let  map_str_item (f) =
                                    object
                                     inherit  map as super
                                    ...
                                    method !  str_item =
                                      fun (st) ->
                                        ...
                                        |
                                          ...
                                          st
                                        | Ast.StTyp(loc,Ast.TyNil(_)) ->
                                          Ast.StNil (loc)
                                        | Ast.StVal(loc,_,Ast.BiNil(_)) ->
                                          Ast.StNil (loc)
                                        | st -> st)
                                    method !  module_type =
                                      fun (mt) ->
