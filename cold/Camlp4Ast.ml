...
external loc_of_class_sig_item :
  ( class_sig_item  ->  FanLoc.t )  = "%field0"
external loc_of_class_expr : ( class_expr  ->  FanLoc.t )  = "%field0"
external loc_of_class_str_item :
  ( class_str_item  ->  FanLoc.t )  = "%field0"
...
external loc_of_module_binding :
  ( module_binding  ->  FanLoc.t )  = "%field0"
...
let rec  is_irrefut_patt =
  ...
  | Ast.PaId(_,Ast.IdLid(_,_)) -> true
    | Ast.PaId(_,Ast.IdUid(_,"()")) -> true | Ast.PaAny(_) -> true
    | Ast.PaNil(_) -> true
    | Ast.PaAli(_,x,y) ->
    ...
    | Ast.PaLaz(_,p) -> (is_irrefut_patt p) | Ast.PaId(_,_) -> false
    | Ast.PaMod(_,_) -> true
    |
      (((((((((((Ast.PaVrn(_,_) |Ast.PaStr(_,_)) |Ast.PaRng(_,_,_))
          ...
          |Ast.PaTyp(_,_)) |Ast.PaArr(_,_)) |Ast.PaAnt(_,_)) -> false)
let rec  is_constructor =
  
  (function
  | Ast.IdAcc(_,_,i) -> (is_constructor i) | Ast.IdUid(_,_) -> true
    | (Ast.IdLid(_,_) |Ast.IdApp(_,_,_)) -> false
    | Ast.IdAnt(_,_) -> assert false)
let  is_patt_constructor =
  
  (function
  | Ast.PaId(_,i) -> (is_constructor i) | Ast.PaVrn(_,_) -> true | _ -> false)
...
let rec  tyOr_of_list =
  ...
  | []  -> Ast.TyNil (ghost) | t::[]  -> t
    | t::ts ->
      ...
      Ast.TyOr ((_loc,t,( (tyOr_of_list ts) ))))
let rec  tyAnd_of_list =
  ...
  | []  -> Ast.TyNil (ghost) | t::[]  -> t
    | t::ts ->
      ...
      let  _loc = (loc_of_ctyp t) in
      Ast.TyAnd ((_loc,t,( (tyAnd_of_list ts) ))))
let rec  tySem_of_list =
  ...
  | []  -> Ast.TyNil (ghost) | t::[]  -> t
    | t::ts ->
      ...
      let  _loc = (loc_of_ctyp t) in
      Ast.TySem ((_loc,t,( (tySem_of_list ts) ))))
let rec  tyCom_of_list =
  ...
  | []  -> Ast.TyNil (ghost) | t::[]  -> t
    | t::ts ->
      ...
      let  _loc = (loc_of_ctyp t) in
      Ast.TyCom ((_loc,t,( (tyCom_of_list ts) ))))
let rec  tyAmp_of_list =
  ...
  | []  -> Ast.TyNil (ghost) | t::[]  -> t
    | t::ts ->
      ...
      let  _loc = (loc_of_ctyp t) in
      Ast.TyAmp ((_loc,t,( (tyAmp_of_list ts) ))))
let rec  tySta_of_list =
  ...
  | []  -> Ast.TyNil (ghost) | t::[]  -> t
    | t::ts ->
      ...
      let  _loc = (loc_of_ctyp t) in
      Ast.TySta ((_loc,t,( (tySta_of_list ts) ))))
let rec  stSem_of_list =
  ...
  | []  -> Ast.StNil (ghost) | t::[]  -> t
    | t::ts ->
      ...
      let  _loc = (loc_of_str_item t) in
      Ast.StSem ((_loc,t,( (stSem_of_list ts) ))))
let rec  sgSem_of_list =
  ...
  | []  -> Ast.SgNil (ghost) | t::[]  -> t
    | t::ts ->
      ...
      let  _loc = (loc_of_sig_item t) in
      Ast.SgSem ((_loc,t,( (sgSem_of_list ts) ))))
let rec  biAnd_of_list =
  ...
  | []  -> Ast.BiNil (ghost) | b::[]  -> b
    | b::bs ->
      ...
      let  _loc = (loc_of_binding b) in
      Ast.BiAnd ((_loc,b,( (biAnd_of_list bs) ))))
let rec  rbSem_of_list =
  ...
  | []  -> Ast.RbNil (ghost) | b::[]  -> b
    | b::bs ->
      ...
      Ast.RbSem ((_loc,b,( (rbSem_of_list bs) ))))
let rec  wcAnd_of_list =
  ...
  | []  -> Ast.WcNil (ghost) | w::[]  -> w
    | w::ws ->
      ...
      Ast.WcAnd ((_loc,w,( (wcAnd_of_list ws) ))))
let rec  idAcc_of_list =
  ...
  | []  -> assert false | i::[]  -> i
    | i::is ->
      ...
      Ast.IdAcc ((_loc,i,( (idAcc_of_list is) ))))
let rec  idApp_of_list =
  ...
  | []  -> assert false | i::[]  -> i
    | i::is ->
      ...
      let  _loc = (loc_of_ident i) in
      Ast.IdApp ((_loc,i,( (idApp_of_list is) ))))
let rec  mcOr_of_list =
  ...
  | []  -> Ast.McNil (ghost) | x::[]  -> x
    | x::xs ->
      ...
      Ast.McOr ((_loc,x,( (mcOr_of_list xs) ))))
let rec  mbAnd_of_list =
  ...
  | []  -> Ast.MbNil (ghost) | x::[]  -> x
    | x::xs ->
      ...
      Ast.MbAnd ((_loc,x,( (mbAnd_of_list xs) ))))
let rec  meApp_of_list =
  ...
  | []  -> assert false | x::[]  -> x
    | x::xs ->
      ...
      Ast.MeApp ((_loc,x,( (meApp_of_list xs) ))))
let rec  ceAnd_of_list =
  ...
  | []  -> Ast.CeNil (ghost) | x::[]  -> x
    | x::xs ->
      ...
      Ast.CeAnd ((_loc,x,( (ceAnd_of_list xs) ))))
let rec  ctAnd_of_list =
  ...
  | []  -> Ast.CtNil (ghost) | x::[]  -> x
    | x::xs ->
      ...
      Ast.CtAnd ((_loc,x,( (ctAnd_of_list xs) ))))
let rec  cgSem_of_list =
  ...
  | []  -> Ast.CgNil (ghost) | x::[]  -> x
    | x::xs ->
      ...
      Ast.CgSem ((_loc,x,( (cgSem_of_list xs) ))))
let rec  crSem_of_list =
  ...
  | []  -> Ast.CrNil (ghost) | x::[]  -> x
    | x::xs ->
      ...
      Ast.CrSem ((_loc,x,( (crSem_of_list xs) ))))
let rec  paSem_of_list =
  ...
  | []  -> Ast.PaNil (ghost) | x::[]  -> x
    | x::xs ->
      ...
      Ast.PaSem ((_loc,x,( (paSem_of_list xs) ))))
let rec  paCom_of_list =
  ...
  | []  -> Ast.PaNil (ghost) | x::[]  -> x
    | x::xs ->
      ...
      let  _loc = (loc_of_patt x) in
      Ast.PaCom ((_loc,x,( (paCom_of_list xs) ))))
let rec  exSem_of_list =
  ...
  | []  -> Ast.ExNil (ghost) | x::[]  -> x
    | x::xs ->
      ...
      Ast.ExSem ((_loc,x,( (exSem_of_list xs) ))))
let rec  exCom_of_list =
  ...
  | []  -> Ast.ExNil (ghost) | x::[]  -> x
    | x::xs ->
      ...
      let  _loc = (loc_of_expr x) in
      Ast.ExCom ((_loc,x,( (exCom_of_list xs) ))))
let  ty_of_stl =
...
let rec  pel_of_binding =
  ...
  | Ast.BiAnd(_,b1,b2) -> (( (pel_of_binding b1) ) @ ( (pel_of_binding b2) ))
    | Ast.BiEq(_,p,e) -> [(p,e)] | _ -> assert false)
...
let rec  list_of_rec_binding (x) (acc) =
  ...
  with
  | Ast.RbSem(_,b1,b2) ->
    (list_of_rec_binding b1 ( (list_of_rec_binding b2 acc) )) | t -> t::acc)
let rec  list_of_with_constr (x) (acc) =
  
  (match x
  with
  | Ast.WcAnd(_,w1,w2) ->
    (list_of_with_constr w1 ( (list_of_with_constr w2 acc) )) | t -> t::acc)
let rec  list_of_ctyp (x) (acc) =
  ...
  | Ast.TyNil(_) -> acc
    |
      (((((Ast.TyAmp(_,x,y) |Ast.TyCom(_,x,y)) |Ast.TySta(_,x,y))
          |Ast.TySem(_,x,y)) |Ast.TyAnd(_,x,y)) |Ast.TyOr(_,x,y)) ->
      (list_of_ctyp x ( (list_of_ctyp y acc) )) | x -> x::acc)
let rec  list_of_patt (x) (acc) =
  ...
  | Ast.PaNil(_) -> acc
    | (Ast.PaCom(_,x,y) |Ast.PaSem(_,x,y)) ->
      (list_of_patt x ( (list_of_patt y acc) )) | x -> x::acc)
let rec  list_of_expr (x) (acc) =
  ...
  | Ast.ExNil(_) -> acc
    | (Ast.ExCom(_,x,y) |Ast.ExSem(_,x,y)) ->
      (list_of_expr x ( (list_of_expr y acc) )) | x -> x::acc)
...
let rec  list_of_module_expr (x) (acc) =
  ...
  with
  | Ast.MeApp(_,x,y) ->
    (list_of_module_expr x ( (list_of_module_expr y acc) )) | x -> x::acc)
let rec  list_of_match_case (x) (acc) =
  ...
  | Ast.McNil(_) -> acc
    | Ast.McOr(_,x,y) ->
      (list_of_match_case x ( (list_of_match_case y acc) )) | x -> x::acc)
let rec  list_of_ident (x) (acc) =
  
  (match x
  with
  | (Ast.IdAcc(_,x,y) |Ast.IdApp(_,x,y)) ->
    (list_of_ident x ( (list_of_ident y acc) )) | x -> x::acc)
...
module type META_LOC =
  sig val meta_loc_patt : ( FanLoc.t  -> ( FanLoc.t  ->  Ast.patt ) ) 
  val meta_loc_expr : ( FanLoc.t  -> ( FanLoc.t  ->  Ast.expr ) )  end
module Meta  =
  struct
    module Make (MetaLoc:META_LOC) =
      struct let  meta_loc = MetaLoc.meta_loc_expr
        module Expr  =
          struct
                    ...
                    ((_loc,(
                      Ast.ExApp
                        ((_loc,(
                          ...
                          (meta_ctyp _loc x1) ))) ),( (meta_ctyp _loc x2) )))
                | Ast.TyAmp(x0,x1,x2) ->
                  Ast.ExApp
                    ((_loc,(
                      Ast.ExApp
                        ...
                        ((_loc,(
                          Ast.ExApp
                            ((_loc,(
                              ...
                              (meta_loc _loc x0) ))) ),(
                          (meta_string _loc x1) ))) ),( (meta_ctyp _loc x2)
                      )))
                | Ast.TyObj(x0,x1,x2) ->
                  Ast.ExApp
                    ((_loc,(
                ...
                | Ast.DiTo  ->
                  Ast.ExId
                    ((_loc,(
                      Ast.IdAcc
                        ((_loc,( Ast.IdUid ((_loc,"Ast")) ),(
                          Ast.IdUid ((_loc,"DiTo")) ))) )))) and meta_expr
              (_loc) =
                        ...
                        ((_loc,(
                          Ast.ExApp
                            ((_loc,(
                              ...
                              (meta_loc _loc x0) ))) ),(
                          (meta_string _loc x1) ))) ),( (meta_expr _loc x2)
                      )))
                | Ast.ExOpI(x0,x1,x2) ->
                  Ast.ExApp
                    ((_loc,(
                        ...
                        ((_loc,(
                          Ast.ExApp
                            ((_loc,(
                              ...
                              (meta_expr _loc x1) ))) ),( (meta_expr _loc x2)
                          ))) ),( (meta_expr _loc x3) )))
                | Ast.ExFun(x0,x1) ->
                  Ast.ExApp
                    ((_loc,(
                        ...
                        ((_loc,(
                          Ast.ExApp
                            ((_loc,(
                              ...
                              (meta_expr _loc x1) ))) ),( (meta_ctyp _loc x2)
                          ))) ),( (meta_ctyp _loc x3) )))
                | Ast.ExChr(x0,x1) ->
                  Ast.ExApp
                    ((_loc,(
                        ...
                        ((_loc,(
                          Ast.ExApp
                            ((_loc,(
                              ...
                              (meta_loc _loc x0) ))) ),( (meta_ident _loc x1)
                          ))) ),( (meta_ident _loc x2) )))) and
              meta_match_case (_loc) =
                        ...
                        ((_loc,(
                          Ast.ExApp
                            ((_loc,(
                              ...
                              (meta_patt _loc x1) ))) ),( (meta_expr _loc x2)
                          ))) ),( (meta_expr _loc x3) )))
                | Ast.McOr(x0,x1,x2) ->
                  Ast.ExApp
                    ((_loc,(
                ...
                | Ast.BTrue  ->
                  Ast.ExId
                    ((_loc,(
                      Ast.IdAcc
                        ((_loc,( Ast.IdUid ((_loc,"Ast")) ),(
                          Ast.IdUid ((_loc,"BTrue")) ))) )))) and
              meta_meta_list (mf_a) (_loc) =
                ...
                | Ast.LNil  ->
                  Ast.ExId
                    ((_loc,(
                      Ast.IdAcc
                        ((_loc,( Ast.IdUid ((_loc,"Ast")) ),(
                          Ast.IdUid ((_loc,"LNil")) ))) )))) and
              meta_meta_option (mf_a) (_loc) =
                        ...
                        ((_loc,(
                          Ast.ExApp
                            ((_loc,(
                              ...
                              (meta_string _loc x1) ))) ),(
                          (meta_patt _loc x2) ))) ),( (meta_expr _loc x3) )))
                | Ast.PaOlb(x0,x1,x2) ->
                  Ast.ExApp
                    ((_loc,(
                      Ast.ExApp
                        ((_loc,(
                          Ast.ExApp
                            ((_loc,(
                              ...
                              (meta_loc _loc x0) ))) ),(
                          (meta_string _loc x1) ))) ),( (meta_patt _loc x2)
                      )))
                | Ast.PaLab(x0,x1,x2) ->
                  Ast.ExApp
                    ((_loc,(
                      ...
                      Ast.PaId
                        ((_loc,(
                          Ast.IdAcc
                            ((_loc,( Ast.IdUid ((_loc,"Ast")) ),(
                              Ast.IdUid ((_loc,"WcNil")) ))) ))) ),(
                      (meta_loc _loc x0) )))) end end end
class
   map = object
     (o : 'self_type )method   string :( string  ->  string ) = o#unknown
    method   list
      :'a_out 'a  .
         (('self_type  -> ('a  -> 'a_out ) )  ->
           ('a  list  -> 'a_out  list ) ) =
    ...
    method   virtual_flag :( virtual_flag  ->  virtual_flag ) =
      ...
      (function
      | ViVirtual  -> ViVirtual | ViNil  -> ViNil
        | ViAnt(_x) -> 
          let  _x = (o#string _x) in ViAnt (_x))
    method   str_item :( str_item  ->  str_item ) =
      
      (function
      | StNil(_x) -> 
        let  _x = (o#loc _x) in StNil (_x)
        | StCls(_x,_x_i1) ->
    ...
    method   row_var_flag :( row_var_flag  ->  row_var_flag ) =
      ...
      (function
      | RvRowVar  -> RvRowVar | RvNil  -> RvNil
        | RvAnt(_x) -> 
          let  _x = (o#string _x) in RvAnt (_x))
    method   rec_flag :( rec_flag  ->  rec_flag ) =
      
      (function
      | ReRecursive  -> ReRecursive | ReNil  -> ReNil
        | ReAnt(_x) -> 
          let  _x = (o#string _x) in ReAnt (_x))
    method   rec_binding :( rec_binding  ->  rec_binding ) =
      
      (function
      | RbNil(_x) -> 
        let  _x = (o#loc _x) in RbNil (_x)
    ...
    method   private_flag :( private_flag  ->  private_flag ) =
      ...
      (function
      | PrPrivate  -> PrPrivate | PrNil  -> PrNil
        | PrAnt(_x) -> 
          let  _x = (o#string _x) in PrAnt (_x))
    method   patt :( patt  ->  patt ) =
      
      (function
      | PaNil(_x) -> 
        let  _x = (o#loc _x) in PaNil (_x)
        | PaId(_x,_x_i1) ->
    ...
    method   override_flag :( override_flag  ->  override_flag ) =
      ...
      (function
      | OvOverride  -> OvOverride | OvNil  -> OvNil
        | OvAnt(_x) -> 
          let  _x = (o#string _x) in OvAnt (_x))
    method   mutable_flag :( mutable_flag  ->  mutable_flag ) =
      
      (function
      | MuMutable  -> MuMutable | MuNil  -> MuNil
        | MuAnt(_x) -> 
          let  _x = (o#string _x) in MuAnt (_x))
    method   module_type :( module_type  ->  module_type ) =
      
      (function
      | MtNil(_x) -> 
        let  _x = (o#loc _x) in MtNil (_x)
        | MtId(_x,_x_i1) ->
    ...
    method   meta_option
      ...
      (fun (_f_a) ->
        ...
        (function
        | ONone  -> ONone | OSome(_x) -> 
                            let  _x = (_f_a o _x) in OSome (_x)
          | OAnt(_x) -> 
            let  _x = (o#string _x) in OAnt (_x)))
    method   meta_list
      :'a_out 'a  .
         (('self_type  -> ('a  -> 'a_out ) )  ->
      ...
      (fun (_f_a) ->
        ...
        | LNil  -> LNil
          ...
          | LAnt(_x) -> 
            let  _x = (o#string _x) in LAnt (_x)))
    method   meta_bool :( meta_bool  ->  meta_bool ) =
      
      (function
      | BTrue  -> BTrue | BFalse  -> BFalse
        | BAnt(_x) -> 
          let  _x = (o#string _x) in BAnt (_x))
    method   match_case :( match_case  ->  match_case ) =
      
      (function
      | McNil(_x) -> 
        let  _x = (o#loc _x) in McNil (_x)
        | McOr(_x,_x_i1,_x_i2) ->
    ...
    method   direction_flag :( direction_flag  ->  direction_flag ) =
      ...
      (function
      | DiTo  -> DiTo | DiDownto  -> DiDownto
        | DiAnt(_x) -> 
          let  _x = (o#string _x) in DiAnt (_x))
    method   ctyp :( ctyp  ->  ctyp ) =
      
      (function
      | TyNil(_x) -> 
        let  _x = (o#loc _x) in TyNil (_x)
        ...
        | TyAnP(_x) -> 
          let  _x = (o#loc _x) in TyAnP (_x)
        | TyAnM(_x) -> 
          let  _x = (o#loc _x) in TyAnM (_x)
        | TyVrn(_x,_x_i1) ->
    ...
    method   unknown :'a  . ('a  -> 'a ) = (fun (x) -> x) end
class
   fold = object
     (o : 'self_type )method   string :( string  -> 'self_type ) = o#unknown
    method   list
      :'a  .
    ...
    method   str_item :( str_item  -> 'self_type ) =
      ...
      | StNil(_x) -> 
        ...
        | StCls(_x,_x_i1) ->
          ...
          let  o = (o#loc _x) in 
          let  o = (o#class_expr _x_i1) in o
        | StClt(_x,_x_i1) ->
          
          let  o = (o#loc _x) in 
          let  o = (o#class_type _x_i1) in o
        | StSem(_x,_x_i1,_x_i2) ->
        ...
        | StInc(_x,_x_i1) ->
          ...
          let  o = (o#loc _x) in 
          let  o = (o#module_expr _x_i1) in o
        | StMod(_x,_x_i1,_x_i2) ->
        ...
        | StOpn(_x,_x_i1) ->
          ...
          let  o = (o#loc _x) in 
          let  o = (o#ident _x_i1) in o
        | StTyp(_x,_x_i1) ->
          
          let  o = (o#loc _x) in 
          let  o = (o#ctyp _x_i1) in o
        | StVal(_x,_x_i1,_x_i2) ->
    ...
    method   sig_item :( sig_item  -> 'self_type ) =
      ...
      | SgNil(_x) -> 
        ...
        | SgInc(_x,_x_i1) ->
          ...
          let  o = (o#loc _x) in 
          let  o = (o#module_type _x_i1) in o
        | SgMod(_x,_x_i1,_x_i2) ->
    ...
    method   expr :( expr  -> 'self_type ) =
      ...
      | ExNil(_x) -> 
        ...
        | ExOvr(_x,_x_i1) ->
          ...
          let  o = (o#loc _x) in 
          let  o = (o#rec_binding _x_i1) in o
        | ExRec(_x,_x_i1,_x_i2) ->
          ...
          (o#list (
            (fun (o) ->
              (fun ((_x,_x_i1)) ->
                ...
                let  o = (o#ctyp _x) in 
                let  o = (o#ctyp _x_i1) in o)) ) _x_i4) in o
        | TyObj(_x,_x_i1,_x_i2) ->
    ...
    method   class_str_item :( class_str_item  -> 'self_type ) =
      ...
      | CrNil(_x) -> 
        ...
        | CrMth(_x,_x_i1,_x_i2,_x_i3,_x_i4,_x_i5) ->
          ...
          let  o = (o#expr _x_i4) in 
          let  o = (o#ctyp _x_i5) in o
        | CrVal(_x,_x_i1,_x_i2,_x_i3,_x_i4) ->
    ...
    method   binding :( binding  -> 'self_type ) =
      ...
      | BiNil(_x) -> 
        ...
        | BiAnt(_x,_x_i1) ->
          ...
          let  o = (o#loc _x) in 
          let  o = (o#string _x_i1) in o)
    method   unknown :'a  . ('a  -> 'self_type ) = (fun (_) -> o) end
let  map_expr (f) =
  object
    inherit  map as super
    method !  expr = (fun (x) -> (f ( (super#expr x) ))) end
let  map_patt (f) =
  object
    inherit  map as super
    method !  patt = (fun (x) -> (f ( (super#patt x) ))) end
let  map_ctyp (f) =
  object
    inherit  map as super
    method !  ctyp = (fun (x) -> (f ( (super#ctyp x) ))) end
let  map_str_item (f) =
  object
    inherit  map as super
    method !  str_item = (fun (x) -> (f ( (super#str_item x) ))) end
let  map_sig_item (f) =
  object
    inherit  map as super
    method !  sig_item = (fun (x) -> (f ( (super#sig_item x) ))) end
let  map_loc (f) =
  object
    inherit  map as super method !  loc = (fun (x) -> (f ( (super#loc x) )))
    end
class
   clean_ast = object
    inherit  map as super
    ...
    method !  expr =
      (fun (e) ->
        ...
        with
        |
          (((((Ast.ExLet(_,_,Ast.BiNil(_),e) |Ast.ExRec(_,Ast.RbNil(_),e))
               |Ast.ExCom(_,Ast.ExNil(_),e)) |Ast.ExCom(_,e,Ast.ExNil(_)))
             |Ast.ExSem(_,Ast.ExNil(_),e)) |Ast.ExSem(_,e,Ast.ExNil(_))) -> e
          | e -> e))
    method !  patt =
      (fun (p) ->
        ...
        with
        |
          ((((((Ast.PaAli(_,p,Ast.PaNil(_)) |Ast.PaOrp(_,Ast.PaNil(_),p))
                |Ast.PaOrp(_,p,Ast.PaNil(_))) |Ast.PaCom(_,Ast.PaNil(_),p))
              |Ast.PaCom(_,p,Ast.PaNil(_))) |Ast.PaSem(_,Ast.PaNil(_),p))
            |Ast.PaSem(_,p,Ast.PaNil(_))) -> p | p -> p))
    method !  match_case =
      (fun (mc) ->
        
        (match (super#match_case mc)
        with
      ...
      (fun (t) ->
        ...
        |
          (((((((((((((((((Ast.TyPol(_,Ast.TyNil(_),t)
                  ...
                  |Ast.TySem(_,Ast.TyNil(_),t)) |Ast.TyCom(_,Ast.TyNil(_),t))
                |Ast.TyCom(_,t,Ast.TyNil(_))) |Ast.TyAmp(_,t,Ast.TyNil(_)))
              |Ast.TyAmp(_,Ast.TyNil(_),t)) |Ast.TySta(_,Ast.TyNil(_),t))
            |Ast.TySta(_,t,Ast.TyNil(_))) -> t | t -> t))
    method !  sig_item =
      (fun (sg) ->
        
        (match (super#sig_item sg)
        with
        | (Ast.SgSem(_,Ast.SgNil(_),sg) |Ast.SgSem(_,sg,Ast.SgNil(_))) -> sg
          | Ast.SgTyp(loc,Ast.TyNil(_)) -> Ast.SgNil (loc) | sg -> sg))
    method !  str_item =
      (fun (st) ->
        
        (match (super#str_item st)
        with
        | (Ast.StSem(_,Ast.StNil(_),st) |Ast.StSem(_,st,Ast.StNil(_))) -> st
          | Ast.StTyp(loc,Ast.TyNil(_)) -> Ast.StNil (loc)
          | Ast.StVal(loc,_,Ast.BiNil(_)) -> Ast.StNil (loc) | st -> st))
    method !  module_type =
      (fun (mt) ->
        
        (match (super#module_type mt)
        with
        | Ast.MtWit(_,mt,Ast.WcNil(_)) -> mt | mt -> mt))
    method !  class_expr =
      (fun (ce) ->
        
        (match (super#class_expr ce)
        with
    ...
    method !  class_sig_item =
      (fun (csg) ->
        ...
        (match (super#class_sig_item csg)
        with
    ...
    method !  class_str_item =
      (fun (cst) ->
        ...
        (match (super#class_str_item cst)
        with
        | (Ast.CrSem(_,Ast.CrNil(_),cst) |Ast.CrSem(_,cst,Ast.CrNil(_))) ->
          cst | cst -> cst)) end
class
   reloc (_loc) = object
    inherit  map method !  loc = (fun (_) -> _loc) end
let  wildcarder =
  object
     (self)inherit  map as super
    method !  patt =
      
      (function
      | Ast.PaId(_loc,Ast.IdLid(_,_)) -> Ast.PaAny (_loc)
        | Ast.PaAli(_,p,_) -> (self#patt p) | p -> (super#patt p)) end