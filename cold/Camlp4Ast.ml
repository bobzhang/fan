...
| _ -> (error ()  ) in function | Ast.TyId (_ , i ) -> i | t -> (self t )
let  ident_of_patt =
let  error (()) =
...
| _ -> (error ()  ) in function | Ast.PaId (_ , i ) -> i | p -> (self p )
     ...
     | Ast.ONone ->
        (Ast.ExId
          (_loc , (
           (Ast.IdAcc
             (_loc , ( (Ast.IdUid (_loc , "Ast" )) ) , (
              (Ast.IdUid (_loc , "ONone" )) ) )) ) )) and meta_module_binding
     (_loc) =
     function
 ...
 method ctyp : (ctyp -> 'self_type )  =
  ...
  | TyDcl (_x , _x_i1 , _x_i2 , _x_i3 , _x_i4 ) ->
     ...
     (o#list (
       fun (o) ->
         fun ((_x , _x_i1 )) ->
           let  o = (o#ctyp _x ) in let  o = (o#ctyp _x_i1 ) in o ) _x_i4 )
     in o
  | TyObj (_x , _x_i1 , _x_i2 ) ->
     let  o = (o#loc _x ) in
