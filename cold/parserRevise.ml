               ...
               ("Gram.mk_action\n  (fun (s : 'luident)  _  (_loc : FanLoc.t)  -> (`Vrn (_loc, s) : 'exp ))\n",
                 (Gram.mk_action
                    (fun (s : 'luident)  _  (_loc : FanLoc.t)  ->
                       (`Vrn (_loc, s) : 'exp )))));
             ([`Skeyword "["; `Skeyword "]"],
               ("Gram.mk_action\n  (fun _  _  (_loc : FanLoc.t)  -> ((`Uid (_loc, \"[]\") : FAst.exp ) : 'exp ))\n",
                 (Gram.mk_action
                    (fun _  _  (_loc : FanLoc.t)  ->
               ...
               ("Gram.mk_action\n  (fun (__fan_1 : [> FanToken.t])  _  (_loc : FanLoc.t)  ->\n     match __fan_1 with\n     | `Flo (_,s) -> (`Flo (_loc, (String.neg s)) : 'pat )\n     | _ -> failwith \"`Flo (_loc, (String.neg s))\n\")\n",
                 (Gram.mk_action
                    (fun (__fan_1 : [> FanToken.t])  _  (_loc : FanLoc.t)  ->
                       ...
                       | _ -> failwith "`Flo (_loc, (String.neg s))\n"))));
             ([`Skeyword "["; `Skeyword "]"],
               ("Gram.mk_action\n  (fun _  _  (_loc : FanLoc.t)  -> ((`Uid (_loc, \"[]\") : FAst.pat ) : 'pat ))\n",
                 (Gram.mk_action
                    (fun _  _  (_loc : FanLoc.t)  ->
                    ...
                    (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                       ...
                       | _ ->
                           failwith
                             "AstQuotation.expand _loc x FanDyn.pat_tag\n"))));
             ([`Skeyword "_"],
               ("Gram.mk_action\n  (fun _  (_loc : FanLoc.t)  -> ((`Any _loc : FAst.pat ) : 'pat ))\n",
                 (Gram.mk_action
                    (fun _  (_loc : FanLoc.t)  ->
               ...
               ("Gram.mk_action\n  (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->\n     match __fan_0 with\n     | `Ant ((\"\"|\"pat\"|\"par\" as n),s) -> (mk_anti _loc ~c:\"pat\" n s : 'ipat )\n     | _ -> failwith \"mk_anti _loc ~c:\"pat\" n s\n\")\n",
                 (Gram.mk_action
                    (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                       ...
                       | _ -> failwith "mk_anti _loc ~c:\"pat\" n s\n"))));
             ([`Skeyword "("; `Skeyword ")"],
               ("Gram.mk_action\n  (fun _  _  (_loc : FanLoc.t)  -> ((`Uid (_loc, \"()\") : FAst.pat ) : 'ipat ))\n",
                 (Gram.mk_action
                    (fun _  _  (_loc : FanLoc.t)  ->
