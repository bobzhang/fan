  ...
  begin
          ...
          (None, None,
            ...
            ([`Stoken
                (((function | `Ant ((""|"sigi"),_) -> true | _ -> false)),
                  (`Normal, "`Ant ((\"\"|\"sigi\"),_)"));
             `Sself],
              ("Gram.mk_action\n  (fun (sg : 'sigis)  (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->\n     match __fan_0 with\n     | `Ant ((\"\"|\"sigi\" as n),s) ->\n         (`Sem (_loc, (mk_anti _loc n ~c:\"sigi\" s), sg) : 'sigis )\n     | _ -> failwith \"`Sem (_loc, (mk_anti _loc n ~c:\"sigi\" s), sg)\n\")\n",
                (Gram.mk_action
                   (fun (sg : 'sigis)  (__fan_0 : [> FanToken.t]) 
                      (_loc : FanLoc.t)  ->
                      match __fan_0 with
                      | `Ant ((""|"sigi" as n),s) ->
                          (`Sem (_loc, (mk_anti _loc n ~c:"sigi" s), sg) : 
            ...
            ([`Snterm (Gram.obj (sigi : 'sigi Gram.t ));
             `Skeyword ";;";
             `Sself],
              ("Gram.mk_action\n  (fun (s : 'sigis)  _  (sg : 'sigi)  (_loc : FanLoc.t)  ->\n     (`Sem (_loc, sg, s) : 'sigis ))\n",
                (Gram.mk_action
                   (fun (s : 'sigis)  _  (sg : 'sigi)  (_loc : FanLoc.t)  ->
                      (`Sem (_loc, sg, s) : 'sigis )))));
            ([`Snterm (Gram.obj (sigi : 'sigi Gram.t )); `Skeyword ";;"],
              ("Gram.mk_action (fun _  (sg : 'sigi)  (_loc : FanLoc.t)  -> (sg : 'sigis ))\n",
                (Gram.mk_action
                   (fun _  (sg : 'sigi)  (_loc : FanLoc.t)  -> (sg : 'sigis )))));
            ([`Snterm (Gram.obj (sigi : 'sigi Gram.t )); `Sself],
              ("Gram.mk_action\n  (fun (s : 'sigis)  (sg : 'sigi)  (_loc : FanLoc.t)  ->\n     (`Sem (_loc, sg, s) : 'sigis ))\n",
                (Gram.mk_action
                   (fun (s : 'sigis)  (sg : 'sigi)  (_loc : FanLoc.t)  ->
                      (`Sem (_loc, sg, s) : 'sigis )))));
            ([`Snterm (Gram.obj (sigi : 'sigi Gram.t ))],
              ("Gram.mk_action (fun (sg : 'sigi)  (_loc : FanLoc.t)  -> (sg : 'sigis ))\n",
                (Gram.mk_action
                   (fun (sg : 'sigi)  (_loc : FanLoc.t)  -> (sg : 'sigis )))))]));
              ...
              ("Gram.mk_action\n  (fun (mt : 'module_declaration)  (i : 'a_uident)  _  (_loc : FanLoc.t)  ->\n     (`Module (_loc, i, mt) : 'sigi ))\n",
                (Gram.mk_action
                   (fun (mt : 'module_declaration)  (i : 'a_uident)  _ 
                      (_loc : FanLoc.t)  -> (`Module (_loc, i, mt) : 
                      'sigi )))));
            ([`Skeyword "module";
             `Skeyword "rec";
             `Snterm
              ...
              ("Gram.mk_action\n  (fun (mb : 'module_rec_declaration)  _  _  (_loc : FanLoc.t)  ->\n     (`RecModule (_loc, mb) : 'sigi ))\n",
                (Gram.mk_action
                   (fun (mb : 'module_rec_declaration)  _  _ 
                      (_loc : FanLoc.t)  -> (`RecModule (_loc, mb) : 
                      'sigi )))));
            ([`Skeyword "module";
             `Skeyword "type";
             `Snterm (Gram.obj (a_uident : 'a_uident Gram.t ));
              ...
              ("Gram.mk_action\n  (fun ((sil,stopped) : 'interf)  _  (si : 'sigi)  (_loc : FanLoc.t)  ->\n     (((si :: sil), stopped) : 'interf ))\n",
                (Gram.mk_action
                   (fun ((sil,stopped) : 'interf)  _  (si : 'sigi) 
                      ...
                      (((si :: sil), stopped) : 'interf )))));
            ([`Snterm (Gram.obj (sigi : 'sigi Gram.t )); `Sself],
              ("Gram.mk_action\n  (fun ((sil,stopped) : 'interf)  (si : 'sigi)  (_loc : FanLoc.t)  ->\n     (((si :: sil), stopped) : 'interf ))\n",
                (Gram.mk_action
         ...
         (None,
                ...
                ("Gram.mk_action\n  (fun _  (seq : 'sequence)  _  (e : 'exp)  _  (_loc : FanLoc.t)  ->\n     (`While (_loc, e, seq) : 'exp ))\n",
                  (Gram.mk_action
                     (fun _  (seq : 'sequence)  _  (e : 'exp)  _ 
                        (_loc : FanLoc.t)  -> (`While (_loc, e, seq) : 
                        'exp )))))]);
           ((Some ":="), (Some `NA),
             [([`Sself; `Skeyword ":="; `Sself],
           ...
           ((Some "||"), (Some `RA),
             [([`Sself;
               ...
               `Sself],
                ("Gram.mk_action\n  (fun (e2 : 'exp)  (op : 'infixop0)  (e1 : 'exp)  (_loc : FanLoc.t)  ->\n     ((`App (_loc, (`App (_loc, op, e1)), e2) : Ast.exp ) : 'exp ))\n",
                  (Gram.mk_action
                     (fun (e2 : 'exp)  (op : 'infixop0)  (e1 : 'exp) 
                        (_loc : FanLoc.t)  ->
                        ((`App (_loc, (`App (_loc, op, e1)), e2) : Ast.exp ) : 
                        'exp )))))]);
           ((Some "&&"), (Some `RA),
             [([`Sself;
           ...
           ((Some "*"), (Some `LA),
             [([`Sself; `Skeyword "land"; `Sself],
                ("Gram.mk_action\n  (fun (e2 : 'exp)  _  (e1 : 'exp)  (_loc : FanLoc.t)  ->\n     ((`App (_loc, (`App (_loc, (`Lid (_loc, \"land\")), e1)), e2) : Ast.exp ) : \n     'exp ))\n",
                  (Gram.mk_action
                     (fun (e2 : 'exp)  _  (e1 : 'exp)  (_loc : FanLoc.t)  ->
                        ((`App
             ...
             ([`Sself; `Skeyword "lor"; `Sself],
               ("Gram.mk_action\n  (fun (e2 : 'exp)  _  (e1 : 'exp)  (_loc : FanLoc.t)  ->\n     ((`App (_loc, (`App (_loc, (`Lid (_loc, \"lor\")), e1)), e2) : Ast.exp ) : \n     'exp ))\n",
                 (Gram.mk_action
                    (fun (e2 : 'exp)  _  (e1 : 'exp)  (_loc : FanLoc.t)  ->
                       ((`App
             ...
             ([`Sself; `Skeyword "lxor"; `Sself],
               ("Gram.mk_action\n  (fun (e2 : 'exp)  _  (e1 : 'exp)  (_loc : FanLoc.t)  ->\n     ((`App (_loc, (`App (_loc, (`Lid (_loc, \"lxor\")), e1)), e2) : Ast.exp ) : \n     'exp ))\n",
                 (Gram.mk_action
                    (fun (e2 : 'exp)  _  (e1 : 'exp)  (_loc : FanLoc.t)  ->
                       ((`App
             ...
             ([`Sself; `Skeyword "mod"; `Sself],
               ("Gram.mk_action\n  (fun (e2 : 'exp)  _  (e1 : 'exp)  (_loc : FanLoc.t)  ->\n     ((`App (_loc, (`App (_loc, (`Lid (_loc, \"mod\")), e1)), e2) : Ast.exp ) : \n     'exp ))\n",
                 (Gram.mk_action
                    (fun (e2 : 'exp)  _  (e1 : 'exp)  (_loc : FanLoc.t)  ->
                       ((`App
           ...
           ((Some "**"), (Some `RA),
             [([`Sself; `Skeyword "asr"; `Sself],
                ("Gram.mk_action\n  (fun (e2 : 'exp)  _  (e1 : 'exp)  (_loc : FanLoc.t)  ->\n     ((`App (_loc, (`App (_loc, (`Lid (_loc, \"asr\")), e1)), e2) : Ast.exp ) : \n     'exp ))\n",
                  (Gram.mk_action
                     (fun (e2 : 'exp)  _  (e1 : 'exp)  (_loc : FanLoc.t)  ->
                        ((`App
             ...
             ([`Sself; `Skeyword "lsl"; `Sself],
               ("Gram.mk_action\n  (fun (e2 : 'exp)  _  (e1 : 'exp)  (_loc : FanLoc.t)  ->\n     ((`App (_loc, (`App (_loc, (`Lid (_loc, \"lsl\")), e1)), e2) : Ast.exp ) : \n     'exp ))\n",
                 (Gram.mk_action
                    (fun (e2 : 'exp)  _  (e1 : 'exp)  (_loc : FanLoc.t)  ->
                       ((`App
             ...
             ([`Sself; `Skeyword "lsr"; `Sself],
               ("Gram.mk_action\n  (fun (e2 : 'exp)  _  (e1 : 'exp)  (_loc : FanLoc.t)  ->\n     ((`App (_loc, (`App (_loc, (`Lid (_loc, \"lsr\")), e1)), e2) : Ast.exp ) : \n     'exp ))\n",
                 (Gram.mk_action
                    (fun (e2 : 'exp)  _  (e1 : 'exp)  (_loc : FanLoc.t)  ->
                       ((`App
               ...
               ("Gram.mk_action\n  (fun _  (cst : 'class_structure)  _  (p : 'pat)  _  _  (_loc : FanLoc.t) \n     -> (`ObjPat (_loc, p, cst) : 'exp ))\n",
                 (Gram.mk_action
                    (fun _  (cst : 'class_structure)  _  (p : 'pat)  _  _ 
                       (_loc : FanLoc.t)  -> (`ObjPat (_loc, p, cst) : 
                       'exp )))));
             ([`Skeyword "object";
              `Skeyword "(";
              `Snterm (Gram.obj (pat : 'pat Gram.t ));
           ...
           ((Some "label"), (Some `NA),
             ...
             ([`Stoken
                 (((function | `LABEL _ -> true | _ -> false)),
                   (`Normal, "`LABEL _"));
              `Sself],
               ("Gram.mk_action\n  (fun (e : 'exp)  (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->\n     match __fan_0 with\n     | `LABEL i -> ((`Label (_loc, (`Lid (_loc, i)), e) : Ast.exp ) : 'exp )\n     | _ -> failwith \"(`Label (_loc, (`Lid (_loc, i)), e) : Ast.exp )\n\")\n",
                 (Gram.mk_action
                    (fun (e : 'exp)  (__fan_0 : [> FanToken.t]) 
                       (_loc : FanLoc.t)  ->
                       match __fan_0 with
                       | `LABEL i ->
                           ((`Label (_loc, (`Lid (_loc, i)), e) : Ast.exp ) : 
                           'exp )
                       | _ ->
                           failwith
                             "(`Label (_loc, (`Lid (_loc, i)), e) : Ast.exp )\n"))));
           ...
           ((Some "simple"), None,
               ...
               ("Gram.mk_action\n  (fun _  (e : 'exp)  (i : 'module_longident_dot_lparen)  (_loc : FanLoc.t) \n     -> (`LetOpen (_loc, i, e) : 'exp ))\n",
                 (Gram.mk_action
                    (fun _  (e : 'exp)  (i : 'module_longident_dot_lparen) 
                       (_loc : FanLoc.t)  -> (`LetOpen (_loc, i, e) : 
                       'exp )))));
               ...
               ("Gram.mk_action\n  (fun (s : 'luident)  _  (_loc : FanLoc.t)  -> (`Vrn (_loc, s) : 'exp ))\n",
                 (Gram.mk_action
                    (fun (s : 'luident)  _  (_loc : FanLoc.t)  ->
                       (`Vrn (_loc, s) : 'exp )))));
             ([`Skeyword "["; `Skeyword "]"],
               ("Gram.mk_action\n  (fun _  _  (_loc : FanLoc.t)  -> ((`Uid (_loc, \"[]\") : Ast.exp ) : 'exp ))\n",
                 (Gram.mk_action
                    (fun _  _  (_loc : FanLoc.t)  ->
                       ((`Uid (_loc, "[]") : Ast.exp ) : 'exp )))));
             ([`Skeyword "[";
              `Snterm
                (Gram.obj (sem_exp_for_list : 'sem_exp_for_list Gram.t ));
              `Skeyword "]"],
               ("Gram.mk_action\n  (fun _  (mk_list : 'sem_exp_for_list)  _  (_loc : FanLoc.t)  ->\n     (mk_list (`Uid (_loc, \"[]\") : Ast.exp ) : 'exp ))\n",
                 (Gram.mk_action
                    (fun _  (mk_list : 'sem_exp_for_list)  _ 
                       (_loc : FanLoc.t)  ->
                       (mk_list (`Uid (_loc, "[]") : Ast.exp ) : 'exp )))));
             ([`Skeyword "[|"; `Skeyword "|]"],
             ...
             ([`Skeyword "{";
              ...
              `Skeyword "}"],
               ("Gram.mk_action\n  (fun _  (el : 'label_exp_list)  _  (__fan_1 : [> FanToken.t])  _ \n     (_loc : FanLoc.t)  ->\n     match __fan_1 with\n     | `Lid x ->\n         ((`RecordWith (_loc, el, (`Lid (_loc, x))) : Ast.exp ) : 'exp )\n     | _ ->\n         failwith \"(`RecordWith (_loc, el, (`Lid (_loc, x))) : Ast.exp )\n\")\n",
                 (Gram.mk_action
                    (fun _  (el : 'label_exp_list)  _ 
                       ...
                       | _ ->
                           failwith
                             "(`RecordWith (_loc, el, (`Lid (_loc, x))) : Ast.exp )\n"))));
             ([`Skeyword "{";
              `Snterm (Gram.obj (label_exp_list : 'label_exp_list Gram.t ));
              `Skeyword "}"],
                  ...
                  ([`Skeyword "&&"],
                    ("Gram.mk_action\n  (fun (x : [> FanToken.t])  (_loc : FanLoc.t)  ->\n     (Gram.string_of_token x : 'e__2 ))\n",
                      (Gram.mk_action
                         (fun (x : [> FanToken.t])  (_loc : FanLoc.t)  ->
                            (Gram.string_of_token x : 'e__2 )))))]],
                ("Gram.mk_action\n  (fun (x : 'e__2)  (_loc : FanLoc.t)  -> (`Lid (_loc, x) : 'infixop1 ))\n",
                  (Gram.mk_action
                  ...
                  ([`Skeyword "||"],
                    ("Gram.mk_action\n  (fun (x : [> FanToken.t])  (_loc : FanLoc.t)  ->\n     (Gram.string_of_token x : 'e__3 ))\n",
                      (Gram.mk_action
                         (fun (x : [> FanToken.t])  (_loc : FanLoc.t)  ->
                            (Gram.string_of_token x : 'e__3 )))))]],
                ("Gram.mk_action\n  (fun (x : 'e__3)  (_loc : FanLoc.t)  -> (`Lid (_loc, x) : 'infixop0 ))\n",
                  (Gram.mk_action
              ...
              ("Gram.mk_action\n  (fun (e : 'exp)  _  (p : 'pat_as_pat_opt)  (_loc : FanLoc.t)  ->\n     (`Case (_loc, p, e) : 'case0 ))\n",
                (Gram.mk_action
                   (fun (e : 'exp)  _  (p : 'pat_as_pat_opt) 
                      (_loc : FanLoc.t)  -> (`Case (_loc, p, e) : 'case0 )))))]));
         ...
         (None,
           ...
           ((Some "apply"), (Some `LA),
             [([`Snterm (Gram.obj (pat_constr : 'pat_constr Gram.t ));
               `Sself],
                ("Gram.mk_action\n  (fun (p2 : 'pat)  (p1 : 'pat_constr)  (_loc : FanLoc.t)  ->\n     (match p2 with\n      | (`Par (_loc,p) : Ast.pat) ->\n          List.fold_left (fun p1  p2  -> (`App (_loc, p1, p2) : Ast.pat )) p1\n            (list_of_com p [])\n      | _ -> (`App (_loc, p1, p2) : Ast.pat ) : 'pat ))\n",
                  (Gram.mk_action
                     (fun (p2 : 'pat)  (p1 : 'pat_constr)  (_loc : FanLoc.t) 
                        ->
                        (match p2 with
                         | (`Par (_loc,p) : Ast.pat) ->
                             List.fold_left
                               (fun p1  p2  ->
                                  (`App (_loc, p1, p2) : Ast.pat )) p1
                               (list_of_com p [])
                         | _ -> (`App (_loc, p1, p2) : Ast.pat ) : 'pat )))));
             ([`Snterm (Gram.obj (pat_constr : 'pat_constr Gram.t ))],
               ("Gram.mk_action (fun (p1 : 'pat_constr)  (_loc : FanLoc.t)  -> (p1 : 'pat ))\n",
                 (Gram.mk_action
                    (fun (p1 : 'pat_constr)  (_loc : FanLoc.t)  ->
                       (p1 : 'pat )))));
             ([`Skeyword "lazy"; `Sself],
               ...
               ("Gram.mk_action\n  (fun (__fan_1 : [> FanToken.t])  _  (_loc : FanLoc.t)  ->\n     match __fan_1 with\n     | `Flo (_,s) -> (`Flo (_loc, (String.neg s)) : 'pat )\n     | _ -> failwith \"`Flo (_loc, (String.neg s))\n\")\n",
                 (Gram.mk_action
                    (fun (__fan_1 : [> FanToken.t])  _  (_loc : FanLoc.t)  ->
                       ...
                       | _ -> failwith "`Flo (_loc, (String.neg s))\n"))));
             ([`Skeyword "["; `Skeyword "]"],
               ("Gram.mk_action\n  (fun _  _  (_loc : FanLoc.t)  -> ((`Uid (_loc, \"[]\") : Ast.pat ) : 'pat ))\n",
                 (Gram.mk_action
                    (fun _  _  (_loc : FanLoc.t)  ->
                       ((`Uid (_loc, "[]") : Ast.pat ) : 'pat )))));
             ([`Skeyword "[";
              `Snterm
                (Gram.obj (sem_pat_for_list : 'sem_pat_for_list Gram.t ));
              `Skeyword "]"],
               ("Gram.mk_action\n  (fun _  (mk_list : 'sem_pat_for_list)  _  (_loc : FanLoc.t)  ->\n     (mk_list (`Uid (_loc, \"[]\") : Ast.pat ) : 'pat ))\n",
                 (Gram.mk_action
                    (fun _  (mk_list : 'sem_pat_for_list)  _ 
                       (_loc : FanLoc.t)  ->
                       (mk_list (`Uid (_loc, "[]") : Ast.pat ) : 'pat )))));
             ([`Skeyword "[|"; `Skeyword "|]"],
             ...
             ([`Skeyword "(";
              ...
              `Skeyword ")"],
               ("Gram.mk_action\n  (fun _  (__fan_4 : [> FanToken.t])  _  (m : 'a_uident)  _  _ \n     (_loc : FanLoc.t)  ->\n     match __fan_4 with\n     | `Ant ((\"opt\" as n),s) ->\n         (`ModuleConstraint (_loc, m, (mk_anti _loc n s)) : 'pat )\n     | _ -> failwith \"`ModuleConstraint (_loc, m, (mk_anti _loc n s))\n\")\n",
                 (Gram.mk_action
                    (fun _  (__fan_4 : [> FanToken.t])  _  (m : 'a_uident)  _
                        _  (_loc : FanLoc.t)  ->
                       match __fan_4 with
                       | `Ant (("opt" as n),s) ->
                    ...
                    (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                       ...
                       | _ ->
                           failwith
                             "AstQuotation.expand _loc x FanDyn.pat_tag\n"))));
             ([`Skeyword "_"],
               ("Gram.mk_action\n  (fun _  (_loc : FanLoc.t)  -> ((`Any _loc : Ast.pat ) : 'pat ))\n",
                 (Gram.mk_action
                    (fun _  (_loc : FanLoc.t)  ->
                       ((`Any _loc : Ast.pat ) : 'pat )))));
             ([`Stoken
                 (((function | `LABEL _ -> true | _ -> false)),
                   (`Normal, "`LABEL _"));
              `Sself],
               ("Gram.mk_action\n  (fun (p : 'pat)  (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->\n     match __fan_0 with\n     | `LABEL i -> ((`Label (_loc, (`Lid (_loc, i)), p) : Ast.pat ) : 'pat )\n     | _ -> failwith \"(`Label (_loc, (`Lid (_loc, i)), p) : Ast.pat )\n\")\n",
                 (Gram.mk_action
                    (fun (p : 'pat)  (__fan_0 : [> FanToken.t]) 
                       (_loc : FanLoc.t)  ->
                       match __fan_0 with
                       | `LABEL i ->
                           ((`Label (_loc, (`Lid (_loc, i)), p) : Ast.pat ) : 
                           'pat )
                       | _ ->
                           failwith
                             "(`Label (_loc, (`Lid (_loc, i)), p) : Ast.pat )\n"))));
             ...
             ([`Skeyword "?";
              ...
              `Skeyword ")"],
               ("Gram.mk_action\n  (fun _  (__fan_6 : [> FanToken.t])  _  (p : 'pat_tcon)  _  _ \n     (i : 'a_lident)  _  (_loc : FanLoc.t)  ->\n     match __fan_6 with\n     | `Ant ((\"opt\" as n),s) ->\n         (`OptLablExpr (_loc, i, p, (mk_anti _loc n s)) : 'pat )\n     | _ -> failwith \"`OptLablExpr (_loc, i, p, (mk_anti _loc n s))\n\")\n",
                 (Gram.mk_action
                    (fun _  (__fan_6 : [> FanToken.t])  _  (p : 'pat_tcon)  _
                        _  (i : 'a_lident)  _  (_loc : FanLoc.t)  ->
                       match __fan_6 with
                       | `Ant (("opt" as n),s) ->
               ...
               ("Gram.mk_action\n  (fun _  (p : 'pat_tcon)  _  _  (i : 'a_lident)  _  (_loc : FanLoc.t)  ->\n     (`OptLabl (_loc, i, p) : 'pat ))\n",
                 (Gram.mk_action
                    (fun _  (p : 'pat_tcon)  _  _  (i : 'a_lident)  _ 
                       (_loc : FanLoc.t)  -> (`OptLabl (_loc, i, p) : 
                       'pat )))));
             ([`Skeyword "?";
              `Snterm (Gram.obj (a_lident : 'a_lident Gram.t ))],
               ("Gram.mk_action\n  (fun (i : 'a_lident)  _  (_loc : FanLoc.t)  ->\n     (`OptLablS (_loc, i) : 'pat ))\n",
         ...
         (None,
           (None, None,
               ...
               ("Gram.mk_action\n  (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->\n     match __fan_0 with\n     | `Ant ((\"\"|\"pat\"|\"par\" as n),s) -> (mk_anti _loc ~c:\"pat\" n s : 'ipat )\n     | _ -> failwith \"mk_anti _loc ~c:\"pat\" n s\n\")\n",
                 (Gram.mk_action
                    (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                       ...
                       | _ -> failwith "mk_anti _loc ~c:\"pat\" n s\n"))));
             ([`Skeyword "("; `Skeyword ")"],
               ("Gram.mk_action\n  (fun _  _  (_loc : FanLoc.t)  -> ((`Uid (_loc, \"()\") : Ast.pat ) : 'ipat ))\n",
                 (Gram.mk_action
                    (fun _  _  (_loc : FanLoc.t)  ->
                       ((`Uid (_loc, "()") : Ast.pat ) : 'ipat )))));
             ([`Skeyword "(";
              `Skeyword "module";
              `Snterm (Gram.obj (a_uident : 'a_uident Gram.t ));
              `Skeyword ")"],
                    ...
                    (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                       ...
                       | _ ->
                           failwith
                             "AstQuotation.expand _loc x FanDyn.pat_tag\n"))));
             ([`Skeyword "_"],
               ("Gram.mk_action\n  (fun _  (_loc : FanLoc.t)  -> ((`Any _loc : Ast.pat ) : 'ipat ))\n",
                 (Gram.mk_action
                    (fun _  (_loc : FanLoc.t)  ->
                       ((`Any _loc : Ast.pat ) : 'ipat )))));
             ([`Stoken
                 (((function | `LABEL _ -> true | _ -> false)),
                   (`Normal, "`LABEL _"));
              `Sself],
               ("Gram.mk_action\n  (fun (p : 'ipat)  (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->\n     match __fan_0 with\n     | `LABEL i -> ((`Label (_loc, (`Lid (_loc, i)), p) : Ast.pat ) : 'ipat )\n     | _ -> failwith \"(`Label (_loc, (`Lid (_loc, i)), p) : Ast.pat )\n\")\n",
                 (Gram.mk_action
             ...
             ([`Skeyword "~";
              ...
              `Skeyword ":";
              `Sself],
               ("Gram.mk_action\n  (fun (p : 'ipat)  _  (i : 'a_lident)  _  (_loc : FanLoc.t)  ->\n     ((`Label (_loc, i, p) : Ast.pat ) : 'ipat ))\n",
                 (Gram.mk_action
                    (fun (p : 'ipat)  _  (i : 'a_lident)  _ 
                       (_loc : FanLoc.t)  ->
                       ((`Label (_loc, i, p) : Ast.pat ) : 'ipat )))));
             ([`Skeyword "~";
              `Snterm (Gram.obj (a_lident : 'a_lident Gram.t ))],
         ...
         (None,
           (None, None,
             [([`Snterm (Gram.obj (pat : 'pat Gram.t ));
               `Skeyword ":";
               `Snterm (Gram.obj (ctyp : 'ctyp Gram.t ))],
                ("Gram.mk_action\n  (fun (t : 'ctyp)  _  (p : 'pat)  (_loc : FanLoc.t)  ->\n     ((`Constraint (_loc, p, t) : Ast.pat ) : 'pat_tcon ))\n",
                  (Gram.mk_action
                     (fun (t : 'ctyp)  _  (p : 'pat)  (_loc : FanLoc.t)  ->
                        ((`Constraint (_loc, p, t) : Ast.pat ) : 'pat_tcon )))));
             ([`Snterm (Gram.obj (pat : 'pat Gram.t ))],
        ...
        (None,
          ...
          ((Some "simple"), None,
            ...
            ([`Stoken
                (((function | `Lid _ -> true | _ -> false)),
                  (`Normal, "`Lid _"))],
              ("Gram.mk_action\n  (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->\n     match __fan_0 with\n     | `Lid i -> ((`Lid (_loc, i) : Ast.ident ) : 'ident_quot )\n     | _ -> failwith \"(`Lid (_loc, i) : Ast.ident )\n\")\n",
                (Gram.mk_action
                   (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                      match __fan_0 with
                      | `Lid i ->
                          ((`Lid (_loc, i) : Ast.ident ) : 'ident_quot )
                      | _ -> failwith "(`Lid (_loc, i) : Ast.ident )\n"))));
            ([`Stoken
                (((function | `Uid _ -> true | _ -> false)),
                  (`Normal, "`Uid _"))],
              ("Gram.mk_action\n  (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->\n     match __fan_0 with\n     | `Uid i -> ((`Uid (_loc, i) : Ast.ident ) : 'ident_quot )\n     | _ -> failwith \"(`Uid (_loc, i) : Ast.ident )\n\")\n",
                (Gram.mk_action
                   (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                      match __fan_0 with
                      | `Uid i ->
                          ((`Uid (_loc, i) : Ast.ident ) : 'ident_quot )
                      | _ -> failwith "(`Uid (_loc, i) : Ast.ident )\n"))));
            ([`Stoken
                (((function | `Uid _ -> true | _ -> false)),
                  (`Normal, "`Uid _"));
             `Skeyword ".";
             `Sself],
              ("Gram.mk_action\n  (fun (j : 'ident_quot)  _  (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t) \n     ->\n     match __fan_0 with\n     | `Uid s ->\n         ((`Dot (_loc, (`Uid (_loc, s)), j) : Ast.ident ) : 'ident_quot )\n     | _ -> failwith \"(`Dot (_loc, (`Uid (_loc, s)), j) : Ast.ident )\n\")\n",
                (Gram.mk_action
                   (fun (j : 'ident_quot)  _  (__fan_0 : [> FanToken.t]) 
                      (_loc : FanLoc.t)  ->
                      match __fan_0 with
                      | `Uid s ->
                          ((`Dot (_loc, (`Uid (_loc, s)), j) : Ast.ident ) : 
                          'ident_quot )
                      | _ ->
                          failwith
                            "(`Dot (_loc, (`Uid (_loc, s)), j) : Ast.ident )\n"))));
            ...
            ([`Skeyword ".";
             ...
             `Sself],
              ("Gram.mk_action\n  (fun (xs : 'dot_lstrings)  _  (__fan_1 : [> FanToken.t])  _ \n     (_loc : FanLoc.t)  ->\n     match __fan_1 with\n     | `Uid i ->\n         ((match xs with\n           | (`Sub xs,v) -> ((`Absolute (i :: xs)), v)\n           | _ -> raise (XStream.Error \"impossible dot_lstrings\")) : \n         'dot_lstrings )\n     | _ ->\n         failwith\n           \"match xs with\n| (`Sub xs,v) -> ((`Absolute (i :: xs)), v)\n| _ -> raise (XStream.Error \"impossible dot_lstrings\")\n\")\n",
                (Gram.mk_action
                   (fun (xs : 'dot_lstrings)  _  (__fan_1 : [> FanToken.t]) 
                      _  (_loc : FanLoc.t)  ->
                      match __fan_1 with
                      | `Uid i ->
                          ((match xs with
        ...
        (None,
          (None, None,
            ...
            ([`Stoken
             ...
             `Skeyword ".";
             `Sself],
              ("Gram.mk_action\n  (fun (l : 'module_longident_dot_lparen)  _  (__fan_0 : [> FanToken.t]) \n     (_loc : FanLoc.t)  ->\n     match __fan_0 with\n     | `Uid i ->\n         ((`Dot (_loc, (`Uid (_loc, i)), l) : Ast.ident ) : 'module_longident_dot_lparen )\n     | _ -> failwith \"(`Dot (_loc, (`Uid (_loc, i)), l) : Ast.ident )\n\")\n",
                (Gram.mk_action
                   (fun (l : 'module_longident_dot_lparen)  _ 
                      (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                      match __fan_0 with
                      | `Uid i ->
                          ((`Dot (_loc, (`Uid (_loc, i)), l) : Ast.ident ) : 
            ...
            ([`Stoken
             ...
             `Skeyword ".";
             `Skeyword "("],
              ("Gram.mk_action\n  (fun _  _  (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->\n     match __fan_0 with\n     | `Uid i ->\n         ((`Uid (_loc, i) : Ast.ident ) : 'module_longident_dot_lparen )\n     | _ -> failwith \"(`Uid (_loc, i) : Ast.ident )\n\")\n",
                (Gram.mk_action
                   (fun _  _  (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t) 
                      ->
                      match __fan_0 with
            ...
            ([`Stoken
             ...
             `Skeyword ".";
             `Sself],
              ("Gram.mk_action\n  (fun (l : 'module_longident_dot_lparen)  _  (__fan_0 : [> FanToken.t]) \n     (_loc : FanLoc.t)  ->\n     match __fan_0 with\n     | `Ant ((\"uid\"|\"\" as n),s) ->\n         ((`Dot (_loc, (mk_anti _loc ~c:\"ident\" n s), l) : Ast.ident ) : \n         'module_longident_dot_lparen )\n     | _ ->\n         failwith\n           \"(`Dot (_loc, (mk_anti _loc ~c:\"ident\" n s), l) : Ast.ident )\n\")\n",
                (Gram.mk_action
                   (fun (l : 'module_longident_dot_lparen)  _ 
                      (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                      match __fan_0 with
                      | `Ant (("uid"|"" as n),s) ->
                          ...
                          Ast.ident ) : 'module_longident_dot_lparen )
                      | _ ->
                          failwith
                            "(`Dot (_loc, (mk_anti _loc ~c:\"ident\" n s), l) : Ast.ident )\n"))))]));
        ...
        (None,
          ...
          ((Some "simple"), None,
            ...
            ([`Stoken
                (((function | `Lid _ -> true | _ -> false)),
                  (`Normal, "`Lid _"))],
              ("Gram.mk_action\n  (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->\n     match __fan_0 with\n     | `Lid i -> ((`Lid (_loc, i) : Ast.ident ) : 'type_longident )\n     | _ -> failwith \"(`Lid (_loc, i) : Ast.ident )\n\")\n",
                (Gram.mk_action
                   (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                      match __fan_0 with
                      | `Lid i ->
                          ((`Lid (_loc, i) : Ast.ident ) : 'type_longident )
                      | _ -> failwith "(`Lid (_loc, i) : Ast.ident )\n"))));
            ([`Stoken
                (((function | `Uid _ -> true | _ -> false)),
                  (`Normal, "`Uid _"))],
              ("Gram.mk_action\n  (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->\n     match __fan_0 with\n     | `Uid i -> ((`Uid (_loc, i) : Ast.ident ) : 'type_longident )\n     | _ -> failwith \"(`Uid (_loc, i) : Ast.ident )\n\")\n",
                (Gram.mk_action
                   (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                      match __fan_0 with
                      | `Uid i ->
                          ((`Uid (_loc, i) : Ast.ident ) : 'type_longident )
                      | _ -> failwith "(`Uid (_loc, i) : Ast.ident )\n"))));
            ([`Skeyword "("; `Sself; `Skeyword ")"],
        ...
        (None,
          (None, None,
            ...
            ([`Stoken
                (((function | `Lid _ -> true | _ -> false)),
                  (`Normal, "`Lid _"))],
              ("Gram.mk_action\n  (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->\n     match __fan_0 with\n     | `Lid i -> ((`Lid (_loc, i) : Ast.ident ) : 'label_longident )\n     | _ -> failwith \"(`Lid (_loc, i) : Ast.ident )\n\")\n",
                (Gram.mk_action
                   (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                      match __fan_0 with
                      | `Lid i ->
                          ((`Lid (_loc, i) : Ast.ident ) : 'label_longident )
                      | _ -> failwith "(`Lid (_loc, i) : Ast.ident )\n"))));
            ([`Stoken
                (((function | `Uid _ -> true | _ -> false)),
                  (`Normal, "`Uid _"));
             `Skeyword ".";
             `Sself],
              ("Gram.mk_action\n  (fun (l : 'label_longident)  _  (__fan_0 : [> FanToken.t]) \n     (_loc : FanLoc.t)  ->\n     match __fan_0 with\n     | `Uid i ->\n         ((`Dot (_loc, (`Uid (_loc, i)), l) : Ast.ident ) : 'label_longident )\n     | _ -> failwith \"(`Dot (_loc, (`Uid (_loc, i)), l) : Ast.ident )\n\")\n",
                (Gram.mk_action
                   (fun (l : 'label_longident)  _  (__fan_0 : [> FanToken.t])
                       (_loc : FanLoc.t)  ->
                      match __fan_0 with
                   ...
                   (fun (st : 'strus)  _  (__fan_0 : [> FanToken.t]) 
                      ...
                      | _ ->
                          failwith
                            "`Sem (_loc, (mk_anti _loc n ~c:\"stru\" s), st)\n"))));
            ([`Snterm (Gram.obj (stru : 'stru Gram.t ))],
              ("Gram.mk_action (fun (st : 'stru)  (_loc : FanLoc.t)  -> (st : 'strus ))\n",
                (Gram.mk_action
                   (fun (st : 'stru)  (_loc : FanLoc.t)  -> (st : 'strus )))));
            ([`Snterm (Gram.obj (stru : 'stru Gram.t )); `Skeyword ";;"],
              ("Gram.mk_action (fun _  (st : 'stru)  (_loc : FanLoc.t)  -> (st : 'strus ))\n",
                (Gram.mk_action
                   (fun _  (st : 'stru)  (_loc : FanLoc.t)  -> (st : 'strus )))));
            ([`Snterm (Gram.obj (stru : 'stru Gram.t ));
             `Skeyword ";;";
             `Sself],
              ("Gram.mk_action\n  (fun (xs : 'strus)  _  (st : 'stru)  (_loc : FanLoc.t)  ->\n     (`Sem (_loc, st, xs) : 'strus ))\n",
                (Gram.mk_action
                   (fun (xs : 'strus)  _  (st : 'stru)  (_loc : FanLoc.t)  ->
                      (`Sem (_loc, st, xs) : 'strus )))));
            ([`Snterm (Gram.obj (stru : 'stru Gram.t )); `Sself],
              ("Gram.mk_action\n  (fun (xs : 'strus)  (st : 'stru)  (_loc : FanLoc.t)  ->\n     (`Sem (_loc, st, xs) : 'strus ))\n",
                (Gram.mk_action
                   (fun (xs : 'strus)  (st : 'stru)  (_loc : FanLoc.t)  ->
                      (`Sem (_loc, st, xs) : 'strus )))))]));
        ...
        (None,
          [((Some "top"), None,
                ...
                ("Gram.mk_action\n  (fun (t : 'constructor_declaration)  _  (_loc : FanLoc.t)  ->\n     (`Exception (_loc, t) : 'stru ))\n",
                  (Gram.mk_action
                     (fun (t : 'constructor_declaration)  _ 
                        (_loc : FanLoc.t)  -> (`Exception (_loc, t) : 
                        'stru )))));
             ([`Skeyword "external";
              `Snterm (Gram.obj (a_lident : 'a_lident Gram.t ));
              `Skeyword ":";
               ...
               ("Gram.mk_action\n  (fun (mb : 'mbind0)  (i : 'a_uident)  _  (_loc : FanLoc.t)  ->\n     (`Module (_loc, i, mb) : 'stru ))\n",
                 (Gram.mk_action
                    (fun (mb : 'mbind0)  (i : 'a_uident)  _ 
                       (_loc : FanLoc.t)  -> (`Module (_loc, i, mb) : 
                       'stru )))));
             ([`Skeyword "module";
              `Skeyword "rec";
               ...
               ("Gram.mk_action\n  (fun _  (ns : 'string_list)  _  _  (t : 'type_declaration)  _ \n     (_loc : FanLoc.t)  -> (`TypeWith (_loc, t, ns) : 'stru ))\n",
                 (Gram.mk_action
                    (fun _  (ns : 'string_list)  _  _ 
                       (t : 'type_declaration)  _  (_loc : FanLoc.t)  ->
             ...
             ([`Skeyword "let";
              ...
              `Skeyword "in";
              `Snterm (Gram.obj (exp : 'exp Gram.t ))],
               ("Gram.mk_action\n  (fun (e : 'exp)  _  (mb : 'mbind0)  (m : 'a_uident)  _  _ \n     (_loc : FanLoc.t)  ->\n     ((`StExp (_loc, (`LetModule (_loc, m, mb, e))) : Ast.stru ) : 'stru ))\n",
                 (Gram.mk_action
                    (fun (e : 'exp)  _  (mb : 'mbind0)  (m : 'a_uident)  _  _
                        (_loc : FanLoc.t)  ->
             ...
             ([`Skeyword "let";
              ...
              `Skeyword "in";
              `Snterm (Gram.obj (exp : 'exp Gram.t ))],
               ("Gram.mk_action\n  (fun (e : 'exp)  _  (i : 'module_longident)  _  _  (_loc : FanLoc.t)  ->\n     (let i = (i : vid  :>ident) in\n      (`StExp (_loc, (`LetOpen (_loc, i, e))) : Ast.stru ) : 'stru ))\n",
                 (Gram.mk_action
                    (fun (e : 'exp)  _  (i : 'module_longident)  _  _ 
                       (_loc : FanLoc.t)  ->
                       (let i = (i : vid  :>ident) in
                        (`StExp (_loc, (`LetOpen (_loc, i, e))) : Ast.stru ) : 
                       'stru )))));
             ([`Skeyword "let";
              `Skeyword "try";
              `Snterm (Gram.obj (opt_rec : 'opt_rec Gram.t ));
        ...
        (None,
          (None, None,
            ...
            ([`Skeyword "val";
             ...
             `Skeyword ":";
             `Snterm (Gram.obj (ctyp : 'ctyp Gram.t ))],
              ("Gram.mk_action\n  (fun (t : 'ctyp)  _  (l : 'a_lident)  (mv : 'opt_virtual) \n     (mf : 'opt_mutable)  _  (_loc : FanLoc.t)  ->\n     ((`CgVal (_loc, l, mf, mv, t) : Ast.clsigi ) : 'clsigi ))\n",
                (Gram.mk_action
                   (fun (t : 'ctyp)  _  (l : 'a_lident)  (mv : 'opt_virtual) 
                      (mf : 'opt_mutable)  _  (_loc : FanLoc.t)  ->
                      ((`CgVal (_loc, l, mf, mv, t) : Ast.clsigi ) : 
                      'clsigi )))));
            ([`Skeyword "method";
             `Skeyword "virtual";
             `Snterm (Gram.obj (opt_private : 'opt_private Gram.t ));
        ...
        (None,
          (None, None,
            ...
            ([`Stoken
             ...
             `Skeyword ";";
             `Sself],
              ("Gram.mk_action\n  (fun (cst : 'class_structure)  _  (__fan_0 : [> FanToken.t]) \n     (_loc : FanLoc.t)  ->\n     match __fan_0 with\n     | `Ant ((\"\"|\"cst\" as n),s) ->\n         ((`Sem (_loc, (mk_anti _loc ~c:\"clfield\" n s), cst) : Ast.clfield ) : \n         'class_structure )\n     | _ ->\n         failwith\n           \"(`Sem (_loc, (mk_anti _loc ~c:\"clfield\" n s), cst) : Ast.clfield )\n\")\n",
                (Gram.mk_action
                   (fun (cst : 'class_structure)  _ 
                      ...
                      | `Ant ((""|"cst" as n),s) ->
                          ...
                          Ast.clfield ) : 'class_structure )
                      | _ ->
                          failwith
                            "(`Sem (_loc, (mk_anti _loc ~c:\"clfield\" n s), cst) : Ast.clfield )\n"))));
            ([`Snterm (Gram.obj (clfield : 'clfield Gram.t ))],
              ("Gram.mk_action\n  (fun (st : 'clfield)  (_loc : FanLoc.t)  -> (st : 'class_structure ))\n",
                (Gram.mk_action
                   (fun (st : 'clfield)  (_loc : FanLoc.t)  ->
                      (st : 'class_structure )))));
            ([`Snterm (Gram.obj (clfield : 'clfield Gram.t )); `Skeyword ";"],
              ("Gram.mk_action\n  (fun _  (st : 'clfield)  (_loc : FanLoc.t)  -> (st : 'class_structure ))\n",
                (Gram.mk_action
                   (fun _  (st : 'clfield)  (_loc : FanLoc.t)  ->
                      (st : 'class_structure )))));
            ([`Snterm (Gram.obj (clfield : 'clfield Gram.t ));
             `Skeyword ";";
             `Sself],
              ("Gram.mk_action\n  (fun (xs : 'class_structure)  _  (st : 'clfield)  (_loc : FanLoc.t)  ->\n     (`Sem (_loc, st, xs) : 'class_structure ))\n",
                (Gram.mk_action
                   (fun (xs : 'class_structure)  _  (st : 'clfield) 
                      (_loc : FanLoc.t)  ->
                      (`Sem (_loc, st, xs) : 'class_structure )))));
            ([`Snterm (Gram.obj (clfield : 'clfield Gram.t )); `Sself],
              ("Gram.mk_action\n  (fun (xs : 'class_structure)  (st : 'clfield)  (_loc : FanLoc.t)  ->\n     (`Sem (_loc, st, xs) : 'class_structure ))\n",
                (Gram.mk_action
        ...
        (None,
          (None, None,
            ...
            ([`Stoken
                (((function | `QUOTATION _ -> true | _ -> false)),
                  (`Normal, "`QUOTATION _"))],
              ("Gram.mk_action\n  (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->\n     match __fan_0 with\n     | `QUOTATION x ->\n         (AstQuotation.expand _loc x FanDyn.clfield_tag : 'clfield )\n     | _ -> failwith \"AstQuotation.expand _loc x FanDyn.clfield_tag\n\")\n",
                (Gram.mk_action
                   (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                      match __fan_0 with
                      | `QUOTATION x ->
                          (AstQuotation.expand _loc x FanDyn.clfield_tag : 
                          'clfield )
                      | _ ->
                          failwith
                            "AstQuotation.expand _loc x FanDyn.clfield_tag\n"))));
            ...
            ([`Skeyword "inherit";
             ...
             `Skeyword "as";
             `Snterm (Gram.obj (a_lident : 'a_lident Gram.t ))],
              ("Gram.mk_action\n  (fun (i : 'a_lident)  _  (ce : 'clexp)  (o : 'opt_override)  _ \n     (_loc : FanLoc.t)  -> (`InheritAs (_loc, o, ce, i) : 'clfield ))\n",
                (Gram.mk_action
              ...
              ("Gram.mk_action\n  (fun (e : 'cvalue_bind)  (lab : 'a_lident)  (mf : 'opt_mutable) \n     (o : 'value_val_opt_override)  (_loc : FanLoc.t)  ->\n     ((`CrVal (_loc, lab, o, mf, e) : Ast.clfield ) : 'clfield ))\n",
                (Gram.mk_action
                   (fun (e : 'cvalue_bind)  (lab : 'a_lident) 
                      ...
                      (_loc : FanLoc.t)  ->
                      ((`CrVal (_loc, lab, o, mf, e) : Ast.clfield ) : 
                      'clfield )))));
            ([`Snterm
                (Gram.obj
                   (value_val_opt_override : 'value_val_opt_override Gram.t ));
            ...
            ([`Skeyword "constraint";
             ...
             `Skeyword "=";
             `Snterm (Gram.obj (ctyp : 'ctyp Gram.t ))],
              ("Gram.mk_action\n  (fun (t2 : 'ctyp)  _  (t1 : 'ctyp)  _  (_loc : FanLoc.t)  ->\n     ((`Eq (_loc, t1, t2) : Ast.clfield ) : 'clfield ))\n",
                (Gram.mk_action
                   (fun (t2 : 'ctyp)  _  (t1 : 'ctyp)  _  (_loc : FanLoc.t) 
                      -> ((`Eq (_loc, t1, t2) : Ast.clfield ) : 'clfield )))));
            ([`Skeyword "initializer";
             `Snterm (Gram.obj (exp : 'exp Gram.t ))],
              ("Gram.mk_action\n  (fun (se : 'exp)  _  (_loc : FanLoc.t)  ->\n     ((`Initializer (_loc, se) : Ast.clfield ) : 'clfield ))\n",
                (Gram.mk_action
                   (fun (se : 'exp)  _  (_loc : FanLoc.t)  ->
                      ((`Initializer (_loc, se) : Ast.clfield ) : 'clfield )))))]));
        ...
        (None,
          (None, None,
            [([`Snterm (Gram.obj (clfield : 'clfield Gram.t ));
              `Skeyword ";";
              `Sself],
               ("Gram.mk_action\n  (fun (x2 : 'clfield_quot)  _  (x1 : 'clfield)  (_loc : FanLoc.t)  ->\n     (`Sem (_loc, x1, x2) : 'clfield_quot ))\n",
                 (Gram.mk_action
                    (fun (x2 : 'clfield_quot)  _  (x1 : 'clfield) 
                       (_loc : FanLoc.t)  ->
                       (`Sem (_loc, x1, x2) : 'clfield_quot )))));
            ([`Snterm (Gram.obj (clfield : 'clfield Gram.t ))],
              ("Gram.mk_action\n  (fun (x : 'clfield)  (_loc : FanLoc.t)  -> (x : 'clfield_quot ))\n",
                (Gram.mk_action
                   (fun (x : 'clfield)  (_loc : FanLoc.t)  ->
                      (x : 'clfield_quot )))))]))
    end;
    begin
               ...
               ("Gram.mk_action\n  (fun (c2 : 'class_declaration)  _  (c1 : 'class_declaration) \n     (_loc : FanLoc.t)  -> (`And (_loc, c1, c2) : 'class_declaration ))\n",
                 (Gram.mk_action
                    (fun (c2 : 'class_declaration)  _ 
                       (c1 : 'class_declaration)  (_loc : FanLoc.t)  ->
    ...
    Gram.extend_single (cltyp_quot : 'cltyp_quot Gram.t )
      (None,
        (None, None,
          [([`Snterm (Gram.obj (cltyp : 'cltyp Gram.t ))],
             ("Gram.mk_action (fun (x : 'cltyp)  (_loc : FanLoc.t)  -> (x : 'cltyp_quot ))\n",
               (Gram.mk_action
                  (fun (x : 'cltyp)  (_loc : FanLoc.t)  -> (x : 'cltyp_quot )))))]));
      ...
      (None,
        (None, None,
          ...
          ([`Snterm (Gram.obj (vid : 'vid Gram.t ));
           ...
           `Snterm (Gram.obj (comma_ctyp : 'comma_ctyp Gram.t ));
           `Skeyword "]"],
            ("Gram.mk_action\n  (fun _  (t : 'comma_ctyp)  _  (i : 'vid)  (_loc : FanLoc.t)  ->\n     (`ClApply (_loc, i, t) : 'cltyp ))\n",
              (Gram.mk_action
                 (fun _  (t : 'comma_ctyp)  _  (i : 'vid)  (_loc : FanLoc.t) 
                    -> (`ClApply (_loc, i, t) : 'cltyp )))));
          ([`Snterm (Gram.obj (vid : 'vid Gram.t ))],
            ("Gram.mk_action\n  (fun (i : 'vid)  (_loc : FanLoc.t)  -> ((i :>cltyp) : 'cltyp ))\n",
              (Gram.mk_action
                 (fun (i : 'vid)  (_loc : FanLoc.t)  ->
                    ((i :>cltyp) : 'cltyp )))));
          ([`Skeyword "object";
            ...
            ("Gram.mk_action\n  (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->\n     match __fan_0 with\n     | `QUOTATION x ->\n         (AstQuotation.expand _loc x FanDyn.ctyp_tag : 'unquoted_typevars )\n     | _ -> failwith \"AstQuotation.expand _loc x FanDyn.ctyp_tag\n\")\n",
              (Gram.mk_action
                 (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                    match __fan_0 with
                    | `QUOTATION x ->
                        (AstQuotation.expand _loc x FanDyn.ctyp_tag : 
                        'unquoted_typevars )
                    | _ ->
                        failwith
                          "AstQuotation.expand _loc x FanDyn.ctyp_tag\n"))));
              ...
              ("Gram.mk_action\n  (fun (i : 'a_lident)  _  _  (t1 : 'ctyp)  (_loc : FanLoc.t)  ->\n     (`Alias (_loc, t1, i) : 'ctyp ))\n",
                (Gram.mk_action
                   (fun (i : 'a_lident)  _  _  (t1 : 'ctyp) 
                      (_loc : FanLoc.t)  -> (`Alias (_loc, t1, i) : 'ctyp )))))]);
        ((Some "forall"), (Some `LA),
          [([`Skeyword "!";
             ...
             ("Gram.mk_action\n  (fun (t2 : 'ctyp)  _  (t1 : 'typevars)  _  (_loc : FanLoc.t)  ->\n     (`TyPol (_loc, t1, t2) : 'ctyp ))\n",
               (Gram.mk_action
                  (fun (t2 : 'ctyp)  _  (t1 : 'typevars)  _ 
                     (_loc : FanLoc.t)  -> (`TyPol (_loc, t1, t2) : 'ctyp )))))]);
        ((Some "arrow"), (Some `RA),
          [([`Sself; `Skeyword "->"; `Sself],
             ...
             ("Gram.mk_action\n  (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->\n     match __fan_0 with\n     | `Ant ((\"\"|\"typ\" as n),s) -> (mk_anti _loc ~c:\"ctyp\" n s : 'com_ctyp )\n     | _ -> failwith \"mk_anti _loc ~c:\"ctyp\" n s\n\")\n",
               (Gram.mk_action
                  (fun (__fan_0 : [> FanToken.t])  (_loc : FanLoc.t)  ->
                     ...
                     | _ -> failwith "mk_anti _loc ~c:\"ctyp\" n s\n"))));
          ([`Sself; `Skeyword ","; `Sself],
            ("Gram.mk_action\n  (fun (t2 : 'com_ctyp)  _  (t1 : 'com_ctyp)  (_loc : FanLoc.t)  ->\n     (`Com (_loc, t1, t2) : 'com_ctyp ))\n",
              (Gram.mk_action
                 (fun (t2 : 'com_ctyp)  _  (t1 : 'com_ctyp) 
                    (_loc : FanLoc.t)  -> (`Com (_loc, t1, t2) : 'com_ctyp )))));
          ([`Snterm (Gram.obj (ctyp : 'ctyp Gram.t ))],
            ("Gram.mk_action (fun (t : 'ctyp)  (_loc : FanLoc.t)  -> (t : 'com_ctyp ))\n",
              (Gram.mk_action
                 (fun (t : 'ctyp)  (_loc : FanLoc.t)  -> (t : 'com_ctyp )))))]));
