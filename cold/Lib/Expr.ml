                          ...
                          Ast.ExFun (_loc, (
                            Ast.McArr (_loc, (
                              ...
                              Ast.ExApp (_loc, (
                                ...
                                Ast.ExId (_loc, ( Ast.IdLid (_loc, "xs") ))
                                ))
                              ))
                            ))
                          ))
...
let map_expr =
  ...
  | Ast.ExId (_loc,Ast.IdLid (_,"__LOCATION__")) ->
      ...
      Ast.ExApp (_loc, (
        ...
        Ast.ExTup (_loc, (
          Ast.ExCom (_loc, ( Ast.ExStr (_loc, ( Ast.safe_string_escaped a ))
            ), (
            Ast.ExCom (_loc, (
              Ast.ExCom (_loc, (
                Ast.ExCom (_loc, (
            ...
            fun n ->
              fun e ->
                ...
                | "`nativeint" ->
                    Ast.ExApp (_loc, (
                      Ast.ExId (_loc, (
                        Ast.IdAcc (_loc, ( Ast.IdUid (_loc, "Nativeint") ), (
                          Ast.IdLid (_loc, "to_string") ))
                        ))
                      ), e)
                | "`flo" ->
                    Ast.ExApp (_loc, (
                      Ast.ExId (_loc, (
                        Ast.IdAcc (_loc, ( Ast.IdUid (_loc, "FanUtil") ), (
