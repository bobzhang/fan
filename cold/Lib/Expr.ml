...
let mkumin _loc f arg =
  ...
  | _ -> Ast.ExApp (_loc,(Ast.ExId (_loc,(Ast.IdLid (_loc,("~" ^ f))))),arg)
let mkassert _loc =
  function
                                   ...
                                   (_loc,(Ast.ExId
                                            (_loc,(Ast.IdAcc
                                                     ...
                                                     Ast.IdAcc
                                                       (_loc,(Ast.IdUid
                                                                (_loc,"Array3")),(
                                                       Ast.IdLid (_loc,"get")))))))),arr)),c1)),c2)),c3)
  | c1::c2::c3::coords ->
      Ast.ExApp
        (_loc,(Ast.ExApp
                 (_loc,(Ast.ExId
        ...
        Ast.ExArr
          (_loc,(Ast.ExSem
                   (_loc,c1,(Ast.ExSem
                               (_loc,c2,(Ast.ExSem
                                           (_loc,c3,(Ast.exSem_of_list coords))))))))))
                                      ...
                                      (_loc,(Ast.ExId
                                               (_loc,(Ast.IdAcc
                                                        ...
                                                        Ast.IdAcc
                                                          ...
                                                          Ast.IdLid
                                                            (_loc,"get")))))))),arr)),c1)),(
                    Ast.ExId (_loc,(Ast.IdLid (_loc,"contents")))))),newval))
  | Ast.ExApp
      (_,Ast.ExApp
       (_,Ast.ExApp
        (_,Ast.ExId
  ...
  then
    Ast.ExApp
      (_loc,(Ast.ExApp
               (_loc,(Ast.ExId
                        (_loc,(Ast.IdAcc
                                 (_loc,(Ast.IdUid (_loc,"List")),(Ast.IdLid
                                                                    (_loc,"filter")))))),(
               Ast.ExFun (_loc,(Ast.McArr (_loc,p,(Ast.ExNil _loc),b)))))),l)
  else
    Ast.ExApp
      (_loc,(Ast.ExApp
               (_loc,(Ast.ExId
               ...
               Ast.ExFun
                 (_loc,(Ast.McOr
                          (_loc,(Ast.McArr
                                   (_loc,p,(Ast.ExId
                                              (_loc,(Ast.IdUid (_loc,"True")))),b)),(
                          Ast.McArr
                            (_loc,(Ast.PaAny _loc),(Ast.ExNil _loc),(
                            Ast.ExId (_loc,(Ast.IdUid (_loc,"False")))))))))))),l)
let concat _loc l =
  Ast.ExApp
    (_loc,(Ast.ExId
             (_loc,(Ast.IdAcc
