...
type full_id_transform = 
  [
    basic_id_transform|`Idents of (Ast.ident list  -> Ast.ident) |`Ident
                                                                    of
                                                                    (Ast.ident
                                                                    ->
                                                                    Ast.ident)
                                                                    |
    `Last of (string -> Ast.ident) |`Obj of (string -> string)  ] 
type named_type =  (string*Ast.ctyp) and and_types =  named_type list  
and types =  Mutual of and_types | Single of named_type and
                                                        module_types
                                                        =  types list  
