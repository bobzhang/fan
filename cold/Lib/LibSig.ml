...
type vrn =
                TyVrn | TyVrnEq | TyVrnSup | TyVrnInf | TyVrnInfSup | TyAbstr
...
module type Config =
                                                         sig
                                                          ...
                                                          val left_type_variable :
                                                           basic_id_transform

                                                          val right_type_variable :
                                                           rhs_basic_id_transform
...
module type Grammar =
                                                sig
                                                 ...
                                                 val add_quotation_of_class_str_item :
                                                  (name : string ->
                                                   (entry :
                                                    Ast.class_str_item t ->
                                                    unit))

                                                 val add_quotation_of_match_case :
                                                  (name : string ->
                                                   (entry : Ast.match_case t
                                                    -> unit))
