...
and ctyp =
  ...
  | `TyOr of (loc* ctyp* ctyp) | `Private of (loc* ctyp)
  | `Mutable of (loc* ctyp) | `Tup of (loc* ctyp) | `Sta of (loc* ctyp* ctyp)
...
and patt =
  ...
  | `Sem of (loc* patt* patt) | `Chr of (loc* string) | `Int of (loc* string)
