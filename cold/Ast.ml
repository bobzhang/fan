...
and patt =
  ...
  | `NativeInt of (loc* string) | `PaFlo of (loc* string)
...
and expr =
  ...
  | `ExAss of (loc* expr* expr) | `Chr of (loc* string)
  ...
  | `Int of (loc* string) | `Int32 of (loc* string) | `Int64 of (loc* string)
  | `NativeInt of (loc* string) | `ExLab of (loc* string* expr)
  | `Lazy of (loc* expr) | `ExLet of (loc* rec_flag* binding* expr)
  ...
  | `ExSte of (loc* expr* expr) | `Str of (loc* string)
