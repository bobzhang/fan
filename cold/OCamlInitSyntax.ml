                               ...
                               functor (U : sig end) ->
                                (struct
                                  ...
                                  let default_warning =
                                   fun loc ->
                                    fun txt ->
                                     (Format.eprintf "<W> %a: %s@."
                                       FanLoc.print loc txt)
                                  ...
                                  let print_warning =
                                   fun loc ->
                                    fun txt ->
                                     ((current_warning.contents) loc txt)
                                  ...
                                  let class_declaration =
                                   (Gram.mk "class_declaration")

                                  let class_description =
                                   (Gram.mk "class_description")

                                  let class_expr = (Gram.mk "class_expr")

                                  let class_fun_binding =
                                   (Gram.mk "class_fun_binding")

                                  let class_fun_def =
                                   (Gram.mk "class_fun_def")

                                  let class_info_for_class_expr =
                                   (Gram.mk "class_info_for_class_expr")

                                  let class_info_for_class_type =
                                   (Gram.mk "class_info_for_class_type")

                                  let class_longident =
                                   (Gram.mk "class_longident")

                                  let class_longident_and_param =
                                   (Gram.mk "class_longident_and_param")

                                  let class_name_and_param =
                                   (Gram.mk "class_name_and_param")

                                  let class_sig_item =
                                   (Gram.mk "class_sig_item")

                                  let class_signature =
                                   (Gram.mk "class_signature")

                                  let class_str_item =
                                   (Gram.mk "class_str_item")

                                  let class_structure =
                                   (Gram.mk "class_structure")

                                  let class_type = (Gram.mk "class_type")

                                  let class_type_declaration =
                                   (Gram.mk "class_type_declaration")

                                  let class_type_longident =
                                   (Gram.mk "class_type_longident")

                                  let class_type_longident_and_param =
                                   (Gram.mk "class_type_longident_and_param")

                                  let class_type_plus =
                                   (Gram.mk "class_type_plus")
                                  ...
                                  let comma_type_parameter =
                                   (Gram.mk "comma_type_parameter")

                                  let constrain = (Gram.mk "constrain")

                                  let constructor_arg_list =
                                   (Gram.mk "constructor_arg_list")

                                  let constructor_declaration =
                                   (Gram.mk "constructor_declaration")

                                  let constructor_declarations =
                                   (Gram.mk "constructor_declarations")

                                  let ctyp = (Gram.mk "ctyp")

                                  let cvalue_binding =
                                   (Gram.mk "cvalue_binding")

                                  let direction_flag =
                                   (Gram.mk "direction_flag")

                                  let direction_flag_quot =
                                   (Gram.mk "direction_flag_quot")
                                  ...
                                  let label_declaration =
                                   (Gram.mk "label_declaration")

                                  let label_declaration_list =
                                   (Gram.mk "label_declaration_list")

                                  let label_expr = (Gram.mk "label_expr")

                                  let label_expr_list =
                                   (Gram.mk "label_expr_list")

                                  let label_ipatt = (Gram.mk "label_ipatt")

                                  let label_ipatt_list =
                                   (Gram.mk "label_ipatt_list")

                                  let label_longident =
                                   (Gram.mk "label_longident")

                                  let label_patt = (Gram.mk "label_patt")

                                  let label_patt_list =
                                   (Gram.mk "label_patt_list")

                                  let labeled_ipatt =
                                   (Gram.mk "labeled_ipatt")
                                  ...
                                  let module_binding =
                                   (Gram.mk "module_binding")

                                  let module_binding0 =
                                   (Gram.mk "module_binding0")

                                  let module_declaration =
                                   (Gram.mk "module_declaration")

                                  let module_expr = (Gram.mk "module_expr")

                                  let module_longident =
                                   (Gram.mk "module_longident")

                                  let module_longident_with_app =
                                   (Gram.mk "module_longident_with_app")

                                  let module_rec_declaration =
                                   (Gram.mk "module_rec_declaration")
                                  ...
                                  let opt_as_lident =
                                   (Gram.mk "opt_as_lident")

                                  let opt_class_self_patt =
                                   (Gram.mk "opt_class_self_patt")

                                  let opt_class_self_type =
                                   (Gram.mk "opt_class_self_type")

                                  let opt_comma_ctyp =
                                   (Gram.mk "opt_comma_ctyp")

                                  let opt_dot_dot = (Gram.mk "opt_dot_dot")

                                  let row_var_flag_quot =
                                   (Gram.mk "row_var_flag_quot")
                                  ...
                                  let opt_meth_list =
                                   (Gram.mk "opt_meth_list")

                                  let opt_mutable = (Gram.mk "opt_mutable")

                                  let mutable_flag_quot =
                                   (Gram.mk "mutable_flag_quot")

                                  let opt_polyt = (Gram.mk "opt_polyt")

                                  let opt_private = (Gram.mk "opt_private")

                                  let private_flag_quot =
                                   (Gram.mk "private_flag_quot")

                                  let opt_rec = (Gram.mk "opt_rec")

                                  let rec_flag_quot =
                                   (Gram.mk "rec_flag_quot")

                                  let opt_virtual = (Gram.mk "opt_virtual")

                                  let virtual_flag_quot =
                                   (Gram.mk "virtual_flag_quot")

                                  let opt_override = (Gram.mk "opt_override")

                                  let override_flag_quot =
                                   (Gram.mk "override_flag_quot")

                                  let opt_when_expr =
                                   (Gram.mk "opt_when_expr")

                                  let patt = (Gram.mk "patt")

                                  let patt_as_patt_opt =
                                   (Gram.mk "patt_as_patt_opt")
                                  ...
                                  let sem_expr_for_list =
                                   (Gram.mk "sem_expr_for_list")

                                  let sem_patt = (Gram.mk "sem_patt")

                                  let sem_patt_for_list =
                                   (Gram.mk "sem_patt_for_list")
                                  ...
                                  let type_constraint =
                                   (Gram.mk "type_constraint")

                                  let type_declaration =
                                   (Gram.mk "type_declaration")

                                  let type_ident_and_parameters =
                                   (Gram.mk "type_ident_and_parameters")

                                  let type_kind = (Gram.mk "type_kind")

                                  let type_longident =
                                   (Gram.mk "type_longident")

                                  let type_longident_and_parameters =
                                   (Gram.mk "type_longident_and_parameters")

                                  let type_parameter =
                                   (Gram.mk "type_parameter")

                                  let type_parameters =
                                   (Gram.mk "type_parameters")
                                  ...
                                  let val_longident =
                                   (Gram.mk "val_longident")

                                  let with_constr = (Gram.mk "with_constr")

                                  let expr_quot =
                                   (Gram.mk "quotation of expression")

                                  let patt_quot =
                                   (Gram.mk "quotation of pattern")

                                  let ctyp_quot =
                                   (Gram.mk "quotation of type")

                                  let str_item_quot =
                                   (Gram.mk "quotation of structure item")

                                  let sig_item_quot =
                                   (Gram.mk "quotation of signature item")
                                  ...
                                  let module_expr_quot =
                                   (Gram.mk "quotation of module expression")

                                  let module_type_quot =
                                   (Gram.mk "quotation of module type")

                                  let class_type_quot =
                                   (Gram.mk "quotation of class type")

                                  let class_expr_quot =
                                   (Gram.mk "quotation of class expression")

                                  let with_constr_quot =
                                   (Gram.mk "quotation of with constraint")

                                  let binding_quot =
                                   (Gram.mk "quotation of binding")

                                  let rec_binding_quot =
                                   (Gram.mk "quotation of record binding")
                                  ...
                                  let ident_quot =
                                   (Gram.mk "quotation of identifier")
                                  ...
                                  module AntiquotSyntax =
                                   struct
                                    ...
                                    let antiquot_expr =
                                     (Gram.mk "antiquot_expr")

                                    let antiquot_patt =
                                     (Gram.mk "antiquot_patt")

                                    let _ = (
                                    (Gram.extend (
                                      (antiquot_expr : 'antiquot_expr Gram.t)
                                      ) (
                                      ((fun ()
                                          ->
                                         (None , (
                                    ...
                                    (Gram.extend (
                                      (antiquot_patt : 'antiquot_patt Gram.t)
                                      ) (
                                      ((fun ()
                                          ->
                                         (None , (
                                    ...
                                    let parse_expr =
                                     fun loc ->
                                      fun str ->
                                       (Gram.parse_string antiquot_expr loc
                                         str)

                                    let parse_patt =
                                     fun loc ->
                                      fun str ->
                                       (Gram.parse_string antiquot_patt loc
                                         str)

                                   end

                                  module Quotation =
                                   (Quotation.Make)(struct end)
                                  ...
                                  let parse_implem =
                                   fun ?(directive_handler = fun _ -> (None)) ->
                                    fun _loc ->
                                     fun cs ->
                                      let l =
                                       (wrap directive_handler (
                                         (Gram.parse implem) ) _loc cs) in
                                      (Ast.stSem_of_list l)
