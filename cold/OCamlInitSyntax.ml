module Make (U:sig  end) : Sig.Camlp4Syntax =
  struct module Ast  = Camlp4Ast
    ...
    let  a_STRING = (Gram.mk "a_STRING") let  a_UIDENT = (Gram.mk "a_UIDENT")
    let  a_ident = (Gram.mk "a_ident") let  amp_ctyp = (Gram.mk "amp_ctyp")
    ...
    let  fun_def = (Gram.mk "fun_def") let  ident = (Gram.mk "ident")
    let  implem = (Gram.mk "implem") let  interf = (Gram.mk "interf")
    let  ipatt = (Gram.mk "ipatt") let  ipatt_tcon = (Gram.mk "ipatt_tcon")
    ...
    let  patt_tcon = (Gram.mk "patt_tcon") let  phrase = (Gram.mk "phrase")
    ...
    module AntiquotSyntax  =
      struct module Ast  = Ast module Gram  = Gram
        ...
        let  parse_expr (loc) (str) =
          (Gram.parse_string antiquot_expr loc str)
        let  parse_patt (loc) (str) =
          (Gram.parse_string antiquot_patt loc str) end
    ...
    module AstFilters  = (AstFilters.Make) (struct  end) end 