module Make(U:sig  end) : Sig.Camlp4Syntax = struct
  ...
  let do_sequence = Gram.mk "do_sequence" let sig_item = Gram.mk "sig_item"
  let sig_items = Gram.mk "sig_items" let star_ctyp = Gram.mk "star_ctyp"
  let str_item = Gram.mk "str_item" let str_items = Gram.mk "str_items"
