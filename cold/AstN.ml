...
type ctyp =
  ...
  | `TyCol of (ctyp* ctyp) | `Com of (ctyp* ctyp) | `Sum of ctyp
...
and name_ctyp =
  [ `Sem of (name_ctyp* name_ctyp) | `TyCol of (ctyp* ctyp) | ant_nil] 
and or_ctyp =
  [ `Or of (or_ctyp* or_ctyp) | `TyCol of (ctyp* ctyp) | `Of of (ctyp* ctyp)
  | sid | ant_nil] 
