...
let entry_name: ([ `name of FToken.name | `non] * FGramDef.name) Gram.t =
  Gram.mk "entry_name"
...
let entry: FGramDef.entry Gram.t = Gram.mk "entry"
        ...
        (None, None,
          [([Gram.srules
               ...
               ([`Snterm (Gram.obj (qualuid : 'qualuid Gram.t ))],
                 ("Gram.mk_action (fun (t : 'qualuid)  (_loc : FLoc.t)  -> (`static t : 'e__1 ))\n",
                   (Gram.mk_action
            ...
            `Slist1
              (Gram.srules
                 [([`Snterm (Gram.obj (a_lident : 'a_lident Gram.t ))],
                    ("Gram.mk_action (fun (x : 'a_lident)  (_loc : FLoc.t)  -> (x : 'e__4 ))\n",
                      (Gram.mk_action
  ...
  begin
            ...
            ("Gram.mk_action\n  (fun (t : 'qualuid)  (_loc : FLoc.t)  ->\n     (let old = gm () in let () = grammar_module_name := t in (None, old) : \n     'extend_header ))\n",
              (Gram.mk_action
                 (fun (t : 'qualuid)  (_loc : FLoc.t)  ->
                    ...
                    'extend_header )))));
          ([],
            ("Gram.mk_action (fun (_loc : FLoc.t)  -> ((None, (gm ())) : 'extend_header ))\n",
              (Gram.mk_action
              ...
              ((Gram.srules
                  [([`Slist0sep
                       ((`Snterm (Gram.obj (psymbol : 'psymbol Gram.t ))),
                         (`Skeyword ";"))],
                     ("Gram.mk_action (fun (sl : 'psymbol list)  (_loc : FLoc.t)  -> (sl : 'e__5 ))\n",
                       (Gram.mk_action
    ...
    Gram.extend_single (rule_list : 'rule_list Gram.t )
      (None,
        (None, None,
          [([`Skeyword "["; `Skeyword "]"],
             ("Gram.mk_action (fun _  _  (_loc : FLoc.t)  -> ([] : 'rule_list ))\n",
               (Gram.mk_action
            ...
            `Sopt
              (Gram.srules
                 [([`Skeyword "->"; `Snterm (Gram.obj (exp : 'exp Gram.t ))],
                    ("Gram.mk_action (fun (act : 'exp)  _  (_loc : FLoc.t)  -> (act : 'e__8 ))\n",
                      (Gram.mk_action
            ...
            `Sopt
              (Gram.srules
                 [([`Skeyword "{";
                   ...
                   `Skeyword "}"],
                    ("Gram.mk_action (fun _  (p : 'pattern)  _  (_loc : FLoc.t)  -> (p : 'e__9 ))\n",
                      (Gram.mk_action
      ...
      (None,
        (None, None,
          ...
          ([`Skeyword "("; `Sself; `Skeyword ")"],
            ("Gram.mk_action (fun _  (s : 'symbol)  _  (_loc : FLoc.t)  -> (s : 'symbol ))\n",
              (Gram.mk_action
             ...
             ("Gram.mk_action\n  (fun (__fan_0 : [> FToken.t])  (_loc : FLoc.t)  ->\n     match __fan_0 with\n     | `STR (_,s) -> (`Str (_loc, s) : 'internal_pat )\n     | _ -> failwith \"`Str (_loc, s)\n\")\n",
               (Gram.mk_action
                  (fun (__fan_0 : [> FToken.t])  (_loc : FLoc.t)  ->
                     ...
                     | _ -> failwith "`Str (_loc, s)\n"))));
          ([`Skeyword "_"],
            ("Gram.mk_action (fun _  (_loc : FLoc.t)  -> (`Any _loc : 'internal_pat ))\n",
              (Gram.mk_action
             ...
             ("Gram.mk_action\n  (fun (__fan_0 : [> FToken.t])  (_loc : FLoc.t)  ->\n     match __fan_0 with\n     | `Lid i -> (`Lid (_loc, i) : 'pattern )\n     | _ -> failwith \"`Lid (_loc, i)\n\")\n",
               (Gram.mk_action
                  (fun (__fan_0 : [> FToken.t])  (_loc : FLoc.t)  ->
                     ...
                     | _ -> failwith "`Lid (_loc, i)\n"))));
          ([`Skeyword "_"],
            ("Gram.mk_action (fun _  (_loc : FLoc.t)  -> (`Any _loc : 'pattern ))\n",
              (Gram.mk_action
      ...
      (None,
        (None, None,
          ...
          ([`Skeyword "(";
           ...
           `Skeyword ")"],
            ("Gram.mk_action (fun _  (e : 'exp)  _  (_loc : FLoc.t)  -> (e : 'simple_exp ))\n",
              (Gram.mk_action
