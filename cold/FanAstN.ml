  ...
  object (self : 'self_type)
    ...
    method ident : ident -> ident -> 'result18=
      fun _a0  _b0  ->
        ...
        | (_,_) -> false
    method ctyp : ctyp -> ctyp -> 'result19=
      fun _a0  _b0  ->
        match (_a0, _b0) with
        | (`Nil,`Nil) -> true
        ...
        | (_,_) -> false
    method patt : patt -> patt -> 'result20=
      fun _a0  _b0  ->
        match (_a0, _b0) with
        | (`Nil,`Nil) -> true
        | (`Id _a0,`Id _b0) -> self#ident _a0 _b0
        ...
        | (`PaRng (_a0,_a1),`PaRng (_b0,_b1)) ->
            (self#patt _a0 _b0) && (self#patt _a1 _b1)
        | (`PaRec _a0,`PaRec _b0) -> self#patt _a0 _b0
        ...
        | (_,_) -> false
    method expr : expr -> expr -> 'result21=
      fun _a0  _b0  ->
        match (_a0, _b0) with
        | (`Nil,`Nil) -> true
        | (`Id _a0,`Id _b0) -> self#ident _a0 _b0
        ...
        | (_,_) -> false
    method module_type : module_type -> module_type -> 'result22=
      fun _a0  _b0  ->
        match (_a0, _b0) with
        | (`Nil,`Nil) -> true
        | (`Id _a0,`Id _b0) -> self#ident _a0 _b0
        ...
        | (_,_) -> false
    method sig_item : sig_item -> sig_item -> 'result23=
      fun _a0  _b0  ->
        match (_a0, _b0) with
        | (`Nil,`Nil) -> true
        ...
        | (_,_) -> false
    method with_constr : with_constr -> with_constr -> 'result24=
      fun _a0  _b0  ->
        match (_a0, _b0) with
        | (`Nil,`Nil) -> true
        ...
        | (_,_) -> false
    method binding : binding -> binding -> 'result25=
      fun _a0  _b0  ->
        match (_a0, _b0) with
        | (`Nil,`Nil) -> true
        | (`And (_a0,_a1),`And (_b0,_b1)) ->
        ...
        | (_,_) -> false
    method rec_binding : rec_binding -> rec_binding -> 'result26=
      fun _a0  _b0  ->
        match (_a0, _b0) with
        | (`Nil,`Nil) -> true
        | (`Sem (_a0,_a1),`Sem (_b0,_b1)) ->
        ...
        | (_,_) -> false
    method module_binding : module_binding -> module_binding -> 'result27=
      fun _a0  _b0  ->
        match (_a0, _b0) with
        | (`Nil,`Nil) -> true
        | (`And (_a0,_a1),`And (_b0,_b1)) ->
        ...
        | (_,_) -> false
    method match_case : match_case -> match_case -> 'result28=
      fun _a0  _b0  ->
        match (_a0, _b0) with
        | (`Nil,`Nil) -> true
        | (`Or (_a0,_a1),`Or (_b0,_b1)) ->
        ...
        | (_,_) -> false
    method module_expr : module_expr -> module_expr -> 'result29=
      fun _a0  _b0  ->
        match (_a0, _b0) with
        | (`Nil,`Nil) -> true
        | (`Id _a0,`Id _b0) -> self#ident _a0 _b0
        ...
        | (_,_) -> false
    method str_item : str_item -> str_item -> 'result30=
      fun _a0  _b0  ->
        match (_a0, _b0) with
        | (`Nil,`Nil) -> true
        ...
        | (_,_) -> false
    method class_type : class_type -> class_type -> 'result31=
      fun _a0  _b0  ->
        match (_a0, _b0) with
        | (`Nil,`Nil) -> true
        ...
        | (_,_) -> false
    method class_sig_item : class_sig_item -> class_sig_item -> 'result32=
      fun _a0  _b0  ->
        match (_a0, _b0) with
        | (`Nil,`Nil) -> true
        ...
        | (_,_) -> false
    method class_expr : class_expr -> class_expr -> 'result33=
      fun _a0  _b0  ->
        match (_a0, _b0) with
        | (`Nil,`Nil) -> true
        ...
        | (_,_) -> false
    method class_str_item : class_str_item -> class_str_item -> 'result34=
      fun _a0  _b0  ->
        match (_a0, _b0) with
        | (`Nil,`Nil) -> true
        | (`Sem (_a0,_a1),`Sem (_b0,_b1)) ->
        ...
        | (_,_) -> false
    method fanloc_t : FanLoc.t -> FanLoc.t -> 'result35= self#unknown
    method fanutil_anti_cxt :
      FanUtil.anti_cxt -> FanUtil.anti_cxt -> 'result36= self#unknown
  end
class print =
  object (self : 'self_type)
    inherit  printbase
    method loc : 'fmt -> loc -> 'result37=
      fun fmt  _a0  -> self#fanloc_t fmt _a0
    method ant : 'fmt -> ant -> 'result38=
      fun fmt  (`Ant (_a0,_a1))  ->
        Format.fprintf fmt "@[<1>(`Ant@ %a@ %a)@]" self#loc _a0
          self#fanutil_anti_cxt _a1
    method literal : 'fmt -> literal -> 'result39=
      fun fmt  ->
        function
    ...
    method meta_bool : 'fmt -> meta_bool -> 'result48=
      fun fmt  ->
        function
    ...
    method meta_option :
      'all_a0 .
        ('self_type -> 'fmt -> 'all_a0 -> 'result49) ->
          'fmt -> 'all_a0 meta_option -> 'result49=
      fun mf_a  fmt  ->
        function
    ...
    method meta_list :
      'all_a0 .
        ('self_type -> 'fmt -> 'all_a0 -> 'result50) ->
          'fmt -> 'all_a0 meta_list -> 'result50=
      fun mf_a  fmt  ->
        function
    ...
    method alident : 'fmt -> alident -> 'result51=
      fun fmt  ->
        function
        | `Lid _a0 -> Format.fprintf fmt "@[<1>(`Lid@ %a)@]" self#string _a0
        | #ant as _a0 -> (self#ant fmt _a0 :>'result51)
    method auident : 'fmt -> auident -> 'result52=
      fun fmt  ->
        function
        | `Uid _a0 -> Format.fprintf fmt "@[<1>(`Uid@ %a)@]" self#string _a0
        | #ant as _a0 -> (self#ant fmt _a0 :>'result52)
    method aident : 'fmt -> aident -> 'result53=
      fun fmt  ->
        function
        | #alident as _a0 -> (self#alident fmt _a0 :>'result53)
        | #auident as _a0 -> (self#auident fmt _a0 :>'result53)
    method astring : 'fmt -> astring -> 'result54=
      fun fmt  ->
        function
        | `C _a0 -> Format.fprintf fmt "@[<1>(`C@ %a)@]" self#string _a0
        | #ant as _a0 -> (self#ant fmt _a0 :>'result54)
    method ident : 'fmt -> ident -> 'result55=
      fun fmt  ->
        function
        | `Dot (_a0,_a1) ->
      ...
      fun fmt  ->
        ...
        | `Sem (_a0,_a1) ->
            Format.fprintf fmt "@[<1>(`Sem@ %a@ %a)@]" self#patt _a0
              self#patt _a1
        | #literal as _a0 -> (self#literal fmt _a0 :>'result57)
        | `Label (_a0,_a1) ->
            Format.fprintf fmt "@[<1>(`Label@ %a@ %a)@]" self#alident _a0
              self#patt _a1
        | `PaOlbi (_a0,_a1,_a2) ->
        ...
        | `PaRng (_a0,_a1) ->
            Format.fprintf fmt "@[<1>(`PaRng@ %a@ %a)@]" self#patt _a0
              self#patt _a1
        | `PaRec _a0 ->
            Format.fprintf fmt "@[<1>(`PaRec@ %a)@]" self#patt _a0
        | `PaEq (_a0,_a1) ->
      ...
      fun fmt  ->
        ...
        | `Package_expr _a0 ->
            Format.fprintf fmt "@[<1>(`Package_expr@ %a)@]" self#module_expr
              _a0
    method module_type : 'fmt -> module_type -> 'result59=
      fun fmt  ->
        function
        | `Nil -> Format.fprintf fmt "`Nil"
        | `Id _a0 -> Format.fprintf fmt "@[<1>(`Id@ %a)@]" self#ident _a0
    ...
    method sig_item : 'fmt -> sig_item -> 'result60=
      fun fmt  ->
        function
        | `Nil -> Format.fprintf fmt "`Nil"
        | `Class _a0 ->
    ...
    method with_constr : 'fmt -> with_constr -> 'result61=
      fun fmt  ->
        function
        | `Nil -> Format.fprintf fmt "`Nil"
        | `TypeEq (_a0,_a1) ->
    ...
    method binding : 'fmt -> binding -> 'result62=
      fun fmt  ->
        function
        | `Nil -> Format.fprintf fmt "`Nil"
        | `And (_a0,_a1) ->
    ...
    method rec_binding : 'fmt -> rec_binding -> 'result63=
      fun fmt  ->
        function
        | `Nil -> Format.fprintf fmt "`Nil"
        | `Sem (_a0,_a1) ->
    ...
    method module_binding : 'fmt -> module_binding -> 'result64=
      fun fmt  ->
        function
        | `Nil -> Format.fprintf fmt "`Nil"
        | `And (_a0,_a1) ->
    ...
    method match_case : 'fmt -> match_case -> 'result65=
      fun fmt  ->
        function
        | `Nil -> Format.fprintf fmt "`Nil"
        | `Or (_a0,_a1) ->
    ...
    method module_expr : 'fmt -> module_expr -> 'result66=
      fun fmt  ->
        function
        | `Nil -> Format.fprintf fmt "`Nil"
        | `Id _a0 -> Format.fprintf fmt "@[<1>(`Id@ %a)@]" self#ident _a0
    ...
    method str_item : 'fmt -> str_item -> 'result67=
      fun fmt  ->
        function
        | `Nil -> Format.fprintf fmt "`Nil"
        | `Class _a0 ->
    ...
    method class_type : 'fmt -> class_type -> 'result68=
      fun fmt  ->
        function
        | `Nil -> Format.fprintf fmt "`Nil"
        | `CtCon (_a0,_a1,_a2) ->
    ...
    method class_sig_item : 'fmt -> class_sig_item -> 'result69=
      fun fmt  ->
        function
        | `Nil -> Format.fprintf fmt "`Nil"
        | `Eq (_a0,_a1) ->
    ...
    method class_expr : 'fmt -> class_expr -> 'result70=
      fun fmt  ->
        function
        | `Nil -> Format.fprintf fmt "`Nil"
        | `CeApp (_a0,_a1) ->
    ...
    method class_str_item : 'fmt -> class_str_item -> 'result71=
      fun fmt  ->
        function
        | `Nil -> Format.fprintf fmt "`Nil"
        | `Sem (_a0,_a1) ->
    ...
    method fanloc_t : 'fmt -> FanLoc.t -> 'result72= self#unknown
    method fanutil_anti_cxt : 'fmt -> FanUtil.anti_cxt -> 'result73=
      self#unknown
  end
module Expr =
  struct
    ...
    let meta_aident _loc =
      function
      | #alident as _a0 -> (meta_alident _loc _a0 :>'result89)
      | #auident as _a0 -> (meta_auident _loc _a0 :>'result89)
      ...
      | `App (_a0,_a1) ->
          `App
            (_loc,
              ...
              (meta_ident _loc _a1))
      | #alident as _a0 -> (meta_alident _loc _a0 :>'result91)
      | #auident as _a0 -> (meta_auident _loc _a0 :>'result91)
      ...
      | `Sem (_a0,_a1) ->
          `App
            (_loc, (`App (_loc, (`Vrn (_loc, "Sem")), (meta_patt _loc _a0))),
              (meta_patt _loc _a1))
      | #literal as _a0 -> (meta_literal _loc _a0 :>'result106)
      | `Label (_a0,_a1) ->
          `App
            (_loc,
              (`App (_loc, (`Vrn (_loc, "Label")), (meta_alident _loc _a0))),
      ...
      | `PaRng (_a0,_a1) ->
          `App
            (_loc,
              ...
              (meta_patt _loc _a1))
      | `PaRec _a0 ->
          `App (_loc, (`Vrn (_loc, "PaRec")), (meta_patt _loc _a0))
      | `PaEq (_a0,_a1) ->
          `App
            (_loc,
      ...
      | `IfThen (_a0,_a1) ->
          `App
            (_loc,
              ...
              (meta_expr _loc _a1))
      | #literal as _a0 -> (meta_literal _loc _a0 :>'result105)
      | `Label (_a0,_a1) ->
          `App
            (_loc,
              (`App (_loc, (`Vrn (_loc, "Label")), (meta_alident _loc _a0))),
      ...
      | `CtEq (_a0,_a1) ->
          `App
            (_loc,
              ...
              (meta_class_type _loc _a1))
      | #ant as _a0 -> (meta_ant _loc _a0 :>'result95)
    ...
    and meta_patt _loc =
      ...
      | `Sem (_a0,_a1) ->
          `App
            (_loc, (`App (_loc, (`Vrn (_loc, "Sem")), (meta_patt _loc _a0))),
              (meta_patt _loc _a1))
      | #literal as _a0 -> (meta_literal _loc _a0 :>'result140)
      | `Label (_a0,_a1) ->
          `App
            (_loc,
              (`App (_loc, (`Vrn (_loc, "Label")), (meta_alident _loc _a0))),
