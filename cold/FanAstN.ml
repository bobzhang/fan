  ...
  object (self : 'self_type)
    ...
    method opt_type_constr : opt_type_constr -> opt_type_constr -> 'result29=
      fun _a0  _b0  ->
        ...
        | (`Nil,`Nil) -> true
        | (_,_) -> false
    method opt_type_params : opt_type_params -> opt_type_params -> 'result30=
      fun _a0  _b0  -> match (_a0, _b0) with | (`Nil,`Nil) -> true
    ...
    method module_binding : module_binding -> module_binding -> 'result44=
      fun _a0  _b0  ->
        ...
        | (_,_) -> false
    method case : case -> case -> 'result45=
      fun _a0  _b0  ->
        match (_a0, _b0) with
        | (`Or (_a0,_a1),`Or (_b0,_b1)) ->
...
class print =
  object (self : 'self_type)
    ...
    method opt_type_params : 'fmt -> opt_type_params -> 'result86=
      fun fmt  `Nil  -> Format.fprintf fmt "`Nil"
    ...
    method case : 'fmt -> case -> 'result101=
      fun fmt  ->
        function
        | `Or (_a0,_a1) ->
...
and meta_opt_type_constr _loc =
  ...
  | `Nil -> `Vrn (_loc, "Nil")
and meta_opt_type_params _loc `Nil = `Vrn (_loc, "Nil")
