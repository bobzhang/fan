  ...
  object (self : 'self_type)
    ...
    method patt : patt -> patt -> 'result21=
      fun _a0  _b0  ->
        ...
        | (_,_) -> false
    method expr : expr -> expr -> 'result22=
      fun _a0  _b0  ->
        match (_a0, _b0) with
        | (`Nil,`Nil) -> true
        | (`Id _a0,`Id _b0) -> self#ident _a0 _b0
        ...
        | (_,_) -> false
    method module_type : module_type -> module_type -> 'result23=
      fun _a0  _b0  ->
        match (_a0, _b0) with
        | (`Nil,`Nil) -> true
        | (`Id _a0,`Id _b0) -> self#ident _a0 _b0
        ...
        | (_,_) -> false
    method sig_item : sig_item -> sig_item -> 'result24=
      fun _a0  _b0  ->
        match (_a0, _b0) with
        | (`Nil,`Nil) -> true
        ...
        | (_,_) -> false
    method with_constr : with_constr -> with_constr -> 'result25=
      fun _a0  _b0  ->
        match (_a0, _b0) with
        | (`Nil,`Nil) -> true
        ...
        | (_,_) -> false
    method binding : binding -> binding -> 'result26=
      fun _a0  _b0  ->
        match (_a0, _b0) with
        | (`Nil,`Nil) -> true
        | (`And (_a0,_a1),`And (_b0,_b1)) ->
        ...
        | (_,_) -> false
    method rec_binding : rec_binding -> rec_binding -> 'result27=
      fun _a0  _b0  ->
        match (_a0, _b0) with
        | (`Nil,`Nil) -> true
        | (`Sem (_a0,_a1),`Sem (_b0,_b1)) ->
        ...
        | (_,_) -> false
    method module_binding : module_binding -> module_binding -> 'result28=
      fun _a0  _b0  ->
        match (_a0, _b0) with
        | (`Nil,`Nil) -> true
        | (`And (_a0,_a1),`And (_b0,_b1)) ->
        ...
        | (_,_) -> false
    method match_case : match_case -> match_case -> 'result29=
      fun _a0  _b0  ->
        match (_a0, _b0) with
        | (`Nil,`Nil) -> true
        | (`Or (_a0,_a1),`Or (_b0,_b1)) ->
        ...
        | (_,_) -> false
    method module_expr : module_expr -> module_expr -> 'result30=
      fun _a0  _b0  ->
        match (_a0, _b0) with
        | (`Nil,`Nil) -> true
        | (`Id _a0,`Id _b0) -> self#ident _a0 _b0
        ...
        | (_,_) -> false
    method str_item : str_item -> str_item -> 'result31=
      fun _a0  _b0  ->
        match (_a0, _b0) with
        | (`Nil,`Nil) -> true
        ...
        | (_,_) -> false
    method class_type : class_type -> class_type -> 'result32=
      fun _a0  _b0  ->
        match (_a0, _b0) with
        | (`Nil,`Nil) -> true
        ...
        | (_,_) -> false
    method class_sig_item : class_sig_item -> class_sig_item -> 'result33=
      fun _a0  _b0  ->
        match (_a0, _b0) with
        | (`Nil,`Nil) -> true
        ...
        | (_,_) -> false
    method class_expr : class_expr -> class_expr -> 'result34=
      fun _a0  _b0  ->
        match (_a0, _b0) with
        | (`Nil,`Nil) -> true
        ...
        | (_,_) -> false
    method class_str_item : class_str_item -> class_str_item -> 'result35=
      fun _a0  _b0  ->
        match (_a0, _b0) with
        | (`Nil,`Nil) -> true
        | (`Sem (_a0,_a1),`Sem (_b0,_b1)) ->
        ...
        | (_,_) -> false
    method fanloc_t : FanLoc.t -> FanLoc.t -> 'result36= self#unknown
    method fanutil_anti_cxt :
      FanUtil.anti_cxt -> FanUtil.anti_cxt -> 'result37= self#unknown
  end
class print =
  object (self : 'self_type)
    inherit  printbase
    method loc : 'fmt -> loc -> 'result38=
      fun fmt  _a0  -> self#fanloc_t fmt _a0
    method ant : 'fmt -> ant -> 'result39=
      fun fmt  (`Ant (_a0,_a1))  ->
        Format.fprintf fmt "@[<1>(`Ant@ %a@ %a)@]" self#loc _a0
          self#fanutil_anti_cxt _a1
    method literal : 'fmt -> literal -> 'result40=
      fun fmt  ->
        function
    ...
    method meta_bool : 'fmt -> meta_bool -> 'result49=
      fun fmt  ->
        function
    ...
    method meta_option :
      'all_a0 .
        ('self_type -> 'fmt -> 'all_a0 -> 'result50) ->
          'fmt -> 'all_a0 meta_option -> 'result50=
      fun mf_a  fmt  ->
        function
    ...
    method alident : 'fmt -> alident -> 'result52=
      fun fmt  ->
        function
        | `Lid _a0 -> Format.fprintf fmt "@[<1>(`Lid@ %a)@]" self#string _a0
        | #ant as _a0 -> (self#ant fmt _a0 :>'result52)
    method auident : 'fmt -> auident -> 'result53=
      fun fmt  ->
        function
        | `Uid _a0 -> Format.fprintf fmt "@[<1>(`Uid@ %a)@]" self#string _a0
        | #ant as _a0 -> (self#ant fmt _a0 :>'result53)
    method aident : 'fmt -> aident -> 'result54=
      fun fmt  ->
        function
        | #alident as _a0 -> (self#alident fmt _a0 :>'result54)
        | #auident as _a0 -> (self#auident fmt _a0 :>'result54)
    method astring : 'fmt -> astring -> 'result55=
      fun fmt  ->
        function
        | `C _a0 -> Format.fprintf fmt "@[<1>(`C@ %a)@]" self#string _a0
        | #ant as _a0 -> (self#ant fmt _a0 :>'result55)
    method ident : 'fmt -> ident -> 'result56=
      fun fmt  ->
        function
        | `Dot (_a0,_a1) ->
        ...
        | `App (_a0,_a1) ->
            Format.fprintf fmt "@[<1>(`App@ %a@ %a)@]" self#ident _a0
              self#ident _a1
        | #alident as _a0 -> (self#alident fmt _a0 :>'result56)
        | #auident as _a0 -> (self#auident fmt _a0 :>'result56)
    method ep : 'fmt -> ep -> 'result57=
      fun fmt  ->
        function
    ...
    method patt : 'fmt -> patt -> 'result59=
      fun fmt  ->
        ...
        | #literal as _a0 -> (self#literal fmt _a0 :>'result59)
        | `Alias (_a0,_a1) ->
      ...
      fun fmt  ->
        ...
        | `Package_expr _a0 ->
            Format.fprintf fmt "@[<1>(`Package_expr@ %a)@]" self#module_expr
              _a0
    method module_type : 'fmt -> module_type -> 'result61=
      fun fmt  ->
        function
        | `Nil -> Format.fprintf fmt "`Nil"
        | `Id _a0 -> Format.fprintf fmt "@[<1>(`Id@ %a)@]" self#ident _a0
    ...
    method sig_item : 'fmt -> sig_item -> 'result62=
      fun fmt  ->
        function
        | `Nil -> Format.fprintf fmt "`Nil"
        | `Class _a0 ->
    ...
    method with_constr : 'fmt -> with_constr -> 'result63=
      fun fmt  ->
        function
        | `Nil -> Format.fprintf fmt "`Nil"
        | `TypeEq (_a0,_a1) ->
    ...
    method binding : 'fmt -> binding -> 'result64=
      fun fmt  ->
        function
        | `Nil -> Format.fprintf fmt "`Nil"
        | `And (_a0,_a1) ->
    ...
    method rec_binding : 'fmt -> rec_binding -> 'result65=
      fun fmt  ->
        function
        | `Nil -> Format.fprintf fmt "`Nil"
        | `Sem (_a0,_a1) ->
    ...
    method module_binding : 'fmt -> module_binding -> 'result66=
      fun fmt  ->
        function
        | `Nil -> Format.fprintf fmt "`Nil"
        | `And (_a0,_a1) ->
    ...
    method match_case : 'fmt -> match_case -> 'result67=
      fun fmt  ->
        function
        | `Nil -> Format.fprintf fmt "`Nil"
        | `Or (_a0,_a1) ->
    ...
    method module_expr : 'fmt -> module_expr -> 'result68=
      fun fmt  ->
        function
        | `Nil -> Format.fprintf fmt "`Nil"
        | `Id _a0 -> Format.fprintf fmt "@[<1>(`Id@ %a)@]" self#ident _a0
    ...
    method str_item : 'fmt -> str_item -> 'result69=
      fun fmt  ->
        function
        | `Nil -> Format.fprintf fmt "`Nil"
        | `Class _a0 ->
    ...
    method class_type : 'fmt -> class_type -> 'result70=
      fun fmt  ->
        function
        | `Nil -> Format.fprintf fmt "`Nil"
        | `CtCon (_a0,_a1,_a2) ->
    ...
    method class_sig_item : 'fmt -> class_sig_item -> 'result71=
      fun fmt  ->
        function
        | `Nil -> Format.fprintf fmt "`Nil"
        | `Eq (_a0,_a1) ->
    ...
    method class_expr : 'fmt -> class_expr -> 'result72=
      fun fmt  ->
        function
        | `Nil -> Format.fprintf fmt "`Nil"
        | `CeApp (_a0,_a1) ->
    ...
    method class_str_item : 'fmt -> class_str_item -> 'result73=
      fun fmt  ->
        function
        | `Nil -> Format.fprintf fmt "`Nil"
        | `Sem (_a0,_a1) ->
    ...
    method fanloc_t : 'fmt -> FanLoc.t -> 'result74= self#unknown
    method fanutil_anti_cxt : 'fmt -> FanUtil.anti_cxt -> 'result75=
      self#unknown
  end
module Expr =
  struct
    ...
    let rec meta_ep _loc =
      ...
      | #literal as _a0 -> (meta_literal _loc _a0 :>'result94)
    ...
    and meta_patt _loc =
      ...
      | #literal as _a0 -> (meta_literal _loc _a0 :>'result109)
      | `Alias (_a0,_a1) ->
          `App
            (_loc,
    ...
    and meta_expr _loc =
      ...
      | #literal as _a0 -> (meta_literal _loc _a0 :>'result108)
      | `Dot (_a0,_a1) ->
          `App
...
module Patt =
  struct
    ...
    let rec meta_ep _loc =
      ...
      | #literal as _a0 -> (meta_literal _loc _a0 :>'result129)
    let rec meta_ctyp _loc =
      function
      | `Nil -> `Vrn (_loc, "Nil")
      | `Alias (_a0,_a1) ->
