 ...
 functor (Syn : Sig.Camlp4Syntax) ->
  ...
  module MetaLoc =
   struct
    let meta_loc_patt =
     fun _loc ->
      fun _ -> (Ast.PaId (_loc , ( (Ast.IdLid (_loc , "loc" )) ) ))
   let meta_loc_expr =
    fun _loc -> fun _ -> (Ast.ExId (_loc , ( (Ast.IdLid (_loc , "loc" )) ) ))
                        ...
                        (_loc , (
                         (Ast.ExApp
                           (_loc , (
                            ...
                            (Ast.ExStr
                              (_loc , ( (Ast.safe_string_escaped msg ) ) )) )
                            )) ) , (
                         (Ast.ExApp
                           (_loc , (
                            (Ast.ExId
...
module MakeFoldGenerator =
 functor (Syn : Sig.Camlp4Syntax) ->
  ...
  let exik =
   fun i ->
    fun k -> (Ast.ExId (_loc , ( (Ast.IdLid (_loc , ( (xik i k ) ) )) ) ))
  let pxik =
   fun i ->
    fun k -> (Ast.PaId (_loc , ( (Ast.IdLid (_loc , ( (xik i k ) ) )) ) ))
  let elidk =
   fun y ->
    fun k ->
  ...
  let exsk =
   fun s ->
    fun k -> (Ast.ExId (_loc , ( (Ast.IdLid (_loc , ( (xsk s k ) ) )) ) ))
  let rec apply_expr =
   fun accu ->
    function
    | [] -> accu
               ...
               (_loc , ( (Ast.TyId (_loc , ( (Ast.IdUid (_loc , "::" )) ) ))
                ...
                (Ast.TyAnd
                  (_loc , ( (Ast.TyQuo (_loc , "a" )) ) , (
                   (Ast.TyApp
                     (_loc , (
                      (Ast.TyId (_loc , ( (Ast.IdLid (_loc , "list" )) ) )) )
                      , ( (Ast.TyQuo (_loc , "a" )) ) )) ) )) ) )) ) )) ) ))
       ) , false  );
         ...
         (_loc , (
          (Ast.TyOr
            (_loc , ( (Ast.TyId (_loc , ( (Ast.IdUid (_loc , "None" )) ) )) )
             ...
             (Ast.TyOf
               (_loc , (
                (Ast.TyId (_loc , ( (Ast.IdUid (_loc , "Some" )) ) )) ) , (
                (Ast.TyQuo (_loc , "a" )) ) )) ) )) ) )) ) , false  );
      ("ref" , ( (Ast.IdLid (_loc , "ref" )) ) , (
       [( (Ast.TyQuo (_loc , "a" )) )] ) , (
       (Ast.TyRec
         (_loc , (
          (Ast.TyCol
  ...
  module Gen =
   functor (X : sig val size : int val mode : mode  end) ->
    ...
    let tuplify_expr =
     fun f ->
      if (size <= 0) then ( assert false )
       ...
       (Ast.ExTup
         (_loc , ( (Ast.ExCom (_loc , ( (f 1 ) ) , ( (loop size ) ) )) )
          ))
    let tuplify_patt =
     fun f ->
      if (size <= 0) then ( assert false )
       ...
       (Ast.PaTup
         (_loc , ( (Ast.PaCom (_loc , ( (f 1 ) ) , ( (loop size ) ) )) )
          ))
    let xiks = fun i -> (tuplify_expr ( (exik i ) ) )
    let tuplify_type =
     fun typ ->
      if (size <= 0) then ( assert false )
       ...
       (Ast.TyTup
         (_loc , ( (Ast.TySta (_loc , typ , ( (loop size ) ) )) ) ))
    let tuplify_tycon =
     fun tycon ->
      (tuplify_type (
        (Ast.TyId (_loc , ( (Ast.IdLid (_loc , tycon )) ) )) ) )
    let rec patt_of_expr =
     ...
     | Ast.ExCom (_ , e1 , e2 ) ->
        (Ast.PaCom
          (_loc , ( (patt_of_expr e1 ) ) , ( (patt_of_expr e2 ) ) ))
      ...
      fun e1 ->
       fun e2 ->
        (match mode with
         ...
         | Map ->
            (Ast.ExLet
              (_loc , Ast.ReNil  , ( (Ast.BiEq (_loc , p , e1 )) ) , e2 ))
         | Fold ->
            (Ast.ExLet
              (_loc , Ast.ReNil  , (
               (Ast.BiEq
       ...
       | Fold_map ->
          (Ast.ExTup
            (_loc , (
             (Ast.ExCom
               (_loc , (
                (Ast.ExId (_loc , ( (Ast.IdLid (_loc , "o" )) ) )) ) , e
                )) ) ))
       | Map -> e
      ...
      fun e1 ->
       fun mk_e2 ->
        (match e1 with
         ...
         | _ ->
            let e2 =
             (mk_e2 ( (Ast.ExId (_loc , ( (Ast.IdLid (_loc , "o" )) ) ))
               ) ) in
            (match opt_patt with
      ...
      fun e1 ->
       fun mk_e2 ->
        let mk_e2 =
         (match ox with
          | Some (x) ->
             fun e1 -> (Ast.ExApp (_loc , ( (mk_e2 e1 ) ) , x ))
          | _ -> mk_e2) in
    ...
    let rec expr_of_ty =
     fun x ->
      fun ty ->
          ...
          | Ast.TyApp (_loc , t1 , t2 ) ->
             let e =
              (opt_bind None  ( (self ~arity:( (arity + 1) ) None  t1 ) )
                ...
                fun e1 ->
                 (Ast.ExApp
                   (_loc , e1 , ( (mkfuno ( (self None  t2 ) ) ) ) )) ) ) in
             (opt_app e ox )
          | Ast.TyTup (_ , t ) ->
       ...
       (self x ty )
    and expr_of_ty' = fun e -> fun t -> (expr_of_ty ( (Some (e)) ) t )
    and out_constr_patt =
     fun s -> (Ast.PaId (_loc , ( (Ast.IdUid (_loc , s )) ) ))
    and out_constr_expr =
     fun s -> (Ast.ExId (_loc , ( (Ast.IdUid (_loc , s )) ) ))
    and match_case_of_constructor =
     fun s ->
      fun t ->
    ...
    and match_case_of_sum_type =
     ...
     | _ -> assert false
    and match_case_of_poly_constructor =
     fun s ->
      fun ts ->
       (chain_tuple (
         function
         | [] -> (Ast.PaVrn (_loc , s ))
         | (p :: []) ->
            (Ast.PaApp (_loc , ( (Ast.PaVrn (_loc , s )) ) , p ))
         | ps ->
            (Ast.PaApp
         ...
         | [] -> (Ast.ExVrn (_loc , s ))
         | (e :: []) ->
            (Ast.ExApp (_loc , ( (Ast.ExVrn (_loc , s )) ) , e ))
         | es ->
            (Ast.ExApp
    ...
    and record_patt_of_type =
     fun k ->
      ...
      | _ -> assert false
    and type_list_of_record_type =
     fun t ->
      fun ((acc1 , acc2 ) as acc) ->
       (match t with
        | Ast.TyNil (_) -> acc
        | (Ast.TyCol
            (_ , Ast.TyId (_ , Ast.IdLid (_ , s ) ) , Ast.TyMut (_ , t ) )
    ...
    and fun_of_ctyp =
     fun tyid ->
      ...
      | Ast.TyId (_ , Ast.IdLid (_ , i ) ) when (i = tyid) ->
         default_expr
            ...
            (_loc , (
             (Ast.McOr
               (_loc , ( (match_case_of_poly_sum_type t ) ) ,
                default_match_case )) ) ))
      | _ -> assert false
    and string_of_type_param =
     fun t ->
      (match t with
       | ((Ast.TyQuo (_ , s ) | Ast.TyQuP (_ , s )) | Ast.TyQuM (_ , s )) ->
          s
       | _ -> assert false)
    and method_of_type_decl =
     fun _ ->
      fun ((id1 , _ , params , ctyp , priv ) as type_decl) ->
       fun acc ->
        let rec lambda =
         fun acc ->
          function
        ...
        (Ast.CrSem
          (_loc , (
           ...
           acc ))
    and ctyp_name_of_name_params =
     fun name ->
      fun params -> (apply_ctyp ( (Ast.TyId (_loc , name )) ) params )
    and method_type_of_type_decl =
     fun (_ , name , params , ctyp , _ ) ->
           ...
           (match mode with
            | Fold_map ->
               (Ast.TyTup
                 (_loc , (
                  (Ast.TySta
                    (_loc , ( (Ast.TyQuo (_loc , "self_type" )) ) , t ))
                  ) ))
          ...
          | _ ->
             ...
             (failwith (
               (Printf.sprintf
                 ...
                 i ) ) ))
    and class_sig_item_of_type_decl =
     fun _ ->
      fun ((name , _ , _ , t , _ ) as type_decl) ->
       fun acc ->
        let (_ :
          < ..  >) =
         (((object (self)
    ...
    fun acc ->
     (match t with
      ...
      | Ast.TyDcl (_ , name , tl , tk , _ ) ->
         (SMap.add name
           (name , ( (Ast.IdLid (_loc , name )) ) , tl , tk , false  )
           acc )
      | _ -> assert false)
  let generate_class_implem =
   fun mode ->
    fun c ->
     fun tydcl ->
      fun n ->
       ...
       let failure =
        if (n > 1) then
         ...
         (Ast.CrMth
           (_loc , ( (sf "%s%d_failure" name n ) ) , Ast.OvNil  ,
            Ast.PrNil  , (
            (Ast.ExFun
              (_loc , (
               (Ast.McArr
                 (_loc , ( (M.tuplify_patt ( (pxik 0 ) ) ) ) , (
                  ...
                  (Ast.ExApp
                    (_loc , (
                     (Ast.ExId
                       (_loc , ( (Ast.IdLid (_loc , "failwith" )) ) )) )
                     , (
                     (Ast.ExStr
                       (_loc , (
                        (Ast.safe_string_escaped (
                          (sf "%s%d_failure: default implementation" name
                            n ) ) ) ) )) ) )) ) )) ) )) ) , gen_type ))
         )
       ...
       let unknown =
        (Ast.CrMth
          (_loc , "unknown" , Ast.OvNil  , Ast.PrNil  , M.default_expr ,
           gen_type )) in
       (Ast.StCls
         (_loc , (
          (Ast.CeEq
      ...
      fun n ->
       ...
       let failure =
        if (n > 1) then
         ...
         let name = (string_of_mode mode ) in
         (Ast.CgMth
           (_loc , ( (sf "%s%d_failure" name n ) ) , Ast.PrNil  ,
            gen_type ))
         )
        ...
        (Ast.TyPol
          (_loc , ( (Ast.TyQuo (_loc , "a" )) ) , (
           (M.method_type_of_type ( (Ast.TyQuo (_loc , "a" )) ) (
             (Ast.TyQuo (_loc , "a" )) ) []  []  ) ) )) in
       let unknown =
        (Ast.CgMth (_loc , "unknown" , Ast.PrNil  , gen_type )) in
       (Ast.SgCls
         (_loc , (
          (Ast.CtCol
            (_loc , (
      ...
      | Ast.StCls
         (_loc ,
          Ast.CeEq
           (_ ,
            Ast.CeCon
             (_ , Ast.ViNil , Ast.IdLid (_ , c ) , Ast.TyNil (_) ) ,
            Ast.CeCon
             (_ , Ast.ViNil ,
              Ast.IdAcc
               (_ , Ast.IdUid (_ , "Camlp4Filters" ) ,
                Ast.IdAcc
                 (_ , Ast.IdUid (_ , "GenerateFold" ) ,
                  Ast.IdLid (_ , "generated" ) ) ) , Ast.TyNil (_) ) ) ) ->
          ...
          Ast.CeEq
           (_ ,
            ...
            Ast.CeCon
             (_ , Ast.ViNil ,
              Ast.IdAcc
               (_ , Ast.IdUid (_ , m ) , Ast.IdLid (_ , "generated" ) ) ,
              Ast.TyNil (_) ) ) ) ->
   ...
   fun decorate_fun ->
    ((object
      ...
      method! binding =
       function
       | Ast.BiEq
          (_loc , Ast.PaId (_ , Ast.IdLid (_ , id ) ) ,
           (Ast.ExFun (_ , _ ) as e) ) ->
          (Ast.BiEq
...
module MakeMetaGenerator =
 functor (Syn : Sig.Camlp4Syntax) ->
  ...
  let _loc = FanLoc.ghost
  let x = fun i -> (Ast.IdLid (_loc , ( ("x" ^ ( (string_of_int i ) )) ) ))
  let meta_ = fun s -> (Ast.IdLid (_loc , ( ("meta_" ^ s) ) ))
  let mf_ = fun s -> ("mf_" ^ s)
   ...
   fun ty ->
    fun f ->
     fun init ->
      ...
      (loop init ty )
  let fold_type_decls =
   fun m -> fun f -> fun init -> (SMap.fold f ( m.type_decls ) init )
  let patt_of_data_ctor_decl =
   fun cons ->
    fun tyargs ->
     (fold_args tyargs (
       fun _ ->
    ...
    fun i ->
     (Ast.ExApp
       (_loc , (
        (Ast.ExApp
          (_loc , ( m.id ) , (
           (Ast.ExId (_loc , ( (Ast.IdLid (_loc , "_loc" )) ) )) ) )) ) , i ))
  let m_uid =
   fun m ->
    fun s -> (m_id m ( (meta_ident m ( (Ast.IdUid (_loc , s )) ) ) ) )
  let failure =
   (Ast.ExApp
  ...
  let mk_meta =
   fun m ->
    let m_name_uid =
     fun x -> (Ast.IdAcc (_loc , ( m.name ) , ( (Ast.IdUid (_loc , x )) ) )) in
    (fold_type_decls m (
      fun tyname ->
       fun tydcl ->
        fun binding_acc ->
                ...
                fun cons ->
                 fun tyargs ->
                  fun acc ->
                   ...
                   let e =
                    if (List.mem cons (
                         ["BAnt"; "OAnt"; "LAnt"; "ReAnt"; "DiAnt"; "MuAnt";
                          "PrAnt"; "ViAnt"; "OvAnt"; "RvAnt"] ) ) then
                     (
                     (Ast.ExApp
                       (_loc , (
                        (Ast.ExApp
                       ...
                       (Ast.StVal
                         (_loc , Ast.ReNil  , (
                          (Ast.BiEq
                            (_loc , (
                             (Ast.PaId
                               (_loc , ( (Ast.IdLid (_loc , "meta_float" )) )
                                )) ) , (
                             (Ast.ExFun
                               (_loc , (
                                (Ast.McArr
                            ...
                            (_loc , (
                             ...
                             (Ast.StSem
                               (_loc , (
                                ...
                                (Ast.StVal (_loc , Ast.ReRecursive  , bi )) )
                                )) ) )) ) )) ) )) ) )) ) )) ) )) in
