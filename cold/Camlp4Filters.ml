...
module MakeFoldGenerator =
                                                            functor (Syn : Camlp4.Sig.Camlp4Syntax) ->
                                                             struct
                                                              ...
                                                              let _ = 
                                                              (Syn.AstFilters.register_sig_item_filter
                                                                (
                                                                processor#sig_item
                                                                ))
                ...
                let decorate_this_expr =
                 fun e ->
                  fun id ->
                   ...
                   let () =
                    (Format.bprintf buf "%s @@ %a@?" id FanLoc.dump _loc) in
                        ...
                        (_loc, (
                         ...
                         (Ast.ExApp
                           (_loc, (
                            ...
                            (Ast.ExStr
                              (_loc, ( (Ast.safe_string_escaped s) ))) ))) )))
                      ), e))
                                         ...
                                         struct
                                          ...
                                          let find_type_decls =
                                           object
                                            ...
                                            method ctyp =
                                             function
                                             | (Ast.TyDcl (_, name, _, _, _) as
                                                t) ->
                                                {< accu =
                                                    (SMap.add name t accu) >}
                                             | t -> (super#ctyp t)
                                           end
