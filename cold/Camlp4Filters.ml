  ...
  let builtin_types =
    ...
    let tyMap =
      ...
      List.fold_right
        (fun name ->
           SMap.add name
             (name,(Ast.IdLid (_loc,name)),[],(Ast.TyNil _loc),false)) abstr
        tyMap in
    let tyMap =
      let concr =
        [("bool",(Ast.IdLid (_loc,"bool")),[],(Ast.TySum
                                                 (_loc,(Ast.TyOr
                                                          (_loc,(Ast.TyId
                                                                   (_loc,(
                                                                   Ast.IdUid
                                                          ...
                                                          Ast.TyId
                                                            (_loc,(Ast.IdUid
                                                                    (_loc,"True")))))))),false);("list",(
        Ast.IdLid (_loc,"list")),([Ast.TyQuo (_loc,"a")]),(Ast.TySum
                                                             (_loc,(Ast.TyOr
                                                                    (_loc,(
                                                                    Ast.TyId
                                                                    (_loc,(
                                                                    ...
                                                                    Ast.TyQuo
                                                                    (_loc,"a")))))))))))),false);("option",(
        Ast.IdLid (_loc,"option")),([Ast.TyQuo (_loc,"a")]),(Ast.TySum
                                                               (_loc,(
                                                               Ast.TyOr
                                                                 (_loc,(
                                                                 Ast.TyId
                                                                 ...
                                                                 Ast.TyOf
                                                                   ...
                                                                   Ast.TyQuo
                                                                    (_loc,"a")))))))),false);("ref",(
        Ast.IdLid (_loc,"ref")),([Ast.TyQuo (_loc,"a")]),(Ast.TyRec
                                                            (_loc,(Ast.TyCol
                                                                    (_loc,(
                                                                    Ast.TyId
                                                                    (_loc,(
  ...
  module Gen(X:sig val size : int  val mode : mode  end) =
    ...
    let rec opt_bind opt_patt e1 mk_e2 =
      ...
      | Ast.ExLet (_,Ast.ReNil ,Ast.BiEq (_,p1,e1),e2) ->
          Ast.ExLet
            (_loc,Ast.ReNil,(Ast.BiEq (_loc,p1,e1)),(opt_bind None e2 mk_e2))
      | _ ->
    ...
    let default_match_case =
      ...
      | Fold_map  ->
          Ast.McArr
            (_loc,(tuplify_patt mk),(Ast.ExNil _loc),(Ast.ExTup
                                                        (_loc,(Ast.ExCom
                                                                 (_loc,(
                                                                 Ast.ExId
                                                                   (_loc,(
      ...
      | Fold  ->
          Ast.McArr
            (_loc,(Ast.PaAny _loc),(Ast.ExNil _loc),(Ast.ExId
                                                       (_loc,(Ast.IdLid
                                                                (_loc,"o")))))
      | Map  ->
          Ast.McArr
            (_loc,(tuplify_patt mk),(Ast.ExNil _loc),(Ast.ExId
                                                        (_loc,(Ast.IdLid
                                                                 (_loc,"x")))))
      ...
      try
        let (_ : < .. >) =
          ((object
             ...
             method! ctyp =
               fun t -> if is_unknown t then raise Exit else (super#ctyp) t
             end)#ctyp) t in
        false
      with | Exit  -> true
    ...
    let rec expr_of_ty x ty =
      ...
      chain_tuple
        (function
         ...
         | ps ->
             Ast.PaApp
               (_loc,(Ast.PaVrn (_loc,s)),(Ast.PaTup
                                             (_loc,(Ast.paCom_of_list ps)))))
        (function
         | [] -> Ast.ExVrn (_loc,s)
         | e::[] -> Ast.ExApp (_loc,(Ast.ExVrn (_loc,s)),e)
         | es ->
             Ast.ExApp
               (_loc,(Ast.ExVrn (_loc,s)),(Ast.ExTup
                                             (_loc,(Ast.exCom_of_list es)))))
        expr_of_ty ts and match_case_of_poly_sum_type =
      function
      | Ast.TyOr (_,t1,t2) ->
          Ast.McOr
            (_loc,(match_case_of_poly_sum_type t1),(match_case_of_poly_sum_type
                                                      t2))
      ...
      | Ast.TyCol (_,Ast.TyId (_,Ast.IdLid (_,s)),_) ->
          Ast.PaEq
            (_loc,(Ast.IdLid (_loc,s)),(Ast.PaId
      ...
      let mkp ps =
        Ast.PaRec
          (_loc,(Ast.paSem_of_list
                   (List.map2
                      (fun l ->
                         fun p -> Ast.PaEq (_loc,(Ast.IdLid (_loc,l)),p)) ls
                      ps))) in
      let mke es =
        Ast.ExRec
          (_loc,(Ast.rbSem_of_list
                   (List.map2
                      (fun l ->
                         fun e -> Ast.RbEq (_loc,(Ast.IdLid (_loc,l)),e)) ls
                      es)),(Ast.ExNil _loc)) in
      chain_tuple mkp mke expr_of_ty ts and failure_match_case =
      Ast.McArr
        (_loc,(tuplify_patt (pxik 0)),(Ast.ExNil _loc),(Ast.ExApp
                                                          (_loc,(Ast.ExSnd
                                                                   (_loc,(
                                                                   Ast.ExId
                                                                    (_loc,(
      ...
      Ast.CrSem (_loc,(Ast.CrMth (_loc,id1,Ast.OvNil,priv,funs,ty)),acc) and
      ...
      | (param_in::[],param_out::[]) ->
          ...
          Ast.TyPol
            (_loc,(Ast.TyApp (_loc,param_in,param_out)),(Ast.TyArr
                                                           (_loc,(Ast.TyArr
                                                                    (_loc,(
                                                                    Ast.TyQuo
                                                                    (_loc,"self_type")),(
    ...
    let module M = Gen(struct
      ...
      let gen_type =
        Ast.TyPol
          ...
          M.method_type_of_type (Ast.TyQuo (_loc,"a")) (Ast.TyQuo (_loc,"b"))
            [] [])) in
      let failure =
        if n > 1
        then
          ...
          Ast.CrMth
            (_loc,(sf "%s%d_failure" name n),Ast.OvNil,Ast.PrNil,(Ast.ExFun
                                                                    (_loc,(
                                                                    Ast.McArr
                                                                    (_loc,(
                                                                    M.tuplify_patt
      ...
      let gen_type =
        Ast.TyPol
          (_loc,(Ast.TyQuo (_loc,"a")),(M.method_type_of_type
                                          (Ast.TyQuo (_loc,"a"))
                                          (Ast.TyQuo (_loc,"a")) [] [])) in
      let unknown =
        Ast.CrMth
      ...
      Ast.StCls
        (_loc,(Ast.CeEq
                 (_loc,(Ast.CeCon
                          (_loc,Ast.ViNil,(Ast.IdLid (_loc,c)),(Ast.TyNil
                                                                  _loc))),(
                 Ast.CeStr
                   (_loc,(Ast.PaTyc
                            (_loc,(Ast.PaId (_loc,(Ast.IdLid (_loc,"o")))),(
                            Ast.TyQuo (_loc,"self_type")))),(Ast.CrSem
                                                               (_loc,generated,(
                                                               Ast.CrSem
                                                                 (_loc,failure,unknown)))))))))
        ...
        (_loc,(Ast.CtCol
                 (_loc,(Ast.CtCon
                          (_loc,Ast.ViNil,(Ast.IdLid (_loc,c)),(Ast.TyNil
                                                                  _loc))),(
                 Ast.CtSig
                   (_loc,(Ast.TyQuo (_loc,"self_type")),(Ast.CgSem
                                                           (_loc,generated,(
                                                           Ast.CgSem
                                                             (_loc,failure,unknown)))))))))
  let processor =
