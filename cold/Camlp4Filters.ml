...
module IdFoldGenerator =
 struct let name = "Camlp4FoldGenerator"
  let version = Sys.ocaml_version
  end
     ...
     fun c ->
      fun tydcl ->
       fun n ->
        ...
        let module M = (Gen)(struct let size = n
                              let mode = mode
                              end) in
...
module IdProfiler =
 struct let name = "Camlp4Profiler"
  let version = Sys.ocaml_version
  end
