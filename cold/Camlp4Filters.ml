...
module MakeFoldGenerator =
                                              functor (AstFilters : Camlp4.Sig.AstFilters) ->
                                               struct
                                                ...
                                                let _ = (register_sig_item_filter
                                                          (
                                                          processor#sig_item
                                                          ))
...
module MakeProfiler =
 functor (AstFilters : Camlp4.Sig.AstFilters) ->
  struct
   ...
   let _ = (register_str_item_filter ( ((decorate decorate_fun)#str_item) ))
