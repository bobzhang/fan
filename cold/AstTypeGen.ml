...
let generate (mtyps : FSig.mtyps) =
  (let tys: string list =
   ...
   let typedecl =
     ...
     (`Type
        ((FanLoc.of_tuple
            ("src/AstTypeGen.ml", 363, 12007, 12025, 363, 12007, 12043,
              false)),
          (`TyDcl
             ((FanLoc.of_tuple
                 ("src/AstTypeGen.ml", 363, 12007, 12030, 363, 12007, 12043,
                   false)),
               (`Lid
                  ((FanLoc.of_tuple
                      ("src/AstTypeGen.ml", 363, 12007, 12033, 363, 12007,
                        12036, false)), "tag")),
               (`Some
                  ((FanLoc.of_tuple
                      ("src/AstTypeGen.ml", 363, 12007, 12030, 363, 12007,
                        12036, false)),
                    (`Quote
                       ((FanLoc.of_tuple
                           ("src/AstTypeGen.ml", 363, 12007, 12030, 363,
                             12007, 12032, false)),
                         (`Normal
                            (FanLoc.of_tuple
                               ("src/AstTypeGen.ml", 363, 12007, 12030, 363,
                         ...
                         (`Lid
                            ((FanLoc.of_tuple
                                ("src/AstTypeGen.ml", 363, 12007, 12031, 363,
                                  12007, 12032, false)), "a")))))),
               (`TyRepr
                  ((FanLoc.of_tuple
                      ("src/AstTypeGen.ml", 363, 12007, 12039, 363, 12007,
                        12043, false)),
                    (`PrNil
                       (FanLoc.of_tuple
                          ("src/AstTypeGen.ml", 363, 12007, 12039, 363,
                            12007, 12043, false))),
                    (`Sum
                       ((FanLoc.of_tuple
                           ("src/AstTypeGen.ml", 363, 12007, 12039, 363,
