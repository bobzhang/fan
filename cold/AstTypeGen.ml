...
let generate (module_types : FSig.module_types) =
  (let tys: string list =
   ...
   let typedecl =
     let x =
       bar_of_list
         (List.map (fun x  -> `Id (_loc, (uid _loc (String.capitalize x))))
            tys) in
     (`Type
        ((FanLoc.of_tuple
            ("src/AstTypeGen.ml", 352, 11980, 11998, 352, 11980, 12018,
              false)),
          (`TyDcl
             ((FanLoc.of_tuple
                 ("src/AstTypeGen.ml", 352, 11980, 12003, 352, 11980, 12018,
                   false)),
               (`Lid
                  ((FanLoc.of_tuple
                      ("src/AstTypeGen.ml", 352, 11980, 12006, 352, 11980,
                        12009, false)), "tag")),
               (`Some
                  ((FanLoc.of_tuple
                      ("src/AstTypeGen.ml", 352, 11980, 12003, 352, 11980,
                        12009, false)),
                    (`Quote
                       ((FanLoc.of_tuple
                           ("src/AstTypeGen.ml", 352, 11980, 12003, 352,
                             11980, 12005, false)),
                         (`Normal
                            (FanLoc.of_tuple
                               ("src/AstTypeGen.ml", 352, 11980, 12003, 352,
                         ...
                         (`Lid
                            ((FanLoc.of_tuple
                                ("src/AstTypeGen.ml", 352, 11980, 12004, 352,
                                  11980, 12005, false)), "a")))))),
               (`TyRepr
                  ((FanLoc.of_tuple
                      ("src/AstTypeGen.ml", 352, 11980, 12012, 352, 11980,
                        12018, false)),
                    (`PrNil
                       (FanLoc.of_tuple
                          ("src/AstTypeGen.ml", 352, 11980, 12012, 352,
                            11980, 12018, false))),
                    (`Sum
                       ((FanLoc.of_tuple
                           ("src/AstTypeGen.ml", 352, 11980, 12012, 352,
