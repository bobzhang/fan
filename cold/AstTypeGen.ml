...
let generate (mtyps : FSig.mtyps) =
  (let tys: string list =
   ...
   let typedecl =
     ...
     (`Type
        ((FanLoc.of_tuple
            ("src/AstTypeGen.ml", 405, 13645, 13662, 405, 13645, 13680,
              false)),
          (`TyDcl
             ((FanLoc.of_tuple
                 ("src/AstTypeGen.ml", 405, 13645, 13667, 405, 13645, 13680,
                   false)),
               (`Lid
                  ((FanLoc.of_tuple
                      ("src/AstTypeGen.ml", 405, 13645, 13670, 405, 13645,
                        13673, false)), "tag")),
               (`Some
                  ((FanLoc.of_tuple
                      ("src/AstTypeGen.ml", 405, 13645, 13667, 405, 13645,
                        13673, false)),
                    (`Quote
                       ((FanLoc.of_tuple
                           ("src/AstTypeGen.ml", 405, 13645, 13667, 405,
                             13645, 13669, false)),
                         (`Normal
                            (FanLoc.of_tuple
                               ("src/AstTypeGen.ml", 405, 13645, 13667, 405,
                         ...
                         (`Lid
                            ((FanLoc.of_tuple
                                ("src/AstTypeGen.ml", 405, 13645, 13668, 405,
                                  13645, 13669, false)), "a")))))),
               (`TyRepr
                  ((FanLoc.of_tuple
                      ("src/AstTypeGen.ml", 405, 13645, 13676, 405, 13645,
                        13680, false)),
                    (`Negative
                       (FanLoc.of_tuple
                          ("src/AstTypeGen.ml", 405, 13645, 13676, 405,
                            13645, 13680, false))),
                    (`Sum
                       ((FanLoc.of_tuple
                           ("src/AstTypeGen.ml", 405, 13645, 13676, 405,
