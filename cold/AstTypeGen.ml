...
let generate (mtyps : FSig.mtyps) =
  (let tys: string list =
   ...
   let typedecl =
     ...
     (`Type
        ((FanLoc.of_tuple
            ("src/AstTypeGen.ml", 402, 13653, 13670, 402, 13653, 13688,
              false)),
          (`TyDcl
             ((FanLoc.of_tuple
                 ("src/AstTypeGen.ml", 402, 13653, 13675, 402, 13653, 13688,
                   false)),
               (`Lid
                  ((FanLoc.of_tuple
                      ("src/AstTypeGen.ml", 402, 13653, 13678, 402, 13653,
                        13681, false)), "tag")),
               (`Some
                  ((FanLoc.of_tuple
                      ("src/AstTypeGen.ml", 402, 13653, 13675, 402, 13653,
                        13681, false)),
                    (`Quote
                       ((FanLoc.of_tuple
                           ("src/AstTypeGen.ml", 402, 13653, 13675, 402,
                             13653, 13677, false)),
                         (`Normal
                            (FanLoc.of_tuple
                               ("src/AstTypeGen.ml", 402, 13653, 13675, 402,
                         ...
                         (`Lid
                            ((FanLoc.of_tuple
                                ("src/AstTypeGen.ml", 402, 13653, 13676, 402,
                                  13653, 13677, false)), "a")))))),
               (`TyRepr
                  ((FanLoc.of_tuple
                      ("src/AstTypeGen.ml", 402, 13653, 13684, 402, 13653,
                        13688, false)),
                    (`PrNil
                       (FanLoc.of_tuple
                          ("src/AstTypeGen.ml", 402, 13653, 13684, 402,
                            13653, 13688, false))),
                    (`Sum
                       ((FanLoc.of_tuple
                           ("src/AstTypeGen.ml", 402, 13653, 13684, 402,
