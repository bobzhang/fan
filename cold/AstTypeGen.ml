   ...
   let typedecl =
     ...
     (`Type
        ((FanLoc.of_tuple
          ...
          (`TyDcl
             ((FanLoc.of_tuple
                 ("src/AstTypeGen.ml", 352, 11958, 11981, 352, 11958, 11996,
                   false)),
               (`Lid
                  ((FanLoc.of_tuple
                      ("src/AstTypeGen.ml", 352, 11958, 11984, 352, 11958,
                        11987, false)), "tag")),
               (`Some
                  ((FanLoc.of_tuple
                      ("src/AstTypeGen.ml", 352, 11958, 11981, 352, 11958,
                        11987, false)),
                    (`Quote
                       ((FanLoc.of_tuple
                           ("src/AstTypeGen.ml", 352, 11958, 11981, 352,
                             11958, 11983, false)),
                         (`Normal
                            (FanLoc.of_tuple
                               ("src/AstTypeGen.ml", 352, 11958, 11981, 352,
                         ...
                         (`Lid
                            ((FanLoc.of_tuple
                                ("src/AstTypeGen.ml", 352, 11958, 11982, 352,
                                  11958, 11983, false)), "a")))))),
               (`TyRepr
                  ((FanLoc.of_tuple
                      ("src/AstTypeGen.ml", 352, 11958, 11990, 352, 11958,
                        11996, false)),
                    (`PrNil
                       (FanLoc.of_tuple
                          ("src/AstTypeGen.ml", 352, 11958, 11990, 352,
                            11958, 11996, false))),
                    (`Sum
                       ((FanLoc.of_tuple
                           ("src/AstTypeGen.ml", 352, 11958, 11990, 352,
