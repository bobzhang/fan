...
let generate (module_types : FSig.module_types) =
  (let tys: string list =
   ...
   let typedecl =
     ...
     (`Type
        ((FanLoc.of_tuple
            ("src/AstTypeGen.ml", 352, 11971, 11989, 352, 11971, 12009,
              false)),
          (`TyDcl
             ((FanLoc.of_tuple
                 ("src/AstTypeGen.ml", 352, 11971, 11994, 352, 11971, 12009,
                   false)),
               (`Lid
                  ((FanLoc.of_tuple
                      ("src/AstTypeGen.ml", 352, 11971, 11997, 352, 11971,
                        12000, false)), "tag")),
               (`Some
                  ((FanLoc.of_tuple
                      ("src/AstTypeGen.ml", 352, 11971, 11994, 352, 11971,
                        12000, false)),
                    (`Quote
                       ((FanLoc.of_tuple
                           ("src/AstTypeGen.ml", 352, 11971, 11994, 352,
                             11971, 11996, false)),
                         (`Normal
                            (FanLoc.of_tuple
                               ("src/AstTypeGen.ml", 352, 11971, 11994, 352,
                         ...
                         (`Lid
                            ((FanLoc.of_tuple
                                ("src/AstTypeGen.ml", 352, 11971, 11995, 352,
                                  11971, 11996, false)), "a")))))),
               (`TyRepr
                  ((FanLoc.of_tuple
                      ("src/AstTypeGen.ml", 352, 11971, 12003, 352, 11971,
                        12009, false)),
                    (`PrNil
                       (FanLoc.of_tuple
                          ("src/AstTypeGen.ml", 352, 11971, 12003, 352,
                            11971, 12009, false))),
                    (`Sum
                       ((FanLoc.of_tuple
                           ("src/AstTypeGen.ml", 352, 11971, 12003, 352,
