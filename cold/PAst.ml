...
and patt =
  ...
  | `PaAnt of (loc * string ) | `PaAny of loc 
  | `PaApp of (loc * patt * patt ) | `PaArr of (loc * patt )
  | `PaCom of (loc * patt * patt ) | `PaSem of (loc * patt * patt )
  | `PaChr of (loc * string ) | `PaInt of (loc * string )
  | `PaInt32 of (loc * string ) | `PaInt64 of (loc * string )
  | `PaNativeInt of (loc * string ) | `PaFlo of (loc * string )
