type loc =  FanLoc.t  and meta_bool = 
                        [ `BTrue | `BFalse | `BAnt of string   ]  and
                                                                    rec_flag
                                                                    = 
                                                                    [
                                                                    `ReRecursive
...
and private_flag =  [ `PrPrivate | `PrNil | `PrAnt of string   ]  and
                                                                    virtual_flag
                                                                    = 
                                                                    [
                                                                    `ViVirtual
...
and override_flag =  [ `OvOverride | `OvNil | `OvAnt of string   ]  and
                                                                    row_var_flag
                                                                    = 
                                                                    [
                                                                    `RvRowVar
...
and module_type = 
  [ `MtNil of loc  | `MtId of (loc * ident )  |
    ...
    `MtOf of (loc * module_expr )  | `MtAnt of (loc * string )   ]  and
                                                                    sig_item
                                                                    = 
                                                                    [
                                                                    `SgNil of
