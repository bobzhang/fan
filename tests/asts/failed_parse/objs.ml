  ...
  | fmt ->
      (function
       ...
       | `TyColMut (_a0,_a1,_a2) ->
           Format.fprintf fmt "@[<1>(`TyColMut@ %a@ %a@ %a)@]" pp_print_loc
             _a0 pp_print_alident _a1 pp_print_ctyp _a2
       | #ant as _a0 -> (pp_print_ant fmt _a0 :> unit))
      ...
      (function
       ...
       | `TypeWith (_a0,_a1,_a2) ->
           Format.fprintf fmt "@[<1>(`TypeWith@ %a@ %a@ %a)@]" pp_print_loc
             _a0 pp_print_typedecl _a1 pp_print_strings _a2
       | `Value (_a0,_a1,_a2) ->
  ...
  object (self : 'self_type)
          ...
          (function
           ...
           | `Bool (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`Bool@ %a@ %a)@]" self#loc _a0
                 self#bool _a1
           | `Unit _a0 ->
               Format.fprintf fmt "@[<1>(`Unit@ %a)@]" self#loc _a0)
    ...
    method astring : 'fmt -> astring -> unit=
      ...
      | fmt ->
          (function
           | `C (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`C@ %a@ %a)@]" self#loc _a0
                 self#string _a1
           | #ant as _a0 -> (self#ant fmt _a0 :> unit))
    ...
    method ctyp : 'fmt -> ctyp -> unit=
      ...
      | fmt ->
          (function
           ...
           | `OptLabl (_a0,_a1,_a2) ->
               Format.fprintf fmt "@[<1>(`OptLabl@ %a@ %a@ %a)@]" self#loc
           ...
           | `TyPolEnd (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`TyPolEnd@ %a@ %a)@]" self#loc _a0
                 self#ctyp _a1
           | `TyTypePol (_a0,_a1,_a2) ->
               Format.fprintf fmt "@[<1>(`TyTypePol@ %a@ %a@ %a)@]" self#loc
           ...
           | `Par (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`Par@ %a@ %a)@]" self#loc _a0
                 self#ctyp _a1
           | `Sta (_a0,_a1,_a2) ->
          ...
          (function
           ...
           | `TyVrn (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`TyVrn@ %a@ %a)@]" self#loc _a0
                 self#astring _a1
           | `TyVrnOf (_a0,_a1,_a2) ->
               Format.fprintf fmt "@[<1>(`TyVrnOf@ %a@ %a@ %a)@]" self#loc
                 _a0 self#astring _a1 self#ctyp _a2
           | `Ctyp (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`Ctyp@ %a@ %a)@]" self#loc _a0
                 self#ctyp _a1)
    ...
    method opt_type_constr : 'fmt -> opt_type_constr -> unit=
      ...
      | fmt ->
          (function
           ...
           | `None _a0 ->
               Format.fprintf fmt "@[<1>(`None@ %a)@]" self#loc _a0)
    ...
    method type_info : 'fmt -> type_info -> unit=
      ...
      | fmt ->
          (function
           | `TyMan (_a0,_a1,_a2,_a3) ->
               Format.fprintf fmt "@[<1>(`TyMan@ %a@ %a@ %a@ %a)@]" self#loc
                 _a0 self#ctyp _a1 self#flag _a2 self#type_repr _a3
           | `TyRepr (_a0,_a1,_a2) ->
          ...
          (function
           ...
           | `TyCol (_a0,_a1,_a2) ->
               Format.fprintf fmt "@[<1>(`TyCol@ %a@ %a@ %a)@]" self#loc _a0
                 self#alident _a1 self#ctyp _a2
           | `TyColMut (_a0,_a1,_a2) ->
               Format.fprintf fmt "@[<1>(`TyColMut@ %a@ %a@ %a)@]" self#loc
                 _a0 self#alident _a1 self#ctyp _a2
           | #ant as _a0 -> (self#ant fmt _a0 :> unit))
    ...
    method pat : 'fmt -> pat -> unit=
      ...
      | fmt ->
          (function
           ...
           | `OptLabl (_a0,_a1,_a2) ->
               Format.fprintf fmt "@[<1>(`OptLabl@ %a@ %a@ %a)@]" self#loc
                 _a0 self#alident _a1 self#pat _a2
           | `OptLablS (_a0,_a1) ->
           ...
           | `Lazy (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`Lazy@ %a@ %a)@]" self#loc _a0
                 self#pat _a1
           | `ModuleUnpack (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`ModuleUnpack@ %a@ %a)@]" self#loc
    ...
    method rec_pat : 'fmt -> rec_pat -> unit=
      ...
      | fmt ->
          (function
           | `RecBind (_a0,_a1,_a2) ->
               Format.fprintf fmt "@[<1>(`RecBind@ %a@ %a@ %a)@]" self#loc
                 _a0 self#vid _a1 self#pat _a2
           | `Sem (_a0,_a1,_a2) ->
               Format.fprintf fmt "@[<1>(`Sem@ %a@ %a@ %a)@]" self#loc _a0
    ...
    method exp : 'fmt -> exp -> unit=
      ...
      | fmt ->
          (function
           ...
           | `ArrayDot (_a0,_a1,_a2) ->
               Format.fprintf fmt "@[<1>(`ArrayDot@ %a@ %a@ %a)@]" self#loc
           ...
           | `Lazy (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`Lazy@ %a@ %a)@]" self#loc _a0
                 self#exp _a1
           | `LetIn (_a0,_a1,_a2,_a3) ->
               Format.fprintf fmt "@[<1>(`LetIn@ %a@ %a@ %a@ %a)@]" self#loc
                 _a0 self#flag _a1 self#bind _a2 self#exp _a3
           | `LetTryInWith (_a0,_a1,_a2,_a3,_a4) ->
               Format.fprintf fmt
                 "@[<1>(`LetTryInWith@ %a@ %a@ %a@ %a@ %a)@]" self#loc _a0
                 self#flag _a1 self#bind _a2 self#exp _a3 self#case _a4
           | `LetModule (_a0,_a1,_a2,_a3) ->
               Format.fprintf fmt "@[<1>(`LetModule@ %a@ %a@ %a@ %a)@]"
           ...
           | `Seq (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`Seq@ %a@ %a)@]" self#loc _a0
                 self#exp _a1
           | `Send (_a0,_a1,_a2) ->
               Format.fprintf fmt "@[<1>(`Send@ %a@ %a@ %a)@]" self#loc _a0
                 self#exp _a1 self#alident _a2
           | `StringDot (_a0,_a1,_a2) ->
               Format.fprintf fmt "@[<1>(`StringDot@ %a@ %a@ %a)@]" self#loc
                 _a0 self#exp _a1 self#exp _a2
           | `Try (_a0,_a1,_a2) ->
           ...
           | `Subtype (_a0,_a1,_a2) ->
               Format.fprintf fmt "@[<1>(`Subtype@ %a@ %a@ %a)@]" self#loc
           ...
           | `LetOpen (_a0,_a1,_a2,_a3) ->
               Format.fprintf fmt "@[<1>(`LetOpen@ %a@ %a@ %a@ %a)@]"
                 self#loc _a0 self#flag _a1 self#ident _a2 self#exp _a3
           | `LocalTypeFun (_a0,_a1,_a2) ->
               Format.fprintf fmt "@[<1>(`LocalTypeFun@ %a@ %a@ %a)@]"
                 self#loc _a0 self#alident _a1 self#exp _a2
           | `Package_exp (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`Package_exp@ %a@ %a)@]" self#loc
                 _a0 self#mexp _a1)
    ...
    method mtyp : 'fmt -> mtyp -> unit=
      ...
      | fmt ->
          (function
           ...
           | `Functor (_a0,_a1,_a2,_a3) ->
               Format.fprintf fmt "@[<1>(`Functor@ %a@ %a@ %a@ %a)@]"
                 self#loc _a0 self#auident _a1 self#mtyp _a2 self#mtyp _a3
           | `With (_a0,_a1,_a2) ->
               Format.fprintf fmt "@[<1>(`With@ %a@ %a@ %a)@]" self#loc _a0
                 self#mtyp _a1 self#constr _a2
           | `ModuleTypeOf (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`ModuleTypeOf@ %a@ %a)@]" self#loc
                 _a0 self#mexp _a1
           | #ant as _a0 -> (self#ant fmt _a0 :> unit))
    method sigi : 'fmt -> sigi -> unit=
      ...
      | fmt ->
          (function
           ...
           | `ModuleTypeEnd (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`ModuleTypeEnd@ %a@ %a)@]" self#loc
                 _a0 self#auident _a1
           | `ModuleType (_a0,_a1,_a2) ->
               Format.fprintf fmt "@[<1>(`ModuleType@ %a@ %a@ %a)@]" 
                 self#loc _a0 self#auident _a1 self#mtyp _a2
           | `Sem (_a0,_a1,_a2) ->
               Format.fprintf fmt "@[<1>(`Sem@ %a@ %a@ %a)@]" self#loc _a0
           ...
           | `Directive (_a0,_a1,_a2) ->
               Format.fprintf fmt "@[<1>(`Directive@ %a@ %a@ %a)@]" self#loc
                 _a0 self#alident _a1 self#exp _a2
           | `Open (_a0,_a1,_a2) ->
    ...
    method mexp : 'fmt -> mexp -> unit=
      ...
      | fmt ->
          (function
           ...
           | `Constraint (_a0,_a1,_a2) ->
               Format.fprintf fmt "@[<1>(`Constraint@ %a@ %a@ %a)@]" 
                 self#loc _a0 self#mexp _a1 self#mtyp _a2
           | `PackageModule (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`PackageModule@ %a@ %a)@]" self#loc
                 _a0 self#exp _a1
           | #ant as _a0 -> (self#ant fmt _a0 :> unit))
          ...
          (function
           ...
           | `Type (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`Type@ %a@ %a)@]" self#loc _a0
                 self#typedecl _a1
           | `TypeWith (_a0,_a1,_a2) ->
               Format.fprintf fmt "@[<1>(`TypeWith@ %a@ %a@ %a)@]" self#loc
                 _a0 self#typedecl _a1 self#strings _a2
           | `Value (_a0,_a1,_a2) ->
    ...
    method cltdecl : 'fmt -> cltdecl -> unit=
      ...
      | fmt ->
          (function
           ...
           | `CtDecl (_a0,_a1,_a2,_a3,_a4) ->
               Format.fprintf fmt "@[<1>(`CtDecl@ %a@ %a@ %a@ %a@ %a)@]"
                 self#loc _a0 self#flag _a1 self#ident _a2
                 self#type_parameters _a3 self#cltyp _a4
           | `CtDeclS (_a0,_a1,_a2,_a3) ->
               Format.fprintf fmt "@[<1>(`CtDeclS@ %a@ %a@ %a@ %a)@]"
                 self#loc _a0 self#flag _a1 self#ident _a2 self#cltyp _a3
           | #ant as _a0 -> (self#ant fmt _a0 :> unit))
    method cltyp : 'fmt -> cltyp -> unit=
      ...
      | fmt ->
          (function
           | #vid' as _a0 -> (self#vid' fmt _a0 :> unit)
           | `ClApply (_a0,_a1,_a2) ->
               Format.fprintf fmt "@[<1>(`ClApply@ %a@ %a@ %a)@]" self#loc
                 _a0 self#vid _a1 self#type_parameters _a2
           | `CtFun (_a0,_a1,_a2) ->
          ...
          (function
           ...
           | `Method (_a0,_a1,_a2,_a3) ->
               Format.fprintf fmt "@[<1>(`Method@ %a@ %a@ %a@ %a)@]" 
                 self#loc _a0 self#alident _a1 self#flag _a2 self#ctyp _a3
           | `VirMeth (_a0,_a1,_a2,_a3) ->
               Format.fprintf fmt "@[<1>(`VirMeth@ %a@ %a@ %a@ %a)@]"
                 self#loc _a0 self#alident _a1 self#flag _a2 self#ctyp _a3
           | `Eq (_a0,_a1,_a2) ->
      ...
      | fmt ->
          (function
           | `ClDecl (_a0,_a1,_a2,_a3,_a4) ->
               Format.fprintf fmt "@[<1>(`ClDecl@ %a@ %a@ %a@ %a@ %a)@]"
                 self#loc _a0 self#flag _a1 self#ident _a2
                 self#type_parameters _a3 self#clexp _a4
           | `ClDeclS (_a0,_a1,_a2,_a3) ->
               Format.fprintf fmt "@[<1>(`ClDeclS@ %a@ %a@ %a@ %a)@]"
                 self#loc _a0 self#flag _a1 self#ident _a2 self#clexp _a3
           | `And (_a0,_a1,_a2) ->
               Format.fprintf fmt "@[<1>(`And@ %a@ %a@ %a)@]" self#loc _a0
    ...
    method clexp : 'fmt -> clexp -> unit=
      ...
      | fmt ->
          (function
           ...
           | `LetIn (_a0,_a1,_a2,_a3) ->
               Format.fprintf fmt "@[<1>(`LetIn@ %a@ %a@ %a@ %a)@]" self#loc
                 _a0 self#flag _a1 self#bind _a2 self#clexp _a3
           | `Obj (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`Obj@ %a@ %a)@]" self#loc _a0
                 self#clfield _a1
           | `ObjEnd _a0 ->
           ...
           | `Constraint (_a0,_a1,_a2) ->
               Format.fprintf fmt "@[<1>(`Constraint@ %a@ %a@ %a)@]" 
                 self#loc _a0 self#clexp _a1 self#cltyp _a2
           | #ant as _a0 -> (self#ant fmt _a0 :> unit))
    method clfield : 'fmt -> clfield -> unit=
      ...
      | fmt ->
          (function
           ...
           | `Inherit (_a0,_a1,_a2) ->
               Format.fprintf fmt "@[<1>(`Inherit@ %a@ %a@ %a)@]" self#loc
                 _a0 self#flag _a1 self#clexp _a2
           | `InheritAs (_a0,_a1,_a2,_a3) ->
               Format.fprintf fmt "@[<1>(`InheritAs@ %a@ %a@ %a@ %a)@]"
           ...
           | `Eq (_a0,_a1,_a2) ->
               Format.fprintf fmt "@[<1>(`Eq@ %a@ %a@ %a)@]" self#loc _a0
                 self#ctyp _a1 self#ctyp _a2
           | `Initializer (_a0,_a1) ->
               Format.fprintf fmt "@[<1>(`Initializer@ %a@ %a)@]" self#loc
                 _a0 self#exp _a1
           | #ant as _a0 -> (self#ant fmt _a0 :> unit))
    method ep : 'fmt -> ep -> unit=
      ...
      | fmt ->
          (function
           ...
           | `Constraint (_a0,_a1,_a2) ->
               Format.fprintf fmt "@[<1>(`Constraint@ %a@ %a@ %a)@]" 
                 self#loc _a0 self#ep _a1 self#ctyp _a2
           | #any as _a0 -> (self#any fmt _a0 :> unit)
           | `ArrayEmpty _a0 ->
               Format.fprintf fmt "@[<1>(`ArrayEmpty@ %a)@]" self#loc _a0
           | `Array (_a0,_a1) ->
...
class map =
  object (self : 'self_type)
    ...
    method any : any -> any=
      function | `Any _a0 -> let _a0 = self#loc _a0 in `Any _a0
...
class fold =
  object (self : 'self_type)
    ...
    method lident : lident -> 'self_type=
      function | `Lid (_a0,_a1) -> let self = self#loc _a0 in self#string _a1
    ...
    method dlpath : dlpath -> 'self_type=
      ...
      | #alident as _a0 -> (self#alident _a0 :> 'self_type)
    method any : any -> 'self_type= function | `Any _a0 -> self#loc _a0
...
class reloc _loc = object inherit  map method! loc = function | _ -> _loc end
let wildcarder =
  object (self)
    inherit  map as super
    method! pat =
