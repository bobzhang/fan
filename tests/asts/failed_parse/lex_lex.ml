let rec token: Lexing.lexbuf -> Tokenf.t =
  ...
  | (lexbuf : Lexing.lexbuf) ->
      ...
      and __ocaml_lex_state1 = function | () -> 11
      and __ocaml_lex_state2 = function | () -> 10
      ...
      and __ocaml_lex_state4 = function | () -> 7
            ...
            (lexbuf.lex_last_pos <- lexbuf.lex_curr_pos;
             ...
             (match __ocaml_lex_next_char () with
              ...
              | _ ->
                  (lexbuf.lex_curr_pos <- lexbuf.lex_last_pos;
                   lexbuf.lex_last_action)))
      and __ocaml_lex_state7 = function | () -> 6
            ...
            (lexbuf.lex_last_pos <- lexbuf.lex_curr_pos;
             ...
             (match __ocaml_lex_next_char () with
              ...
              | _ ->
                  (lexbuf.lex_curr_pos <- lexbuf.lex_last_pos;
                   lexbuf.lex_last_action)))
      and __ocaml_lex_state11 = function | () -> 1
        ...
        | () ->
            (match __ocaml_lex_next_char () with
             ...
             | _ ->
                 (lexbuf.lex_curr_pos <- lexbuf.lex_last_pos;
                  lexbuf.lex_last_action))
      and __ocaml_lex_state17 = function | () -> 3
      and __ocaml_lex_state18 = function | () -> 4
      and __ocaml_lex_state19 = function | () -> 5
      ...
      and __ocaml_lex_state26 =
        function | () -> ((lexbuf.lex_mem).(0) <- (lexbuf.lex_mem).(5); 8)
      ...
      (((let pos = lexbuf.lex_curr_pos in
         ...
         lexbuf.lex_last_action <- (-1));
        lexbuf.lex_mem <- Array.create 9 (-1));
       (let __ocaml_lex_result = __ocaml_lex_state0 () in
        ...
        (match __ocaml_lex_result with
         ...
         | _ ->
             failwith
               ("Lex_lex" ^ ("." ^ ("token" ^ " lexing: empty token"))))))
let from_lexbuf =
