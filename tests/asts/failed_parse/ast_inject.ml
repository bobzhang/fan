...
let register_inject_stru =
  function | (k,f) -> Hashtbl.replace inject_stru_tbl k f
let register_inject_clfield =
  function | (k,f) -> Hashtbl.replace inject_clfield_tbl k f
