...
let _ =
  Gramf.extend_single
    ({
       entry = (parser_exp : 'parser_exp Gramf.t);
       olevel =
         ({
            label = None;
            lassoc = true;
                           ...
                           (function
                            | (_loc : Locf.t) ->
                                ...
                                ((match n with
                                  | Some o ->
                                      Ref.protect
                                        Compile_stream.grammar_module_name o
                                        (function | _ -> cparser _loc pcl)
                                  | None  -> cparser _loc pcl) : 'parser_exp)) : 
                      'parser_case_list -> Locf.t -> 'parser_exp))
               };
              {
                symbols =
                  [Token
                               ...
                               (function
                                | (_loc : Locf.t) ->
                                    ...
                                    ((match n with
                                      | Some o ->
                                          Ref.protect
                                            Compile_stream.grammar_module_name
                                            o
                                            (function | _ -> cparser _loc pcl)
                                      | None  -> cparser _loc pcl) : 
                                      'parser_exp))) : 'parser_case_list ->
                                                         Tokenf.txt ->
                                                           Locf.t ->
                                                             'parser_exp))
              }]
  ...
  Gramf.extend_single
    ({
       entry = (parser_case_list : 'parser_case_list Gramf.t);
       olevel =
         ({
            label = None;
            lassoc = true;
            productions =
              [{
                 ...
                 fn =
                   (Gramf.mk_action
                      (function
                       | (pcl : 'parser_case list) ->
                           (function
                            | _ ->
                                (function
                                 | (_loc : Locf.t) ->
                                     (pcl : 'parser_case_list))) : 'parser_case
                                                                    list ->
                                                                    Tokenf.txt
                                                                    ->
                                                                    Locf.t ->
  ...
  Gramf.extend_single
    ({
       entry = (parser_case : 'parser_case Gramf.t);
       olevel =
         ({
            label = None;
            lassoc = true;
              ...
              [{
                 ...
                 fn =
                   (Gramf.mk_action
                      ...
                      'exp ->
                        Tokenf.txt -> 'stream_pat -> Locf.t -> 'parser_case))
               }]
          } : Gramf.olevel)
     } : _ Gramf.single_extend_statement);
  Gramf.extend_single
    ({
       entry = (stream_pat : 'stream_pat Gramf.t);
       olevel =
         ({
            label = None;
            lassoc = true;
            productions =
              ...
              };
              {
                ...
                fn =
                  (Gramf.mk_action
                     (function | (_loc : Locf.t) -> ([] : 'stream_pat) : 
                     Locf.t -> 'stream_pat))
              }]
          } : Gramf.olevel)
     } : _ Gramf.single_extend_statement);
  Gramf.extend_single
    ({
       entry = (stream_pat_comp : 'stream_pat_comp Gramf.t);
       olevel =
         ({
            label = None;
            lassoc = true;
              ...
              };
              {
                ...
                fn =
                  (Gramf.mk_action
                     ...
                     'pat -> Tokenf.txt -> Locf.t -> 'stream_pat_comp))
              }]
          } : Gramf.olevel)
     } : _ Gramf.single_extend_statement);
  Gramf.extend_single
    ({
       entry = (stream_pat_comp_err : 'stream_pat_comp_err Gramf.t);
       olevel =
         ({
            label = None;
            lassoc = true;
              ...
              [{
                 ...
                 fn =
                   (Gramf.mk_action
                      ...
                      'exp ->
                        Tokenf.txt ->
                          'stream_pat_comp -> Locf.t -> 'stream_pat_comp_err))
               };
              {
                symbols =
                  [Nterm
  ...
  Gramf.extend_single
    ({
       entry = (stream_pat_comp_err_list : 'stream_pat_comp_err_list Gramf.t);
       olevel =
         ({
            label = None;
            lassoc = true;
            productions =
              [{
                 ...
                 fn =
                   (Gramf.mk_action
                      (function
                       | (spc : 'stream_pat_comp_err) ->
                           (function
                            | (_loc : Locf.t) ->
                                ([spc] : 'stream_pat_comp_err_list)) : 
                      'stream_pat_comp_err ->
                        Locf.t -> 'stream_pat_comp_err_list))
               };
              {
                symbols =
                  [Nterm
