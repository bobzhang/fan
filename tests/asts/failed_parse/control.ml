let rec token: Lexing.lexbuf -> Tokenf.t =
  ...
  | (lexbuf : Lexing.lexbuf) ->
      ...
      and __ocaml_lex_state2 = function | () -> 7
      ...
      and __ocaml_lex_state5 = function | () -> 4
      ...
      (((let pos = lexbuf.lex_curr_pos in
       ...
       (let __ocaml_lex_result = __ocaml_lex_state0 () in
        ...
        (match __ocaml_lex_result with
         ...
         | _ ->
             failwith
               ("Control" ^ ("." ^ ("token" ^ " lexing: empty token"))))))
               ...
               };
              {
                ...
                fn =
                  (Gramf.mk_action
                     ...
                     'dot_namespace -> Tokenf.txt -> Locf.t -> 'item))
              };
              {
                symbols =
                  [Token
         ...
         ({
            ...
            productions =
              ...
              };
              {
                ...
                fn =
                  (Gramf.mk_action
                     (function | (_loc : Locf.t) -> (() : 'items) : Locf.t ->
                                                                    'items))
              }]
          } : Gramf.olevel)
     } : _ Gramf.single_extend_statement)
