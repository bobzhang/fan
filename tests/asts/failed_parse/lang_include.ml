let rec token: Lexing.lexbuf -> Tokenf.t =
  ...
  | (lexbuf : Lexing.lexbuf) ->
      ...
      and __ocaml_lex_state1 = function | () -> 5
      and __ocaml_lex_state2 = function | () -> 4
      and __ocaml_lex_state3 = function | () -> 3
            ...
            (lexbuf.lex_last_pos <- lexbuf.lex_curr_pos;
             ...
             (match __ocaml_lex_next_char () with
              ...
              | _ ->
                  (lexbuf.lex_curr_pos <- lexbuf.lex_last_pos;
                   lexbuf.lex_last_action)))
      and __ocaml_lex_state6 = function | () -> 1
                            ...
                            | (_loc : Locf.t) ->
                                ...
                                (let (keep,cf) =
                                 ...
                                 (try
                                    let res__003_ =
                                      State.reset ();
                                      Gramlib.parse_include_file
                                        Syntaxf.strus s in
                                    let _ =
                                      keep := keep__001_; cf := cf__002_ in
                                    res__003_
                                  with
                                  | e__004_ ->
                                      ((keep := keep__001_; cf := cf__002_);
                                       raise e__004_)) : 'include_quot)) : 
                      Tokenf.txt -> Locf.t -> 'include_quot))
               }]
          } : Gramf.olevel)
