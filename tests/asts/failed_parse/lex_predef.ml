       ...
       | (e : Astf.exp) ->
           (match y with
            ...
            | Some y ->
                ...
                let _loc = y.loc in
                (`Seq (_loc, (`Sem (_loc, (e :> Astf.exp), (a :> Astf.exp)))) :> 
                  Astf.exp)))
let _ =
  Hashtblf.add_list named_cases
    [("ocaml_uid",
       ((function
         | { tokens_opt = ls; loc = _loc;_} ->
             [((Bind
                  ((Sequence
                      ((Characters [(65, 90); (192, 214); (216, 222)]),
                        (Repetition
                            ...
                            (_loc,
                              ...
                              (`Dot
                                 (_loc, (`Uid (_loc, "Tokenf")),
                                   (`Lid (_loc, "t"))))))) :> Astf.exp))]
             | None  ->
                 Locf.failf _loc "no following strings after kwd_symbol"))));
    ("ocaml_int",
      ((function
        | { loc = _loc;_} ->
            [((Bind
    ...
    ("ocaml_comment",
      ((function
        | { quot_opt = q; loc = _loc;_} ->
            [((Sequence
                 ((Sequence
                     ((Characters [(40, 40)]), (Characters [(42, 42)]))),
                   (Alternative
                      (Epsilon,
                        (Bind
                           ((Characters [(41, 41)]),
