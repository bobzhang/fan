open Astfn
let ant = function | _loc -> (function | x -> x)
...
let lident: Locf.t -> Astfn.lident -> Astf.lident =
  function | loc -> (function | `Lid _a0 -> `Lid (loc, _a0))
...
let any: Locf.t -> Astfn.any -> Astf.any =
  function | loc -> (function | `Any -> `Any loc)
  ...
  | loc ->
      (function
       | `TyDcl (_a0,_a1,_a2,_a3) ->
           ...
           let _a3 = opt_type_constr loc _a3 in
...
and exp: Locf.t -> Astfn.exp -> Astf.exp =
  ...
  | loc ->
      (function
       ...
       | `Package_exp _a0 ->
           let _a0 = mexp loc _a0 in `Package_exp (loc, _a0))
...
and mtyp: Locf.t -> Astfn.mtyp -> Astf.mtyp =
  ...
  | loc ->
      (function
       ...
       | `ModuleTypeOf _a0 ->
           let _a0 = mexp loc _a0 in `ModuleTypeOf (loc, _a0)
  ...
  | loc ->
      (function
       ...
       | `App (_a0,_a1) ->
           ...
           let _a1 = ep loc _a1 in `App (loc, _a0, _a1)
       | `Vrn _a0 -> `Vrn (loc, _a0)
       | `Com (_a0,_a1) ->
           let _a0 = ep loc _a0 in
           let _a1 = ep loc _a1 in `Com (loc, _a0, _a1)
       | `Sem (_a0,_a1) ->
           let _a0 = ep loc _a0 in
           let _a1 = ep loc _a1 in `Sem (loc, _a0, _a1)
