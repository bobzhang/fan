...
let () =
  ...
  after_rules_dispatch := fun () -> begin
    ...
    "src/Ast.ml" |-? ["src/RawAst.ml"];
    "src/AstN.ml" |-? ["src/Ast.ml"];
    "src/FanAst.ml"   |-? [(* "src/MetaTemplate.ml"; *) "src/Ast.ml"];
    "src/FanAstN.ml"  |-? ["src/AstN.ml"; "src/Ast.ml"];
    "src/AstAnt.ml" |-? ["src/RawAst.ml"];
    "src/AstAntLoc.ml" |-? ["src/RawAst.ml"];
    "src/AstLoc.ml" |-? ["src/AstAntLoc.ml"; "src/RawAst.ml"];
    "src/Objs.ml" |-? ["src/Ast.ml";"src/RawAst.ml"];
  end;;
